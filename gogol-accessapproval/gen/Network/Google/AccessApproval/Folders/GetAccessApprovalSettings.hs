...
-- |
-- Module      : Network.Google.AccessApproval.Folders.GetAccessApprovalSettings
...
--
-- /See:/ <https://cloud.google.com/cloud-provider-access-management/access-approval/docs Access Approval API Reference> for @accessapproval.folders.getAccessApprovalSettings@.
module Network.Google.AccessApproval.Folders.GetAccessApprovalSettings
  ( -- * Resource
