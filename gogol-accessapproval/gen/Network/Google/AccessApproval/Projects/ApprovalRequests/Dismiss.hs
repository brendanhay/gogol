...
-- |
-- Module      : Network.Google.AccessApproval.Projects.ApprovalRequests.Dismiss
...
--
-- /See:/ <https://cloud.google.com/cloud-provider-access-management/access-approval/docs Access Approval API Reference> for @accessapproval.projects.approvalRequests.dismiss@.
module Network.Google.AccessApproval.Projects.ApprovalRequests.Dismiss
  ( -- * Resource
...
instance
  ...
  where
  type
    Rs AccessApprovalProjectsApprovalRequestsDismiss =
      ApprovalRequest
  type
    Scopes
      AccessApprovalProjectsApprovalRequestsDismiss =
