...
-- |
-- Module      : Network.Google.AccessApproval.Projects.DeleteAccessApprovalSettings
...
--
-- /See:/ <https://cloud.google.com/cloud-provider-access-management/access-approval/docs Access Approval API Reference> for @accessapproval.projects.deleteAccessApprovalSettings@.
module Network.Google.AccessApproval.Projects.DeleteAccessApprovalSettings
  ( -- * Resource
