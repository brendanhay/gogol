...
-- |
-- Module      : Network.Google.AccessApproval.Projects.UpdateAccessApprovalSettings
...
--
-- /See:/ <https://cloud.google.com/cloud-provider-access-management/access-approval/docs Access Approval API Reference> for @accessapproval.projects.updateAccessApprovalSettings@.
module Network.Google.AccessApproval.Projects.UpdateAccessApprovalSettings
  ( -- * Resource
