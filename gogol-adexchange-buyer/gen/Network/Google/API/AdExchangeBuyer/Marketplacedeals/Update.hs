...
-- | A resource alias for adexchangebuyer.marketplacedeals.update which the
...
muuAlt :: Lens' MarketplacedealsUpdate' Alt
...
instance GoogleRequest MarketplacedealsUpdate' where
        ...
        requestWithRoute r u MarketplacedealsUpdate'{..}
          = go _muuQuotaUser (Just _muuPrettyPrint) _muuUserIp
              _muuKey
              _muuOauthToken
              _muuOrderId
              _muuFields
