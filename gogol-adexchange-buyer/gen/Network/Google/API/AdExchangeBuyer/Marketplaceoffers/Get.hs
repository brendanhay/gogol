...
--
-- /See:/ <https://developers.google.com/ad-exchange/buyer-rest Ad Exchange Buyer API Reference> for @adexchangebuyer.marketplaceoffers.get@.
module Network.Google.API.AdExchangeBuyer.Marketplaceoffers.Get
    (
    -- * REST Resource
...
-- | A resource alias for adexchangebuyer.marketplaceoffers.get which the
