...
-- | A resource alias for adexchangebuyer.marketplaceorders.update which the
...
data MarketplaceordersUpdate' = MarketplaceordersUpdate'
    ...
    , _muUpdateAction   :: !MarketplaceordersUpdate'UpdateAction
    , _muPrettyPrint    :: !Bool
...
-- * 'muAlt'
marketplaceordersUpdate'
    :: MarketplaceordersUpdate'UpdateAction -- ^ 'updateAction'
...
muUpdateAction :: Lens' MarketplaceordersUpdate' MarketplaceordersUpdate'UpdateAction
muUpdateAction
...
muAlt :: Lens' MarketplaceordersUpdate' Alt
...
instance GoogleRequest MarketplaceordersUpdate' where
        ...
        requestWithRoute r u MarketplaceordersUpdate'{..}
          = go _muQuotaUser _muUpdateAction
              (Just _muPrettyPrint)
              _muUserIp
              _muRevisionNumber
              _muKey
