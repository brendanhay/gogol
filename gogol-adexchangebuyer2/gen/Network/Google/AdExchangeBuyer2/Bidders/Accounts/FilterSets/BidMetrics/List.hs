...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.Accounts.FilterSets.BidMetrics.List
...
newAdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList
newAdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList filterSetName =
  AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList
    { xgafv = Core.Nothing,
