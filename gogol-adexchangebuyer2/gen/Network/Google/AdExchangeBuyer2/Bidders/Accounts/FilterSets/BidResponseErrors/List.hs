...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.Accounts.FilterSets.BidResponseErrors.List
...
newAdExchangeBuyer2BiddersAccountsFilterSetsBidResponseErrorsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersAccountsFilterSetsBidResponseErrorsList
newAdExchangeBuyer2BiddersAccountsFilterSetsBidResponseErrorsList filterSetName =
  AdExchangeBuyer2BiddersAccountsFilterSetsBidResponseErrorsList
    { xgafv = Core.Nothing,
