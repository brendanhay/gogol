...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.Accounts.FilterSets.FilteredBids.Details.List
...
newAdExchangeBuyer2BiddersAccountsFilterSetsFilteredBidsDetailsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersAccountsFilterSetsFilteredBidsDetailsList
newAdExchangeBuyer2BiddersAccountsFilterSetsFilteredBidsDetailsList creativeStatusId filterSetName =
  AdExchangeBuyer2BiddersAccountsFilterSetsFilteredBidsDetailsList
    { xgafv = Core.Nothing,
