...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.Accounts.FilterSets.ImpressionMetrics.List
...
newAdExchangeBuyer2BiddersAccountsFilterSetsImpressionMetricsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersAccountsFilterSetsImpressionMetricsList
newAdExchangeBuyer2BiddersAccountsFilterSetsImpressionMetricsList filterSetName =
  AdExchangeBuyer2BiddersAccountsFilterSetsImpressionMetricsList
    { xgafv = Core.Nothing,
