...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.Accounts.FilterSets.LosingBids.List
...
newAdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList
newAdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList filterSetName =
  AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList
    { xgafv = Core.Nothing,
