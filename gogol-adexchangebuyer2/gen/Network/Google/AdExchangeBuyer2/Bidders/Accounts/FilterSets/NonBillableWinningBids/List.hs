...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.Accounts.FilterSets.NonBillableWinningBids.List
...
newAdExchangeBuyer2BiddersAccountsFilterSetsNonBillableWinningBidsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersAccountsFilterSetsNonBillableWinningBidsList
newAdExchangeBuyer2BiddersAccountsFilterSetsNonBillableWinningBidsList filterSetName =
  AdExchangeBuyer2BiddersAccountsFilterSetsNonBillableWinningBidsList
    { xgafv = Core.Nothing,
