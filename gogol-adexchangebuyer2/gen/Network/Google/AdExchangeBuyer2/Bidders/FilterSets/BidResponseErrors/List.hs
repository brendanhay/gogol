...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.FilterSets.BidResponseErrors.List
...
newAdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList
newAdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList filterSetName =
  AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList
    { xgafv = Core.Nothing,
