...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.FilterSets.BidResponsesWithoutBids.List
...
newAdExchangeBuyer2BiddersFilterSetsBidResponsesWithoutBidsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersFilterSetsBidResponsesWithoutBidsList
newAdExchangeBuyer2BiddersFilterSetsBidResponsesWithoutBidsList filterSetName =
  AdExchangeBuyer2BiddersFilterSetsBidResponsesWithoutBidsList
    { xgafv = Core.Nothing,
