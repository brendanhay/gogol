...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.FilterSets.FilteredBids.Details.List
...
newAdExchangeBuyer2BiddersFilterSetsFilteredBidsDetailsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersFilterSetsFilteredBidsDetailsList
newAdExchangeBuyer2BiddersFilterSetsFilteredBidsDetailsList creativeStatusId filterSetName =
  AdExchangeBuyer2BiddersFilterSetsFilteredBidsDetailsList
    { xgafv = Core.Nothing,
