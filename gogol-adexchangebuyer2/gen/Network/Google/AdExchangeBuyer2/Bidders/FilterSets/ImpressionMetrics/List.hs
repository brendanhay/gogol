...
-- |
-- Module      : Network.Google.AdExchangeBuyer2.Bidders.FilterSets.ImpressionMetrics.List
...
newAdExchangeBuyer2BiddersFilterSetsImpressionMetricsList ::
  ...
  Core.Text ->
  AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList
newAdExchangeBuyer2BiddersFilterSetsImpressionMetricsList filterSetName =
  AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList
    { xgafv = Core.Nothing,
