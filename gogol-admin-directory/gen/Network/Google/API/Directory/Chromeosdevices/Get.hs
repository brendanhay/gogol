...
-- | A resource alias for directory.chromeosdevices.get which the
               ...
               QueryParam "quotaUser" Text :>
                 QueryParam "prettyPrint" Bool :>
                   QueryParam "userIp" Text :>
                     QueryParam "key" Text :>
                       QueryParam "projection" ChromeosdevicesGet'Projection
                         :>
...
data ChromeosdevicesGet' = ChromeosdevicesGet'
    ...
    , _cgKey         :: !(Maybe Text)
    , _cgDeviceId    :: !Text
    , _cgProjection  :: !(Maybe ChromeosdevicesGet'Projection)
...
cgProjection :: Lens' ChromeosdevicesGet' (Maybe ChromeosdevicesGet'Projection)
cgProjection
