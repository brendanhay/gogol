...
-- | A resource alias for directory.chromeosdevices.list which the
           ...
           "chromeos" :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "orderBy" ChromeosdevicesList'OrderBy :>
                   QueryParam "userIp" Text :>
                     QueryParam "sortOrder" ChromeosdevicesList'SortOrder
                       :>
                       QueryParam "key" Text :>
...
data ChromeosdevicesList' = ChromeosdevicesList'
    ...
    , _clPrettyPrint :: !Bool
    , _clOrderBy     :: !(Maybe ChromeosdevicesList'OrderBy)
    , _clUserIp      :: !(Maybe Text)
    , _clCustomerId  :: !Text
    , _clSortOrder   :: !(Maybe ChromeosdevicesList'SortOrder)
    , _clKey         :: !(Maybe Text)
    , _clQuery       :: !(Maybe Text)
    , _clProjection  :: !(Maybe ChromeosdevicesList'Projection)
...
clOrderBy :: Lens' ChromeosdevicesList' (Maybe ChromeosdevicesList'OrderBy)
clOrderBy
...
clSortOrder :: Lens' ChromeosdevicesList' (Maybe ChromeosdevicesList'SortOrder)
clSortOrder
...
clProjection :: Lens' ChromeosdevicesList' (Maybe ChromeosdevicesList'Projection)
clProjection
...
clMaxResults :: Lens' ChromeosdevicesList' (Maybe Natural)
clMaxResults
