...
-- | A resource alias for directory.chromeosdevices.patch which the
...
data ChromeosdevicesPatch' = ChromeosdevicesPatch'
    ...
    , _cpKey         :: !(Maybe Text)
    , _cpDeviceId    :: !Text
    , _cpProjection  :: !(Maybe ChromeosdevicesPatch'Projection)
...
cpProjection :: Lens' ChromeosdevicesPatch' (Maybe ChromeosdevicesPatch'Projection)
cpProjection
