...
-- | A resource alias for directory.orgunits.list which the
             ...
             QueryParam "prettyPrint" Bool :>
               QueryParam "userIp" Text :>
                 QueryParam "orgUnitPath" Text :>
                   QueryParam "key" Text :>
                     QueryParam "type" OrgunitsList'Type :>
...
data OrgunitsList' = OrgunitsList'
    ...
    , _olCustomerId  :: !Text
    , _olKey         :: !(Maybe Text)
    , _olType        :: !(Maybe OrgunitsList'Type)
...
olType :: Lens' OrgunitsList' (Maybe OrgunitsList'Type)
