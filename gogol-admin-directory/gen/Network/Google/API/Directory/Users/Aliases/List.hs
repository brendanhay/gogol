...
-- | A resource alias for directory.users.aliases.list which the
-- 'UsersAliasesList'' request conforms to.
type UsersAliasesListAPI =
     "users" :>
       Capture "userKey" Text :>
         "aliases" :>
           QueryParam "event" UsersAliasesList'Event :>
...
data UsersAliasesList' = UsersAliasesList'
    { _ualEvent       :: !(Maybe UsersAliasesList'Event)
...
ualEvent :: Lens' UsersAliasesList' (Maybe UsersAliasesList'Event)
