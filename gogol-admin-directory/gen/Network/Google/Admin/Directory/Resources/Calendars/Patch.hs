...
-- |
-- Module      : Network.Google.Admin.Directory.Resources.Calendars.Patch
...
newDirectoryResourcesCalendarsPatch ::
  ...
  CalendarResource ->
  DirectoryResourcesCalendarsPatch
newDirectoryResourcesCalendarsPatch calendarResourceId customer payload =
  DirectoryResourcesCalendarsPatch
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs DirectoryResourcesCalendarsPatch =
      CalendarResource
  type
  ...
  requestClient DirectoryResourcesCalendarsPatch {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy DirectoryResourcesCalendarsPatchResource
          )
          Core.mempty
