...
import           Network.Google.API.EmailMigration.Mail.Insert
...
type AdminEmailMigration = MailInsertAPI

adminEmailMigration :: Proxy AdminEmailMigration
adminEmailMigration = Proxy
