...
type AdSenseHost =
     AdclientsAPI :<|>
       AccountsAPI :<|>
         ReportsAPI :<|>
           UrlchannelsAPI :<|>
             CustomchannelsAPI :<|> AssociationsessionsAPI
...
type AdclientsAPI = AdclientsGet :<|> AdclientsList
...
type AccountsAPI =
     ReportsAPI :<|> AdunitsAPI :<|> AdclientsAPI
...
type AdunitsAPI =
     AdunitsList :<|>
       AdunitsPatch :<|>
         AdunitsGet :<|>
           AdunitsGetAdCode :<|>
             AdunitsDelete :<|> AdunitsUpdate :<|> AdunitsInsert
...
type UrlchannelsAPI =
     UrlchannelsList :<|>
       UrlchannelsDelete :<|> UrlchannelsInsert
...
type CustomchannelsAPI =
     CustomchannelsList :<|>
       CustomchannelsPatch :<|>
         CustomchannelsGet :<|>
           CustomchannelsDelete :<|>
             CustomchannelsUpdate :<|> CustomchannelsInsert
