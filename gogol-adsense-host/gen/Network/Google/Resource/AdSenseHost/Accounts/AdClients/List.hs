...
-- | A resource alias for @AdsensehostAccountsAdClientsList@ method which the
...
-- token.
aaclKey :: Lens' AccountsAdClientsList' (Maybe AuthKey)
...
instance GoogleRequest AccountsAdClientsList' where
        ...
        requestWith rq AccountsAdClientsList'{..}
