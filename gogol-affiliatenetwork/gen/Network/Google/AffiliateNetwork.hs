...
-- |
-- Module      : Network.Google.AffiliateNetwork
...
type AffiliateNetwork =
     CcOffersAPI :<|>
       AdvertisersAPI :<|>
         EventsAPI :<|>
           PublishersAPI :<|> LinksAPI :<|> ReportsAPI
...
type AdvertisersAPI =
     AdvertisersGet :<|> AdvertisersList
...
type LinksAPI =
     LinksList :<|> LinksGet :<|> LinksInsert
