...
-- | A resource alias for gan.ccOffers.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "key" Text :>
                   QueryParam "advertiser" Text :>
                     QueryParam "projection" CcOffersList'Projection :>
...
data CcOffersList' = CcOffersList'
    ...
    , _colProjection  :: !(Maybe CcOffersList'Projection)
...
colProjection :: Lens' CcOffersList' (Maybe CcOffersList'Projection)
colProjection
  = lens _colProjection
