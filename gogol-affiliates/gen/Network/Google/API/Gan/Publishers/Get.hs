...
-- | A resource alias for gan.publishers.get which the
-- 'PublishersGet'' request conforms to.
type PublishersGetAPI =
     Capture "role" PublishersGet'Role :>
       Capture "roleId" Text :>
         "publisher" :>
...
-- \'publishers\'.
pgRole :: Lens' PublishersGet' PublishersGet'Role
