...
-- | A resource alias for gan.publishers.list which the
-- 'PublishersList'' request conforms to.
type PublishersListAPI =
     Capture "role" PublishersList'Role :>
       Capture "roleId" Text :>
         "publishers" :>
...
data PublishersList' = PublishersList'
    ...
    , _plRelationshipStatus :: !(Maybe PublishersList'RelationshipStatus)
    , _plMinSevenDayEpc     :: !(Maybe Double)
    , _plRoleId             :: !Text
    , _plMinNinetyDayEpc    :: !(Maybe Double)
    , _plRole               :: !PublishersList'Role
    , _plKey                :: !(Maybe Text)
    , _plMinPayoutRank      :: !(Maybe Nat)
...
plRelationshipStatus :: Lens' PublishersList' (Maybe PublishersList'RelationshipStatus)
plRelationshipStatus
...
-- \'publishers\'.
plRole :: Lens' PublishersList' PublishersList'Role
...
plMinPayoutRank :: Lens' PublishersList' (Maybe Natural)
plMinPayoutRank
