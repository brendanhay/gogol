...
-- | A resource alias for analytics.management.profileFilterLinks.delete which the
...
mpfldAlt :: Lens' ManagementProfileFilterLinksDelete' Alt
...
instance GoogleRequest
        ...
        requestWithRoute r u
          ManagementProfileFilterLinksDelete'{..}
          = go _mpfldQuotaUser (Just _mpfldPrettyPrint)
              _mpfldWebPropertyId
              _mpfldUserIp
              _mpfldProfileId
              _mpfldAccountId
