...
-- |
-- Module      : Network.Google.Analytics.Management.CustomDimensions.Update
...
newAnalyticsManagementCustomDimensionsUpdate ::
  ...
  Core.Text ->
  AnalyticsManagementCustomDimensionsUpdate
newAnalyticsManagementCustomDimensionsUpdate accountId customDimensionId payload webPropertyId =
  AnalyticsManagementCustomDimensionsUpdate
    { accountId = accountId,
...
instance
  ...
  where
  type
    Rs AnalyticsManagementCustomDimensionsUpdate =
      CustomDimension
  type
