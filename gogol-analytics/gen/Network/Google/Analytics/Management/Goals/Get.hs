...
-- |
-- Module      : Network.Google.Analytics.Management.Goals.Get
...
newAnalyticsManagementGoalsGet ::
  ...
  Core.Text ->
  AnalyticsManagementGoalsGet
newAnalyticsManagementGoalsGet accountId goalId profileId webPropertyId =
  AnalyticsManagementGoalsGet
    { accountId = accountId,
      goalId = goalId,
      profileId = profileId,
  ...
  requestClient AnalyticsManagementGoalsGet {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy AnalyticsManagementGoalsGetResource
          )
          Core.mempty
