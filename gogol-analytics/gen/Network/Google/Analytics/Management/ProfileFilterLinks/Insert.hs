...
-- |
-- Module      : Network.Google.Analytics.Management.ProfileFilterLinks.Insert
...
newAnalyticsManagementProfileFilterLinksInsert ::
  ...
  Core.Text ->
  AnalyticsManagementProfileFilterLinksInsert
newAnalyticsManagementProfileFilterLinksInsert accountId payload profileId webPropertyId =
  AnalyticsManagementProfileFilterLinksInsert
    { accountId = accountId,
      payload = payload,
      profileId = profileId,
