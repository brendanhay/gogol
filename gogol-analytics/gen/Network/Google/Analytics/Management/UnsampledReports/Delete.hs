...
-- |
-- Module      : Network.Google.Analytics.Management.UnsampledReports.Delete
...
newAnalyticsManagementUnsampledReportsDelete ::
  ...
  Core.Text ->
  AnalyticsManagementUnsampledReportsDelete
newAnalyticsManagementUnsampledReportsDelete accountId profileId unsampledReportId webPropertyId =
  AnalyticsManagementUnsampledReportsDelete
    { accountId = accountId,
      profileId = profileId,
...
instance
  ...
  where
  type
    Rs AnalyticsManagementUnsampledReportsDelete =
      ()
  type
