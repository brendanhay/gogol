...
type ManagementAccountUserLinksUpdateAPI =
     "management" :>
       "accounts" :>
...
mauluAlt :: Lens' ManagementAccountUserLinksUpdate' Text
...
instance GoogleRequest
        ...
        requestWithRoute r u
          ManagementAccountUserLinksUpdate{..}
          = go _mauluQuotaUser _mauluPrettyPrint _mauluUserIp
              _mauluAccountId
              _mauluKey
              _mauluLinkId
              _mauluOauthToken
          ...
          where go
                  = clientWithRoute
                      (Proxy :: Proxy ManagementAccountUserLinksUpdateAPI)
                      r
                      u
