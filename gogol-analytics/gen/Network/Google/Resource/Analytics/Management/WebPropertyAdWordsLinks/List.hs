...
-- token.
mwpawllKey :: Lens' ManagementWebPropertyAdWordsLinksList' (Maybe AuthKey)
mwpawllKey
...
instance GoogleAuth
        ...
        _AuthKey = mwpawllKey . _Just
        _AuthToken = mwpawllOAuthToken . _Just
