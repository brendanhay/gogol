             ...
             GrouplicensesAPI :<|>
               EntitlementsAPI :<|>
                 PermissionsAPI :<|>
                   ProductsAPI :<|>
                     DevicesAPI :<|>
                       GrouplicenseusersAPI :<|> CollectionviewersAPI

type CollectionviewersAPI =
     CollectionviewersPatch :<|>
       CollectionviewersGet :<|>
         CollectionviewersDelete :<|>
           CollectionviewersUpdate :<|> CollectionviewersList
...
type UsersAPI =
     UsersGenerateToken :<|>
       UsersGet :<|>
         UsersSetAvailableProductSet :<|>
           UsersRevokeToken :<|>
             UsersGetAvailableProductSet :<|> UsersList
...
type InstallsAPI =
     InstallsPatch :<|>
       InstallsGet :<|>
         InstallsDelete :<|> InstallsUpdate :<|> InstallsList
...
type CollectionsAPI =
     CollectionsList :<|>
       CollectionsPatch :<|>
         CollectionsGet :<|>
           CollectionsDelete :<|>
             CollectionsUpdate :<|> CollectionsInsert
       ...
       EnterprisesUnenroll :<|>
         EnterprisesSetAccount :<|>
           EnterprisesEnroll :<|>
             EnterprisesGet :<|>
               EnterprisesSendTestPushNotification :<|>
                 EnterprisesDelete :<|> EnterprisesInsert
...
type GrouplicensesAPI =
     GrouplicensesGet :<|> GrouplicensesList
...
type EntitlementsAPI =
     EntitlementsPatch :<|>
       EntitlementsGet :<|>
         EntitlementsDelete :<|>
           EntitlementsUpdate :<|> EntitlementsList
...
type DevicesAPI =
     DevicesSetState :<|>
       DevicesGet :<|> DevicesGetState :<|> DevicesList
