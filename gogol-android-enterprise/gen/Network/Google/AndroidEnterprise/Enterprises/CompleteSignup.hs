...
-- |
-- Module      : Network.Google.AndroidEnterprise.Enterprises.CompleteSignup
...
type AndroidEnterpriseEnterprisesCompleteSignupResource =
  "androidenterprise"
    ...
    Core.:> Core.QueryParam "completionToken" Core.Text
...
instance
  ...
  where
  type
    Rs AndroidEnterpriseEnterprisesCompleteSignup =
      Enterprise
  type
    Scopes
      AndroidEnterpriseEnterprisesCompleteSignup =
