...
-- |
-- Module      : Network.Google.AndroidEnterprise.Entitlements.Get
...
newAndroidEnterpriseEntitlementsGet ::
  ...
  Core.Text ->
  AndroidEnterpriseEntitlementsGet
newAndroidEnterpriseEntitlementsGet enterpriseId entitlementId userId =
  AndroidEnterpriseEntitlementsGet
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs AndroidEnterpriseEntitlementsGet =
      Entitlement
  type
  ...
  requestClient AndroidEnterpriseEntitlementsGet {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy AndroidEnterpriseEntitlementsGetResource
          )
          Core.mempty
