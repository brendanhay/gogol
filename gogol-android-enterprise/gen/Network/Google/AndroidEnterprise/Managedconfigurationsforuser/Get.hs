...
-- |
-- Module      : Network.Google.AndroidEnterprise.Managedconfigurationsforuser.Get
...
newAndroidEnterpriseManagedconfigurationsforuserGet ::
  ...
  Core.Text ->
  AndroidEnterpriseManagedconfigurationsforuserGet
newAndroidEnterpriseManagedconfigurationsforuserGet enterpriseId managedConfigurationForUserId userId =
  AndroidEnterpriseManagedconfigurationsforuserGet
    { xgafv = Core.Nothing,
