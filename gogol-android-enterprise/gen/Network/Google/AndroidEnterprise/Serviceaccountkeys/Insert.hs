...
-- |
-- Module      : Network.Google.AndroidEnterprise.Serviceaccountkeys.Insert
...
type AndroidEnterpriseServiceaccountkeysInsertResource =
  "androidenterprise"
    ...
    Core.:> Core.ReqBody '[Core.JSON] ServiceAccountKey
...
instance
  ...
  where
  type
    Rs AndroidEnterpriseServiceaccountkeysInsert =
      ServiceAccountKey
  type
