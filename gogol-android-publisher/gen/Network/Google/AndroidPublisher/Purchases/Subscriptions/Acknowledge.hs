...
-- |
-- Module      : Network.Google.AndroidPublisher.Purchases.Subscriptions.Acknowledge
...
newAndroidPublisherPurchasesSubscriptionsAcknowledge ::
  ...
  Core.Text ->
  AndroidPublisherPurchasesSubscriptionsAcknowledge
newAndroidPublisherPurchasesSubscriptionsAcknowledge packageName payload subscriptionId token =
  AndroidPublisherPurchasesSubscriptionsAcknowledge
    { xgafv = Core.Nothing,
