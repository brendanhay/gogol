...
-- |
-- Module      : Network.Google.AndroidPublisher.Systemapks.Variants.Get
...
newAndroidPublisherSystemapksVariantsGet ::
  ...
  Core.Int64 ->
  AndroidPublisherSystemapksVariantsGet
newAndroidPublisherSystemapksVariantsGet packageName variantId versionCode =
  AndroidPublisherSystemapksVariantsGet
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs AndroidPublisherSystemapksVariantsGet =
      Variant
  type
