...
editsAPKListingsUpdate'
    ...
    -> Text -- ^ 'editId'
    -> EditsAPKListingsUpdate'
editsAPKListingsUpdate' pEapkluPackageName_ pEapkluAPKVersionCode_ pEapkluAPKListing_ pEapkluLanguage_ pEapkluEditId_ =
    EditsAPKListingsUpdate'
    ...
    , _eapkluAPKListing = pEapkluAPKListing_
...
eapkluAPKListing :: Lens' EditsAPKListingsUpdate' APKListing
eapkluAPKListing
  = lens _eapkluAPKListing
      (\ s a -> s{_eapkluAPKListing = a})
...
instance GoogleRequest EditsAPKListingsUpdate' where
        ...
        requestWithRoute r u EditsAPKListingsUpdate'{..}
          = go _eapkluQuotaUser (Just _eapkluPrettyPrint)
              _eapkluPackageName
