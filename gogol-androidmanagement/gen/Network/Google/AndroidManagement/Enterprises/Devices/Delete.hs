...
-- |
-- Module      : Network.Google.AndroidManagement.Enterprises.Devices.Delete
...
type AndroidManagementEnterprisesDevicesDeleteResource =
  "v1"
    ...
    Core.:> Core.QueryParam "wipeReasonMessage" Core.Text
...
instance
  ...
  where
  type
    Rs AndroidManagementEnterprisesDevicesDelete =
      Empty
  type
    Scopes AndroidManagementEnterprisesDevicesDelete =
