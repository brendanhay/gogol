...
-- | A resource alias for appsactivity.activities.list which the
...
data ActivitiesList' = ActivitiesList'
    ...
    , _alGroupingStrategy :: !ActivitiesList'GroupingStrategy
    , _alUserId           :: !Text
    , _alKey              :: !(Maybe Text)
...
alGroupingStrategy :: Lens' ActivitiesList' ActivitiesList'GroupingStrategy
alGroupingStrategy
