...
-- | A resource alias for calendar.calendarList.list which the
...
data CalendarListList' = CalendarListList'
    ...
    , _cllMinAccessRole :: !(Maybe CalendarListList'MinAccessRole)
...
cllMinAccessRole :: Lens' CalendarListList' (Maybe CalendarListList'MinAccessRole)
cllMinAccessRole
...
-- entries. Optional.
cllMaxResults :: Lens' CalendarListList' (Maybe Natural)
cllMaxResults
  = lens _cllMaxResults
