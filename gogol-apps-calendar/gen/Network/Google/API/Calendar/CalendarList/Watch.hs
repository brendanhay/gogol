...
-- | A resource alias for calendar.calendarList.watch which the
...
data CalendarListWatch' = CalendarListWatch'
    ...
    , _clwMinAccessRole :: !(Maybe CalendarListWatch'MinAccessRole)
...
clwMinAccessRole :: Lens' CalendarListWatch' (Maybe CalendarListWatch'MinAccessRole)
clwMinAccessRole
...
-- entries. Optional.
clwMaxResults :: Lens' CalendarListWatch' (Maybe Natural)
clwMaxResults
  = lens _clwMaxResults
