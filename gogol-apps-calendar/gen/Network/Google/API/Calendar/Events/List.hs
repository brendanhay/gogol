...
-- | A resource alias for calendar.events.list which the
             ...
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "timeMin" UTCTime :>
                   QueryParam "orderBy" EventsList'OrderBy :>
...
data EventsList' = EventsList'
    ...
    , _elOrderBy                 :: !(Maybe EventsList'OrderBy)
...
elOrderBy :: Lens' EventsList' (Maybe EventsList'OrderBy)
elOrderBy
...
-- returned. Optional.
elMaxAttendees :: Lens' EventsList' (Maybe Natural)
elMaxAttendees
...
-- Optional.
elMaxResults :: Lens' EventsList' (Maybe Natural)
elMaxResults
