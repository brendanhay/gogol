...
-- | A resource alias for calendar.events.watch which the
               ...
               QueryParam "quotaUser" Text :>
                 QueryParam "prettyPrint" Bool :>
                   QueryParam "timeMin" UTCTime :>
                     QueryParam "orderBy" EventsWatch'OrderBy :>
...
data EventsWatch' = EventsWatch'
    ...
    , _ewOrderBy                 :: !(Maybe EventsWatch'OrderBy)
...
ewOrderBy :: Lens' EventsWatch' (Maybe EventsWatch'OrderBy)
ewOrderBy
...
-- returned. Optional.
ewMaxAttendees :: Lens' EventsWatch' (Maybe Natural)
ewMaxAttendees
...
-- Optional.
ewMaxResults :: Lens' EventsWatch' (Maybe Natural)
ewMaxResults
