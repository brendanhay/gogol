...
-- | A resource alias for licensing.licenseAssignments.listForProductAndSku which the
...
lalfpasMaxResults :: Lens' LicenseAssignmentsListForProductAndSku' Natural
lalfpasMaxResults
