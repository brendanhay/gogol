...
-- | A resource alias for bigquery.jobs.list which the
           ...
           QueryParam "quotaUser" Text :>
             QueryParam "prettyPrint" Bool :>
               QueryParam "userIp" Text :>
                 QueryParam "key" Text :>
                   QueryParam "stateFilter" JobsList'StateFilter :>
                     QueryParam "projection" JobsList'Projection :>
...
data JobsList' = JobsList'
    ...
    , _jlKey         :: !(Maybe Text)
    , _jlStateFilter :: !(Maybe JobsList'StateFilter)
    , _jlProjection  :: !(Maybe JobsList'Projection)
...
jlStateFilter :: Lens' JobsList' (Maybe JobsList'StateFilter)
jlStateFilter
  = lens _jlStateFilter
      (\ s a -> s{_jlStateFilter = a})

-- | Restrict information returned to a set of selected fields
jlProjection :: Lens' JobsList' (Maybe JobsList'Projection)
jlProjection
