...
-- |
-- Module      : Network.Google.BigQueryDataTransfer.Projects.Locations.TransferConfigs.Runs.List
...
newBigQueryDataTransferProjectsLocationsTransferConfigsRunsList ::
  ...
  Core.Text ->
  BigQueryDataTransferProjectsLocationsTransferConfigsRunsList
newBigQueryDataTransferProjectsLocationsTransferConfigsRunsList parent =
  BigQueryDataTransferProjectsLocationsTransferConfigsRunsList
    { xgafv = Core.Nothing,
