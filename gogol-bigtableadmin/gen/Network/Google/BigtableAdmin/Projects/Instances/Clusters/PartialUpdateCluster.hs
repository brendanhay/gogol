...
-- |
-- Module      : Network.Google.BigtableAdmin.Projects.Instances.Clusters.PartialUpdateCluster
...
newBigtableAdminProjectsInstancesClustersPartialUpdateCluster ::
  ...
  Cluster ->
  BigtableAdminProjectsInstancesClustersPartialUpdateCluster
newBigtableAdminProjectsInstancesClustersPartialUpdateCluster name payload =
  BigtableAdminProjectsInstancesClustersPartialUpdateCluster
    { xgafv = Core.Nothing,
