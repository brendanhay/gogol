...
-- | A resource alias for cloudbilling.billingAccounts.projects.list which the
...
-- token.
baplKey :: Lens' BillingAccountsProjectsList' (Maybe Text)
...
baplOauthToken :: Lens' BillingAccountsProjectsList' (Maybe Text)
baplOauthToken
...
baplAlt :: Lens' BillingAccountsProjectsList' Text
baplAlt = lens _baplAlt (\ s a -> s{_baplAlt = a})
