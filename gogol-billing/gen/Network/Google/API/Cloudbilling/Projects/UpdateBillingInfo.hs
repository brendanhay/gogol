...
-- | A resource alias for cloudbilling.projects.updateBillingInfo which the
...
-- token.
pubiKey :: Lens' ProjectsUpdateBillingInfo' (Maybe Text)
...
pubiOauthToken :: Lens' ProjectsUpdateBillingInfo' (Maybe Text)
pubiOauthToken
...
pubiAlt :: Lens' ProjectsUpdateBillingInfo' Text
pubiAlt = lens _pubiAlt (\ s a -> s{_pubiAlt = a})
