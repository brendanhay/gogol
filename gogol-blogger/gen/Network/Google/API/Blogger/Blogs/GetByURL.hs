...
-- | A resource alias for blogger.blogs.getByUrl which the
         ...
         QueryParam "quotaUser" Text :>
           QueryParam "prettyPrint" Bool :>
             QueryParam "userIp" Text :>
               QueryParam "url" Text :>
                 QueryParam "key" Text :>
                   QueryParam "view" BlogsGetByURL'View :>
...
data BlogsGetByURL' = BlogsGetByURL'
    ...
    , _bgbuUrl         :: !Text
    , _bgbuKey         :: !(Maybe Text)
    , _bgbuView        :: !(Maybe BlogsGetByURL'View)
...
-- elevated access.
bgbuView :: Lens' BlogsGetByURL' (Maybe BlogsGetByURL'View)
