...
-- | A resource alias for blogger.comments.list which the
     ...
     "blogs" :>
       Capture "blogId" Text :>
         "posts" :>
           Capture "postId" Text :>
             "comments" :>
               QueryParam "status" CommentsList'Status :>
                         ...
                         QueryParam "startDate" UTCTime :>
                           QueryParam "key" Text :>
                             QueryParam "fetchBodies" Bool :>
                               QueryParam "view" CommentsList'View :>
...
data CommentsList' = CommentsList'
    { _clStatus      :: !(Maybe CommentsList'Status)
    ...
    , _clView        :: !(Maybe CommentsList'View)
    , _clPostId      :: !Text
...
clStatus :: Lens' CommentsList' (Maybe CommentsList'Status)
...
clView :: Lens' CommentsList' (Maybe CommentsList'View)
