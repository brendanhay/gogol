...
-- | A resource alias for blogger.comments.listByBlog which the
-- 'CommentsListByBlog'' request conforms to.
type CommentsListByBlogAPI =
     "blogs" :>
       Capture "blogId" Text :>
         "comments" :>
           QueryParam "status" CommentsListByBlog'Status :>
...
data CommentsListByBlog' = CommentsListByBlog'
    { _clbbStatus      :: !(Maybe CommentsListByBlog'Status)
...
clbbStatus :: Lens' CommentsListByBlog' (Maybe CommentsListByBlog'Status)
clbbStatus
