...
-- | A resource alias for blogger.pageViews.get which the
           ...
           QueryParam "quotaUser" Text :>
             QueryParam "prettyPrint" Bool :>
               QueryParam "userIp" Text :>
                 QueryParam "key" Text :>
                   QueryParam "range" PageViewsGet'Range :>
...
data PageViewsGet' = PageViewsGet'
    ...
    , _pvgBlogId      :: !Text
    , _pvgKey         :: !(Maybe Text)
    , _pvgRange       :: !(Maybe PageViewsGet'Range)
...
pvgRange :: Lens' PageViewsGet' (Maybe PageViewsGet'Range)
