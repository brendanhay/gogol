...
-- | A resource alias for blogger.pages.list which the
-- 'PagesList'' request conforms to.
type PagesListAPI =
     "blogs" :>
       Capture "blogId" Text :>
         "pages" :>
           QueryParam "status" PagesList'Status :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "userIp" Text :>
                   QueryParam "key" Text :>
                     QueryParam "fetchBodies" Bool :>
                       QueryParam "view" PagesList'View :>
...
data PagesList' = PagesList'
    { _plStatus      :: !(Maybe PagesList'Status)
...
plStatus :: Lens' PagesList' (Maybe PagesList'Status)
...
plView :: Lens' PagesList' (Maybe PagesList'View)
