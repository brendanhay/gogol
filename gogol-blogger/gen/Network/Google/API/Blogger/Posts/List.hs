...
-- | A resource alias for blogger.posts.list which the
-- 'PostsList'' request conforms to.
type PostsListAPI =
     "blogs" :>
       Capture "blogId" Text :>
         "posts" :>
           QueryParam "status" PostsList'Status :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "orderBy" PostsList'OrderBy :>
                         ...
                         QueryParam "startDate" UTCTime :>
                           QueryParam "key" Text :>
                             QueryParam "fetchBodies" Bool :>
                               QueryParam "view" PostsList'View :>
...
data PostsList' = PostsList'
    { _pllStatus      :: !(Maybe PostsList'Status)
    , _pllQuotaUser   :: !(Maybe Text)
    , _pllPrettyPrint :: !Bool
    , _pllOrderBy     :: !PostsList'OrderBy
...
pllStatus :: Lens' PostsList' (Maybe PostsList'Status)
pllStatus
...
-- | Sort search results
pllOrderBy :: Lens' PostsList' PostsList'OrderBy
pllOrderBy
...
pllView :: Lens' PostsList' (Maybe PostsList'View)
