...
-- | A resource alias for blogger.posts.search which the
           ...
           "search" :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "orderBy" PostsSearch'OrderBy :>
...
data PostsSearch' = PostsSearch'
    ...
    , _psPrettyPrint :: !Bool
    , _psOrderBy     :: !PostsSearch'OrderBy
...
-- | Sort search results
psOrderBy :: Lens' PostsSearch' PostsSearch'OrderBy
psOrderBy
