...
-- | A resource alias for books.myconfig.syncVolumeLicenses which the
...
data MyconfigSyncVolumeLicenses' = MyconfigSyncVolumeLicenses'
    ...
    , _msvlKey           :: !(Maybe Text)
    , _msvlFeatures      :: !(Maybe MyconfigSyncVolumeLicenses'Features)
    , _msvlSource        :: !Text
...
msvlFeatures :: Lens' MyconfigSyncVolumeLicenses' (Maybe MyconfigSyncVolumeLicenses'Features)
msvlFeatures
