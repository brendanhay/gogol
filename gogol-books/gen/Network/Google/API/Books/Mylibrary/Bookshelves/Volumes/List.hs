...
-- | A resource alias for books.mylibrary.bookshelves.volumes.list which the
...
data MylibraryBookshelvesVolumesList' = MylibraryBookshelvesVolumesList'
    ...
    , _mbvlProjection    :: !(Maybe MylibraryBookshelvesVolumesList'Projection)
...
mbvlProjection :: Lens' MylibraryBookshelvesVolumesList' (Maybe MylibraryBookshelvesVolumesList'Projection)
mbvlProjection
