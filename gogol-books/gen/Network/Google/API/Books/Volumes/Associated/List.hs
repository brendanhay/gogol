...
-- | A resource alias for books.volumes.associated.list which the
...
data VolumesAssociatedList' = VolumesAssociatedList'
    ...
    , _valMaxAllowedMaturityRating :: !(Maybe VolumesAssociatedList'MaxAllowedMaturityRating)
    , _valKey                      :: !(Maybe Text)
    , _valVolumeId                 :: !Text
    ...
    , _valAlt                      :: !Alt
    , _valAssociation              :: !(Maybe VolumesAssociatedList'Association)
...
valMaxAllowedMaturityRating :: Lens' VolumesAssociatedList' (Maybe VolumesAssociatedList'MaxAllowedMaturityRating)
valMaxAllowedMaturityRating
...
-- | Association type.
valAssociation :: Lens' VolumesAssociatedList' (Maybe VolumesAssociatedList'Association)
valAssociation
