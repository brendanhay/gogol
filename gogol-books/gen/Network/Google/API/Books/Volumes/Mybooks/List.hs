...
-- | A resource alias for books.volumes.mybooks.list which the
-- 'VolumesMybooksList'' request conforms to.
type VolumesMybooksListAPI =
     "volumes" :>
       "mybooks" :>
         QueryParam "processingState"
           VolumesMybooksList'ProcessingState
           :>
           QueryParam "quotaUser" Text :>
             QueryParam "acquireMethod"
...
data VolumesMybooksList' = VolumesMybooksList'
    { _vmlProcessingState :: !(Maybe VolumesMybooksList'ProcessingState)
    , _vmlQuotaUser       :: !(Maybe Text)
    , _vmlAcquireMethod   :: !(Maybe VolumesMybooksList'AcquireMethod)
...
vmlProcessingState :: Lens' VolumesMybooksList' (Maybe VolumesMybooksList'ProcessingState)
vmlProcessingState
...
vmlAcquireMethod :: Lens' VolumesMybooksList' (Maybe VolumesMybooksList'AcquireMethod)
vmlAcquireMethod
