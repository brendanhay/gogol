...
-- | A resource alias for books.volumes.recommended.list which the
...
data VolumesRecommendedList' = VolumesRecommendedList'
    ...
    , _vrlMaxAllowedMaturityRating :: !(Maybe VolumesRecommendedList'MaxAllowedMaturityRating)
    , _vrlKey                      :: !(Maybe Text)
...
vrlMaxAllowedMaturityRating :: Lens' VolumesRecommendedList' (Maybe VolumesRecommendedList'MaxAllowedMaturityRating)
vrlMaxAllowedMaturityRating
