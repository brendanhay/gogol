...
-- | A resource alias for books.volumes.recommended.rate which the
       ...
       "recommended" :>
         "rate" :>
           QueryParam "quotaUser" Text :>
             QueryParam "rating" VolumesRecommendedRate'Rating :>
...
data VolumesRecommendedRate' = VolumesRecommendedRate'
    ...
    , _vrrRating      :: !VolumesRecommendedRate'Rating
...
-- * 'vrrAlt'
volumesRecommendedRate'
    :: VolumesRecommendedRate'Rating -- ^ 'rating'
    -> Text -- ^ 'volumeId'
    -> VolumesRecommendedRate'
...
vrrRating :: Lens' VolumesRecommendedRate' VolumesRecommendedRate'Rating
vrrRating
