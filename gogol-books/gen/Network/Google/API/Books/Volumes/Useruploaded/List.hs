...
-- | A resource alias for books.volumes.useruploaded.list which the
...
data VolumesUseruploadedList' = VolumesUseruploadedList'
    { _vulProcessingState :: !(Maybe VolumesUseruploadedList'ProcessingState)
...
vulProcessingState :: Lens' VolumesUseruploadedList' (Maybe VolumesUseruploadedList'ProcessingState)
vulProcessingState
