...
-- |
-- Module      : Network.Google.Books.Cloudloading.UpdateBook
...
type BooksCloudloadingUpdateBookResource =
  "books"
    ...
    Core.:> Core.ReqBody '[Core.JSON] BooksCloudloadingResource
    Core.:> Core.Post '[Core.JSON] BooksCloudloadingResource
...
instance
  ...
  where
  type
    Rs BooksCloudloadingUpdateBook =
      BooksCloudloadingResource
  type
