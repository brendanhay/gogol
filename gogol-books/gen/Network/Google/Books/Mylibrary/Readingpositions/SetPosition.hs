...
-- |
-- Module      : Network.Google.Books.Mylibrary.Readingpositions.SetPosition
...
type BooksMylibraryReadingpositionsSetPositionResource =
  "books"
    ...
    Core.:> "setPosition"
    Core.:> Core.QueryParam "position" Core.Text
    Core.:> Core.QueryParam "timestamp" Core.Text
    ...
    Core.:> Core.QueryParam "deviceCookie" Core.Text
...
instance
  ...
  where
  type
    Rs BooksMylibraryReadingpositionsSetPosition =
      Empty
  type
