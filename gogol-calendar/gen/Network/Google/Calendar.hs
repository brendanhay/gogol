...
-- |
-- Module      : Network.Google.Calendar
     ...
     ChannelsAPI :<|>
       CalendarsAPI :<|>
         EventsAPI :<|>
           CalendarListAPI :<|>
             AclAPI :<|>
               ColorsAPI :<|> FreebusyAPI :<|> SettingsAPI

type SettingsAPI =
     SettingsGet :<|> SettingsWatch :<|> SettingsList
...
type CalendarsAPI =
     CalendarsPatch :<|>
       CalendarsGet :<|>
         CalendarsClear :<|>
           CalendarsDelete :<|>
             CalendarsUpdate :<|> CalendarsInsert
           ...
           EventsGet :<|>
             EventsInstances :<|>
               EventsImport :<|>
                 EventsDelete :<|>
                   EventsUpdate :<|>
                     EventsMove :<|> EventsWatch :<|> EventsQuickAdd
     ...
     CalendarListList :<|>
       CalendarListPatch :<|>
         CalendarListGet :<|>
           CalendarListDelete :<|>
             CalendarListUpdate :<|>
               CalendarListWatch :<|> CalendarListInsert
...
type AclAPI =
     AclList :<|>
       AclPatch :<|>
         AclGet :<|>
           AclDelete :<|> AclUpdate :<|> AclWatch :<|> AclInsert
