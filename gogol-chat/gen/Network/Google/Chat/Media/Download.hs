...
-- |
-- Module      : Network.Google.Chat.Media.Download
...
instance
  ...
  where
  type
    Rs (Core.MediaDownload ChatMediaDownload) =
      Core.Stream
  type
    Scopes (Core.MediaDownload ChatMediaDownload) =
