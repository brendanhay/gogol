...
-- | A resource alias for civicinfo.representatives.representativeInfoByDivision which the
...
data RepresentativesRepresentativeInfoByDivision' = RepresentativesRepresentativeInfoByDivision'
    ...
    , _rribdRoles       :: !(Maybe RepresentativesRepresentativeInfoByDivision'Roles)
    , _rribdPrettyPrint :: !Bool
    , _rribdUserIp      :: !(Maybe Text)
    , _rribdKey         :: !(Maybe Text)
    , _rribdRecursive   :: !(Maybe Bool)
    , _rribdOcdId       :: !Text
    , _rribdLevels      :: !(Maybe RepresentativesRepresentativeInfoByDivision'Levels)
...
rribdRoles :: Lens' RepresentativesRepresentativeInfoByDivision' (Maybe RepresentativesRepresentativeInfoByDivision'Roles)
rribdRoles
...
rribdLevels :: Lens' RepresentativesRepresentativeInfoByDivision' (Maybe RepresentativesRepresentativeInfoByDivision'Levels)
rribdLevels
