...
-- |
-- Module      : Network.Google.Classroom.Courses.Students.Create
...
type ClassroomCoursesStudentsCreateResource =
  "v1"
    ...
    Core.:> Core.QueryParam "enrollmentCode" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.ReqBody '[Core.JSON] Student
    Core.:> Core.Post '[Core.JSON] Student
...
instance
  ...
  type
    Scopes ClassroomCoursesStudentsCreate =
