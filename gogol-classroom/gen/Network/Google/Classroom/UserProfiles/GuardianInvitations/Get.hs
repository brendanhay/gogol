...
-- |
-- Module      : Network.Google.Classroom.UserProfiles.GuardianInvitations.Get
...
type ClassroomUserProfilesGuardianInvitationsGetResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] GuardianInvitation
...
instance
  ...
  where
  type
    Rs ClassroomUserProfilesGuardianInvitationsGet =
      GuardianInvitation
  type
    Scopes
      ClassroomUserProfilesGuardianInvitationsGet =
