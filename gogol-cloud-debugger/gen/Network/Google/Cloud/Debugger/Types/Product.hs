...
-- |
-- Module      : Network.Google.Cloud.Debugger.Types.Product
...
--
module Network.Google.Cloud.Debugger.Types.Product where

import           Network.Google.Cloud.Debugger.Types.Sum
...
data GerritSourceContext = GerritSourceContext
    { _gGerritProject :: !(Maybe Text)
    , _gAliasName     :: !(Maybe Text)
    , _gRevisionId    :: !(Maybe Text)
    , _gHostUri       :: !(Maybe Text)
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
-- hostURI\/project.
gGerritProject :: Lens' GerritSourceContext (Maybe Text)
gGerritProject
  = lens _gGerritProject
      (\ s a -> s{_gGerritProject = a})

-- | The name of an alias (branch, tag, etc.).
gAliasName :: Lens' GerritSourceContext (Maybe Text)
gAliasName
  = lens _gAliasName (\ s a -> s{_gAliasName = a})

-- | A revision (commit) ID.
gRevisionId :: Lens' GerritSourceContext (Maybe Text)
gRevisionId
...
-- | Git repository URL.
gscUrl :: Lens' GitSourceContext (Maybe Text)
gscUrl = lens _gscUrl (\ s a -> s{_gscUrl = a})

-- | Git commit hash. required.
gscRevisionId :: Lens' GitSourceContext (Maybe Text)
gscRevisionId
  = lens _gscRevisionId
