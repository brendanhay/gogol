...
type CloudLogging = ProjectsAPI

type ProjectsAPI =
     LogServicesAPI :<|> LogsAPI :<|> SinksAPI

type SinksAPI =
     SinksGet :<|>
       SinksCreate :<|>
         SinksDelete :<|> SinksUpdate :<|> SinksList
...
type LogServicesAPI = IndexesAPI :<|> SinksAPI
...
type LogsAPI = EntriesAPI :<|> SinksAPI
