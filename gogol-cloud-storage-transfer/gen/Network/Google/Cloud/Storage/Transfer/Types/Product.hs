...
-- |
-- Module      : Network.Google.Cloud.Storage.Transfer.Types.Product
...
--
module Network.Google.Cloud.Storage.Transfer.Types.Product where

import           Network.Google.Cloud.Storage.Transfer.Types.Sum
