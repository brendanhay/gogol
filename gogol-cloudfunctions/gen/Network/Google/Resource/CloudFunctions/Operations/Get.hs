...
-- API service.
--
-- /See:/ <https://cloud.google.com/functions Cloud Functions API Reference> for @cloudfunctions.operations.get@.
module Network.Google.Resource.CloudFunctions.Operations.Get
    (
    -- * REST Resource
...
-- | A resource alias for @cloudfunctions.operations.get@ method which the
