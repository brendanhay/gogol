...
-- |
-- Module      : Network.Google.CloudIOT.Internal.Product
    ...
    Core.object
      ( Core.catMaybes
          [ ("blocked" Core..=) Core.<$> blocked,
            ...
            ("id" Core..=) Core.<$> id,
            ("lastConfigAckTime" Core..=)
              Core.<$> lastConfigAckTime,
            ("lastConfigSendTime" Core..=)
              Core.<$> lastConfigSendTime,
            ("lastErrorStatus" Core..=) Core.<$> lastErrorStatus,
            ("lastErrorTime" Core..=) Core.<$> lastErrorTime,
            ("lastEventTime" Core..=) Core.<$> lastEventTime,
            ("lastHeartbeatTime" Core..=)
              Core.<$> lastHeartbeatTime,
...
newDevice_Metadata ::
  ...
  Device_Metadata
newDevice_Metadata addtional = Device_Metadata {addtional = addtional}
...
instance Core.ToJSON Device_Metadata where
  toJSON Device_Metadata {..} = Core.toJSON addtional
...
instance Core.ToJSON DeviceRegistry where
  toJSON DeviceRegistry {..} =
    Core.object
      ( Core.catMaybes
          [ ("credentials" Core..=) Core.<$> credentials,
            ("eventNotificationConfigs" Core..=)
              Core.<$> eventNotificationConfigs,
...
instance Core.FromJSON EventNotificationConfig where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          EventNotificationConfig
            Core.<$> (o Core..:? "pubsubTopicName")
            Core.<*> (o Core..:? "subfolderMatches")
      )
...
instance Core.ToJSON EventNotificationConfig where
  toJSON EventNotificationConfig {..} =
    Core.object
      ( Core.catMaybes
          [ ("pubsubTopicName" Core..=)
              Core.<$> pubsubTopicName,
            ("subfolderMatches" Core..=)
              Core.<$> subfolderMatches
          ]
      )
...
instance Core.FromJSON GatewayConfig where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GatewayConfig
            Core.<$> (o Core..:? "gatewayAuthMethod")
            Core.<*> (o Core..:? "gatewayType")
...
instance Core.ToJSON GatewayConfig where
  toJSON GatewayConfig {..} =
    Core.object
      ( Core.catMaybes
          [ ("gatewayAuthMethod" Core..=)
              Core.<$> gatewayAuthMethod,
            ("gatewayType" Core..=) Core.<$> gatewayType,
            ("lastAccessedGatewayId" Core..=)
              Core.<$> lastAccessedGatewayId,
            ("lastAccessedGatewayTime" Core..=)
              Core.<$> lastAccessedGatewayTime
          ]
      )
...
instance Core.ToJSON HttpConfig where
  toJSON HttpConfig {..} =
    Core.object
      ( Core.catMaybes
          [ ("httpEnabledState" Core..=)
              Core.<$> httpEnabledState
          ]
      )
...
instance Core.ToJSON ListDeviceRegistriesResponse where
  toJSON ListDeviceRegistriesResponse {..} =
    Core.object
      ( Core.catMaybes
          [ ("deviceRegistries" Core..=)
              Core.<$> deviceRegistries,
...
instance Core.ToJSON MqttConfig where
  toJSON MqttConfig {..} =
    Core.object
      ( Core.catMaybes
          [ ("mqttEnabledState" Core..=)
              Core.<$> mqttEnabledState
          ]
      )
...
instance Core.FromJSON PublicKeyCredential where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          PublicKeyCredential
            Core.<$> (o Core..:? "format") Core.<*> (o Core..:? "key")
      )
...
instance Core.FromJSON RegistryCredential where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          RegistryCredential
            Core.<$> (o Core..:? "publicKeyCertificate")
      )
