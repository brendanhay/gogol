...
-- |
-- Module      : Network.Google.CloudKMS.Projects.Locations.KeyRings.CryptoKeys.CryptoKeyVersions.AsymmetricSign
...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricSignResource =
  "v1"
    Core.:> Core.CaptureMode "name" "asymmetricSign" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] AsymmetricSignRequest
