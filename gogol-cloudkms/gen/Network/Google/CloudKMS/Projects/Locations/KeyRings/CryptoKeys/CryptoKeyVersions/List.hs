...
-- |
-- Module      : Network.Google.CloudKMS.Projects.Locations.KeyRings.CryptoKeys.CryptoKeyVersions.List
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsList ::
  ...
  Core.Text ->
  CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsList
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsList parent =
  CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsList
    { xgafv = Core.Nothing,
