...
-- |
-- Module      : Network.Google.CloudPrivateCatalogProducer.Catalogs.Products.Versions.Create
...
newCloudPrivateCatalogProducerCatalogsProductsVersionsCreate ::
  ...
  GoogleCloudPrivatecatalogproducerV1beta1Version ->
  CloudPrivateCatalogProducerCatalogsProductsVersionsCreate
newCloudPrivateCatalogProducerCatalogsProductsVersionsCreate parent payload =
  CloudPrivateCatalogProducerCatalogsProductsVersionsCreate
    { xgafv = Core.Nothing,
