...
-- |
-- Module      : Network.Google.CloudScheduler.Internal.Product
...
instance Core.ToJSON RetryConfig where
  toJSON RetryConfig {..} =
    Core.object
      ( Core.catMaybes
          [ ("maxBackoffDuration" Core..=)
              Core.<$> maxBackoffDuration,
            ("maxDoublings" Core..=) Core.<$> maxDoublings,
            ("maxRetryDuration" Core..=)
              Core.<$> maxRetryDuration,
            ("minBackoffDuration" Core..=)
              Core.<$> minBackoffDuration,
