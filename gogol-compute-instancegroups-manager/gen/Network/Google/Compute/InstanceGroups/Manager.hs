...
-- |
-- Module      : Network.Google.Compute.InstanceGroups.Manager
...
import           Network.Google.Compute.InstanceGroups.Manager.Types
...
type ComputeInstanceGroupsManager =
     ZoneOperationsAPI :<|> InstanceGroupManagersAPI
