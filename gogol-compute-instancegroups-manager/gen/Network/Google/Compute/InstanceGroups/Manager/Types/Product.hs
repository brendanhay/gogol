...
-- |
-- Module      : Network.Google.Compute.InstanceGroups.Manager.Types.Product
...
--
module Network.Google.Compute.InstanceGroups.Manager.Types.Product where

import           Network.Google.Compute.InstanceGroups.Manager.Types.Sum
