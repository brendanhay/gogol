...
-- | A resource alias for compute.instances.getSerialPortOutput which the
...
igspoPort :: Lens' InstancesGetSerialPortOutput' Natural
igspoPort
  = lens _igspoPort (\ s a -> s{_igspoPort = a}) . _Nat
