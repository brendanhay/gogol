...
-- |
-- Module      : Network.Google.Compute.BackendServices.AddSignedUrlKey
...
newComputeBackendServicesAddSignedUrlKey ::
  ...
  Core.Text ->
  ComputeBackendServicesAddSignedUrlKey
newComputeBackendServicesAddSignedUrlKey backendService payload project =
  ComputeBackendServicesAddSignedUrlKey
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeBackendServicesAddSignedUrlKey =
      Operation
  type
