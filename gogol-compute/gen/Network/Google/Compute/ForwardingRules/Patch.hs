...
-- |
-- Module      : Network.Google.Compute.ForwardingRules.Patch
...
newComputeForwardingRulesPatch ::
  ...
  Core.Text ->
  ComputeForwardingRulesPatch
newComputeForwardingRulesPatch forwardingRule payload project region =
  ComputeForwardingRulesPatch
    { xgafv = Core.Nothing,
  ...
  requestClient ComputeForwardingRulesPatch {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy ComputeForwardingRulesPatchResource
          )
          Core.mempty
