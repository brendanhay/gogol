...
-- |
-- Module      : Network.Google.Compute.GlobalNetworkEndpointGroups.AttachNetworkEndpoints
...
newComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints ::
  ...
  Core.Text ->
  ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints
newComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints networkEndpointGroup payload project =
  ComputeGlobalNetworkEndpointGroupsAttachNetworkEndpoints
    { xgafv = Core.Nothing,
