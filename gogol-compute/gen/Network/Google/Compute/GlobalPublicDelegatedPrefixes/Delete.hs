...
-- |
-- Module      : Network.Google.Compute.GlobalPublicDelegatedPrefixes.Delete
...
newComputeGlobalPublicDelegatedPrefixesDelete ::
  ...
  Core.Text ->
  ComputeGlobalPublicDelegatedPrefixesDelete
newComputeGlobalPublicDelegatedPrefixesDelete project publicDelegatedPrefix =
  ComputeGlobalPublicDelegatedPrefixesDelete
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeGlobalPublicDelegatedPrefixesDelete =
      Operation
  type
    Scopes
      ComputeGlobalPublicDelegatedPrefixesDelete =
