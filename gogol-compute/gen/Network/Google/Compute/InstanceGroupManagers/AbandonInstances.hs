...
-- |
-- Module      : Network.Google.Compute.InstanceGroupManagers.AbandonInstances
...
newComputeInstanceGroupManagersAbandonInstances ::
  ...
  Core.Text ->
  ComputeInstanceGroupManagersAbandonInstances
newComputeInstanceGroupManagersAbandonInstances instanceGroupManager payload project zone =
  ComputeInstanceGroupManagersAbandonInstances
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstanceGroupManagersAbandonInstances =
      Operation
  type
    Scopes
      ComputeInstanceGroupManagersAbandonInstances =
