...
-- |
-- Module      : Network.Google.Compute.InstanceGroupManagers.CreateInstances
...
newComputeInstanceGroupManagersCreateInstances ::
  ...
  Core.Text ->
  ComputeInstanceGroupManagersCreateInstances
newComputeInstanceGroupManagersCreateInstances instanceGroupManager payload project zone =
  ComputeInstanceGroupManagersCreateInstances
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstanceGroupManagersCreateInstances =
      Operation
  type
    Scopes
      ComputeInstanceGroupManagersCreateInstances =
