...
-- |
-- Module      : Network.Google.Compute.InstanceGroupManagers.DeleteInstances
...
newComputeInstanceGroupManagersDeleteInstances ::
  ...
  Core.Text ->
  ComputeInstanceGroupManagersDeleteInstances
newComputeInstanceGroupManagersDeleteInstances instanceGroupManager payload project zone =
  ComputeInstanceGroupManagersDeleteInstances
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstanceGroupManagersDeleteInstances =
      Operation
  type
    Scopes
      ComputeInstanceGroupManagersDeleteInstances =
