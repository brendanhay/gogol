...
-- |
-- Module      : Network.Google.Compute.InstanceGroups.RemoveInstances
...
newComputeInstanceGroupsRemoveInstances ::
  ...
  Core.Text ->
  ComputeInstanceGroupsRemoveInstances
newComputeInstanceGroupsRemoveInstances instanceGroup payload project zone =
  ComputeInstanceGroupsRemoveInstances
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstanceGroupsRemoveInstances =
      Operation
  type
