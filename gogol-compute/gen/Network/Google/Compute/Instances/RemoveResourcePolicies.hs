...
-- |
-- Module      : Network.Google.Compute.Instances.RemoveResourcePolicies
...
newComputeInstancesRemoveResourcePolicies ::
  ...
  Core.Text ->
  ComputeInstancesRemoveResourcePolicies
newComputeInstancesRemoveResourcePolicies instance' payload project zone =
  ComputeInstancesRemoveResourcePolicies
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstancesRemoveResourcePolicies =
      Operation
  type
