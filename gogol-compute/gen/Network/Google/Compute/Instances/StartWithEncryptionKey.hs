...
-- |
-- Module      : Network.Google.Compute.Instances.StartWithEncryptionKey
...
newComputeInstancesStartWithEncryptionKey ::
  ...
  Core.Text ->
  ComputeInstancesStartWithEncryptionKey
newComputeInstancesStartWithEncryptionKey instance' payload project zone =
  ComputeInstancesStartWithEncryptionKey
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstancesStartWithEncryptionKey =
      Operation
  type
