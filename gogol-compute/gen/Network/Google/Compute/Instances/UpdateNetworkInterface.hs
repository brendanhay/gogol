...
-- |
-- Module      : Network.Google.Compute.Instances.UpdateNetworkInterface
...
newComputeInstancesUpdateNetworkInterface ::
  ...
  Core.Text ->
  ComputeInstancesUpdateNetworkInterface
newComputeInstancesUpdateNetworkInterface instance' networkInterface payload project zone =
  ComputeInstancesUpdateNetworkInterface
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeInstancesUpdateNetworkInterface =
      Operation
  type
