...
-- |
-- Module      : Network.Google.Compute.NetworkEndpointGroups.AttachNetworkEndpoints
...
newComputeNetworkEndpointGroupsAttachNetworkEndpoints ::
  ...
  Core.Text ->
  ComputeNetworkEndpointGroupsAttachNetworkEndpoints
newComputeNetworkEndpointGroupsAttachNetworkEndpoints networkEndpointGroup payload project zone =
  ComputeNetworkEndpointGroupsAttachNetworkEndpoints
    { xgafv = Core.Nothing,
