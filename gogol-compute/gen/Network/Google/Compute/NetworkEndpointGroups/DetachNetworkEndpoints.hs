...
-- |
-- Module      : Network.Google.Compute.NetworkEndpointGroups.DetachNetworkEndpoints
...
newComputeNetworkEndpointGroupsDetachNetworkEndpoints ::
  ...
  Core.Text ->
  ComputeNetworkEndpointGroupsDetachNetworkEndpoints
newComputeNetworkEndpointGroupsDetachNetworkEndpoints networkEndpointGroup payload project zone =
  ComputeNetworkEndpointGroupsDetachNetworkEndpoints
    { xgafv = Core.Nothing,
