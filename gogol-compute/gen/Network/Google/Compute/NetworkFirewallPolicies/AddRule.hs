...
-- |
-- Module      : Network.Google.Compute.NetworkFirewallPolicies.AddRule
...
newComputeNetworkFirewallPoliciesAddRule ::
  ...
  Core.Text ->
  ComputeNetworkFirewallPoliciesAddRule
newComputeNetworkFirewallPoliciesAddRule firewallPolicy payload project =
  ComputeNetworkFirewallPoliciesAddRule
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeNetworkFirewallPoliciesAddRule =
      Operation
  type
