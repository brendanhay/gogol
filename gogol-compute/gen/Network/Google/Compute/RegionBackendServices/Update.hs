...
-- |
-- Module      : Network.Google.Compute.RegionBackendServices.Update
...
newComputeRegionBackendServicesUpdate ::
  ...
  Core.Text ->
  ComputeRegionBackendServicesUpdate
newComputeRegionBackendServicesUpdate backendService payload project region =
  ComputeRegionBackendServicesUpdate
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeRegionBackendServicesUpdate =
      Operation
  type
