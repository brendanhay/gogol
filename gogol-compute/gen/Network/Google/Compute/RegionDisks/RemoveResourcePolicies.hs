...
-- |
-- Module      : Network.Google.Compute.RegionDisks.RemoveResourcePolicies
...
newComputeRegionDisksRemoveResourcePolicies ::
  ...
  Core.Text ->
  ComputeRegionDisksRemoveResourcePolicies
newComputeRegionDisksRemoveResourcePolicies disk payload project region =
  ComputeRegionDisksRemoveResourcePolicies
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeRegionDisksRemoveResourcePolicies =
      Operation
  type
