...
-- |
-- Module      : Network.Google.Compute.RegionHealthChecks.Patch
...
newComputeRegionHealthChecksPatch ::
  ...
  Core.Text ->
  ComputeRegionHealthChecksPatch
newComputeRegionHealthChecksPatch healthCheck payload project region =
  ComputeRegionHealthChecksPatch
    { xgafv = Core.Nothing,
  ...
  requestClient ComputeRegionHealthChecksPatch {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy ComputeRegionHealthChecksPatchResource
          )
          Core.mempty
