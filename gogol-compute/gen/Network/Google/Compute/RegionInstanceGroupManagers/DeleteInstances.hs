...
-- |
-- Module      : Network.Google.Compute.RegionInstanceGroupManagers.DeleteInstances
...
newComputeRegionInstanceGroupManagersDeleteInstances ::
  ...
  Core.Text ->
  ComputeRegionInstanceGroupManagersDeleteInstances
newComputeRegionInstanceGroupManagersDeleteInstances instanceGroupManager payload project region =
  ComputeRegionInstanceGroupManagersDeleteInstances
    { xgafv = Core.Nothing,
