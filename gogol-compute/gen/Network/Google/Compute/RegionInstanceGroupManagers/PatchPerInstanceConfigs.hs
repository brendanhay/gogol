...
-- |
-- Module      : Network.Google.Compute.RegionInstanceGroupManagers.PatchPerInstanceConfigs
...
newComputeRegionInstanceGroupManagersPatchPerInstanceConfigs ::
  ...
  Core.Text ->
  ComputeRegionInstanceGroupManagersPatchPerInstanceConfigs
newComputeRegionInstanceGroupManagersPatchPerInstanceConfigs instanceGroupManager payload project region =
  ComputeRegionInstanceGroupManagersPatchPerInstanceConfigs
    { xgafv = Core.Nothing,
