...
-- |
-- Module      : Network.Google.Compute.RegionInstanceGroupManagers.RecreateInstances
...
newComputeRegionInstanceGroupManagersRecreateInstances ::
  ...
  Core.Text ->
  ComputeRegionInstanceGroupManagersRecreateInstances
newComputeRegionInstanceGroupManagersRecreateInstances instanceGroupManager payload project region =
  ComputeRegionInstanceGroupManagersRecreateInstances
    { xgafv = Core.Nothing,
