...
-- |
-- Module      : Network.Google.Compute.RegionInstanceGroupManagers.SetInstanceTemplate
...
newComputeRegionInstanceGroupManagersSetInstanceTemplate ::
  ...
  Core.Text ->
  ComputeRegionInstanceGroupManagersSetInstanceTemplate
newComputeRegionInstanceGroupManagersSetInstanceTemplate instanceGroupManager payload project region =
  ComputeRegionInstanceGroupManagersSetInstanceTemplate
    { xgafv = Core.Nothing,
