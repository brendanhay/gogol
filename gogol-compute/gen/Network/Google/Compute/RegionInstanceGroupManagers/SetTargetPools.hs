...
-- |
-- Module      : Network.Google.Compute.RegionInstanceGroupManagers.SetTargetPools
...
newComputeRegionInstanceGroupManagersSetTargetPools ::
  ...
  Core.Text ->
  ComputeRegionInstanceGroupManagersSetTargetPools
newComputeRegionInstanceGroupManagersSetTargetPools instanceGroupManager payload project region =
  ComputeRegionInstanceGroupManagersSetTargetPools
    { xgafv = Core.Nothing,
