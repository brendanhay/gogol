...
-- |
-- Module      : Network.Google.Compute.RegionNetworkFirewallPolicies.RemoveAssociation
...
newComputeRegionNetworkFirewallPoliciesRemoveAssociation ::
  ...
  Core.Text ->
  ComputeRegionNetworkFirewallPoliciesRemoveAssociation
newComputeRegionNetworkFirewallPoliciesRemoveAssociation firewallPolicy project region =
  ComputeRegionNetworkFirewallPoliciesRemoveAssociation
    { xgafv = Core.Nothing,
