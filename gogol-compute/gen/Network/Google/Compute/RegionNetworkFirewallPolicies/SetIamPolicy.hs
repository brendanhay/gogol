...
-- |
-- Module      : Network.Google.Compute.RegionNetworkFirewallPolicies.SetIamPolicy
...
newComputeRegionNetworkFirewallPoliciesSetIamPolicy ::
  ...
  Core.Text ->
  ComputeRegionNetworkFirewallPoliciesSetIamPolicy
newComputeRegionNetworkFirewallPoliciesSetIamPolicy payload project region resource =
  ComputeRegionNetworkFirewallPoliciesSetIamPolicy
    { xgafv = Core.Nothing,
