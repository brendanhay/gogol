...
-- |
-- Module      : Network.Google.Compute.RegionNotificationEndpoints.Delete
...
newComputeRegionNotificationEndpointsDelete ::
  ...
  Core.Text ->
  ComputeRegionNotificationEndpointsDelete
newComputeRegionNotificationEndpointsDelete notificationEndpoint project region =
  ComputeRegionNotificationEndpointsDelete
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeRegionNotificationEndpointsDelete =
      Operation
  type
