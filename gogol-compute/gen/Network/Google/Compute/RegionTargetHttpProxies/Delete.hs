...
-- |
-- Module      : Network.Google.Compute.RegionTargetHttpProxies.Delete
...
newComputeRegionTargetHttpProxiesDelete ::
  ...
  Core.Text ->
  ComputeRegionTargetHttpProxiesDelete
newComputeRegionTargetHttpProxiesDelete project region targetHttpProxy =
  ComputeRegionTargetHttpProxiesDelete
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeRegionTargetHttpProxiesDelete =
      Operation
  type
