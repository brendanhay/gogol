...
-- |
-- Module      : Network.Google.Compute.RegionTargetHttpsProxies.SetUrlMap
...
newComputeRegionTargetHttpsProxiesSetUrlMap ::
  ...
  Core.Text ->
  ComputeRegionTargetHttpsProxiesSetUrlMap
newComputeRegionTargetHttpsProxiesSetUrlMap payload project region targetHttpsProxy =
  ComputeRegionTargetHttpsProxiesSetUrlMap
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeRegionTargetHttpsProxiesSetUrlMap =
      Operation
  type
