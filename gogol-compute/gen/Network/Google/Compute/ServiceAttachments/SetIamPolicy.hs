...
-- |
-- Module      : Network.Google.Compute.ServiceAttachments.SetIamPolicy
...
newComputeServiceAttachmentsSetIamPolicy ::
  ...
  Core.Text ->
  ComputeServiceAttachmentsSetIamPolicy
newComputeServiceAttachmentsSetIamPolicy payload project region resource =
  ComputeServiceAttachmentsSetIamPolicy
    { xgafv = Core.Nothing,
...
instance
  ...
  where
  type
    Rs ComputeServiceAttachmentsSetIamPolicy =
      Policy
  type
