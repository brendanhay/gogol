...
-- |
-- Module      : Network.Google.Compute.TargetPools.AddHealthCheck
...
newComputeTargetPoolsAddHealthCheck ::
  ...
  Core.Text ->
  ComputeTargetPoolsAddHealthCheck
newComputeTargetPoolsAddHealthCheck payload project region targetPool =
  ComputeTargetPoolsAddHealthCheck
    { xgafv = Core.Nothing,
  ...
  requestClient ComputeTargetPoolsAddHealthCheck {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy ComputeTargetPoolsAddHealthCheckResource
          )
          Core.mempty
