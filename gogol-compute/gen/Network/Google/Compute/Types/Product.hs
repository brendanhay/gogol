...
data Instance = Instance
    { _iiStatus            :: !(Maybe InstanceStatus)
...
iiStatus :: Lens' Instance (Maybe InstanceStatus)
...
data ImageList = ImageList
    { _imaNextPageToken :: !(Maybe Text)
    , _imaKind          :: !Text
    , _imaItems         :: !(Maybe [Maybe Image])
...
imageList =
    ImageList
    { _imaNextPageToken = Nothing
    , _imaKind = "compute#imageList"
    , _imaItems = Nothing
...
-- | [Output Only] A token used to continue a truncated list request.
imaNextPageToken :: Lens' ImageList (Maybe Text)
imaNextPageToken
  = lens _imaNextPageToken
      (\ s a -> s{_imaNextPageToken = a})

-- | Type of resource.
imaKind :: Lens' ImageList Text
imaKind = lens _imaKind (\ s a -> s{_imaKind = a})

-- | A list of Image resources.
imaItems :: Lens' ImageList [Maybe Image]
imaItems
  = lens _imaItems (\ s a -> s{_imaItems = a}) .
      _Default
      . _Coerce

-- | [Output Only] Server-defined URL for this resource.
imaSelfLink :: Lens' ImageList (Maybe Text)
imaSelfLink
  = lens _imaSelfLink (\ s a -> s{_imaSelfLink = a})

-- | [Output Only] Unique identifier for the resource; defined by the server.
imaId :: Lens' ImageList (Maybe Text)
...
instance ToJSON ImageList where
        toJSON ImageList{..}
          = object
              (catMaybes
                 [("nextPageToken" .=) <$> _imaNextPageToken,
                  Just ("kind" .= _imaKind),
                  ("items" .=) <$> _imaItems,
...
-- | [Output Only] A warning data value corresponding to the key.
autValue :: Lens' AutoscalersScopedListItemDataWarning (Maybe Text)
autValue = lens _autValue (\ s a -> s{_autValue = a})

-- | [Output Only] A key for the warning data.
autKey :: Lens' AutoscalersScopedListItemDataWarning (Maybe Text)
