...
data AddressesList =
  AddressesList'
    { _alReturnPartialSuccess :: !(Maybe Bool)
...
addressesList pAlProject_ pAlRegion_ =
  AddressesList'
    { _alReturnPartialSuccess = Nothing
    , _alOrderBy = Nothing
...
alReturnPartialSuccess :: Lens' AddressesList (Maybe Bool)
alReturnPartialSuccess
  = lens _alReturnPartialSuccess
      (\ s a -> s{_alReturnPartialSuccess = a})
...
instance GoogleRequest AddressesList where
        ...
        requestClient AddressesList'{..}
          = go _alProject _alRegion _alReturnPartialSuccess
              _alOrderBy
              _alFilter
              _alPageToken
              (Just _alMaxResults)
