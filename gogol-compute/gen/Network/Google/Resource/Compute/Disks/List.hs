...
data DisksList =
  DisksList'
    { _dlReturnPartialSuccess :: !(Maybe Bool)
...
disksList pDlProject_ pDlZone_ =
  DisksList'
    { _dlReturnPartialSuccess = Nothing
    , _dlOrderBy = Nothing
...
dlReturnPartialSuccess :: Lens' DisksList (Maybe Bool)
dlReturnPartialSuccess
  = lens _dlReturnPartialSuccess
      (\ s a -> s{_dlReturnPartialSuccess = a})
...
instance GoogleRequest DisksList where
        ...
        requestClient DisksList'{..}
          = go _dlProject _dlZone _dlReturnPartialSuccess
              _dlOrderBy
              _dlFilter
              _dlPageToken
              (Just _dlMaxResults)
