...
module Network.Google.Resource.Compute.GlobalOperations.AggregatedList
    ...
    -- * Request Lenses
    , goalIncludeAllScopes
    , goalReturnPartialSuccess
    , goalOrderBy
    , goalProject
    , goalFilter
    , goalPageToken
...
data GlobalOperationsAggregatedList =
  GlobalOperationsAggregatedList'
    { _goalIncludeAllScopes :: !(Maybe Bool)
    , _goalReturnPartialSuccess :: !(Maybe Bool)
...
globalOperationsAggregatedList pGoalProject_ =
  GlobalOperationsAggregatedList'
    { _goalIncludeAllScopes = Nothing
    , _goalReturnPartialSuccess = Nothing
...
goalIncludeAllScopes :: Lens' GlobalOperationsAggregatedList (Maybe Bool)
goalIncludeAllScopes
  = lens _goalIncludeAllScopes
      (\ s a -> s{_goalIncludeAllScopes = a})

-- | Opt-in for partial success behavior which provides partial results in
-- case of failure. The default value is false.
goalReturnPartialSuccess :: Lens' GlobalOperationsAggregatedList (Maybe Bool)
goalReturnPartialSuccess
  = lens _goalReturnPartialSuccess
      (\ s a -> s{_goalReturnPartialSuccess = a})
...
instance GoogleRequest GlobalOperationsAggregatedList
        ...
        requestClient GlobalOperationsAggregatedList'{..}
          = go _goalProject _goalIncludeAllScopes
              _goalReturnPartialSuccess
              _goalOrderBy
              _goalFilter
              _goalPageToken
