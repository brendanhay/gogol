...
data HealthChecksList =
  HealthChecksList'
    { _hclReturnPartialSuccess :: !(Maybe Bool)
...
healthChecksList pHclProject_ =
  HealthChecksList'
    { _hclReturnPartialSuccess = Nothing
    , _hclOrderBy = Nothing
...
hclReturnPartialSuccess :: Lens' HealthChecksList (Maybe Bool)
hclReturnPartialSuccess
  = lens _hclReturnPartialSuccess
      (\ s a -> s{_hclReturnPartialSuccess = a})
...
instance GoogleRequest HealthChecksList where
        ...
        requestClient HealthChecksList'{..}
          = go _hclProject _hclReturnPartialSuccess _hclOrderBy
              _hclFilter
              _hclPageToken
              (Just _hclMaxResults)
              (Just AltJSON)
