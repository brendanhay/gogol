...
module Network.Google.Resource.Compute.NetworkEndpointGroups.AggregatedList
    ...
    -- * Request Lenses
    , negalIncludeAllScopes
    , negalReturnPartialSuccess
    , negalOrderBy
    , negalProject
    , negalFilter
    , negalPageToken
...
data NetworkEndpointGroupsAggregatedList =
  NetworkEndpointGroupsAggregatedList'
    { _negalIncludeAllScopes :: !(Maybe Bool)
    , _negalReturnPartialSuccess :: !(Maybe Bool)
...
networkEndpointGroupsAggregatedList pNegalProject_ =
  NetworkEndpointGroupsAggregatedList'
    { _negalIncludeAllScopes = Nothing
    , _negalReturnPartialSuccess = Nothing
...
negalIncludeAllScopes :: Lens' NetworkEndpointGroupsAggregatedList (Maybe Bool)
negalIncludeAllScopes
  = lens _negalIncludeAllScopes
      (\ s a -> s{_negalIncludeAllScopes = a})

-- | Opt-in for partial success behavior which provides partial results in
-- case of failure. The default value is false.
negalReturnPartialSuccess :: Lens' NetworkEndpointGroupsAggregatedList (Maybe Bool)
negalReturnPartialSuccess
  = lens _negalReturnPartialSuccess
      (\ s a -> s{_negalReturnPartialSuccess = a})
...
instance GoogleRequest
        ...
        requestClient
          NetworkEndpointGroupsAggregatedList'{..}
          = go _negalProject _negalIncludeAllScopes
              _negalReturnPartialSuccess
              _negalOrderBy
              _negalFilter
              _negalPageToken
