...
data NodeTemplatesAggregatedList =
  NodeTemplatesAggregatedList'
    { _nIncludeAllScopes :: !(Maybe Bool)
    , _nReturnPartialSuccess :: !(Maybe Bool)
...
nodeTemplatesAggregatedList pNProject_ =
  NodeTemplatesAggregatedList'
    { _nIncludeAllScopes = Nothing
    , _nReturnPartialSuccess = Nothing
    , _nOrderBy = Nothing
...
nIncludeAllScopes :: Lens' NodeTemplatesAggregatedList (Maybe Bool)
nIncludeAllScopes
  = lens _nIncludeAllScopes
      (\ s a -> s{_nIncludeAllScopes = a})

-- | Opt-in for partial success behavior which provides partial results in
-- case of failure. The default value is false.
nReturnPartialSuccess :: Lens' NodeTemplatesAggregatedList (Maybe Bool)
nReturnPartialSuccess
  = lens _nReturnPartialSuccess
      (\ s a -> s{_nReturnPartialSuccess = a})
...
instance GoogleRequest NodeTemplatesAggregatedList
        ...
        requestClient NodeTemplatesAggregatedList'{..}
          = go _nProject _nIncludeAllScopes
              _nReturnPartialSuccess
              _nOrderBy
              _nFilter
              _nPageToken
              (Just _nMaxResults)
