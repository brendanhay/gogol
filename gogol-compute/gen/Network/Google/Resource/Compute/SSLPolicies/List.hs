...
data SSLPoliciesList' =
  SSLPoliciesList''
    { _sslplReturnPartialSuccess :: !(Maybe Bool)
...
sslPoliciesList' pSslplProject_ =
  SSLPoliciesList''
    { _sslplReturnPartialSuccess = Nothing
...
sslplReturnPartialSuccess :: Lens' SSLPoliciesList' (Maybe Bool)
sslplReturnPartialSuccess
  = lens _sslplReturnPartialSuccess
      (\ s a -> s{_sslplReturnPartialSuccess = a})
...
instance GoogleRequest SSLPoliciesList' where
        ...
        requestClient SSLPoliciesList''{..}
          = go _sslplProject _sslplReturnPartialSuccess
              _sslplOrderBy
              _sslplFilter
              _sslplPageToken
