...
data SecurityPoliciesList =
  SecurityPoliciesList'
    { _splReturnPartialSuccess :: !(Maybe Bool)
...
securityPoliciesList pSplProject_ =
  SecurityPoliciesList'
    { _splReturnPartialSuccess = Nothing
    , _splOrderBy = Nothing
...
splReturnPartialSuccess :: Lens' SecurityPoliciesList (Maybe Bool)
splReturnPartialSuccess
  = lens _splReturnPartialSuccess
      (\ s a -> s{_splReturnPartialSuccess = a})
...
instance GoogleRequest SecurityPoliciesList where
        ...
        requestClient SecurityPoliciesList'{..}
          = go _splProject _splReturnPartialSuccess _splOrderBy
              _splFilter
              _splPageToken
              (Just _splMaxResults)
              (Just AltJSON)
