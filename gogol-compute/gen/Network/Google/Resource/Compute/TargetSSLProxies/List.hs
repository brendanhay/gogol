...
data TargetSSLProxiesList =
  TargetSSLProxiesList'
    { _tsplReturnPartialSuccess :: !(Maybe Bool)
...
targetSSLProxiesList pTsplProject_ =
  TargetSSLProxiesList'
    { _tsplReturnPartialSuccess = Nothing
...
tsplReturnPartialSuccess :: Lens' TargetSSLProxiesList (Maybe Bool)
tsplReturnPartialSuccess
  = lens _tsplReturnPartialSuccess
      (\ s a -> s{_tsplReturnPartialSuccess = a})
...
instance GoogleRequest TargetSSLProxiesList where
        ...
        requestClient TargetSSLProxiesList'{..}
          = go _tsplProject _tsplReturnPartialSuccess
              _tsplOrderBy
              _tsplFilter
              _tsplPageToken
