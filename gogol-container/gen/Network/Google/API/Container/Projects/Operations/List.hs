...
--
-- /See:/ <https://cloud.google.com/container-engine/docs/v1beta1/ Google Container Engine API Reference> for @container.projects.operations.list@.
module Network.Google.API.Container.Projects.Operations.List
    (
    -- * REST Resource
...
-- | A resource alias for container.projects.operations.list which the
