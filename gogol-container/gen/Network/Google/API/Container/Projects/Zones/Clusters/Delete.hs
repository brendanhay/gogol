...
-- also deleted.
--
-- /See:/ <https://cloud.google.com/container-engine/docs/v1beta1/ Google Container Engine API Reference> for @container.projects.zones.clusters.delete@.
module Network.Google.API.Container.Projects.Zones.Clusters.Delete
    (
    -- * REST Resource
...
-- | A resource alias for container.projects.zones.clusters.delete which the
