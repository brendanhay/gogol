...
-- |
-- Module      : Network.Google.Container.Projects.Zones.Clusters.Locations
...
instance
  ...
  where
  type
    Rs ContainerProjectsZonesClustersLocations =
      Operation
  type
    Scopes ContainerProjectsZonesClustersLocations =
