...
-- |
-- Module      : Network.Google.ContainerAnalysis.Projects.Notes.Occurrences.List
...
type ContainerAnalysisProjectsNotesOccurrencesListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListNoteOccurrencesResponse
...
instance
  ...
  where
  type
    Rs ContainerAnalysisProjectsNotesOccurrencesList =
