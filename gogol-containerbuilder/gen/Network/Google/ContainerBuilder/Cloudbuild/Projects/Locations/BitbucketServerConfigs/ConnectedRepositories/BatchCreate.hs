...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Locations.BitbucketServerConfigs.ConnectedRepositories.BatchCreate
...
type CloudbuildProjectsLocationsBitbucketServerConfigsConnectedRepositoriesBatchCreateResource =
  "v1"
    ...
    Core.:> "connectedRepositories:batchCreate"
