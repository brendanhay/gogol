...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Locations.Builds.Cancel
...
instance
  ...
  where
  type
    Rs CloudbuildProjectsLocationsBuildsCancel =
      Build
  type
    Scopes CloudbuildProjectsLocationsBuildsCancel =
