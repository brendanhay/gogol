...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Locations.Triggers.Get
...
instance
  ...
  where
  type
    Rs CloudbuildProjectsLocationsTriggersGet =
      BuildTrigger
  type
    Scopes CloudbuildProjectsLocationsTriggersGet =
