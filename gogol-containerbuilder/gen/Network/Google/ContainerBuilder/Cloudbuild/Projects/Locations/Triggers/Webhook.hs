...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Locations.Triggers.Webhook
...
type CloudbuildProjectsLocationsTriggersWebhookResource =
  "v1"
    Core.:> Core.CaptureMode "name" "webhook" Core.Text
    Core.:> Core.QueryParam "$.xgafv" Xgafv
    Core.:> Core.QueryParam "access_token" Core.Text
    Core.:> Core.QueryParam "callback" Core.Text
    Core.:> Core.QueryParam "projectId" Core.Text
    Core.:> Core.QueryParam "secret" Core.Text
    Core.:> Core.QueryParam "trigger" Core.Text
...
instance
  ...
  where
  type
    Rs CloudbuildProjectsLocationsTriggersWebhook =
      ReceiveTriggerWebhookResponse
  type
    Scopes
      CloudbuildProjectsLocationsTriggersWebhook =
