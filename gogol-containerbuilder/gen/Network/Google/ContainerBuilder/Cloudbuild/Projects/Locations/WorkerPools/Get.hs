...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Locations.WorkerPools.Get
...
type CloudbuildProjectsLocationsWorkerPoolsGetResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] WorkerPool
...
instance
  ...
  where
  type
    Rs CloudbuildProjectsLocationsWorkerPoolsGet =
      WorkerPool
  type
