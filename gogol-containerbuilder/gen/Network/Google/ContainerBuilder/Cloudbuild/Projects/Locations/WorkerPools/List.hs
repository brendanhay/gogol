...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Locations.WorkerPools.List
...
type CloudbuildProjectsLocationsWorkerPoolsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListWorkerPoolsResponse
...
instance
  ...
  where
  type
    Rs CloudbuildProjectsLocationsWorkerPoolsList =
