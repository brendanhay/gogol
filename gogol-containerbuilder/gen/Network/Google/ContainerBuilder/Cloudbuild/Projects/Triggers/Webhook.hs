...
-- |
-- Module      : Network.Google.ContainerBuilder.Cloudbuild.Projects.Triggers.Webhook
...
type CloudbuildProjectsTriggersWebhookResource =
  "v1"
    ...
    Core.:> "triggers"
    Core.:> Core.CaptureMode "trigger" "webhook" Core.Text
...
instance
  ...
  where
  type
    Rs CloudbuildProjectsTriggersWebhook =
      ReceiveTriggerWebhookResponse
