...
-- | A resource alias for search.cse.list which the
                         ...
                         QueryParam "excludeTerms" Text :>
                           QueryParam "num" Word32 :>
                             QueryParam "fileType" Text :>
                               QueryParam "searchType" CseList'SearchType :>
                                 QueryParam "lr" CseList'Lr :>
                                   QueryParam "q" Text :>
...
data CseList' = CseList'
    { _clImgDominantColor :: !(Maybe CseList'ImgDominantColor)
    , _clQuotaUser        :: !(Maybe Text)
    , _clPrettyPrint      :: !Bool
    , _clSiteSearchFilter :: !(Maybe CseList'SiteSearchFilter)
    ...
    , _clSearchType       :: !(Maybe CseList'SearchType)
    , _clLr               :: !(Maybe CseList'Lr)
    , _clQ                :: !Text
    ...
    , _clFilter           :: !(Maybe CseList'Filter)
    , _clDateRestrict     :: !(Maybe Text)
    , _clLinkSite         :: !(Maybe Text)
    , _clOauthToken       :: !(Maybe Text)
    , _clLowRange         :: !(Maybe Text)
    , _clImgType          :: !(Maybe CseList'ImgType)
    , _clGl               :: !(Maybe Text)
    , _clCx               :: !(Maybe Text)
    , _clImgColorType     :: !(Maybe CseList'ImgColorType)
    , _clImgSize          :: !(Maybe CseList'ImgSize)
    , _clExactTerms       :: !(Maybe Text)
    , _clCr               :: !(Maybe Text)
    , _clSafe             :: !CseList'Safe
    , _clHq               :: !(Maybe Text)
...
clImgDominantColor :: Lens' CseList' (Maybe CseList'ImgDominantColor)
clImgDominantColor
...
clSiteSearchFilter :: Lens' CseList' (Maybe CseList'SiteSearchFilter)
clSiteSearchFilter
...
clSearchType :: Lens' CseList' (Maybe CseList'SearchType)
clSearchType
  = lens _clSearchType (\ s a -> s{_clSearchType = a})

-- | The language restriction for the search results
clLr :: Lens' CseList' (Maybe CseList'Lr)
...
clFilter :: Lens' CseList' (Maybe CseList'Filter)
...
-- news, and photo.
clImgType :: Lens' CseList' (Maybe CseList'ImgType)
clImgType
...
-- color.
clImgColorType :: Lens' CseList' (Maybe CseList'ImgColorType)
clImgColorType
...
clImgSize :: Lens' CseList' (Maybe CseList'ImgSize)
clImgSize
...
-- | Search safety level
clSafe :: Lens' CseList' CseList'Safe
