...
-- |
-- Module      : Network.Google.Dataproc.Projects.Locations.AutoscalingPolicies.GetIamPolicy
...
newDataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy ::
  ...
  Core.Text ->
  DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy
newDataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy payload resource =
  DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy
    { xgafv = Core.Nothing,
