...
-- |
-- Module      : Network.Google.Dataproc.Projects.Regions.Clusters.Repair
...
type DataprocProjectsRegionsClustersRepairResource =
  "v1"
    ...
    Core.:> "clusters"
    Core.:> Core.CaptureMode "clusterName" "repair" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] RepairClusterRequest
...
instance
  ...
  where
  type
    Rs DataprocProjectsRegionsClustersRepair =
      Operation
  type
    Scopes DataprocProjectsRegionsClustersRepair =
