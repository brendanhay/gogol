...
-- |
-- Module      : Network.Google.Dataproc.Projects.Regions.Jobs.GetIamPolicy
...
instance
  ...
  where
  type
    Rs DataprocProjectsRegionsJobsGetIamPolicy =
      Policy
  type
    Scopes DataprocProjectsRegionsJobsGetIamPolicy =
