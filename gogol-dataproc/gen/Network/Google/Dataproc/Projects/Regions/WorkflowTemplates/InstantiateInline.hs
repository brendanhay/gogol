...
-- |
-- Module      : Network.Google.Dataproc.Projects.Regions.WorkflowTemplates.InstantiateInline
...
newDataprocProjectsRegionsWorkflowTemplatesInstantiateInline ::
  ...
  WorkflowTemplate ->
  DataprocProjectsRegionsWorkflowTemplatesInstantiateInline
newDataprocProjectsRegionsWorkflowTemplatesInstantiateInline parent payload =
  DataprocProjectsRegionsWorkflowTemplatesInstantiateInline
    { xgafv = Core.Nothing,
