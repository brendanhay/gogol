...
-- |
-- Module      : Network.Google.Dataproc.Projects.Regions.WorkflowTemplates.TestIamPermissions
...
newDataprocProjectsRegionsWorkflowTemplatesTestIamPermissions ::
  ...
  Core.Text ->
  DataprocProjectsRegionsWorkflowTemplatesTestIamPermissions
newDataprocProjectsRegionsWorkflowTemplatesTestIamPermissions payload resource =
  DataprocProjectsRegionsWorkflowTemplatesTestIamPermissions
    { xgafv = Core.Nothing,
