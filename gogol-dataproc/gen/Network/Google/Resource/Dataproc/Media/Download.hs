...
--
-- /See:/ <https://cloud.google.com/dataproc/ Google Cloud Dataproc API Reference> for @dataproc.media.download@.
module Network.Google.Resource.Dataproc.Media.Download
    (
    -- * REST Resource
...
-- | A resource alias for @dataproc.media.download@ method which the
