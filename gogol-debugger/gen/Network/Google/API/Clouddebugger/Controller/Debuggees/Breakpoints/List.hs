...
-- | A resource alias for clouddebugger.controller.debuggees.breakpoints.list which the
...
-- token.
cdblKey :: Lens' ControllerDebuggeesBreakpointsList' (Maybe Text)
...
cdblOauthToken :: Lens' ControllerDebuggeesBreakpointsList' (Maybe Text)
cdblOauthToken
...
cdblAlt :: Lens' ControllerDebuggeesBreakpointsList' Text
cdblAlt = lens _cdblAlt (\ s a -> s{_cdblAlt = a})
