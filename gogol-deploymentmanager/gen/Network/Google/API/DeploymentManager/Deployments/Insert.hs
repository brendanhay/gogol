...
-- deployment manifest.
--
-- /See:/ <https://developers.google.com/deployment-manager/ Google Cloud Deployment Manager API Reference> for @deploymentmanager.deployments.insert@.
module Network.Google.API.DeploymentManager.Deployments.Insert
    (
    -- * REST Resource
...
-- | A resource alias for deploymentmanager.deployments.insert which the
