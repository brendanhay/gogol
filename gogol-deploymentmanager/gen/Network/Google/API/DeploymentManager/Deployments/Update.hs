...
-- deployment manifest.
--
-- /See:/ <https://developers.google.com/deployment-manager/ Google Cloud Deployment Manager API Reference> for @deploymentmanager.deployments.update@.
module Network.Google.API.DeploymentManager.Deployments.Update
    (
    -- * REST Resource
...
-- | A resource alias for deploymentmanager.deployments.update which the
...
data DeploymentsUpdate' = DeploymentsUpdate'
    { _duCreatePolicy :: !DeploymentsUpdate'CreatePolicy
    , _duQuotaUser    :: !(Maybe Text)
    , _duPrettyPrint  :: !Bool
    , _duProject      :: !Text
    , _duUserIp       :: !(Maybe Text)
    , _duUpdatePolicy :: !DeploymentsUpdate'UpdatePolicy
    , _duDeletePolicy :: !DeploymentsUpdate'DeletePolicy
    , _duKey          :: !(Maybe Text)
...
deploymentsUpdate' pDuProject_ pDuDeployment_ =
    DeploymentsUpdate'
    { _duCreatePolicy = DUCPCreateOrAcquire
...
duCreatePolicy :: Lens' DeploymentsUpdate' DeploymentsUpdate'CreatePolicy
duCreatePolicy
...
duUpdatePolicy :: Lens' DeploymentsUpdate' DeploymentsUpdate'UpdatePolicy
duUpdatePolicy
  = lens _duUpdatePolicy
      (\ s a -> s{_duUpdatePolicy = a})

-- | Sets the policy to use for deleting resources.
duDeletePolicy :: Lens' DeploymentsUpdate' DeploymentsUpdate'DeletePolicy
duDeletePolicy
