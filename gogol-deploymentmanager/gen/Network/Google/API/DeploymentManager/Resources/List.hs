...
--
-- /See:/ <https://developers.google.com/deployment-manager/ Google Cloud Deployment Manager API Reference> for @deploymentmanager.resources.list@.
module Network.Google.API.DeploymentManager.Resources.List
    (
    -- * REST Resource
      ResourcesListAPI
...
-- | A resource alias for deploymentmanager.resources.list which the
