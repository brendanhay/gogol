...
--
-- /See:/ <https://developers.google.com/deployment-manager/ Google Cloud Deployment Manager API Reference> for @deploymentmanager.types.list@.
module Network.Google.API.DeploymentManager.Types.List
    (
    -- * REST Resource
      TypesListAPI
...
-- | A resource alias for deploymentmanager.types.list which the
