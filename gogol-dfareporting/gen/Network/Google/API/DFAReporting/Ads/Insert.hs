...
-- | Inserts a new ad.
--
-- /See:/ <https://developers.google.com/doubleclick-advertisers/reporting/ DCM/DFA Reporting And Trafficking API Reference> for @dfareporting.ads.insert@.
module Network.Google.API.DFAReporting.Ads.Insert
    (
    -- * REST Resource
      AdsInsertAPI
...
-- | A resource alias for dfareporting.ads.insert which the
