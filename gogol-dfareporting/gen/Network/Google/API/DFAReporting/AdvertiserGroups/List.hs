...
-- | A resource alias for dfareporting.advertiserGroups.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "searchString" Text :>
                   QueryParam "ids" Int64 :>
                     QueryParam "sortOrder" AdvertiserGroupsList'SortOrder
                       :>
                       QueryParam "key" Text :>
                         QueryParam "pageToken" Text :>
                           QueryParam "sortField" AdvertiserGroupsList'SortField
                             :>
...
data AdvertiserGroupsList' = AdvertiserGroupsList'
    ...
    , _aglIds          :: !(Maybe Int64)
    , _aglProfileId    :: !Int64
    , _aglSortOrder    :: !(Maybe AdvertiserGroupsList'SortOrder)
    , _aglKey          :: !(Maybe Text)
    , _aglPageToken    :: !(Maybe Text)
    , _aglSortField    :: !(Maybe AdvertiserGroupsList'SortField)
...
aglSortOrder :: Lens' AdvertiserGroupsList' (Maybe AdvertiserGroupsList'SortOrder)
aglSortOrder
...
aglSortField :: Lens' AdvertiserGroupsList' (Maybe AdvertiserGroupsList'SortField)
aglSortField
