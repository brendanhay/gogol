...
-- | A resource alias for dfareporting.campaignCreativeAssociations.list which the
...
data CampaignCreativeAssociationsList' = CampaignCreativeAssociationsList'
    ...
    , _ccalSortOrder   :: !(Maybe CampaignCreativeAssociationsList'SortOrder)
    , _ccalKey         :: !(Maybe Text)
...
ccalSortOrder :: Lens' CampaignCreativeAssociationsList' (Maybe CampaignCreativeAssociationsList'SortOrder)
ccalSortOrder
  = lens _ccalSortOrder
