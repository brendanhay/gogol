...
-- | A resource alias for dfareporting.contentCategories.list which the
...
data ContentCategoriesList' = ContentCategoriesList'
    ...
    , _cclIds          :: !(Maybe Int64)
    , _cclProfileId    :: !Int64
    , _cclSortOrder    :: !(Maybe ContentCategoriesList'SortOrder)
    , _cclKey          :: !(Maybe Text)
    , _cclPageToken    :: !(Maybe Text)
    , _cclSortField    :: !(Maybe ContentCategoriesList'SortField)
...
cclSortOrder :: Lens' ContentCategoriesList' (Maybe ContentCategoriesList'SortOrder)
cclSortOrder
...
cclSortField :: Lens' ContentCategoriesList' (Maybe ContentCategoriesList'SortField)
cclSortField
