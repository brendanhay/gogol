...
-- | A resource alias for dfareporting.creativeFieldValues.list which the
...
data CreativeFieldValuesList' = CreativeFieldValuesList'
    ...
    , _cfvlSortOrder       :: !(Maybe CreativeFieldValuesList'SortOrder)
    , _cfvlKey             :: !(Maybe Text)
    , _cfvlPageToken       :: !(Maybe Text)
    , _cfvlSortField       :: !(Maybe CreativeFieldValuesList'SortField)
...
cfvlSortOrder :: Lens' CreativeFieldValuesList' (Maybe CreativeFieldValuesList'SortOrder)
cfvlSortOrder
  = lens _cfvlSortOrder
...
cfvlSortField :: Lens' CreativeFieldValuesList' (Maybe CreativeFieldValuesList'SortField)
cfvlSortField
  = lens _cfvlSortField
