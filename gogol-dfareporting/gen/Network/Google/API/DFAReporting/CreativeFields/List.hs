...
-- | A resource alias for dfareporting.creativeFields.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "searchString" Text :>
                   QueryParam "ids" Int64 :>
                     QueryParam "sortOrder" CreativeFieldsList'SortOrder
                       :>
                       QueryParam "key" Text :>
                         QueryParam "pageToken" Text :>
                           QueryParam "sortField" CreativeFieldsList'SortField
                             :>
...
data CreativeFieldsList' = CreativeFieldsList'
    ...
    , _cflIds           :: !(Maybe Int64)
    , _cflProfileId     :: !Int64
    , _cflSortOrder     :: !(Maybe CreativeFieldsList'SortOrder)
    , _cflKey           :: !(Maybe Text)
    , _cflPageToken     :: !(Maybe Text)
    , _cflSortField     :: !(Maybe CreativeFieldsList'SortField)
...
cflSortOrder :: Lens' CreativeFieldsList' (Maybe CreativeFieldsList'SortOrder)
cflSortOrder
...
cflSortField :: Lens' CreativeFieldsList' (Maybe CreativeFieldsList'SortField)
cflSortField
