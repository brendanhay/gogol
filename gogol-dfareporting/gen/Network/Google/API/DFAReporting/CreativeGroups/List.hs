...
-- | A resource alias for dfareporting.creativeGroups.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "searchString" Text :>
                   QueryParam "ids" Int64 :>
                     QueryParam "sortOrder" CreativeGroupsList'SortOrder
                       :>
                       QueryParam "groupNumber" Int32 :>
                         QueryParam "key" Text :>
                           QueryParam "pageToken" Text :>
                             QueryParam "sortField" CreativeGroupsList'SortField
                               :>
...
data CreativeGroupsList' = CreativeGroupsList'
    ...
    , _cglIds           :: !(Maybe Int64)
    , _cglProfileId     :: !Int64
    , _cglSortOrder     :: !(Maybe CreativeGroupsList'SortOrder)
    , _cglGroupNumber   :: !(Maybe Int32)
    , _cglKey           :: !(Maybe Text)
    , _cglPageToken     :: !(Maybe Text)
    , _cglSortField     :: !(Maybe CreativeGroupsList'SortField)
...
cglSortOrder :: Lens' CreativeGroupsList' (Maybe CreativeGroupsList'SortOrder)
cglSortOrder
...
-- token.
cglKey :: Lens' CreativeGroupsList' (Maybe Text)
...
cglSortField :: Lens' CreativeGroupsList' (Maybe CreativeGroupsList'SortField)
cglSortField
  = lens _cglSortField (\ s a -> s{_cglSortField = a})

-- | OAuth 2.0 token for the current user.
cglOauthToken :: Lens' CreativeGroupsList' (Maybe Text)
cglOauthToken
  = lens _cglOauthToken
