...
-- | A resource alias for dfareporting.directorySiteContacts.list which the
-- 'DirectorySiteContactsList'' request conforms to.
type DirectorySiteContactsListAPI =
     "userprofiles" :>
...
data DirectorySiteContactsList' = DirectorySiteContactsList'
    ...
    , _dsclSortOrder        :: !(Maybe DirectorySiteContactsList'SortOrder)
    , _dsclKey              :: !(Maybe Text)
    , _dsclPageToken        :: !(Maybe Text)
    , _dsclSortField        :: !(Maybe DirectorySiteContactsList'SortField)
...
dsclSortOrder :: Lens' DirectorySiteContactsList' (Maybe DirectorySiteContactsList'SortOrder)
dsclSortOrder
  = lens _dsclSortOrder
...
dsclSortField :: Lens' DirectorySiteContactsList' (Maybe DirectorySiteContactsList'SortField)
dsclSortField
  = lens _dsclSortField
...
instance GoogleRequest DirectorySiteContactsList'
        ...
        requestWithRoute r u DirectorySiteContactsList'{..}
          ...
          where go
                  = clientWithRoute
                      (Proxy :: Proxy DirectorySiteContactsListAPI)
                      r
                      u
