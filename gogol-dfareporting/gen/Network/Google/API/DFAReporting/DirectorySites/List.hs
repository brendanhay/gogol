...
-- | A resource alias for dfareporting.directorySites.list which the
                   ...
                   QueryParam "acceptsInterstitialPlacements" Bool :>
                     QueryParam "acceptsPublisherPaidPlacements" Bool :>
                       QueryParam "ids" Int64 :>
                         QueryParam "sortOrder" DirectorySitesList'SortOrder
                           :>
...
data DirectorySitesList' = DirectorySitesList'
    ...
    , _dslIds                            :: !(Maybe Int64)
    , _dslProfileId                      :: !Int64
    , _dslSortOrder                      :: !(Maybe DirectorySitesList'SortOrder)
    , _dslActive                         :: !(Maybe Bool)
    , _dslKey                            :: !(Maybe Text)
    , _dslCountryId                      :: !(Maybe Int64)
    , _dslPageToken                      :: !(Maybe Text)
    , _dslSortField                      :: !(Maybe DirectorySitesList'SortField)
...
dslSortOrder :: Lens' DirectorySitesList' (Maybe DirectorySitesList'SortOrder)
dslSortOrder
...
dslSortField :: Lens' DirectorySitesList' (Maybe DirectorySitesList'SortField)
dslSortField
