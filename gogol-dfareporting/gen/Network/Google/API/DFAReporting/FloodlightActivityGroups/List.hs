...
-- | A resource alias for dfareporting.floodlightActivityGroups.list which the
...
data FloodlightActivityGroupsList' = FloodlightActivityGroupsList'
    ...
    , _faglSortOrder                 :: !(Maybe FloodlightActivityGroupsList'SortOrder)
    , _faglKey                       :: !(Maybe Text)
    , _faglPageToken                 :: !(Maybe Text)
    , _faglSortField                 :: !(Maybe FloodlightActivityGroupsList'SortField)
    , _faglType                      :: !(Maybe FloodlightActivityGroupsList'Type)
...
faglSortOrder :: Lens' FloodlightActivityGroupsList' (Maybe FloodlightActivityGroupsList'SortOrder)
faglSortOrder
  = lens _faglSortOrder
...
faglSortField :: Lens' FloodlightActivityGroupsList' (Maybe FloodlightActivityGroupsList'SortField)
faglSortField
  = lens _faglSortField
...
-- | Select only floodlight activity groups with the specified floodlight
-- activity group type.
faglType :: Lens' FloodlightActivityGroupsList' (Maybe FloodlightActivityGroupsList'Type)
