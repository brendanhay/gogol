...
-- | A resource alias for dfareporting.inventoryItems.list which the
                 ...
                 QueryParam "prettyPrint" Bool :>
                   QueryParam "userIp" Text :>
                     QueryParam "ids" Int64 :>
                       QueryParam "sortOrder" InventoryItemsList'SortOrder
                         :>
...
data InventoryItemsList' = InventoryItemsList'
    ...
    , _iilIds         :: !(Maybe Int64)
    , _iilProfileId   :: !Int64
    , _iilSortOrder   :: !(Maybe InventoryItemsList'SortOrder)
    , _iilInPlan      :: !(Maybe Bool)
    , _iilKey         :: !(Maybe Text)
    , _iilPageToken   :: !(Maybe Text)
    , _iilProjectId   :: !Int64
    , _iilSortField   :: !(Maybe InventoryItemsList'SortField)
...
iilSortOrder :: Lens' InventoryItemsList' (Maybe InventoryItemsList'SortOrder)
iilSortOrder
...
iilSortField :: Lens' InventoryItemsList' (Maybe InventoryItemsList'SortField)
iilSortField
