...
-- | A resource alias for dfareporting.orderDocuments.list which the
                   ...
                   QueryParam "userIp" Text :>
                     QueryParam "searchString" Text :>
                       QueryParam "ids" Int64 :>
                         QueryParam "sortOrder" OrderDocumentsList'SortOrder
                           :>
                           QueryParam "key" Text :>
...
data OrderDocumentsList' = OrderDocumentsList'
    ...
    , _odlIds          :: !(Maybe Int64)
    , _odlProfileId    :: !Int64
    , _odlSortOrder    :: !(Maybe OrderDocumentsList'SortOrder)
    , _odlKey          :: !(Maybe Text)
    , _odlPageToken    :: !(Maybe Text)
    , _odlProjectId    :: !Int64
    , _odlSortField    :: !(Maybe OrderDocumentsList'SortField)
...
odlSortOrder :: Lens' OrderDocumentsList' (Maybe OrderDocumentsList'SortOrder)
odlSortOrder
...
odlSortField :: Lens' OrderDocumentsList' (Maybe OrderDocumentsList'SortField)
odlSortField
