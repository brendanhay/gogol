...
-- | A resource alias for dfareporting.placementGroups.list which the
...
data PlacementGroupsList' = PlacementGroupsList'
    ...
    , _pglPricingTypes         :: !(Maybe PlacementGroupsList'PricingTypes)
    , _pglSearchString         :: !(Maybe Text)
    , _pglIds                  :: !(Maybe Int64)
    , _pglProfileId            :: !Int64
    , _pglPlacementGroupType   :: !(Maybe PlacementGroupsList'PlacementGroupType)
    , _pglDirectorySiteIds     :: !(Maybe Int64)
    , _pglSortOrder            :: !(Maybe PlacementGroupsList'SortOrder)
    , _pglKey                  :: !(Maybe Text)
    , _pglSiteIds              :: !(Maybe Int64)
    , _pglPageToken            :: !(Maybe Text)
    , _pglSortField            :: !(Maybe PlacementGroupsList'SortField)
...
pglPricingTypes :: Lens' PlacementGroupsList' (Maybe PlacementGroupsList'PricingTypes)
pglPricingTypes
...
pglPlacementGroupType :: Lens' PlacementGroupsList' (Maybe PlacementGroupsList'PlacementGroupType)
pglPlacementGroupType
...
pglSortOrder :: Lens' PlacementGroupsList' (Maybe PlacementGroupsList'SortOrder)
pglSortOrder
...
pglSortField :: Lens' PlacementGroupsList' (Maybe PlacementGroupsList'SortField)
pglSortField
