...
-- | A resource alias for dfareporting.placementStrategies.list which the
...
data PlacementStrategiesList' = PlacementStrategiesList'
    ...
    , _pslIds          :: !(Maybe Int64)
    , _pslProfileId    :: !Int64
    , _pslSortOrder    :: !(Maybe PlacementStrategiesList'SortOrder)
    , _pslKey          :: !(Maybe Text)
    , _pslPageToken    :: !(Maybe Text)
    , _pslSortField    :: !(Maybe PlacementStrategiesList'SortField)
...
pslSortOrder :: Lens' PlacementStrategiesList' (Maybe PlacementStrategiesList'SortOrder)
pslSortOrder
...
pslSortField :: Lens' PlacementStrategiesList' (Maybe PlacementStrategiesList'SortField)
pslSortField
