...
--
-- /See:/ <https://developers.google.com/doubleclick-advertisers/reporting/ DCM/DFA Reporting And Trafficking API Reference> for @dfareporting.placements.update@.
module Network.Google.API.DFAReporting.Placements.Update
    (
    -- * REST Resource
      PlacementsUpdateAPI
...
-- | A resource alias for dfareporting.placements.update which the
