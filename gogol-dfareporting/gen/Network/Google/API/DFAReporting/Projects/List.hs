...
-- | A resource alias for dfareporting.projects.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "searchString" Text :>
                   QueryParam "ids" Int64 :>
                     QueryParam "sortOrder" ProjectsList'SortOrder :>
                       QueryParam "key" Text :>
                         QueryParam "pageToken" Text :>
                           QueryParam "sortField" ProjectsList'SortField :>
...
data ProjectsList' = ProjectsList'
    ...
    , _proIds           :: !(Maybe Int64)
    , _proProfileId     :: !Int64
    , _proSortOrder     :: !(Maybe ProjectsList'SortOrder)
    , _proKey           :: !(Maybe Text)
    , _proPageToken     :: !(Maybe Text)
    , _proSortField     :: !(Maybe ProjectsList'SortField)
...
proSortOrder :: Lens' ProjectsList' (Maybe ProjectsList'SortOrder)
proSortOrder
...
proSortField :: Lens' ProjectsList' (Maybe ProjectsList'SortField)
proSortField
