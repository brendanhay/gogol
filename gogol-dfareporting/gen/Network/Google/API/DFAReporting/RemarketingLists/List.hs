...
-- | A resource alias for dfareporting.remarketingLists.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "floodlightActivityId" Int64 :>
                   QueryParam "advertiserId" Int64 :>
                     QueryParam "sortOrder" RemarketingListsList'SortOrder
                       :>
...
data RemarketingListsList' = RemarketingListsList'
    ...
    , _rllProfileId            :: !Int64
    , _rllSortOrder            :: !(Maybe RemarketingListsList'SortOrder)
    , _rllActive               :: !(Maybe Bool)
    , _rllKey                  :: !(Maybe Text)
    , _rllName                 :: !(Maybe Text)
    , _rllPageToken            :: !(Maybe Text)
    , _rllSortField            :: !(Maybe RemarketingListsList'SortField)
...
rllSortOrder :: Lens' RemarketingListsList' (Maybe RemarketingListsList'SortOrder)
rllSortOrder
...
rllSortField :: Lens' RemarketingListsList' (Maybe RemarketingListsList'SortField)
rllSortField
