...
-- | A resource alias for dfareporting.sites.list which the
                         ...
                         QueryParam "acceptsPublisherPaidPlacements" Bool :>
                           QueryParam "ids" Int64 :>
                             QueryParam "directorySiteIds" Int64 :>
                               QueryParam "sortOrder" SitesList'SortOrder :>
                                 QueryParam "key" Text :>
                                   QueryParam "pageToken" Text :>
                                     QueryParam "sortField" SitesList'SortField
                                       :>
...
data SitesList' = SitesList'
    ...
    , _slSortOrder                      :: !(Maybe SitesList'SortOrder)
    , _slKey                            :: !(Maybe Text)
    , _slPageToken                      :: !(Maybe Text)
    , _slSortField                      :: !(Maybe SitesList'SortField)
...
slSortOrder :: Lens' SitesList' (Maybe SitesList'SortOrder)
slSortOrder
...
slSortField :: Lens' SitesList' (Maybe SitesList'SortField)
slSortField
...
instance GoogleRequest SitesList' where
        ...
        requestWithRoute r u SitesList'{..}
          = go _slQuotaUser (Just _slPrettyPrint)
              _slUnmappedSite
              _slUserIp
              _slCampaignIds
              _slSearchString
