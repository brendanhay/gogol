...
-- | A resource alias for dfareporting.userRoles.list which the
               ...
               QueryParam "userIp" Text :>
                 QueryParam "searchString" Text :>
                   QueryParam "ids" Int64 :>
                     QueryParam "sortOrder" UserRolesList'SortOrder :>
                       QueryParam "key" Text :>
                         QueryParam "accountUserRoleOnly" Bool :>
                           QueryParam "pageToken" Text :>
                             QueryParam "sortField" UserRolesList'SortField :>
...
data UserRolesList' = UserRolesList'
    ...
    , _urlIds                 :: !(Maybe Int64)
    , _urlProfileId           :: !Int64
    , _urlSortOrder           :: !(Maybe UserRolesList'SortOrder)
    , _urlKey                 :: !(Maybe Text)
    , _urlAccountUserRoleOnly :: !(Maybe Bool)
    , _urlPageToken           :: !(Maybe Text)
    , _urlSortField           :: !(Maybe UserRolesList'SortField)
...
urlSortOrder :: Lens' UserRolesList' (Maybe UserRolesList'SortOrder)
urlSortOrder
...
urlSortField :: Lens' UserRolesList' (Maybe UserRolesList'SortField)
urlSortField
