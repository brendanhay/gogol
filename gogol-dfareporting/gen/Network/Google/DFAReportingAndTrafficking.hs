-- |
-- Module      : Network.Google.DCM/DFAReportingAndTrafficking
...
module Network.Google.DCM/DFAReportingAndTrafficking
    (
    -- * API Definition
      DCM/DFAReportingAndTrafficking
...
import Network.Google.DCM/DFAReportingAndTrafficking.Types

{- $resources
TODO
-}

type DCM/DFAReportingAndTrafficking = ()

dCM/DFAReportingAndTrafficking :: Proxy DCM/DFAReportingAndTrafficking
dCM/DFAReportingAndTrafficking = Proxy
