...
type AccountActiveAdSummariesGetAPI =
     "userprofiles" :>
...
aaasgAlt :: Lens' AccountActiveAdSummariesGet' Text
...
instance GoogleRequest AccountActiveAdSummariesGet'
        ...
        requestWithRoute r u AccountActiveAdSummariesGet{..}
          = go _aaasgQuotaUser _aaasgPrettyPrint _aaasgUserIp
              _aaasgProfileId
              _aaasgKey
          ...
          where go
                  = clientWithRoute
                      (Proxy :: Proxy AccountActiveAdSummariesGetAPI)
                      r
                      u
