...
-- |
-- Module      : Network.Google.DialogFlow.Projects.Locations.Agents.Environments.Sessions.EntityTypes.Delete
...
newDialogFlowProjectsLocationsAgentsEnvironmentsSessionsEntityTypesDelete ::
  ...
  Core.Text ->
  DialogFlowProjectsLocationsAgentsEnvironmentsSessionsEntityTypesDelete
newDialogFlowProjectsLocationsAgentsEnvironmentsSessionsEntityTypesDelete name =
  DialogFlowProjectsLocationsAgentsEnvironmentsSessionsEntityTypesDelete
    { xgafv = Core.Nothing,
