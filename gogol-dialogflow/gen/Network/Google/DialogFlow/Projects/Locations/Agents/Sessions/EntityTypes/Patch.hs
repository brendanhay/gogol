...
-- |
-- Module      : Network.Google.DialogFlow.Projects.Locations.Agents.Sessions.EntityTypes.Patch
...
newDialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch ::
  ...
  GoogleCloudDialogflowCxV3SessionEntityType ->
  DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch
newDialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch name payload =
  DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch
    { xgafv = Core.Nothing,
