...
-- |
-- Module      : Network.Google.DialogFlow.Projects.Locations.Agents.TestCases.BatchDelete
...
newDialogFlowProjectsLocationsAgentsTestCasesBatchDelete ::
  ...
  GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequest ->
  DialogFlowProjectsLocationsAgentsTestCasesBatchDelete
newDialogFlowProjectsLocationsAgentsTestCasesBatchDelete parent payload =
  DialogFlowProjectsLocationsAgentsTestCasesBatchDelete
    { xgafv = Core.Nothing,
