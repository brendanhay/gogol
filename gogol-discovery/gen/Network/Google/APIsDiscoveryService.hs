-- |
-- Module      : Network.Google.APIsDiscoveryService
...
import           Network.Google.APIsDiscoveryService.Types

{- $resources
TODO
-}

type APIsDiscoveryService = ()

aPIsDiscoveryService :: Proxy APIsDiscoveryService
aPIsDiscoveryService = Proxy
