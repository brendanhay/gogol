...
-- |
-- Module      : Network.Google.DLP.Organizations.DeidentifyTemplates.Patch
...
instance
  ...
  where
  type
    Rs DLPOrganizationsDeidentifyTemplatesPatch =
      GooglePrivacyDlpV2DeidentifyTemplate
  type
    Scopes DLPOrganizationsDeidentifyTemplatesPatch =
