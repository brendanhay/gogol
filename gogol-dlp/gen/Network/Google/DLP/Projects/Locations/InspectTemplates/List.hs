...
-- |
-- Module      : Network.Google.DLP.Projects.Locations.InspectTemplates.List
...
instance
  ...
  where
  type
    Rs DLPProjectsLocationsInspectTemplatesList =
      GooglePrivacyDlpV2ListInspectTemplatesResponse
  type
    Scopes DLPProjectsLocationsInspectTemplatesList =
