...
-- |
-- Module      : Network.Google.DLP.Projects.Locations.InspectTemplates.Patch
...
instance
  ...
  where
  type
    Rs DLPProjectsLocationsInspectTemplatesPatch =
      GooglePrivacyDlpV2InspectTemplate
  type
    Scopes DLPProjectsLocationsInspectTemplatesPatch =
