...
-- |
-- Module      : Network.Google.DLP.Projects.Locations.StoredInfoTypes.Create
...
instance
  ...
  where
  type
    Rs DLPProjectsLocationsStoredInfoTypesCreate =
      GooglePrivacyDlpV2StoredInfoType
  type
    Scopes DLPProjectsLocationsStoredInfoTypesCreate =
