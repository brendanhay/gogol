...
-- | A resource alias for doubleclicksearch.conversion.get which the
...
-- yyyymmdd.
cgEndDate :: Lens' ConversionGet' Natural
cgEndDate
  = lens _cgEndDate (\ s a -> s{_cgEndDate = a}) . _Nat
...
-- yyyymmdd.
cgStartDate :: Lens' ConversionGet' Natural
cgStartDate
...
cgRowCount :: Lens' ConversionGet' Natural
cgRowCount
