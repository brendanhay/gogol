...
-- | A resource alias for drive.files.get which the
           ...
           QueryParam "prettyPrint" Bool :>
             QueryParam "userIp" Text :>
               QueryParam "updateViewedDate" Bool :>
                 QueryParam "key" Text :>
                   QueryParam "projection" FilesGet'Projection :>
...
data FilesGet' = FilesGet'
    ...
    , _fgKey              :: !(Maybe Text)
    , _fgProjection       :: !(Maybe FilesGet'Projection)
...
fgProjection :: Lens' FilesGet' (Maybe FilesGet'Projection)
fgProjection
