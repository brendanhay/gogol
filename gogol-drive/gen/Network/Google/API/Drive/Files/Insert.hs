...
-- | A resource alias for drive.files.insert which the
         ...
         QueryParam "prettyPrint" Bool :>
           QueryParam "userIp" Text :>
             QueryParam "pinned" Bool :>
               QueryParam "visibility" FilesInsert'Visibility :>
...
data FilesInsert' = FilesInsert'
    ...
    , _fiPinned                    :: !Bool
    , _fiVisibility                :: !FilesInsert'Visibility
...
-- convert=false.
fiVisibility :: Lens' FilesInsert' FilesInsert'Visibility
fiVisibility
