...
-- | A resource alias for drive.files.list which the
               ...
               QueryParam "q" Text :>
                 QueryParam "key" Text :>
                   QueryParam "spaces" Text :>
                     QueryParam "projection" FilesList'Projection :>
                       QueryParam "corpus" FilesList'Corpus :>
...
data FilesList' = FilesList'
    ...
    , _flProjection  :: !(Maybe FilesList'Projection)
    , _flCorpus      :: !(Maybe FilesList'Corpus)
...
flProjection :: Lens' FilesList' (Maybe FilesList'Projection)
flProjection
  = lens _flProjection (\ s a -> s{_flProjection = a})

-- | The body of items (files\/documents) to which the query applies.
flCorpus :: Lens' FilesList' (Maybe FilesList'Corpus)
