...
-- | A resource alias for drive.files.watch which the
             ...
             QueryParam "prettyPrint" Bool :>
               QueryParam "userIp" Text :>
                 QueryParam "updateViewedDate" Bool :>
                   QueryParam "key" Text :>
                     QueryParam "projection" FilesWatch'Projection :>
...
data FilesWatch' = FilesWatch'
    ...
    , _fwKey              :: !(Maybe Text)
    , _fwProjection       :: !(Maybe FilesWatch'Projection)
...
fwProjection :: Lens' FilesWatch' (Maybe FilesWatch'Projection)
fwProjection
