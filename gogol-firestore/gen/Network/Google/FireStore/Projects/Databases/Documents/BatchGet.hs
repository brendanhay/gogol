...
-- |
-- Module      : Network.Google.FireStore.Projects.Databases.Documents.BatchGet
...
type FireStoreProjectsDatabasesDocumentsBatchGetResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] BatchGetDocumentsRequest
    Core.:> Core.Post '[Core.JSON] BatchGetDocumentsResponse
...
instance
  ...
  where
  type
    Rs FireStoreProjectsDatabasesDocumentsBatchGet =
