...
-- | A resource alias for freebase.search which the
               ...
               QueryParam "with" Text :>
                 QueryParam "userIp" Text :>
                   QueryParam "domain" Text :>
                     QueryParam "format" Search'Format :>
                       QueryParam "help" Search'Help :>
                         QueryParam "lang" Text :>
                           QueryParam "indent" Bool :>
                             QueryParam "key" Text :>
                               QueryParam "output" Text :>
                                 QueryParam "query" Text :>
                                   QueryParam "scoring" Search'Scoring :>
...
data Search' = Search'
    ...
    , _sUserIp      :: !(Maybe Text)
    , _sDomain      :: !(Maybe Text)
    , _sFormat      :: !Search'Format
    , _sHelp        :: !(Maybe Search'Help)
    , _sLang        :: !(Maybe Text)
    , _sIndent      :: !(Maybe Bool)
    , _sKey         :: !(Maybe Text)
    , _sOutput      :: !(Maybe Text)
    , _sQuery       :: !(Maybe Text)
    , _sScoring     :: !Search'Scoring
    , _sLimit       :: !Int32
    , _sFilter      :: !(Maybe Text)
    ...
    , _sExact       :: !(Maybe Bool)
    , _sSpell       :: !Search'Spell
    , _sAsOfTime    :: !(Maybe Text)
    , _sEncode      :: !Search'Encode
...
sFormat :: Lens' Search' Search'Format
sFormat = lens _sFormat (\ s a -> s{_sFormat = a})

-- | The keyword to request help on.
sHelp :: Lens' Search' (Maybe Search'Help)
...
sScoring :: Lens' Search' Search'Scoring
...
sSpell :: Lens' Search' Search'Spell
...
-- encoding.
sEncode :: Lens' Search' Search'Encode
...
instance GoogleRequest Search' where
        ...
        requestWithRoute r u Search'{..}
          = go _sWithout _sQuotaUser (Just _sPrettyPrint)
              ...
              (Just _sAlt)
          where go
                  = clientWithRoute (Proxy :: Proxy SearchAPI) r u
