...
-- | A resource alias for fusiontables.template.list which the
...
tlQuotaUser :: Lens' TemplateList' (Maybe Text)
tlQuotaUser
  = lens _tlQuotaUser (\ s a -> s{_tlQuotaUser = a})

-- | Returns response with indentations and line breaks.
tlPrettyPrint :: Lens' TemplateList' Bool
tlPrettyPrint
  = lens _tlPrettyPrint
