...
-- | A resource alias for games.applications.get which the
...
data ApplicationsGet' = ApplicationsGet'
    ...
    , _agKey           :: !(Maybe Text)
    , _agPlatformType  :: !(Maybe ApplicationsGet'PlatformType)
...
agPlatformType :: Lens' ApplicationsGet' (Maybe ApplicationsGet'PlatformType)
agPlatformType
