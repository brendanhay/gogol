...
-- | A resource alias for games.metagame.listCategoriesByPlayer which the
...
-- * 'mlcbpAlt'
metagameListCategoriesByPlayer'
    :: MetagameListCategoriesByPlayer'Collection -- ^ 'collection'
    -> Text -- ^ 'playerId'
    -> MetagameListCategoriesByPlayer'
...
mlcbpCollection :: Lens' MetagameListCategoriesByPlayer' MetagameListCategoriesByPlayer'Collection
mlcbpCollection
...
mlcbpMaxResults :: Lens' MetagameListCategoriesByPlayer' (Maybe Natural)
mlcbpMaxResults
