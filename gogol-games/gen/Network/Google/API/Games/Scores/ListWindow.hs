...
-- | A resource alias for games.scores.listWindow which the
-- 'ScoresListWindow'' request conforms to.
type ScoresListWindowAPI =
     "leaderboards" :>
       Capture "leaderboardId" Text :>
         "window" :>
           Capture "collection" ScoresListWindow'Collection :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "userIp" Text :>
                   QueryParam "timeSpan" ScoresListWindow'TimeSpan :>
...
data ScoresListWindow' = ScoresListWindow'
    ...
    , _slwCollection        :: !ScoresListWindow'Collection
    , _slwTimeSpan          :: !ScoresListWindow'TimeSpan
...
-- * 'slwAlt'
scoresListWindow'
    :: ScoresListWindow'Collection -- ^ 'collection'
    -> ScoresListWindow'TimeSpan -- ^ 'timeSpan'
    -> Text -- ^ 'leaderboardId'
    -> ScoresListWindow'
...
slwCollection :: Lens' ScoresListWindow' ScoresListWindow'Collection
slwCollection
  = lens _slwCollection
      (\ s a -> s{_slwCollection = a})

-- | The time span for the scores and ranks you\'re requesting.
slwTimeSpan :: Lens' ScoresListWindow' ScoresListWindow'TimeSpan
slwTimeSpan
...
slwMaxResults :: Lens' ScoresListWindow' (Maybe Natural)
slwMaxResults
  = lens _slwMaxResults
