...
data EventUpdateRequest = EventUpdateRequest
    { _eurUpdateCount  :: !(Maybe Int64)
    , _eurKind         :: !Text
    , _eurDefinitionId :: !(Maybe Text)
...
eventUpdateRequest =
    EventUpdateRequest
    { _eurUpdateCount = Nothing
    , _eurKind = "games#eventUpdateRequest"
    , _eurDefinitionId = Nothing
    }

-- | The number of times this event occurred in this time period.
eurUpdateCount :: Lens' EventUpdateRequest (Maybe Int64)
eurUpdateCount
  = lens _eurUpdateCount
      (\ s a -> s{_eurUpdateCount = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#eventUpdateRequest.
eurKind :: Lens' EventUpdateRequest Text
eurKind = lens _eurKind (\ s a -> s{_eurKind = a})

-- | The ID of the event being modified in this update.
eurDefinitionId :: Lens' EventUpdateRequest (Maybe Text)
eurDefinitionId
...
data AchievementUpdateMultipleRequest = AchievementUpdateMultipleRequest
    { _aumrKind    :: !Text
    , _aumrUpdates :: !(Maybe [Maybe AchievementUpdateRequest])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
achievementUpdateMultipleRequest =
    AchievementUpdateMultipleRequest
    { _aumrKind = "games#achievementUpdateMultipleRequest"
    , _aumrUpdates = Nothing
    }

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#achievementUpdateMultipleRequest.
aumrKind :: Lens' AchievementUpdateMultipleRequest Text
aumrKind = lens _aumrKind (\ s a -> s{_aumrKind = a})

-- | The individual achievement update requests.
aumrUpdates :: Lens' AchievementUpdateMultipleRequest [Maybe AchievementUpdateRequest]
aumrUpdates
...
data RoomP2PStatuses = RoomP2PStatuses
    { _rppsKind    :: !Text
    , _rppsUpdates :: !(Maybe [Maybe RoomP2PStatus])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
roomP2PStatuses =
    RoomP2PStatuses
    { _rppsKind = "games#roomP2PStatuses"
    , _rppsUpdates = Nothing
    }

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#roomP2PStatuses.
rppsKind :: Lens' RoomP2PStatuses Text
rppsKind = lens _rppsKind (\ s a -> s{_rppsKind = a})

-- | The updates for the peers.
rppsUpdates :: Lens' RoomP2PStatuses [Maybe RoomP2PStatus]
rppsUpdates
...
data AchievementUpdateRequest = AchievementUpdateRequest
    { _aAchievementId          :: !(Maybe Text)
    , _aKind                   :: !Text
    , _aUpdateType             :: !(Maybe Text)
    , _aSetStepsAtLeastPayload :: !(Maybe (Maybe GamesAchievementSetStepsAtLeast))
    , _aIncrementPayload       :: !(Maybe (Maybe GamesAchievementIncrement))
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
achievementUpdateRequest =
    AchievementUpdateRequest
    { _aAchievementId = Nothing
    , _aKind = "games#achievementUpdateRequest"
    , _aUpdateType = Nothing
    , _aSetStepsAtLeastPayload = Nothing
    , _aIncrementPayload = Nothing
    }

-- | The achievement this update is being applied to.
aAchievementId :: Lens' AchievementUpdateRequest (Maybe Text)
aAchievementId
  = lens _aAchievementId
      (\ s a -> s{_aAchievementId = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#achievementUpdateRequest.
aKind :: Lens' AchievementUpdateRequest Text
...
aUpdateType :: Lens' AchievementUpdateRequest (Maybe Text)
aUpdateType
  = lens _aUpdateType (\ s a -> s{_aUpdateType = a})

-- | The payload if an update of type SET_STEPS_AT_LEAST was requested for
-- the achievement.
aSetStepsAtLeastPayload :: Lens' AchievementUpdateRequest (Maybe (Maybe GamesAchievementSetStepsAtLeast))
aSetStepsAtLeastPayload
  = lens _aSetStepsAtLeastPayload
      (\ s a -> s{_aSetStepsAtLeastPayload = a})

-- | The payload if an update of type INCREMENT was requested for the
-- achievement.
aIncrementPayload :: Lens' AchievementUpdateRequest (Maybe (Maybe GamesAchievementIncrement))
aIncrementPayload
...
data Application = Application
    { _appThemeColor           :: !(Maybe Text)
    , _appLeaderboardCount     :: !(Maybe Int32)
    , _appKind                 :: !Text
    , _appCategory             :: !(Maybe (Maybe ApplicationCategory))
    , _appName                 :: !(Maybe Text)
    , _appEnabledFeatures      :: !(Maybe [Text])
    , _appInstances            :: !(Maybe [Maybe Instance])
    , _appAuthor               :: !(Maybe Text)
    , _appId                   :: !(Maybe Text)
    , _appAchievementCount     :: !(Maybe Int32)
    , _appAssets               :: !(Maybe [Maybe ImageAsset])
    , _appDescription          :: !(Maybe Text)
    , _appLastUpdatedTimestamp :: !(Maybe Int64)
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
application =
    Application
    { _appThemeColor = Nothing
    , _appLeaderboardCount = Nothing
    , _appKind = "games#application"
    , _appCategory = Nothing
    , _appName = Nothing
    , _appEnabledFeatures = Nothing
    , _appInstances = Nothing
    , _appAuthor = Nothing
    , _appId = Nothing
    , _appAchievementCount = Nothing
    , _appAssets = Nothing
    , _appDescription = Nothing
    , _appLastUpdatedTimestamp = Nothing
    }

-- | A hint to the client UI for what color to use as an app-themed color.
-- The color is given as an RGB triplet (e.g. \"E0E0E0\").
appThemeColor :: Lens' Application (Maybe Text)
appThemeColor
  = lens _appThemeColor
      (\ s a -> s{_appThemeColor = a})

-- | The number of leaderboards visible to the currently authenticated
-- player.
appLeaderboardCount :: Lens' Application (Maybe Int32)
appLeaderboardCount
  = lens _appLeaderboardCount
      (\ s a -> s{_appLeaderboardCount = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#application.
appKind :: Lens' Application Text
appKind = lens _appKind (\ s a -> s{_appKind = a})

-- | The category of the application.
appCategory :: Lens' Application (Maybe (Maybe ApplicationCategory))
appCategory
  = lens _appCategory (\ s a -> s{_appCategory = a})
...
appEnabledFeatures :: Lens' Application [Text]
appEnabledFeatures
  = lens _appEnabledFeatures
      (\ s a -> s{_appEnabledFeatures = a})
      . _Default
      . _Coerce

-- | The instances of the application.
appInstances :: Lens' Application [Maybe Instance]
appInstances
  = lens _appInstances (\ s a -> s{_appInstances = a})
      . _Default
      . _Coerce

-- | The author of the application.
appAuthor :: Lens' Application (Maybe Text)
appAuthor
  = lens _appAuthor (\ s a -> s{_appAuthor = a})

-- | The ID of the application.
appId :: Lens' Application (Maybe Text)
appId = lens _appId (\ s a -> s{_appId = a})

-- | The number of achievements visible to the currently authenticated
-- player.
appAchievementCount :: Lens' Application (Maybe Int32)
appAchievementCount
  = lens _appAchievementCount
      (\ s a -> s{_appAchievementCount = a})

-- | The assets of the application.
appAssets :: Lens' Application [Maybe ImageAsset]
appAssets
  = lens _appAssets (\ s a -> s{_appAssets = a}) .
      _Default
      . _Coerce

-- | The description of the application.
appDescription :: Lens' Application (Maybe Text)
appDescription
  = lens _appDescription
      (\ s a -> s{_appDescription = a})

-- | The last updated timestamp of the application.
appLastUpdatedTimestamp :: Lens' Application (Maybe Int64)
appLastUpdatedTimestamp
...
data EventUpdateResponse = EventUpdateResponse
    { _ePlayerEvents  :: !(Maybe [Maybe PlayerEvent])
    , _eBatchFailures :: !(Maybe [Maybe EventBatchRecordFailure])
    , _eEventFailures :: !(Maybe [Maybe EventRecordFailure])
    , _eKind          :: !Text
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
eventUpdateResponse =
    EventUpdateResponse
    { _ePlayerEvents = Nothing
    , _eBatchFailures = Nothing
    , _eEventFailures = Nothing
    , _eKind = "games#eventUpdateResponse"
    }

-- | The current status of any updated events
ePlayerEvents :: Lens' EventUpdateResponse [Maybe PlayerEvent]
ePlayerEvents
  = lens _ePlayerEvents
      (\ s a -> s{_ePlayerEvents = a})
      . _Default
      . _Coerce

-- | Any batch-wide failures which occurred applying updates.
eBatchFailures :: Lens' EventUpdateResponse [Maybe EventBatchRecordFailure]
eBatchFailures
  = lens _eBatchFailures
      (\ s a -> s{_eBatchFailures = a})
      . _Default
      . _Coerce

-- | Any failures updating a particular event.
eEventFailures :: Lens' EventUpdateResponse [Maybe EventRecordFailure]
eEventFailures
  = lens _eEventFailures
      (\ s a -> s{_eEventFailures = a})
      . _Default
      . _Coerce
...
data Room = Room
    { _rooStatus               :: !(Maybe Text)
    , _rooVariant              :: !(Maybe Int32)
    , _rooKind                 :: !Text
    , _rooAutoMatchingStatus   :: !(Maybe (Maybe RoomAutoMatchStatus))
    , _rooCreationDetails      :: !(Maybe (Maybe RoomModification))
    , _rooInviterId            :: !(Maybe Text)
    , _rooLastUpdateDetails    :: !(Maybe (Maybe RoomModification))
    , _rooRoomStatusVersion    :: !(Maybe Int32)
    , _rooParticipants         :: !(Maybe [Maybe RoomParticipant])
    , _rooApplicationId        :: !(Maybe Text)
    , _rooAutoMatchingCriteria :: !(Maybe (Maybe RoomAutoMatchingCriteria))
    , _rooRoomId               :: !(Maybe Text)
    , _rooDescription          :: !(Maybe Text)
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
room =
    ...
    , _rooVariant = Nothing
    , _rooKind = "games#room"
    , _rooAutoMatchingStatus = Nothing
    , _rooCreationDetails = Nothing
    , _rooInviterId = Nothing
    , _rooLastUpdateDetails = Nothing
    , _rooRoomStatusVersion = Nothing
    , _rooParticipants = Nothing
    , _rooApplicationId = Nothing
    , _rooAutoMatchingCriteria = Nothing
    , _rooRoomId = Nothing
    , _rooDescription = Nothing
    }
...
rooStatus :: Lens' Room (Maybe Text)
rooStatus
  = lens _rooStatus (\ s a -> s{_rooStatus = a})

-- | The variant \/ mode of the application being played; can be any integer
-- value, or left blank.
rooVariant :: Lens' Room (Maybe Int32)
rooVariant
  = lens _rooVariant (\ s a -> s{_rooVariant = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#room.
rooKind :: Lens' Room Text
...
rooAutoMatchingStatus :: Lens' Room (Maybe (Maybe RoomAutoMatchStatus))
rooAutoMatchingStatus
  = lens _rooAutoMatchingStatus
      (\ s a -> s{_rooAutoMatchingStatus = a})

-- | Details about the room creation.
rooCreationDetails :: Lens' Room (Maybe (Maybe RoomModification))
rooCreationDetails
  = lens _rooCreationDetails
      (\ s a -> s{_rooCreationDetails = a})

-- | The ID of the participant that invited the user to the room. Not set if
-- the user was not invited to the room.
rooInviterId :: Lens' Room (Maybe Text)
rooInviterId
  = lens _rooInviterId (\ s a -> s{_rooInviterId = a})

-- | Details about the last update to the room.
rooLastUpdateDetails :: Lens' Room (Maybe (Maybe RoomModification))
rooLastUpdateDetails
  = lens _rooLastUpdateDetails
      (\ s a -> s{_rooLastUpdateDetails = a})

-- | The version of the room status: an increasing counter, used by the
-- client to ignore out-of-order updates to room status.
rooRoomStatusVersion :: Lens' Room (Maybe Int32)
rooRoomStatusVersion
  = lens _rooRoomStatusVersion
      (\ s a -> s{_rooRoomStatusVersion = a})
...
rooParticipants :: Lens' Room [Maybe RoomParticipant]
rooParticipants
  = lens _rooParticipants
      (\ s a -> s{_rooParticipants = a})
      . _Default
      . _Coerce

-- | The ID of the application being played.
rooApplicationId :: Lens' Room (Maybe Text)
rooApplicationId
  = lens _rooApplicationId
      (\ s a -> s{_rooApplicationId = a})

-- | Criteria for auto-matching players into this room.
rooAutoMatchingCriteria :: Lens' Room (Maybe (Maybe RoomAutoMatchingCriteria))
rooAutoMatchingCriteria
  = lens _rooAutoMatchingCriteria
      (\ s a -> s{_rooAutoMatchingCriteria = a})

-- | Globally unique ID for a room.
rooRoomId :: Lens' Room (Maybe Text)
rooRoomId
...
rooDescription :: Lens' Room (Maybe Text)
rooDescription
  = lens _rooDescription
      (\ s a -> s{_rooDescription = a})
          ...
          = object
              (catMaybes
                 [("status" .=) <$> _rooStatus,
                  ("variant" .=) <$> _rooVariant,
                  Just ("kind" .= _rooKind),
                  ("autoMatchingStatus" .=) <$> _rooAutoMatchingStatus,
                  ("creationDetails" .=) <$> _rooCreationDetails,
                  ("inviterId" .=) <$> _rooInviterId,
                  ("lastUpdateDetails" .=) <$> _rooLastUpdateDetails,
                  ("roomStatusVersion" .=) <$> _rooRoomStatusVersion,
                  ("participants" .=) <$> _rooParticipants,
                  ("applicationId" .=) <$> _rooApplicationId,
                  ("autoMatchingCriteria" .=) <$>
                    _rooAutoMatchingCriteria,
                  ("roomId" .=) <$> _rooRoomId,
                  ("description" .=) <$> _rooDescription])
...
data RoomCreateRequest = RoomCreateRequest
    { _rRequestId            :: !(Maybe Int64)
    , _rVariant              :: !(Maybe Int32)
    , _rNetworkDiagnostics   :: !(Maybe (Maybe NetworkDiagnostics))
    , _rKind                 :: !Text
    , _rInvitedPlayerIds     :: !(Maybe [Text])
    , _rClientAddress        :: !(Maybe (Maybe RoomClientAddress))
    , _rAutoMatchingCriteria :: !(Maybe (Maybe RoomAutoMatchingCriteria))
    , _rCapabilities         :: !(Maybe [Text])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
roomCreateRequest =
    ...
    { _rRequestId = Nothing
    , _rVariant = Nothing
    , _rNetworkDiagnostics = Nothing
    , _rKind = "games#roomCreateRequest"
    , _rInvitedPlayerIds = Nothing
    , _rClientAddress = Nothing
    , _rAutoMatchingCriteria = Nothing
    , _rCapabilities = Nothing
    }

-- | A randomly generated numeric ID. This number is used at the server to
-- ensure that the request is handled correctly across retries.
rRequestId :: Lens' RoomCreateRequest (Maybe Int64)
rRequestId
  = lens _rRequestId (\ s a -> s{_rRequestId = a})

-- | The variant \/ mode of the application to be played. This can be any
-- integer value, or left blank. You should use a small number of variants
-- to keep the auto-matching pool as large as possible.
rVariant :: Lens' RoomCreateRequest (Maybe Int32)
rVariant = lens _rVariant (\ s a -> s{_rVariant = a})

-- | Network diagnostics for the client creating the room.
rNetworkDiagnostics :: Lens' RoomCreateRequest (Maybe (Maybe NetworkDiagnostics))
rNetworkDiagnostics
  = lens _rNetworkDiagnostics
      (\ s a -> s{_rNetworkDiagnostics = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#roomCreateRequest.
rKind :: Lens' RoomCreateRequest Text
rKind = lens _rKind (\ s a -> s{_rKind = a})

-- | The player IDs to invite to the room.
rInvitedPlayerIds :: Lens' RoomCreateRequest [Text]
rInvitedPlayerIds
  = lens _rInvitedPlayerIds
      (\ s a -> s{_rInvitedPlayerIds = a})
      . _Default
      . _Coerce

-- | Client address for the player creating the room.
rClientAddress :: Lens' RoomCreateRequest (Maybe (Maybe RoomClientAddress))
rClientAddress
  = lens _rClientAddress
      (\ s a -> s{_rClientAddress = a})

-- | Criteria for auto-matching players into this room.
rAutoMatchingCriteria :: Lens' RoomCreateRequest (Maybe (Maybe RoomAutoMatchingCriteria))
rAutoMatchingCriteria
  = lens _rAutoMatchingCriteria
      (\ s a -> s{_rAutoMatchingCriteria = a})

-- | The capabilities that this client supports for realtime communication.
rCapabilities :: Lens' RoomCreateRequest [Text]
rCapabilities
  = lens _rCapabilities
      (\ s a -> s{_rCapabilities = a})
      . _Default
      . _Coerce
...
instance ToJSON RoomCreateRequest where
        toJSON RoomCreateRequest{..}
          = object
              (catMaybes
                 [("requestId" .=) <$> _rRequestId,
                  ("variant" .=) <$> _rVariant,
                  ("networkDiagnostics" .=) <$> _rNetworkDiagnostics,
                  Just ("kind" .= _rKind),
                  ("invitedPlayerIds" .=) <$> _rInvitedPlayerIds,
                  ("clientAddress" .=) <$> _rClientAddress,
                  ("autoMatchingCriteria" .=) <$>
                    _rAutoMatchingCriteria,
                  ("capabilities" .=) <$> _rCapabilities])
...
data AchievementUpdateResponse = AchievementUpdateResponse
    { _achUpdateOccurred :: !(Maybe Bool)
    , _achAchievementId  :: !(Maybe Text)
    , _achKind           :: !Text
    , _achCurrentState   :: !(Maybe Text)
    , _achNewlyUnlocked  :: !(Maybe Bool)
    , _achCurrentSteps   :: !(Maybe Int32)
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
achievementUpdateResponse =
    AchievementUpdateResponse
    { _achUpdateOccurred = Nothing
    , _achAchievementId = Nothing
    , _achKind = "games#achievementUpdateResponse"
    , _achCurrentState = Nothing
    , _achNewlyUnlocked = Nothing
    , _achCurrentSteps = Nothing
    }

-- | Whether the requested updates actually affected the achievement.
achUpdateOccurred :: Lens' AchievementUpdateResponse (Maybe Bool)
achUpdateOccurred
  = lens _achUpdateOccurred
      (\ s a -> s{_achUpdateOccurred = a})

-- | The achievement this update is was applied to.
achAchievementId :: Lens' AchievementUpdateResponse (Maybe Text)
achAchievementId
  = lens _achAchievementId
      (\ s a -> s{_achAchievementId = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#achievementUpdateResponse.
achKind :: Lens' AchievementUpdateResponse Text
achKind = lens _achKind (\ s a -> s{_achKind = a})

-- | The current state of the achievement. Possible values are: - \"HIDDEN\"
-- - Achievement is hidden. - \"REVEALED\" - Achievement is revealed. -
-- \"UNLOCKED\" - Achievement is unlocked.
achCurrentState :: Lens' AchievementUpdateResponse (Maybe Text)
achCurrentState
  = lens _achCurrentState
      (\ s a -> s{_achCurrentState = a})

-- | Whether this achievement was newly unlocked (that is, whether the unlock
-- request for the achievement was the first for the player).
achNewlyUnlocked :: Lens' AchievementUpdateResponse (Maybe Bool)
achNewlyUnlocked
  = lens _achNewlyUnlocked
      (\ s a -> s{_achNewlyUnlocked = a})

-- | The current steps recorded for this achievement if it is incremental.
achCurrentSteps :: Lens' AchievementUpdateResponse (Maybe Int32)
achCurrentSteps
...
data AchievementUpdateMultipleResponse = AchievementUpdateMultipleResponse
    { _aumruKind                :: !Text
    , _aumruUpdatedAchievements :: !(Maybe [Maybe AchievementUpdateResponse])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
achievementUpdateMultipleResponse =
    AchievementUpdateMultipleResponse
    { _aumruKind = "games#achievementUpdateMultipleResponse"
    , _aumruUpdatedAchievements = Nothing
    }

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#achievementUpdateListResponse.
aumruKind :: Lens' AchievementUpdateMultipleResponse Text
aumruKind
  = lens _aumruKind (\ s a -> s{_aumruKind = a})

-- | The updated state of the achievements.
aumruUpdatedAchievements :: Lens' AchievementUpdateMultipleResponse [Maybe AchievementUpdateResponse]
aumruUpdatedAchievements
  = lens _aumruUpdatedAchievements
...
data RoomP2PStatus = RoomP2PStatus
    { _rppssStatus                           :: !(Maybe Text)
    , _rppssParticipantId                    :: !(Maybe Text)
    , _rppssKind                             :: !Text
    , _rppssError                            :: !(Maybe Text)
    , _rppssErrorReason                      :: !(Maybe Text)
    , _rppssConnectionSetupLatencyMillis     :: !(Maybe Int32)
    , _rppssUnreliableRoundtripLatencyMillis :: !(Maybe Int32)
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
roomP2PStatus =
    RoomP2PStatus
    { _rppssStatus = Nothing
    , _rppssParticipantId = Nothing
    , _rppssKind = "games#roomP2PStatus"
    , _rppssError = Nothing
    , _rppssErrorReason = Nothing
    , _rppssConnectionSetupLatencyMillis = Nothing
    , _rppssUnreliableRoundtripLatencyMillis = Nothing
    }
...
rppssStatus :: Lens' RoomP2PStatus (Maybe Text)
rppssStatus
  = lens _rppssStatus (\ s a -> s{_rppssStatus = a})

-- | The ID of the participant.
rppssParticipantId :: Lens' RoomP2PStatus (Maybe Text)
rppssParticipantId
  = lens _rppssParticipantId
      (\ s a -> s{_rppssParticipantId = a})

-- | Uniquely identifies the type of this resource. Value is always the fixed
-- string games#roomP2PStatus.
rppssKind :: Lens' RoomP2PStatus Text
rppssKind
...
rppssError :: Lens' RoomP2PStatus (Maybe Text)
rppssError
  = lens _rppssError (\ s a -> s{_rppssError = a})

-- | More detailed diagnostic message returned in event of a failure.
rppssErrorReason :: Lens' RoomP2PStatus (Maybe Text)
rppssErrorReason
  = lens _rppssErrorReason
      (\ s a -> s{_rppssErrorReason = a})

-- | The amount of time in milliseconds it took to establish connections with
-- this peer.
rppssConnectionSetupLatencyMillis :: Lens' RoomP2PStatus (Maybe Int32)
rppssConnectionSetupLatencyMillis
  = lens _rppssConnectionSetupLatencyMillis
      (\ s a -> s{_rppssConnectionSetupLatencyMillis = a})

-- | The amount of time in milliseconds it took to send packets back and
-- forth on the unreliable channel with this peer.
rppssUnreliableRoundtripLatencyMillis :: Lens' RoomP2PStatus (Maybe Int32)
rppssUnreliableRoundtripLatencyMillis
  = lens _rppssUnreliableRoundtripLatencyMillis
      (\ s a ->
