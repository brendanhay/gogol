...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotationSets.delete@.
module Network.Google.API.Genomics.AnnotationSets.Delete
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotationSets.delete which the
