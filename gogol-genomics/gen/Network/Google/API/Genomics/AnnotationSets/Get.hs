...
-- associated dataset.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotationSets.get@.
module Network.Google.API.Genomics.AnnotationSets.Get
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotationSets.get which the
