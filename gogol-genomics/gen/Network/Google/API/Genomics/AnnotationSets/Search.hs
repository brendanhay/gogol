...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotationSets.search@.
module Network.Google.API.Genomics.AnnotationSets.Search
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotationSets.search which the
