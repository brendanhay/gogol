...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotations.batchCreate@.
module Network.Google.API.Genomics.Annotations.BatchCreate
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotations.batchCreate which the
