...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotations.create@.
module Network.Google.API.Genomics.Annotations.Create
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotations.create which the
