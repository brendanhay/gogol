...
-- annotation set.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotations.get@.
module Network.Google.API.Genomics.Annotations.Get
    (
    -- * REST Resource
      AnnotationsGetAPI
...
-- | A resource alias for genomics.annotations.get which the
