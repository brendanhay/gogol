...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotations.patch@.
module Network.Google.API.Genomics.Annotations.Patch
    (
    -- * REST Resource
      AnnotationsPatchAPI
...
-- | A resource alias for genomics.annotations.patch which the
