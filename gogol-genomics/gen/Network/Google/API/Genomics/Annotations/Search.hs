...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotations.search@.
module Network.Google.API.Genomics.Annotations.Search
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotations.search which the
