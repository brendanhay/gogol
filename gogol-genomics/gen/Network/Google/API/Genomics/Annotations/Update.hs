...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.annotations.update@.
module Network.Google.API.Genomics.Annotations.Update
    (
    -- * REST Resource
...
-- | A resource alias for genomics.annotations.update which the
