...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.callsets.create@.
module Network.Google.API.Genomics.Callsets.Create
    (
    -- * REST Resource
      CallsetsCreateAPI
...
-- | A resource alias for genomics.callsets.create which the
