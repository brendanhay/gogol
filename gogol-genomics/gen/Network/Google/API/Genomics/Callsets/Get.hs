...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.callsets.get@.
module Network.Google.API.Genomics.Callsets.Get
    (
    -- * REST Resource
      CallsetsGetAPI
...
-- | A resource alias for genomics.callsets.get which the
