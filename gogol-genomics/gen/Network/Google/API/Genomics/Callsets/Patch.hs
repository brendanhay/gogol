...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.callsets.patch@.
module Network.Google.API.Genomics.Callsets.Patch
    (
    -- * REST Resource
      CallsetsPatchAPI
...
-- | A resource alias for genomics.callsets.patch which the
