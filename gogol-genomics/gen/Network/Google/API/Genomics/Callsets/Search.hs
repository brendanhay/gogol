...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.callsets.search@.
module Network.Google.API.Genomics.Callsets.Search
    (
    -- * REST Resource
      CallsetsSearchAPI
...
-- | A resource alias for genomics.callsets.search which the
