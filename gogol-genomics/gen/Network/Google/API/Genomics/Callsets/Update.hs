...
-- | Updates a call set.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.callsets.update@.
module Network.Google.API.Genomics.Callsets.Update
    (
    -- * REST Resource
      CallsetsUpdateAPI
...
-- | A resource alias for genomics.callsets.update which the
