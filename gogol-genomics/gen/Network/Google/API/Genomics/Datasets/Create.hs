...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.datasets.create@.
module Network.Google.API.Genomics.Datasets.Create
    (
    -- * REST Resource
      DatasetsCreateAPI
...
-- | A resource alias for genomics.datasets.create which the
