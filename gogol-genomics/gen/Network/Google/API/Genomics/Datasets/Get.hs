...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.datasets.get@.
module Network.Google.API.Genomics.Datasets.Get
    (
    -- * REST Resource
      DatasetsGetAPI
...
-- | A resource alias for genomics.datasets.get which the
