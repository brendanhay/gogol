...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.datasets.list@.
module Network.Google.API.Genomics.Datasets.List
    (
    -- * REST Resource
      DatasetsListAPI
...
-- | A resource alias for genomics.datasets.list which the
