...
-- occurred.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.datasets.undelete@.
module Network.Google.API.Genomics.Datasets.Undelete
    (
    -- * REST Resource
      DatasetsUndeleteAPI
...
-- | A resource alias for genomics.datasets.undelete which the
