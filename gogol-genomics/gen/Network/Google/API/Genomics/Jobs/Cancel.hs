...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.jobs.cancel@.
module Network.Google.API.Genomics.Jobs.Cancel
    (
    -- * REST Resource
      JobsCancelAPI
...
-- | A resource alias for genomics.jobs.cancel which the
