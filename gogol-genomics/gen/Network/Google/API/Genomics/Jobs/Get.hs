...
-- | Gets a job by ID.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.jobs.get@.
module Network.Google.API.Genomics.Jobs.Get
    (
    -- * REST Resource
      JobsGetAPI
...
-- | A resource alias for genomics.jobs.get which the
