...
-- group set.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.readgroupsets.coveragebuckets.list@.
module Network.Google.API.Genomics.Readgroupsets.Coveragebuckets.List
    (
    -- * REST Resource
...
-- | A resource alias for genomics.readgroupsets.coveragebuckets.list which the
