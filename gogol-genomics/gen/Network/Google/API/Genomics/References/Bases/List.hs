...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.references.bases.list@.
module Network.Google.API.Genomics.References.Bases.List
    (
    -- * REST Resource
...
-- | A resource alias for genomics.references.bases.list which the
