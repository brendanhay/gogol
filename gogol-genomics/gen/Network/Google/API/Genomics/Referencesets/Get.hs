...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.referencesets.get@.
module Network.Google.API.Genomics.Referencesets.Get
    (
    -- * REST Resource
      ReferencesetsGetAPI
...
-- | A resource alias for genomics.referencesets.get which the
...
refAlt :: Lens' ReferencesetsGet' Alt
...
instance GoogleRequest ReferencesetsGet' where
        ...
        requestWithRoute r u ReferencesetsGet'{..}
          = go _refReferenceSetId _refQuotaUser
