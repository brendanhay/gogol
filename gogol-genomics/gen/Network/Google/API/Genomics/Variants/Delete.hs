...
-- | Deletes a variant.
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.variants.delete@.
module Network.Google.API.Genomics.Variants.Delete
    (
    -- * REST Resource
      VariantsDeleteAPI
...
-- | A resource alias for genomics.variants.delete which the
