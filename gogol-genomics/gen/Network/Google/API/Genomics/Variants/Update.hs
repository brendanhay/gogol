...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.variants.update@.
module Network.Google.API.Genomics.Variants.Update
    (
    -- * REST Resource
      VariantsUpdateAPI
...
-- | A resource alias for genomics.variants.update which the
