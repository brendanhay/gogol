...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.variantsets.export@.
module Network.Google.API.Genomics.Variantsets.Export
    (
    -- * REST Resource
...
-- | A resource alias for genomics.variantsets.export which the
