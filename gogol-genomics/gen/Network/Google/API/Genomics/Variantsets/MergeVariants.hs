...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.variantsets.mergeVariants@.
module Network.Google.API.Genomics.Variantsets.MergeVariants
    (
    -- * REST Resource
...
-- | A resource alias for genomics.variantsets.mergeVariants which the
