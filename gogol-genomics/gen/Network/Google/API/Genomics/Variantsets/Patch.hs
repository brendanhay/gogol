...
--
-- /See:/ <https://developers.google.com/genomics/v1beta2/reference Genomics API Reference> for @genomics.variantsets.patch@.
module Network.Google.API.Genomics.Variantsets.Patch
    (
    -- * REST Resource
      VariantsetsPatchAPI
...
-- | A resource alias for genomics.variantsets.patch which the
