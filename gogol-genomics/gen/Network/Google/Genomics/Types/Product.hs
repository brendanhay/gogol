...
data SearchReadsResponse = SearchReadsResponse
    ...
    , _srrAlignments    :: !(Maybe [Maybe Read])
...
-- results.
srrNextPageToken :: Lens' SearchReadsResponse (Maybe Text)
srrNextPageToken
...
srrAlignments :: Lens' SearchReadsResponse [Maybe Read]
srrAlignments
  = lens _srrAlignments
...
data SearchReferencesRequest = SearchReferencesRequest
    { _srrReferenceSetId :: !(Maybe Text)
    , _srrMd5checksums   :: !(Maybe [Text])
    , _srrAccessions     :: !(Maybe [Text])
...
searchReferencesRequest =
    SearchReferencesRequest
    { _srrReferenceSetId = Nothing
    , _srrMd5checksums = Nothing
    , _srrAccessions = Nothing
    , _srrPageToken = Nothing
    , _srrPageSize = Nothing
    }

-- | If present, return only references which belong to this reference set.
srrReferenceSetId :: Lens' SearchReferencesRequest (Maybe Text)
srrReferenceSetId
  = lens _srrReferenceSetId
      (\ s a -> s{_srrReferenceSetId = a})

-- | If present, return references for which the md5checksum matches. See
-- Reference.md5checksum for construction details.
srrMd5checksums :: Lens' SearchReferencesRequest [Text]
srrMd5checksums
  = lens _srrMd5checksums
      (\ s a -> s{_srrMd5checksums = a})
      . _Default
      . _Coerce
...
srrAccessions :: Lens' SearchReferencesRequest [Text]
srrAccessions
  = lens _srrAccessions
      (\ s a -> s{_srrAccessions = a})
      . _Default
      . _Coerce
...
-- To get the next page of results, set this parameter to the value of
-- nextPageToken from the previous response.
srrPageToken :: Lens' SearchReferencesRequest (Maybe Text)
srrPageToken
  = lens _srrPageToken (\ s a -> s{_srrPageToken = a})

-- | Specifies the maximum number of results to return in a single page.
srrPageSize :: Lens' SearchReferencesRequest (Maybe Int32)
srrPageSize
...
searchReadsRequest =
    SearchReadsRequest
    { _sStart = Nothing
    , _sReadGroupIds = Nothing
    , _sReferenceName = Nothing
    , _sEnd = Nothing
    , _sPageToken = Nothing
    , _sPageSize = Nothing
    , _sReadGroupSetIds = Nothing
    }

-- | The start position of the range on the reference, 0-based inclusive. If
-- specified, referenceName must also be specified.
sStart :: Lens' SearchReadsRequest (Maybe Int64)
...
sReadGroupIds :: Lens' SearchReadsRequest [Text]
sReadGroupIds
  = lens _sReadGroupIds
      (\ s a -> s{_sReadGroupIds = a})
      . _Default
      . _Coerce

-- | The reference sequence name, for example chr1, 1, or chrX. If set to *,
-- only unmapped reads are returned.
sReferenceName :: Lens' SearchReadsRequest (Maybe Text)
sReferenceName
...
-- | The end position of the range on the reference, 0-based exclusive. If
-- specified, referenceName must also be specified.
sEnd :: Lens' SearchReadsRequest (Maybe Int64)
sEnd = lens _sEnd (\ s a -> s{_sEnd = a})

-- | The continuation token, which is used to page through large result sets.
-- To get the next page of results, set this parameter to the value of
-- nextPageToken from the previous response.
sPageToken :: Lens' SearchReadsRequest (Maybe Text)
sPageToken
  = lens _sPageToken (\ s a -> s{_sPageToken = a})

-- | Specifies number of results to return in a single page. If unspecified,
-- it will default to 256. The maximum value is 2048.
sPageSize :: Lens' SearchReadsRequest (Maybe Int32)
sPageSize
...
sReadGroupSetIds :: Lens' SearchReadsRequest [Text]
sReadGroupSetIds
  = lens _sReadGroupSetIds
      (\ s a -> s{_sReadGroupSetIds = a})
      . _Default
      . _Coerce
...
data Variant = Variant
    { _vvVariantSetId   :: !(Maybe Text)
    , _vvCreated        :: !(Maybe Int64)
    , _vvStart          :: !(Maybe Int64)
    , _vvAlternateBases :: !(Maybe [Text])
    , _vvReferenceName  :: !(Maybe Text)
    , _vvNames          :: !(Maybe [Text])
    , _vvEnd            :: !(Maybe Int64)
    , _vvReferenceBases :: !(Maybe Text)
    , _vvId             :: !(Maybe Text)
    , _vvQuality        :: !(Maybe Double)
    , _vvFilter         :: !(Maybe [Text])
    , _vvInfo           :: !(Maybe VariantInfo)
    , _vvCalls          :: !(Maybe [Maybe Call])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
variant =
    Variant
    { _vvVariantSetId = Nothing
    , _vvCreated = Nothing
    , _vvStart = Nothing
    , _vvAlternateBases = Nothing
    , _vvReferenceName = Nothing
    , _vvNames = Nothing
    , _vvEnd = Nothing
    , _vvReferenceBases = Nothing
    , _vvId = Nothing
    , _vvQuality = Nothing
    , _vvFilter = Nothing
    , _vvInfo = Nothing
...
vvVariantSetId :: Lens' Variant (Maybe Text)
vvVariantSetId
  = lens _vvVariantSetId
      (\ s a -> s{_vvVariantSetId = a})

-- | The date this variant was created, in milliseconds from the epoch.
vvCreated :: Lens' Variant (Maybe Int64)
vvCreated
  = lens _vvCreated (\ s a -> s{_vvCreated = a})

-- | The position at which this variant occurs (0-based). This corresponds to
-- the first base of the string of reference bases.
vvStart :: Lens' Variant (Maybe Int64)
vvStart = lens _vvStart (\ s a -> s{_vvStart = a})

-- | The bases that appear instead of the reference bases.
vvAlternateBases :: Lens' Variant [Text]
vvAlternateBases
  = lens _vvAlternateBases
      (\ s a -> s{_vvAlternateBases = a})
      . _Default
      . _Coerce

-- | The reference on which this variant occurs. (such as chr20 or X)
vvReferenceName :: Lens' Variant (Maybe Text)
vvReferenceName
  = lens _vvReferenceName
      (\ s a -> s{_vvReferenceName = a})

-- | Names for the variant, for example a RefSNP ID.
vvNames :: Lens' Variant [Text]
vvNames
  = lens _vvNames (\ s a -> s{_vvNames = a}) . _Default
      . _Coerce
...
-- deletions.
vvEnd :: Lens' Variant (Maybe Int64)
vvEnd = lens _vvEnd (\ s a -> s{_vvEnd = a})

-- | The reference bases for this variant. They start at the given position.
vvReferenceBases :: Lens' Variant (Maybe Text)
vvReferenceBases
  = lens _vvReferenceBases
      (\ s a -> s{_vvReferenceBases = a})

-- | The Google generated ID of the variant, immutable.
vvId :: Lens' Variant (Maybe Text)
vvId = lens _vvId (\ s a -> s{_vvId = a})

-- | A measure of how likely this variant is to be real. A higher value is
-- better.
vvQuality :: Lens' Variant (Maybe Double)
vvQuality
  = lens _vvQuality (\ s a -> s{_vvQuality = a})

-- | A list of filters (normally quality filters) this variant has failed.
-- PASS indicates this variant has passed all filters.
vvFilter :: Lens' Variant [Text]
vvFilter
  = lens _vvFilter (\ s a -> s{_vvFilter = a}) .
      _Default
      . _Coerce

-- | A string which maps to an array of values.
vvInfo :: Lens' Variant (Maybe VariantInfo)
vvInfo = lens _vvInfo (\ s a -> s{_vvInfo = a})

-- | The variant calls for this particular variant. Each one represents the
-- determination of genotype with respect to this variant.
vvCalls :: Lens' Variant [Maybe Call]
vvCalls
  = lens _vvCalls (\ s a -> s{_vvCalls = a}) . _Default
      . _Coerce
...
instance ToJSON Variant where
        toJSON Variant{..}
          = object
              (catMaybes
                 [("variantSetId" .=) <$> _vvVariantSetId,
                  ("created" .=) <$> _vvCreated,
                  ("start" .=) <$> _vvStart,
                  ("alternateBases" .=) <$> _vvAlternateBases,
                  ("referenceName" .=) <$> _vvReferenceName,
                  ("names" .=) <$> _vvNames, ("end" .=) <$> _vvEnd,
                  ("referenceBases" .=) <$> _vvReferenceBases,
                  ("id" .=) <$> _vvId, ("quality" .=) <$> _vvQuality,
                  ("filter" .=) <$> _vvFilter, ("info" .=) <$> _vvInfo,
                  ("calls" .=) <$> _vvCalls])
...
data SearchReferencesResponse = SearchReferencesResponse
    ...
    , _sReferences    :: !(Maybe [Maybe Reference])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
-- results. This field will be empty if there aren\'t any additional
-- results.
sNextPageToken :: Lens' SearchReferencesResponse (Maybe Text)
sNextPageToken
  = lens _sNextPageToken
      (\ s a -> s{_sNextPageToken = a})

-- | The matching references.
sReferences :: Lens' SearchReferencesResponse [Maybe Reference]
sReferences
...
data SearchJobsRequest = SearchJobsRequest
    ...
    , _sjrStatus        :: !(Maybe [SearchJobsRequestItemStatus])
...
sjrStatus :: Lens' SearchJobsRequest [SearchJobsRequestItemStatus]
sjrStatus
...
data SearchAnnotationSetsRequest = SearchAnnotationSetsRequest
    ...
    , _sasrTypes          :: !(Maybe [SearchAnnotationSetsRequestItemTypes])
...
-- returned.
sasrTypes :: Lens' SearchAnnotationSetsRequest [SearchAnnotationSetsRequestItemTypes]
sasrTypes
