...
-- | A resource alias for @GenomicsReadgroupsetsCall@ method which the
...
-- token.
rcKey :: Lens' ReadgroupsetsCall' (Maybe AuthKey)
...
instance GoogleRequest ReadgroupsetsCall' where
        ...
        requestWith rq ReadgroupsetsCall'{..}
