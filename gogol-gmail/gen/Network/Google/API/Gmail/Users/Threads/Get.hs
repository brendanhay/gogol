...
-- | A resource alias for gmail.users.threads.get which the
           ...
           QueryParam "quotaUser" Text :>
             QueryParam "prettyPrint" Bool :>
               QueryParam "userIp" Text :>
                 QueryParam "format" UsersThreadsGet'Format :>
                   QueryParam "key" Text :>
...
data UsersThreadsGet' = UsersThreadsGet'
    ...
    , _utgFormat          :: !UsersThreadsGet'Format
    , _utgUserId          :: !Text
    , _utgKey             :: !(Maybe Text)
    , _utgId              :: !Text
...
utgFormat :: Lens' UsersThreadsGet' UsersThreadsGet'Format
utgFormat
