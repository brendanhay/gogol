...
-- |
-- Module      : Network.Google.Healthcare.Projects.Locations.Datasets.Create
...
type HealthcareProjectsLocationsDatasetsCreateResource =
  "v1"
    ...
    Core.:> Core.QueryParam "datasetId" Core.Text
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsCreate =
      Operation
  type
    Scopes HealthcareProjectsLocationsDatasetsCreate =
