...
-- |
-- Module      : Network.Google.Healthcare.Projects.Locations.Datasets.Deidentify
...
type HealthcareProjectsLocationsDatasetsDeidentifyResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] DeidentifyDatasetRequest
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsDeidentify =
      Operation
  type
    Scopes
      HealthcareProjectsLocationsDatasetsDeidentify =
