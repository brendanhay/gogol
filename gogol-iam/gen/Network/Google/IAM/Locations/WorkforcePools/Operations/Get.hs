...
-- |
-- Module      : Network.Google.IAM.Locations.WorkforcePools.Operations.Get
...
instance
  ...
  where
  type
    Rs IAMLocationsWorkforcePoolsOperationsGet =
      Operation
  type
    Scopes IAMLocationsWorkforcePoolsOperationsGet =
