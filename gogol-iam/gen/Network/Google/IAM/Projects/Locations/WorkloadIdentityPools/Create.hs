...
-- |
-- Module      : Network.Google.IAM.Projects.Locations.WorkloadIdentityPools.Create
...
type IAMProjectsLocationsWorkloadIdentityPoolsCreateResource =
  "v1"
    ...
    Core.:> Core.QueryParam "workloadIdentityPoolId" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.ReqBody '[Core.JSON] WorkloadIdentityPool
