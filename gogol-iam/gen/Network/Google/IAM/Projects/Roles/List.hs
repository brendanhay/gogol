...
-- |
-- Module      : Network.Google.IAM.Projects.Roles.List
...
type IAMProjectsRolesListResource =
  "v1"
    ...
    Core.:> Core.QueryParam "view" ProjectsRolesListView
...
instance Core.GoogleRequest IAMProjectsRolesList where
  type Rs IAMProjectsRolesList = ListRolesResponse
  type
    Scopes IAMProjectsRolesList =
