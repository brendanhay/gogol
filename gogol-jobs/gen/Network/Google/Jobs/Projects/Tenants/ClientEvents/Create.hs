...
-- |
-- Module      : Network.Google.Jobs.Projects.Tenants.ClientEvents.Create
...
type JobsProjectsTenantsClientEventsCreateResource =
  "v4"
    ...
    Core.:> Core.ReqBody '[Core.JSON] ClientEvent
    Core.:> Core.Post '[Core.JSON] ClientEvent
...
instance
  ...
  where
  type
    Rs JobsProjectsTenantsClientEventsCreate =
      ClientEvent
  type
    Scopes JobsProjectsTenantsClientEventsCreate =
