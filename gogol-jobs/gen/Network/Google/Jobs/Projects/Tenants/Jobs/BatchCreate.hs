...
-- |
-- Module      : Network.Google.Jobs.Projects.Tenants.Jobs.BatchCreate
...
type JobsProjectsTenantsJobsBatchCreateResource =
  "v4"
    ...
    Core.:> Core.ReqBody '[Core.JSON] BatchCreateJobsRequest
...
instance
  ...
  where
  type
    Rs JobsProjectsTenantsJobsBatchCreate =
      Operation
  type
    Scopes JobsProjectsTenantsJobsBatchCreate =
