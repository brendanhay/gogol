...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logServices.sinks.delete@.
module Network.Google.API.Logging.Projects.LogServices.Sinks.Delete
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logServices.sinks.delete which the
...
instance GoogleRequest
        ...
        requestWithRoute r u
          ProjectsLogServicesSinksDelete'{..}
          = go _plssdXgafv _plssdQuotaUser
