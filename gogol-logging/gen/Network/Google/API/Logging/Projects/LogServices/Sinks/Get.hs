...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logServices.sinks.get@.
module Network.Google.API.Logging.Projects.LogServices.Sinks.Get
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logServices.sinks.get which the
...
instance GoogleRequest ProjectsLogServicesSinksGet'
        ...
        requestWithRoute r u ProjectsLogServicesSinksGet'{..}
          = go _plssgXgafv _plssgQuotaUser
