...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logServices.sinks.update@.
module Network.Google.API.Logging.Projects.LogServices.Sinks.Update
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logServices.sinks.update which the
