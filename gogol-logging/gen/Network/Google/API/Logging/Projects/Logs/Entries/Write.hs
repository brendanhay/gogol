...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logs.entries.write@.
module Network.Google.API.Logging.Projects.Logs.Entries.Write
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logs.entries.write which the
