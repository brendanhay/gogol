...
-- the destination.
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logs.sinks.create@.
module Network.Google.API.Logging.Projects.Logs.Sinks.Create
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logs.sinks.create which the
