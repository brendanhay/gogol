...
-- | Gets a log sink.
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logs.sinks.get@.
module Network.Google.API.Logging.Projects.Logs.Sinks.Get
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logs.sinks.get which the
