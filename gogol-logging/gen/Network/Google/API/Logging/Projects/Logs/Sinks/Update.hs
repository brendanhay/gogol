...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Google Cloud Logging API Reference> for @logging.projects.logs.sinks.update@.
module Network.Google.API.Logging.Projects.Logs.Sinks.Update
    (
    -- * REST Resource
...
-- | A resource alias for logging.projects.logs.sinks.update which the
