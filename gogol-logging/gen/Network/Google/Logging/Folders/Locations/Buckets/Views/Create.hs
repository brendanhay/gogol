...
-- |
-- Module      : Network.Google.Logging.Folders.Locations.Buckets.Views.Create
...
instance
  ...
  where
  type
    Rs LoggingFoldersLocationsBucketsViewsCreate =
      LogView
  type
    Scopes LoggingFoldersLocationsBucketsViewsCreate =
