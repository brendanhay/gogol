...
-- |
-- Module      : Network.Google.Logging.Folders.Locations.Buckets.Views.Delete
...
instance
  ...
  where
  type
    Rs LoggingFoldersLocationsBucketsViewsDelete =
      Empty
  type
    Scopes LoggingFoldersLocationsBucketsViewsDelete =
