...
-- |
-- Module      : Network.Google.Logging.Folders.Locations.Buckets.Views.Get
...
instance
  ...
  where
  type
    Rs LoggingFoldersLocationsBucketsViewsGet =
      LogView
  type
    Scopes LoggingFoldersLocationsBucketsViewsGet =
