...
-- |
-- Module      : Network.Google.Logging.Folders.Locations.Buckets.Views.List
...
instance
  ...
  where
  type
    Rs LoggingFoldersLocationsBucketsViewsList =
      ListViewsResponse
  type
    Scopes LoggingFoldersLocationsBucketsViewsList =
