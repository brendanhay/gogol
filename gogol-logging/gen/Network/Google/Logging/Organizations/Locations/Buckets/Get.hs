...
-- |
-- Module      : Network.Google.Logging.Organizations.Locations.Buckets.Get
...
instance
  ...
  where
  type
    Rs LoggingOrganizationsLocationsBucketsGet =
      LogBucket
  type
    Scopes LoggingOrganizationsLocationsBucketsGet =
