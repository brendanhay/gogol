...
-- |
-- Module      : Network.Google.Logging.Organizations.Locations.Buckets.List
...
instance
  ...
  where
  type
    Rs LoggingOrganizationsLocationsBucketsList =
      ListBucketsResponse
  type
    Scopes LoggingOrganizationsLocationsBucketsList =
