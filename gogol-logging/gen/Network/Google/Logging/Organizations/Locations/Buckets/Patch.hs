...
-- |
-- Module      : Network.Google.Logging.Organizations.Locations.Buckets.Patch
...
instance
  ...
  where
  type
    Rs LoggingOrganizationsLocationsBucketsPatch =
      LogBucket
  type
    Scopes LoggingOrganizationsLocationsBucketsPatch =
