...
-- |
-- Module      : Network.Google.Logging.Projects.Locations.Buckets.Undelete
...
instance
  ...
  where
  type
    Rs LoggingProjectsLocationsBucketsUndelete =
      Empty
  type
    Scopes LoggingProjectsLocationsBucketsUndelete =
