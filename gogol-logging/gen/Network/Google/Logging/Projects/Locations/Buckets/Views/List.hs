...
-- |
-- Module      : Network.Google.Logging.Projects.Locations.Buckets.Views.List
...
instance
  ...
  where
  type
    Rs LoggingProjectsLocationsBucketsViewsList =
      ListViewsResponse
  type
    Scopes LoggingProjectsLocationsBucketsViewsList =
