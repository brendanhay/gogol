...
--
-- /See:/ <https://developers.google.com/coordinate/ Google Maps Coordinate API Reference> for @coordinate.jobs.update@.
module Network.Google.API.Coordinate.Jobs.Update
    (
    -- * REST Resource
      JobsUpdateAPI
...
-- | A resource alias for coordinate.jobs.update which the
           ...
           Capture "jobId" Word64 :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "progress" JobsUpdate'Progress :>
...
data JobsUpdate' = JobsUpdate'
    ...
    , _juPrettyPrint         :: !Bool
    , _juJobId               :: !Word64
    , _juProgress            :: !(Maybe JobsUpdate'Progress)
    , _juNote                :: !(Maybe Text)
...
-- | Job progress
juProgress :: Lens' JobsUpdate' (Maybe JobsUpdate'Progress)
juProgress
