...
-- | A resource alias for mapsengine.rasterCollections.rasters.list which the
-- 'RasterCollectionsRastersList'' request conforms to.
type RasterCollectionsRastersListAPI =
     "rasterCollections" :>
       Capture "id" Text :>
         "rasters" :>
               ...
               QueryParam "prettyPrint" Bool :>
                 QueryParam "userIp" Text :>
                   QueryParam "creatorEmail" Text :>
                     QueryParam "role" RasterCollectionsRastersList'Role
                       :>
                       QueryParam "key" Text :>
...
data RasterCollectionsRastersList' = RasterCollectionsRastersList'
    ...
    , _rcrlRole           :: !(Maybe RasterCollectionsRastersList'Role)
    , _rcrlKey            :: !(Maybe Text)
...
rcrlRole :: Lens' RasterCollectionsRastersList' (Maybe RasterCollectionsRastersList'Role)
...
instance GoogleRequest RasterCollectionsRastersList'
        ...
        requestWithRoute r u
          ...
          where go
                  = clientWithRoute
                      (Proxy :: Proxy RasterCollectionsRastersListAPI)
                      r
                      u
