...
-- | A resource alias for mapsengine.tables.features.get which the
             ...
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "userIp" Text :>
                   QueryParam "key" Text :>
                     QueryParam "version" TablesFeaturesGet'Version :>
...
data TablesFeaturesGet' = TablesFeaturesGet'
    ...
    , _tfgKey         :: !(Maybe Text)
    , _tfgVersion     :: !(Maybe TablesFeaturesGet'Version)
    , _tfgId          :: !Text
...
tfgVersion :: Lens' TablesFeaturesGet' (Maybe TablesFeaturesGet'Version)
tfgVersion
