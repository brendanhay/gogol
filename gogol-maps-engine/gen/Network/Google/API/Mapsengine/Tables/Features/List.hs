...
-- | A resource alias for mapsengine.tables.features.list which the
                 ...
                 QueryParam "where" Text :>
                   QueryParam "orderBy" Text :>
                     QueryParam "userIp" Text :>
                       QueryParam "key" Text :>
                         QueryParam "version" TablesFeaturesList'Version :>
...
data TablesFeaturesList' = TablesFeaturesList'
    ...
    , _tflKey         :: !(Maybe Text)
    , _tflVersion     :: !(Maybe TablesFeaturesList'Version)
    , _tflId          :: !Text
...
tflVersion :: Lens' TablesFeaturesList' (Maybe TablesFeaturesList'Version)
tflVersion
