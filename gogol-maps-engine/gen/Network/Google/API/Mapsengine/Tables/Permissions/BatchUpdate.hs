...
-- is atomic.
--
-- /See:/ <https://developers.google.com/maps-engine/ Google Maps Engine API Reference> for @mapsengine.tables.permissions.batchUpdate@.
module Network.Google.API.Mapsengine.Tables.Permissions.BatchUpdate
    (
    -- * REST Resource
...
-- | A resource alias for mapsengine.tables.permissions.batchUpdate which the
