...
-- |
-- Module      : Network.Google.Mirror.Timeline.List
...
type MirrorTimelineListResource =
  "mirror"
    Core.:> "v1"
    Core.:> "timeline"
    Core.:> Core.QueryParam "bundleId" Core.Text
    Core.:> Core.QueryParam "includeDeleted" Core.Bool
    Core.:> Core.QueryParam "maxResults" Core.Word32
    Core.:> Core.QueryParam "orderBy" TimelineListOrderBy
    Core.:> Core.QueryParam "pageToken" Core.Text
    Core.:> Core.QueryParam "pinnedOnly" Core.Bool
    Core.:> Core.QueryParam "sourceItemId" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.Get '[Core.JSON] TimelineListResponse
