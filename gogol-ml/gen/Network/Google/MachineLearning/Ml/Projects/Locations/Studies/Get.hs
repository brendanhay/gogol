...
-- |
-- Module      : Network.Google.MachineLearning.Ml.Projects.Locations.Studies.Get
...
type MlProjectsLocationsStudiesGetResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] GoogleCloudMlV1__Study
...
instance
  ...
  where
  type
    Rs MlProjectsLocationsStudiesGet =
      GoogleCloudMlV1__Study
  type
    Scopes MlProjectsLocationsStudiesGet =
