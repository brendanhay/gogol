...
-- | A resource alias for pagespeedonline.pagespeedapi.runpagespeed which the
...
data PagespeedapiRunpagespeed' = PagespeedapiRunpagespeed'
    ...
    , _prStrategy                  :: !(Maybe PagespeedapiRunpagespeed'Strategy)
    , _prRule                      :: !(Maybe Text)
    , _prKey                       :: !(Maybe Text)
...
prStrategy :: Lens' PagespeedapiRunpagespeed' (Maybe PagespeedapiRunpagespeed'Strategy)
prStrategy
