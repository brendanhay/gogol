...
-- |
-- Module      : Network.Google.Partners.ClientMessages.Log
...
type PartnersClientMessagesLogResource =
  "v2"
    ...
    Core.:> Core.ReqBody '[Core.JSON] LogMessageRequest
    Core.:> Core.Post '[Core.JSON] LogMessageResponse
