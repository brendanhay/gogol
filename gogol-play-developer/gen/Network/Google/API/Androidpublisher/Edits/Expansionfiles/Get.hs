...
-- | A resource alias for androidpublisher.edits.expansionfiles.get which the
...
data EditsExpansionfilesGet' = EditsExpansionfilesGet'
    ...
    , _eegKey               :: !(Maybe Text)
    , _eegExpansionFileType :: !EditsExpansionfilesGet'ExpansionFileType
...
editsExpansionfilesGet'
    ...
    -> EditsExpansionfilesGet'ExpansionFileType -- ^ 'expansionFileType'
    -> Text -- ^ 'editId'
    -> EditsExpansionfilesGet'
...
eegExpansionFileType :: Lens' EditsExpansionfilesGet' EditsExpansionfilesGet'ExpansionFileType
eegExpansionFileType
