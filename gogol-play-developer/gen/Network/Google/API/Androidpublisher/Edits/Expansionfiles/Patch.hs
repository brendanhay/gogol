...
-- | A resource alias for androidpublisher.edits.expansionfiles.patch which the
...
data EditsExpansionfilesPatch' = EditsExpansionfilesPatch'
    ...
    , _eepKey               :: !(Maybe Text)
    , _eepExpansionFileType :: !EditsExpansionfilesPatch'ExpansionFileType
...
editsExpansionfilesPatch'
    ...
    -> EditsExpansionfilesPatch'ExpansionFileType -- ^ 'expansionFileType'
    -> Text -- ^ 'editId'
    -> EditsExpansionfilesPatch'
...
eepExpansionFileType :: Lens' EditsExpansionfilesPatch' EditsExpansionfilesPatch'ExpansionFileType
eepExpansionFileType
