...
-- | A resource alias for androidpublisher.edits.expansionfiles.upload which the
...
data EditsExpansionfilesUpload' = EditsExpansionfilesUpload'
    ...
    , _eeuKey               :: !(Maybe Text)
    , _eeuExpansionFileType :: !EditsExpansionfilesUpload'ExpansionFileType
...
editsExpansionfilesUpload'
    ...
    -> EditsExpansionfilesUpload'ExpansionFileType -- ^ 'expansionFileType'
    -> Text -- ^ 'editId'
    -> EditsExpansionfilesUpload'
...
eeuExpansionFileType :: Lens' EditsExpansionfilesUpload' EditsExpansionfilesUpload'ExpansionFileType
eeuExpansionFileType
