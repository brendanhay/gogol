...
-- | A resource alias for androidpublisher.edits.images.deleteall which the
         ...
         Capture "editId" Text :>
           "listings" :>
             Capture "language" Text :>
               Capture "imageType" EditsImagesDeleteall'ImageType :>
...
data EditsImagesDeleteall' = EditsImagesDeleteall'
    ...
    , _eidImageType   :: !EditsImagesDeleteall'ImageType
    , _eidKey         :: !(Maybe Text)
    , _eidLanguage    :: !Text
...
editsImagesDeleteall'
    :: Text -- ^ 'packageName'
    -> EditsImagesDeleteall'ImageType -- ^ 'imageType'
    -> Text -- ^ 'language'
    -> Text -- ^ 'editId'
    -> EditsImagesDeleteall'
...
eidImageType :: Lens' EditsImagesDeleteall' EditsImagesDeleteall'ImageType
eidImageType
...
eidAlt :: Lens' EditsImagesDeleteall' Alt
