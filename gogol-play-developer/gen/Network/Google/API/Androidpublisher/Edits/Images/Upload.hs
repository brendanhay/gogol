...
-- | A resource alias for androidpublisher.edits.images.upload which the
         ...
         Capture "editId" Text :>
           "listings" :>
             Capture "language" Text :>
               Capture "imageType" EditsImagesUpload'ImageType :>
...
data EditsImagesUpload' = EditsImagesUpload'
    ...
    , _eiuImageType   :: !EditsImagesUpload'ImageType
    , _eiuKey         :: !(Maybe Text)
    , _eiuLanguage    :: !Text
...
editsImagesUpload'
    :: Text -- ^ 'packageName'
    -> EditsImagesUpload'ImageType -- ^ 'imageType'
    -> Text -- ^ 'language'
    -> Text -- ^ 'editId'
    -> EditsImagesUpload'
...
eiuImageType :: Lens' EditsImagesUpload' EditsImagesUpload'ImageType
eiuImageType
