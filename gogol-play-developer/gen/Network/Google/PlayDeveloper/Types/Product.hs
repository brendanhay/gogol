...
-- |
-- Module      : Network.Google.PlayDeveloper.Types.Product
...
--
module Network.Google.PlayDeveloper.Types.Product where
...
data InappproductsBatchRequestEntry = InappproductsBatchRequestEntry
    ...
    , _ibreInappproductsinsertrequest :: !(Maybe (Maybe InappproductsInsertRequest))
    , _ibreInappproductsupdaterequest :: !(Maybe (Maybe InappproductsUpdateRequest))
...
ibreInappproductsinsertrequest :: Lens' InappproductsBatchRequestEntry (Maybe (Maybe InappproductsInsertRequest))
ibreInappproductsinsertrequest
  = lens _ibreInappproductsinsertrequest
      (\ s a -> s{_ibreInappproductsinsertrequest = a})

ibreInappproductsupdaterequest :: Lens' InappproductsBatchRequestEntry (Maybe (Maybe InappproductsUpdateRequest))
ibreInappproductsupdaterequest
...
instance ToJSON ApkListing where
        toJSON ApkListing{..}
          = object
              (catMaybes
                 [("language" .=) <$> _alLanguage,
                  ("recentChanges" .=) <$> _alRecentChanges])
...
newtype InappproductsBatchRequest = InappproductsBatchRequest
    { _ibrEntrys :: Maybe [Maybe InappproductsBatchRequestEntry]
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
ibrEntrys :: Lens' InappproductsBatchRequest [Maybe InappproductsBatchRequestEntry]
ibrEntrys
...
instance ToJSON ExternallyHostedApk where
        toJSON ExternallyHostedApk{..}
          = object
              (catMaybes
                 [("applicationLabel" .=) <$> _ehaApplicationLabel,
                  ("maximumSdk" .=) <$> _ehaMaximumSdk,
                  ("nativeCodes" .=) <$> _ehaNativeCodes,
                  ("versionCode" .=) <$> _ehaVersionCode,
                  ("fileSha256Base64" .=) <$> _ehaFileSha256Base64,
                  ("externallyHostedUrl" .=) <$>
                    _ehaExternallyHostedUrl,
                  ("versionName" .=) <$> _ehaVersionName,
                  ("packageName" .=) <$> _ehaPackageName,
                  ("fileSize" .=) <$> _ehaFileSize,
                  ("iconBase64" .=) <$> _ehaIconBase64,
                  ("usesFeatures" .=) <$> _ehaUsesFeatures,
                  ("minimumSdk" .=) <$> _ehaMinimumSdk,
                  ("fileSha1Base64" .=) <$> _ehaFileSha1Base64,
...
aaehrExternallyHostedApk :: Lens' ApksAddExternallyHostedResponse (Maybe (Maybe ExternallyHostedApk))
aaehrExternallyHostedApk
...
iirInappproduct :: Lens' InappproductsInsertResponse (Maybe (Maybe InAppProduct))
iirInappproduct
...
data InappproductsBatchResponseEntry = InappproductsBatchResponseEntry
    { _iInappproductsupdateresponse :: !(Maybe (Maybe InappproductsUpdateResponse))
    , _iInappproductsinsertresponse :: !(Maybe (Maybe InappproductsInsertResponse))
...
iInappproductsupdateresponse :: Lens' InappproductsBatchResponseEntry (Maybe (Maybe InappproductsUpdateResponse))
iInappproductsupdateresponse
  = lens _iInappproductsupdateresponse
      (\ s a -> s{_iInappproductsupdateresponse = a})

iInappproductsinsertresponse :: Lens' InappproductsBatchResponseEntry (Maybe (Maybe InappproductsInsertResponse))
iInappproductsinsertresponse
...
instance ToJSON ExternallyHostedApkUsesPermission
        ...
        toJSON ExternallyHostedApkUsesPermission{..}
          = object
              (catMaybes
                 [("name" .=) <$> _ehaupName,
                  ("maxSdkVersion" .=) <$> _ehaupMaxSdkVersion])
...
iInappproduct :: Lens' InappproductsInsertRequest (Maybe (Maybe InAppProduct))
iInappproduct
  = lens _iInappproduct
...
-- | The definition of the externally-hosted APK and where it is located.
aExternallyHostedApk :: Lens' ApksAddExternallyHostedRequest (Maybe (Maybe ExternallyHostedApk))
aExternallyHostedApk
...
data InappproductsBatchResponse = InappproductsBatchResponse
    { _iEntrys :: !(Maybe [Maybe InappproductsBatchResponseEntry])
    , _iKind   :: !Text
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
iEntrys :: Lens' InappproductsBatchResponse [Maybe InappproductsBatchResponseEntry]
iEntrys
