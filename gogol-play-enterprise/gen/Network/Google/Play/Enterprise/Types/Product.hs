...
-- |
-- Module      : Network.Google.Play.Enterprise.Types.Product
...
--
module Network.Google.Play.Enterprise.Types.Product where
...
data AppRestrictionsSchema = AppRestrictionsSchema
    { _arsKind         :: !Text
    , _arsRestrictions :: !(Maybe [Maybe AppRestrictionsSchemaRestriction])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
arsRestrictions :: Lens' AppRestrictionsSchema [Maybe AppRestrictionsSchemaRestriction]
arsRestrictions
...
data EnterprisesListResponse = EnterprisesListResponse
    { _elrKind       :: !Text
    , _elrEnterprise :: !(Maybe [Maybe Enterprise])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
-- | An enterprise.
elrEnterprise :: Lens' EnterprisesListResponse [Maybe Enterprise]
elrEnterprise
  = lens _elrEnterprise
...
data Product = Product
    ...
    , _pAppVersion           :: !(Maybe [Maybe AppVersion])
...
pAppVersion :: Lens' Product [Maybe AppVersion]
pAppVersion
...
data EntitlementsListResponse = EntitlementsListResponse
    { _entKind        :: !Text
    , _entEntitlement :: !(Maybe [Maybe Entitlement])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
entEntitlement :: Lens' EntitlementsListResponse [Maybe Entitlement]
entEntitlement
...
data ProductPermissions = ProductPermissions
    { _ppKind       :: !Text
    , _ppPermission :: !(Maybe [Maybe ProductPermission])
...
ppPermission :: Lens' ProductPermissions [Maybe ProductPermission]
ppPermission
...
data GroupLicensesListResponse = GroupLicensesListResponse
    { _gllrGroupLicense :: !(Maybe [Maybe GroupLicense])
    , _gllrKind         :: !Text
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
gllrGroupLicense :: Lens' GroupLicensesListResponse [Maybe GroupLicense]
gllrGroupLicense
...
data Collection = Collection
    { _ccKind         :: !Text
    , _ccCollectionId :: !(Maybe Text)
    , _ccVisibility   :: !(Maybe Text)
    , _ccName         :: !(Maybe Text)
    , _ccProductId    :: !(Maybe [Text])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
collection =
    Collection
    { _ccKind = "androidenterprise#collection"
    , _ccCollectionId = Nothing
    , _ccVisibility = Nothing
    , _ccName = Nothing
    , _ccProductId = Nothing
    }

-- | Identifies what kind of resource this is. Value: the fixed string
-- \"androidenterprise#collection\".
ccKind :: Lens' Collection Text
ccKind = lens _ccKind (\ s a -> s{_ccKind = a})

-- | Arbitrary unique ID, allocated by the API on creation.
ccCollectionId :: Lens' Collection (Maybe Text)
ccCollectionId
  = lens _ccCollectionId
      (\ s a -> s{_ccCollectionId = a})
...
ccVisibility :: Lens' Collection (Maybe Text)
ccVisibility
  = lens _ccVisibility (\ s a -> s{_ccVisibility = a})

-- | A user-friendly name for the collection (should be unique), e.g.
-- \"Accounting apps\".
ccName :: Lens' Collection (Maybe Text)
ccName = lens _ccName (\ s a -> s{_ccName = a})

-- | The IDs of the products in the collection, in the order in which they
-- should be displayed.
ccProductId :: Lens' Collection [Text]
ccProductId
  = lens _ccProductId (\ s a -> s{_ccProductId = a}) .
      _Default
      . _Coerce
...
instance ToJSON Collection where
        toJSON Collection{..}
          = object
              (catMaybes
                 [Just ("kind" .= _ccKind),
                  ("collectionId" .=) <$> _ccCollectionId,
                  ("visibility" .=) <$> _ccVisibility,
                  ("name" .=) <$> _ccName,
                  ("productId" .=) <$> _ccProductId])
...
data CollectionsListResponse = CollectionsListResponse
    { _clrKind       :: !Text
    , _clrCollection :: !(Maybe [Maybe Collection])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
clrCollection :: Lens' CollectionsListResponse [Maybe Collection]
clrCollection
  = lens _clrCollection
...
glulrUser :: Lens' GroupLicenseUsersListResponse [Maybe User]
glulrUser
...
-- | A managed device.
dlrDevice :: Lens' DevicesListResponse [Maybe Device]
dlrDevice
...
data InstallsListResponse = InstallsListResponse
    { _ilrKind    :: !Text
    , _ilrInstall :: !(Maybe [Maybe Install])
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
ilrInstall :: Lens' InstallsListResponse [Maybe Install]
ilrInstall
...
data AppRestrictionsSchemaRestriction = AppRestrictionsSchemaRestriction
    ...
    , _arsrDefaultValue    :: !(Maybe (Maybe AppRestrictionsSchemaRestrictionRestrictionValue))
...
arsrDefaultValue :: Lens' AppRestrictionsSchemaRestriction (Maybe (Maybe AppRestrictionsSchemaRestrictionRestrictionValue))
arsrDefaultValue
...
-- | A user of an enterprise.
ulrUser :: Lens' UsersListResponse [Maybe User]
ulrUser
...
newtype ProductsApproveRequest = ProductsApproveRequest
    { _parApprovalUrlInfo :: Maybe (Maybe ApprovalUrlInfo)
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
-- was generated.
parApprovalUrlInfo :: Lens' ProductsApproveRequest (Maybe (Maybe ApprovalUrlInfo))
parApprovalUrlInfo
...
-- | A user of an enterprise.
cvlrUser :: Lens' CollectionViewersListResponse [Maybe User]
cvlrUser
