...
-- |
-- Module      : Network.Google.PlayEnterprise.Types.Product
...
--
module Network.Google.PlayEnterprise.Types.Product where
...
data Product = Product
    ...
    , _proAppVersion           :: !(Maybe [Maybe AppVersion])
...
proAppVersion :: Lens' Product [Maybe AppVersion]
proAppVersion
  = lens _proAppVersion
