...
-- | A resource alias for plusDomains.comments.list which the
           ...
           QueryParam "quotaUser" Text :>
             QueryParam "prettyPrint" Bool :>
               QueryParam "userIp" Text :>
                 QueryParam "sortOrder" CommentsList'SortOrder :>
                   QueryParam "key" Text :>
...
data CommentsList' = CommentsList'
    ...
    , _clActivityId  :: !Text
    , _clSortOrder   :: !CommentsList'SortOrder
    , _clKey         :: !(Maybe Text)
...
clSortOrder :: Lens' CommentsList' CommentsList'SortOrder
clSortOrder
