...
-- | A resource alias for plusDomains.media.insert which the
-- 'MediaInsert'' request conforms to.
type MediaInsertAPI =
     "people" :>
       Capture "userId" Text :>
         "media" :>
           Capture "collection" MediaInsert'Collection :>
...
data MediaInsert' = MediaInsert'
    ...
    , _miCollection  :: !MediaInsert'Collection
    , _miUserId      :: !Text
    , _miKey         :: !(Maybe Text)
...
-- * 'miAlt'
mediaInsert'
    :: MediaInsert'Collection -- ^ 'collection'
    -> Text -- ^ 'userId'
    -> MediaInsert'
...
miCollection :: Lens' MediaInsert' MediaInsert'Collection
miCollection
