...
-- | A resource alias for plusDomains.people.list which the
-- 'PeopleList'' request conforms to.
type PeopleListAPI =
     "people" :>
       Capture "userId" Text :>
         "people" :>
           Capture "collection" PeopleList'Collection :>
             QueryParam "quotaUser" Text :>
               QueryParam "prettyPrint" Bool :>
                 QueryParam "orderBy" PeopleList'OrderBy :>
...
data PeopleList' = PeopleList'
    ...
    , _plPrettyPrint :: !Bool
    , _plOrderBy     :: !(Maybe PeopleList'OrderBy)
    , _plUserIp      :: !(Maybe Text)
    , _plCollection  :: !PeopleList'Collection
    , _plUserId      :: !Text
    , _plKey         :: !(Maybe Text)
...
-- * 'plAlt'
peopleList'
    :: PeopleList'Collection -- ^ 'collection'
    -> Text -- ^ 'userId'
    -> PeopleList'
...
plOrderBy :: Lens' PeopleList' (Maybe PeopleList'OrderBy)
plOrderBy
...
plCollection :: Lens' PeopleList' PeopleList'Collection
plCollection
...
plMaxResults :: Lens' PeopleList' Natural
plMaxResults
