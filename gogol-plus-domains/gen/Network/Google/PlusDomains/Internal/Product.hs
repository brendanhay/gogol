    ...
    Core.object
      ( Core.catMaybes
          [ ("description" Core..=) Core.<$> description,
            ("domainRestricted" Core..=)
              Core.<$> domainRestricted,
...
instance Core.FromJSON Activity_Actor where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Activity_Actor
            Core.<$> (o Core..:? "clientSpecificActorInfo")
...
instance Core.ToJSON Activity_Actor where
  toJSON Activity_Actor {..} =
    Core.object
      ( Core.catMaybes
          [ ("clientSpecificActorInfo" Core..=)
              Core.<$> clientSpecificActorInfo,
...
instance
  ...
  toJSON Activity_Actor_ClientSpecificActorInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("youtubeActorInfo" Core..=)
              Core.<$> youtubeActorInfo
          ]
      )
...
newActivity_Object_AttachmentsItem =
  Activity_Object_AttachmentsItem
    { content = Core.Nothing,
      ...
      image = Core.Nothing,
      objectType = Core.Nothing,
      previewThumbnails = Core.Nothing,
    ...
    Core.object
      ( Core.catMaybes
          [ ("content" Core..=) Core.<$> content,
            ...
            ("image" Core..=) Core.<$> image,
            ("objectType" Core..=) Core.<$> objectType,
            ("previewThumbnails" Core..=)
              Core.<$> previewThumbnails,
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Activity_Object_AttachmentsItem_Embed
            Core.<$> (o Core..:? "type") Core.<*> (o Core..:? "url")
      )
...
newActivity_Object_AttachmentsItem_PreviewThumbnailsItem ::
  Activity_Object_AttachmentsItem_PreviewThumbnailsItem
newActivity_Object_AttachmentsItem_PreviewThumbnailsItem =
  Activity_Object_AttachmentsItem_PreviewThumbnailsItem {url = Core.Nothing}
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Activity_Object_AttachmentsItem_ThumbnailsItem_Image
            Core.<$> (o Core..:? "height") Core.<*> (o Core..:? "type")
              Core.<*> (o Core..:? "url")
              Core.<*> (o Core..:? "width")
      )
...
newActivity_Object_StatusForViewer =
  Activity_Object_StatusForViewer
    { canComment = Core.Nothing,
      canPlusone = Core.Nothing,
      canUpdate = Core.Nothing,
      isPlusOned = Core.Nothing,
      resharingDisabled = Core.Nothing
    }
    ...
    Core.object
      ( Core.catMaybes
          [ ("canComment" Core..=) Core.<$> canComment,
            ...
            ("resharingDisabled" Core..=)
              Core.<$> resharingDisabled
          ]
      )
    ...
    Core.withObject
      ...
      ( \o ->
          Audience
            Core.<$> (o Core..:? "etag")
            Core.<*> (o Core..:? "item")
            Core.<*> (o Core..:? "kind" Core..!= "plus#audience")
...
instance Core.FromJSON Circle_People where
  parseJSON =
    Core.withObject
      "Circle_People"
      ( \o ->
          Circle_People Core.<$> (o Core..:? "totalItems")
      )
...
instance Core.FromJSON Comment_InReplyToItem where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Comment_InReplyToItem
            Core.<$> (o Core..:? "id") Core.<*> (o Core..:? "url")
      )
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Comment_Object
            Core.<$> (o Core..:? "content")
            Core.<*> (o Core..:? "objectType" Core..!= "comment")
            Core.<*> (o Core..:? "originalContent")
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("author" Core..=) Core.<$> author,
            ...
            ("id" Core..=) Core.<$> id,
            Core.Just ("kind" Core..= kind),
            ("mediaCreatedTime" Core..=)
              Core.<$> mediaCreatedTime,
            ...
            ("updated" Core..=) Core.<$> updated,
            ("url" Core..=) Core.<$> url,
            ("videoDuration" Core..=) Core.. Core.AsText
              Core.<$> videoDuration,
...
instance Core.FromJSON Media_Author_Image where
  parseJSON =
    Core.withObject
      "Media_Author_Image"
      ( \o ->
          Media_Author_Image Core.<$> (o Core..:? "url")
      )
...
instance Core.ToJSON Media_Exif where
  toJSON Media_Exif {..} =
    Core.object
      (Core.catMaybes [("time" Core..=) Core.<$> time])
...
newPerson_Cover =
  Person_Cover
    { coverInfo = Core.Nothing,
      coverPhoto = Core.Nothing,
      layout = Core.Nothing
    }
...
instance Core.FromJSON Person_Cover where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Person_Cover
            Core.<$> (o Core..:? "coverInfo")
            Core.<*> (o Core..:? "coverPhoto")
            Core.<*> (o Core..:? "layout")
      )
...
instance Core.FromJSON Person_Cover_CoverInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Person_Cover_CoverInfo
            Core.<$> (o Core..:? "leftImageOffset")
            Core.<*> (o Core..:? "topImageOffset")
      )
...
instance Core.ToJSON Person_Cover_CoverInfo where
  toJSON Person_Cover_CoverInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("leftImageOffset" Core..=)
              Core.<$> leftImageOffset,
...
instance Core.FromJSON Person_Image where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Person_Image
            Core.<$> (o Core..:? "isDefault") Core.<*> (o Core..:? "url")
      )
...
instance Core.FromJSON Person_PlacesLivedItem where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Person_PlacesLivedItem
            Core.<$> (o Core..:? "primary") Core.<*> (o Core..:? "value")
      )
