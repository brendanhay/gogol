...
data PeopleListByActivity' = PeopleListByActivity'
    ...
    , _plbaCollection  :: !PlusDomainsPeopleListByActivityCollection
    , _plbaKey         :: !(Maybe Text)
...
peopleListByActivity'
    :: Text -- ^ 'activityId'
    -> PlusDomainsPeopleListByActivityCollection -- ^ 'collection'
    -> PeopleListByActivity'
...
plbaCollection :: Lens' PeopleListByActivity' PlusDomainsPeopleListByActivityCollection
plbaCollection
