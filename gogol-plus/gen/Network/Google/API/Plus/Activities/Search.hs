...
-- | A resource alias for plus.activities.search which the
-- 'ActivitiesSearch'' request conforms to.
type ActivitiesSearchAPI =
     "activities" :>
       QueryParam "quotaUser" Text :>
         QueryParam "prettyPrint" Bool :>
           QueryParam "orderBy" ActivitiesSearch'OrderBy :>
...
data ActivitiesSearch' = ActivitiesSearch'
    ...
    , _asPrettyPrint :: !Bool
    , _asOrderBy     :: !ActivitiesSearch'OrderBy
...
asOrderBy :: Lens' ActivitiesSearch' ActivitiesSearch'OrderBy
asOrderBy
...
asMaxResults :: Lens' ActivitiesSearch' Natural
asMaxResults
