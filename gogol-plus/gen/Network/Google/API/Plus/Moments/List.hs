...
-- | A resource alias for plus.moments.list which the
-- 'MomentsList'' request conforms to.
type MomentsListAPI =
     "people" :>
       Capture "userId" Text :>
         "moments" :>
           Capture "collection" MomentsList'Collection :>
...
data MomentsList' = MomentsList'
    ...
    , _mlCollection  :: !MomentsList'Collection
    , _mlUserId      :: !Text
    , _mlKey         :: !(Maybe Text)
...
-- * 'mlAlt'
momentsList'
    :: MomentsList'Collection -- ^ 'collection'
    -> Text -- ^ 'userId'
    -> MomentsList'
...
mlCollection :: Lens' MomentsList' MomentsList'Collection
mlCollection
...
mlMaxResults :: Lens' MomentsList' Natural
mlMaxResults
