...
-- |
-- Module      : Network.Google.PubSub.Projects.Subscriptions.Detach
...
type PubSubProjectsSubscriptionsDetachResource =
  "v1"
    Core.:> Core.CaptureMode "subscription" "detach" Core.Text
    ...
    Core.:> Core.Post '[Core.JSON] DetachSubscriptionResponse
...
instance
  ...
  where
  type
    Rs PubSubProjectsSubscriptionsDetach =
