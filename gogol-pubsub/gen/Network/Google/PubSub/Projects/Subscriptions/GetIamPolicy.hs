...
-- |
-- Module      : Network.Google.PubSub.Projects.Subscriptions.GetIamPolicy
...
instance
  ...
  where
  type
    Rs PubSubProjectsSubscriptionsGetIamPolicy =
      Policy
  type
    Scopes PubSubProjectsSubscriptionsGetIamPolicy =
