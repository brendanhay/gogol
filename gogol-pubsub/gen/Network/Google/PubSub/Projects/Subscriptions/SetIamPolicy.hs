...
-- |
-- Module      : Network.Google.PubSub.Projects.Subscriptions.SetIamPolicy
...
instance
  ...
  where
  type
    Rs PubSubProjectsSubscriptionsSetIamPolicy =
      Policy
  type
    Scopes PubSubProjectsSubscriptionsSetIamPolicy =
