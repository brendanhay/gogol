...
-- |
-- Module      : Network.Google.InstanceGroupsManager.Types.Product
...
--
module Network.Google.InstanceGroupsManager.Types.Product where
...
data InstanceGroupManager = InstanceGroupManager
    ...
    , _igmAutoHealingPolicies :: !(Maybe [Maybe ReplicaPoolAutoHealingPolicy])
...
-- only one value.
igmAutoHealingPolicies :: Lens' InstanceGroupManager [Maybe ReplicaPoolAutoHealingPolicy]
igmAutoHealingPolicies
...
rpahpActionType :: Lens' ReplicaPoolAutoHealingPolicy (Maybe Text)
rpahpActionType
