...
-- |
-- Module      : Network.Google.ResourceManager.Cloudresourcemanager.Folders.Search
...
type CloudresourcemanagerFoldersSearchResource =
  "v3"
    ...
    Core.:> Core.Get '[Core.JSON] SearchFoldersResponse
...
instance
  ...
  where
  type
    Rs CloudresourcemanagerFoldersSearch =
