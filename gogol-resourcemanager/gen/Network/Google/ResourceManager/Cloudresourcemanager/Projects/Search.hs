...
-- |
-- Module      : Network.Google.ResourceManager.Cloudresourcemanager.Projects.Search
...
type CloudresourcemanagerProjectsSearchResource =
  "v3"
    ...
    Core.:> Core.Get '[Core.JSON] SearchProjectsResponse
...
instance
  ...
  where
  type
    Rs CloudresourcemanagerProjectsSearch =
