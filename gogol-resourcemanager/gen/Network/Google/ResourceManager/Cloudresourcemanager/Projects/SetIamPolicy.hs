...
-- |
-- Module      : Network.Google.ResourceManager.Cloudresourcemanager.Projects.SetIamPolicy
...
instance
  ...
  where
  type
    Rs CloudresourcemanagerProjectsSetIamPolicy =
      Policy
  type
    Scopes CloudresourcemanagerProjectsSetIamPolicy =
