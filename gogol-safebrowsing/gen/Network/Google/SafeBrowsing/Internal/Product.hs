...
-- |
-- Module      : Network.Google.SafeBrowsing.Internal.Product
...
newGoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequest =
  GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequest
    { client = Core.Nothing,
      listUpdateRequests = Core.Nothing
    }
      ...
      Core.object
        ( Core.catMaybes
            [ ("client" Core..=) Core.<$> client,
              ("listUpdateRequests" Core..=)
                Core.<$> listUpdateRequests
            ]
        )
      ...
      Core.object
        ( Core.catMaybes
            [ ("deviceLocation" Core..=) Core.<$> deviceLocation,
              ...
              ("maxDatabaseEntries" Core..=)
                Core.<$> maxDatabaseEntries,
              ("maxUpdateEntries" Core..=)
                Core.<$> maxUpdateEntries,
              ("region" Core..=) Core.<$> region,
              ("supportedCompressions" Core..=)
                Core.<$> supportedCompressions
            ]
        )
...
newGoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse =
  GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse
    { listUpdateResponses = Core.Nothing,
...
instance
  ...
  toJSON
    GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse {..} =
      Core.object
        ( Core.catMaybes
            [ ("listUpdateResponses" Core..=)
                Core.<$> listUpdateResponses,
              ("minimumWaitDuration" Core..=)
                Core.<$> minimumWaitDuration
            ]
        )
      ...
      Core.object
        ( Core.catMaybes
            [ ("matches" Core..=) Core.<$> matches,
              ("minimumWaitDuration" Core..=)
                Core.<$> minimumWaitDuration,
              ("negativeCacheDuration" Core..=)
                Core.<$> negativeCacheDuration
            ]
        )
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleSecuritySafebrowsingV4RawHashes
            Core.<$> (o Core..:? "prefixSize")
            Core.<*> (o Core..:? "rawHashes")
      )
      ...
      Core.object
        ( Core.catMaybes
            [ ("encodedData" Core..=) Core.<$> encodedData,
              ("firstValue" Core..=) Core.. Core.AsText
                Core.<$> firstValue,
    ...
    Core.object
      ( Core.catMaybes
          [ ("platformTypes" Core..=) Core.<$> platformTypes,
            ...
            ("threatEntryTypes" Core..=)
              Core.<$> threatEntryTypes,
    ...
    Core.object
      ( Core.catMaybes
          [ ("cacheDuration" Core..=) Core.<$> cacheDuration,
            ...
            ("threatEntryMetadata" Core..=)
              Core.<$> threatEntryMetadata,
            ("threatEntryType" Core..=) Core.<$> threatEntryType,
            ("threatType" Core..=) Core.<$> threatType
          ]
      )
