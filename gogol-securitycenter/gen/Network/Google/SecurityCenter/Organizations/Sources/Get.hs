...
-- |
-- Module      : Network.Google.SecurityCenter.Organizations.Sources.Get
...
type SecurityCenterOrganizationsSourcesGetResource =
  "v1p1beta1"
    ...
    Core.:> Core.Get '[Core.JSON] Source
...
instance
  ...
  where
  type
    Rs SecurityCenterOrganizationsSourcesGet =
      Source
  type
    Scopes SecurityCenterOrganizationsSourcesGet =
