...
-- |
-- Module      : Network.Google.ServiceConsumerManagement.Internal.Product
...
import Network.Google.ServiceConsumerManagement.Internal.Sum
...
instance Core.ToJSON AttachTenantProjectRequest where
  toJSON AttachTenantProjectRequest {..} =
    Core.object
      ( Core.catMaybes
          [ ("externalResource" Core..=)
              Core.<$> externalResource,
            ("reservedResource" Core..=)
              Core.<$> reservedResource,
            ("tag" Core..=) Core.<$> tag
          ]
      )
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          ListTenancyUnitsResponse
            Core.<$> (o Core..:? "nextPageToken")
            Core.<*> (o Core..:? "tenancyUnits" Core..!= Core.mempty)
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("accountId" Core..=) Core.<$> accountId,
            ("tenantProjectRoles" Core..=)
              Core.<$> tenantProjectRoles
          ]
      )
    ...
    Core.withObject
      ...
      ( \o ->
          TenancyUnit
            ...
            Core.<*> (o Core..:? "name")
            Core.<*> (o Core..:? "service")
            Core.<*> (o Core..:? "tenantResources" Core..!= Core.mempty)
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("consumer" Core..=) Core.<$> consumer,
            ...
            ("tenantResources" Core..=)
              Core.<$> tenantResources
          ]
      )
...
newTenantProjectConfig_Labels ::
  ...
  TenantProjectConfig_Labels
newTenantProjectConfig_Labels addtional =
  TenantProjectConfig_Labels {addtional = addtional}
...
instance Core.FromJSON TenantProjectPolicy where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          TenantProjectPolicy
            Core.<$> (o Core..:? "policyBindings" Core..!= Core.mempty)
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("container" Core..=) Core.<$> container,
            ...
            ("metric" Core..=) Core.<$> metric,
            ("name" Core..=) Core.<$> name,
            ("policyValue" Core..=) Core.. Core.AsText
              Core.<$> policyValue,
            ("unit" Core..=) Core.<$> unit
          ]
      )
...
newV1Beta1ProducerQuotaPolicy_Dimensions ::
  ...
  Core.HashMap Core.Text Core.Text ->
  V1Beta1ProducerQuotaPolicy_Dimensions
newV1Beta1ProducerQuotaPolicy_Dimensions addtional =
  V1Beta1ProducerQuotaPolicy_Dimensions {addtional = addtional}
...
instance Core.ToJSON V1Beta1QuotaOverride where
  toJSON V1Beta1QuotaOverride {..} =
    Core.object
      ( Core.catMaybes
          [ ("adminOverrideAncestor" Core..=)
              Core.<$> adminOverrideAncestor,
            ("dimensions" Core..=) Core.<$> dimensions,
            ("metric" Core..=) Core.<$> metric,
            ("name" Core..=) Core.<$> name,
            ("overrideValue" Core..=) Core.. Core.AsText
              Core.<$> overrideValue,
            ("unit" Core..=) Core.<$> unit
          ]
      )
...
newV1Beta1QuotaOverride_Dimensions ::
  ...
  Core.HashMap Core.Text Core.Text ->
  V1Beta1QuotaOverride_Dimensions
newV1Beta1QuotaOverride_Dimensions addtional =
  V1Beta1QuotaOverride_Dimensions {addtional = addtional}
