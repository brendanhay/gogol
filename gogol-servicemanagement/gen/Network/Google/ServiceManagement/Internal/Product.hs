...
-- |
-- Module      : Network.Google.ServiceManagement.Internal.Product
...
import Network.Google.ServiceManagement.Internal.Sum
    ...
    Core.object
      ( Core.catMaybes
          [ ("createTime" Core..=) Core.<$> createTime,
            ...
            ("deleteServiceStrategy" Core..=)
              Core.<$> deleteServiceStrategy,
