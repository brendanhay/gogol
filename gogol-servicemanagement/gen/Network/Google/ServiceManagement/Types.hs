...
import Network.Google.ServiceManagement.Internal.Product
...
serviceManagementReadOnlyScope :: Core.Proxy '["https://www.googleapis.com/auth/service.management.readonly"]
serviceManagementReadOnlyScope = Core.Proxy
