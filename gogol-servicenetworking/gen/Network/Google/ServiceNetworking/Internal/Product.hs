...
-- |
-- Module      : Network.Google.ServiceNetworking.Internal.Product
...
import Network.Google.ServiceNetworking.Internal.Sum
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AddRolesRequest
            Core.<$> (o Core..:? "consumerNetwork")
            Core.<*> (o Core..:? "policyBinding" Core..!= Core.mempty)
      )
    ...
    Core.withObject
      ...
      ( \o ->
          AddSubnetworkRequest
            ...
            Core.<*> (o Core..:? "requestedRanges" Core..!= Core.mempty)
            Core.<*> ( o Core..:? "secondaryIpRangeSpecs"
                         Core..!= Core.mempty
                     )
            Core.<*> (o Core..:? "subnetwork")
            Core.<*> (o Core..:? "subnetworkUsers" Core..!= Core.mempty)
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("checkServiceNetworkingUsePermission" Core..=)
            ...
            ("subnetworkUsers" Core..=)
              Core.<$> subnetworkUsers
          ]
      )
    ...
    Core.withObject
      ...
      ( \o ->
          ConsumerConfig
            ...
            Core.<*> (o Core..:? "reservedRanges" Core..!= Core.mempty)
...
instance Core.FromJSON ListPeeredDnsDomainsResponse where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          ListPeeredDnsDomainsResponse
            Core.<$> (o Core..:? "peeredDnsDomains" Core..!= Core.mempty)
      )
