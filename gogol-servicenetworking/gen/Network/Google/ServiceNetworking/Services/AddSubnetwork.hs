...
-- |
-- Module      : Network.Google.ServiceNetworking.Services.AddSubnetwork
...
type ServiceNetworkingServicesAddSubnetworkResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "addSubnetwork" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] AddSubnetworkRequest
...
instance
  ...
  where
  type
    Rs ServiceNetworkingServicesAddSubnetwork =
      Operation
  type
    Scopes ServiceNetworkingServicesAddSubnetwork =
