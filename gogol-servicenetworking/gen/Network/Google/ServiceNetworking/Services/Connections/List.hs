...
-- |
-- Module      : Network.Google.ServiceNetworking.Services.Connections.List
...
instance
  ...
  where
  type
    Rs ServiceNetworkingServicesConnectionsList =
      ListConnectionsResponse
  type
    Scopes ServiceNetworkingServicesConnectionsList =
