...
-- |
-- Module      : Network.Google.ServiceNetworking.Services.DnsRecordSets.Update
...
type ServiceNetworkingServicesDnsRecordSetsUpdateResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] UpdateDnsRecordSetRequest
...
instance
  ...
  where
  type
    Rs ServiceNetworkingServicesDnsRecordSetsUpdate =
      Operation
  type
    Scopes
      ServiceNetworkingServicesDnsRecordSetsUpdate =
