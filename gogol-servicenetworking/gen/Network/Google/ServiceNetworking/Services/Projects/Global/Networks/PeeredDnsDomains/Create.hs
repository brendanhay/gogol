...
-- |
-- Module      : Network.Google.ServiceNetworking.Services.Projects.Global.Networks.PeeredDnsDomains.Create
...
newServiceNetworkingServicesProjectsGlobalNetworksPeeredDnsDomainsCreate ::
  ...
  PeeredDnsDomain ->
  ServiceNetworkingServicesProjectsGlobalNetworksPeeredDnsDomainsCreate
newServiceNetworkingServicesProjectsGlobalNetworksPeeredDnsDomainsCreate parent payload =
  ServiceNetworkingServicesProjectsGlobalNetworksPeeredDnsDomainsCreate
    { xgafv = Core.Nothing,
