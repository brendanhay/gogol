...
-- |
-- Module      : Network.Google.ServiceNetworking.Services.Validate
...
type ServiceNetworkingServicesValidateResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "validate" Core.Text
    ...
    Core.:> Core.Post '[Core.JSON] ValidateConsumerConfigResponse
...
instance
  ...
  where
  type
    Rs ServiceNetworkingServicesValidate =
