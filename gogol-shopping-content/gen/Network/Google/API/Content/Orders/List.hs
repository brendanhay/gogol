...
-- | A resource alias for content.orders.list which the
         ...
         QueryParam "placedDateEnd" Text :>
           QueryParam "quotaUser" Text :>
             QueryParam "prettyPrint" Bool :>
               QueryParam "orderBy" OrdersList'OrderBy :>
                 QueryParam "userIp" Text :>
                   QueryParam "acknowledged" Bool :>
                     QueryParam "key" Text :>
                       QueryParam "statuses" OrdersList'Statuses :>
...
data OrdersList' = OrdersList'
    ...
    , _olPrettyPrint     :: !Bool
    , _olOrderBy         :: !(Maybe OrdersList'OrderBy)
    , _olUserIp          :: !(Maybe Text)
    , _olAcknowledged    :: !(Maybe Bool)
    , _olKey             :: !(Maybe Text)
    , _olStatuses        :: !(Maybe OrdersList'Statuses)
...
olOrderBy :: Lens' OrdersList' (Maybe OrdersList'OrderBy)
olOrderBy
...
olStatuses :: Lens' OrdersList' (Maybe OrdersList'Statuses)
olStatuses
