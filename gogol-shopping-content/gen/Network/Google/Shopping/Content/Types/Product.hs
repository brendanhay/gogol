...
-- |
-- Module      : Network.Google.Shopping.Content.Types.Product
...
--
module Network.Google.Shopping.Content.Types.Product where
...
data Order = Order
    ...
    , _ordrMerchantId      :: !(Maybe Word64)
    , _ordrRefunds         :: !(Maybe [Maybe OrderRefund])
    , _ordrKind            :: !Text
    , _ordrLineItems       :: !(Maybe [Maybe OrderLineItem])
    , _ordrShipments       :: !(Maybe [Maybe OrderShipment])
    , _ordrNetAmount       :: !(Maybe (Maybe Price))
    , _ordrPlacedDate      :: !(Maybe Text)
    , _ordrDeliveryDetails :: !(Maybe (Maybe OrderDeliveryDetails))
    , _ordrShippingOption  :: !(Maybe Text)
    , _ordrMerchantOrderId :: !(Maybe Text)
    , _ordrAcknowledged    :: !(Maybe Bool)
    , _ordrShippingCostTax :: !(Maybe (Maybe Price))
    , _ordrCustomer        :: !(Maybe (Maybe OrderCustomer))
    , _ordrId              :: !(Maybe Text)
    , _ordrPaymentMethod   :: !(Maybe (Maybe OrderPaymentMethod))
    , _ordrPaymentStatus   :: !(Maybe Text)
    , _ordrShippingCost    :: !(Maybe (Maybe Price))
    } deriving (Eq,Read,Show,Data,Typeable,Generic)
...
ordrRefunds :: Lens' Order [Maybe OrderRefund]
ordrRefunds
...
ordrLineItems :: Lens' Order [Maybe OrderLineItem]
ordrLineItems
  = lens _ordrLineItems
...
ordrShipments :: Lens' Order [Maybe OrderShipment]
ordrShipments
  = lens _ordrShipments
...
-- amount will be $80.
ordrNetAmount :: Lens' Order (Maybe (Maybe Price))
ordrNetAmount
  = lens _ordrNetAmount
...
ordrDeliveryDetails :: Lens' Order (Maybe (Maybe OrderDeliveryDetails))
ordrDeliveryDetails
...
-- | The tax for the total shipping cost.
ordrShippingCostTax :: Lens' Order (Maybe (Maybe Price))
ordrShippingCostTax
  = lens _ordrShippingCostTax
      (\ s a -> s{_ordrShippingCostTax = a})

-- | The details of the customer who placed the order.
ordrCustomer :: Lens' Order (Maybe (Maybe OrderCustomer))
ordrCustomer
...
-- | The details of the payment method.
ordrPaymentMethod :: Lens' Order (Maybe (Maybe OrderPaymentMethod))
ordrPaymentMethod
...
-- | The total cost of shipping for all items.
ordrShippingCost :: Lens' Order (Maybe (Maybe Price))
ordrShippingCost
