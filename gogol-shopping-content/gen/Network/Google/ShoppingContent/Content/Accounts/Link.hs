...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Accounts.Link
...
type ContentAccountsLinkResource =
  "content"
    ...
    Core.:> Core.ReqBody '[Core.JSON] AccountsLinkRequest
    Core.:> Core.Post '[Core.JSON] AccountsLinkResponse
