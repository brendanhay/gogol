...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Accounts.Listlinks
...
type ContentAccountsListlinksResource =
  "content"
    ...
    Core.:> Core.Get '[Core.JSON] AccountsListLinksResponse
...
instance Core.GoogleRequest ContentAccountsListlinks where
  type
    Rs ContentAccountsListlinks =
      AccountsListLinksResponse
  type
    Scopes ContentAccountsListlinks =
