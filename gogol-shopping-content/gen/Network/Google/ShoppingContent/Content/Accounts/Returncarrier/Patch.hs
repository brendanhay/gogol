...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Accounts.Returncarrier.Patch
...
type ContentAccountsReturncarrierPatchResource =
  "content"
    ...
    Core.:> "returncarrier"
    Core.:> Core.Capture "carrierAccountId" Core.Int64
    ...
    Core.:> Core.Patch '[Core.JSON] AccountReturnCarrier
...
instance
  ...
  where
  type
    Rs ContentAccountsReturncarrierPatch =
      AccountReturnCarrier
  type
    Scopes ContentAccountsReturncarrierPatch =
