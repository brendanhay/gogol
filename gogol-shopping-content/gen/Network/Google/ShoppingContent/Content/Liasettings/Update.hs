...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Liasettings.Update
...
type ContentLiasettingsUpdateResource =
  "content"
    ...
    Core.:> Core.ReqBody '[Core.JSON] LiaSettings
    Core.:> Core.Put '[Core.JSON] LiaSettings
...
instance Core.GoogleRequest ContentLiasettingsUpdate where
  ...
  type
    Scopes ContentLiasettingsUpdate =
