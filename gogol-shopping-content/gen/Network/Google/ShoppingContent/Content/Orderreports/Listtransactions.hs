...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Orderreports.Listtransactions
...
type ContentOrderreportsListtransactionsResource =
  "content"
    ...
    Core.:> "orderreports"
    Core.:> "disbursements"
    Core.:> Core.Capture "disbursementId" Core.Text
    Core.:> "transactions"
    ...
    Core.:> Core.QueryParam "transactionEndDate" Core.Text
    Core.:> Core.QueryParam "transactionStartDate" Core.Text
...
instance
  ...
  where
  type
    Rs ContentOrderreportsListtransactions =
      OrderreportsListTransactionsResponse
  type
    Scopes ContentOrderreportsListtransactions =
