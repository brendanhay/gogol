...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Orders.Refunditem
...
type ContentOrdersRefunditemResource =
  "content"
    ...
    Core.:> Core.ReqBody '[Core.JSON] OrdersRefundItemRequest
    Core.:> Core.Post '[Core.JSON] OrdersRefundItemResponse
...
instance Core.GoogleRequest ContentOrdersRefunditem where
  type
    Rs ContentOrdersRefunditem =
      OrdersRefundItemResponse
  type
    Scopes ContentOrdersRefunditem =
