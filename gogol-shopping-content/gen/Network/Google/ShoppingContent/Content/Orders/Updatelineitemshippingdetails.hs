...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Orders.Updatelineitemshippingdetails
...
type ContentOrdersUpdatelineitemshippingdetailsResource =
  "content"
    ...
    Core.:> "updateLineItemShippingDetails"
...
instance
  ...
  where
  type
    Rs ContentOrdersUpdatelineitemshippingdetails =
      OrdersUpdateLineItemShippingDetailsResponse
  type
    Scopes
      ContentOrdersUpdatelineitemshippingdetails =
