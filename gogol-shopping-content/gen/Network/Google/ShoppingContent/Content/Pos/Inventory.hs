...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Pos.Inventory
...
type ContentPosInventoryResource =
  "content"
    ...
    Core.:> Core.ReqBody '[Core.JSON] PosInventoryRequest
    Core.:> Core.Post '[Core.JSON] PosInventoryResponse
