...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Settlementtransactions.List
...
type ContentSettlementtransactionsListResource =
  "content"
    ...
    Core.:> Core.QueryParams "transactionIds" Core.Text
...
instance
  ...
  where
  type
    Rs ContentSettlementtransactionsList =
      SettlementtransactionsListResponse
  type
