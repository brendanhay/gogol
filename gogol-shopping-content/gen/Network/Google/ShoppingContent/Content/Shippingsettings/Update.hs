...
-- |
-- Module      : Network.Google.ShoppingContent.Content.Shippingsettings.Update
...
type ContentShippingsettingsUpdateResource =
  "content"
    ...
    Core.:> Core.ReqBody '[Core.JSON] ShippingSettings
    Core.:> Core.Put '[Core.JSON] ShippingSettings
...
instance
  ...
  where
  type
    Rs ContentShippingsettingsUpdate =
      ShippingSettings
  type
