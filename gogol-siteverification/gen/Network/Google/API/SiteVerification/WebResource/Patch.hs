...
-- | A resource alias for siteVerification.webResource.patch which the
...
-- token.
wrpKey :: Lens' WebResourcePatch' (Maybe Text)
...
wrpOauthToken :: Lens' WebResourcePatch' (Maybe Text)
wrpOauthToken
  = lens _wrpOauthToken
