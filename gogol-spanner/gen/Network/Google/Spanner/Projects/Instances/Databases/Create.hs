...
-- |
-- Module      : Network.Google.Spanner.Projects.Instances.Databases.Create
...
type SpannerProjectsInstancesDatabasesCreateResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] CreateDatabaseRequest
...
instance
  ...
  where
  type
    Rs SpannerProjectsInstancesDatabasesCreate =
      Operation
  type
    Scopes SpannerProjectsInstancesDatabasesCreate =
