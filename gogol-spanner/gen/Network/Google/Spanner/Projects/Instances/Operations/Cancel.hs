...
-- |
-- Module      : Network.Google.Spanner.Projects.Instances.Operations.Cancel
...
instance
  ...
  where
  type
    Rs SpannerProjectsInstancesOperationsCancel =
      Empty
  type
    Scopes SpannerProjectsInstancesOperationsCancel =
