...
type InstancesResetSSLConfigAPI =
     "projects" :>
       Capture "project" Text :>
         "instances" :>
           Capture "instance" Text :>
             "resetSslConfig" :> Post '[JSON] Operation
...
irscAlt :: Lens' InstancesResetSSLConfig' Text
...
instance GoogleRequest InstancesResetSSLConfig' where
        ...
        requestWithRoute r u InstancesResetSSLConfig{..}
          = go _irscQuotaUser _irscPrettyPrint _irscProject
              _irscUserIp
              _irscKey
              _irscOauthToken
              _irscFields
          ...
          where go
                  = clientWithRoute
                      (Proxy :: Proxy InstancesResetSSLConfigAPI)
                      r
                      u
