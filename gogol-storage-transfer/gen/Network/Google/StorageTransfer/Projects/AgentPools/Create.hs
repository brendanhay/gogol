...
-- |
-- Module      : Network.Google.StorageTransfer.Projects.AgentPools.Create
...
type StorageTransferProjectsAgentPoolsCreateResource =
  "v1"
    ...
    Core.:> Core.QueryParam "agentPoolId" Core.Text
    Core.:> Core.QueryParam "callback" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.ReqBody '[Core.JSON] AgentPool
    Core.:> Core.Post '[Core.JSON] AgentPool
...
instance
  ...
  where
  type
    Rs StorageTransferProjectsAgentPoolsCreate =
      AgentPool
  type
    Scopes StorageTransferProjectsAgentPoolsCreate =
