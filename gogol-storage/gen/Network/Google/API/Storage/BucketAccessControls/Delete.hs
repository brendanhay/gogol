...
-- specified bucket.
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.bucketAccessControls.delete@.
module Network.Google.API.Storage.BucketAccessControls.Delete
    (
    -- * REST Resource
...
-- | A resource alias for storage.bucketAccessControls.delete which the
