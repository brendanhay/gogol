...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.bucketAccessControls.insert@.
module Network.Google.API.Storage.BucketAccessControls.Insert
    (
    -- * REST Resource
...
-- | A resource alias for storage.bucketAccessControls.insert which the
