...
-- semantics.
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.bucketAccessControls.patch@.
module Network.Google.API.Storage.BucketAccessControls.Patch
    (
    -- * REST Resource
...
-- | A resource alias for storage.bucketAccessControls.patch which the
