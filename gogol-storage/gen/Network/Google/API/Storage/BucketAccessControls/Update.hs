...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.bucketAccessControls.update@.
module Network.Google.API.Storage.BucketAccessControls.Update
    (
    -- * REST Resource
...
-- | A resource alias for storage.bucketAccessControls.update which the
