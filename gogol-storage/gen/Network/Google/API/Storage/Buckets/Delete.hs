...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.buckets.delete@.
module Network.Google.API.Storage.Buckets.Delete
    (
    -- * REST Resource
      BucketsDeleteAPI
...
-- | A resource alias for storage.buckets.delete which the
