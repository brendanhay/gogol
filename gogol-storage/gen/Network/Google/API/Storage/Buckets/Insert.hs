...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.buckets.insert@.
module Network.Google.API.Storage.Buckets.Insert
    (
    -- * REST Resource
      BucketsInsertAPI
...
-- | A resource alias for storage.buckets.insert which the
         ...
         QueryParam "prettyPrint" Bool :>
           QueryParam "project" Text :>
             QueryParam "userIp" Text :>
               QueryParam "key" Text :>
                 QueryParam "projection" BucketsInsert'Projection :>
...
data BucketsInsert' = BucketsInsert'
    ...
    , _biKey         :: !(Maybe Text)
    , _biProjection  :: !(Maybe BucketsInsert'Projection)
...
-- to full.
biProjection :: Lens' BucketsInsert' (Maybe BucketsInsert'Projection)
biProjection
