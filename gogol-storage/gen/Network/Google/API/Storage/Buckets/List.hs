...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.buckets.list@.
module Network.Google.API.Storage.Buckets.List
    (
    -- * REST Resource
      BucketsListAPI
...
-- | A resource alias for storage.buckets.list which the
         ...
         QueryParam "prettyPrint" Bool :>
           QueryParam "project" Text :>
             QueryParam "userIp" Text :>
               QueryParam "key" Text :>
                 QueryParam "projection" BucketsList'Projection :>
...
data BucketsList' = BucketsList'
    ...
    , _blKey         :: !(Maybe Text)
    , _blProjection  :: !(Maybe BucketsList'Projection)
...
blProjection :: Lens' BucketsList' (Maybe BucketsList'Projection)
blProjection
