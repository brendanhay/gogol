...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.channels.stop@.
module Network.Google.API.Storage.Channels.Stop
    (
    -- * REST Resource
      ChannelsStopAPI
...
-- | A resource alias for storage.channels.stop which the
