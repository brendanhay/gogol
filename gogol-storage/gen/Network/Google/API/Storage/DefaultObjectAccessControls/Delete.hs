...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.defaultObjectAccessControls.delete@.
module Network.Google.API.Storage.DefaultObjectAccessControls.Delete
    (
    -- * REST Resource
...
-- | A resource alias for storage.defaultObjectAccessControls.delete which the
