...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.defaultObjectAccessControls.insert@.
module Network.Google.API.Storage.DefaultObjectAccessControls.Insert
    (
    -- * REST Resource
...
-- | A resource alias for storage.defaultObjectAccessControls.insert which the
