...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.defaultObjectAccessControls.patch@.
module Network.Google.API.Storage.DefaultObjectAccessControls.Patch
    (
    -- * REST Resource
...
-- | A resource alias for storage.defaultObjectAccessControls.patch which the
