...
-- specified object.
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objectAccessControls.delete@.
module Network.Google.API.Storage.ObjectAccessControls.Delete
    (
    -- * REST Resource
...
-- | A resource alias for storage.objectAccessControls.delete which the
