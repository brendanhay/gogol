...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objectAccessControls.get@.
module Network.Google.API.Storage.ObjectAccessControls.Get
    (
    -- * REST Resource
...
-- | A resource alias for storage.objectAccessControls.get which the
