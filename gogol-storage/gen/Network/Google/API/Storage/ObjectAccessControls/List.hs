...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objectAccessControls.list@.
module Network.Google.API.Storage.ObjectAccessControls.List
    (
    -- * REST Resource
...
-- | A resource alias for storage.objectAccessControls.list which the
