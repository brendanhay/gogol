...
-- semantics.
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objectAccessControls.patch@.
module Network.Google.API.Storage.ObjectAccessControls.Patch
    (
    -- * REST Resource
...
-- | A resource alias for storage.objectAccessControls.patch which the
