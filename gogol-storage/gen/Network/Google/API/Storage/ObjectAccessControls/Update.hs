...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objectAccessControls.update@.
module Network.Google.API.Storage.ObjectAccessControls.Update
    (
    -- * REST Resource
...
-- | A resource alias for storage.objectAccessControls.update which the
