...
-- bucket.
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objects.compose@.
module Network.Google.API.Storage.Objects.Compose
    (
    -- * REST Resource
      ObjectsComposeAPI
...
-- | A resource alias for storage.objects.compose which the
