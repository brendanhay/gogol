...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objects.get@.
module Network.Google.API.Storage.Objects.Get
    (
    -- * REST Resource
      ObjectsGetAPI
...
-- | A resource alias for storage.objects.get which the
                       ...
                       QueryParam "userIp" Text :>
                         QueryParam "key" Text :>
                           QueryParam "ifMetagenerationNotMatch" Word64 :>
                             QueryParam "projection" ObjectsGet'Projection :>
...
data ObjectsGet' = ObjectsGet'
    ...
    , _ogObject                   :: !Text
    , _ogProjection               :: !(Maybe ObjectsGet'Projection)
...
ogProjection :: Lens' ObjectsGet' (Maybe ObjectsGet'Projection)
ogProjection
