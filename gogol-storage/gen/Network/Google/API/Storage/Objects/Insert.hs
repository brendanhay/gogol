...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objects.insert@.
module Network.Google.API.Storage.Objects.Insert
    (
    -- * REST Resource
      ObjectsInsertAPI
...
-- | A resource alias for storage.objects.insert which the
                       ...
                       QueryParam "key" Text :>
                         QueryParam "name" Text :>
                           QueryParam "ifMetagenerationNotMatch" Word64 :>
                             QueryParam "projection" ObjectsInsert'Projection :>
...
data ObjectsInsert' = ObjectsInsert'
    ...
    , _oiProjection               :: !(Maybe ObjectsInsert'Projection)
...
oiProjection :: Lens' ObjectsInsert' (Maybe ObjectsInsert'Projection)
oiProjection
