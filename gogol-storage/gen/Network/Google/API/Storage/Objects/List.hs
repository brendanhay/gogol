...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objects.list@.
module Network.Google.API.Storage.Objects.List
    (
    -- * REST Resource
      ObjectsListAPI
...
-- | A resource alias for storage.objects.list which the
               ...
               QueryParam "prefix" Text :>
                 QueryParam "userIp" Text :>
                   QueryParam "versions" Bool :>
                     QueryParam "key" Text :>
                       QueryParam "projection" ObjectsList'Projection :>
...
data ObjectsList' = ObjectsList'
    ...
    , _olKey         :: !(Maybe Text)
    , _olProjection  :: !(Maybe ObjectsList'Projection)
...
olProjection :: Lens' ObjectsList' (Maybe ObjectsList'Projection)
olProjection
