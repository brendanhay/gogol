...
-- semantics.
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objects.patch@.
module Network.Google.API.Storage.Objects.Patch
    (
    -- * REST Resource
      ObjectsPatchAPI
...
-- | A resource alias for storage.objects.patch which the
                       ...
                       QueryParam "userIp" Text :>
                         QueryParam "key" Text :>
                           QueryParam "ifMetagenerationNotMatch" Word64 :>
                             QueryParam "projection" ObjectsPatch'Projection :>
...
data ObjectsPatch' = ObjectsPatch'
    ...
    , _opObject                   :: !Text
    , _opProjection               :: !(Maybe ObjectsPatch'Projection)
...
opProjection :: Lens' ObjectsPatch' (Maybe ObjectsPatch'Projection)
opProjection
