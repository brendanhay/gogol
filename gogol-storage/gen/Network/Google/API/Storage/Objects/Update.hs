...
--
-- /See:/ <https://developers.google.com/storage/docs/json_api/ Cloud Storage API Reference> for @storage.objects.update@.
module Network.Google.API.Storage.Objects.Update
    (
    -- * REST Resource
      ObjectsUpdateAPI
...
-- | A resource alias for storage.objects.update which the
                       ...
                       QueryParam "userIp" Text :>
                         QueryParam "key" Text :>
                           QueryParam "ifMetagenerationNotMatch" Word64 :>
                             QueryParam "projection" ObjectsUpdate'Projection :>
...
data ObjectsUpdate' = ObjectsUpdate'
    ...
    , _ouObject                   :: !Text
    , _ouProjection               :: !(Maybe ObjectsUpdate'Projection)
...
ouProjection :: Lens' ObjectsUpdate' (Maybe ObjectsUpdate'Projection)
ouProjection
