...
-- | Creates a GTM Macro.
--
-- /See:/ <https://developers.google.com/tag-manager/api/v1/ Tag Manager API Reference> for @tagmanager.accounts.containers.macros.create@.
module Network.Google.API.TagManager.Accounts.Containers.MACros.Create
    (
    -- * REST Resource
...
-- | A resource alias for tagmanager.accounts.containers.macros.create which the
