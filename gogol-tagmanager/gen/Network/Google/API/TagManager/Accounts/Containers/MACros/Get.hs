...
-- | Gets a GTM Macro.
--
-- /See:/ <https://developers.google.com/tag-manager/api/v1/ Tag Manager API Reference> for @tagmanager.accounts.containers.macros.get@.
module Network.Google.API.TagManager.Accounts.Containers.MACros.Get
    (
    -- * REST Resource
...
-- | A resource alias for tagmanager.accounts.containers.macros.get which the
