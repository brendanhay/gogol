...
--
-- /See:/ <https://developers.google.com/tag-manager/api/v1/ Tag Manager API Reference> for @tagmanager.accounts.containers.rules.list@.
module Network.Google.API.TagManager.Accounts.Containers.Rules.List
    (
    -- * REST Resource
...
-- | A resource alias for tagmanager.accounts.containers.rules.list which the
