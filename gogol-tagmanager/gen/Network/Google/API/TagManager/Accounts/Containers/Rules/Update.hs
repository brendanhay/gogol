...
-- | Updates a GTM Rule.
--
-- /See:/ <https://developers.google.com/tag-manager/api/v1/ Tag Manager API Reference> for @tagmanager.accounts.containers.rules.update@.
module Network.Google.API.TagManager.Accounts.Containers.Rules.Update
    (
    -- * REST Resource
...
-- | A resource alias for tagmanager.accounts.containers.rules.update which the
