...
-- | A resource alias for tagmanager.accounts.containers.triggers.list which the
...
actlcQuotaUser :: Lens' AccountsContainersTriggersList' (Maybe Text)
actlcQuotaUser
  = lens _actlcQuotaUser
      (\ s a -> s{_actlcQuotaUser = a})

-- | Returns response with indentations and line breaks.
actlcPrettyPrint :: Lens' AccountsContainersTriggersList' Bool
actlcPrettyPrint
...
actlcUserIp :: Lens' AccountsContainersTriggersList' (Maybe Text)
actlcUserIp
...
-- token.
actlcKey :: Lens' AccountsContainersTriggersList' (Maybe Text)
actlcKey = lens _actlcKey (\ s a -> s{_actlcKey = a})

-- | OAuth 2.0 token for the current user.
actlcOauthToken :: Lens' AccountsContainersTriggersList' (Maybe Text)
actlcOauthToken
  = lens _actlcOauthToken
      (\ s a -> s{_actlcOauthToken = a})

-- | Selector specifying which fields to include in a partial response.
actlcFields :: Lens' AccountsContainersTriggersList' (Maybe Text)
actlcFields
  = lens _actlcFields (\ s a -> s{_actlcFields = a})

-- | Data format for the response.
actlcAlt :: Lens' AccountsContainersTriggersList' Alt
