...
-- | A resource alias for tagmanager.accounts.containers.variables.update which the
...
accountsContainersVariablesUpdate'
    ...
    -> Text -- ^ 'accountId'
    -> AccountsContainersVariablesUpdate'
accountsContainersVariablesUpdate' pAcvucContainerId_ pAcvucVariableId_ pAcvucAccountId_ =
    AccountsContainersVariablesUpdate'
    ...
    , _acvucVariableId = pAcvucVariableId_
...
acvucQuotaUser :: Lens' AccountsContainersVariablesUpdate' (Maybe Text)
acvucQuotaUser
  = lens _acvucQuotaUser
      (\ s a -> s{_acvucQuotaUser = a})

-- | Returns response with indentations and line breaks.
acvucPrettyPrint :: Lens' AccountsContainersVariablesUpdate' Bool
acvucPrettyPrint
  = lens _acvucPrettyPrint
      (\ s a -> s{_acvucPrettyPrint = a})

-- | The GTM Container ID.
acvucContainerId :: Lens' AccountsContainersVariablesUpdate' Text
acvucContainerId
...
acvucUserIp :: Lens' AccountsContainersVariablesUpdate' (Maybe Text)
acvucUserIp
  = lens _acvucUserIp (\ s a -> s{_acvucUserIp = a})

-- | When provided, this fingerprint must match the fingerprint of the
-- variable in storage.
acvucFingerprint :: Lens' AccountsContainersVariablesUpdate' (Maybe Text)
acvucFingerprint
  = lens _acvucFingerprint
      (\ s a -> s{_acvucFingerprint = a})

-- | The GTM Variable ID.
acvucVariableId :: Lens' AccountsContainersVariablesUpdate' Text
acvucVariableId
  = lens _acvucVariableId
      (\ s a -> s{_acvucVariableId = a})

-- | The GTM Account ID.
acvucAccountId :: Lens' AccountsContainersVariablesUpdate' Text
acvucAccountId
...
-- token.
acvucKey :: Lens' AccountsContainersVariablesUpdate' (Maybe Text)
acvucKey = lens _acvucKey (\ s a -> s{_acvucKey = a})

-- | OAuth 2.0 token for the current user.
acvucOauthToken :: Lens' AccountsContainersVariablesUpdate' (Maybe Text)
acvucOauthToken
  = lens _acvucOauthToken
      (\ s a -> s{_acvucOauthToken = a})

-- | Selector specifying which fields to include in a partial response.
acvucFields :: Lens' AccountsContainersVariablesUpdate' (Maybe Text)
acvucFields
  = lens _acvucFields (\ s a -> s{_acvucFields = a})

-- | Data format for the response.
acvucAlt :: Lens' AccountsContainersVariablesUpdate' Alt
