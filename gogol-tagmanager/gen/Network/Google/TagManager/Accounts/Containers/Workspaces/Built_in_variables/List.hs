...
-- |
-- Module      : Network.Google.TagManager.Accounts.Containers.Workspaces.Built_in_variables.List
...
newTagManagerAccountsContainersWorkspacesBuilt_in_variablesList ::
  ...
  Core.Text ->
  TagManagerAccountsContainersWorkspacesBuilt_in_variablesList
newTagManagerAccountsContainersWorkspacesBuilt_in_variablesList parent =
  TagManagerAccountsContainersWorkspacesBuilt_in_variablesList
    { xgafv = Core.Nothing,
