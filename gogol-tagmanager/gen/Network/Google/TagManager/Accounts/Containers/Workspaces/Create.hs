...
-- |
-- Module      : Network.Google.TagManager.Accounts.Containers.Workspaces.Create
...
type TagManagerAccountsContainersWorkspacesCreateResource =
  "tagmanager"
    ...
    Core.:> Core.Post '[Core.JSON] Workspace
...
instance
  ...
  where
  type
    Rs TagManagerAccountsContainersWorkspacesCreate =
      Workspace
  type
    Scopes
      TagManagerAccountsContainersWorkspacesCreate =
