...
-- |
-- Module      : Network.Google.TagManager.Accounts.Containers.Workspaces.Folders.Move_entities_to_folder
...
type TagManagerAccountsContainersWorkspacesFoldersMove_entities_to_folderResource =
  "tagmanager"
    ...
    Core.:> Core.QueryParams "tagId" Core.Text
    Core.:> Core.QueryParams "triggerId" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParams "variableId" Core.Text
