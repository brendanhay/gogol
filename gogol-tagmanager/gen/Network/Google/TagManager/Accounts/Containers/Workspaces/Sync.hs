...
-- |
-- Module      : Network.Google.TagManager.Accounts.Containers.Workspaces.Sync
...
type TagManagerAccountsContainersWorkspacesSyncResource =
  "tagmanager"
    Core.:> "v2"
    Core.:> Core.CaptureMode "path" "sync" Core.Text
    ...
    Core.:> Core.Post '[Core.JSON] SyncWorkspaceResponse
...
instance
  ...
  where
  type
    Rs TagManagerAccountsContainersWorkspacesSync =
