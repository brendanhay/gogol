...
-- |
-- Module      : Network.Google.TagManager.Accounts.User_permissions.Get
...
type TagManagerAccountsUser_permissionsGetResource =
  "tagmanager"
    ...
    Core.:> Core.Get '[Core.JSON] UserPermission
...
instance
  ...
  where
  type
    Rs TagManagerAccountsUser_permissionsGet =
      UserPermission
  type
    Scopes TagManagerAccountsUser_permissionsGet =
