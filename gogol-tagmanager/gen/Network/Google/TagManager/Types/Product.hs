...
data Container = Container
    ...
    , _cUsageContext           :: !(Maybe [ContainerItemUsageContext])
    , _cEnabledBuiltInVariable :: !(Maybe [ContainerItemEnabledBuiltInVariable])
...
-- android, ios.
cUsageContext :: Lens' Container [ContainerItemUsageContext]
cUsageContext
  = lens _cUsageContext
...
cEnabledBuiltInVariable :: Lens' Container [ContainerItemEnabledBuiltInVariable]
cEnabledBuiltInVariable
...
lmrMacros :: Lens' ListMacrosResponse [Maybe Macro]
lmrMacros
...
-- edit, delete, publish.
caPermission :: Lens' ContainerAccess [ContainerAccessItemPermission]
caPermission
...
-- manage.
aaPermission :: Lens' AccountAccess [AccountAccessItemPermission]
aaPermission
