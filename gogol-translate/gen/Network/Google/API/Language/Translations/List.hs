...
-- | A resource alias for language.translations.list which the
       ...
       QueryParam "quotaUser" Text :>
         QueryParam "prettyPrint" Bool :>
           QueryParam "userIp" Text :>
             QueryParam "format" TranslationsList'Format :>
               QueryParam "q" Text :>
                 QueryParam "key" Text :>
...
data TranslationsList' = TranslationsList'
    ...
    , _tlFormat      :: !(Maybe TranslationsList'Format)
    , _tlQ           :: !Text
    , _tlKey         :: !(Maybe Text)
...
tlFormat :: Lens' TranslationsList' (Maybe TranslationsList'Format)
