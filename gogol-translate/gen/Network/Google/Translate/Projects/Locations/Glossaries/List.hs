...
-- |
-- Module      : Network.Google.Translate.Projects.Locations.Glossaries.List
...
type TranslateProjectsLocationsGlossariesListResource =
  "v3"
    ...
    Core.:> Core.Get '[Core.JSON] ListGlossariesResponse
...
instance
  ...
  where
  type
    Rs TranslateProjectsLocationsGlossariesList =
      ListGlossariesResponse
  type
    Scopes TranslateProjectsLocationsGlossariesList =
