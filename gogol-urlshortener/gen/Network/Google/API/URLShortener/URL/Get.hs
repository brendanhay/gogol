...
-- | A resource alias for urlshortener.url.get which the
       ...
       QueryParam "quotaUser" Text :>
         QueryParam "prettyPrint" Bool :>
           QueryParam "userIp" Text :>
             QueryParam "key" Text :>
               QueryParam "projection" URLGet'Projection :>
...
data URLGet' = URLGet'
    ...
    , _ugKey         :: !(Maybe Text)
    , _ugProjection  :: !(Maybe URLGet'Projection)
...
ugProjection :: Lens' URLGet' (Maybe URLGet'Projection)
ugProjection
