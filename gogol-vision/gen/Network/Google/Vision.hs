...
import Network.Google.Resource.Vision.Files.Annotate
import Network.Google.Resource.Vision.Files.AsyncBatchAnnotate
import Network.Google.Resource.Vision.Images.Annotate
import Network.Google.Resource.Vision.Images.AsyncBatchAnnotate
import Network.Google.Resource.Vision.Projects.Files.Annotate
import Network.Google.Resource.Vision.Projects.Files.AsyncBatchAnnotate
import Network.Google.Resource.Vision.Projects.Images.Annotate
import Network.Google.Resource.Vision.Projects.Images.AsyncBatchAnnotate
import Network.Google.Resource.Vision.Projects.Locations.Files.Annotate
import Network.Google.Resource.Vision.Projects.Locations.Files.AsyncBatchAnnotate
import Network.Google.Resource.Vision.Projects.Locations.Images.Annotate
import Network.Google.Resource.Vision.Projects.Locations.Images.AsyncBatchAnnotate
