...
-- | A resource alias for webmasters.urlcrawlerrorscounts.query which the
...
data URLcrawlerrorscountsQuery' = URLcrawlerrorscountsQuery'
    ...
    , _uqPrettyPrint      :: !Bool
    , _uqPlatform         :: !(Maybe URLcrawlerrorscountsQuery'Platform)
    , _uqUserIp           :: !(Maybe Text)
    , _uqCategory         :: !(Maybe URLcrawlerrorscountsQuery'Category)
    , _uqSiteUrl          :: !Text
    , _uqKey              :: !(Maybe Text)
...
uqPlatform :: Lens' URLcrawlerrorscountsQuery' (Maybe URLcrawlerrorscountsQuery'Platform)
uqPlatform
...
uqCategory :: Lens' URLcrawlerrorscountsQuery' (Maybe URLcrawlerrorscountsQuery'Category)
uqCategory
