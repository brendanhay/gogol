...
-- | A resource alias for webmasters.urlcrawlerrorssamples.get which the
...
data URLcrawlerrorssamplesGet' = URLcrawlerrorssamplesGet'
    ...
    , _ugPrettyPrint :: !Bool
    , _ugPlatform    :: !URLcrawlerrorssamplesGet'Platform
    , _ugUserIp      :: !(Maybe Text)
    , _ugCategory    :: !URLcrawlerrorssamplesGet'Category
    , _ugSiteUrl     :: !Text
    , _ugUrl         :: !Text
    , _ugKey         :: !(Maybe Text)
...
-- * 'ugAlt'
uRLcrawlerrorssamplesGet'
    :: URLcrawlerrorssamplesGet'Platform -- ^ 'platform'
    -> URLcrawlerrorssamplesGet'Category -- ^ 'category'
    -> Text -- ^ 'siteUrl'
    -> Text -- ^ 'url'
    -> URLcrawlerrorssamplesGet'
...
ugPlatform :: Lens' URLcrawlerrorssamplesGet' URLcrawlerrorssamplesGet'Platform
ugPlatform
...
ugCategory :: Lens' URLcrawlerrorssamplesGet' URLcrawlerrorssamplesGet'Category
ugCategory
