...
-- | A resource alias for webmasters.urlcrawlerrorssamples.list which the
...
data URLcrawlerrorssamplesList' = URLcrawlerrorssamplesList'
    ...
    , _ulPrettyPrint :: !Bool
    , _ulPlatform    :: !URLcrawlerrorssamplesList'Platform
    , _ulUserIp      :: !(Maybe Text)
    , _ulCategory    :: !URLcrawlerrorssamplesList'Category
    , _ulSiteUrl     :: !Text
    , _ulKey         :: !(Maybe Text)
...
-- * 'ulAlt'
uRLcrawlerrorssamplesList'
    :: URLcrawlerrorssamplesList'Platform -- ^ 'platform'
    -> URLcrawlerrorssamplesList'Category -- ^ 'category'
    -> Text -- ^ 'siteUrl'
    -> URLcrawlerrorssamplesList'
...
ulPlatform :: Lens' URLcrawlerrorssamplesList' URLcrawlerrorssamplesList'Platform
ulPlatform
...
ulCategory :: Lens' URLcrawlerrorssamplesList' URLcrawlerrorssamplesList'Category
ulCategory
