...
-- | A resource alias for webmasters.urlcrawlerrorssamples.markAsFixed which the
...
data URLcrawlerrorssamplesMarkAsFixed' = URLcrawlerrorssamplesMarkAsFixed'
    ...
    , _umafPlatform    :: !URLcrawlerrorssamplesMarkAsFixed'Platform
    , _umafUserIp      :: !(Maybe Text)
    , _umafCategory    :: !URLcrawlerrorssamplesMarkAsFixed'Category
    , _umafSiteUrl     :: !Text
    , _umafUrl         :: !Text
    , _umafKey         :: !(Maybe Text)
...
-- * 'umafAlt'
uRLcrawlerrorssamplesMarkAsFixed'
    :: URLcrawlerrorssamplesMarkAsFixed'Platform -- ^ 'platform'
    -> URLcrawlerrorssamplesMarkAsFixed'Category -- ^ 'category'
    -> Text -- ^ 'siteUrl'
    -> Text -- ^ 'url'
    -> URLcrawlerrorssamplesMarkAsFixed'
...
umafPlatform :: Lens' URLcrawlerrorssamplesMarkAsFixed' URLcrawlerrorssamplesMarkAsFixed'Platform
umafPlatform
...
umafCategory :: Lens' URLcrawlerrorssamplesMarkAsFixed' URLcrawlerrorssamplesMarkAsFixed'Category
umafCategory
