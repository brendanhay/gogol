...
-- |
-- Module      : Network.Google.WebSecurityScanner.Projects.ScanConfigs.ScanRuns.FindingTypeStats.List
...
newWebSecurityScannerProjectsScanConfigsScanRunsFindingTypeStatsList ::
  ...
  Core.Text ->
  WebSecurityScannerProjectsScanConfigsScanRunsFindingTypeStatsList
newWebSecurityScannerProjectsScanConfigsScanRunsFindingTypeStatsList parent =
  WebSecurityScannerProjectsScanConfigsScanRunsFindingTypeStatsList
    { xgafv = Core.Nothing,
