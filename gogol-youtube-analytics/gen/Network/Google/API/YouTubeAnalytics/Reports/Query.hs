...
-- | A resource alias for youtubeAnalytics.reports.query which the
...
data ReportsQuery' = ReportsQuery'
    ...
    , _rqStartIndex  :: !(Maybe Nat)
    , _rqMaxResults  :: !(Maybe Nat)
    , _rqStartDate   :: !Text
...
-- inclusive).
rqStartIndex :: Lens' ReportsQuery' (Maybe Natural)
rqStartIndex
  = lens _rqStartIndex (\ s a -> s{_rqStartIndex = a})
      . mapping _Nat

-- | The maximum number of rows to include in the response.
rqMaxResults :: Lens' ReportsQuery' (Maybe Natural)
rqMaxResults
