...
-- | A resource alias for youtube.liveBroadcasts.list which the
...
data LiveBroadcastsList' = LiveBroadcastsList'
    ...
    , _lblBroadcastStatus               :: !(Maybe LiveBroadcastsList'BroadcastStatus)
...
lblBroadcastStatus :: Lens' LiveBroadcastsList' (Maybe LiveBroadcastsList'BroadcastStatus)
lblBroadcastStatus
...
-- token.
lblKey :: Lens' LiveBroadcastsList' (Maybe Text)
...
lblOauthToken :: Lens' LiveBroadcastsList' (Maybe Text)
lblOauthToken
  = lens _lblOauthToken
