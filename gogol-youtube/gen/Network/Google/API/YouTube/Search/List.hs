...
-- | A resource alias for youtube.search.list which the
         ...
         QueryParam "videoDefinition"
           ...
           QueryParam "quotaUser" Text :>
             QueryParam "part" Text :>
               QueryParam "videoDuration" SearchList'VideoDuration
                 :>
                 QueryParam "prettyPrint" Bool :>
                   QueryParam "videoCaption" SearchList'VideoCaption :>
                     QueryParam "videoLicense" SearchList'VideoLicense :>
...
data SearchList' = SearchList'
    ...
    , _sVideoDefinition        :: !(Maybe SearchList'VideoDefinition)
    , _sQuotaUser              :: !(Maybe Text)
    , _sPart                   :: !Text
    , _sVideoDuration          :: !(Maybe SearchList'VideoDuration)
    , _sPrettyPrint            :: !Bool
    , _sVideoCaption           :: !(Maybe SearchList'VideoCaption)
    , _sVideoLicense           :: !(Maybe SearchList'VideoLicense)
    ...
    , _sVideoEmbeddable        :: !(Maybe SearchList'VideoEmbeddable)
    , _sEventType              :: !(Maybe SearchList'EventType)
    , _sOnBehalfOfContentOwner :: !(Maybe Text)
    , _sVideoCategoryId        :: !(Maybe Text)
    , _sTopicId                :: !(Maybe Text)
    , _sKey                    :: !(Maybe Text)
    , _sSafeSearch             :: !(Maybe SearchList'SafeSearch)
    , _sVideoSyndicated        :: !(Maybe SearchList'VideoSyndicated)
    , _sRelatedToVideoId       :: !(Maybe Text)
    , _sPageToken              :: !(Maybe Text)
    , _sType                   :: !Text
    , _sOauthToken             :: !(Maybe Text)
    , _sChannelType            :: !(Maybe SearchList'ChannelType)
    , _sRelevanceLanguage      :: !(Maybe Text)
    , _sOrder                  :: !SearchList'Order
    , _sMaxResults             :: !Word32
    , _sPublishedBefore        :: !(Maybe UTCTime)
    , _sVideoType              :: !(Maybe SearchList'VideoType)
    , _sVideoDimension         :: !(Maybe SearchList'VideoDimension)
    , _sFields                 :: !(Maybe Text)
    , _sAlt                    :: !Alt
...
searchList' pSPart_ =
    ...
    , _sOrder = SLOSearchSortRelevance
    , _sMaxResults = 5
...
-- video.
sVideoDefinition :: Lens' SearchList' (Maybe SearchList'VideoDefinition)
sVideoDefinition
...
sVideoDuration :: Lens' SearchList' (Maybe SearchList'VideoDuration)
sVideoDuration
...
-- to video.
sVideoCaption :: Lens' SearchList' (Maybe SearchList'VideoCaption)
sVideoCaption
  = lens _sVideoCaption
...
sVideoLicense :: Lens' SearchList' (Maybe SearchList'VideoLicense)
sVideoLicense
  = lens _sVideoLicense
...
sVideoEmbeddable :: Lens' SearchList' (Maybe SearchList'VideoEmbeddable)
sVideoEmbeddable
...
sEventType :: Lens' SearchList' (Maybe SearchList'EventType)
sEventType
...
sSafeSearch :: Lens' SearchList' (Maybe SearchList'SafeSearch)
sSafeSearch
...
-- for this parameter, you must also set the type parameter\'s value to
-- video.
sVideoSyndicated :: Lens' SearchList' (Maybe SearchList'VideoSyndicated)
sVideoSyndicated
...
-- type of channel.
sChannelType :: Lens' SearchList' (Maybe SearchList'ChannelType)
sChannelType
...
sOrder :: Lens' SearchList' SearchList'Order
...
-- the type parameter\'s value to video.
sVideoType :: Lens' SearchList' (Maybe SearchList'VideoType)
sVideoType
...
sVideoDimension :: Lens' SearchList' (Maybe SearchList'VideoDimension)
sVideoDimension
