...
-- | A resource alias for youtube.subscriptions.list which the
                             ...
                             QueryParam "forChannelId" Text :>
                               QueryParam "pageToken" Text :>
                                 QueryParam "oauth_token" Text :>
                                   QueryParam "order" SubscriptionsList'Order :>
...
data SubscriptionsList' = SubscriptionsList'
    ...
    , _slOrder                         :: !SubscriptionsList'Order
...
subscriptionsList' pSlPart_ =
    ...
    , _slOrder = SubscriptionOrderRelevance
    , _slMaxResults = 5
    , _slFields = Nothing
    , _slAlt = JSON
    }
...
slOrder :: Lens' SubscriptionsList' SubscriptionsList'Order
