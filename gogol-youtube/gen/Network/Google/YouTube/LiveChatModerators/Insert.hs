...
-- |
-- Module      : Network.Google.YouTube.LiveChatModerators.Insert
...
type YouTubeLiveChatModeratorsInsertResource =
  "youtube"
    ...
    Core.:> Core.ReqBody '[Core.JSON] LiveChatModerator
    Core.:> Core.Post '[Core.JSON] LiveChatModerator
...
instance
  ...
  where
  type
    Rs YouTubeLiveChatModeratorsInsert =
      LiveChatModerator
  type
    Scopes YouTubeLiveChatModeratorsInsert =
