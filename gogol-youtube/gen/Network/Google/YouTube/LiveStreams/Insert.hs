...
-- |
-- Module      : Network.Google.YouTube.LiveStreams.Insert
...
type YouTubeLiveStreamsInsertResource =
  "youtube"
    ...
    Core.:> Core.ReqBody '[Core.JSON] LiveStream
    Core.:> Core.Post '[Core.JSON] LiveStream
  ...
  requestClient YouTubeLiveStreamsInsert {..} =
    ...
    where
      go =
        Core.buildClient
          ( Core.Proxy ::
              Core.Proxy YouTubeLiveStreamsInsertResource
          )
          Core.mempty
