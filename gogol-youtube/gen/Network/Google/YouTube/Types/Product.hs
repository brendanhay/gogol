...
data Channel = Channel
    { _chaStatus              :: !(Maybe (Maybe ChannelStatus))
    , _chaEtag                :: !(Maybe Text)
    , _chaAuditDetails        :: !(Maybe (Maybe ChannelAuditDetails))
    , _chaContentOwnerDetails :: !(Maybe (Maybe ChannelContentOwnerDetails))
    , _chaSnippet             :: !(Maybe (Maybe ChannelSnippet))
    , _chaKind                :: !Text
    , _chaTopicDetails        :: !(Maybe (Maybe ChannelTopicDetails))
    , _chaContentDetails      :: !(Maybe (Maybe ChannelContentDetails))
    , _chaConversionPings     :: !(Maybe (Maybe ChannelConversionPings))
    , _chaBrandingSettings    :: !(Maybe (Maybe ChannelBrandingSettings))
    , _chaId                  :: !(Maybe Text)
    , _chaInvideoPromotion    :: !(Maybe (Maybe InvideoPromotion))
    , _chaStatistics          :: !(Maybe (Maybe ChannelStatistics))
...
-- the channel.
chaStatus :: Lens' Channel (Maybe (Maybe ChannelStatus))
chaStatus
...
chaAuditDetails :: Lens' Channel (Maybe (Maybe ChannelAuditDetails))
chaAuditDetails
...
chaContentOwnerDetails :: Lens' Channel (Maybe (Maybe ChannelContentOwnerDetails))
chaContentOwnerDetails
...
chaSnippet :: Lens' Channel (Maybe (Maybe ChannelSnippet))
chaSnippet
...
chaTopicDetails :: Lens' Channel (Maybe (Maybe ChannelTopicDetails))
chaTopicDetails
...
-- content.
chaContentDetails :: Lens' Channel (Maybe (Maybe ChannelContentDetails))
chaContentDetails
...
chaConversionPings :: Lens' Channel (Maybe (Maybe ChannelConversionPings))
chaConversionPings
...
-- of the channel.
chaBrandingSettings :: Lens' Channel (Maybe (Maybe ChannelBrandingSettings))
chaBrandingSettings
...
chaInvideoPromotion :: Lens' Channel (Maybe (Maybe InvideoPromotion))
chaInvideoPromotion
  = lens _chaInvideoPromotion
      (\ s a -> s{_chaInvideoPromotion = a})

-- | The statistics object encapsulates statistics for the channel.
chaStatistics :: Lens' Channel (Maybe (Maybe ChannelStatistics))
chaStatistics
  = lens _chaStatistics
...
vrRating :: Lens' VideoRating (Maybe VideoRatingRating)
