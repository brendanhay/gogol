...
newBatchGetAmpUrlsRequest 
    ::  BatchGetAmpUrlsRequest
newBatchGetAmpUrlsRequest =
  BatchGetAmpUrlsRequest {lookupStrategy = Core.Nothing, urls = Core.Nothing}
          ...
          = Core.withObject "BatchGetAmpUrlsRequest"
              (\ o ->
                 BatchGetAmpUrlsRequest Core.<$>
                   (o Core..:? "lookupStrategy") Core.<*>
                     (o Core..:? "urls" Core..!= Core.mempty))
...
newBatchGetAmpUrlsResponse 
    ::  BatchGetAmpUrlsResponse
newBatchGetAmpUrlsResponse =
  BatchGetAmpUrlsResponse {ampUrls = Core.Nothing, urlErrors = Core.Nothing}
          ...
          = Core.withObject "BatchGetAmpUrlsResponse"
              (\ o ->
                 BatchGetAmpUrlsResponse Core.<$>
                   (o Core..:? "ampUrls" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "urlErrors" Core..!= Core.mempty))
