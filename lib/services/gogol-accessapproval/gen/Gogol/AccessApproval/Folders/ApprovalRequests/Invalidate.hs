...
--
-- /See:/ <https://cloud.google.com/cloud-provider-access-management/access-approval/docs Access Approval API Reference> for @accessapproval.folders.approvalRequests.invalidate@.
module Gogol.AccessApproval.Folders.ApprovalRequests.Invalidate
  ( -- * Resource
