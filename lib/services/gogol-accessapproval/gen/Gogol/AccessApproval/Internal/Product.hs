              ...
              (\ o ->
                 AccessApprovalSettings Core.<$>
                   (o Core..:? "activeKeyVersion") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "requestScopeMaxWidthPreference")
                     Core.<*>
                     (o Core..:? "requireCustomerVisibleJustification"))
          ...
          = Core.object
              (Core.catMaybes
                 [("approve" Core..=) Core.<$> approve,
                  ...
                  ("requestedAugmentedInfo" Core..=) Core.<$>
                    requestedAugmentedInfo,
                  ("requestedDuration" Core..=) Core.<$>
                    requestedDuration,
...
instance Core.FromJSON AugmentedInfo where
        parseJSON
          = Core.withObject "AugmentedInfo"
              (\ o ->
                 AugmentedInfo Core.<$> (o Core..:? "command"))
