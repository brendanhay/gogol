...
--
-- /See:/ <https://cloud.google.com/cloud-provider-access-management/access-approval/docs Access Approval API Reference> for @accessapproval.projects.approvalRequests.invalidate@.
module Gogol.AccessApproval.Projects.ApprovalRequests.Invalidate
  ( -- * Resource
