...
instance Core.FromJSON AccessScope where
        parseJSON
          = Core.withObject "AccessScope"
              (\ o ->
                 AccessScope Core.<$> (o Core..:? "clientScope"))

instance Core.ToJSON AccessScope where
        toJSON AccessScope{..}
          = Core.object
              (Core.catMaybes
                 [("clientScope" Core..=) Core.<$> clientScope])
...
newAccessSettings 
    ::  AccessSettings
newAccessSettings =
  AccessSettings {accessLevels = Core.Nothing, sessionSettings = Core.Nothing}
...
newApplication 
    ::  Application
newApplication = Application {clientId = Core.Nothing, name = Core.Nothing}
...
newClientScope 
    ::  ClientScope
newClientScope = ClientScope {restrictedClientApplication = Core.Nothing}
...
instance Core.FromJSON ClientScope where
        parseJSON
          = Core.withObject "ClientScope"
              (\ o ->
                 ClientScope Core.<$>
                   (o Core..:? "restrictedClientApplication"))
...
newEgressPolicy =
  EgressPolicy
    {egressFrom = Core.Nothing, egressTo = Core.Nothing, title = Core.Nothing}
...
newtype EgressSource = EgressSource
    {
...
newEgressSource 
    ::  EgressSource
newEgressSource = EgressSource {accessLevel = Core.Nothing}

instance Core.FromJSON EgressSource where
        parseJSON
          = Core.withObject "EgressSource"
              (\ o ->
                 EgressSource Core.<$> (o Core..:? "accessLevel"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accessLevels" Core..=) Core.<$> accessLevels,
                  ...
                  ("scopedAccessSettings" Core..=) Core.<$>
                    scopedAccessSettings,
                  ("sessionSettings" Core..=) Core.<$>
                    sessionSettings])
...
newIngressPolicy =
  IngressPolicy
    {ingressFrom = Core.Nothing, ingressTo = Core.Nothing, title = Core.Nothing}
...
newListSupportedServicesResponse =
  ListSupportedServicesResponse
    {nextPageToken = Core.Nothing, supportedServices = Core.Nothing}

instance Core.FromJSON ListSupportedServicesResponse
         where
        parseJSON
...
instance Core.ToJSON ListSupportedServicesResponse
         where
        toJSON ListSupportedServicesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("supportedServices" Core..=) Core.<$>
                    supportedServices])
          ...
          = Core.withObject "SessionSettings"
              (\ o ->
                 SessionSettings Core.<$>
                   (o Core..:? "maxInactivity") Core.<*>
                     (o Core..:? "sessionLength")
          ...
          = Core.object
              (Core.catMaybes
                 [("maxInactivity" Core..=) Core.<$> maxInactivity,
                  ...
                  ("sessionLengthEnabled" Core..=) Core.<$>
                    sessionLengthEnabled,
                  ("sessionReauthMethod" Core..=) Core.<$>
                    sessionReauthMethod,
          ...
          = Core.object
              (Core.catMaybes
                 [("availableOnRestrictedVip" Core..=) Core.<$>
                  ...
                  ("knownLimitations" Core..=) Core.<$>
                    knownLimitations,
                  ("name" Core..=) Core.<$> name,
                  ("serviceSupportStage" Core..=) Core.<$>
                    serviceSupportStage,
                  ("supportStage" Core..=) Core.<$> supportStage,
                  ("supportedMethods" Core..=) Core.<$>
                    supportedMethods,
                  ("title" Core..=) Core.<$> title])
...
newVpcNetworkSource 
    ::  VpcNetworkSource
newVpcNetworkSource = VpcNetworkSource {vpcSubnetwork = Core.Nothing}

instance Core.FromJSON VpcNetworkSource where
        parseJSON
          = Core.withObject "VpcNetworkSource"
              (\ o ->
                 VpcNetworkSource Core.<$>
...
instance Core.ToJSON VpcNetworkSource where
        toJSON VpcNetworkSource{..}
          = Core.object
              (Core.catMaybes
                 [("vpcSubnetwork" Core..=) Core.<$> vpcSubnetwork])
...
newVpcSubNetwork 
    ::  VpcSubNetwork
newVpcSubNetwork =
  VpcSubNetwork {network = Core.Nothing, vpcIpSubnetworks = Core.Nothing}
