...
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "applyPretargetingToNonGuaranteedDeals")
                     Core.<*>
                     (o Core..:? "bidderLocation" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "cookieMatchingNid")
                     Core.<*> (o Core..:? "cookieMatchingUrl")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "adexchangebuyer#account")
          ...
          = Core.object
              (Core.catMaybes
                 [("applyPretargetingToNonGuaranteedDeals" Core..=)
                  ...
                  ("cookieMatchingNid" Core..=) Core.<$>
                    cookieMatchingNid,
                  ("cookieMatchingUrl" Core..=) Core.<$>
                    cookieMatchingUrl,
                  ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("maximumActiveCreatives" Core..=) Core.<$>
                    maximumActiveCreatives,
                  ("maximumTotalQps" Core..=) Core.<$> maximumTotalQps,
                  ("numberActiveCreatives" Core..=) Core.<$>
          ...
          = Core.withObject "AddOrderDealsRequest"
              (\ o ->
                 AddOrderDealsRequest Core.<$>
                   (o Core..:? "deals" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "proposalRevisionNumber")
...
newAddOrderDealsResponse =
  AddOrderDealsResponse
    {deals = Core.Nothing, proposalRevisionNumber = Core.Nothing}
...
instance Core.FromJSON AddOrderNotesRequest where
        parseJSON
          = Core.withObject "AddOrderNotesRequest"
              (\ o ->
                 AddOrderNotesRequest Core.<$>
                   (o Core..:? "notes" Core..!= Core.mempty))
              ...
              (\ o ->
                 BillingInfo Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "accountName")
                     Core.<*>
                     (o Core..:? "billingId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "adexchangebuyer#billingInfo"))
...
newBillingInfoList =
  BillingInfoList
    {items = Core.Nothing, kind = "adexchangebuyer#billingInfoList"}
          ...
          = Core.withObject "BillingInfoList"
              (\ o ->
                 BillingInfoList Core.<$>
                   (o Core..:? "items" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind" Core..!=
                        "adexchangebuyer#billingInfoList"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$>
                    accountId,
                  ("billingId" Core..=) Core.. Core.AsText Core.<$>
                    billingId,
                  ("budgetAmount" Core..=) Core.. Core.AsText Core.<$>
                    budgetAmount,
          ...
          = Core.withObject "CreateOrdersRequest"
              (\ o ->
                 CreateOrdersRequest Core.<$>
                   (o Core..:? "proposals" Core..!= Core.mempty)
...
instance Core.FromJSON Creative where
        parseJSON
          = Core.withObject "Creative"
              (\ o ->
                 Creative Core.<$>
                   (o Core..:? "HTMLSnippet") Core.<*>
                     (o Core..:? "accountId")
                     Core.<*> (o Core..:? "adChoicesDestinationUrl")
                     Core.<*> (o Core..:? "adTechnologyProviders")
                     Core.<*>
                     (o Core..:? "advertiserId" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "advertiserName")
                     Core.<*> (o Core..:? "agencyId")
                     Core.<*> (o Core..:? "apiUploadTimestamp")
                     Core.<*>
                     (o Core..:? "attribute" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "buyerCreativeId")
                     Core.<*>
                     (o Core..:? "clickThroughUrl" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "corrections" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "creativeStatusIdentityType")
                     Core.<*> (o Core..:? "dealsStatus")
                     Core.<*>
                     (o Core..:? "detectedDomains" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "filteringReasons")
                     Core.<*> (o Core..:? "height")
                     Core.<*>
                     (o Core..:? "impressionTrackingUrl" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "adexchangebuyer#creative")
                     Core.<*>
                     (o Core..:? "languages" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nativeAd")
                     Core.<*> (o Core..:? "openAuctionStatus")
                     Core.<*>
                     (o Core..:? "productCategories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "restrictedCategories" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "sensitiveCategories" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "servingRestrictions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "vendorType" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "version")
          ...
          = Core.object
              (Core.catMaybes
                 [("HTMLSnippet" Core..=) Core.<$> hTMLSnippet,
                  ...
                  ("filteringReasons" Core..=) Core.<$>
                    filteringReasons,
                  ("height" Core..=) Core.<$> height,
                  ("impressionTrackingUrl" Core..=) Core.<$>
...
instance Core.FromJSON Creative_AdTechnologyProviders
         where
        parseJSON
...
instance Core.ToJSON Creative_AdTechnologyProviders
         where
...
newCreative_CorrectionsItem =
  Creative_CorrectionsItem
    {contexts = Core.Nothing, details = Core.Nothing, reason = Core.Nothing}
          ...
          = Core.withObject "Creative_CorrectionsItem"
              (\ o ->
                 Creative_CorrectionsItem Core.<$>
                   (o Core..:? "contexts" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject
              ...
              (\ o ->
                 Creative_CorrectionsItem_ContextsItem Core.<$>
                   (o Core..:? "auctionType" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "contextType")
                     Core.<*>
                     (o Core..:? "geoCriteriaId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "platform" Core..!= Core.mempty))
...
instance Core.FromJSON Creative_FilteringReasons
         where
        parseJSON
          = Core.withObject "Creative_FilteringReasons"
              (\ o ->
                 Creative_FilteringReasons Core.<$>
                   (o Core..:? "date") Core.<*>
                     (o Core..:? "reasons" Core..!= Core.mempty))
...
newCreative_FilteringReasons_ReasonsItem =
  Creative_FilteringReasons_ReasonsItem
    {filteringCount = Core.Nothing, filteringStatus = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 Creative_FilteringReasons_ReasonsItem Core.<$>
                   (o Core..:? "filteringCount") Core.<*>
                     (o Core..:? "filteringStatus"))
...
instance Core.FromJSON Creative_NativeAd_AppIcon
         where
        parseJSON
          ...
          = Core.withObject "Creative_ServingRestrictionsItem"
              (\ o ->
                 Creative_ServingRestrictionsItem Core.<$>
                   (o Core..:? "contexts" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "disapprovalReasons" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "reason"))

instance Core.ToJSON Creative_ServingRestrictionsItem
         where
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 Creative_ServingRestrictionsItem_DisapprovalReasonsItem
                   Core.<$>
                   (o Core..:? "details" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "reason"))
...
newCreativeDealIds =
  CreativeDealIds
    {dealStatuses = Core.Nothing, kind = "adexchangebuyer#creativeDealIds"}
          ...
          = Core.withObject "CreativeDealIds"
              (\ o ->
                 CreativeDealIds Core.<$>
                   (o Core..:? "dealStatuses" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON CreativeDealIds_DealStatusesItem
         where
...
newDealServingMetadata =
  DealServingMetadata
    {alcoholAdsAllowed = Core.Nothing, dealPauseStatus = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 DealTermsGuaranteedFixedPriceTerms Core.<$>
                   (o Core..:? "billingInfo") Core.<*>
                     (o Core..:? "fixedPrices" Core..!= Core.mempty)
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("currencyConversionTimeMs" Core..=) Core..
                    Core.AsText
                    Core.<$> currencyConversionTimeMs,
                  ("dfpLineItemId" Core..=) Core.. Core.AsText Core.<$>
                    dfpLineItemId,
                  ("originalContractedQuantity" Core..=) Core..
                    Core.AsText
              ...
              (\ o ->
                 DealTermsNonGuaranteedAuctionTerms Core.<$>
                   (o Core..:? "autoOptimizePrivateAuction") Core.<*>
                     (o Core..:? "reservePricePerBuyers" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("autoOptimizePrivateAuction" Core..=) Core.<$>
                  ...
                  ("reservePricePerBuyers" Core..=) Core.<$>
...
newDealTermsRubiconNonGuaranteedTerms =
  DealTermsRubiconNonGuaranteedTerms
    {priorityPrice = Core.Nothing, standardPrice = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 DealTermsRubiconNonGuaranteedTerms Core.<$>
                   (o Core..:? "priorityPrice") Core.<*>
                     (o Core..:? "standardPrice"))
          ...
          = Core.withObject "DeleteOrderDealsRequest"
              (\ o ->
                 DeleteOrderDealsRequest Core.<$>
                   (o Core..:? "dealIds" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "proposalRevisionNumber")
                     Core.<*> (o Core..:? "updateAction"))
              ...
              (\ o ->
                 DeliveryControl Core.<$>
                   (o Core..:? "creativeBlockingLevel") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "frequencyCaps" Core..!= Core.mempty))
...
instance Core.FromJSON DeliveryControlFrequencyCap
         where
        parseJSON
...
instance Core.ToJSON DeliveryControlFrequencyCap
         where
              ...
              (\ o ->
                 Dimension Core.<$>
                   (o Core..:? "dimensionType") Core.<*>
                     (o Core..:? "dimensionValues" Core..!= Core.mempty))
...
newDimensionDimensionValue =
  DimensionDimensionValue
    {id = Core.Nothing, name = Core.Nothing, percentage = Core.Nothing}
...
newEditAllOrderDealsResponse =
  EditAllOrderDealsResponse
    {deals = Core.Nothing, orderRevisionNumber = Core.Nothing}

instance Core.FromJSON EditAllOrderDealsResponse
         where
        parseJSON
...
instance Core.FromJSON GetOffersResponse where
        parseJSON
          = Core.withObject "GetOffersResponse"
              (\ o ->
                 GetOffersResponse Core.<$>
                   (o Core..:? "products" Core..!= Core.mempty))
...
instance Core.FromJSON GetOrderDealsResponse where
        parseJSON
          = Core.withObject "GetOrderDealsResponse"
              (\ o ->
                 GetOrderDealsResponse Core.<$>
                   (o Core..:? "deals" Core..!= Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 GetPublisherProfilesByAccountIdResponse Core.<$>
                   (o Core..:? "profiles" Core..!= Core.mempty))
              ...
              (\ o ->
                 MarketplaceDeal Core.<$>
                   (o Core..:? "buyerPrivateData") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "sellerContacts" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "sharedTargetings" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("buyerPrivateData" Core..=) Core.<$>
                  ...
                  ("inventoryDescription" Core..=) Core.<$>
              ...
              (\ o ->
                 MarketplaceLabel Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "createTimeMs")
                     Core.<*>
                     (o Core..:? "deprecatedMarketplaceDealParty")
                     Core.<*> (o Core..:? "label"))
...
instance Core.ToJSON MarketplaceLabel where
        toJSON MarketplaceLabel{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("createTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    createTimeMs,
          ...
          = Core.object
              (Core.catMaybes
                 [("creatorRole" Core..=) Core.<$> creatorRole,
                  ...
                  ("proposalRevisionNumber" Core..=) Core.. Core.AsText
                    Core.<$> proposalRevisionNumber,
                  ("timestampMs" Core..=) Core.. Core.AsText Core.<$>
                    timestampMs])
          ...
          = Core.withObject "PerformanceReport"
              (\ o ->
                 PerformanceReport Core.<$>
                   (o Core..:? "bidRate") Core.<*>
                     (o Core..:? "bidRequestRate")
                     Core.<*>
                     (o Core..:? "calloutStatusRate" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "cookieMatcherStatusRate" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "creativeStatusRate" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "filteredBidRate")
                     Core.<*>
                     (o Core..:? "hostedMatchStatusRate" Core..!=
                        Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("bidRate" Core..=) Core.<$> bidRate,
                  ...
                  ("calloutStatusRate" Core..=) Core.<$>
                    calloutStatusRate,
                  ("cookieMatcherStatusRate" Core..=) Core.<$>
                    cookieMatcherStatusRate,
                  ("creativeStatusRate" Core..=) Core.<$>
                    creativeStatusRate,
                  ("filteredBidRate" Core..=) Core.<$> filteredBidRate,
                  ("hostedMatchStatusRate" Core..=) Core.<$>
                    hostedMatchStatusRate,
                  ("inventoryMatchRate" Core..=) Core.<$>
                    inventoryMatchRate,
                  Core.Just ("kind" Core..= kind),
                  ("latency50thPercentile" Core..=) Core.<$>
                    latency50thPercentile,
                  ("latency85thPercentile" Core..=) Core.<$>
                    latency85thPercentile,
                  ("latency95thPercentile" Core..=) Core.<$>
                    latency95thPercentile,
                  ("noQuotaInRegion" Core..=) Core.<$> noQuotaInRegion,
                  ("outOfQuota" Core..=) Core.<$> outOfQuota,
                  ("pixelMatchRequests" Core..=) Core.<$>
                    pixelMatchRequests,
                  ("pixelMatchResponses" Core..=) Core.<$>
                    pixelMatchResponses,
                  ("quotaConfiguredLimit" Core..=) Core.<$>
                    quotaConfiguredLimit,
                  ("quotaThrottledLimit" Core..=) Core.<$>
                    quotaThrottledLimit,
                  ("region" Core..=) Core.<$> region,
                  ("successfulRequestRate" Core..=) Core.<$>
          ...
          = Core.withObject "PretargetingConfig"
              (\ o ->
                 PretargetingConfig Core.<$>
                   (o Core..:? "billingId") Core.<*>
                     (o Core..:? "configId")
                     Core.<*> (o Core..:? "configName")
                     Core.<*>
                     (o Core..:? "creativeType" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "dimensions" Core..!= Core.mempty)
                     Core.<*>
                     ...
                     (o Core..:? "excludedGeoCriteriaIds" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "excludedPlacements" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "excludedUserLists" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "excludedVerticals" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "geoCriteriaIds" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "mobileCarriers" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "mobileDevices" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "mobileOperatingSystemVersions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "placements" Core..!= Core.mempty)
                     Core.<*>
                     ...
                     (o Core..:? "supportedCreativeAttributes" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "userIdentifierDataRequired" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "userLists" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "vendorTypes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "verticals" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "videoPlayerSizes" Core..!= Core.mempty))
        ...
        toJSON PretargetingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("billingId" Core..=) Core.. Core.AsText Core.<$>
                    billingId,
                  ("configId" Core..=) Core.. Core.AsText Core.<$>
                    configId,
                  ("configName" Core..=) Core.<$> configName,
                  ("creativeType" Core..=) Core.<$> creativeType,
                  ("dimensions" Core..=) Core.<$> dimensions,
                  ("excludedContentLabels" Core..=) Core.<$>
                    excludedContentLabels,
                  ("excludedGeoCriteriaIds" Core..=) Core.<$>
                    excludedGeoCriteriaIds,
                  ("excludedPlacements" Core..=) Core.<$>
                    excludedPlacements,
                  ("excludedUserLists" Core..=) Core.<$>
                    excludedUserLists,
                  ("excludedVerticals" Core..=) Core.<$>
                    excludedVerticals,
                  ("geoCriteriaIds" Core..=) Core.<$> geoCriteriaIds,
                  ("isActive" Core..=) Core.<$> isActive,
                  Core.Just ("kind" Core..= kind),
                  ("languages" Core..=) Core.<$> languages,
                  ("maximumQps" Core..=) Core.. Core.AsText Core.<$>
                    maximumQps,
...
newPretargetingConfig_ExcludedPlacementsItem =
  PretargetingConfig_ExcludedPlacementsItem
    {token = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("aspectRatio" Core..=) Core.<$> aspectRatio,
                  ("minHeight" Core..=) Core.. Core.AsText Core.<$>
                    minHeight,
                  ("minWidth" Core..=) Core.. Core.AsText Core.<$>
                    minWidth])
...
newPretargetingConfigList =
  PretargetingConfigList
    {items = Core.Nothing, kind = "adexchangebuyer#pretargetingConfigList"}
              ...
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "billedBuyer") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "creatorContacts" Core..!= Core.mempty)
              ...
              (\ o ->
                 Proposal Core.<$>
                   (o Core..:? "billedBuyer") Core.<*>
                     (o Core..:? "buyer")
                     Core.<*>
                     (o Core..:? "buyerContacts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "buyerPrivateData")
                     Core.<*>
                     (o Core..:? "dbmAdvertiserIds" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("billedBuyer" Core..=) Core.<$> billedBuyer,
                  ...
                  ("buyerPrivateData" Core..=) Core.<$>
                    buyerPrivateData,
                  ("dbmAdvertiserIds" Core..=) Core.<$>
                    dbmAdvertiserIds,
                  ("hasBuyerSignedOff" Core..=) Core.<$>
                    hasBuyerSignedOff,
                  ("hasSellerSignedOff" Core..=) Core.<$>
                    hasSellerSignedOff,
                  ("inventorySource" Core..=) Core.<$> inventorySource,
              ...
              (\ o ->
                 PublisherProfileApiProto Core.<$>
                   (o Core..:? "audience") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "publisherAppIds" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "publisherApps" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "publisherDomains" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "publisherProfileId")
                     Core.<*> (o Core..:? "publisherProvidedForecast")
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "topHeadlines" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("audience" Core..=) Core.<$> audience,
                  ...
                  ("programmaticContact" Core..=) Core.<$>
                    programmaticContact,
                  ("publisherAppIds" Core..=) Core.<$> publisherAppIds,
                  ("publisherApps" Core..=) Core.<$> publisherApps,
                  ("publisherDomains" Core..=) Core.<$>
                    publisherDomains,
                  ("publisherProfileId" Core..=) Core.<$>
                    publisherProfileId,
                  ("publisherProvidedForecast" Core..=) Core.<$>
                    publisherProvidedForecast,
                  ("rateCardInfoLink" Core..=) Core.<$>
                    rateCardInfoLink,
...
instance Core.FromJSON PublisherProvidedForecast
         where
        parseJSON
          ...
          = Core.withObject "SharedTargeting"
              (\ o ->
                 SharedTargeting Core.<$>
                   (o Core..:? "exclusions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "inclusions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "key"))
          ...
          = Core.object
              (Core.catMaybes
                 [("creativeSizeValue" Core..=) Core.<$>
                  ...
                  ("demogAgeCriteriaValue" Core..=) Core.<$>
...
instance Core.FromJSON TargetingValueCreativeSize
         where
        parseJSON
          = Core.withObject "TargetingValueCreativeSize"
              (\ o ->
                 TargetingValueCreativeSize Core.<$>
                   (o Core..:? "allowedFormats" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "companionSizes" Core..!= Core.mempty)
...
newTargetingValueDayPartTargeting =
  TargetingValueDayPartTargeting
    {dayParts = Core.Nothing, timeZoneType = Core.Nothing}

instance Core.FromJSON TargetingValueDayPartTargeting
         where
        parseJSON
          = Core.withObject "TargetingValueDayPartTargeting"
              (\ o ->
                 TargetingValueDayPartTargeting Core.<$>
                   (o Core..:? "dayParts" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "timeZoneType"))

instance Core.ToJSON TargetingValueDayPartTargeting
         where
...
instance Core.FromJSON TargetingValueDemogAgeCriteria
         where
        parseJSON
          = Core.withObject "TargetingValueDemogAgeCriteria"
              (\ o ->
                 TargetingValueDemogAgeCriteria Core.<$>
                   (o Core..:? "demogAgeCriteriaIds" Core..!=
                      Core.mempty))

instance Core.ToJSON TargetingValueDemogAgeCriteria
         where
        toJSON TargetingValueDemogAgeCriteria{..}
          = Core.object
              (Core.catMaybes
                 [("demogAgeCriteriaIds" Core..=) Core.<$>
                    demogAgeCriteriaIds])
          ...
          = Core.withObject "TargetingValueDemogGenderCriteria"
              (\ o ->
                 TargetingValueDemogGenderCriteria Core.<$>
                   (o Core..:? "demogGenderCriteriaIds" Core..!=
                      Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 TargetingValueRequestPlatformTargeting Core.<$>
                   (o Core..:? "requestPlatforms" Core..!= Core.mempty))
