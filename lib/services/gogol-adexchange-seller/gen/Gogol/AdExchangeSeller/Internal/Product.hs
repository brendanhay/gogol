...
newAccount =
  Account
    {id = Core.Nothing, kind = "adexchangeseller#account", name = Core.Nothing}
...
instance Core.FromJSON AdClient where
        parseJSON
          = Core.withObject "AdClient"
              (\ o ->
                 AdClient Core.<$>
                   (o Core..:? "arcOptIn") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
newAlerts 
    ::  Alerts
newAlerts = Alerts {items = Core.Nothing, kind = "adexchangeseller#alerts"}
...
instance Core.FromJSON CustomChannel_TargetingInfo
         where
        parseJSON
          = Core.withObject "CustomChannel_TargetingInfo"
              (\ o ->
                 CustomChannel_TargetingInfo Core.<$>
                   (o Core..:? "adsAppearOn") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "siteLanguage"))

instance Core.ToJSON CustomChannel_TargetingInfo
         where
...
newMetadata 
    ::  Metadata
newMetadata =
  Metadata {items = Core.Nothing, kind = "adexchangeseller#metadata"}
...
newPreferredDeals =
  PreferredDeals
    {items = Core.Nothing, kind = "adexchangeseller#preferredDeals"}
...
instance Core.FromJSON Report where
        parseJSON
          = Core.withObject "Report"
              (\ o ->
                 Report Core.<$>
                   (o Core..:? "averages" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "headers" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "adexchangeseller#report")
...
newReport_HeadersItem =
  Report_HeadersItem
    {currency = Core.Nothing, name = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.withObject "Report_HeadersItem"
              (\ o ->
                 Report_HeadersItem Core.<$>
                   (o Core..:? "currency") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))
              ...
              (\ o ->
                 ReportingMetadataEntry Core.<$>
                   (o Core..:? "compatibleDimensions" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "compatibleMetrics" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "adexchangeseller#reportingMetadataEntry")
                     Core.<*>
                     (o Core..:? "requiredDimensions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "requiredMetrics" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "supportedProducts" Core..!=
                        Core.mempty))
...
instance Core.ToJSON ReportingMetadataEntry where
        toJSON ReportingMetadataEntry{..}
          = Core.object
              (Core.catMaybes
                 [("compatibleDimensions" Core..=) Core.<$>
                    compatibleDimensions,
                  ("compatibleMetrics" Core..=) Core.<$>
                    compatibleMetrics,
                  ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("requiredDimensions" Core..=) Core.<$>
                    requiredDimensions,
                  ("requiredMetrics" Core..=) Core.<$> requiredMetrics,
                  ("supportedProducts" Core..=) Core.<$>
                    supportedProducts])
