...
instance Core.FromJSON AppContext where
        parseJSON
          = Core.withObject "AppContext"
              (\ o ->
                 AppContext Core.<$>
                   (o Core..:? "appTypes" Core..!= Core.mempty))
...
instance Core.FromJSON AuctionContext where
        parseJSON
          = Core.withObject "AuctionContext"
              (\ o ->
                 AuctionContext Core.<$>
                   (o Core..:? "auctionTypes" Core..!= Core.mempty))
              ...
              (\ o ->
                 Creative Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "attributes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "clickThroughUrls" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "corrections" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "creativeId")
                     Core.<*> (o Core..:? "dealsStatus")
                     Core.<*>
                     (o Core..:? "declaredClickThroughUrls" Core..!=
                        Core.mempty)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "detectedLanguages" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "detectedProductCategories" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "detectedSensitiveCategories" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "html")
                     Core.<*>
                     (o Core..:? "impressionTrackingUrls" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "native")
                     ...
                     (o Core..:? "servingRestrictions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "vendorIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "version")
                     Core.<*> (o Core..:? "video"))
              ...
              (\ o ->
                 CreativeRestrictions Core.<$>
                   (o Core..:? "creativeFormat") Core.<*>
                     (o Core..:? "creativeSpecifications" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 Deal Core.<$>
                   (o Core..:? "availableEndTime") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "targetingCriterion" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 FilterSet Core.<$>
                   (o Core..:? "absoluteDateRange") Core.<*>
                     (o Core..:? "breakdownDimensions" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "creativeId")
                     Core.<*> (o Core..:? "dealId")
                     ...
                     Core.<*>
                     (o Core..:? "publisherIdentifiers" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "realtimeTimeRange")
                     Core.<*> (o Core..:? "relativeDateRange")
                     Core.<*>
                     (o Core..:? "sellerNetworkIds" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 FirstPartyMobileApplicationTargeting Core.<$>
                   (o Core..:? "excludedAppIds" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "targetedAppIds" Core..!= Core.mempty))
              ...
              (\ o ->
                 InventorySizeTargeting Core.<$>
                   (o Core..:? "excludedInventorySizes" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "targetedInventorySizes" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "ListBidMetricsResponse"
              (\ o ->
                 ListBidMetricsResponse Core.<$>
                   (o Core..:? "bidMetricsRows" Core..!= Core.mempty)
          ...
          = Core.withObject "ListBidResponseErrorsResponse"
              (\ o ->
                 ListBidResponseErrorsResponse Core.<$>
                   (o Core..:? "calloutStatusRows" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListClientUserInvitationsResponse"
              (\ o ->
                 ListClientUserInvitationsResponse Core.<$>
                   (o Core..:? "invitations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListClientsResponse"
              (\ o ->
                 ListClientsResponse Core.<$>
                   (o Core..:? "clients" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 ListCreativeStatusBreakdownByDetailResponse Core.<$>
                   (o Core..:? "detailType") Core.<*>
                     (o Core..:? "filteredBidDetailRows" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListDealAssociationsResponse"
              (\ o ->
                 ListDealAssociationsResponse Core.<$>
                   (o Core..:? "associations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListFilterSetsResponse"
              (\ o ->
                 ListFilterSetsResponse Core.<$>
                   (o Core..:? "filterSets" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
              ...
              (\ o ->
                 NonGuaranteedAuctionTerms Core.<$>
                   (o Core..:? "autoOptimizePrivateAuction") Core.<*>
                     (o Core..:? "reservePricesPerBuyer" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "PauseProposalDealsRequest"
              (\ o ->
                 PauseProposalDealsRequest Core.<$>
                   (o Core..:? "externalDealIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "reason"))
...
instance Core.FromJSON PricePerBuyer where
        parseJSON
          = Core.withObject "PricePerBuyer"
              (\ o ->
                 PricePerBuyer Core.<$>
                   (o Core..:? "advertiserIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "buyer")
                     Core.<*> (o Core..:? "price"))
          ...
          = Core.withObject "SecurityContext"
              (\ o ->
                 SecurityContext Core.<$>
                   (o Core..:? "securities" Core..!= Core.mempty))
...
instance Core.FromJSON UrlTargeting where
        parseJSON
          = Core.withObject "UrlTargeting"
              (\ o ->
                 UrlTargeting Core.<$>
                   (o Core..:? "excludedUrls" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "targetedUrls" Core..!= Core.mempty))
              ...
              (\ o ->
                 VideoTargeting Core.<$>
                   (o Core..:? "excludedPositionTypes" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "targetedPositionTypes" Core..!=
                        Core.mempty))
