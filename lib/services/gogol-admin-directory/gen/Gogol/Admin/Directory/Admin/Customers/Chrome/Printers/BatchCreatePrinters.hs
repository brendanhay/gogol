...
type AdminCustomersChromePrintersBatchCreatePrintersResource =
  "admin"
    ...
    Core.:> Core.ReqBody '[Core.JSON] BatchCreatePrintersRequest
    Core.:> Core.Post '[Core.JSON] BatchCreatePrintersResponse
...
instance
  ...
  where
  type
    Rs AdminCustomersChromePrintersBatchCreatePrinters =
      BatchCreatePrintersResponse
  type
    Scopes AdminCustomersChromePrintersBatchCreatePrinters =
