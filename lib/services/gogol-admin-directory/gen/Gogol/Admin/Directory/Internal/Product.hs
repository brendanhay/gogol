...
instance Core.FromJSON Aliases where
        parseJSON
          = Core.withObject "Aliases"
              (\ o ->
                 Aliases Core.<$>
                   (o Core..:? "aliases" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
              ...
              (\ o ->
                 BatchCreatePrintersResponse Core.<$>
                   (o Core..:? "failures" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "printers" Core..!= Core.mempty))
          ...
          = Core.withObject "BatchDeletePrintersRequest"
              (\ o ->
                 BatchDeletePrintersRequest Core.<$>
                   (o Core..:? "printerIds" Core..!= Core.mempty))
          ...
          = Core.withObject "BatchDeletePrintersResponse"
              (\ o ->
                 BatchDeletePrintersResponse Core.<$>
                   (o Core..:? "failedPrinters" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "printerIds" Core..!= Core.mempty))
              ...
              (\ o ->
                 Building Core.<$>
                   (o Core..:? "address") Core.<*>
                     ...
                     Core.<*> (o Core..:? "etags")
                     Core.<*>
                     (o Core..:? "floorNames" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
          ...
          = Core.withObject "BuildingAddress"
              (\ o ->
                 BuildingAddress Core.<$>
                   (o Core..:? "addressLines" Core..!= Core.mempty)
...
instance Core.FromJSON Buildings where
        parseJSON
          = Core.withObject "Buildings"
              (\ o ->
                 Buildings Core.<$>
                   (o Core..:? "buildings" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON ChromeOsDevice where
        parseJSON
          = Core.withObject "ChromeOsDevice"
              (\ o ->
                 ChromeOsDevice Core.<$>
                   (o Core..:? "activeTimeRanges" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "cpuStatusReports" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "deviceFiles" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "deviceId")
                     Core.<*>
                     (o Core..:? "diskVolumeReports" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "lastKnownNetwork" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "recentUsers" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "screenshotFiles" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "serialNumber")
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "supportEndDate")
                     Core.<*>
                     (o Core..:? "systemRamFreeReports" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 ChromeOsDevice_CpuInfoItem Core.<$>
                   (o Core..:? "architecture") Core.<*>
                     (o Core..:? "logicalCpus" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 ChromeOsDevice_CpuInfoItem_LogicalCpusItem Core.<$>
                   (o Core..:? "cStates" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 ChromeOsDevice_CpuStatusReportsItem Core.<$>
                   (o Core..:? "cpuTemperatureInfo" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "cpuUtilizationPercentageInfo" Core..!=
                        Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 ChromeOsDevice_DiskVolumeReportsItem Core.<$>
                   (o Core..:? "volumeInfo" Core..!= Core.mempty))
          ...
          = Core.withObject "ChromeOsDevices"
              (\ o ->
                 ChromeOsDevices Core.<$>
                   (o Core..:? "chromeosdevices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
          ...
          = Core.withObject "ChromeOsMoveDevicesToOu"
              (\ o ->
                 ChromeOsMoveDevicesToOu Core.<$>
                   (o Core..:? "deviceIds" Core..!= Core.mempty))
...
instance Core.FromJSON DomainAliases where
        parseJSON
          = Core.withObject "DomainAliases"
              (\ o ->
                 DomainAliases Core.<$>
                   (o Core..:? "domainAliases" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
        ...
        parseJSON
          = Core.withObject "Features"
              (\ o ->
                 Features Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "features" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
              ...
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "adminCreated") Core.<*>
                     (o Core..:? "aliases" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "description")
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "nonEditableAliases" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 ListPrinterModelsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "printerModels" Core..!= Core.mempty))
              ...
              (\ o ->
                 MobileDevice Core.<$>
                   (o Core..:? "adbStatus") Core.<*>
                     ...
                     Core.<*> (o Core..:? "os")
                     Core.<*>
                     (o Core..:? "otherAccountsInfo" Core..!= Core.mempty)
...
instance Core.FromJSON Printer where
        parseJSON
          = Core.withObject "Printer"
              (\ o ->
                 Printer Core.<$>
                   (o Core..:? "auxiliaryMessages" Core..!= Core.mempty)
...
instance Core.FromJSON Privilege where
        parseJSON
          = Core.withObject "Privilege"
              (\ o ->
                 Privilege Core.<$>
                   (o Core..:? "childPrivileges" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "etag")
              ...
              (\ o ->
                 Role Core.<$>
                   (o Core..:? "etag") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "rolePrivileges" Core..!= Core.mempty))
