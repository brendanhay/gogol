...
newBatchChangeChromeOsDeviceStatusRequest =
  BatchChangeChromeOsDeviceStatusRequest
    { changeChromeOsDeviceStatusAction = Core.Nothing
          ...
          = Core.withObject
              ...
              (\ o ->
                 BatchChangeChromeOsDeviceStatusRequest Core.<$>
                   (o Core..:? "changeChromeOsDeviceStatusAction")
...
newBatchChangeChromeOsDeviceStatusResponse =
  BatchChangeChromeOsDeviceStatusResponse
    {changeChromeOsDeviceStatusResults = Core.Nothing}
...
instance Core.FromJSON ByteUsage where
        parseJSON
          = Core.withObject "ByteUsage"
              (\ o ->
                 ByteUsage Core.<$>
                   (o Core..:? "capacityBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "usedBytes" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON ByteUsage where
        toJSON ByteUsage{..}
          = Core.object
              (Core.catMaybes
                 [("capacityBytes" Core..=) Core.. Core.AsText
                    Core.<$> capacityBytes,
                  ("usedBytes" Core..=) Core.. Core.AsText Core.<$>
                    usedBytes])
...
newChangeChromeOsDeviceStatusResult =
  ChangeChromeOsDeviceStatusResult
    {deviceId = Core.Nothing, error = Core.Nothing, response = Core.Nothing}
          ...
          = Core.withObject "ChangeChromeOsDeviceStatusResult"
              (\ o ->
                 ChangeChromeOsDeviceStatusResult Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "response"))

instance Core.ToJSON ChangeChromeOsDeviceStatusResult
         where
...
newChangeChromeOsDeviceStatusSucceeded 
    ::  ChangeChromeOsDeviceStatusSucceeded
newChangeChromeOsDeviceStatusSucceeded = ChangeChromeOsDeviceStatusSucceeded
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ChangeChromeOsDeviceStatusSucceeded"
              (\ o ->
                 Core.pure ChangeChromeOsDeviceStatusSucceeded)
          ...
          = Core.object
              (Core.catMaybes
                 [("activeTimeRanges" Core..=) Core.<$>
                  ...
                  ("extendedSupportEnabled" Core..=) Core.<$>
                    extendedSupportEnabled,
                  ("extendedSupportStart" Core..=) Core.<$>
              ...
              (\ o ->
                 UserEmail Core.<$>
                   (o Core..:? "address") Core.<*>
                     ...
                     Core.<*> (o Core..:? "primary")
                     Core.<*>
                     (o Core..:? "public_key_encryption_certificates")
                     Core.<*> (o Core..:? "type"))
...
newUserEmail_Public_key_encryption_certificates =
  UserEmail_Public_key_encryption_certificates
    {certificate = Core.Nothing, isDefault = Core.Nothing, state = Core.Nothing}
