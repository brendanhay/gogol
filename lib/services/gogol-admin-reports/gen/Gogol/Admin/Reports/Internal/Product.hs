              ...
              (\ o ->
                 Activity_EventsItem_ParametersItem Core.<$>
                   (o Core..:? "boolValue") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "multiIntValue" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "multiMessageValue" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "multiValue" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "value"))
              ...
              (\ o ->
                 NestedParameter Core.<$>
                   (o Core..:? "boolValue") Core.<*>
                     (o Core..:? "intValue")
                     Core.<*>
                     (o Core..:? "multiBoolValue" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "multiIntValue" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "multiValue" Core..!= Core.mempty)
              ...
              (\ o ->
                 UsageReports Core.<$>
                   (o Core..:? "etag") Core.<*>
                     ...
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "usageReports" Core..!= Core.mempty)
                     Core.<*>
