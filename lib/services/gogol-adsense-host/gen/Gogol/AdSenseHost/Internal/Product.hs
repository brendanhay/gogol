...
newAccounts =
  Accounts
    {etag = Core.Nothing, items = Core.Nothing, kind = "adsensehost#accounts"}
...
instance Core.FromJSON AdStyle where
        parseJSON
          = Core.withObject "AdStyle"
              (\ o ->
                 AdStyle Core.<$>
                   (o Core..:? "colors") Core.<*> (o Core..:? "corners")
                     Core.<*> (o Core..:? "font")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#adStyle"))
        ...
        parseJSON
          = Core.withObject "AdUnit"
              (\ o ->
                 AdUnit Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "contentAdsSettings")
                     Core.<*> (o Core..:? "customStyle")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#adUnit")
...
newAdUnit_ContentAdsSettings =
  AdUnit_ContentAdsSettings
    {backupOption = Core.Nothing, size = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON AdUnit_ContentAdsSettings
         where
        parseJSON
          = Core.withObject "AdUnit_ContentAdsSettings"
              (\ o ->
                 AdUnit_ContentAdsSettings Core.<$>
                   (o Core..:? "backupOption") Core.<*>
                     (o Core..:? "size")
                     Core.<*> (o Core..:? "type"))
...
newAdUnit_ContentAdsSettings_BackupOption =
  AdUnit_ContentAdsSettings_BackupOption
    {color = Core.Nothing, type' = Core.Nothing, url = Core.Nothing}
...
instance Core.ToJSON AdUnit_MobileContentAdsSettings
         where
        toJSON AdUnit_MobileContentAdsSettings{..}
          = Core.object
              (Core.catMaybes
                 [("markupLanguage" Core..=) Core.<$> markupLanguage,
                  ("scriptingLanguage" Core..=) Core.<$>
                    scriptingLanguage,
                  ("size" Core..=) Core.<$> size,
                  ("type" Core..=) Core.<$> type'])
              ...
              (\ o ->
                 AssociationSession Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "id")
                     ...
                     Core.<*>
                     (o Core..:? "productCodes" Core..!= Core.mempty)
