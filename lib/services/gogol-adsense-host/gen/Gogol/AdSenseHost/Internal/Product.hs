    ...
    Core.withObject
      ...
      ( \o ->
          AssociationSession
            ...
            Core.<*> (o Core..:? "id")
            Core.<*> (o Core..:? "kind" Core..!= "adsensehost#associationSession")
    ...
    Core.withObject
      ...
      ( \o ->
          CustomChannel
            Core.<$> (o Core..:? "code")
            Core.<*> (o Core..:? "id")
            Core.<*> (o Core..:? "kind" Core..!= "adsensehost#customChannel")
            Core.<*> (o Core..:? "name")
      )
    ...
    Core.withObject
      ...
      ( \o ->
          CustomChannels
            Core.<$> (o Core..:? "etag")
            Core.<*> (o Core..:? "items")
            Core.<*> (o Core..:? "kind" Core..!= "adsensehost#customChannels")
            Core.<*> (o Core..:? "nextPageToken")
      )
    ...
    Core.withObject
      ...
      ( \o ->
          UrlChannels
            Core.<$> (o Core..:? "etag")
            Core.<*> (o Core..:? "items")
            Core.<*> (o Core..:? "kind" Core..!= "adsensehost#urlChannels")
            Core.<*> (o Core..:? "nextPageToken")
      )
