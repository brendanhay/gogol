...
type AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnitsResource =
  "v2"
    Core.:> Core.CaptureMode "parent" "listLinkedAdUnits" Core.Text
...
instance
  ...
  where
  type
    Rs AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits =
      ListLinkedAdUnitsResponse
  type
    Scopes AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits =
