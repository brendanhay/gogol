...
type AdSenseAccountsReportsGenerateCsvResource =
  "v2"
    ...
    Core.:> Core.QueryParam "dateRange" AccountsReportsGenerateCsvDateRange
    Core.:> Core.QueryParams "dimensions" AccountsReportsGenerateCsvDimensions
    ...
    Core.:> Core.QueryParams "metrics" AccountsReportsGenerateCsvMetrics
