                             ...
                             Core.QueryParams "filters" Core.Text Core.:>
                               Core.QueryParam "languageCode" Core.Text Core.:>
                                 Core.QueryParam "limit" Core.Int32 Core.:>
                                   Core.QueryParams "metrics"
                                     AccountsReportsGenerateCsvMetrics
                                     Core.:>
                                     Core.QueryParams "orderBy" Core.Text
                                       Core.:>
                                       Core.QueryParam "reportingTimeZone"
                                         AccountsReportsGenerateCsvReportingTimeZone
                                         Core.:>
                                         Core.QueryParam "startDate.day"
                                           Core.Int32
                                           Core.:>
                                           Core.QueryParam "startDate.month"
                                             Core.Int32
                                             Core.:>
                                             Core.QueryParam "startDate.year"
                                               Core.Int32
                                               Core.:>
...
instance Core.GoogleRequest
        ...
        requestClient AdSenseAccountsReportsGenerateCsv{..}
          = go account xgafv accessToken callback currencyCode
              dateRange
