                         ...
                         Core.QueryParam "endDate.year" Core.Int32 Core.:>
                           Core.QueryParam "languageCode" Core.Text Core.:>
                             Core.QueryParam "reportingTimeZone"
                               ...
                               Core.:>
                               Core.QueryParam "startDate.day" Core.Int32
                                 Core.:>
                                 Core.QueryParam "startDate.month" Core.Int32
                                   Core.:>
                                   Core.QueryParam "startDate.year" Core.Int32
                                     Core.:>
...
instance Core.GoogleRequest
           AdSenseAccountsReportsSavedGenerateCsv
         where
        type Rs AdSenseAccountsReportsSavedGenerateCsv =
             HttpBody
        type Scopes AdSenseAccountsReportsSavedGenerateCsv =
             '[Adsense'FullControl, Adsense'Readonly]
        requestClient
          AdSenseAccountsReportsSavedGenerateCsv{..}
          = go name xgafv accessToken callback currencyCode
              dateRange
              endDateDay
              endDateMonth
              endDateYear
