              ...
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "pendingTasks" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "premium")
          ...
          = Core.withObject "ListAdClientsResponse"
              (\ o ->
                 ListAdClientsResponse Core.<$>
                   (o Core..:? "adClients" Core..!= Core.mempty)
          ...
          = Core.withObject "ListAdUnitsResponse"
              (\ o ->
                 ListAdUnitsResponse Core.<$>
                   (o Core..:? "adUnits" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListAlertsResponse"
              (\ o ->
                 ListAlertsResponse Core.<$>
                   (o Core..:? "alerts" Core..!= Core.mempty))
          ...
          = Core.withObject "ListCustomChannelsResponse"
              (\ o ->
                 ListCustomChannelsResponse Core.<$>
                   (o Core..:? "customChannels" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListPaymentsResponse"
              (\ o ->
                 ListPaymentsResponse Core.<$>
                   (o Core..:? "payments" Core..!= Core.mempty))
              ...
              (\ o ->
                 ListSavedReportsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "savedReports" Core..!= Core.mempty))
          ...
          = Core.withObject "ListUrlChannelsResponse"
              (\ o ->
                 ListUrlChannelsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "urlChannels" Core..!= Core.mempty))
