...
newListPolicyIssuesResponse =
  ListPolicyIssuesResponse
    {nextPageToken = Core.Nothing, policyIssues = Core.Nothing}
...
newPolicyIssue =
  PolicyIssue
    { action = Core.Nothing
    , adClients = Core.Nothing
    , adRequestCount = Core.Nothing
    , entityType = Core.Nothing
    , firstDetectedDate = Core.Nothing
    , lastDetectedDate = Core.Nothing
    , name = Core.Nothing
    , policyTopics = Core.Nothing
    , site = Core.Nothing
    , siteSection = Core.Nothing
    , uri = Core.Nothing
    , warningEscalationDate = Core.Nothing
    }
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("adClients" Core..=) Core.<$> adClients,
                  ("adRequestCount" Core..=) Core.. Core.AsText
                    Core.<$> adRequestCount,
                  ("entityType" Core..=) Core.<$> entityType,
                  ("firstDetectedDate" Core..=) Core.<$>
                    firstDetectedDate,
                  ("lastDetectedDate" Core..=) Core.<$>
                    lastDetectedDate,
                  ("name" Core..=) Core.<$> name,
                  ...
                  ("uri" Core..=) Core.<$> uri,
                  ("warningEscalationDate" Core..=) Core.<$>
...
newPolicyTopic 
    ::  PolicyTopic
newPolicyTopic = PolicyTopic {mustFix = Core.Nothing, topic = Core.Nothing}
...
instance Core.FromJSON PolicyTopic where
        parseJSON
          = Core.withObject "PolicyTopic"
              (\ o ->
                 PolicyTopic Core.<$>
                   (o Core..:? "mustFix") Core.<*> (o Core..:? "topic"))
