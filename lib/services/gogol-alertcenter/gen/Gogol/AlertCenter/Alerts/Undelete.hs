...
type AlertCenterAlertsUndeleteResource =
     "v1beta1" Core.:>
       "alerts" Core.:>
         Core.CaptureMode "alertId" "undelete" Core.Text
           Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UndeleteAlertRequest
...
instance Core.GoogleRequest AlertCenterAlertsUndelete
         where
        type Rs AlertCenterAlertsUndelete = Alert
        type Scopes AlertCenterAlertsUndelete =
             '[Apps'Alerts]
        requestClient AlertCenterAlertsUndelete{..}
          = go alertId xgafv accessToken callback uploadType
              uploadProtocol
