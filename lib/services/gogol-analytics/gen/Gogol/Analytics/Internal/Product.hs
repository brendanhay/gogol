...
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "childLink") Core.<*>
                     (o Core..:? "created")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#account")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON Account_Permissions where
        parseJSON
          = Core.withObject "Account_Permissions"
              (\ o ->
                 Account_Permissions Core.<$>
                   (o Core..:? "effective" Core..!= Core.mempty))
              ...
              (\ o ->
                 AccountSummary Core.<$>
                   (o Core..:? "id") Core.<*>
                     ...
                     Core.<*> (o Core..:? "starred")
                     Core.<*>
                     (o Core..:? "webProperties" Core..!= Core.mempty))
...
instance Core.FromJSON AccountTicket where
        parseJSON
          = Core.withObject "AccountTicket"
              (\ o ->
                 AccountTicket Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "analytics#accountTicket")
                     Core.<*> (o Core..:? "profile")
          ...
          = Core.withObject
              ...
              (\ o ->
                 AnalyticsDataimportDeleteUploadDataRequest Core.<$>
                   (o Core..:? "customDataImportUids" Core..!=
                      Core.mempty))
...
instance Core.ToJSON
        ...
        toJSON AnalyticsDataimportDeleteUploadDataRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customDataImportUids" Core..=) Core.<$>
...
newColumn =
  Column
    {attributes = Core.Nothing, id = Core.Nothing, kind = "analytics#column"}
...
instance Core.FromJSON Column where
        parseJSON
          = Core.withObject "Column"
              (\ o ->
                 Column Core.<$>
                   (o Core..:? "attributes") Core.<*> (o Core..:? "id")
                     Core.<*>
...
instance Core.FromJSON Columns where
        parseJSON
          = Core.withObject "Columns"
              (\ o ->
                 Columns Core.<$>
                   (o Core..:? "attributeNames" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "items" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#columns")
                     Core.<*> (o Core..:? "totalResults"))
              ...
              (\ o ->
                 CustomDataSource Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "profilesLinked" Core..!= Core.mempty)
...
instance Core.FromJSON CustomDataSource_ChildLink
         where
        parseJSON
...
newCustomDataSource_ParentLink =
  CustomDataSource_ParentLink
    {href = Core.Nothing, type' = "analytics#webproperty"}

instance Core.FromJSON CustomDataSource_ParentLink
         where
        parseJSON
...
instance Core.ToJSON CustomDataSource_ParentLink
         where
...
instance Core.FromJSON CustomDimension_ParentLink
         where
        parseJSON
              ...
              (\ o ->
                 CustomMetric Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "index")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#customMetric")
          ...
          = Core.withObject "EntityAdWordsLink"
              (\ o ->
                 EntityAdWordsLink Core.<$>
                   (o Core..:? "adWordsAccounts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "entity")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "profileIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "selfLink"))
...
instance Core.FromJSON EntityAdWordsLink_Entity where
        parseJSON
          = Core.withObject "EntityAdWordsLink_Entity"
              (\ o ->
                 EntityAdWordsLink_Entity Core.<$>
                   (o Core..:? "webPropertyRef"))
...
instance Core.FromJSON EntityUserLink where
        parseJSON
          = Core.withObject "EntityUserLink"
              (\ o ->
                 EntityUserLink Core.<$>
                   (o Core..:? "entity") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "analytics#entityUserLink")
                     Core.<*> (o Core..:? "permissions")
                     Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "userRef"))
...
instance Core.FromJSON EntityUserLink_Permissions
         where
        parseJSON
              ...
              (\ o ->
                 Experiment Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#experiment")
                     ...
                     Core.<*>
                     (o Core..:? "rewriteVariationUrlsAsOriginal")
                     Core.<*> (o Core..:? "selfLink")
                     ...
                     Core.<*> (o Core..:? "updated")
                     Core.<*>
                     (o Core..:? "variations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "webPropertyId")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("internalWebPropertyId" Core..=) Core.<$>
                  ...
                  ("webPropertyId" Core..=) Core.<$> webPropertyId,
                  ("winnerConfidenceLevel" Core..=) Core.<$>
...
instance Core.FromJSON Experiment_VariationsItem
         where
        parseJSON
          = Core.withObject "Experiment_VariationsItem"
              (\ o ->
                 Experiment_VariationsItem Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "url")
                     Core.<*> (o Core..:? "weight")
                     Core.<*> (o Core..:? "won"))
        ...
        parseJSON
          = Core.withObject "Filter"
              (\ o ->
                 Filter Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "advancedDetails")
                     Core.<*> (o Core..:? "created")
                     Core.<*> (o Core..:? "excludeDetails")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "includeDetails")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#filter")
          ...
          = Core.object
              (Core.catMaybes
                 [("caseSensitive" Core..=) Core.<$> caseSensitive,
                  ...
                  ("outputConstructor" Core..=) Core.<$>
                    outputConstructor,
                  ("outputToField" Core..=) Core.<$> outputToField,
                  ("outputToFieldIndex" Core..=) Core.<$>
                    outputToFieldIndex,
                  ("overrideOutputField" Core..=) Core.<$>
                    overrideOutputField])
...
instance Core.FromJSON Filter_SearchAndReplaceDetails
         where
        parseJSON
...
instance Core.ToJSON Filter_SearchAndReplaceDetails
         where
...
instance Core.FromJSON FilterRef where
        parseJSON
          = Core.withObject "FilterRef"
              (\ o ->
                 FilterRef Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "href")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#filterRef")
                     Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON GaData where
        parseJSON
          = Core.withObject "GaData"
              (\ o ->
                 GaData Core.<$>
                   (o Core..:? "columnHeaders" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#gaData")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("columnHeaders" Core..=) Core.<$> columnHeaders,
                  ...
                  ("rows" Core..=) Core.<$> rows,
                  ("sampleSize" Core..=) Core.. Core.AsText Core.<$>
                    sampleSize,
                  ("sampleSpace" Core..=) Core.. Core.AsText Core.<$>
                    sampleSpace,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("totalResults" Core..=) Core.<$> totalResults,
                  ("totalsForAllResults" Core..=) Core.<$>
                    totalsForAllResults])
          ...
          = Core.withObject "GaData_DataTable"
              (\ o ->
                 GaData_DataTable Core.<$>
                   (o Core..:? "cols" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "rows" Core..!= Core.mempty))
...
newGaData_DataTable_ColsItem =
  GaData_DataTable_ColsItem
    {id = Core.Nothing, label = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON GaData_DataTable_ColsItem
         where
        parseJSON
...
instance Core.FromJSON GaData_DataTable_RowsItem
         where
        parseJSON
          = Core.withObject "GaData_DataTable_RowsItem"
              (\ o ->
                 GaData_DataTable_RowsItem Core.<$>
                   (o Core..:? "c" Core..!= Core.mempty))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GaData_DataTable_RowsItem_CItem"
              (\ o ->
                 GaData_DataTable_RowsItem_CItem Core.<$>
                   (o Core..:? "v"))

instance Core.ToJSON GaData_DataTable_RowsItem_CItem
         where
...
instance Core.FromJSON GaData_TotalsForAllResults
         where
        parseJSON
          = Core.withObject "GaData_TotalsForAllResults"
              (\ o ->
                 GaData_TotalsForAllResults Core.<$>
              ...
              (\ o ->
                 Goal Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#goal")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "parentLink")
                     Core.<*> (o Core..:? "profileId")
                     Core.<*> (o Core..:? "selfLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("updated" Core..=) Core.<$> updated,
                  ("urlDestinationDetails" Core..=) Core.<$>
                    urlDestinationDetails,
                  ("value" Core..=) Core.<$> value,
                  ("visitNumPagesDetails" Core..=) Core.<$>
                    visitNumPagesDetails,
                  ("visitTimeOnSiteDetails" Core..=) Core.<$>
...
newGoal_EventDetails =
  Goal_EventDetails
    {eventConditions = Core.Nothing, useEventValue = Core.Nothing}
          ...
          = Core.withObject "Goal_EventDetails"
              (\ o ->
                 Goal_EventDetails Core.<$>
                   (o Core..:? "eventConditions" Core..!= Core.mempty)
...
instance Core.FromJSON Goal_UrlDestinationDetails
         where
        parseJSON
...
newGoal_UrlDestinationDetails_StepsItem =
  Goal_UrlDestinationDetails_StepsItem
    {name = Core.Nothing, number = Core.Nothing, url = Core.Nothing}
...
newGoal_VisitNumPagesDetails =
  Goal_VisitNumPagesDetails
    {comparisonType = Core.Nothing, comparisonValue = Core.Nothing}

instance Core.FromJSON Goal_VisitNumPagesDetails
         where
        parseJSON
...
instance Core.FromJSON Goal_VisitTimeOnSiteDetails
         where
        parseJSON
...
instance Core.ToJSON Goal_VisitTimeOnSiteDetails
         where
          ...
          = Core.withObject "HashClientIdResponse"
              (\ o ->
                 HashClientIdResponse Core.<$>
                   (o Core..:? "clientId") Core.<*>
                     (o Core..:? "hashedClientId")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "analytics#hashClientIdResponse")
                     Core.<*> (o Core..:? "webPropertyId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("daysToLookBack" Core..=) Core.<$> daysToLookBack,
                  ...
                  Core.Just ("kind" Core..= kind),
                  ("membershipDurationDays" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("remarketingAudienceId" Core..=) Core.<$>
              ...
              (\ o ->
                 McfData Core.<$>
                   (o Core..:? "columnHeaders" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "itemsPerPage")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#mcfData")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "profileInfo")
                     Core.<*> (o Core..:? "query")
...
instance Core.FromJSON McfData_ColumnHeadersItem
         where
        parseJSON
...
newMcfData_RowsItemItem =
  McfData_RowsItemItem
    {conversionPathValue = Core.Nothing, primitiveValue = Core.Nothing}
...
newMcfData_RowsItemItem_ConversionPathValueItem =
  McfData_RowsItemItem_ConversionPathValueItem
    {interactionType = Core.Nothing, nodeValue = Core.Nothing}
...
instance Core.FromJSON McfData_TotalsForAllResults
         where
        parseJSON
          = Core.withObject "McfData_TotalsForAllResults"
              (\ o ->
                 McfData_TotalsForAllResults Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON McfData_TotalsForAllResults
         where
              ...
              (\ o ->
                 Profile Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#profile")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "parentLink")
                     Core.<*> (o Core..:? "permissions")
                     Core.<*> (o Core..:? "selfLink")
                     ...
                     Core.<*> (o Core..:? "starred")
                     Core.<*>
                     (o Core..:? "stripSiteSearchCategoryParameters")
                     Core.<*>
                     (o Core..:? "stripSiteSearchQueryParameters")
                     Core.<*> (o Core..:? "timezone")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "updated")
                     Core.<*> (o Core..:? "webPropertyId")
          ...
          = Core.withObject "ProfileFilterLink"
              (\ o ->
                 ProfileFilterLink Core.<$>
                   (o Core..:? "filterRef") Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "analytics#profileFilterLink")
              ...
              (\ o ->
                 ProfileRef Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "href")
                     ...
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#profileRef")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "webPropertyId"))
...
instance Core.FromJSON RealtimeData_ColumnHeadersItem
         where
        parseJSON
...
instance Core.ToJSON RealtimeData_ColumnHeadersItem
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "RealtimeData_TotalsForAllResults"
              (\ o ->
                 RealtimeData_TotalsForAllResults Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON RealtimeData_TotalsForAllResults
         where
              ...
              (\ o ->
                 RemarketingAudience Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "analytics#remarketingAudience")
                     Core.<*>
                     (o Core..:? "linkedAdAccounts" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "linkedViews" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
...
newRemarketingAudience_StateBasedAudienceDefinition =
  RemarketingAudience_StateBasedAudienceDefinition
    {excludeConditions = Core.Nothing, includeConditions = Core.Nothing}
...
newRemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions =
  RemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions
    {exclusionDuration = Core.Nothing, segment = Core.Nothing}
              ...
              (\ o ->
                 RemarketingAudiences Core.<$>
                   (o Core..:? "items" Core..!= Core.mempty) Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "analytics#remarketingAudiences")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
              ...
              (\ o ->
                 Segment Core.<$>
                   (o Core..:? "created") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#segment")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("driveDownloadDetails" Core..=) Core.<$>
...
newUnsampledReport_CloudStorageDownloadDetails =
  UnsampledReport_CloudStorageDownloadDetails
    {bucketId = Core.Nothing, objectId = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "Upload"
              (\ o ->
                 Upload Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "customDataSourceId")
                     Core.<*> (o Core..:? "errors" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#upload")
                     Core.<*> (o Core..:? "status")
...
instance Core.ToJSON UserDeletionRequest where
        toJSON UserDeletionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("deletionRequestTime" Core..=) Core.<$>
                    deletionRequestTime,
                  ("firebaseProjectId" Core..=) Core.<$>
                    firebaseProjectId,
                  ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
              ...
              (\ o ->
                 Webproperty Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "created")
                     Core.<*>
                     (o Core..:? "dataRetentionResetOnNewActivity")
                     ...
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#webproperty")
                     Core.<*> (o Core..:? "level")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "parentLink")
                     Core.<*> (o Core..:? "permissions")
