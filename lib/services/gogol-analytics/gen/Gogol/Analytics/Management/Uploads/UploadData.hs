...
instance Core.GoogleRequest AnalyticsManagementUploadsUploadData where
...
instance
  ...
  where
  type
    Rs (Core.MediaUpload AnalyticsManagementUploadsUploadData) =
      Upload
  type
    Scopes (Core.MediaUpload AnalyticsManagementUploadsUploadData) =
