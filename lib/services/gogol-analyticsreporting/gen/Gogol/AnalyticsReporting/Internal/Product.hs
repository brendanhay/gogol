...
instance Core.FromJSON Activity where
        parseJSON
          = Core.withObject "Activity"
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "activityTime") Core.<*>
                     (o Core..:? "activityType")
                     Core.<*> (o Core..:? "appview")
                     Core.<*> (o Core..:? "campaign")
                     Core.<*> (o Core..:? "channelGrouping")
                     Core.<*>
                     (o Core..:? "customDimension" Core..!= Core.mempty)
...
newCohort 
    ::  Cohort
newCohort =
  Cohort {dateRange = Core.Nothing, name = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON Cohort where
        parseJSON
          = Core.withObject "Cohort"
              (\ o ->
                 Cohort Core.<$>
                   (o Core..:? "dateRange") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON CohortGroup where
        parseJSON
          = Core.withObject "CohortGroup"
              (\ o ->
                 CohortGroup Core.<$>
                   (o Core..:? "cohorts" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "lifetimeValue"))
...
newColumnHeader 
    ::  ColumnHeader
newColumnHeader =
  ColumnHeader {dimensions = Core.Nothing, metricHeader = Core.Nothing}
...
newDateRange 
    ::  DateRange
newDateRange = DateRange {endDate = Core.Nothing, startDate = Core.Nothing}
...
newDateRangeValues 
    ::  DateRangeValues
newDateRangeValues =
  DateRangeValues {pivotValueRegions = Core.Nothing, values = Core.Nothing}
          ...
          = Core.withObject "DateRangeValues"
              (\ o ->
                 DateRangeValues Core.<$>
                   (o Core..:? "pivotValueRegions" Core..!= Core.mempty)
...
newDimension 
    ::  Dimension
newDimension = Dimension {histogramBuckets = Core.Nothing, name = Core.Nothing}
...
instance Core.FromJSON Dimension where
        parseJSON
          = Core.withObject "Dimension"
              (\ o ->
                 Dimension Core.<$>
                   (o Core..:? "histogramBuckets" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name"))
              ...
              (\ o ->
                 DimensionFilter Core.<$>
                   (o Core..:? "caseSensitive") Core.<*>
                     (o Core..:? "dimensionName")
                     Core.<*>
                     (o Core..:? "expressions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "not")
...
newDimensionFilterClause 
    ::  DimensionFilterClause
newDimensionFilterClause =
  DimensionFilterClause {filters = Core.Nothing, operator = Core.Nothing}
...
instance Core.FromJSON EventData where
        parseJSON
          = Core.withObject "EventData"
              (\ o ->
                 EventData Core.<$>
                   (o Core..:? "eventAction") Core.<*>
                     (o Core..:? "eventCategory")
          ...
          = Core.object
              (Core.catMaybes
                 [("eventAction" Core..=) Core.<$> eventAction,
                  ...
                  ("eventCount" Core..=) Core.. Core.AsText Core.<$>
                    eventCount,
                  ("eventLabel" Core..=) Core.<$> eventLabel,
                  ("eventValue" Core..=) Core.. Core.AsText Core.<$>
                    eventValue])
...
newGetReportsRequest =
  GetReportsRequest
    {reportRequests = Core.Nothing, useResourceQuotas = Core.Nothing}
          ...
          = Core.withObject "GetReportsRequest"
              (\ o ->
                 GetReportsRequest Core.<$>
                   (o Core..:? "reportRequests" Core..!= Core.mempty)
          ...
          = Core.withObject "GetReportsResponse"
              (\ o ->
                 GetReportsResponse Core.<$>
                   (o Core..:? "queryCost") Core.<*>
                     (o Core..:? "reports" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("goalCompletionLocation" Core..=) Core.<$>
                  ...
                  ("goalCompletions" Core..=) Core.. Core.AsText
                    Core.<$> goalCompletions,
                  ("goalIndex" Core..=) Core.<$> goalIndex,
                  ("goalName" Core..=) Core.<$> goalName,
                  ("goalPreviousStep1" Core..=) Core.<$>
                    goalPreviousStep1,
                  ("goalPreviousStep2" Core..=) Core.<$>
                    goalPreviousStep2,
                  ("goalPreviousStep3" Core..=) Core.<$>
                    goalPreviousStep3,
...
instance Core.FromJSON GoalSetData where
        parseJSON
          = Core.withObject "GoalSetData"
              (\ o ->
                 GoalSetData Core.<$>
                   (o Core..:? "goals" Core..!= Core.mempty))

instance Core.ToJSON GoalSetData where
        toJSON GoalSetData{..}
          = Core.object
              (Core.catMaybes [("goals" Core..=) Core.<$> goals])
...
newMetricFilterClause 
    ::  MetricFilterClause
newMetricFilterClause =
  MetricFilterClause {filters = Core.Nothing, operator = Core.Nothing}
...
newMetricHeader 
    ::  MetricHeader
newMetricHeader =
  MetricHeader {metricHeaderEntries = Core.Nothing, pivotHeaders = Core.Nothing}
              ...
              (\ o ->
                 MetricHeader Core.<$>
                   (o Core..:? "metricHeaderEntries" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "pivotHeaders" Core..!= Core.mempty))

instance Core.ToJSON MetricHeader where
        toJSON MetricHeader{..}
          = Core.object
              (Core.catMaybes
                 [("metricHeaderEntries" Core..=) Core.<$>
                    metricHeaderEntries,
...
instance Core.FromJSON OrFiltersForSegment where
        parseJSON
          = Core.withObject "OrFiltersForSegment"
              (\ o ->
                 OrFiltersForSegment Core.<$>
                   (o Core..:? "segmentFilterClauses" Core..!=
                      Core.mempty))
...
instance Core.ToJSON OrFiltersForSegment where
        toJSON OrFiltersForSegment{..}
          = Core.object
              (Core.catMaybes
                 [("segmentFilterClauses" Core..=) Core.<$>
...
newPivotHeader =
  PivotHeader
    {pivotHeaderEntries = Core.Nothing, totalPivotGroupsCount = Core.Nothing}
...
instance Core.ToJSON PivotHeader where
        toJSON PivotHeader{..}
          = Core.object
              (Core.catMaybes
                 [("pivotHeaderEntries" Core..=) Core.<$>
                    pivotHeaderEntries,
                  ("totalPivotGroupsCount" Core..=) Core.<$>
          ...
          = Core.withObject "PivotHeaderEntry"
              (\ o ->
                 PivotHeaderEntry Core.<$>
                   (o Core..:? "dimensionNames" Core..!= Core.mempty)
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("itemRevenue" Core..=) Core.<$> itemRevenue,
                  ...
                  ("productQuantity" Core..=) Core.. Core.AsText
              ...
              (\ o ->
                 ReportData Core.<$>
                   (o Core..:? "dataLastRefreshed") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "samplesReadCounts" Core..!= Core.mempty)
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("dataLastRefreshed" Core..=) Core.<$>
                  ...
                  ("rows" Core..=) Core.<$> rows,
                  ("samplesReadCounts" Core..=) Core.<$>
                    samplesReadCounts,
                  ("samplingSpaceSizes" Core..=) Core.<$>
                    samplingSpaceSizes,
...
instance Core.FromJSON ReportRequest where
        parseJSON
          = Core.withObject "ReportRequest"
              (\ o ->
                 ReportRequest Core.<$>
                   (o Core..:? "cohortGroup") Core.<*>
                     (o Core..:? "dateRanges" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "dimensionFilterClauses" Core..!=
                        Core.mempty)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "metricFilterClauses" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "metrics" Core..!= Core.mempty)
              ...
              (Core.catMaybes
                 [("cohortGroup" Core..=) Core.<$> cohortGroup,
                  ...
                  ("dimensionFilterClauses" Core..=) Core.<$>
                    dimensionFilterClauses,
                  ("dimensions" Core..=) Core.<$> dimensions,
                  ("filtersExpression" Core..=) Core.<$>
                    filtersExpression,
                  ("hideTotals" Core..=) Core.<$> hideTotals,
                  ("hideValueRanges" Core..=) Core.<$> hideValueRanges,
                  ("includeEmptyRows" Core..=) Core.<$>
                    includeEmptyRows,
                  ("metricFilterClauses" Core..=) Core.<$>
                    metricFilterClauses,
                  ("metrics" Core..=) Core.<$> metrics,
...
newReportRow 
    ::  ReportRow
newReportRow = ReportRow {dimensions = Core.Nothing, metrics = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("appName" Core..=) Core.<$> appName,
                  ("mobileDeviceBranding" Core..=) Core.<$>
                    mobileDeviceBranding,
                  ("mobileDeviceModel" Core..=) Core.<$>
                    mobileDeviceModel,
...
instance Core.FromJSON SearchUserActivityRequest
         where
        parseJSON
          = Core.withObject "SearchUserActivityRequest"
              (\ o ->
                 SearchUserActivityRequest Core.<$>
                   (o Core..:? "activityTypes" Core..!= Core.mempty)
...
instance Core.FromJSON SearchUserActivityResponse
         where
        parseJSON
...
newSegment 
    ::  Segment
newSegment = Segment {dynamicSegment = Core.Nothing, segmentId = Core.Nothing}
...
newSegmentDefinition 
    ::  SegmentDefinition
newSegmentDefinition = SegmentDefinition {segmentFilters = Core.Nothing}

instance Core.FromJSON SegmentDefinition where
        parseJSON
          = Core.withObject "SegmentDefinition"
              (\ o ->
                 SegmentDefinition Core.<$>
                   (o Core..:? "segmentFilters" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("caseSensitive" Core..=) Core.<$> caseSensitive,
                  ("dimensionName" Core..=) Core.<$> dimensionName,
                  ("expressions" Core..=) Core.<$> expressions,
                  ("maxComparisonValue" Core..=) Core.<$>
                    maxComparisonValue,
                  ("minComparisonValue" Core..=) Core.<$>
                    minComparisonValue,
                  ("operator" Core..=) Core.<$> operator])
...
newSegmentSequenceStep =
  SegmentSequenceStep
    {matchType = Core.Nothing, orFiltersForSegment = Core.Nothing}
              ...
              (\ o ->
                 SegmentSequenceStep Core.<$>
                   (o Core..:? "matchType") Core.<*>
                     (o Core..:? "orFiltersForSegment" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 SequenceSegment Core.<$>
                   (o Core..:? "firstStepShouldMatchFirstHit") Core.<*>
                     (o Core..:? "segmentSequenceSteps" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("firstStepShouldMatchFirstHit" Core..=) Core.<$>
                  ...
                  ("segmentSequenceSteps" Core..=) Core.<$>
...
newSimpleSegment 
    ::  SimpleSegment
newSimpleSegment = SimpleSegment {orFiltersForSegment = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("transactionId" Core..=) Core.<$> transactionId,
                  ("transactionRevenue" Core..=) Core.<$>
                    transactionRevenue,
                  ("transactionShipping" Core..=) Core.<$>
                    transactionShipping,
          ...
          = Core.withObject "UserActivitySession"
              (\ o ->
                 UserActivitySession Core.<$>
                   (o Core..:? "activities" Core..!= Core.mempty)
