...
type AndroidEnterpriseEnterprisesSendTestPushNotificationResource =
  "androidenterprise"
    ...
    Core.:> Core.Post '[Core.JSON] EnterprisesSendTestPushNotificationResponse
...
instance
  ...
  where
  type
    Rs AndroidEnterpriseEnterprisesSendTestPushNotification =
      EnterprisesSendTestPushNotificationResponse
  type
    Scopes AndroidEnterpriseEnterprisesSendTestPushNotification =
