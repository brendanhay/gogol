              ...
              (\ o ->
                 AdministratorWebTokenSpec Core.<$>
                   (o Core..:? "managedConfigurations") Core.<*>
                     (o Core..:? "parent")
                     Core.<*>
                     (o Core..:? "permission" Core..!= Core.mempty)
          ...
          = Core.withObject "AppRestrictionsSchema"
              (\ o ->
                 AppRestrictionsSchema Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "restrictions" Core..!= Core.mempty))
              ...
              (\ o ->
                 AppRestrictionsSchemaRestriction Core.<$>
                   (o Core..:? "defaultValue") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "entryValue" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "key")
                     Core.<*>
                     (o Core..:? "nestedRestriction" Core..!= Core.mempty)
              ...
              (\ o ->
                 AppRestrictionsSchemaRestrictionRestrictionValue
                   ...
                   (o Core..:? "type") Core.<*> (o Core..:? "valueBool")
                     ...
                     Core.<*>
                     (o Core..:? "valueMultiselect" Core..!= Core.mempty)
...
instance Core.FromJSON AppState where
        parseJSON
          = Core.withObject "AppState"
              (\ o ->
                 AppState Core.<$>
                   (o Core..:? "keyedAppState" Core..!= Core.mempty)
          ...
          = Core.withObject "ConfigurationVariables"
              (\ o ->
                 ConfigurationVariables Core.<$>
                   (o Core..:? "mcmId") Core.<*>
                     (o Core..:? "variableSet" Core..!= Core.mempty))
...
instance Core.FromJSON DeviceReport where
        parseJSON
          = Core.withObject "DeviceReport"
              (\ o ->
                 DeviceReport Core.<$>
                   (o Core..:? "appState" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "lastUpdatedTimestampMillis"))
...
instance Core.FromJSON DevicesListResponse where
        parseJSON
          = Core.withObject "DevicesListResponse"
              (\ o ->
                 DevicesListResponse Core.<$>
                   (o Core..:? "device" Core..!= Core.mempty))
...
instance Core.FromJSON Enterprise where
        parseJSON
          = Core.withObject "Enterprise"
              (\ o ->
                 Enterprise Core.<$>
                   (o Core..:? "administrator" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.withObject "EnterprisesListResponse"
              (\ o ->
                 EnterprisesListResponse Core.<$>
                   (o Core..:? "enterprise" Core..!= Core.mempty))
          ...
          = Core.withObject "EntitlementsListResponse"
              (\ o ->
                 EntitlementsListResponse Core.<$>
                   (o Core..:? "entitlement" Core..!= Core.mempty))
          ...
          = Core.withObject "GroupLicensesListResponse"
              (\ o ->
                 GroupLicensesListResponse Core.<$>
                   (o Core..:? "groupLicense" Core..!= Core.mempty))
...
instance Core.FromJSON InstallsListResponse where
        parseJSON
          = Core.withObject "InstallsListResponse"
              (\ o ->
                 InstallsListResponse Core.<$>
                   (o Core..:? "install" Core..!= Core.mempty))
              ...
              (\ o ->
                 MaintenanceWindow Core.<$>
                   (o Core..:? "durationMs") Core.<*>
                     (o Core..:? "startTimeAfterMidnightMs"))
              ...
              (\ o ->
                 ManagedConfiguration Core.<$>
                   (o Core..:? "configurationVariables") Core.<*>
                     (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "managedProperty" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "productId"))
          ...
          = Core.withObject
              ...
              (\ o ->
                 ManagedConfigurationsForDeviceListResponse Core.<$>
                   (o Core..:? "managedConfigurationForDevice" Core..!=
                      Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 ManagedConfigurationsForUserListResponse Core.<$>
                   (o Core..:? "managedConfigurationForUser" Core..!=
                      Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 ManagedConfigurationsSettingsListResponse Core.<$>
                   (o Core..:? "managedConfigurationsSettings" Core..!=
                      Core.mempty))
              ...
              (\ o ->
                 ManagedProperty Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "valueBool")
                     ...
                     Core.<*>
                     (o Core..:? "valueBundleArray" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "valueInteger")
                     Core.<*> (o Core..:? "valueString")
                     Core.<*>
                     (o Core..:? "valueStringArray" Core..!= Core.mempty))
              ...
              (\ o ->
                 NewPermissionsEvent Core.<$>
                   (o Core..:? "approvedPermissions" Core..!=
                     ...
                     Core.<*> (o Core..:? "productId")
                     Core.<*>
                     (o Core..:? "requestedPermissions" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "NotificationSet"
              (\ o ->
                 NotificationSet Core.<$>
                   (o Core..:? "notification" Core..!= Core.mempty)
              ...
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "autoUpdatePolicy") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "productPolicy" Core..!= Core.mempty))
              ...
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "appTracks" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "appVersion" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "authorName")
                     Core.<*>
                     (o Core..:? "availableCountries" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "availableTracks" Core..!= Core.mempty)
...
instance Core.FromJSON ProductSet where
        parseJSON
          = Core.withObject "ProductSet"
              (\ o ->
                 ProductSet Core.<$>
                   (o Core..:? "productId" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "productSetBehavior")
                     Core.<*>
                     (o Core..:? "productVisibility" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 ProductsListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*>
                     (o Core..:? "product" Core..!= Core.mempty)
          ...
          = Core.withObject "StoreLayoutClustersListResponse"
              (\ o ->
                 StoreLayoutClustersListResponse Core.<$>
                   (o Core..:? "cluster" Core..!= Core.mempty))
...
instance Core.FromJSON WebAppsListResponse where
        parseJSON
          = Core.withObject "WebAppsListResponse"
              (\ o ->
                 WebAppsListResponse Core.<$>
                   (o Core..:? "webApp" Core..!= Core.mempty))
