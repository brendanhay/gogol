...
type AndroidEnterpriseManagedconfigurationssettingsListResource =
  "androidenterprise"
    ...
    Core.:> Core.Get '[Core.JSON] ManagedConfigurationsSettingsListResponse
...
instance
  ...
  where
  type
    Rs AndroidEnterpriseManagedconfigurationssettingsList =
      ManagedConfigurationsSettingsListResponse
  type
    Scopes AndroidEnterpriseManagedconfigurationssettingsList =
