               ...
               Core.Capture "editId" Core.Text Core.:>
                 "listings" Core.:>
                   Core.Capture "language" Core.Text Core.:>
                     Core.Capture "imageType" EditsImagesUploadImageType
                       Core.:>
...
newAndroidPublisherEditsImagesUpload 
    ...
    -> AndroidPublisherEditsImagesUpload
newAndroidPublisherEditsImagesUpload editId imageType language packageName =
  AndroidPublisherEditsImagesUpload
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          (Core.MediaUpload
             AndroidPublisherEditsImagesUpload{..} body)
          = go packageName editId language imageType xgafv
              accessToken
              callback
              uploadType
