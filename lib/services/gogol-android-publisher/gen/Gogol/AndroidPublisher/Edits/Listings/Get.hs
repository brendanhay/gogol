...
instance Core.GoogleRequest AndroidPublisherEditsListingsGet where
        type Core.Scopes AndroidPublisherEditsListingsGet = '[Androidpublisher'FullControl]
        type Core.Config AndroidPublisherEditsListingsGet = AndroidPublisherService
        type Core.Response AndroidPublisherEditsListingsGet = Listing
        toRequest Core.Service{serviceRequest, serviceParams = AndroidPublisherParams{..}} AndroidPublisherEditsListingsGet{..}
