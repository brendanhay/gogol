...
instance Core.GoogleRequest AndroidPublisherEditsTracksGet where
        type Core.Scopes AndroidPublisherEditsTracksGet = '[Androidpublisher'FullControl]
        type Core.Config AndroidPublisherEditsTracksGet = AndroidPublisherService
        type Core.Response AndroidPublisherEditsTracksGet = Track
        toRequest Core.Service{serviceRequest, serviceParams = AndroidPublisherParams{..}} AndroidPublisherEditsTracksGet{..}
