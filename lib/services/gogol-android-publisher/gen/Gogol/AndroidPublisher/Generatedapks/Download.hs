           ...
           Core.Capture "packageName" Core.Text Core.:>
             "generatedApks" Core.:>
               Core.Capture "versionCode" Core.Int32 Core.:>
                 "downloads" Core.:>
                   Core.CaptureMode "downloadId" "download" Core.Text
                     Core.:>
...
newAndroidPublisherGeneratedapksDownload 
    ...
    -> AndroidPublisherGeneratedapksDownload
newAndroidPublisherGeneratedapksDownload downloadId packageName versionCode =
  AndroidPublisherGeneratedapksDownload
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          AndroidPublisherGeneratedapksDownload{..}
          = go packageName versionCode downloadId xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
