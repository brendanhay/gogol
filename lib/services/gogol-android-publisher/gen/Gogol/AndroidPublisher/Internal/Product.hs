...
instance Core.FromJSON AllUsers where
        parseJSON
          = Core.withObject "AllUsers"
              (\ o ->
                 AllUsers Core.<$> (o Core..:? "isAllUsersRequested"))

instance Core.ToJSON AllUsers where
        toJSON AllUsers{..}
          = Core.object
              (Core.catMaybes
                 [("isAllUsersRequested" Core..=) Core.<$>
                    isAllUsersRequested])
...
instance Core.ToJSON AndroidSdks where
        toJSON AndroidSdks{..}
          = Core.object
              (Core.catMaybes
                 [("sdkLevels" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> sdkLevels])
...
instance Core.ToJSON ApkDescription where
        toJSON ApkDescription{..}
          = Core.object
              (Core.catMaybes
                 [("assetSliceMetadata" Core..=) Core.<$>
                    assetSliceMetadata,
                  ("instantApkMetadata" Core..=) Core.<$>
                    instantApkMetadata,
                  ("path" Core..=) Core.<$> path,
                  ("splitApkMetadata" Core..=) Core.<$>
                    splitApkMetadata,
                  ("standaloneApkMetadata" Core..=) Core.<$>
                    standaloneApkMetadata,
...
newApkSet 
    ::  ApkSet
newApkSet =
  ApkSet {apkDescription = Core.Nothing, moduleMetadata = Core.Nothing}
              ...
              (\ o ->
                 ApkTargeting Core.<$>
                   (o Core..:? "abiTargeting") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "textureCompressionFormatTargeting"))
              ...
              (Core.catMaybes
                 [("abiTargeting" Core..=) Core.<$> abiTargeting,
                  ("languageTargeting" Core..=) Core.<$>
                    languageTargeting,
                  ("multiAbiTargeting" Core..=) Core.<$>
                    multiAbiTargeting,
                  ("screenDensityTargeting" Core..=) Core.<$>
                    screenDensityTargeting,
                  ("sdkVersionTargeting" Core..=) Core.<$>
                    sdkVersionTargeting,
...
newAppVersionRange =
  AppVersionRange
    {versionCodeEnd = Core.Nothing, versionCodeStart = Core.Nothing}
          ...
          = Core.withObject "AppVersionRange"
              (\ o ->
                 AppVersionRange Core.<$>
                   (o Core..:? "versionCodeEnd" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "versionCodeStart" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON AppVersionRange where
        toJSON AppVersionRange{..}
          = Core.object
              (Core.catMaybes
                 [("versionCodeEnd" Core..=) Core.. Core.AsText
                    Core.<$> versionCodeEnd,
                  ("versionCodeStart" Core..=) Core.. Core.AsText
...
newAssetModuleMetadata 
    ::  AssetModuleMetadata
newAssetModuleMetadata =
  AssetModuleMetadata {deliveryType = Core.Nothing, name = Core.Nothing}
...
newAssetSliceSet =
  AssetSliceSet
    {apkDescription = Core.Nothing, assetModuleMetadata = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "BatchGetSubscriptionOffersRequest"
              (\ o ->
                 BatchGetSubscriptionOffersRequest Core.<$>
                   (o Core..:? "requests"))
...
newBatchGetSubscriptionOffersResponse 
    ::  BatchGetSubscriptionOffersResponse
newBatchGetSubscriptionOffersResponse =
  BatchGetSubscriptionOffersResponse {subscriptionOffers = Core.Nothing}
...
instance Core.FromJSON BatchGetSubscriptionsResponse
         where
        parseJSON
...
instance Core.ToJSON BatchGetSubscriptionsResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "BatchMigrateBasePlanPricesRequest"
              (\ o ->
                 BatchMigrateBasePlanPricesRequest Core.<$>
                   (o Core..:? "requests"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "BatchUpdateBasePlanStatesRequest"
              (\ o ->
                 BatchUpdateBasePlanStatesRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchUpdateBasePlanStatesRequest
         where
...
newBatchUpdateSubscriptionOfferStatesRequest 
    ::  BatchUpdateSubscriptionOfferStatesRequest
newBatchUpdateSubscriptionOfferStatesRequest =
  BatchUpdateSubscriptionOfferStatesRequest {requests = Core.Nothing}
...
newBatchUpdateSubscriptionOfferStatesResponse 
    ::  BatchUpdateSubscriptionOfferStatesResponse
newBatchUpdateSubscriptionOfferStatesResponse =
  BatchUpdateSubscriptionOfferStatesResponse {subscriptionOffers = Core.Nothing}
...
newBatchUpdateSubscriptionOffersResponse 
    ::  BatchUpdateSubscriptionOffersResponse
newBatchUpdateSubscriptionOffersResponse =
  BatchUpdateSubscriptionOffersResponse {subscriptionOffers = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "BatchUpdateSubscriptionsRequest"
              (\ o ->
                 BatchUpdateSubscriptionsRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchUpdateSubscriptionsRequest
         where
...
instance Core.ToJSON BatchUpdateSubscriptionsResponse
         where
...
instance Core.FromJSON CancelAppRecoveryResponse
         where
        parseJSON
...
newCreateDraftAppRecoveryRequest =
  CreateDraftAppRecoveryRequest
    {remoteInAppUpdate = Core.Nothing, targeting = Core.Nothing}

instance Core.FromJSON CreateDraftAppRecoveryRequest
         where
        parseJSON
          = Core.withObject "CreateDraftAppRecoveryRequest"
              (\ o ->
                 CreateDraftAppRecoveryRequest Core.<$>
                   (o Core..:? "remoteInAppUpdate") Core.<*>
                     (o Core..:? "targeting"))

instance Core.ToJSON CreateDraftAppRecoveryRequest
         where
        toJSON CreateDraftAppRecoveryRequest{..}
          = Core.object
              (Core.catMaybes
                 [("remoteInAppUpdate" Core..=) Core.<$>
                    remoteInAppUpdate,
                  ("targeting" Core..=) Core.<$> targeting])
...
newDeferredItemReplacement 
    ::  DeferredItemReplacement
newDeferredItemReplacement = DeferredItemReplacement {productId = Core.Nothing}
...
instance Core.FromJSON DeployAppRecoveryResponse
         where
        parseJSON
...
newDeviceFeature 
    ::  DeviceFeature
newDeviceFeature =
  DeviceFeature {featureName = Core.Nothing, featureVersion = Core.Nothing}
...
instance Core.FromJSON DeviceFeature where
        parseJSON
          = Core.withObject "DeviceFeature"
              (\ o ->
                 DeviceFeature Core.<$>
                   (o Core..:? "featureName") Core.<*>
                     (o Core..:? "featureVersion"))
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("transactionProgramCode" Core..=) Core.<$>
...
newExternalTransactionAddress =
  ExternalTransactionAddress
    {administrativeArea = Core.Nothing, regionCode = Core.Nothing}
        ...
        toJSON GeneratedRecoveryApk{..}
          = Core.object
              (Core.catMaybes
                 [("downloadId" Core..=) Core.<$> downloadId,
                  ("moduleName" Core..=) Core.<$> moduleName,
                  ("recoveryId" Core..=) Core.. Core.AsText Core.<$>
                    recoveryId,
...
instance Core.FromJSON GetSubscriptionOfferRequest
         where
        parseJSON
...
instance Core.ToJSON GetSubscriptionOfferRequest
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "InappproductsBatchDeleteRequest"
              (\ o ->
                 InappproductsBatchDeleteRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON InappproductsBatchDeleteRequest
         where
...
instance Core.FromJSON InappproductsBatchGetResponse
         where
        parseJSON
          = Core.withObject "InappproductsBatchGetResponse"
              (\ o ->
                 InappproductsBatchGetResponse Core.<$>
                   (o Core..:? "inappproduct"))

instance Core.ToJSON InappproductsBatchGetResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "InappproductsBatchUpdateRequest"
              (\ o ->
                 InappproductsBatchUpdateRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON InappproductsBatchUpdateRequest
         where
...
instance Core.ToJSON InappproductsBatchUpdateResponse
         where
        toJSON InappproductsBatchUpdateResponse{..}
          = Core.object
              (Core.catMaybes
                 [("inappproducts" Core..=) Core.<$> inappproducts])
...
instance Core.FromJSON InappproductsDeleteRequest
         where
        parseJSON
          = Core.withObject "InappproductsDeleteRequest"
              (\ o ->
                 InappproductsDeleteRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*>
                     (o Core..:? "packageName")
                     Core.<*> (o Core..:? "sku"))
...
instance Core.FromJSON InappproductsUpdateRequest
         where
        parseJSON
              ...
              (\ o ->
                 InstallmentPlan Core.<$>
                   (o Core..:? "initialCommittedPaymentsCount") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "remainingCommittedPaymentsCount")
                     Core.<*>
                     (o Core..:? "subsequentCommittedPaymentsCount"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accountHoldDuration" Core..=) Core.<$>
                  ...
                  ("billingPeriodDuration" Core..=) Core.<$>
                    billingPeriodDuration,
                  ("committedPaymentsCount" Core..=) Core.<$>
...
newLanguageTargeting 
    ::  LanguageTargeting
newLanguageTargeting =
  LanguageTargeting {alternatives = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON ListAppRecoveriesResponse
         where
        parseJSON
          = Core.withObject "ListAppRecoveriesResponse"
              (\ o ->
                 ListAppRecoveriesResponse Core.<$>
                   (o Core..:? "recoveryActions"))

instance Core.ToJSON ListAppRecoveriesResponse where
        toJSON ListAppRecoveriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("recoveryActions" Core..=) Core.<$>
                    recoveryActions])
...
instance Core.ToJSON MultiAbi where
        toJSON MultiAbi{..}
          = Core.object
              (Core.catMaybes [("abi" Core..=) Core.<$> abi])
...
newMultiAbiTargeting 
    ::  MultiAbiTargeting
newMultiAbiTargeting =
  MultiAbiTargeting {alternatives = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON OneTimeCode where
        parseJSON
          = Core.withObject "OneTimeCode"
              (\ o -> Core.pure OneTimeCode)
          ...
          = Core.object
              (Core.catMaybes
                 [("externalSubscription" Core..=) Core.<$>
                  ...
                  ("otherRecurringProduct" Core..=) Core.<$>
                    otherRecurringProduct])
...
newRemoteInAppUpdateData 
    ::  RemoteInAppUpdateData
newRemoteInAppUpdateData =
  RemoteInAppUpdateData {remoteAppUpdateDataPerBundle = Core.Nothing}
...
newRemoteInAppUpdateDataPerBundle =
  RemoteInAppUpdateDataPerBundle
    { recoveredDeviceCount = Core.Nothing
    , totalDeviceCount = Core.Nothing
    , versionCode = Core.Nothing
    }

instance Core.FromJSON RemoteInAppUpdateDataPerBundle
         where
        parseJSON
              ...
              (\ o ->
                 RemoteInAppUpdateDataPerBundle Core.<$>
                   (o Core..:? "recoveredDeviceCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalDeviceCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "versionCode" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON RemoteInAppUpdateDataPerBundle
         where
        toJSON RemoteInAppUpdateDataPerBundle{..}
          = Core.object
              (Core.catMaybes
                 [("recoveredDeviceCount" Core..=) Core.. Core.AsText
                    Core.<$> recoveredDeviceCount,
                  ("totalDeviceCount" Core..=) Core.. Core.AsText
...
instance Core.FromJSON RestrictedPaymentCountries
         where
        parseJSON
...
newRevocationContext 
    ::  RevocationContext
newRevocationContext =
  RevocationContext {fullRefund = Core.Nothing, proratedRefund = Core.Nothing}
...
instance Core.FromJSON RevocationContextFullRefund
         where
        parseJSON
          = Core.withObject "RevocationContextFullRefund"
              (\ o -> Core.pure RevocationContextFullRefund)

instance Core.ToJSON RevocationContextFullRefund
         where
        toJSON = Core.const Core.emptyObject
...
newRevocationContextProratedRefund 
    ::  RevocationContextProratedRefund
newRevocationContextProratedRefund = RevocationContextProratedRefund
...
instance Core.ToJSON RevocationContextProratedRefund
         where
        toJSON = Core.const Core.emptyObject
...
newRevokeSubscriptionPurchaseRequest 
    ::  RevokeSubscriptionPurchaseRequest
newRevokeSubscriptionPurchaseRequest =
  RevokeSubscriptionPurchaseRequest {revocationContext = Core.Nothing}
...
newRevokeSubscriptionPurchaseResponse 
    ::  RevokeSubscriptionPurchaseResponse
newRevokeSubscriptionPurchaseResponse = RevokeSubscriptionPurchaseResponse
...
instance Core.FromJSON SafetyLabelsUpdateRequest
         where
        parseJSON
          = Core.withObject "SafetyLabelsUpdateRequest"
              (\ o ->
                 SafetyLabelsUpdateRequest Core.<$>
                   (o Core..:? "safetyLabels"))
...
instance Core.ToJSON SafetyLabelsUpdateRequest where
        toJSON SafetyLabelsUpdateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("safetyLabels" Core..=) Core.<$> safetyLabels])
...
instance Core.FromJSON SafetyLabelsUpdateResponse
         where
        parseJSON
...
newScreenDensity 
    ::  ScreenDensity
newScreenDensity =
  ScreenDensity {densityAlias = Core.Nothing, densityDpi = Core.Nothing}
...
newScreenDensityTargeting 
    ::  ScreenDensityTargeting
newScreenDensityTargeting =
  ScreenDensityTargeting {alternatives = Core.Nothing, value = Core.Nothing}
...
instance Core.ToJSON SdkVersion where
        toJSON SdkVersion{..}
          = Core.object
              (Core.catMaybes [("min" Core..=) Core.<$> min])
...
newSdkVersionTargeting 
    ::  SdkVersionTargeting
newSdkVersionTargeting =
  SdkVersionTargeting {alternatives = Core.Nothing, value = Core.Nothing}
...
newSignupPromotion 
    ::  SignupPromotion
newSignupPromotion =
  SignupPromotion {oneTimeCode = Core.Nothing, vanityCode = Core.Nothing}
...
newSplitApkMetadata 
    ::  SplitApkMetadata
newSplitApkMetadata =
  SplitApkMetadata {isMasterSplit = Core.Nothing, splitId = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("rotated" Core..=) Core.<$> rotated,
                  ("uncompressedDexFiles" Core..=) Core.<$>
...
instance Core.ToJSON TargetingRuleScope where
        toJSON TargetingRuleScope{..}
          = Core.object
              (Core.catMaybes
                 [("anySubscriptionInApp" Core..=) Core.<$>
                    anySubscriptionInApp,
                  ("specificSubscriptionInApp" Core..=) Core.<$>
                    specificSubscriptionInApp,
                  ("thisSubscription" Core..=) Core.<$>
                    thisSubscription])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "TargetingRuleScopeAnySubscriptionInApp"
              (\ o ->
                 Core.pure TargetingRuleScopeAnySubscriptionInApp)
...
newTargetingRuleScopeThisSubscription 
    ::  TargetingRuleScopeThisSubscription
newTargetingRuleScopeThisSubscription = TargetingRuleScopeThisSubscription
...
newTextureCompressionFormat 
    ::  TextureCompressionFormat
newTextureCompressionFormat = TextureCompressionFormat {alias = Core.Nothing}

instance Core.FromJSON TextureCompressionFormat where
        parseJSON
          = Core.withObject "TextureCompressionFormat"
              (\ o ->
                 TextureCompressionFormat Core.<$>
                   (o Core..:? "alias"))
...
newTextureCompressionFormatTargeting =
  TextureCompressionFormatTargeting
    {alternatives = Core.Nothing, value = Core.Nothing}
...
newTrackConfig =
  TrackConfig
    {formFactor = Core.Nothing, track = Core.Nothing, type' = Core.Nothing}
...
newUpdateBasePlanStateRequest =
  UpdateBasePlanStateRequest
    { activateBasePlanRequest = Core.Nothing
    , deactivateBasePlanRequest = Core.Nothing
    }

instance Core.FromJSON UpdateBasePlanStateRequest
         where
        parseJSON
...
instance Core.FromJSON UpdateSubscriptionOfferRequest
         where
        parseJSON
...
instance Core.ToJSON UpdateSubscriptionOfferRequest
         where
...
newUpdateSubscriptionOfferStateRequest =
  UpdateSubscriptionOfferStateRequest
    { activateSubscriptionOfferRequest = Core.Nothing
          ...
          = Core.withObject
              ...
              (\ o ->
                 UpdateSubscriptionOfferStateRequest Core.<$>
                   (o Core..:? "activateSubscriptionOfferRequest")
                     Core.<*>
...
newUserCountriesTargeting 
    ::  UserCountriesTargeting
newUserCountriesTargeting =
  UserCountriesTargeting {countryCodes = Core.Nothing, exclude = Core.Nothing}
...
instance Core.FromJSON VanityCode where
        parseJSON
          = Core.withObject "VanityCode"
              (\ o ->
                 VanityCode Core.<$> (o Core..:? "promotionCode"))
