          ...
          = Core.withObject "ApksListResponse"
              (\ o ->
                 ApksListResponse Core.<$>
                   (o Core..:? "apks" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind"))
              ...
              (\ o ->
                 DeviceSpec Core.<$>
                   (o Core..:? "screenDensity") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "supportedLocales" Core..!= Core.mempty))
              ...
              (\ o ->
                 ExternallyHostedApk Core.<$>
                   (o Core..:? "applicationLabel") Core.<*>
                     (o Core..:? "certificateBase64s" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "nativeCodes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "packageName")
                     Core.<*>
                     (o Core..:? "usesFeatures" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "usesPermissions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "versionCode")
          ...
          = Core.withObject "GeneratedApksListResponse"
              (\ o ->
                 GeneratedApksListResponse Core.<$>
                   (o Core..:? "generatedApks" Core..!= Core.mempty))
              ...
              (\ o ->
                 GeneratedApksPerSigningKey Core.<$>
                   (o Core..:? "certificateSha256Hash") Core.<*>
                     (o Core..:? "generatedAssetPackSlices" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "generatedSplitApks" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "generatedStandaloneApks" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "ImagesDeleteAllResponse"
              (\ o ->
                 ImagesDeleteAllResponse Core.<$>
                   (o Core..:? "deleted" Core..!= Core.mempty))
...
instance Core.FromJSON ImagesListResponse where
        parseJSON
          = Core.withObject "ImagesListResponse"
              (\ o ->
                 ImagesListResponse Core.<$>
                   (o Core..:? "images" Core..!= Core.mempty))
          ...
          = Core.withObject "InAppProductListing"
              (\ o ->
                 InAppProductListing Core.<$>
                   (o Core..:? "benefits" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "title"))
          ...
          = Core.withObject "InappproductsListResponse"
              (\ o ->
                 InappproductsListResponse Core.<$>
                   (o Core..:? "inappproduct" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kind")
              ...
              (\ o ->
                 IntroductoryPriceInfo Core.<$>
                   (o Core..:? "introductoryPriceAmountMicros") Core.<*>
                     (o Core..:? "introductoryPriceCurrencyCode")
          ...
          = Core.withObject "ListingsListResponse"
              (\ o ->
                 ListingsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "listings" Core..!= Core.mempty))
...
newRegionalTaxRateInfo =
  RegionalTaxRateInfo
    {eligibleForStreamingServiceTaxRate = Core.Nothing, taxTier = Core.Nothing}
              ...
              (\ o ->
                 ReviewsListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*>
                     (o Core..:? "reviews" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "tokenPagination"))
              ...
              (\ o ->
                 SubscriptionDeferralInfo Core.<$>
                   (o Core..:? "desiredExpiryTimeMillis") Core.<*>
                     (o Core..:? "expectedExpiryTimeMillis"))
          ...
          = Core.withObject "SystemApksListResponse"
              (\ o ->
                 SystemApksListResponse Core.<$>
                   (o Core..:? "variants" Core..!= Core.mempty))
...
instance Core.FromJSON Testers where
        parseJSON
          = Core.withObject "Testers"
              (\ o ->
                 Testers Core.<$>
                   (o Core..:? "googleGroups" Core..!= Core.mempty))
...
instance Core.FromJSON Timestamp where
        parseJSON
          = Core.withObject "Timestamp"
              (\ o ->
                 Timestamp Core.<$>
                   (o Core..:? "nanos") Core.<*> (o Core..:? "seconds"))
...
instance Core.FromJSON Track where
        parseJSON
          = Core.withObject "Track"
              (\ o ->
                 Track Core.<$>
                   (o Core..:? "releases" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "track"))
              ...
              (\ o ->
                 TrackRelease Core.<$>
                   (o Core..:? "countryTargeting") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "releaseNotes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "userFraction")
                     Core.<*>
                     (o Core..:? "versionCodes" Core..!= Core.mempty))
              ...
              (\ o ->
                 User Core.<$>
                   (o Core..:? "accessState") Core.<*>
                     (o Core..:? "developerAccountPermissions" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "email")
              ...
              (\ o ->
                 VoidedPurchasesListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "voidedPurchases" Core..!= Core.mempty))
