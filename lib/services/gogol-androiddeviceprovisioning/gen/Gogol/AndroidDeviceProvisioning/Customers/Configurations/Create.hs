...
type AndroidDeviceProvisioningCustomersConfigurationsCreateResource =
  "v1"
    ...
    Core.:> Core.Post '[Core.JSON] Configuration
...
instance
  ...
  where
  type
    Rs AndroidDeviceProvisioningCustomersConfigurationsCreate =
      Configuration
  type
    Scopes AndroidDeviceProvisioningCustomersConfigurationsCreate =
      '[]
  requestClient
    AndroidDeviceProvisioningCustomersConfigurationsCreate {..} =
      go
