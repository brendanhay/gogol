...
type AndroidDeviceProvisioningCustomersConfigurationsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] CustomerListConfigurationsResponse
...
instance
  ...
  where
  type
    Rs AndroidDeviceProvisioningCustomersConfigurationsList =
      CustomerListConfigurationsResponse
  type
    Scopes AndroidDeviceProvisioningCustomersConfigurationsList =
      '[]
  requestClient
    AndroidDeviceProvisioningCustomersConfigurationsList {..} =
      go
