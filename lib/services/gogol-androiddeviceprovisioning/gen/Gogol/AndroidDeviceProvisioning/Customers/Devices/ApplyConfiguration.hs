...
type AndroidDeviceProvisioningCustomersDevicesApplyConfigurationResource =
  "v1"
    ...
    Core.:> "devices:applyConfiguration"
    ...
    Core.:> Core.ReqBody '[Core.JSON] CustomerApplyConfigurationRequest
...
instance
  ...
  where
  type
    Rs AndroidDeviceProvisioningCustomersDevicesApplyConfiguration =
      Empty
  type
    Scopes
      AndroidDeviceProvisioningCustomersDevicesApplyConfiguration =
