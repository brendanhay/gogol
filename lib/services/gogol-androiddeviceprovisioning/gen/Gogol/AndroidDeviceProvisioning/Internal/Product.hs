...
instance Core.FromJSON ClaimDevicesRequest where
        parseJSON
          = Core.withObject "ClaimDevicesRequest"
              (\ o ->
                 ClaimDevicesRequest Core.<$>
                   (o Core..:? "claims" Core..!= Core.mempty))
...
instance Core.FromJSON Company where
        parseJSON
          = Core.withObject "Company"
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "adminEmails" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "companyId")
                     Core.<*> (o Core..:? "companyName")
                     Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "ownerEmails" Core..!= Core.mempty)
          ...
          = Core.withObject "CustomerListCustomersResponse"
              (\ o ->
                 CustomerListCustomersResponse Core.<$>
                   (o Core..:? "customers" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 DevicesLongRunningOperationResponse Core.<$>
                   (o Core..:? "perDeviceStatus" Core..!= Core.mempty)
          ...
          = Core.withObject "FindDevicesByOwnerRequest"
              (\ o ->
                 FindDevicesByOwnerRequest Core.<$>
                   (o Core..:? "customerId" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "limit")
                     Core.<*> (o Core..:? "pageToken")
                     Core.<*> (o Core..:? "sectionType"))
          ...
          = Core.withObject "UnclaimDevicesRequest"
              (\ o ->
                 UnclaimDevicesRequest Core.<$>
                   (o Core..:? "unclaims" Core..!= Core.mempty))
