...
instance Core.FromJSON GetDeviceSimLockStateRequest
         where
        parseJSON
...
instance Core.ToJSON GetDeviceSimLockStateRequest
         where
...
instance Core.FromJSON GetDeviceSimLockStateResponse
         where
        parseJSON
          = Core.withObject "GetDeviceSimLockStateResponse"
              (\ o ->
                 GetDeviceSimLockStateResponse Core.<$>
                   (o Core..:? "simLockState"))

instance Core.ToJSON GetDeviceSimLockStateResponse
         where
        toJSON GetDeviceSimLockStateResponse{..}
          = Core.object
              (Core.catMaybes
                 [("simLockState" Core..=) Core.<$> simLockState])
