...
type AndroidDeviceProvisioningPartnersDevicesFindByIdentifierResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] FindDevicesByDeviceIdentifierRequest
    Core.:> Core.Post '[Core.JSON] FindDevicesByDeviceIdentifierResponse
...
instance
  ...
  where
  type
    Rs AndroidDeviceProvisioningPartnersDevicesFindByIdentifier =
