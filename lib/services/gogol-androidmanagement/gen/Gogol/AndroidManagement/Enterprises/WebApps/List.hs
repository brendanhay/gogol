...
type AndroidManagementEnterprisesWebAppsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListWebAppsResponse
...
instance Core.GoogleRequest AndroidManagementEnterprisesWebAppsList where
  type
    Rs AndroidManagementEnterprisesWebAppsList =
      ListWebAppsResponse
  type
