              ...
              (Core.catMaybes
                 [("clearAppsDataParams" Core..=) Core.<$>
                  ...
                  ("resetPasswordFlags" Core..=) Core.<$>
                    resetPasswordFlags,
                  ("startLostModeParams" Core..=) Core.<$>
                    startLostModeParams,
                  ("startLostModeStatus" Core..=) Core.<$>
                    startLostModeStatus,
                  ("stopLostModeParams" Core..=) Core.<$>
                    stopLostModeParams,
                  ("stopLostModeStatus" Core..=) Core.<$>
                    stopLostModeStatus,
                  ("type" Core..=) Core.<$> type',
          ...
          = Core.withObject "DeviceConnectivityManagement"
              (\ o ->
                 DeviceConnectivityManagement Core.<$>
                   (o Core..:? "configureWifi") Core.<*>
                     (o Core..:? "tetheringSettings")
          ...
          = Core.object
              (Core.catMaybes
                 [("configureWifi" Core..=) Core.<$> configureWifi,
                  ("tetheringSettings" Core..=) Core.<$>
                    tetheringSettings,
                  ("usbDataAccess" Core..=) Core.<$> usbDataAccess,
                  ("wifiDirectSettings" Core..=) Core.<$>
                    wifiDirectSettings,
                  ("wifiRoamingPolicy" Core..=) Core.<$>
                    wifiRoamingPolicy,
...
instance Core.ToJSON DeviceRadioState where
        toJSON DeviceRadioState{..}
          = Core.object
              (Core.catMaybes
                 [("airplaneModeState" Core..=) Core.<$>
                    airplaneModeState,
                  ("cellularTwoGState" Core..=) Core.<$>
                    cellularTwoGState,
                  ("minimumWifiSecurityLevel" Core..=) Core.<$>
                    minimumWifiSecurityLevel,
                  ("ultraWidebandState" Core..=) Core.<$>
                    ultraWidebandState,
          ...
          = Core.object
              (Core.catMaybes
                 [("screenBrightnessSettings" Core..=) Core.<$>
                    screenBrightnessSettings,
                  ("screenTimeoutSettings" Core..=) Core.<$>
                    screenTimeoutSettings])
...
newDpcMigrationInfo 
    ::  DpcMigrationInfo
newDpcMigrationInfo =
  DpcMigrationInfo {additionalData = Core.Nothing, previousDpc = Core.Nothing}
...
newGoogleAuthenticationSettings 
    ::  GoogleAuthenticationSettings
newGoogleAuthenticationSettings =
  GoogleAuthenticationSettings {googleAuthenticationRequired = Core.Nothing}
...
instance Core.ToJSON InstallConstraint where
        toJSON InstallConstraint{..}
          = Core.object
              (Core.catMaybes
                 [("chargingConstraint" Core..=) Core.<$>
                    chargingConstraint,
                  ("deviceIdleConstraint" Core..=) Core.<$>
...
newListMigrationTokensResponse =
  ListMigrationTokensResponse
    {migrationTokens = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListMigrationTokensResponse
         where
        parseJSON
...
instance Core.ToJSON ListMigrationTokensResponse
         where
        toJSON ListMigrationTokensResponse{..}
          = Core.object
              (Core.catMaybes
                 [("migrationTokens" Core..=) Core.<$>
                    migrationTokens,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newLocation 
    ::  Location
newLocation = Location {latitude = Core.Nothing, longitude = Core.Nothing}
...
newLostModeLocationEvent 
    ::  LostModeLocationEvent
newLostModeLocationEvent =
  LostModeLocationEvent {batteryLevel = Core.Nothing, location = Core.Nothing}
...
instance Core.FromJSON LostModeOutgoingPhoneCallEvent
         where
        parseJSON
          = Core.withObject "LostModeOutgoingPhoneCallEvent"
              (\ o -> Core.pure LostModeOutgoingPhoneCallEvent)

instance Core.ToJSON LostModeOutgoingPhoneCallEvent
         where
        toJSON = Core.const Core.emptyObject
              ...
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "accountTypesWithManagementDisabled")
                     ...
                     Core.<*>
                     (o Core..:? "credentialProviderPolicyDefault")
...
instance Core.ToJSON ProvisioningInfo where
        toJSON ProvisioningInfo{..}
          = Core.object
              (Core.catMaybes
                 [("apiLevel" Core..=) Core.<$> apiLevel,
                  ("authenticatedUserEmail" Core..=) Core.<$>
...
newScreenBrightnessSettings =
  ScreenBrightnessSettings
    {screenBrightness = Core.Nothing, screenBrightnessMode = Core.Nothing}
...
instance Core.ToJSON ScreenBrightnessSettings where
        toJSON ScreenBrightnessSettings{..}
          = Core.object
              (Core.catMaybes
                 [("screenBrightness" Core..=) Core.<$>
                    screenBrightness,
                  ("screenBrightnessMode" Core..=) Core.<$>
...
newScreenTimeoutSettings =
  ScreenTimeoutSettings
    {screenTimeout = Core.Nothing, screenTimeoutMode = Core.Nothing}
...
instance Core.ToJSON StartLostModeParams where
        toJSON StartLostModeParams{..}
          = Core.object
              (Core.catMaybes
                 [("lostEmailAddress" Core..=) Core.<$>
                    lostEmailAddress,
                  ("lostMessage" Core..=) Core.<$> lostMessage,
                  ("lostOrganization" Core..=) Core.<$>
                    lostOrganization,
                  ("lostPhoneNumber" Core..=) Core.<$> lostPhoneNumber,
                  ("lostStreetAddress" Core..=) Core.<$>
                    lostStreetAddress])
...
instance Core.FromJSON StartLostModeStatus where
        parseJSON
          = Core.withObject "StartLostModeStatus"
              (\ o ->
                 StartLostModeStatus Core.<$> (o Core..:? "status"))
...
instance Core.FromJSON StopLostModeStatus where
        parseJSON
          = Core.withObject "StopLostModeStatus"
              (\ o ->
                 StopLostModeStatus Core.<$> (o Core..:? "status"))
...
instance Core.FromJSON StopLostModeUserAttemptEvent
         where
        parseJSON
...
instance Core.ToJSON StopLostModeUserAttemptEvent
         where
              ...
              (\ o ->
                 UsageLogEvent Core.<$>
                   (o Core..:? "adbShellCommandEvent") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "lostModeOutgoingPhoneCallEvent")
              ...
              (Core.catMaybes
                 [("adbShellCommandEvent" Core..=) Core.<$>
                  ...
                  ("loggingStoppedEvent" Core..=) Core.<$>
                    loggingStoppedEvent,
                  ("lostModeLocationEvent" Core..=) Core.<$>
                    lostModeLocationEvent,
...
newWifiRoamingPolicy 
    ::  WifiRoamingPolicy
newWifiRoamingPolicy = WifiRoamingPolicy {wifiRoamingSettings = Core.Nothing}

instance Core.FromJSON WifiRoamingPolicy where
        parseJSON
          = Core.withObject "WifiRoamingPolicy"
              (\ o ->
                 WifiRoamingPolicy Core.<$>
                   (o Core..:? "wifiRoamingSettings"))

instance Core.ToJSON WifiRoamingPolicy where
        toJSON WifiRoamingPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("wifiRoamingSettings" Core..=) Core.<$>
                    wifiRoamingSettings])
...
newWifiRoamingSetting 
    ::  WifiRoamingSetting
newWifiRoamingSetting =
  WifiRoamingSetting {wifiRoamingMode = Core.Nothing, wifiSsid = Core.Nothing}
...
newWifiSsidPolicy 
    ::  WifiSsidPolicy
newWifiSsidPolicy =
  WifiSsidPolicy {wifiSsidPolicyType = Core.Nothing, wifiSsids = Core.Nothing}
