              ...
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "authDomain") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "dispatchRules" Core..!= Core.mempty)
              ...
              (\ o ->
                 AuthorizedCertificate Core.<$>
                   (o Core..:? "certificateRawData") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "domainNames" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "expireTime")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "managedCertificate")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "visibleDomainMappings" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "BatchUpdateIngressRulesRequest"
              (\ o ->
                 BatchUpdateIngressRulesRequest Core.<$>
                   (o Core..:? "ingressRules" Core..!= Core.mempty))
          ...
          = Core.withObject "DomainMapping"
              (\ o ->
                 DomainMapping Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "resourceRecords" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 ListAuthorizedCertificatesResponse Core.<$>
                   (o Core..:? "certificates" Core..!= Core.mempty)
          ...
          = Core.withObject "ListAuthorizedDomainsResponse"
              (\ o ->
                 ListAuthorizedDomainsResponse Core.<$>
                   (o Core..:? "domains" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListDomainMappingsResponse"
              (\ o ->
                 ListDomainMappingsResponse Core.<$>
                   (o Core..:? "domainMappings" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListInstancesResponse"
              (\ o ->
                 ListInstancesResponse Core.<$>
                   (o Core..:? "instances" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON Network where
        parseJSON
          = Core.withObject "Network"
              (\ o ->
                 Network Core.<$>
                   (o Core..:? "forwardedPorts" Core..!= Core.mempty)
              ...
              (\ o ->
                 Version Core.<$>
                   (o Core..:? "apiConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "errorHandlers" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "handlers" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "healthCheck")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "inboundServices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "instanceClass")
                     Core.<*>
                     (o Core..:? "libraries" Core..!= Core.mempty)
