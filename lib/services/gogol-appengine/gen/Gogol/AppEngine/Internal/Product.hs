...
newListRuntimesResponse 
    ::  ListRuntimesResponse
newListRuntimesResponse =
  ListRuntimesResponse {nextPageToken = Core.Nothing, runtimes = Core.Nothing}
...
newResourceEvent =
  ResourceEvent
    {eventId = Core.Nothing, name = Core.Nothing, state = Core.Nothing}
...
instance Core.FromJSON ResourceEvent where
        parseJSON
          = Core.withObject "ResourceEvent"
              (\ o ->
                 ResourceEvent Core.<$>
                   (o Core..:? "eventId") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state"))
...
instance Core.ToJSON Runtime where
        toJSON Runtime{..}
          = Core.object
              (Core.catMaybes
                 [("decommissionedDate" Core..=) Core.<$>
                    decommissionedDate,
                  ("deprecationDate" Core..=) Core.<$> deprecationDate,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("endOfSupportDate" Core..=) Core.<$>
                    endOfSupportDate,
...
instance Core.FromJSON Service where
        parseJSON
          = Core.withObject "Service"
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "generatedCustomerMetadata") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
