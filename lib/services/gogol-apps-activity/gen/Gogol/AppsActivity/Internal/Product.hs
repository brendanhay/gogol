...
newActivity 
    ::  Activity
newActivity =
  Activity {combinedEvent = Core.Nothing, singleEvents = Core.Nothing}
...
instance Core.FromJSON Activity where
        parseJSON
          = Core.withObject "Activity"
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "combinedEvent") Core.<*>
                     (o Core..:? "singleEvents" Core..!= Core.mempty))
              ...
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "additionalEventTypes" Core..!=
                     ...
                     Core.<*> (o Core..:? "move")
                     Core.<*>
                     (o Core..:? "permissionChanges" Core..!= Core.mempty)
...
instance Core.ToJSON Event where
        toJSON Event{..}
          = Core.object
              (Core.catMaybes
                 [("additionalEventTypes" Core..=) Core.<$>
                    additionalEventTypes,
                  ("eventTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> eventTimeMillis,
                  ("fromUserDeletion" Core..=) Core.<$>
                    fromUserDeletion,
                  ("move" Core..=) Core.<$> move,
                  ("permissionChanges" Core..=) Core.<$>
                    permissionChanges,
                  ("primaryEventType" Core..=) Core.<$>
                    primaryEventType,
...
newParent 
    ::  Parent
newParent =
  Parent {id = Core.Nothing, isRoot = Core.Nothing, title = Core.Nothing}
...
newTarget 
    ::  Target
newTarget =
  Target {id = Core.Nothing, mimeType = Core.Nothing, name = Core.Nothing}
...
instance Core.FromJSON Target where
        parseJSON
          = Core.withObject "Target"
              (\ o ->
                 Target Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "mimeType")
                     Core.<*> (o Core..:? "name"))
...
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "isDeleted") Core.<*> (o Core..:? "isMe")
                     Core.<*> (o Core..:? "name")
