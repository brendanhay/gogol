...
instance Core.GoogleRequest CalendarCalendarListWatch
         where
        ...
        requestClient CalendarCalendarListWatch{..}
          = go maxResults minAccessRole pageToken showDeleted
              showHidden
              syncToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CalendarCalendarListWatchResource)
                      Core.mempty
