              ...
              (Core.catMaybes
                 [Core.Just
                  ...
                  ("originalStartTime" Core..=) Core.<$>
                    originalStartTime,
                  ("outOfOfficeProperties" Core..=) Core.<$>
...
newEventBirthdayProperties =
  EventBirthdayProperties
    {contact = Core.Nothing, customTypeName = Core.Nothing, type' = "birthday"}
...
newEventOutOfOfficeProperties =
  EventOutOfOfficeProperties
    {autoDeclineMode = Core.Nothing, declineMessage = Core.Nothing}

instance Core.FromJSON EventOutOfOfficeProperties
         where
        parseJSON
