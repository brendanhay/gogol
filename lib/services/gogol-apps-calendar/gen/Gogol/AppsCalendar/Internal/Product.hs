              ...
              (\ o ->
                 CalendarListEntry Core.<$>
                   (o Core..:? "accessRole") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "defaultReminders" Core..!= Core.mempty)
          ...
          = Core.withObject "ConferenceProperties"
              (\ o ->
                 ConferenceProperties Core.<$>
                   (o Core..:? "allowedConferenceSolutionTypes" Core..!=
                      Core.mempty))
              ...
              (\ o ->
                 EntryPoint Core.<$>
                   (o Core..:? "accessCode") Core.<*>
                     (o Core..:? "entryPointFeatures" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "anyoneCanAddSelf" Core..!= Core.False)
                     ...
                     Core.<*>
                     (o Core..:? "attendees" Core..!= Core.mempty)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "recurrence" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "updated")
                     Core.<*>
                     (o Core..:? "visibility" Core..!= "default"))
          ...
          = Core.withObject "FreeBusyCalendar"
              (\ o ->
                 FreeBusyCalendar Core.<$>
                   (o Core..:? "busy" Core..!= Core.mempty) Core.<*>
...
instance Core.FromJSON FreeBusyGroup where
        parseJSON
          = Core.withObject "FreeBusyGroup"
              (\ o ->
                 FreeBusyGroup Core.<$>
                   (o Core..:? "calendars" Core..!= Core.mempty)
