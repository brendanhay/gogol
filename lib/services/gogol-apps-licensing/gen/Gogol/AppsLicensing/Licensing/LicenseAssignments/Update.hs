                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text
                                 ...
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] LicenseAssignment
                                     Core.:>
...
instance Core.GoogleRequest
           LicensingLicenseAssignmentsUpdate
         where
        type Rs LicensingLicenseAssignmentsUpdate =
             LicenseAssignment
        type Scopes LicensingLicenseAssignmentsUpdate =
             '["https://www.googleapis.com/auth/apps.licensing"]
        requestClient LicensingLicenseAssignmentsUpdate{..}
          = go productId skuId userId xgafv accessToken
              callback
              uploadType
              uploadProtocol
