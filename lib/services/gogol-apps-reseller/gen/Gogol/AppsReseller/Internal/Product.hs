              ...
              (\ o ->
                 Address Core.<$>
                   (o Core..:? "addressLine1") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "customers#address")
              ...
              (\ o ->
                 Customer Core.<$>
                   (o Core..:? "alternateEmail") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "reseller#customer")
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateEmail" Core..=) Core.<$> alternateEmail,
                  ...
                  ("customerDomainVerified" Core..=) Core.<$>
...
newRenewalSettings =
  RenewalSettings
    {kind = "subscriptions#renewalSettings", renewalType = Core.Nothing}
...
newResellernotifyGetwatchdetailsResponse =
  ResellernotifyGetwatchdetailsResponse
    {serviceAccountEmailAddresses = Core.Nothing, topicName = Core.Nothing}
...
instance Core.FromJSON Seats where
        parseJSON
          = Core.withObject "Seats"
              (\ o ->
                 Seats Core.<$>
                   (o Core..:? "kind" Core..!= "subscriptions#seats")
...
instance Core.ToJSON Seats where
        toJSON Seats{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("licensedNumberOfSeats" Core..=) Core.<$>
                    licensedNumberOfSeats,
                  ("maximumNumberOfSeats" Core..=) Core.<$>
              ...
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "billingMethod") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "reseller#subscription")
                     Core.<*> (o Core..:? "plan")
                     Core.<*> (o Core..:? "purchaseOrderId")
...
instance Core.ToJSON Subscription_Plan where
        toJSON Subscription_Plan{..}
          = Core.object
              (Core.catMaybes
                 [("commitmentInterval" Core..=) Core.<$>
                    commitmentInterval,
                  ("isCommitmentPlan" Core..=) Core.<$>
                    isCommitmentPlan,
                  ("planName" Core..=) Core.<$> planName])
...
instance Core.FromJSON Subscription_TransferInfo
         where
        parseJSON
...
newSubscription_TrialSettings =
  Subscription_TrialSettings
    {isInTrial = Core.Nothing, trialEndTime = Core.Nothing}

instance Core.FromJSON Subscription_TrialSettings
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("isInTrial" Core..=) Core.<$> isInTrial,
                  ("trialEndTime" Core..=) Core.. Core.AsText Core.<$>
                    trialEndTime])
...
instance Core.FromJSON Subscriptions where
        parseJSON
          = Core.withObject "Subscriptions"
              (\ o ->
                 Subscriptions Core.<$>
                   (o Core..:? "kind" Core..!= "reseller#subscriptions")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "subscriptions" Core..!= Core.mempty))
