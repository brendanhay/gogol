              ...
              (\ o ->
                 ArimaCoefficients Core.<$>
                   (o Core..:? "autoRegressiveCoefficients" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "movingAverageCoefficients" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 ArimaForecastingMetrics Core.<$>
                   (o Core..:? "arimaFittingMetrics" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "nonSeasonalOrder" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "seasonalPeriods" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "timeSeriesId" Core..!= Core.mempty))
              ...
              (\ o ->
                 ArimaModelInfo Core.<$>
                   (o Core..:? "arimaCoefficients") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "timeSeriesIds" Core..!= Core.mempty))
...
instance Core.FromJSON ArimaResult where
        parseJSON
          = Core.withObject "ArimaResult"
              (\ o ->
                 ArimaResult Core.<$>
                   (o Core..:? "arimaModelInfo" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "seasonalPeriods" Core..!= Core.mempty))
...
newBiEngineStatistics =
  BiEngineStatistics
    {biEngineMode = "$(stats.bi_engine_mode)", biEngineReasons = Core.Nothing}
              ...
              (\ o ->
                 BiEngineStatistics Core.<$>
                   (o Core..:? "biEngineMode" Core..!=
                      "$(stats.bi_engine_mode)")
                     Core.<*>
                     (o Core..:? "biEngineReasons" Core..!= Core.mempty))
              ...
              (\ o ->
                 BigQueryModelTraining Core.<$>
                   (o Core..:? "currentIteration") Core.<*>
                     (o Core..:? "expectedTotalIterations"))
          ...
          = Core.withObject "BigtableOptions"
              (\ o ->
                 BigtableOptions Core.<$>
                   (o Core..:? "columnFamilies" Core..!= Core.mempty)
                     Core.<*>
              ...
              (\ o ->
                 BinaryClassificationMetrics Core.<$>
                   (o Core..:? "aggregateClassificationMetrics")
                     Core.<*>
                     (o Core..:? "binaryConfusionMatrixList" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "BqmlTrainingRun"
              (\ o ->
                 BqmlTrainingRun Core.<$>
                   (o Core..:? "iterationResults" Core..!= Core.mempty)
          ...
          = Core.withObject "CategoricalValue"
              (\ o ->
                 CategoricalValue Core.<$>
                   (o Core..:? "categoryCounts" Core..!= Core.mempty))
              ...
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "centroidId") Core.<*>
                     (o Core..:? "count")
                     Core.<*>
                     (o Core..:? "featureValues" Core..!= Core.mempty))
...
instance Core.FromJSON Dataset where
        parseJSON
          = Core.withObject "Dataset"
              (\ o ->
                 Dataset Core.<$>
                   (o Core..:? "access" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "creationTime")
...
newDataset_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Dataset_Labels
newDataset_Labels addtional = Dataset_Labels {addtional = addtional}
...
instance Core.ToJSON Dataset_Labels where
        toJSON Dataset_Labels{..} = Core.toJSON addtional
          ...
          = Core.withObject "DatasetAccessEntry"
              (\ o ->
                 DatasetAccessEntry Core.<$>
                   (o Core..:? "dataset") Core.<*>
                     (o Core..:? "targetTypes" Core..!= Core.mempty))
...
instance Core.FromJSON DatasetList where
        parseJSON
          = Core.withObject "DatasetList"
              (\ o ->
                 DatasetList Core.<$>
                   (o Core..:? "datasets" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "etag")
                     Core.<*>
...
newDatasetList_DatasetsItem_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> DatasetList_DatasetsItem_Labels
newDatasetList_DatasetsItem_Labels addtional =
  DatasetList_DatasetsItem_Labels {addtional = addtional}
...
newDestinationTableProperties_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> DestinationTableProperties_Labels
newDestinationTableProperties_Labels addtional =
  DestinationTableProperties_Labels {addtional = addtional}
...
instance Core.FromJSON DoubleCandidates where
        parseJSON
          = Core.withObject "DoubleCandidates"
              (\ o ->
                 DoubleCandidates Core.<$>
                   (o Core..:? "candidates" Core..!= Core.mempty))
              ...
              (\ o ->
                 ExplainQueryStage Core.<$>
                   (o Core..:? "completedParallelInputs") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "inputStages" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
          ...
          = Core.withObject "ExplainQueryStep"
              (\ o ->
                 ExplainQueryStep Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "substeps" Core..!= Core.mempty))
              ...
              (\ o ->
                 ExternalDataConfiguration Core.<$>
                   (o Core..:? "autodetect") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "decimalTargetTypes" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "sourceUris" Core..!= Core.mempty))
              ...
              (\ o ->
                 GlobalExplanation Core.<$>
                   (o Core..:? "classLabel") Core.<*>
                     (o Core..:? "explanations" Core..!= Core.mempty))
...
newJobConfiguration_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> JobConfiguration_Labels
newJobConfiguration_Labels addtional =
  JobConfiguration_Labels {addtional = addtional}
              ...
              (\ o ->
                 JobConfigurationExtract Core.<$>
                   (o Core..:? "compression") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "destinationUris" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fieldDelimiter")
                     Core.<*>
              ...
              (\ o ->
                 JobConfigurationLoad Core.<$>
                   (o Core..:? "allowJaggedRows") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "projectionFields" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "quote")
                     ...
                     Core.<*>
                     (o Core..:? "schemaUpdateOptions" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "skipLeadingRows")
                     Core.<*> (o Core..:? "sourceFormat")
                     Core.<*>
              ...
              (\ o ->
                 JobConfigurationQuery Core.<$>
                   (o Core..:? "allowLargeResults" Core..!= Core.False)
                     ...
                     Core.<*> (o Core..:? "query")
                     Core.<*>
                     (o Core..:? "queryParameters" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "rangePartitioning")
                     Core.<*>
                     (o Core..:? "schemaUpdateOptions" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "userDefinedFunctionResources" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "writeDisposition"))
...
newtype JobConfigurationQuery_TableDefinitions = JobConfigurationQuery_TableDefinitions
    {
      -- | 
      addtional :: (Core.HashMap Core.Text ExternalDataConfiguration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newJobConfigurationQuery_TableDefinitions 
    ::  Core.HashMap Core.Text ExternalDataConfiguration
       -- ^  See 'addtional'.
    -> JobConfigurationQuery_TableDefinitions
newJobConfigurationQuery_TableDefinitions addtional =
  JobConfigurationQuery_TableDefinitions {addtional = addtional}
              ...
              (\ o ->
                 JobConfigurationTableCopy Core.<$>
                   (o Core..:? "createDisposition") Core.<*>
                     ...
                     Core.<*> (o Core..:? "sourceTable")
                     Core.<*>
                     (o Core..:? "sourceTables" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "writeDisposition"))
              ...
              (\ o ->
                 JobStatistics Core.<$>
                   (o Core..:? "completionRatio") Core.<*>
                     ...
                     Core.<*> (o Core..:? "query")
                     Core.<*>
                     (o Core..:? "quotaDeferments" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "reservationUsage" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 JobStatistics_ReservationUsageItem Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "slotMs"))
              ...
              (\ o ->
                 JobStatistics2 Core.<$>
                   (o Core..:? "biEngineStatistics") Core.<*>
                     ...
                     Core.<*> (o Core..:? "numDmlAffectedRows")
                     Core.<*>
                     (o Core..:? "queryPlan" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "referencedRoutines" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "referencedTables" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "reservationUsage" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "schema")
                     ...
                     Core.<*> (o Core..:? "totalSlotMs")
                     Core.<*>
                     (o Core..:? "undeclaredQueryParameters" Core..!=
                        Core.mempty))
...
newJsonObject 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  See 'addtional'.
    -> JsonObject
newJsonObject addtional = JsonObject {addtional = addtional}
...
instance Core.ToJSON JsonObject where
        toJSON JsonObject{..} = Core.toJSON addtional
          ...
          = Core.withObject "ListModelsResponse"
              (\ o ->
                 ListModelsResponse Core.<$>
                   (o Core..:? "models" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 ListRoutinesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "routines" Core..!= Core.mempty))
              ...
              (\ o ->
                 Model Core.<$>
                   (o Core..:? "bestTrialId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "featureColumns" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "friendlyName")
                     Core.<*> (o Core..:? "hparamSearchSpaces")
                     Core.<*>
                     (o Core..:? "hparamTrials" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "labelColumns" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "lastModifiedTime")
                     Core.<*> (o Core..:? "location")
                     ...
                     Core.<*>
                     (o Core..:? "optimalTrialIds" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "trainingRuns" Core..!= Core.mempty))
...
newModel_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Model_Labels
newModel_Labels addtional = Model_Labels {addtional = addtional}
...
instance Core.ToJSON Model_Labels where
        toJSON Model_Labels{..} = Core.toJSON addtional
          ...
          = Core.withObject "ModelDefinition_ModelOptions"
              (\ o ->
                 ModelDefinition_ModelOptions Core.<$>
                   (o Core..:? "labels" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "lossType")
                     Core.<*> (o Core..:? "modelType"))
          ...
          = Core.withObject "MultiClassClassificationMetrics"
              (\ o ->
                 MultiClassClassificationMetrics Core.<$>
                   (o Core..:? "aggregateClassificationMetrics")
                     Core.<*>
                     (o Core..:? "confusionMatrixList" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 QueryParameterType Core.<$>
                   (o Core..:? "arrayType") Core.<*>
                     (o Core..:? "structTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.withObject "QueryParameterValue"
              (\ o ->
                 QueryParameterValue Core.<$>
                   (o Core..:? "arrayValues" Core..!= Core.mempty)
...
newtype QueryParameterValue_StructValues = QueryParameterValue_StructValues
    {
      -- | 
      addtional :: (Core.HashMap Core.Text QueryParameterValue)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newQueryParameterValue_StructValues 
    ::  Core.HashMap Core.Text QueryParameterValue
       -- ^  See 'addtional'.
    -> QueryParameterValue_StructValues
newQueryParameterValue_StructValues addtional =
  QueryParameterValue_StructValues {addtional = addtional}
...
newQueryRequest_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> QueryRequest_Labels
newQueryRequest_Labels addtional = QueryRequest_Labels {addtional = addtional}
...
instance Core.FromJSON Routine where
        parseJSON
          = Core.withObject "Routine"
              (\ o ->
                 Routine Core.<$>
                   (o Core..:? "arguments" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "importedLibraries" Core..!= Core.mempty)
              ...
              (\ o ->
                 ScriptStatistics Core.<$>
                   (o Core..:? "evaluationKind") Core.<*>
                     (o Core..:? "stackFrames" Core..!= Core.mempty))
...
instance Core.FromJSON StandardSqlTableType where
        parseJSON
          = Core.withObject "StandardSqlTableType"
              (\ o ->
                 StandardSqlTableType Core.<$>
                   (o Core..:? "columns" Core..!= Core.mempty))
...
newTable_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Table_Labels
newTable_Labels addtional = Table_Labels {addtional = addtional}
...
instance Core.ToJSON Table_Labels where
        toJSON Table_Labels{..} = Core.toJSON addtional
          ...
          = Core.withObject "TableDataInsertAllResponse"
              (\ o ->
                 TableDataInsertAllResponse Core.<$>
                   (o Core..:? "insertErrors" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
newTableList_TablesItem_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> TableList_TablesItem_Labels
newTableList_TablesItem_Labels addtional =
  TableList_TablesItem_Labels {addtional = addtional}
              ...
              (\ o ->
                 TrainingOptions Core.<$>
                   (o Core..:? "adjustStepChanges") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "hiddenUnits" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "holidayRegion")
                     Core.<*> (o Core..:? "horizon")
                     Core.<*>
                     (o Core..:? "hparamTuningObjectives" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "includeDrift")
                     Core.<*> (o Core..:? "initialLearnRate")
                     Core.<*>
                     (o Core..:? "inputLabelColumns" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "timeSeriesIdColumns" Core..!=
                        Core.mempty)
...
newtype TrainingOptions_LabelClassWeights = TrainingOptions_LabelClassWeights
    {
      -- | 
      addtional :: (Core.HashMap Core.Text Core.Double)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newTrainingOptions_LabelClassWeights 
    ::  Core.HashMap Core.Text Core.Double
       -- ^  See 'addtional'.
    -> TrainingOptions_LabelClassWeights
newTrainingOptions_LabelClassWeights addtional =
  TrainingOptions_LabelClassWeights {addtional = addtional}
