                       ...
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "formatOptions.useInt64Timestamp"
                               Core.Bool
                               Core.:>
                               Core.QueryParam "maxResults" Core.Word32 Core.:>
                                 Core.QueryParam "pageToken" Core.Text Core.:>
                                   Core.QueryParam "selectedFields" Core.Text
                                     Core.:>
                                     Core.QueryParam "startIndex" Core.Word64
                                       Core.:>
...
instance Core.GoogleRequest BigQueryTabledataList
         where
