          ...
          = Core.withObject "EnrollDataSourcesRequest"
              (\ o ->
                 EnrollDataSourcesRequest Core.<$>
                   (o Core..:? "dataSourceIds" Core..!= Core.mempty))
              ...
              (\ o ->
                 ListTransferConfigsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "transferConfigs" Core..!= Core.mempty))
          ...
          = Core.withObject "ListTransferLogsResponse"
              (\ o ->
                 ListTransferLogsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "transferMessages" Core..!= Core.mempty))
          ...
          = Core.withObject "ListTransferRunsResponse"
              (\ o ->
                 ListTransferRunsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "transferRuns" Core..!= Core.mempty))
...
newTransferConfig_Params 
    ...
    -> TransferConfig_Params
newTransferConfig_Params addtional =
  TransferConfig_Params {addtional = addtional}
...
newTransferRun_Params 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'addtional'.
    -> TransferRun_Params
newTransferRun_Params addtional = TransferRun_Params {addtional = addtional}
...
instance Core.ToJSON TransferRun_Params where
        toJSON TransferRun_Params{..} = Core.toJSON addtional
