...
newScheduleOptionsV2 =
  ScheduleOptionsV2
    { eventDrivenSchedule = Core.Nothing
    , manualSchedule = Core.Nothing
    , timeBasedSchedule = Core.Nothing
    }
...
instance Core.ToJSON ScheduleOptionsV2 where
        toJSON ScheduleOptionsV2{..}
          = Core.object
              (Core.catMaybes
                 [("eventDrivenSchedule" Core..=) Core.<$>
                    eventDrivenSchedule,
                  ("manualSchedule" Core..=) Core.<$> manualSchedule,
                  ("timeBasedSchedule" Core..=) Core.<$>
                    timeBasedSchedule])
...
newTimeBasedSchedule =
  TimeBasedSchedule
    {endTime = Core.Nothing, schedule = Core.Nothing, startTime = Core.Nothing}
...
newTransferConfig =
  TransferConfig
    ...
    , scheduleOptionsV2 = Core.Nothing
    , state = Core.Nothing
...
instance Core.FromJSON UnenrollDataSourcesRequest
         where
        parseJSON
          = Core.withObject "UnenrollDataSourcesRequest"
              (\ o ->
                 UnenrollDataSourcesRequest Core.<$>
                   (o Core..:? "dataSourceIds"))
