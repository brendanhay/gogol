...
type BigQueryDataTransferProjectsTransferConfigsRunsListResource =
  "v1"
    ...
    Core.:> Core.QueryParams "states" ProjectsTransferConfigsRunsListStates
...
instance
  ...
  where
  type
    Rs BigQueryDataTransferProjectsTransferConfigsRunsList =
      ListTransferRunsResponse
  type
    Scopes BigQueryDataTransferProjectsTransferConfigsRunsList =
