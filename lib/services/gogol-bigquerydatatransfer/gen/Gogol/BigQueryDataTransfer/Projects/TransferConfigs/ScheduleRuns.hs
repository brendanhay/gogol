...
type BigQueryDataTransferProjectsTransferConfigsScheduleRunsResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "scheduleRuns" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ScheduleTransferRunsRequest
                       Core.:>
...
newBigQueryDataTransferProjectsTransferConfigsScheduleRuns 
    ...
    -> BigQueryDataTransferProjectsTransferConfigsScheduleRuns
newBigQueryDataTransferProjectsTransferConfigsScheduleRuns parent payload =
  BigQueryDataTransferProjectsTransferConfigsScheduleRuns
    { xgafv = Core.Nothing
