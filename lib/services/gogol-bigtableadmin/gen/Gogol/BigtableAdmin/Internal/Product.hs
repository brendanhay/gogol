...
instance Core.FromJSON AppProfile where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AppProfile
            Core.<$> (o Core..:? "dataBoostIsolationReadOnly")
    ...
    Core.object
      ( Core.catMaybes
          [ ("dataBoostIsolationReadOnly" Core..=)
              Core.<$> dataBoostIsolationReadOnly,
    ...
    Core.withObject
      ...
      ( \o ->
          CheckConsistencyRequest
            ...
            Core.<*> (o Core..:? "dataBoostReadLocalWrites")
    ...
    Core.object
      ( Core.catMaybes
          [ ("consistencyToken" Core..=) Core.<$> consistencyToken,
            ("dataBoostReadLocalWrites" Core..=)
              Core.<$> dataBoostReadLocalWrites,
            ("standardReadRemoteWrites" Core..=)
              Core.<$> standardReadRemoteWrites
          ]
      )
    ...
    Core.withObject
      ...
      ( \o ->
          ColumnFamilyStats
            ...
            Core.<*> (o Core..:? "logicalDataBytes" Core.<&> Core.fmap Core.fromAsText)
      )
...
instance Core.FromJSON CreateAuthorizedViewRequest where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          CreateAuthorizedViewRequest
            Core.<$> (o Core..:? "authorizedView")
            Core.<*> (o Core..:? "authorizedViewId")
            Core.<*> (o Core..:? "parent")
      )
...
instance Core.FromJSON DataBoostIsolationReadOnly where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          DataBoostIsolationReadOnly
            Core.<$> (o Core..:? "computeBillingOwner")
      )
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleBigtableAdminV2AuthorizedViewFamilySubsets
            Core.<$> (o Core..:? "qualifierPrefixes")
            Core.<*> (o Core..:? "qualifiers")
      )
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleBigtableAdminV2AuthorizedViewSubsetView
            Core.<$> (o Core..:? "familySubsets")
            Core.<*> (o Core..:? "rowPrefixes")
      )

instance Core.ToJSON GoogleBigtableAdminV2AuthorizedViewSubsetView where
...
newGoogleBigtableAdminV2TypeStringEncoding =
  GoogleBigtableAdminV2TypeStringEncoding
    { utf8Bytes = Core.Nothing,
      utf8Raw = Core.Nothing
    }

instance Core.FromJSON GoogleBigtableAdminV2TypeStringEncoding where
  parseJSON =
    Core.withObject
      "GoogleBigtableAdminV2TypeStringEncoding"
      ( \o ->
          GoogleBigtableAdminV2TypeStringEncoding
            Core.<$> (o Core..:? "utf8Bytes")
            Core.<*> (o Core..:? "utf8Raw")
      )
...
instance Core.ToJSON GoogleBigtableAdminV2TypeStringEncodingUtf8Raw where
  toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON Table where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          Table
            Core.<$> (o Core..:? "automatedBackupPolicy")
            Core.<*> (o Core..:? "changeStreamConfig")
