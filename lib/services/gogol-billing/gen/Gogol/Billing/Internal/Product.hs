...
instance Core.FromJSON GeoTaxonomy where
        parseJSON
          = Core.withObject "GeoTaxonomy"
              (\ o ->
                 GeoTaxonomy Core.<$>
                   (o Core..:? "regions" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.withObject "ListBillingAccountsResponse"
              (\ o ->
                 ListBillingAccountsResponse Core.<$>
                   (o Core..:? "billingAccounts" Core..!= Core.mempty)
              ...
              (\ o ->
                 ListProjectBillingInfoResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "projectBillingInfo" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 PricingExpression Core.<$>
                   (o Core..:? "baseUnit") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "tieredRates" Core..!= Core.mempty)
              ...
              (\ o ->
                 Sku Core.<$>
                   (o Core..:? "category") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "pricingInfo" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "serviceProviderName")
                     Core.<*>
                     (o Core..:? "serviceRegions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "skuId"))
