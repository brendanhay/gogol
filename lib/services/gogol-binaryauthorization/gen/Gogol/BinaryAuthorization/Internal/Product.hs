    ...
    Core.object
      ( Core.catMaybes
          [ ("enforcementMode" Core..=)
            ...
            ("requireAttestationsBy" Core..=)
              Core.<$> requireAttestationsBy
          ]
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("admissionWhitelistPatterns" Core..=)
            ...
            ("clusterAdmissionRules" Core..=)
              Core.<$> clusterAdmissionRules,
            ("defaultAdmissionRule" Core..=)
              Core.<$> defaultAdmissionRule,
            ("description" Core..=) Core.<$> description,
            ("etag" Core..=) Core.<$> etag,
    ...
    Core.object
      ( Core.catMaybes
          [ ("attestation" Core..=) Core.<$> attestation,
            ...
            ("occurrenceResourceUri" Core..=)
              Core.<$> occurrenceResourceUri
          ]
      )
