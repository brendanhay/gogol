...
instance Core.FromJSON AttestationSource where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AttestationSource
            Core.<$> (o Core..:? "containerAnalysisAttestationProjects")
      )
...
instance Core.FromJSON AttestorPublicKey where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AttestorPublicKey
            Core.<$> (o Core..:? "asciiArmoredPgpPublicKey")
            Core.<*> (o Core..:? "comment")
            Core.<*> (o Core..:? "id")
...
instance Core.ToJSON AttestorPublicKey where
  toJSON AttestorPublicKey {..} =
    Core.object
      ( Core.catMaybes
          [ ("asciiArmoredPgpPublicKey" Core..=)
              Core.<$> asciiArmoredPgpPublicKey,
      ...
      ( Core.catMaybes
          [ ("alwaysDeny" Core..=) Core.<$> alwaysDeny,
            ...
            ("simpleSigningAttestationCheck" Core..=)
              Core.<$> simpleSigningAttestationCheck,
    ...
    Core.object
      ( Core.catMaybes
          [ ("imageResults" Core..=) Core.<$> imageResults,
            ...
            ("kubernetesServiceAccount" Core..=)
              Core.<$> kubernetesServiceAccount,
...
instance Core.ToJSON Policy where
  toJSON Policy {..} =
    Core.object
      ( Core.catMaybes
          [ ("admissionWhitelistPatterns" Core..=)
              Core.<$> admissionWhitelistPatterns,
            ("clusterAdmissionRules" Core..=) Core.<$> clusterAdmissionRules,
            ("defaultAdmissionRule" Core..=) Core.<$> defaultAdmissionRule,
            ("description" Core..=) Core.<$> description,
            ("etag" Core..=) Core.<$> etag,
            ("globalPolicyEvaluationMode" Core..=)
              Core.<$> globalPolicyEvaluationMode,
...
instance Core.FromJSON Policy_IstioServiceIdentityAdmissionRules where
  parseJSON =
    Core.withObject
      "Policy_IstioServiceIdentityAdmissionRules"
      ( \o ->
...
instance Core.ToJSON Policy_IstioServiceIdentityAdmissionRules where
...
instance Core.FromJSON Policy_KubernetesNamespaceAdmissionRules where
  parseJSON =
    Core.withObject
      "Policy_KubernetesNamespaceAdmissionRules"
      ( \o ->
...
instance Core.ToJSON Policy_KubernetesServiceAccountAdmissionRules where
...
instance Core.FromJSON SimpleSigningAttestationCheck where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          SimpleSigningAttestationCheck
            Core.<$> (o Core..:? "attestationAuthenticators")
            Core.<*> (o Core..:? "containerAnalysisAttestationProjects")
      )
...
instance Core.ToJSON SimpleSigningAttestationCheck where
  toJSON SimpleSigningAttestationCheck {..} =
    Core.object
      ( Core.catMaybes
          [ ("attestationAuthenticators" Core..=)
              Core.<$> attestationAuthenticators,
            ("containerAnalysisAttestationProjects" Core..=)
              Core.<$> containerAnalysisAttestationProjects
          ]
      )
...
instance Core.ToJSON UserOwnedGrafeasNote where
  toJSON UserOwnedGrafeasNote {..} =
    Core.object
      ( Core.catMaybes
          [ ("delegationServiceAccountEmail" Core..=)
              Core.<$> delegationServiceAccountEmail,
...
instance Core.FromJSON VerificationRule where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          VerificationRule
            Core.<$> (o Core..:? "attestationSource")
            Core.<*> (o Core..:? "configBasedBuildRequired")
    ...
    Core.object
      ( Core.catMaybes
          [ ("attestationSource" Core..=) Core.<$> attestationSource,
            ("configBasedBuildRequired" Core..=)
              Core.<$> configBasedBuildRequired,
            ("trustedBuilder" Core..=) Core.<$> trustedBuilder,
            ("trustedSourceRepoPatterns" Core..=)
              Core.<$> trustedSourceRepoPatterns
          ]
      )
...
instance Core.FromJSON VulnerabilityCheck where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          VulnerabilityCheck
            Core.<$> (o Core..:? "allowedCves")
            Core.<*> (o Core..:? "blockedCves")
    ...
    Core.object
      ( Core.catMaybes
          [ ("allowedCves" Core..=) Core.<$> allowedCves,
            ...
            ("maximumUnfixableSeverity" Core..=)
              Core.<$> maximumUnfixableSeverity
          ]
      )
