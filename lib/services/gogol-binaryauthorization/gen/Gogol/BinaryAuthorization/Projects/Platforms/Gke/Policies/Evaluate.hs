...
type BinaryAuthorizationProjectsPlatformsGkePoliciesEvaluateResource =
  "v1"
    Core.:> Core.CaptureMode "name" "evaluate" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] EvaluateGkePolicyRequest
    Core.:> Core.Post '[Core.JSON] EvaluateGkePolicyResponse
...
instance
  ...
  where
  type
    Rs BinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate =
      EvaluateGkePolicyResponse
  type
    Scopes BinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate =
