...
newBlog_Locale =
  Blog_Locale
    {country = Core.Nothing, language = Core.Nothing, variant = Core.Nothing}
...
newBlog_Posts =
  Blog_Posts
    {items = Core.Nothing, selfLink = Core.Nothing, totalItems = Core.Nothing}
...
instance Core.FromJSON Blog_Posts where
        parseJSON
          = Core.withObject "Blog_Posts"
              (\ o ->
                 Blog_Posts Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "selfLink")
...
newBlogList =
  BlogList
    {blogUserInfos = Core.Nothing, items = Core.Nothing, kind = Core.Nothing}
...
newBlogUserInfo =
  BlogUserInfo
    {blog = Core.Nothing, blogUserInfo = Core.Nothing, kind = Core.Nothing}
...
instance Core.FromJSON Comment where
        parseJSON
          = Core.withObject "Comment"
              (\ o ->
                 Comment Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "blog")
                     Core.<*> (o Core..:? "content")
                     Core.<*> (o Core..:? "id")
...
instance Core.FromJSON Pageviews where
        parseJSON
          = Core.withObject "Pageviews"
              (\ o ->
                 Pageviews Core.<$>
                   (o Core..:? "blogId") Core.<*> (o Core..:? "counts")
                     Core.<*> (o Core..:? "kind"))
        ...
        toJSON Post_Replies{..}
          = Core.object
              (Core.catMaybes
                 [("items" Core..=) Core.<$> items,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("totalItems" Core..=) Core.. Core.AsText Core.<$>
                    totalItems])
...
newPostUserInfo =
  PostUserInfo
    {kind = Core.Nothing, post = Core.Nothing, postUserInfo = Core.Nothing}
...
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "about") Core.<*> (o Core..:? "blogs")
                     Core.<*> (o Core..:? "created")
