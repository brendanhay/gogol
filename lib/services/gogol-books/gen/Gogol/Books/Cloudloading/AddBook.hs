                     ...
                     Core.QueryParam "mime_type" Core.Text Core.:>
                       Core.QueryParam "name" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_client_token" Core.Text
                             Core.:>
...
instance Core.GoogleRequest BooksCloudloadingAddBook
         where
        type Rs BooksCloudloadingAddBook =
             BooksCloudloadingResource
        type Scopes BooksCloudloadingAddBook =
             '["https://www.googleapis.com/auth/books"]
        requestClient BooksCloudloadingAddBook{..}
          = go xgafv accessToken callback driveDocumentId
              mimeType
              name
              uploadType
              uploadClientToken
