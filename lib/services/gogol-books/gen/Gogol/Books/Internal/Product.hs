...
instance Core.ToJSON Annotation where
        toJSON Annotation{..}
          = Core.object
              (Core.catMaybes
                 [("afterSelectedText" Core..=) Core.<$>
                    afterSelectedText,
                  ("beforeSelectedText" Core..=) Core.<$>
                    beforeSelectedText,
                  ("clientVersionRanges" Core..=) Core.<$>
                    clientVersionRanges,
                  ("created" Core..=) Core.<$> created,
                  ("currentVersionRanges" Core..=) Core.<$>
...
instance Core.ToJSON Annotation_CurrentVersionRanges
         where
...
instance Core.ToJSON Annotation_LayerSummary where
        toJSON Annotation_LayerSummary{..}
          = Core.object
              (Core.catMaybes
                 [("allowedCharacterCount" Core..=) Core.<$>
          ...
          = Core.withObject "AnnotationsSummary"
              (\ o ->
                 AnnotationsSummary Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "layers" Core..!= Core.mempty))
...
instance Core.FromJSON AnnotationsSummary_LayersItem
         where
        parseJSON
...
instance Core.ToJSON AnnotationsSummary_LayersItem
         where
...
instance Core.FromJSON BooksCloudloadingResource
         where
        parseJSON
...
newBooksVolumesRecommendedRateResponse 
    ::  BooksVolumesRecommendedRateResponse
newBooksVolumesRecommendedRateResponse =
  BooksVolumesRecommendedRateResponse {consistencyToken = Core.Nothing}
...
instance Core.FromJSON Bookshelf where
        parseJSON
          = Core.withObject "Bookshelf"
              (\ o ->
                 Bookshelf Core.<$>
                   (o Core..:? "access") Core.<*> (o Core..:? "created")
...
newBookshelves 
    ::  Bookshelves
newBookshelves = Bookshelves {items = Core.Nothing, kind = Core.Nothing}
...
newCategory_ItemsItem =
  Category_ItemsItem
    {badgeUrl = Core.Nothing, categoryId = Core.Nothing, name = Core.Nothing}
...
instance Core.FromJSON ConcurrentAccessRestriction
         where
        parseJSON
...
instance Core.ToJSON ConcurrentAccessRestriction
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("deviceAllowed" Core..=) Core.<$> deviceAllowed,
                  ("kind" Core..=) Core.<$> kind,
                  ("maxConcurrentDevices" Core..=) Core.<$>
...
newDictlayerdata =
  Dictlayerdata
    {common = Core.Nothing, dict = Core.Nothing, kind = Core.Nothing}
...
instance Core.FromJSON Dictlayerdata where
        parseJSON
          = Core.withObject "Dictlayerdata"
              (\ o ->
                 Dictlayerdata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "dict")
                     Core.<*> (o Core..:? "kind"))
...
newDictlayerdata_Common 
    ::  Dictlayerdata_Common
newDictlayerdata_Common = Dictlayerdata_Common {title = Core.Nothing}

instance Core.FromJSON Dictlayerdata_Common where
        parseJSON
          = Core.withObject "Dictlayerdata_Common"
              (\ o ->
                 Dictlayerdata_Common Core.<$> (o Core..:? "title"))
...
newDictlayerdata_Dict_Source 
    ::  Dictlayerdata_Dict_Source
newDictlayerdata_Dict_Source =
  Dictlayerdata_Dict_Source {attribution = Core.Nothing, url = Core.Nothing}

instance Core.FromJSON Dictlayerdata_Dict_Source
         where
        parseJSON
...
newDictlayerdata_Dict_WordsItem_DerivativesItem =
  Dictlayerdata_Dict_WordsItem_DerivativesItem
    {source = Core.Nothing, text = Core.Nothing}
...
newDictlayerdata_Dict_WordsItem_DerivativesItem_Source =
  Dictlayerdata_Dict_WordsItem_DerivativesItem_Source
    {attribution = Core.Nothing, url = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem Core.<$>
                   (o Core..:? "conjugations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "definitions" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "synonyms" Core..!= Core.mempty))
...
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem =
  Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem
    {definition = Core.Nothing, examples = Core.Nothing}
              ...
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem
                   ...
                   (o Core..:? "definition") Core.<*>
                     (o Core..:? "examples" Core..!= Core.mempty))
...
newDiscoveryclusters =
  Discoveryclusters
    {clusters = Core.Nothing, kind = Core.Nothing, totalClusters = Core.Nothing}
          ...
          = Core.withObject "Discoveryclusters"
              (\ o ->
                 Discoveryclusters Core.<$>
                   (o Core..:? "clusters" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind")
...
newDiscoveryclusters_ClustersItem =
  Discoveryclusters_ClustersItem
    { bannerWithContentContainer = Core.Nothing
...
instance Core.FromJSON Discoveryclusters_ClustersItem
         where
        parseJSON
...
instance Core.ToJSON Discoveryclusters_ClustersItem
         where
...
instance Core.FromJSON DownloadAccessRestriction
         where
        parseJSON
...
instance Core.ToJSON DownloadAccessRestriction where
        toJSON DownloadAccessRestriction{..}
          = Core.object
              (Core.catMaybes
                 [("deviceAllowed" Core..=) Core.<$> deviceAllowed,
                  ("downloadsAcquired" Core..=) Core.<$>
                    downloadsAcquired,
                  ("justAcquired" Core..=) Core.<$> justAcquired,
                  ("kind" Core..=) Core.<$> kind,
                  ("maxDownloadDevices" Core..=) Core.<$>
                    maxDownloadDevices,
                  ("message" Core..=) Core.<$> message,
                  ("nonce" Core..=) Core.<$> nonce,
                  ("reasonCode" Core..=) Core.<$> reasonCode,
...
newDownloadAccesses 
    ::  DownloadAccesses
newDownloadAccesses =
  DownloadAccesses {downloadAccessList = Core.Nothing, kind = Core.Nothing}
          ...
          = Core.withObject "DownloadAccesses"
              (\ o ->
                 DownloadAccesses Core.<$>
                   (o Core..:? "downloadAccessList" Core..!=
                      Core.mempty)
                     Core.<*> (o Core..:? "kind"))
...
newFamilyInfo 
    ::  FamilyInfo
newFamilyInfo = FamilyInfo {kind = Core.Nothing, membership = Core.Nothing}
...
instance Core.ToJSON FamilyInfo_Membership where
        toJSON FamilyInfo_Membership{..}
          = Core.object
              (Core.catMaybes
                 [("acquirePermission" Core..=) Core.<$>
                    acquirePermission,
                  ("ageGroup" Core..=) Core.<$> ageGroup,
                  ("allowedMaturityRating" Core..=) Core.<$>
...
newGeolayerdata 
    ::  Geolayerdata
newGeolayerdata =
  Geolayerdata {common = Core.Nothing, geo = Core.Nothing, kind = Core.Nothing}
          ...
          = Core.withObject "Geolayerdata_Geo"
              (\ o ->
                 Geolayerdata_Geo Core.<$>
                   (o Core..:? "boundary" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "cachePolicy")
...
instance Core.FromJSON Geolayerdata_Geo_Viewport
         where
        parseJSON
...
instance Core.FromJSON Geolayerdata_Geo_Viewport_Hi
         where
        parseJSON
...
instance Core.ToJSON Geolayerdata_Geo_Viewport_Hi
         where
...
instance Core.FromJSON Geolayerdata_Geo_Viewport_Lo
         where
        parseJSON
...
instance Core.ToJSON Geolayerdata_Geo_Viewport_Lo
         where
...
newLayersummaries =
  Layersummaries
    {items = Core.Nothing, kind = Core.Nothing, totalItems = Core.Nothing}
              ...
              (\ o ->
                 Layersummary Core.<$>
                   (o Core..:? "annotationCount") Core.<*>
                     (o Core..:? "annotationTypes" Core..!= Core.mempty)
...
instance Core.ToJSON Layersummary where
        toJSON Layersummary{..}
          = Core.object
              (Core.catMaybes
                 [("annotationCount" Core..=) Core.<$>
                    annotationCount,
                  ("annotationTypes" Core..=) Core.<$> annotationTypes,
                  ("annotationsDataLink" Core..=) Core.<$>
                    annotationsDataLink,
          ...
          = Core.withObject "Metadata_ItemsItem"
              (\ o ->
                 Metadata_ItemsItem Core.<$>
                   (o Core..:? "download_url") Core.<*>
                     (o Core..:? "encrypted_key")
        ...
        parseJSON
          = Core.withObject "Notification"
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "body") Core.<*>
                     (o Core..:? "crmExperimentIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "doc_id")
                     ...
                     Core.<*> (o Core..:? "reason")
                     Core.<*>
                     (o Core..:? "show_notification_settings_action")
...
instance Core.ToJSON Notification where
        toJSON Notification{..}
          = Core.object
              (Core.catMaybes
                 [("body" Core..=) Core.<$> body,
                  ("crmExperimentIds" Core..=) Core.<$>
                    crmExperimentIds,
                  ("doc_id" Core..=) Core.<$> docId,
                  ("doc_type" Core..=) Core.<$> docType,
                  ("dont_show_notification" Core..=) Core.<$>
                    dontShowNotification,
                  ("iconUrl" Core..=) Core.<$> iconUrl,
                  ("is_document_mature" Core..=) Core.<$>
                    isDocumentMature,
                  ("kind" Core..=) Core.<$> kind,
                  ("notificationGroup" Core..=) Core.<$>
                    notificationGroup,
                  ("notification_type" Core..=) Core.<$>
                    notificationType,
                  ...
                  ("timeToExpireMs" Core..=) Core.. Core.AsText
                    Core.<$> timeToExpireMs,
                  ("title" Core..=) Core.<$> title])
...
instance Core.FromJSON Offers_ItemsItem_ItemsItem
         where
        parseJSON
...
instance Core.FromJSON Review where
        parseJSON
          = Core.withObject "Review"
              (\ o ->
                 Review Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "content")
                     Core.<*> (o Core..:? "date")
...
instance Core.FromJSON Review_Author where
        parseJSON
          = Core.withObject "Review_Author"
              (\ o ->
                 Review_Author Core.<$> (o Core..:? "displayName"))
        ...
        parseJSON
          = Core.withObject "Series"
              (\ o ->
                 Series Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "series" Core..!= Core.mempty))
...
newSeriesmembership =
  Seriesmembership
    {kind = Core.Nothing, member = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.withObject "Seriesmembership"
              (\ o ->
                 Seriesmembership Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "member" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
...
newUsersettings_NotesExport 
    ::  Usersettings_NotesExport
newUsersettings_NotesExport =
  Usersettings_NotesExport {folderName = Core.Nothing, isEnabled = Core.Nothing}
...
instance Core.FromJSON Usersettings_Notification
         where
        parseJSON
...
newUsersettings_Notification_MatchMyInterests 
    ::  Usersettings_Notification_MatchMyInterests
newUsersettings_Notification_MatchMyInterests =
  Usersettings_Notification_MatchMyInterests {optedState = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON Usersettings_Notification_MatchMyInterests{..}
          = Core.object
              (Core.catMaybes
                 [("opted_state" Core..=) Core.<$> optedState])
...
newUsersettings_Notification_MoreFromAuthors 
    ::  Usersettings_Notification_MoreFromAuthors
newUsersettings_Notification_MoreFromAuthors =
  Usersettings_Notification_MoreFromAuthors {optedState = Core.Nothing}
...
newUsersettings_Notification_MoreFromSeries 
    ::  Usersettings_Notification_MoreFromSeries
newUsersettings_Notification_MoreFromSeries =
  Usersettings_Notification_MoreFromSeries {optedState = Core.Nothing}
...
newUsersettings_Notification_RewardExpirations 
    ::  Usersettings_Notification_RewardExpirations
newUsersettings_Notification_RewardExpirations =
  Usersettings_Notification_RewardExpirations {optedState = Core.Nothing}
              ...
              (\ o ->
                 Volume_AccessInfo Core.<$>
                   (o Core..:? "accessViewStatus") Core.<*>
                     ...
                     Core.<*> (o Core..:? "epub")
                     Core.<*>
                     (o Core..:? "explicitOfflineLicenseManagement")
                     Core.<*> (o Core..:? "pdf")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessViewStatus" Core..=) Core.<$>
                  ...
                  ("quoteSharingAllowed" Core..=) Core.<$>
                    quoteSharingAllowed,
                  ("textToSpeechPermission" Core..=) Core.<$>
...
newVolume_LayerInfo_LayersItem =
  Volume_LayerInfo_LayersItem
    {layerId = Core.Nothing, volumeAnnotationsVersion = Core.Nothing}

instance Core.FromJSON Volume_LayerInfo_LayersItem
         where
        parseJSON
...
instance Core.ToJSON Volume_LayerInfo_LayersItem
         where
...
newVolume_RecommendedInfo 
    ::  Volume_RecommendedInfo
newVolume_RecommendedInfo = Volume_RecommendedInfo {explanation = Core.Nothing}

instance Core.FromJSON Volume_RecommendedInfo where
        parseJSON
          = Core.withObject "Volume_RecommendedInfo"
              (\ o ->
                 Volume_RecommendedInfo Core.<$>
                   (o Core..:? "explanation"))
...
newVolume_SaleInfo_ListPrice 
    ::  Volume_SaleInfo_ListPrice
newVolume_SaleInfo_ListPrice =
  Volume_SaleInfo_ListPrice {amount = Core.Nothing, currencyCode = Core.Nothing}

instance Core.FromJSON Volume_SaleInfo_ListPrice
         where
        parseJSON
...
instance Core.FromJSON Volume_SaleInfo_OffersItem
         where
        parseJSON
          = Core.withObject "Volume_SaleInfo_OffersItem"
              (\ o ->
                 Volume_SaleInfo_OffersItem Core.<$>
                   (o Core..:? "finskyOfferType") Core.<*>
                     (o Core..:? "giftable")
                     Core.<*> (o Core..:? "listPrice")
...
newVolume_SaleInfo_OffersItem_ListPrice =
  Volume_SaleInfo_OffersItem_ListPrice
    {amountInMicros = Core.Nothing, currencyCode = Core.Nothing}
...
newVolume_SaleInfo_OffersItem_RentalDuration =
  Volume_SaleInfo_OffersItem_RentalDuration
    {count = Core.Nothing, unit = Core.Nothing}
...
newVolume_SaleInfo_RetailPrice =
  Volume_SaleInfo_RetailPrice
    {amount = Core.Nothing, currencyCode = Core.Nothing}

instance Core.FromJSON Volume_SaleInfo_RetailPrice
         where
        parseJSON
...
instance Core.ToJSON Volume_SaleInfo_RetailPrice
         where
...
newVolume_SearchInfo 
    ::  Volume_SearchInfo
newVolume_SearchInfo = Volume_SearchInfo {textSnippet = Core.Nothing}

instance Core.FromJSON Volume_SearchInfo where
        parseJSON
          = Core.withObject "Volume_SearchInfo"
              (\ o ->
                 Volume_SearchInfo Core.<$>
                   (o Core..:? "textSnippet"))
...
instance Core.ToJSON Volume_SearchInfo where
        toJSON Volume_SearchInfo{..}
          = Core.object
              (Core.catMaybes
                 [("textSnippet" Core..=) Core.<$> textSnippet])
          ...
          = Core.withObject "Volume_UserInfo"
              (\ o ->
                 Volume_UserInfo Core.<$>
                   (o Core..:? "acquiredTime") Core.<*>
                     (o Core..:? "acquisitionType")
                     Core.<*> (o Core..:? "copy")
          ...
          = Core.object
              (Core.catMaybes
                 [("acquiredTime" Core..=) Core.<$> acquiredTime,
                  ...
                  ("isFamilySharedFromUser" Core..=) Core.<$>
                    isFamilySharedFromUser,
                  ("isFamilySharedToUser" Core..=) Core.<$>
                    isFamilySharedToUser,
                  ("isFamilySharingAllowed" Core..=) Core.<$>
...
newVolume_UserInfo_RentalPeriod =
  Volume_UserInfo_RentalPeriod
    {endUtcSec = Core.Nothing, startUtcSec = Core.Nothing}

instance Core.FromJSON Volume_UserInfo_RentalPeriod
         where
        parseJSON
          = Core.withObject "Volume_UserInfo_RentalPeriod"
              (\ o ->
                 Volume_UserInfo_RentalPeriod Core.<$>
                   (o Core..:? "endUtcSec") Core.<*>
                     (o Core..:? "startUtcSec"))

instance Core.ToJSON Volume_UserInfo_RentalPeriod
         where
        toJSON Volume_UserInfo_RentalPeriod{..}
          = Core.object
              (Core.catMaybes
                 [("endUtcSec" Core..=) Core.. Core.AsText Core.<$>
                    endUtcSec,
                  ("startUtcSec" Core..=) Core.. Core.AsText Core.<$>
                    startUtcSec])
...
newVolume_UserInfo_UserUploadedVolumeInfo 
    ::  Volume_UserInfo_UserUploadedVolumeInfo
newVolume_UserInfo_UserUploadedVolumeInfo =
  Volume_UserInfo_UserUploadedVolumeInfo {processingState = Core.Nothing}
          ...
          = Core.withObject "Volume_VolumeInfo"
              (\ o ->
                 Volume_VolumeInfo Core.<$>
                   (o Core..:? "allowAnonLogging") Core.<*>
                     (o Core..:? "authors" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "averageRating")
                     Core.<*> (o Core..:? "canonicalVolumeLink")
                     Core.<*>
                     (o Core..:? "categories" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "industryIdentifiers" Core..!=
                        Core.mempty)
...
newVolume_VolumeInfo_Dimensions =
  Volume_VolumeInfo_Dimensions
    {height = Core.Nothing, thickness = Core.Nothing, width = Core.Nothing}

instance Core.FromJSON Volume_VolumeInfo_Dimensions
         where
        parseJSON
...
instance Core.ToJSON Volume_VolumeInfo_Dimensions
         where
...
instance Core.ToJSON Volume_VolumeInfo_ImageLinks
         where
...
newVolume_VolumeInfo_IndustryIdentifiersItem =
  Volume_VolumeInfo_IndustryIdentifiersItem
    {identifier = Core.Nothing, type' = Core.Nothing}
...
newVolume_VolumeInfo_PanelizationSummary =
  Volume_VolumeInfo_PanelizationSummary
    { containsEpubBubbles = Core.Nothing
...
instance Core.ToJSON
        ...
        toJSON Volume_VolumeInfo_PanelizationSummary{..}
          = Core.object
              (Core.catMaybes
                 [("containsEpubBubbles" Core..=) Core.<$>
                    containsEpubBubbles,
                  ("containsImageBubbles" Core..=) Core.<$>
                    containsImageBubbles,
                  ("epubBubbleVersion" Core..=) Core.<$>
                    epubBubbleVersion,
                  ("imageBubbleVersion" Core..=) Core.<$>
                    imageBubbleVersion])
...
newVolume_VolumeInfo_ReadingModes 
    ::  Volume_VolumeInfo_ReadingModes
newVolume_VolumeInfo_ReadingModes =
  Volume_VolumeInfo_ReadingModes {image = Core.Nothing, text = Core.Nothing}

instance Core.FromJSON Volume_VolumeInfo_ReadingModes
         where
        parseJSON
...
instance Core.ToJSON Volume_VolumeInfo_ReadingModes
         where
...
instance Core.ToJSON Volumeannotation where
        toJSON Volumeannotation{..}
          = Core.object
              (Core.catMaybes
                 [("annotationDataId" Core..=) Core.<$>
                    annotationDataId,
                  ("annotationDataLink" Core..=) Core.<$>
                    annotationDataLink,
                  ("annotationType" Core..=) Core.<$> annotationType,
...
instance Core.FromJSON Volumeannotation_ContentRanges
         where
        parseJSON
...
instance Core.ToJSON Volumeannotation_ContentRanges
         where
...
newVolumes 
    ::  Volumes
newVolumes =
  Volumes {items = Core.Nothing, kind = Core.Nothing, totalItems = Core.Nothing}
          ...
          = Core.withObject "Volumeseriesinfo"
              (\ o ->
                 Volumeseriesinfo Core.<$>
                   (o Core..:? "bookDisplayNumber") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "shortSeriesBookTitle")
                     Core.<*>
                     (o Core..:? "volumeSeries" Core..!= Core.mempty))

instance Core.ToJSON Volumeseriesinfo where
        toJSON Volumeseriesinfo{..}
          = Core.object
              (Core.catMaybes
                 [("bookDisplayNumber" Core..=) Core.<$>
                    bookDisplayNumber,
                  ("kind" Core..=) Core.<$> kind,
                  ("shortSeriesBookTitle" Core..=) Core.<$>
          ...
          = Core.withObject "Volumeseriesinfo_VolumeSeriesItem"
              (\ o ->
                 Volumeseriesinfo_VolumeSeriesItem Core.<$>
                   (o Core..:? "issue" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "orderNumber")
...
newVolumeseriesinfo_VolumeSeriesItem_IssueItem =
  Volumeseriesinfo_VolumeSeriesItem_IssueItem
    {issueDisplayNumber = Core.Nothing, issueOrderNumber = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("issueDisplayNumber" Core..=) Core.<$>
                    issueDisplayNumber,
                  ("issueOrderNumber" Core..=) Core.<$>
                    issueOrderNumber])
