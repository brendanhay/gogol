                     ...
                     Core.QueryParam "contentVersion" Core.Text Core.:>
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "allowWebDefinitions" Core.Bool
                             Core.:>
...
newBooksLayersAnnotationDataGet 
    ...
    -> BooksLayersAnnotationDataGet
newBooksLayersAnnotationDataGet annotationDataId contentVersion layerId volumeId =
  BooksLayersAnnotationDataGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        type Rs BooksLayersAnnotationDataGet =
             DictionaryAnnotationdata
        type Scopes BooksLayersAnnotationDataGet =
        ...
        requestClient BooksLayersAnnotationDataGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksLayersAnnotationDataGetResource)
                      Core.mempty
