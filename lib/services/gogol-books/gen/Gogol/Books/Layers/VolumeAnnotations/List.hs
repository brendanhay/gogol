                                 ...
                                 Core.QueryParam "pageToken" Core.Text Core.:>
                                   Core.QueryParam "showDeleted" Core.Bool
                                     ...
                                     Core.QueryParam "source" Core.Text Core.:>
                                       Core.QueryParam "startOffset" Core.Text
                                         Core.:>
                                         Core.QueryParam "startPosition"
                                           Core.Text
                                           Core.:>
                                           Core.QueryParam "updatedMax"
                                             Core.Text
                                             Core.:>
...
instance Core.GoogleRequest
           BooksLayersVolumeAnnotationsList
         where
        type Rs BooksLayersVolumeAnnotationsList =
             Volumeannotations
        type Scopes BooksLayersVolumeAnnotationsList =
             '["https://www.googleapis.com/auth/books"]
        requestClient BooksLayersVolumeAnnotationsList{..}
          = go volumeId layerId (Core.Just contentVersion)
              xgafv
              accessToken
              callback
              endOffset
