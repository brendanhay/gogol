...
type BooksMylibraryBookshelvesAddVolumeResource =
  "books"
    ...
    Core.:> Core.QueryParam "reason" MylibraryBookshelvesAddVolumeReason
...
instance Core.GoogleRequest BooksMylibraryBookshelvesAddVolume where
  type Rs BooksMylibraryBookshelvesAddVolume = Empty
  type
    Scopes BooksMylibraryBookshelvesAddVolume =
      '[Books'FullControl]
