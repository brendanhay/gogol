...
instance Core.GoogleRequest BooksOnboardingListCategoryVolumes where
  type Rs BooksOnboardingListCategoryVolumes = Volume2
  type
    Scopes BooksOnboardingListCategoryVolumes =
      '[Books'FullControl]
