...
instance Core.GoogleRequest
        ...
        type Scopes BooksVolumesAssociatedList =
             '["https://www.googleapis.com/auth/books"]
        requestClient BooksVolumesAssociatedList{..}
          = go volumeId xgafv accessToken association callback
              locale
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksVolumesAssociatedListResource)
                      Core.mempty
