                         ...
                         Core.QueryParam "libraryRestrict"
                           ...
                           Core.QueryParam "maxAllowedMaturityRating"
                             ...
                             Core.QueryParam "maxResults" Core.Word32 Core.:>
                               Core.QueryParam "orderBy" VolumesListOrderBy
                                 Core.:>
                                 Core.QueryParam "partner" Core.Text Core.:>
                                   Core.QueryParam "printType"
                                     VolumesListPrintType
                                     Core.:>
                                     Core.QueryParam "projection"
                                       VolumesListProjection
                                       Core.:>
                                       Core.QueryParam "showPreorders" Core.Bool
                                         Core.:>
                                         Core.QueryParam "source" Core.Text
                                           Core.:>
                                           Core.QueryParam "startIndex"
                                             Core.Word32
                                             Core.:>
...
instance Core.GoogleRequest BooksVolumesList where
        ...
        type Scopes BooksVolumesList =
             '["https://www.googleapis.com/auth/books"]
        requestClient BooksVolumesList{..}
          = go (Core.Just q) xgafv accessToken callback
              download
              filter
              langRestrict
              libraryRestrict
