...
type BooksVolumesListResource =
  "books"
    ...
    Core.:> Core.QueryParam "libraryRestrict" VolumesListLibraryRestrict
    ...
    Core.:> Core.QueryParam "printType" VolumesListPrintType
    Core.:> Core.QueryParam "projection" VolumesListProjection
