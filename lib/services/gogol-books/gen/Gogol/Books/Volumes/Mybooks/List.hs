           ...
           "mybooks" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParams "acquireMethod"
...
instance Core.GoogleRequest BooksVolumesMybooksList
         where
        type Rs BooksVolumesMybooksList = Volumes
        type Scopes BooksVolumesMybooksList =
             '["https://www.googleapis.com/auth/books"]
        requestClient BooksVolumesMybooksList{..}
          = go xgafv accessToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksVolumesMybooksListResource)
                      Core.mempty
