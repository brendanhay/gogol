...
instance Core.FromJSON AppCommandMetadata where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AppCommandMetadata
            Core.<$> (o Core..:? "appCommandId")
            Core.<*> (o Core..:? "appCommandType")
      )
...
newAttachmentDataRef =
  AttachmentDataRef
    { attachmentUploadToken = Core.Nothing,
...
instance Core.FromJSON AttachmentDataRef where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AttachmentDataRef
            Core.<$> (o Core..:? "attachmentUploadToken")
...
instance Core.ToJSON CustomEmoji where
  toJSON CustomEmoji {..} =
    Core.object (Core.catMaybes [("uid" Core..=) Core.<$> uid])
...
instance Core.FromJSON DateInput where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          DateInput
            Core.<$> (o Core..:? "msSinceEpoch" Core.<&> Core.fmap Core.fromAsText)
      )
...
newDeprecatedEvent =
  DeprecatedEvent
    { action = Core.Nothing,
      appCommandMetadata = Core.Nothing,
      common = Core.Nothing,
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          DeprecatedEvent
            Core.<$> (o Core..:? "action")
            Core.<*> (o Core..:? "appCommandMetadata")
            Core.<*> (o Core..:? "common")
...
instance Core.FromJSON GoogleAppsCardV1Action where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleAppsCardV1Action
            Core.<$> (o Core..:? "allWidgetsAreRequired")
...
instance Core.FromJSON GoogleAppsCardV1CollapseControl where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleAppsCardV1CollapseControl
            Core.<$> (o Core..:? "collapseButton")
            Core.<*> (o Core..:? "expandButton")
    ...
    Core.withObject
      ...
      ( \o ->
          GoogleAppsCardV1DateTimePicker
            ...
            Core.<*> (o Core..:? "type")
            Core.<*> (o Core..:? "valueMsEpoch" Core.<&> Core.fmap Core.fromAsText)
      )
...
instance Core.FromJSON GoogleAppsCardV1SelectionInput where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleAppsCardV1SelectionInput
            Core.<$> (o Core..:? "externalDataSource")
            Core.<*> (o Core..:? "items")
            Core.<*> (o Core..:? "label")
    ...
    Core.object
      ( Core.catMaybes
          [ ("externalDataSource" Core..=) Core.<$> externalDataSource,
            ("items" Core..=) Core.<$> items,
            ("label" Core..=) Core.<$> label,
            ("multiSelectMaxSelectedItems" Core..=)
              Core.<$> multiSelectMaxSelectedItems,
            ("multiSelectMinQueryLength" Core..=)
              Core.<$> multiSelectMinQueryLength,
            ("name" Core..=) Core.<$> name,
            ("onChangeAction" Core..=) Core.<$> onChangeAction,
...
instance Core.FromJSON GoogleAppsCardV1Validation where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleAppsCardV1Validation
            Core.<$> (o Core..:? "characterLimit")
            Core.<*> (o Core..:? "inputType")
      )
...
newMembershipCount =
  MembershipCount
    { joinedDirectHumanUserCount = Core.Nothing,
...
instance Core.FromJSON MembershipCount where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          MembershipCount
            Core.<$> (o Core..:? "joinedDirectHumanUserCount")
            Core.<*> (o Core..:? "joinedGroupCount")
      )
...
instance Core.ToJSON MembershipCount where
  toJSON MembershipCount {..} =
    Core.object
      ( Core.catMaybes
          [ ("joinedDirectHumanUserCount" Core..=)
              Core.<$> joinedDirectHumanUserCount,
...
instance Core.FromJSON PermissionSetting where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          PermissionSetting
            Core.<$> (o Core..:? "managersAllowed")
            Core.<*> (o Core..:? "membersAllowed")
      )
...
instance Core.FromJSON PermissionSettings where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          PermissionSettings
            Core.<$> (o Core..:? "manageApps")
            Core.<*> (o Core..:? "manageMembersAndGroups")
    ...
    Core.object
      ( Core.catMaybes
          [ ("accessSettings" Core..=) Core.<$> accessSettings,
            ...
            ("predefinedPermissionSettings" Core..=)
              Core.<$> predefinedPermissionSettings,
    ...
    Core.withObject
      ...
      ( \o ->
          SpaceEvent
            ...
            Core.<*> (o Core..:? "membershipBatchCreatedEventData")
      ...
      ( Core.catMaybes
          [ ("eventTime" Core..=) Core.<$> eventTime,
            ...
            ("membershipBatchCreatedEventData" Core..=)
              Core.<$> membershipBatchCreatedEventData,
            ("membershipBatchDeletedEventData" Core..=)
              Core.<$> membershipBatchDeletedEventData,
            ("membershipBatchUpdatedEventData" Core..=)
              Core.<$> membershipBatchUpdatedEventData,
            ("membershipCreatedEventData" Core..=)
              Core.<$> membershipCreatedEventData,
            ("membershipDeletedEventData" Core..=)
              Core.<$> membershipDeletedEventData,
            ("membershipUpdatedEventData" Core..=)
              Core.<$> membershipUpdatedEventData,
            ("messageBatchCreatedEventData" Core..=)
              Core.<$> messageBatchCreatedEventData,
            ("messageBatchDeletedEventData" Core..=)
              Core.<$> messageBatchDeletedEventData,
            ("messageBatchUpdatedEventData" Core..=)
              Core.<$> messageBatchUpdatedEventData,
            ("messageCreatedEventData" Core..=)
              Core.<$> messageCreatedEventData,
            ("messageDeletedEventData" Core..=)
              Core.<$> messageDeletedEventData,
            ("messageUpdatedEventData" Core..=)
              Core.<$> messageUpdatedEventData,
            ("name" Core..=) Core.<$> name,
            ("reactionBatchCreatedEventData" Core..=)
              Core.<$> reactionBatchCreatedEventData,
            ("reactionBatchDeletedEventData" Core..=)
              Core.<$> reactionBatchDeletedEventData,
            ("reactionCreatedEventData" Core..=)
              Core.<$> reactionCreatedEventData,
            ("reactionDeletedEventData" Core..=)
              Core.<$> reactionDeletedEventData,
            ("spaceBatchUpdatedEventData" Core..=)
              Core.<$> spaceBatchUpdatedEventData,
...
newSpaceNotificationSetting =
  SpaceNotificationSetting
    { muteSetting = Core.Nothing,
      name = Core.Nothing,
      notificationSetting = Core.Nothing
    }
...
instance Core.FromJSON SpaceNotificationSetting where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          SpaceNotificationSetting
            Core.<$> (o Core..:? "muteSetting")
            Core.<*> (o Core..:? "name")
            Core.<*> (o Core..:? "notificationSetting")
      )
