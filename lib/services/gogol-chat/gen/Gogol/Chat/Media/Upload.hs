...
type ChatMediaUploadResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] UploadAttachmentRequest
    Core.:> Core.Post '[Core.JSON] UploadAttachmentResponse
    Core.:<|> "upload"
    Core.:> "v1"
    Core.:> Core.Capture "parent" Core.Text
    Core.:> "attachments:upload"
    ...
    Core.:> Core.MultipartRelated '[Core.JSON] UploadAttachmentRequest
    Core.:> Core.Post '[Core.JSON] UploadAttachmentResponse
...
instance Core.GoogleRequest (Core.MediaUpload ChatMediaUpload) where
  type
    Rs (Core.MediaUpload ChatMediaUpload) =
      UploadAttachmentResponse
  type
    Scopes (Core.MediaUpload ChatMediaUpload) =
