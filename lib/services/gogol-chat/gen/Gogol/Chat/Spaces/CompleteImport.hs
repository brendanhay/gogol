...
type ChatSpacesCompleteImportResource =
     "v1" Core.:>
       Core.CaptureMode "name" "completeImport" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CompleteImportSpaceRequest
                       Core.:>
...
instance Core.GoogleRequest ChatSpacesCompleteImport
         where
        type Rs ChatSpacesCompleteImport =
        ...
        requestClient ChatSpacesCompleteImport{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ChatSpacesCompleteImportResource)
                      Core.mempty
