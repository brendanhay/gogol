              ...
              (\ o ->
                 AdministrativeBody Core.<$>
                   (o Core..:? "absenteeVotingInfoUrl") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "electionOfficials" Core..!= Core.mempty)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "voter_services" Core..!= Core.mempty)
              ...
              (\ o ->
                 Candidate Core.<$>
                   (o Core..:? "candidateUrl") Core.<*>
                     (o Core..:? "channels" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "name")
              ...
              (\ o ->
                 Contest Core.<$>
                   (o Core..:? "ballotPlacement") Core.<*>
                     ...
                     Core.<*> (o Core..:? "office")
                     Core.<*>
                     (o Core..:? "primaryParties" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "primaryParty")
                     Core.<*>
                     (o Core..:? "referendumBallotResponses" Core..!=
                        Core.mempty)
...
instance Core.FromJSON Election where
        parseJSON
          = Core.withObject "Election"
              (\ o ->
                 Election Core.<$>
                   (o Core..:? "electionDay") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.withObject "ElectionsQueryResponse"
              (\ o ->
                 ElectionsQueryResponse Core.<$>
                   (o Core..:? "elections" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON FeatureIdProto where
        parseJSON
          = Core.withObject "FeatureIdProto"
              (\ o ->
                 FeatureIdProto Core.<$>
                   (o Core..:? "cellId") Core.<*> (o Core..:? "fprint")
          ...
          = Core.withObject "GeographicDivision"
              (\ o ->
                 GeographicDivision Core.<$>
                   (o Core..:? "alsoKnownAs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "officeIndices" Core..!= Core.mempty))
              ...
              (\ o ->
                 Office Core.<$>
                   (o Core..:? "divisionId") Core.<*>
                     (o Core..:? "levels" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "officialIndices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "roles" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "sources" Core..!= Core.mempty))
...
instance Core.FromJSON Official where
        parseJSON
          = Core.withObject "Official"
              (\ o ->
                 Official Core.<$>
                   (o Core..:? "address" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "channels" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "emails" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "geocodingSummaries" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "party")
              ...
              (\ o ->
                 RepresentativeInfoData Core.<$>
                   (o Core..:? "divisions") Core.<*>
                     (o Core..:? "offices" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "officials" Core..!= Core.mempty))
...
newtype RepresentativeInfoData_Divisions = RepresentativeInfoData_Divisions
    {
      -- | 
      addtional :: (Core.HashMap Core.Text GeographicDivision)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRepresentativeInfoData_Divisions 
    ::  Core.HashMap Core.Text GeographicDivision
       -- ^  See 'addtional'.
    -> RepresentativeInfoData_Divisions
newRepresentativeInfoData_Divisions addtional =
  RepresentativeInfoData_Divisions {addtional = addtional}
...
newRepresentativeInfoResponse_Divisions 
    ::  Core.HashMap Core.Text GeographicDivision
       -- ^  See 'addtional'.
    -> RepresentativeInfoResponse_Divisions
newRepresentativeInfoResponse_Divisions addtional =
  RepresentativeInfoResponse_Divisions {addtional = addtional}
          ...
          = Core.withObject "VoterInfoResponse"
              (\ o ->
                 VoterInfoResponse Core.<$>
                   (o Core..:? "contests" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "dropOffLocations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "earlyVoteSites" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "normalizedInput")
                     Core.<*>
                     (o Core..:? "otherElections" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "pollingLocations" Core..!= Core.mempty)
