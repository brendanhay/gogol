...
newDivisionByAddressResponse =
  DivisionByAddressResponse
    {divisions = Core.Nothing, normalizedInput = Core.Nothing}

instance Core.FromJSON DivisionByAddressResponse
         where
        parseJSON
          = Core.withObject "DivisionByAddressResponse"
              (\ o ->
                 DivisionByAddressResponse Core.<$>
                   (o Core..:? "divisions") Core.<*>
                     (o Core..:? "normalizedInput"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DivisionByAddressResponse_Divisions"
              (\ o ->
                 DivisionByAddressResponse_Divisions Core.<$>
