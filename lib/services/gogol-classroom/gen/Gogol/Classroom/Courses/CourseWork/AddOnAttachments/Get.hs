...
--
-- /See:/ <https://developers.google.com/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.get@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.Get
  ( -- * Resource
...
instance
  ...
  where
  type
    Rs ClassroomCoursesCourseWorkAddOnAttachmentsGet =
      AddOnAttachment
  type
    Scopes ClassroomCoursesCourseWorkAddOnAttachmentsGet =
