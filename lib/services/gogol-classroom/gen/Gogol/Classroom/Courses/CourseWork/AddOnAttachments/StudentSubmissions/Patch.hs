...
newClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch 
    ...
    -> ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch
newClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch attachmentId courseId itemId payload submissionId =
  ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch{..}
          = go courseId itemId attachmentId submissionId xgafv
              accessToken
              callback
              postId
              updateMask
