...
newClassroomCoursesCourseWorkRubricsCreate 
    ...
    -> ClassroomCoursesCourseWorkRubricsCreate
newClassroomCoursesCourseWorkRubricsCreate courseId courseWorkId payload =
  ClassroomCoursesCourseWorkRubricsCreate
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkRubricsCreate
         where
        type Rs ClassroomCoursesCourseWorkRubricsCreate =
             Rubric
        type Scopes ClassroomCoursesCourseWorkRubricsCreate =
             '[Classroom'Coursework'Students]
        requestClient
          ClassroomCoursesCourseWorkRubricsCreate{..}
          = go courseId courseWorkId xgafv accessToken callback
              uploadType
              uploadProtocol
