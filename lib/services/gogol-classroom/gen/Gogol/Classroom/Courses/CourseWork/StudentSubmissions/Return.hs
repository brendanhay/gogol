...
type ClassroomCoursesCourseWorkStudentSubmissionsReturnResource =
  "v1"
    ...
    Core.:> Core.CaptureMode "id" "return" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] ReturnStudentSubmissionRequest
...
instance
  ...
  type
    Scopes ClassroomCoursesCourseWorkStudentSubmissionsReturn =
