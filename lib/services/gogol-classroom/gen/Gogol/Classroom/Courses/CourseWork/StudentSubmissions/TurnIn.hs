...
type ClassroomCoursesCourseWorkStudentSubmissionsTurnInResource =
  "v1"
    ...
    Core.:> Core.CaptureMode "id" "turnIn" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] TurnInStudentSubmissionRequest
...
instance
  ...
  type
    Scopes ClassroomCoursesCourseWorkStudentSubmissionsTurnIn =
