...
--
-- /See:/ <https://developers.google.com/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.delete@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Delete
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete 
    ...
    -> ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete attachmentId courseId itemId =
  ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete
    { xgafv = Core.Nothing
