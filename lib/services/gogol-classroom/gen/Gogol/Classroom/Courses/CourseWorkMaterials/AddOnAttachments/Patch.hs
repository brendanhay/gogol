...
--
-- /See:/ <https://developers.google.com/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.patch@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Patch
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch 
    ...
    -> ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch attachmentId courseId itemId payload =
  ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
    { xgafv = Core.Nothing
