...
--
-- /See:/ <https://developers.google.com/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.studentSubmissions.patch@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.StudentSubmissions.Patch
    (
    -- * Resource
...
newClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch 
    ...
    -> ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch
newClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch attachmentId courseId payload postId submissionId =
  ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch{..}
          = go courseId postId attachmentId submissionId xgafv
              accessToken
              callback
              itemId
              updateMask
