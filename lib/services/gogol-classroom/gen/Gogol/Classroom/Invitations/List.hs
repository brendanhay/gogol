...
instance Core.GoogleRequest ClassroomInvitationsList
         where
        type Rs ClassroomInvitationsList =
             ListInvitationsResponse
        type Scopes ClassroomInvitationsList =
             '["https://www.googleapis.com/auth/classroom.rosters",
               "https://www.googleapis.com/auth/classroom.rosters.readonly"]
        requestClient ClassroomInvitationsList{..}
          = go xgafv accessToken callback courseId pageSize
              pageToken
              uploadType
              uploadProtocol
              userId
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomInvitationsListResource)
                      Core.mempty
