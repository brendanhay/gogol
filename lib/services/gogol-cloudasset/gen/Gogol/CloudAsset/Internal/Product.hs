...
instance Core.FromJSON GoogleCloudAssetV1p7beta1BigQueryDestination where
  parseJSON =
    Core.withObject
      "GoogleCloudAssetV1p7beta1BigQueryDestination"
      ( \o ->
...
instance Core.ToJSON GoogleCloudAssetV1p7beta1BigQueryDestination where
...
instance Core.FromJSON GoogleCloudAssetV1p7beta1ExportAssetsRequest where
  parseJSON =
    Core.withObject
      "GoogleCloudAssetV1p7beta1ExportAssetsRequest"
      ( \o ->
...
instance Core.ToJSON GoogleCloudAssetV1p7beta1ExportAssetsRequest where
...
instance Core.FromJSON GoogleCloudAssetV1p7beta1GcsDestination where
  parseJSON =
    Core.withObject
      "GoogleCloudAssetV1p7beta1GcsDestination"
      ( \o ->
...
instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1BasicLevel where
...
instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1Condition where
...
instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1EgressFrom where
...
instance Core.FromJSON GoogleIdentityAccesscontextmanagerV1EgressTo where
  parseJSON =
    Core.withObject
      "GoogleIdentityAccesscontextmanagerV1EgressTo"
      ( \o ->
...
instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1EgressTo where
...
instance Core.ToJSON GoogleIdentityAccesscontextmanagerV1IngressTo where
