              ...
              (\ o ->
                 GoogleCloudAssetV1p7beta1Asset Core.<$>
                   (o Core..:? "accessLevel") Core.<*>
                     (o Core..:? "accessPolicy")
                     Core.<*>
                     (o Core..:? "ancestors" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "assetType")
                     Core.<*> (o Core..:? "iamPolicy")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "orgPolicy" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudAssetV1p7beta1RelatedAssets Core.<$>
                   (o Core..:? "assets" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 GoogleCloudOrgpolicyV1ListPolicy Core.<$>
                   (o Core..:? "allValues") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "deniedValues" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1ApiOperation
                   Core.<$>
                   (o Core..:? "methodSelectors" Core..!= Core.mempty)
              ...
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1DevicePolicy
                   ...
                   (o Core..:? "allowedDeviceManagementLevels" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "allowedEncryptionStatuses" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "osConstraints" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1EgressFrom
                   Core.<$>
                   (o Core..:? "identities" Core..!= Core.mempty)
              ...
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig
                   ...
                   (o Core..:? "accessLevels" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "egressPolicies" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "ingressPolicies" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "resources" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "restrictedServices" Core..!=
                        Core.mempty)
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices
                   Core.<$>
                   (o Core..:? "allowedServices" Core..!= Core.mempty)
