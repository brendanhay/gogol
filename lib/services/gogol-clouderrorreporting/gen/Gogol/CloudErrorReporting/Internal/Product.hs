              ...
              (\ o ->
                 ErrorContext Core.<$>
                   (o Core..:? "httpRequest") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "sourceReferences" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "user"))
              ...
              (\ o ->
                 ErrorGroup Core.<$>
                   (o Core..:? "groupId") Core.<*> (o Core..:? "name")
                     ...
                     Core.<*>
                     (o Core..:? "trackingIssues" Core..!= Core.mempty))
          ...
          = Core.withObject "ErrorGroupStats"
              (\ o ->
                 ErrorGroupStats Core.<$>
                   (o Core..:? "affectedServices" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "timedCounts" Core..!= Core.mempty))
          ...
          = Core.withObject "ListEventsResponse"
              (\ o ->
                 ListEventsResponse Core.<$>
                   (o Core..:? "errorEvents" Core..!= Core.mempty)
          ...
          = Core.withObject "ListGroupStatsResponse"
              (\ o ->
                 ListGroupStatsResponse Core.<$>
                   (o Core..:? "errorGroupStats" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "timeRangeBegin"))
...
instance Core.FromJSON TimedCount where
        parseJSON
          = Core.withObject "TimedCount"
              (\ o ->
                 TimedCount Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "endTime")
