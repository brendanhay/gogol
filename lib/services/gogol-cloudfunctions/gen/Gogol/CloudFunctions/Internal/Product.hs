...
instance Core.FromJSON AbortFunctionUpgradeRequest
         where
        parseJSON
          = Core.withObject "AbortFunctionUpgradeRequest"
              (\ o -> Core.pure AbortFunctionUpgradeRequest)

instance Core.ToJSON AbortFunctionUpgradeRequest
         where
...
instance Core.FromJSON BuildConfig where
        parseJSON
          = Core.withObject "BuildConfig"
              (\ o ->
                 BuildConfig Core.<$>
                   (o Core..:? "automaticUpdatePolicy") Core.<*>
                     (o Core..:? "build")
...
instance Core.ToJSON BuildConfig where
        toJSON BuildConfig{..}
          = Core.object
              (Core.catMaybes
                 [("automaticUpdatePolicy" Core..=) Core.<$>
                    automaticUpdatePolicy,
                  ...
                  ("onDeployUpdatePolicy" Core..=) Core.<$>
                    onDeployUpdatePolicy,
...
instance Core.FromJSON CommitFunctionUpgradeRequest
         where
        parseJSON
          = Core.withObject "CommitFunctionUpgradeRequest"
              (\ o -> Core.pure CommitFunctionUpgradeRequest)

instance Core.ToJSON CommitFunctionUpgradeRequest
         where
        toJSON = Core.const Core.emptyObject
...
newGenerateUploadUrlRequest =
  GenerateUploadUrlRequest
    {environment = Core.Nothing, kmsKeyName = Core.Nothing}
...
newOnDeployUpdatePolicy 
    ::  OnDeployUpdatePolicy
newOnDeployUpdatePolicy = OnDeployUpdatePolicy {runtimeVersion = Core.Nothing}

instance Core.FromJSON OnDeployUpdatePolicy where
        parseJSON
          = Core.withObject "OnDeployUpdatePolicy"
              (\ o ->
                 OnDeployUpdatePolicy Core.<$>
...
newRedirectFunctionUpgradeTrafficRequest 
    ::  RedirectFunctionUpgradeTrafficRequest
newRedirectFunctionUpgradeTrafficRequest = RedirectFunctionUpgradeTrafficRequest
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RedirectFunctionUpgradeTrafficRequest"
              (\ o ->
                 Core.pure RedirectFunctionUpgradeTrafficRequest)
...
newRollbackFunctionUpgradeTrafficRequest 
    ::  RollbackFunctionUpgradeTrafficRequest
newRollbackFunctionUpgradeTrafficRequest = RollbackFunctionUpgradeTrafficRequest
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RollbackFunctionUpgradeTrafficRequest"
              (\ o ->
                 Core.pure RollbackFunctionUpgradeTrafficRequest)
...
data SetupFunctionUpgradeConfigRequest = SetupFunctionUpgradeConfigRequest
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SetupFunctionUpgradeConfigRequest' with the minimum fields required to make a request.
newSetupFunctionUpgradeConfigRequest 
    ::  SetupFunctionUpgradeConfigRequest
newSetupFunctionUpgradeConfigRequest = SetupFunctionUpgradeConfigRequest
