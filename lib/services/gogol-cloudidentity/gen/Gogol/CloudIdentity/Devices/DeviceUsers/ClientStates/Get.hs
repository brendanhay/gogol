...
type CloudIdentityDevicesDeviceUsersClientStatesGetResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] GoogleAppsCloudidentityDevicesV1ClientState
...
instance
  ...
  where
  type
    Rs CloudIdentityDevicesDeviceUsersClientStatesGet =
      GoogleAppsCloudidentityDevicesV1ClientState
  type
    Scopes CloudIdentityDevicesDeviceUsersClientStatesGet =
