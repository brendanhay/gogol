...
type CloudIdentityDevicesDeviceUsersGetResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] GoogleAppsCloudidentityDevicesV1DeviceUser
...
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersGet where
  type
    Rs CloudIdentityDevicesDeviceUsersGet =
