...
type CloudIdentityGroupsMembershipsLookupResource =
  "v1"
    ...
    Core.:> "memberships:lookup"
    Core.:> Core.QueryParam "$.xgafv" Xgafv
    Core.:> Core.QueryParam "access_token" Core.Text
    Core.:> Core.QueryParam "callback" Core.Text
    Core.:> Core.QueryParam "memberKey.id" Core.Text
    Core.:> Core.QueryParam "memberKey.namespace" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.Get '[Core.JSON] LookupMembershipNameResponse
...
instance Core.GoogleRequest CloudIdentityGroupsMembershipsLookup where
  type
    Rs CloudIdentityGroupsMembershipsLookup =
