...
type CloudIdentityGroupsMembershipsSearchTransitiveGroupsResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] SearchTransitiveGroupsResponse
...
instance
  ...
  where
  type
    Rs CloudIdentityGroupsMembershipsSearchTransitiveGroups =
      SearchTransitiveGroupsResponse
  type
    Scopes CloudIdentityGroupsMembershipsSearchTransitiveGroups =
