...
type CloudIdentityInboundSsoAssignmentsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListInboundSsoAssignmentsResponse
...
instance Core.GoogleRequest CloudIdentityInboundSsoAssignmentsList where
  type
    Rs CloudIdentityInboundSsoAssignmentsList =
      ListInboundSsoAssignmentsResponse
  type
    Scopes CloudIdentityInboundSsoAssignmentsList =
