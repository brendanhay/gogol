          ...
          = Core.withObject "DynamicGroupMetadata"
              (\ o ->
                 DynamicGroupMetadata Core.<$>
                   (o Core..:? "queries" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "status"))
          ...
          = Core.withObject "GetMembershipGraphResponse"
              (\ o ->
                 GetMembershipGraphResponse Core.<$>
                   (o Core..:? "adjacencyList" Core..!= Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ClientState Core.<$>
                   (o Core..:? "assetTags" Core..!= Core.mempty)
...
newGoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs 
    ::  Core.HashMap Core.Text GoogleAppsCloudidentityDevicesV1CustomAttributeValue
       -- ^  See 'addtional'.
    -> GoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs
newGoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs addtional =
  GoogleAppsCloudidentityDevicesV1ClientState_KeyValuePairs
    {addtional = addtional}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse
                   Core.<$>
                   (o Core..:? "deviceUsers" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
...
newGroup_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Group_Labels
newGroup_Labels addtional = Group_Labels {addtional = addtional}
...
instance Core.ToJSON Group_Labels where
        toJSON Group_Labels{..} = Core.toJSON addtional
...
newGroupRelation_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> GroupRelation_Labels
newGroupRelation_Labels addtional = GroupRelation_Labels {addtional = addtional}
          ...
          = Core.withObject "ListGroupsResponse"
              (\ o ->
                 ListGroupsResponse Core.<$>
                   (o Core..:? "groups" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
        ...
        parseJSON
          = Core.withObject "MemberRelation"
              (\ o ->
                 MemberRelation Core.<$>
                   (o Core..:? "member") Core.<*>
                     (o Core..:? "preferredMemberKey" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "relationType")
                     Core.<*> (o Core..:? "roles" Core..!= Core.mempty))
          ...
          = Core.withObject "MembershipAdjacencyList"
              (\ o ->
                 MembershipAdjacencyList Core.<$>
                   (o Core..:? "edges" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "group"))
          ...
          = Core.withObject "ModifyMembershipRolesRequest"
              (\ o ->
                 ModifyMembershipRolesRequest Core.<$>
                   (o Core..:? "addRoles" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "removeRoles" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "updateRolesParams" Core..!=
                        Core.mempty))
