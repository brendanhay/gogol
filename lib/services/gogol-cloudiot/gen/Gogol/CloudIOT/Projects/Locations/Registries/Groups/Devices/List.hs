...
type CloudIOTProjectsLocationsRegistriesGroupsDevicesListResource =
  "v1"
    ...
    Core.:> Core.QueryParam "gatewayListOptions.associationsDeviceId" Core.Text
...
instance
  ...
  where
  type
    Rs CloudIOTProjectsLocationsRegistriesGroupsDevicesList =
      ListDevicesResponse
  type
    Scopes CloudIOTProjectsLocationsRegistriesGroupsDevicesList =
