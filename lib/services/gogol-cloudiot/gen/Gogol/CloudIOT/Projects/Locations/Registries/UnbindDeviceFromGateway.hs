...
type CloudIOTProjectsLocationsRegistriesUnbindDeviceFromGatewayResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "unbindDeviceFromGateway" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] UnbindDeviceFromGatewayRequest
    Core.:> Core.Post '[Core.JSON] UnbindDeviceFromGatewayResponse
...
instance
  ...
  where
  type
    Rs CloudIOTProjectsLocationsRegistriesUnbindDeviceFromGateway =
