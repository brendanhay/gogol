              ...
              (\ o ->
                 Certificate Core.<$>
                   (o Core..:? "issuer") Core.<*>
                     ...
                     Core.<*> (o Core..:? "subject")
                     Core.<*>
                     (o Core..:? "subjectAlternativeDnsNames" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "CertificateChains"
              (\ o ->
                 CertificateChains Core.<$>
                   (o Core..:? "caviumCerts" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "googleCardCerts" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "googlePartitionCerts" Core..!=
                        Core.mempty))
...
newCryptoKey_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> CryptoKey_Labels
newCryptoKey_Labels addtional = CryptoKey_Labels {addtional = addtional}
...
instance Core.ToJSON CryptoKey_Labels where
        toJSON CryptoKey_Labels{..} = Core.toJSON addtional
              ...
              (\ o ->
                 EkmConnection Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "serviceResolvers" Core..!= Core.mempty))
          ...
          = Core.withObject "ListCryptoKeyVersionsResponse"
              (\ o ->
                 ListCryptoKeyVersionsResponse Core.<$>
                   (o Core..:? "cryptoKeyVersions" Core..!= Core.mempty)
          ...
          = Core.withObject "ListCryptoKeysResponse"
              (\ o ->
                 ListCryptoKeysResponse Core.<$>
                   (o Core..:? "cryptoKeys" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
          ...
          = Core.withObject "ListEkmConnectionsResponse"
              (\ o ->
                 ListEkmConnectionsResponse Core.<$>
                   (o Core..:? "ekmConnections" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
          ...
          = Core.withObject "ListImportJobsResponse"
              (\ o ->
                 ListImportJobsResponse Core.<$>
                   (o Core..:? "importJobs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
          ...
          = Core.withObject "ListKeyRingsResponse"
              (\ o ->
                 ListKeyRingsResponse Core.<$>
                   (o Core..:? "keyRings" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "MacSignResponse"
              (\ o ->
                 MacSignResponse Core.<$>
                   (o Core..:? "mac") Core.<*> (o Core..:? "macCrc32c")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "protectionLevel")
                     Core.<*> (o Core..:? "verifiedDataCrc32c"))
              ...
              (\ o ->
                 ServiceResolver Core.<$>
                   (o Core..:? "endpointFilter") Core.<*>
                     (o Core..:? "hostname")
                     Core.<*>
                     (o Core..:? "serverCertificates" Core..!=
                        Core.mempty)
