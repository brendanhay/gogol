...
newAutokeyConfig =
  AutokeyConfig
    {keyProject = Core.Nothing, name = Core.Nothing, state = Core.Nothing}
...
newKeyAccessJustificationsPolicy 
    ::  KeyAccessJustificationsPolicy
newKeyAccessJustificationsPolicy =
  KeyAccessJustificationsPolicy {allowedAccessReasons = Core.Nothing}

instance Core.FromJSON KeyAccessJustificationsPolicy
         where
        parseJSON
...
instance Core.ToJSON KeyAccessJustificationsPolicy
         where
        toJSON KeyAccessJustificationsPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("allowedAccessReasons" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("kmsKey" Core..=) Core.<$> kmsKey,
                  ("name" Core..=) Core.<$> name,
                  ("resourceTypeSelector" Core..=) Core.<$>
...
newListKeyHandlesResponse =
  ListKeyHandlesResponse
    {keyHandles = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalAuthenticatedData" Core..=) Core.<$>
                  ...
                  ("ciphertextCrc32c" Core..=) Core.. Core.AsText
                    Core.<$> ciphertextCrc32c,
                  ("initializationVector" Core..=) Core.<$>
                    initializationVector,
                  ("initializationVectorCrc32c" Core..=) Core..
                    Core.AsText
              ...
              (\ o ->
                 RawDecryptResponse Core.<$>
                   (o Core..:? "plaintext") Core.<*>
                     ...
                     Core.<*> (o Core..:? "verifiedCiphertextCrc32c")
                     Core.<*>
                     (o Core..:? "verifiedInitializationVectorCrc32c"))
