...
type CloudKMSProjectsLocationsKeyHandlesListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListKeyHandlesResponse
...
instance Core.GoogleRequest CloudKMSProjectsLocationsKeyHandlesList where
  type
    Rs CloudKMSProjectsLocationsKeyHandlesList =
      ListKeyHandlesResponse
  type
    Scopes CloudKMSProjectsLocationsKeyHandlesList =
