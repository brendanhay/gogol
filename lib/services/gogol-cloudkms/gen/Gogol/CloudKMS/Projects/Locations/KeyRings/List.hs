...
type CloudKMSProjectsLocationsKeyRingsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListKeyRingsResponse
...
instance Core.GoogleRequest CloudKMSProjectsLocationsKeyRingsList where
  type
    Rs CloudKMSProjectsLocationsKeyRingsList =
      ListKeyRingsResponse
  type
    Scopes CloudKMSProjectsLocationsKeyRingsList =
