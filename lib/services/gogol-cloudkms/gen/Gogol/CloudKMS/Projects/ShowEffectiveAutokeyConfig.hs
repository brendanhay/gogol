...
type CloudKMSProjectsShowEffectiveAutokeyConfigResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "showEffectiveAutokeyConfig" Core.Text
    ...
    Core.:> Core.Get '[Core.JSON] ShowEffectiveAutokeyConfigResponse
...
instance
  ...
  where
  type
    Rs CloudKMSProjectsShowEffectiveAutokeyConfig =
      ShowEffectiveAutokeyConfigResponse
  type
    Scopes CloudKMSProjectsShowEffectiveAutokeyConfig =
