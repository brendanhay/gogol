              ...
              (\ o ->
                 CreateProfileRequest Core.<$>
                   (o Core..:? "deployment") Core.<*>
                     (o Core..:? "profileType" Core..!= Core.mempty))
...
newDeployment_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Deployment_Labels
newDeployment_Labels addtional = Deployment_Labels {addtional = addtional}
...
instance Core.ToJSON Deployment_Labels where
        toJSON Deployment_Labels{..} = Core.toJSON addtional
...
newProfile_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Profile_Labels
newProfile_Labels addtional = Profile_Labels {addtional = addtional}
...
instance Core.ToJSON Profile_Labels where
        toJSON Profile_Labels{..} = Core.toJSON addtional
