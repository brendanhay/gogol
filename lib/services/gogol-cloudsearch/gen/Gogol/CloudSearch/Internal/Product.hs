...
instance Core.FromJSON AclInfo where
        parseJSON
          = Core.withObject "AclInfo"
              (\ o ->
                 AclInfo Core.<$>
                   (o Core..:? "groupsCount") Core.<*>
                     (o Core..:? "scope")
...
newAppId =
  AppId
    {appType = Core.Nothing, gsuiteAppType = Core.Nothing, id = Core.Nothing}

instance Core.FromJSON AppId where
        parseJSON
          = Core.withObject "AppId"
              (\ o ->
                 AppId Core.<$>
                   (o Core..:? "appType") Core.<*>
                     (o Core..:? "gsuiteAppType")
                     Core.<*> (o Core..:? "id"))
              ...
              (\ o ->
                 CompositeFilter Core.<$>
                   (o Core..:? "logicOperator") Core.<*>
                     (o Core..:? "subFilters" Core..!= Core.mempty))
          ...
          = Core.withObject "CustomerQueryStats"
              (\ o ->
                 CustomerQueryStats Core.<$>
                   (o Core..:? "date") Core.<*>
                     (o Core..:? "queryCountByStatus" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "disableModifications") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "indexingServiceAccounts" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "itemsVisibility" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "operationIds" Core..!= Core.mempty)
          ...
          = Core.withObject "DataSourceRestriction"
              (\ o ->
                 DataSourceRestriction Core.<$>
                   (o Core..:? "filterOptions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON DynamiteSpacesScoringInfo
         where
        parseJSON
          = Core.withObject "DynamiteSpacesScoringInfo"
              (\ o ->
                 DynamiteSpacesScoringInfo Core.<$>
                   (o Core..:? "affinityScore") Core.<*>
                     (o Core..:? "commonContactCountAffinityScore")
                     ...
                     Core.<*>
                     (o Core..:? "smallUnjoinedSpacesAffinityScore")
              ...
              (\ o ->
                 EnumPropertyOptions Core.<$>
                   (o Core..:? "operatorOptions") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "possibleValues" Core..!= Core.mempty))
...
instance Core.FromJSON ErrorInfo where
        parseJSON
          = Core.withObject "ErrorInfo"
              (\ o ->
                 ErrorInfo Core.<$>
                   (o Core..:? "errorMessages" Core..!= Core.mempty))
...
newFacetBucket =
  FacetBucket
    {count = Core.Nothing, percentage = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject "GetCustomerQueryStatsResponse"
              (\ o ->
                 GetCustomerQueryStatsResponse Core.<$>
                   (o Core..:? "stats" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "totalQueryCount"))
...
instance Core.FromJSON GoogleDocsMetadata where
        parseJSON
          = Core.withObject "GoogleDocsMetadata"
              (\ o ->
                 GoogleDocsMetadata Core.<$>
                   (o Core..:? "aclInfo") Core.<*>
                     (o Core..:? "documentType")
          ...
          = Core.object
              (Core.catMaybes
                 [("aclInfo" Core..=) Core.<$> aclInfo,
                  ...
                  ("lastContentModifiedTimestamp" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON GoogleDocsResultInfo where
        parseJSON
          = Core.withObject "GoogleDocsResultInfo"
              (\ o ->
                 GoogleDocsResultInfo Core.<$>
                   (o Core..:? "attachmentSha1") Core.<*>
                     (o Core..:? "cosmoId")
...
instance Core.FromJSON GroupId where
        parseJSON
          = Core.withObject "GroupId"
              (\ o ->
                 GroupId Core.<$>
                   (o Core..:? "dmId") Core.<*> (o Core..:? "spaceId"))
              ...
              (\ o ->
                 ItemAcl Core.<$>
                   (o Core..:? "aclInheritanceType") Core.<*>
                     (o Core..:? "deniedReaders" Core..!= Core.mempty)
              ...
              (\ o ->
                 ItemMetadata Core.<$>
                   (o Core..:? "containerName") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "contextAttributes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "hash")
                     Core.<*>
                     (o Core..:? "interactions" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject "ItemStatus"
              (\ o ->
                 ItemStatus Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "processingErrors" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "repositoryErrors" Core..!= Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 ListItemNamesForUnmappedIdentityResponse Core.<$>
                   (o Core..:? "itemNames" Core..!= Core.mempty)
          ...
          = Core.withObject "ListSearchApplicationsResponse"
              (\ o ->
                 ListSearchApplicationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "searchApplications" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "ListUnmappedIdentitiesResponse"
              (\ o ->
                 ListUnmappedIdentitiesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "unmappedIdentities" Core..!=
                        Core.mempty))
...
instance Core.FromJSON Metaline where
        parseJSON
          = Core.withObject "Metaline"
              (\ o ->
                 Metaline Core.<$>
                   (o Core..:? "properties" Core..!= Core.mempty))
              ...
              (\ o ->
                 ObjectDefinition Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "options")
                     Core.<*>
                     (o Core..:? "propertyDefinitions" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "ObjectDisplayOptions"
              (\ o ->
                 ObjectDisplayOptions Core.<$>
                   (o Core..:? "metalines" Core..!= Core.mempty)
          ...
          = Core.withObject "ObjectPropertyOptions"
              (\ o ->
                 ObjectPropertyOptions Core.<$>
                   (o Core..:? "subobjectProperties" Core..!=
                      Core.mempty))
...
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "emailAddresses" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "obfuscatedId")
                     Core.<*>
                     (o Core..:? "personNames" Core..!= Core.mempty)
              ...
              (\ o ->
                 PollItemsRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*>
                     ...
                     Core.<*> (o Core..:? "queue")
                     Core.<*>
                     (o Core..:? "statusCodes" Core..!= Core.mempty))
              ...
              (\ o ->
                 ProcessingError Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "errorMessage")
                     Core.<*>
                     (o Core..:? "fieldViolations" Core..!= Core.mempty))
              ...
              (\ o ->
                 QueryOperator Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "enumValues" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject "QuerySource"
              (\ o ->
                 QuerySource Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "operators" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "shortName")
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON ResultCounts where
        parseJSON
          = Core.withObject "ResultCounts"
              (\ o ->
                 ResultCounts Core.<$>
                   (o Core..:? "sourceResultCounts" Core..!=
                      Core.mempty))
...
instance Core.FromJSON Schema where
        parseJSON
          = Core.withObject "Schema"
              (\ o ->
                 Schema Core.<$>
                   (o Core..:? "objectDefinitions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "operationIds" Core..!= Core.mempty))
              ...
              (\ o ->
                 SearchApplication Core.<$>
                   (o Core..:? "dataSourceRestrictions" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "defaultFacetOptions" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "sourceConfig" Core..!= Core.mempty))
                 ...
                 SearchRequest Core.<$>
                   (o Core..:? "contextAttributes" Core..!= Core.mempty)
                     ...
                     (o Core..:? "dataSourceRestrictions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "facetOptions" Core..!= Core.mempty)
              ...
              (\ o ->
                 SearchResponse Core.<$>
                   (o Core..:? "debugInfo") Core.<*>
                     (o Core..:? "errorInfo")
                     Core.<*>
                     (o Core..:? "facetResults" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "spellResults" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "structuredResults" Core..!=
                        Core.mempty))
...
instance Core.FromJSON SearchResult where
        parseJSON
          = Core.withObject "SearchResult"
              (\ o ->
                 SearchResult Core.<$>
                   (o Core..:? "clusteredResults" Core..!= Core.mempty)
...
instance Core.FromJSON ShareScope where
        parseJSON
          = Core.withObject "ShareScope"
              (\ o ->
                 ShareScope Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "scope"))
...
instance Core.FromJSON Snippet where
        parseJSON
          = Core.withObject "Snippet"
              (\ o ->
                 Snippet Core.<$>
                   (o Core..:? "matchRanges" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "snippet"))
          ...
          = Core.withObject "SuggestResponse"
              (\ o ->
                 SuggestResponse Core.<$>
                   (o Core..:? "suggestResults" Core..!= Core.mempty))
...
instance Core.FromJSON UserId where
        parseJSON
          = Core.withObject "UserId"
              (\ o ->
                 UserId Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "originAppId")
                     Core.<*> (o Core..:? "type"))
