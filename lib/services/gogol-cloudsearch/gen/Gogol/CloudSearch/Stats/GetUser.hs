...
instance Core.GoogleRequest CloudSearchStatsGetUser
         where
        type Rs CloudSearchStatsGetUser =
             GetCustomerUserStatsResponse
        ...
        requestClient CloudSearchStatsGetUser{..}
          = go xgafv accessToken callback fromDateDay
              fromDateMonth
              fromDateYear
              toDateDay
              toDateMonth
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchStatsGetUserResource)
                      Core.mempty
