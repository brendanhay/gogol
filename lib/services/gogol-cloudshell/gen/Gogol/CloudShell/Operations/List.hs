...
instance Core.GoogleRequest CloudShellOperationsList
         where
        type Rs CloudShellOperationsList =
             ListOperationsResponse
        type Scopes CloudShellOperationsList =
        ...
        requestClient CloudShellOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudShellOperationsListResource)
                      Core.mempty
