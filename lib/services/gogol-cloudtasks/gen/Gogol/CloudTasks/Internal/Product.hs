...
instance Core.FromJSON BufferTaskRequest where
        parseJSON
          = Core.withObject "BufferTaskRequest"
              (\ o ->
                 BufferTaskRequest Core.<$> (o Core..:? "body"))
...
newCmekConfig 
    ::  CmekConfig
newCmekConfig = CmekConfig {kmsKey = Core.Nothing, name = Core.Nothing}
...
instance Core.FromJSON HeaderOverride where
        parseJSON
          = Core.withObject "HeaderOverride"
              (\ o ->
                 HeaderOverride Core.<$> (o Core..:? "header"))

instance Core.ToJSON HeaderOverride where
        toJSON HeaderOverride{..}
          = Core.object
              (Core.catMaybes [("header" Core..=) Core.<$> header])
...
instance Core.FromJSON QueryOverride where
        parseJSON
          = Core.withObject "QueryOverride"
              (\ o ->
                 QueryOverride Core.<$> (o Core..:? "queryParams"))
