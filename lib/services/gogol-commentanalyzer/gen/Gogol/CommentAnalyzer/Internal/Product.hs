          ...
          = Core.object
              (Core.catMaybes
                 [("clientToken" Core..=) Core.<$> clientToken,
                  ...
                  ("requestedAttributes" Core..=) Core.<$>
                    requestedAttributes,
                  ("sessionId" Core..=) Core.<$> sessionId,
                  ("spanAnnotations" Core..=) Core.<$>
                    spanAnnotations])
...
newAnalyzeCommentRequest_RequestedAttributes additional =
  AnalyzeCommentRequest_RequestedAttributes {additional = additional}
...
instance Core.FromJSON SuggestCommentScoreRequest
         where
        parseJSON
...
newSuggestCommentScoreRequest_AttributeScores additional =
  SuggestCommentScoreRequest_AttributeScores {additional = additional}
...
instance Core.FromJSON SuggestCommentScoreResponse
         where
        parseJSON
...
instance Core.ToJSON SuggestCommentScoreResponse
         where
