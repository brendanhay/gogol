...
newCheckUpgradeResponse_PypiDependencies 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> CheckUpgradeResponse_PypiDependencies
newCheckUpgradeResponse_PypiDependencies addtional =
  CheckUpgradeResponse_PypiDependencies {addtional = addtional}
...
newEnvironment_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Environment_Labels
newEnvironment_Labels addtional = Environment_Labels {addtional = addtional}
...
instance Core.ToJSON Environment_Labels where
        toJSON Environment_Labels{..} = Core.toJSON addtional
              ...
              (\ o ->
                 ImageVersion Core.<$>
                   (o Core..:? "creationDisabled") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "supportedPythonVersions" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "ListEnvironmentsResponse"
              (\ o ->
                 ListEnvironmentsResponse Core.<$>
                   (o Core..:? "environments" Core..!= Core.mempty)
          ...
          = Core.withObject "ListImageVersionsResponse"
              (\ o ->
                 ListImageVersionsResponse Core.<$>
                   (o Core..:? "imageVersions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
...
newSoftwareConfig_AirflowConfigOverrides 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> SoftwareConfig_AirflowConfigOverrides
newSoftwareConfig_AirflowConfigOverrides addtional =
  SoftwareConfig_AirflowConfigOverrides {addtional = addtional}
...
newSoftwareConfig_EnvVariables 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> SoftwareConfig_EnvVariables
newSoftwareConfig_EnvVariables addtional =
  SoftwareConfig_EnvVariables {addtional = addtional}
...
newSoftwareConfig_PypiPackages 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> SoftwareConfig_PypiPackages
newSoftwareConfig_PypiPackages addtional =
  SoftwareConfig_PypiPackages {addtional = addtional}
          ...
          = Core.withObject "WebServerNetworkAccessControl"
              (\ o ->
                 WebServerNetworkAccessControl Core.<$>
                   (o Core..:? "allowedIpRanges" Core..!= Core.mempty))
