...
newAirflowMetadataRetentionPolicyConfig =
  AirflowMetadataRetentionPolicyConfig
    {retentionDays = Core.Nothing, retentionMode = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 AirflowMetadataRetentionPolicyConfig Core.<$>
                   (o Core..:? "retentionDays") Core.<*>
                     (o Core..:? "retentionMode"))
...
newCheckUpgradeRequest 
    ::  CheckUpgradeRequest
newCheckUpgradeRequest = CheckUpgradeRequest {imageVersion = Core.Nothing}

instance Core.FromJSON CheckUpgradeRequest where
        parseJSON
          = Core.withObject "CheckUpgradeRequest"
              (\ o ->
                 CheckUpgradeRequest Core.<$>
                   (o Core..:? "imageVersion"))
...
instance Core.FromJSON CloudDataLineageIntegration
         where
        parseJSON
...
instance Core.ToJSON CloudDataLineageIntegration
         where
          ...
          = Core.withObject "ComposerWorkloadStatus"
              (\ o ->
                 ComposerWorkloadStatus Core.<$>
                   (o Core..:? "detailedStatusMessage") Core.<*>
                     (o Core..:? "state")
...
instance Core.ToJSON ComposerWorkloadStatus where
        toJSON ComposerWorkloadStatus{..}
          = Core.object
              (Core.catMaybes
                 [("detailedStatusMessage" Core..=) Core.<$>
...
newDataRetentionConfig =
  DataRetentionConfig
    { airflowMetadataRetentionConfig = Core.Nothing
          ...
          = Core.withObject "DataRetentionConfig"
              (\ o ->
                 DataRetentionConfig Core.<$>
                   (o Core..:? "airflowMetadataRetentionConfig")
...
newListUserWorkloadsConfigMapsResponse =
  ListUserWorkloadsConfigMapsResponse
    {nextPageToken = Core.Nothing, userWorkloadsConfigMaps = Core.Nothing}
...
newListUserWorkloadsSecretsResponse =
  ListUserWorkloadsSecretsResponse
    {nextPageToken = Core.Nothing, userWorkloadsSecrets = Core.Nothing}
...
instance Core.ToJSON ListUserWorkloadsSecretsResponse
         where
        toJSON ListUserWorkloadsSecretsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("userWorkloadsSecrets" Core..=) Core.<$>
...
newListWorkloadsResponse 
    ::  ListWorkloadsResponse
newListWorkloadsResponse =
  ListWorkloadsResponse {nextPageToken = Core.Nothing, workloads = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("airflowConfigOverrides" Core..=) Core.<$>
                  ...
                  ("webServerPluginsMode" Core..=) Core.<$>
...
instance Core.ToJSON TaskLogsRetentionConfig where
        toJSON TaskLogsRetentionConfig{..}
          = Core.object
              (Core.catMaybes
                 [("storageMode" Core..=) Core.<$> storageMode])
...
newTriggererResource =
  TriggererResource
    {count = Core.Nothing, cpu = Core.Nothing, memoryGb = Core.Nothing}
...
instance Core.FromJSON UserWorkloadsConfigMap_Data
         where
        parseJSON
          = Core.withObject "UserWorkloadsConfigMap_Data"
              (\ o ->
                 UserWorkloadsConfigMap_Data Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON UserWorkloadsConfigMap_Data
         where
        toJSON UserWorkloadsConfigMap_Data{..}
          = Core.toJSON additional
...
instance Core.FromJSON UserWorkloadsSecret_Data where
        parseJSON
          = Core.withObject "UserWorkloadsSecret_Data"
              (\ o ->
                 UserWorkloadsSecret_Data Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON UserWorkloadsSecret_Data where
        toJSON UserWorkloadsSecret_Data{..}
          = Core.toJSON additional
