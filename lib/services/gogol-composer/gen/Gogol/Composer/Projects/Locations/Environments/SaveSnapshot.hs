...
type ComposerProjectsLocationsEnvironmentsSaveSnapshotResource =
  "v1"
    Core.:> Core.CaptureMode "environment" "saveSnapshot" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] SaveSnapshotRequest
...
instance
  ...
  where
  type
    Rs ComposerProjectsLocationsEnvironmentsSaveSnapshot =
      Operation
  type
    Scopes ComposerProjectsLocationsEnvironmentsSaveSnapshot =
