                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text
                                     ...
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] AccessConfig
                                         Core.:>
...
newComputeInstancesAddAccessConfig 
    ...
    -> ComputeInstancesAddAccessConfig
newComputeInstancesAddAccessConfig instance' networkInterface payload project zone =
  ComputeInstancesAddAccessConfig
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient ComputeInstancesAddAccessConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeInstancesAddAccessConfigResource)
                      Core.mempty
