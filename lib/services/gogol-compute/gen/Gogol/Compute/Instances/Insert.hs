                     ...
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "requestId" Core.Text Core.:>
                           Core.QueryParam "sourceInstanceTemplate" Core.Text
                             Core.:>
                             Core.QueryParam "sourceMachineImage" Core.Text
                               Core.:>
...
instance Core.GoogleRequest ComputeInstancesInsert
         where
        ...
        requestClient ComputeInstancesInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeInstancesInsertResource)
                      Core.mempty
