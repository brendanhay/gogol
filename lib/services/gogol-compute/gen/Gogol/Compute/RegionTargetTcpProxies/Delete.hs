...
newComputeRegionTargetTcpProxiesDelete 
    ...
    -> ComputeRegionTargetTcpProxiesDelete
newComputeRegionTargetTcpProxiesDelete project region targetTcpProxy =
  ComputeRegionTargetTcpProxiesDelete
    { xgafv = Core.Nothing
