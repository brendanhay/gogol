                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text
                                   ...
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ResourcePolicy
...
newComputeResourcePoliciesPatch 
    ...
    -> ComputeResourcePoliciesPatch
newComputeResourcePoliciesPatch payload project region resourcePolicy =
  ComputeResourcePoliciesPatch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient ComputeResourcePoliciesPatch{..}
          = go project region resourcePolicy xgafv accessToken
              callback
              requestId
              updateMask
              uploadType
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeResourcePoliciesPatchResource)
                      Core.mempty
