                     ...
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "drainTimeoutSeconds" Core.Int32
                             Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text
                                   ...
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] Subnetwork
...
instance Core.GoogleRequest ComputeSubnetworksPatch
         where
        ...
        requestClient ComputeSubnetworksPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeSubnetworksPatchResource)
                      Core.mempty
