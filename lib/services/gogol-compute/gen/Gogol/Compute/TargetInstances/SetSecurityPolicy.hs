...
newComputeTargetInstancesSetSecurityPolicy 
    ...
    -> ComputeTargetInstancesSetSecurityPolicy
newComputeTargetInstancesSetSecurityPolicy payload project targetInstance zone =
  ComputeTargetInstancesSetSecurityPolicy
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           ComputeTargetInstancesSetSecurityPolicy
         where
        type Rs ComputeTargetInstancesSetSecurityPolicy =
             Operation
        type Scopes ComputeTargetInstancesSetSecurityPolicy =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient
          ComputeTargetInstancesSetSecurityPolicy{..}
          = go project zone targetInstance xgafv accessToken
              callback
              requestId
              uploadType
              uploadProtocol
