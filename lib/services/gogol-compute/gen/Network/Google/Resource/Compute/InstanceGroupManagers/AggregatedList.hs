...
module Network.Google.Resource.Compute.InstanceGroupManagers.AggregatedList
    ...
    -- * Request Lenses
    , igmalIncludeAllScopes
    , igmalReturnPartialSuccess
    , igmalOrderBy
    , igmalProject
    , igmalFilter
    , igmalPageToken
...
data InstanceGroupManagersAggregatedList =
  InstanceGroupManagersAggregatedList'
    { _igmalIncludeAllScopes :: !(Maybe Bool)
    , _igmalReturnPartialSuccess :: !(Maybe Bool)
...
instanceGroupManagersAggregatedList pIgmalProject_ =
  InstanceGroupManagersAggregatedList'
    { _igmalIncludeAllScopes = Nothing
    , _igmalReturnPartialSuccess = Nothing
...
igmalIncludeAllScopes :: Lens' InstanceGroupManagersAggregatedList (Maybe Bool)
igmalIncludeAllScopes
  = lens _igmalIncludeAllScopes
      (\ s a -> s{_igmalIncludeAllScopes = a})

-- | Opt-in for partial success behavior which provides partial results in
-- case of failure. The default value is false.
igmalReturnPartialSuccess :: Lens' InstanceGroupManagersAggregatedList (Maybe Bool)
igmalReturnPartialSuccess
  = lens _igmalReturnPartialSuccess
      (\ s a -> s{_igmalReturnPartialSuccess = a})
...
instance GoogleRequest
        ...
        requestClient
          InstanceGroupManagersAggregatedList'{..}
          = go _igmalProject _igmalIncludeAllScopes
              _igmalReturnPartialSuccess
              _igmalOrderBy
              _igmalFilter
              _igmalPageToken
