...
data InstancesList =
  InstancesList'
    { _il1ReturnPartialSuccess :: !(Maybe Bool)
...
instancesList pIl1Project_ pIl1Zone_ =
  InstancesList'
    { _il1ReturnPartialSuccess = Nothing
    , _il1OrderBy = Nothing
...
il1ReturnPartialSuccess :: Lens' InstancesList (Maybe Bool)
il1ReturnPartialSuccess
  = lens _il1ReturnPartialSuccess
      (\ s a -> s{_il1ReturnPartialSuccess = a})
...
instance GoogleRequest InstancesList where
        ...
        requestClient InstancesList'{..}
          = go _il1Project _il1Zone _il1ReturnPartialSuccess
              _il1OrderBy
              _il1Filter
              _il1PageToken
              (Just _il1MaxResults)
