...
data RegionDisksList =
  RegionDisksList'
    { _rdlReturnPartialSuccess :: !(Maybe Bool)
...
regionDisksList pRdlProject_ pRdlRegion_ =
  RegionDisksList'
    { _rdlReturnPartialSuccess = Nothing
    , _rdlOrderBy = Nothing
...
rdlReturnPartialSuccess :: Lens' RegionDisksList (Maybe Bool)
rdlReturnPartialSuccess
  = lens _rdlReturnPartialSuccess
      (\ s a -> s{_rdlReturnPartialSuccess = a})
...
instance GoogleRequest RegionDisksList where
        ...
        requestClient RegionDisksList'{..}
          = go _rdlProject _rdlRegion _rdlReturnPartialSuccess
              _rdlOrderBy
              _rdlFilter
              _rdlPageToken
              (Just _rdlMaxResults)
