...
data RegionOperationsList =
  RegionOperationsList'
    { _rolReturnPartialSuccess :: !(Maybe Bool)
...
regionOperationsList pRolProject_ pRolRegion_ =
  RegionOperationsList'
    { _rolReturnPartialSuccess = Nothing
    , _rolOrderBy = Nothing
...
rolReturnPartialSuccess :: Lens' RegionOperationsList (Maybe Bool)
rolReturnPartialSuccess
  = lens _rolReturnPartialSuccess
      (\ s a -> s{_rolReturnPartialSuccess = a})
...
instance GoogleRequest RegionOperationsList where
        ...
        requestClient RegionOperationsList'{..}
          = go _rolProject _rolRegion _rolReturnPartialSuccess
              _rolOrderBy
              _rolFilter
              _rolPageToken
              (Just _rolMaxResults)
