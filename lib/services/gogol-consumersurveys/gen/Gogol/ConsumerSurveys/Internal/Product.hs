...
instance Core.FromJSON MobileAppPanelsListResponse
         where
        parseJSON
...
instance Core.ToJSON MobileAppPanelsListResponse
         where
...
instance Core.FromJSON Survey where
        parseJSON
          = Core.withObject "Survey"
              (\ o ->
                 Survey Core.<$>
                   (o Core..:? "audience") Core.<*> (o Core..:? "cost")
                     Core.<*> (o Core..:? "customerData")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "owners" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "questions" Core..!= Core.mempty)
...
instance Core.FromJSON SurveyAudience where
        parseJSON
          = Core.withObject "SurveyAudience"
              (\ o ->
                 SurveyAudience Core.<$>
                   (o Core..:? "ages" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "country")
        ...
        toJSON SurveyAudience{..}
          = Core.object
              (Core.catMaybes
                 [("ages" Core..=) Core.<$> ages,
                  ("country" Core..=) Core.<$> country,
                  ("countrySubdivision" Core..=) Core.<$>
                    countrySubdivision,
                  ("gender" Core..=) Core.<$> gender,
                  ("languages" Core..=) Core.<$> languages,
                  ("mobileAppPanelId" Core..=) Core.<$>
                    mobileAppPanelId,
                  ("populationSource" Core..=) Core.<$>
                    populationSource])
          ...
          = Core.object
              (Core.catMaybes
                 [("costPerResponseNanos" Core..=) Core.. Core.AsText
                  ...
                  ("maxCostPerResponseNanos" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON SurveyQuestion where
        parseJSON
          = Core.withObject "SurveyQuestion"
              (\ o ->
                 SurveyQuestion Core.<$>
                   (o Core..:? "answerOrder") Core.<*>
                     (o Core..:? "answers" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("answerOrder" Core..=) Core.<$> answerOrder,
                  ...
                  ("mustPickSuggestion" Core..=) Core.<$>
                    mustPickSuggestion,
                  ("numStars" Core..=) Core.<$> numStars,
                  ("openTextPlaceholder" Core..=) Core.<$>
                    openTextPlaceholder,
                  ("openTextSuggestions" Core..=) Core.<$>
                    openTextSuggestions,
                  ("question" Core..=) Core.<$> question,
                  ("sentimentText" Core..=) Core.<$> sentimentText,
                  ("singleLineResponse" Core..=) Core.<$>
                    singleLineResponse,
                  ("thresholdAnswers" Core..=) Core.<$>
                    thresholdAnswers,
                  ("type" Core..=) Core.<$> type',
                  ("unitOfMeasurementLabel" Core..=) Core.<$>
...
newSurveyQuestionImage =
  SurveyQuestionImage
    {altText = Core.Nothing, data' = Core.Nothing, url = Core.Nothing}
          ...
          = Core.withObject "SurveyQuestionImage"
              (\ o ->
                 SurveyQuestionImage Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "data")
                     Core.<*> (o Core..:? "url"))
          ...
          = Core.withObject "SurveysStartRequest"
              (\ o ->
                 SurveysStartRequest Core.<$>
                   (o Core..:? "maxCostPerResponseNanos"))
