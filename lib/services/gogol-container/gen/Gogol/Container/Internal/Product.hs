...
newAdditionalNodeNetworkConfig =
  AdditionalNodeNetworkConfig
    {network = Core.Nothing, subnetwork = Core.Nothing}

instance Core.FromJSON AdditionalNodeNetworkConfig
         where
        parseJSON
...
instance Core.ToJSON AdditionalNodeNetworkConfig
         where
...
instance Core.FromJSON AdditionalPodNetworkConfig
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("maxPodsPerNode" Core..=) Core.<$> maxPodsPerNode,
                  ("networkAttachment" Core..=) Core.<$>
                    networkAttachment,
                  ("secondaryPodRange" Core..=) Core.<$>
                    secondaryPodRange,
                  ("subnetwork" Core..=) Core.<$> subnetwork])
...
newAdditionalPodRangesConfig =
  AdditionalPodRangesConfig
    {podRangeInfo = Core.Nothing, podRangeNames = Core.Nothing}
              ...
              (Core.catMaybes
                 [("cloudRunConfig" Core..=) Core.<$> cloudRunConfig,
                  ...
                  ("gcpFilestoreCsiDriverConfig" Core..=) Core.<$>
                    gcpFilestoreCsiDriverConfig,
                  ("gcsFuseCsiDriverConfig" Core..=) Core.<$>
                    gcsFuseCsiDriverConfig,
                  ...
                  ("parallelstoreCsiDriverConfig" Core..=) Core.<$>
                    parallelstoreCsiDriverConfig,
                  ("rayOperatorConfig" Core..=) Core.<$>
                    rayOperatorConfig,
                  ("statefulHaConfig" Core..=) Core.<$>
                    statefulHaConfig])
...
newAdvancedMachineFeatures =
  AdvancedMachineFeatures
    {enableNestedVirtualization = Core.Nothing, threadsPerCore = Core.Nothing}
...
newAutopilot 
    ::  Autopilot
newAutopilot =
  Autopilot {enabled = Core.Nothing, workloadPolicyConfig = Core.Nothing}
...
instance Core.ToJSON Autopilot where
        toJSON Autopilot{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("workloadPolicyConfig" Core..=) Core.<$>
                    workloadPolicyConfig])
...
instance Core.FromJSON AutopilotCompatibilityIssue
         where
        parseJSON
          = Core.withObject "AutopilotCompatibilityIssue"
              (\ o ->
                 AutopilotCompatibilityIssue Core.<$>
                   (o Core..:? "constraintType") Core.<*>
                     (o Core..:? "description")
...
instance Core.ToJSON AutopilotCompatibilityIssue
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("constraintType" Core..=) Core.<$> constraintType,
                  ("description" Core..=) Core.<$> description,
                  ("documentationUrl" Core..=) Core.<$>
                    documentationUrl,
                  ("incompatibilityType" Core..=) Core.<$>
                    incompatibilityType,
              ...
              (\ o ->
                 AutoprovisioningNodePoolDefaults Core.<$>
                   (o Core..:? "bootDiskKmsKey") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "insecureKubeletReadonlyPortEnabled")
...
newBestEffortProvisioning =
  BestEffortProvisioning
    {enabled = Core.Nothing, minProvisionNodes = Core.Nothing}
...
newCertificateAuthorityDomainConfig =
  CertificateAuthorityDomainConfig
    {fqdns = Core.Nothing, gcpSecretManagerCertificateConfig = Core.Nothing}
...
instance Core.ToJSON CertificateAuthorityDomainConfig
         where
...
newCheckAutopilotCompatibilityResponse =
  CheckAutopilotCompatibilityResponse
    {issues = Core.Nothing, summary = Core.Nothing}
              ...
              (Core.catMaybes
                 [("addonsConfig" Core..=) Core.<$> addonsConfig,
                  ...
                  ("notificationConfig" Core..=) Core.<$>
                    notificationConfig,
                  ("parentProductConfig" Core..=) Core.<$>
                    parentProductConfig,
                  ("privateClusterConfig" Core..=) Core.<$>
                    privateClusterConfig,
                  ("rbacBindingConfig" Core..=) Core.<$>
                    rbacBindingConfig,
                  ...
                  ("secretManagerConfig" Core..=) Core.<$>
                    secretManagerConfig,
                  ("securityPostureConfig" Core..=) Core.<$>
                    securityPostureConfig,
                  ...
                  ("tpuIpv4CidrBlock" Core..=) Core.<$>
                    tpuIpv4CidrBlock,
                  ("userManagedKeysConfig" Core..=) Core.<$>
                    userManagedKeysConfig,
...
newClusterNetworkPerformanceConfig 
    ::  ClusterNetworkPerformanceConfig
newClusterNetworkPerformanceConfig =
  ClusterNetworkPerformanceConfig {totalEgressBandwidthTier = Core.Nothing}
...
instance Core.ToJSON ClusterNetworkPerformanceConfig
         where
              ...
              (\ o ->
                 ClusterUpdate Core.<$>
                   (o Core..:? "additionalPodRangesConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "desiredEnableFqdnNetworkPolicy")
                     ...
                     Core.<*>
                     (o Core..:? "desiredInTransitEncryptionConfig")
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "desiredNetworkPerformanceConfig")
                     Core.<*> (o Core..:? "desiredNodeKubeletConfig")
                     Core.<*>
                     (o Core..:? "desiredNodePoolAutoConfigKubeletConfig")
                     Core.<*>
                     (o Core..:?
...
newCompliancePostureConfig =
  CompliancePostureConfig
    {complianceStandards = Core.Nothing, mode = Core.Nothing}
          ...
          = Core.withObject "CompliancePostureConfig"
              (\ o ->
                 CompliancePostureConfig Core.<$>
                   (o Core..:? "complianceStandards") Core.<*>
                     (o Core..:? "mode"))
...
instance Core.FromJSON ComplianceStandard where
        parseJSON
          = Core.withObject "ComplianceStandard"
              (\ o ->
                 ComplianceStandard Core.<$> (o Core..:? "standard"))
...
newControlPlaneEndpointsConfig =
  ControlPlaneEndpointsConfig
    {dnsEndpointConfig = Core.Nothing, ipEndpointsConfig = Core.Nothing}

instance Core.FromJSON ControlPlaneEndpointsConfig
         where
        parseJSON
...
instance Core.ToJSON ControlPlaneEndpointsConfig
         where
        toJSON ControlPlaneEndpointsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("dnsEndpointConfig" Core..=) Core.<$>
                    dnsEndpointConfig,
                  ("ipEndpointsConfig" Core..=) Core.<$>
                    ipEndpointsConfig])
...
newDNSEndpointConfig =
  DNSEndpointConfig
    {allowExternalTraffic = Core.Nothing, endpoint = Core.Nothing}
...
instance Core.ToJSON DNSEndpointConfig where
        toJSON DNSEndpointConfig{..}
          = Core.object
              (Core.catMaybes
                 [("allowExternalTraffic" Core..=) Core.<$>
...
newEnterpriseConfig 
    ::  EnterpriseConfig
newEnterpriseConfig =
  EnterpriseConfig {clusterTier = Core.Nothing, desiredTier = Core.Nothing}
...
instance Core.FromJSON GPUDriverInstallationConfig
         where
        parseJSON
...
instance Core.ToJSON GPUDriverInstallationConfig
         where
        toJSON GPUDriverInstallationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("gpuDriverVersion" Core..=) Core.<$>
                    gpuDriverVersion])
...
newGcsFuseCsiDriverConfig 
    ::  GcsFuseCsiDriverConfig
newGcsFuseCsiDriverConfig = GcsFuseCsiDriverConfig {enabled = Core.Nothing}

instance Core.FromJSON GcsFuseCsiDriverConfig where
        parseJSON
          = Core.withObject "GcsFuseCsiDriverConfig"
              (\ o ->
                 GcsFuseCsiDriverConfig Core.<$>
                   (o Core..:? "enabled"))
...
newHugepagesConfig 
    ::  HugepagesConfig
newHugepagesConfig =
  HugepagesConfig {hugepageSize1g = Core.Nothing, hugepageSize2m = Core.Nothing}
              ...
              (\ o ->
                 IPAllocationPolicy Core.<$>
                   (o Core..:? "additionalPodRangesConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "defaultPodIpv4RangeUtilization")
          ...
          = Core.object
              (Core.catMaybes
                 [("authorizedNetworksConfig" Core..=) Core.<$>
                  ...
                  ("enablePublicEndpoint" Core..=) Core.<$>
...
instance Core.FromJSON K8sBetaAPIConfig where
        parseJSON
          = Core.withObject "K8sBetaAPIConfig"
              (\ o ->
                 K8sBetaAPIConfig Core.<$> (o Core..:? "enabledApis"))

instance Core.ToJSON K8sBetaAPIConfig where
        toJSON K8sBetaAPIConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enabledApis" Core..=) Core.<$> enabledApis])
              ...
              (\ o ->
                 MasterAuthorizedNetworksConfig Core.<$>
                   (o Core..:? "cidrBlocks") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "privateEndpointEnforcementEnabled"))
...
newMonitoringConfig =
  MonitoringConfig
    { advancedDatapathObservabilityConfig = Core.Nothing
          ...
          = Core.withObject "MonitoringConfig"
              (\ o ->
                 MonitoringConfig Core.<$>
                   (o Core..:? "advancedDatapathObservabilityConfig")
              ...
              (\ o ->
                 NetworkConfig Core.<$>
                   (o Core..:? "datapathProvider") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "enableCiliumClusterwideNetworkPolicy")
          ...
          = Core.object
              (Core.catMaybes
                 [("datapathProvider" Core..=) Core.<$>
                  ...
                  ("enableMultiNetworking" Core..=) Core.<$>
...
newNodeAffinity =
  NodeAffinity
    {key = Core.Nothing, operator = Core.Nothing, values = Core.Nothing}
...
instance Core.FromJSON NodeAffinity where
        parseJSON
          = Core.withObject "NodeAffinity"
              (\ o ->
                 NodeAffinity Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "operator")
                     Core.<*> (o Core..:? "values"))
              ...
              (\ o ->
                 NodeConfig Core.<$>
                   (o Core..:? "accelerators") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "secondaryBootDiskUpdateStrategy")
          ...
          = Core.object
              (Core.catMaybes
                 [("accelerators" Core..=) Core.<$> accelerators,
                  ...
                  ("confidentialNodes" Core..=) Core.<$>
                    confidentialNodes,
                  ("containerdConfig" Core..=) Core.<$>
                    containerdConfig,
                  ("diskSizeGb" Core..=) Core.<$> diskSizeGb,
                  ("diskType" Core..=) Core.<$> diskType,
                  ("effectiveCgroupMode" Core..=) Core.<$>
                    effectiveCgroupMode,
                  ...
                  ("localNvmeSsdBlockConfig" Core..=) Core.<$>
                    localNvmeSsdBlockConfig,
                  ("localSsdCount" Core..=) Core.<$> localSsdCount,
                  ("localSsdEncryptionMode" Core..=) Core.<$>
                  ...
                  ("reservationAffinity" Core..=) Core.<$>
                    reservationAffinity,
                  ("resourceLabels" Core..=) Core.<$> resourceLabels,
                  ("resourceManagerTags" Core..=) Core.<$>
                    resourceManagerTags,
                  ("sandboxConfig" Core..=) Core.<$> sandboxConfig,
                  ("secondaryBootDiskUpdateStrategy" Core..=) Core.<$>
                    secondaryBootDiskUpdateStrategy,
                  ("secondaryBootDisks" Core..=) Core.<$>
                    secondaryBootDisks,
                  ("serviceAccount" Core..=) Core.<$> serviceAccount,
                  ("shieldedInstanceConfig" Core..=) Core.<$>
                    shieldedInstanceConfig,
                  ("soleTenantConfig" Core..=) Core.<$>
                    soleTenantConfig,
                  ("spot" Core..=) Core.<$> spot,
...
instance Core.ToJSON NodePool where
        toJSON NodePool{..}
          = Core.object
              (Core.catMaybes
                 [("autoscaling" Core..=) Core.<$> autoscaling,
                  ("bestEffortProvisioning" Core..=) Core.<$>
                    bestEffortProvisioning,
                  ("conditions" Core..=) Core.<$> conditions,
...
instance Core.FromJSON ParallelstoreCsiDriverConfig
         where
        parseJSON
...
instance Core.ToJSON ParallelstoreCsiDriverConfig
         where
...
newParentProductConfig 
    ::  ParentProductConfig
newParentProductConfig =
  ParentProductConfig {labels = Core.Nothing, productName = Core.Nothing}
...
instance Core.FromJSON ParentProductConfig_Labels
         where
        parseJSON
          = Core.withObject "ParentProductConfig_Labels"
              (\ o ->
                 ParentProductConfig_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ParentProductConfig_Labels where
        toJSON ParentProductConfig_Labels{..}
          = Core.toJSON additional
...
newPrivateRegistryAccessConfig =
  PrivateRegistryAccessConfig
    {certificateAuthorityDomainConfig = Core.Nothing, enabled = Core.Nothing}

instance Core.FromJSON PrivateRegistryAccessConfig
         where
        parseJSON
          = Core.withObject "PrivateRegistryAccessConfig"
              (\ o ->
                 PrivateRegistryAccessConfig Core.<$>
                   (o Core..:? "certificateAuthorityDomainConfig")
                     Core.<*> (o Core..:? "enabled"))

instance Core.ToJSON PrivateRegistryAccessConfig
         where
...
instance Core.FromJSON QueuedProvisioning where
        parseJSON
          = Core.withObject "QueuedProvisioning"
              (\ o ->
                 QueuedProvisioning Core.<$> (o Core..:? "enabled"))
...
newRBACBindingConfig =
  RBACBindingConfig
    { enableInsecureBindingSystemAuthenticated = Core.Nothing
...
newRangeInfo 
    ::  RangeInfo
newRangeInfo = RangeInfo {rangeName = Core.Nothing, utilization = Core.Nothing}
...
newRayClusterLoggingConfig 
    ::  RayClusterLoggingConfig
newRayClusterLoggingConfig = RayClusterLoggingConfig {enabled = Core.Nothing}
...
instance Core.FromJSON RayClusterMonitoringConfig
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("channel" Core..=) Core.<$> channel,
                  ...
                  ("upgradeTargetVersion" Core..=) Core.<$>
...
instance Core.FromJSON ResourceManagerTags where
        parseJSON
          = Core.withObject "ResourceManagerTags"
              (\ o ->
                 ResourceManagerTags Core.<$> (o Core..:? "tags"))
...
instance Core.FromJSON ResourceManagerTags_Tags where
        parseJSON
          = Core.withObject "ResourceManagerTags_Tags"
              (\ o ->
                 ResourceManagerTags_Tags Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ResourceManagerTags_Tags where
        toJSON ResourceManagerTags_Tags{..}
          = Core.toJSON additional
...
newSecondaryBootDiskUpdateStrategy 
    ::  SecondaryBootDiskUpdateStrategy
newSecondaryBootDiskUpdateStrategy = SecondaryBootDiskUpdateStrategy
...
instance Core.ToJSON SecondaryBootDiskUpdateStrategy
         where
        toJSON = Core.const Core.emptyObject
...
newSecretManagerConfig 
    ::  SecretManagerConfig
newSecretManagerConfig = SecretManagerConfig {enabled = Core.Nothing}

instance Core.FromJSON SecretManagerConfig where
        parseJSON
          = Core.withObject "SecretManagerConfig"
              (\ o ->
                 SecretManagerConfig Core.<$> (o Core..:? "enabled"))
...
newSecurityPostureConfig 
    ::  SecurityPostureConfig
newSecurityPostureConfig =
  SecurityPostureConfig {mode = Core.Nothing, vulnerabilityMode = Core.Nothing}
...
newSoleTenantConfig 
    ::  SoleTenantConfig
newSoleTenantConfig = SoleTenantConfig {nodeAffinities = Core.Nothing}
...
instance Core.FromJSON StatefulHAConfig where
        parseJSON
          = Core.withObject "StatefulHAConfig"
              (\ o ->
                 StatefulHAConfig Core.<$> (o Core..:? "enabled"))
              ...
              (\ o ->
                 UserManagedKeysConfig Core.<$>
                   (o Core..:? "aggregationCa") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "serviceAccountVerificationKeys"))
...
newWorkloadPolicyConfig 
    ::  WorkloadPolicyConfig
newWorkloadPolicyConfig = WorkloadPolicyConfig {allowNetAdmin = Core.Nothing}
