              ...
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "addonsConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "instanceGroupUrls" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "nodePools" Core..!= Core.mempty)
...
newCluster_ResourceLabels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Cluster_ResourceLabels
newCluster_ResourceLabels addtional =
  Cluster_ResourceLabels {addtional = addtional}
              ...
              (\ o ->
                 ClusterAutoscaling Core.<$>
                   (o Core..:? "autoprovisioningLocations" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "resourceLimits" Core..!= Core.mempty))
...
instance Core.FromJSON ClusterUpdate where
        parseJSON
          = Core.withObject "ClusterUpdate"
              (\ o ->
                 ClusterUpdate Core.<$>
                   (o Core..:? "desiredAddonsConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "desiredLocations" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "desiredWorkloadIdentityConfig"))
...
instance Core.FromJSON Filter where
        parseJSON
          = Core.withObject "Filter"
              (\ o ->
                 Filter Core.<$>
                   (o Core..:? "eventType" Core..!= Core.mempty))
          ...
          = Core.withObject "GetOpenIDConfigResponse"
              (\ o ->
                 GetOpenIDConfigResponse Core.<$>
                   (o Core..:? "cacheHeader") Core.<*>
                     (o Core..:? "claims_supported" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "grant_types" Core..!= Core.mempty)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "response_types_supported" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "subject_types_supported" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "HttpCacheControlResponseHeader"
              (\ o ->
                 HttpCacheControlResponseHeader Core.<$>
                   (o Core..:? "age") Core.<*> (o Core..:? "directive")
                     Core.<*> (o Core..:? "expires"))
          ...
          = Core.withObject "IPAllocationPolicy"
              (\ o ->
                 IPAllocationPolicy Core.<$>
                   (o Core..:? "clusterIpv4Cidr") Core.<*>
                     (o Core..:? "clusterIpv4CidrBlock")
...
newLinuxNodeConfig_Sysctls 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> LinuxNodeConfig_Sysctls
newLinuxNodeConfig_Sysctls addtional =
  LinuxNodeConfig_Sysctls {addtional = addtional}
              ...
              (\ o ->
                 ListClustersResponse Core.<$>
                   (o Core..:? "clusters" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "missingZones" Core..!= Core.mempty))
              ...
              (\ o ->
                 ListUsableSubnetworksResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "subnetworks" Core..!= Core.mempty))
          ...
          = Core.withObject "LoggingComponentConfig"
              (\ o ->
                 LoggingComponentConfig Core.<$>
                   (o Core..:? "enableComponents" Core..!= Core.mempty))
...
newtype MaintenanceWindow_MaintenanceExclusions = MaintenanceWindow_MaintenanceExclusions
    {
      -- | 
      addtional :: (Core.HashMap Core.Text TimeWindow)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newMaintenanceWindow_MaintenanceExclusions 
    ::  Core.HashMap Core.Text TimeWindow
       -- ^  See 'addtional'.
    -> MaintenanceWindow_MaintenanceExclusions
newMaintenanceWindow_MaintenanceExclusions addtional =
  MaintenanceWindow_MaintenanceExclusions {addtional = addtional}
          ...
          = Core.withObject "MasterAuthorizedNetworksConfig"
              (\ o ->
                 MasterAuthorizedNetworksConfig Core.<$>
                   (o Core..:? "cidrBlocks" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "enabled"))
...
instance Core.FromJSON NodeConfig where
        parseJSON
          = Core.withObject "NodeConfig"
              (\ o ->
                 NodeConfig Core.<$>
                   (o Core..:? "accelerators" Core..!= Core.mempty)
...
newNodeConfig_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> NodeConfig_Labels
newNodeConfig_Labels addtional = NodeConfig_Labels {addtional = addtional}
...
instance Core.ToJSON NodeConfig_Labels where
        toJSON NodeConfig_Labels{..} = Core.toJSON addtional
...
newNodeConfig_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> NodeConfig_Metadata
newNodeConfig_Metadata addtional = NodeConfig_Metadata {addtional = addtional}
...
instance Core.FromJSON Operation where
        parseJSON
          = Core.withObject "Operation"
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "clusterConditions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "detail")
                     Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "error")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "nodepoolConditions" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 ReleaseChannelConfig Core.<$>
                   (o Core..:? "channel") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "validVersions" Core..!= Core.mempty))
              ...
              (\ o ->
                 SecurityBulletinEvent Core.<$>
                   (o Core..:? "affectedSupportedMinors" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "patchedVersions" Core..!= Core.mempty)
...
instance Core.FromJSON ServerConfig where
        parseJSON
          = Core.withObject "ServerConfig"
              (\ o ->
                 ServerConfig Core.<$>
                   (o Core..:? "channels" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "defaultClusterVersion")
                     Core.<*> (o Core..:? "defaultImageType")
                     Core.<*>
                     (o Core..:? "validImageTypes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "validMasterVersions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "validNodeVersions" Core..!=
                        Core.mempty))
...
newSetLabelsRequest_ResourceLabels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> SetLabelsRequest_ResourceLabels
newSetLabelsRequest_ResourceLabels addtional =
  SetLabelsRequest_ResourceLabels {addtional = addtional}
          ...
          = Core.withObject "UpgradeSettings"
              (\ o ->
                 UpgradeSettings Core.<$>
                   (o Core..:? "maxSurge") Core.<*>
                     (o Core..:? "maxUnavailable"))
              ...
              (\ o ->
                 UsableSubnetwork Core.<$>
                   (o Core..:? "ipCidrRange") Core.<*>
                     (o Core..:? "network")
                     Core.<*>
                     (o Core..:? "secondaryIpRanges" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "statusMessage")
                     Core.<*> (o Core..:? "subnetwork"))
