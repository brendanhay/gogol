...
type ContainerProjectsLocationsClustersNodePoolsSetSizeResource =
  "v1"
    Core.:> Core.CaptureMode "name" "setSize" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] SetNodePoolSizeRequest
...
instance
  ...
  where
  type
    Rs ContainerProjectsLocationsClustersNodePoolsSetSize =
      Operation
  type
    Scopes ContainerProjectsLocationsClustersNodePoolsSetSize =
