...
type ContainerProjectsZonesClustersSetMaintenancePolicyResource =
  "v1"
    ...
    Core.:> "clusters"
    Core.:> Core.CaptureMode "clusterId" "setMaintenancePolicy" Core.Text
...
instance
  ...
  where
  type
    Rs ContainerProjectsZonesClustersSetMaintenancePolicy =
      Operation
  type
    Scopes ContainerProjectsZonesClustersSetMaintenancePolicy =
