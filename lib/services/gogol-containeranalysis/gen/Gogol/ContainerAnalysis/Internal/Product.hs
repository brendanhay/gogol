          ...
          = Core.withObject "BatchCreateOccurrencesRequest"
              (\ o ->
                 BatchCreateOccurrencesRequest Core.<$>
                   (o Core..:? "occurrences" Core..!= Core.mempty))
              ...
              (\ o ->
                 BuildProvenance Core.<$>
                   (o Core..:? "buildOptions") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "builtArtifacts" Core..!= Core.mempty)
...
newContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts =
  ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts
    {images = Core.Nothing, objects = Core.Nothing}
...
instance Core.FromJSON DeploymentNote where
        parseJSON
          = Core.withObject "DeploymentNote"
              (\ o ->
                 DeploymentNote Core.<$>
                   (o Core..:? "resourceUri" Core..!= Core.mempty))
          ...
          = Core.withObject "DiscoveryOccurrence"
              (\ o ->
                 DiscoveryOccurrence Core.<$>
                   (o Core..:? "analysisStatus") Core.<*>
                     (o Core..:? "analysisStatusError")
        ...
        parseJSON
          = Core.withObject "Fingerprint"
              (\ o ->
                 Fingerprint Core.<$>
                   (o Core..:? "v1Name") Core.<*>
                     (o Core..:? "v2Blob" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "v2Name"))
              ...
              (\ o ->
                 ImageOccurrence Core.<$>
                   (o Core..:? "baseResourceUrl") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "layerInfo" Core..!= Core.mempty))
              ...
              (\ o ->
                 InTotoProvenance Core.<$>
                   (o Core..:? "builderConfig") Core.<*>
                     (o Core..:? "materials" Core..!= Core.mempty)
              ...
              (\ o ->
                 Note Core.<$>
                   (o Core..:? "attestation") Core.<*>
                     ...
                     Core.<*> (o Core..:? "package")
                     Core.<*>
                     (o Core..:? "relatedNoteNames" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "relatedUrl" Core..!= Core.mempty)
...
instance Core.FromJSON PackageNote where
        parseJSON
          = Core.withObject "PackageNote"
              (\ o ->
                 PackageNote Core.<$>
                   (o Core..:? "distribution" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name"))
          ...
          = Core.withObject "PackageOccurrence"
              (\ o ->
                 PackageOccurrence Core.<$>
                   (o Core..:? "location" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "name"))
              ...
              (\ o ->
                 Recipe Core.<$>
                   (o Core..:? "arguments" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "entryPoint")
                     Core.<*>
                     (o Core..:? "environment" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON UpgradeNote where
        parseJSON
          = Core.withObject "UpgradeNote"
              (\ o ->
                 UpgradeNote Core.<$>
                   (o Core..:? "distributions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "package")
                     Core.<*> (o Core..:? "version")
              ...
              (\ o ->
                 VulnerabilityNote Core.<$>
                   (o Core..:? "cvssScore") Core.<*>
                     ...
                     Core.<*> (o Core..:? "sourceUpdateTime")
                     Core.<*>
                     (o Core..:? "windowsDetails" Core..!= Core.mempty))
              ...
              (\ o ->
                 VulnerabilityOccurrence Core.<$>
                   (o Core..:? "cvssScore") Core.<*>
                     ...
                     Core.<*> (o Core..:? "longDescription")
                     Core.<*>
                     (o Core..:? "packageIssue" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "relatedUrls" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "severity")
                     Core.<*> (o Core..:? "shortDescription")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.withObject "VulnerabilityOccurrencesSummary"
              (\ o ->
                 VulnerabilityOccurrencesSummary Core.<$>
                   (o Core..:? "counts" Core..!= Core.mempty))
              ...
              (\ o ->
                 WindowsDetail Core.<$>
                   (o Core..:? "cpeUri") Core.<*>
                     (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "fixingKbs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name"))
              ...
              (\ o ->
                 WindowsUpdate Core.<$>
                   (o Core..:? "categories" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "kbArticleIds" Core..!= Core.mempty)
