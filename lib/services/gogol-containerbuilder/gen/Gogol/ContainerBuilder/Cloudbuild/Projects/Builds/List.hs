...
-- |
-- Module      : Gogol.ContainerBuilder.Cloudbuild.Projects.Builds.List
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListBuildsResponse
...
instance Core.GoogleRequest
           CloudbuildProjectsBuildsList
         where
        type Rs CloudbuildProjectsBuildsList =
             ListBuildsResponse
        type Scopes CloudbuildProjectsBuildsList =
