...
-- |
-- Module      : Gogol.ContainerBuilder.Cloudbuild.Projects.Locations.Triggers.List
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsTriggersList
         where
        type Rs CloudbuildProjectsLocationsTriggersList =
             ListBuildTriggersResponse
        type Scopes CloudbuildProjectsLocationsTriggersList =
