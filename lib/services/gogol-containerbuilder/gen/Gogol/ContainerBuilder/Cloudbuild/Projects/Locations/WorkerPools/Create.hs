...
-- |
-- Module      : Gogol.ContainerBuilder.Cloudbuild.Projects.Locations.WorkerPools.Create
                     ...
                     Core.QueryParam "validateOnly" Core.Bool Core.:>
                       Core.QueryParam "workerPoolId" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] WorkerPool Core.:>
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsWorkerPoolsCreate
         where
        type Rs CloudbuildProjectsLocationsWorkerPoolsCreate
             = Operation
        type Scopes
               CloudbuildProjectsLocationsWorkerPoolsCreate
