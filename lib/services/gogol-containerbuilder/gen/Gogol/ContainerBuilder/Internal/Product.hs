...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "AddBitbucketServerConnectedRepositoryRequest"
              (\ o ->
                 AddBitbucketServerConnectedRepositoryRequest Core.<$>
...
newAddBitbucketServerConnectedRepositoryResponse =
  AddBitbucketServerConnectedRepositoryResponse
    {config = Core.Nothing, connectedRepository = Core.Nothing}
...
instance Core.FromJSON ArtifactResult where
        parseJSON
          = Core.withObject "ArtifactResult"
              (\ o ->
                 ArtifactResult Core.<$>
                   (o Core..:? "fileHash" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "location"))
...
instance Core.FromJSON Artifacts where
        parseJSON
          = Core.withObject "Artifacts"
              (\ o ->
                 Artifacts Core.<$>
                   (o Core..:? "images" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "objects"))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BatchCreateBitbucketServerConnectedRepositoriesRequest
                   Core.<$>
                   (o Core..:? "requests" Core..!= Core.mempty))
...
newBuild_Substitutions 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Build_Substitutions
newBuild_Substitutions addtional = Build_Substitutions {addtional = addtional}
...
newtype Build_Timing = Build_Timing
    {
      -- | 
      addtional :: (Core.HashMap Core.Text TimeSpan)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newBuild_Timing 
    ::  Core.HashMap Core.Text TimeSpan
       -- ^  See 'addtional'.
    -> Build_Timing
newBuild_Timing addtional = Build_Timing {addtional = addtional}
...
instance Core.ToJSON Build_Timing where
        toJSON Build_Timing{..} = Core.toJSON addtional
              ...
              (\ o ->
                 BuildOptions Core.<$>
                   (o Core..:? "diskSizeGb") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "secretEnv" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "sourceProvenanceHash" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 BuildTrigger Core.<$>
                   (o Core..:? "approvalConfig") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "ignoredFiles" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "includedFiles" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
...
newBuildTrigger_Substitutions 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> BuildTrigger_Substitutions
newBuildTrigger_Substitutions addtional =
  BuildTrigger_Substitutions {addtional = addtional}
...
instance Core.FromJSON FileHashes where
        parseJSON
          = Core.withObject "FileHashes"
              (\ o ->
                 FileHashes Core.<$>
                   (o Core..:? "fileHash" Core..!= Core.mempty))
...
newInlineSecret_EnvMap 
    ::  Core.HashMap Core.Text Core.Base64
       -- ^  See 'addtional'.
    -> InlineSecret_EnvMap
newInlineSecret_EnvMap addtional = InlineSecret_EnvMap {addtional = addtional}
              ...
              (\ o ->
                 ListBuildTriggersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "triggers" Core..!= Core.mempty))
          ...
          = Core.withObject "ListBuildsResponse"
              (\ o ->
                 ListBuildsResponse Core.<$>
                   (o Core..:? "builds" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject
              ...
              (\ o ->
                 ListGithubEnterpriseConfigsResponse Core.<$>
                   (o Core..:? "configs" Core..!= Core.mempty))
...
newNotification_StructDelivery 
    ...
    -> Notification_StructDelivery
newNotification_StructDelivery addtional =
  Notification_StructDelivery {addtional = addtional}

instance Core.FromJSON Notification_StructDelivery
         where
        parseJSON
          = Core.withObject "Notification_StructDelivery"
              (\ o ->
                 Notification_StructDelivery Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Notification_StructDelivery
         where
...
instance Core.FromJSON NotifierConfig where
        parseJSON
          = Core.withObject "NotifierConfig"
              (\ o ->
                 NotifierConfig Core.<$>
                   (o Core..:? "apiVersion") Core.<*>
                     (o Core..:? "kind")
...
instance Core.FromJSON NotifierMetadata where
        parseJSON
          = Core.withObject "NotifierMetadata"
              (\ o ->
                 NotifierMetadata Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "notifier"))
...
instance Core.FromJSON NotifierSecret where
        parseJSON
          = Core.withObject "NotifierSecret"
              (\ o ->
                 NotifierSecret Core.<$>
...
instance Core.FromJSON NotifierSecretRef where
        parseJSON
          = Core.withObject "NotifierSecretRef"
              (\ o ->
...
instance Core.FromJSON NotifierSpec where
        parseJSON
          = Core.withObject "NotifierSpec"
              (\ o ->
                 NotifierSpec Core.<$>
                   (o Core..:? "notification") Core.<*>
                     (o Core..:? "secrets" Core..!= Core.mempty))
...
newRepoSource_Substitutions 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> RepoSource_Substitutions
newRepoSource_Substitutions addtional =
  RepoSource_Substitutions {addtional = addtional}
              ...
              (\ o ->
                 Results Core.<$>
                   (o Core..:? "artifactManifest") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "buildStepImages" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "buildStepOutputs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "images" Core..!= Core.mempty)
...
instance Core.FromJSON SMTPDelivery where
        parseJSON
          = Core.withObject "SMTPDelivery"
              (\ o ->
                 SMTPDelivery Core.<$>
                   (o Core..:? "fromAddress") Core.<*>
                     (o Core..:? "password")
                     Core.<*> (o Core..:? "port")
                     Core.<*>
                     (o Core..:? "recipientAddresses" Core..!=
                        Core.mempty)
...
newSecret_SecretEnv 
    ::  Core.HashMap Core.Text Core.Base64
       -- ^  See 'addtional'.
    -> Secret_SecretEnv
newSecret_SecretEnv addtional = Secret_SecretEnv {addtional = addtional}
...
instance Core.ToJSON Secret_SecretEnv where
        toJSON Secret_SecretEnv{..} = Core.toJSON addtional
...
instance Core.FromJSON Secrets where
        parseJSON
          = Core.withObject "Secrets"
              (\ o ->
                 Secrets Core.<$>
                   (o Core..:? "inline" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "secretManager" Core..!= Core.mempty))
...
newSourceProvenance_FileHashes 
    ::  Core.HashMap Core.Text FileHashes
       -- ^  See 'addtional'.
    -> SourceProvenance_FileHashes
newSourceProvenance_FileHashes addtional =
  SourceProvenance_FileHashes {addtional = addtional}
...
newWorkerPool_Annotations 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> WorkerPool_Annotations
newWorkerPool_Annotations addtional =
  WorkerPool_Annotations {addtional = addtional}
