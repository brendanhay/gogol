...
instance Core.FromJSON Promotion where
        parseJSON
          = Core.withObject "Promotion"
              (\ o ->
                 Promotion Core.<$>
                   (o Core..:? "bodyLines" Core..!= Core.mempty)
          ...
          = Core.withObject "Promotion_BodyLinesItem"
              (\ o ->
                 Promotion_BodyLinesItem Core.<$>
                   (o Core..:? "htmlTitle") Core.<*> (o Core..:? "link")
                     Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "url"))
...
newPromotion_Image =
  Promotion_Image
    {height = Core.Nothing, source = Core.Nothing, width = Core.Nothing}
          ...
          = Core.withObject "Promotion_Image"
              (\ o ->
                 Promotion_Image Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "source")
                     Core.<*> (o Core..:? "width"))
...
newResult_Pagemap 
    ...
    -> Result_Pagemap
newResult_Pagemap addtional = Result_Pagemap {addtional = addtional}
...
instance Core.ToJSON Result_Pagemap where
        toJSON Result_Pagemap{..} = Core.toJSON addtional
...
newSearch_Context 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'addtional'.
    -> Search_Context
newSearch_Context addtional = Search_Context {addtional = addtional}
...
instance Core.ToJSON Search_Context where
        toJSON Search_Context{..} = Core.toJSON addtional
...
instance Core.FromJSON Search_Queries where
        parseJSON
          = Core.withObject "Search_Queries"
              (\ o ->
                 Search_Queries Core.<$>
                   (o Core..:? "nextPage" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "previousPage" Core..!= Core.mempty)
...
instance Core.FromJSON Search_Queries_NextPageItem
         where
        parseJSON
          = Core.withObject "Search_Queries_NextPageItem"
              (\ o ->
                 Search_Queries_NextPageItem Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cr")
                     Core.<*> (o Core..:? "cx")
...
instance Core.ToJSON Search_Queries_NextPageItem
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("count" Core..=) Core.<$> count,
                  ...
                  ("disableCnTwTranslation" Core..=) Core.<$>
                  ...
                  ("siteSearchFilter" Core..=) Core.<$>
                    siteSearchFilter,
                  ("sort" Core..=) Core.<$> sort,
                  ("startIndex" Core..=) Core.<$> startIndex,
                  ("startPage" Core..=) Core.<$> startPage,
                  ("title" Core..=) Core.<$> title,
                  ("totalResults" Core..=) Core.. Core.AsText Core.<$>
                    totalResults])
...
instance Core.ToJSON Search_Queries_PreviousPageItem
         where
...
instance Core.FromJSON Search_Queries_RequestItem
         where
        parseJSON
...
instance Core.ToJSON Search_SearchInformation where
        toJSON Search_SearchInformation{..}
          = Core.object
              (Core.catMaybes
                 [("formattedSearchTime" Core..=) Core.<$>
                    formattedSearchTime,
                  ("formattedTotalResults" Core..=) Core.<$>
...
newSearch_Spelling =
  Search_Spelling
    {correctedQuery = Core.Nothing, htmlCorrectedQuery = Core.Nothing}
