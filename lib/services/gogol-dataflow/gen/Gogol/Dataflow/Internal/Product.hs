...
newBase2Exponent 
    ::  Base2Exponent
newBase2Exponent =
  Base2Exponent {numberOfBuckets = Core.Nothing, scale = Core.Nothing}
...
newDataSamplingConfig 
    ::  DataSamplingConfig
newDataSamplingConfig = DataSamplingConfig {behaviors = Core.Nothing}

instance Core.FromJSON DataSamplingConfig where
        parseJSON
          = Core.withObject "DataSamplingConfig"
              (\ o ->
                 DataSamplingConfig Core.<$> (o Core..:? "behaviors"))
...
instance Core.ToJSON DataSamplingReport where
        toJSON DataSamplingReport{..}
          = Core.object
              (Core.catMaybes
                 [("bytesWrittenDelta" Core..=) Core.. Core.AsText
                    Core.<$> bytesWrittenDelta,
                  ("elementsSampledBytes" Core..=) Core.. Core.AsText
                    Core.<$> elementsSampledBytes,
                  ("elementsSampledCount" Core..=) Core.. Core.AsText
                    Core.<$> elementsSampledCount,
                  ("exceptionsSampledCount" Core..=) Core.. Core.AsText
                    Core.<$> exceptionsSampledCount,
                  ("pcollectionsSampledCount" Core..=) Core..
                    Core.AsText
                    Core.<$> pcollectionsSampledCount,
                  ("persistenceErrorsCount" Core..=) Core.. Core.AsText
                    Core.<$> persistenceErrorsCount,
                  ("translationErrorsCount" Core..=) Core.. Core.AsText
...
newDataflowGaugeValue 
    ::  DataflowGaugeValue
newDataflowGaugeValue =
  DataflowGaugeValue {measuredTime = Core.Nothing, value = Core.Nothing}
...
newDebugOptions 
    ::  DebugOptions
newDebugOptions =
  DebugOptions {dataSampling = Core.Nothing, enableHotKeyLogging = Core.Nothing}
              ...
              (\ o ->
                 Environment Core.<$>
                   (o Core..:? "clusterManagerApiService") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "useStreamingEngineResourceBasedBilling")
...
newGPUUsage 
    ::  GPUUsage
newGPUUsage = GPUUsage {timestamp = Core.Nothing, utilization = Core.Nothing}
...
instance Core.ToJSON GPUUtilization where
        toJSON GPUUtilization{..}
          = Core.object
              (Core.catMaybes [("rate" Core..=) Core.<$> rate])
...
newLinear =
  Linear
    {numberOfBuckets = Core.Nothing, start = Core.Nothing, width = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("metric" Core..=) Core.<$> metric,
                  ...
                  ("valueInt64" Core..=) Core.. Core.AsText Core.<$>
                    valueInt64])
...
instance Core.FromJSON MetricValue_MetricLabels where
        parseJSON
          = Core.withObject "MetricValue_MetricLabels"
              (\ o ->
                 MetricValue_MetricLabels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON MetricValue_MetricLabels where
        toJSON MetricValue_MetricLabels{..}
          = Core.toJSON additional
...
instance Core.FromJSON OutlierStats where
        parseJSON
          = Core.withObject "OutlierStats"
              (\ o ->
                 OutlierStats Core.<$>
                   (o Core..:? "overflowCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "overflowMean")
                     Core.<*>
                     (o Core..:? "underflowCount" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON OutlierStats where
        toJSON OutlierStats{..}
          = Core.object
              (Core.catMaybes
                 [("overflowCount" Core..=) Core.. Core.AsText
                    Core.<$> overflowCount,
                  ("overflowMean" Core..=) Core.<$> overflowMean,
                  ("underflowCount" Core..=) Core.. Core.AsText
                    Core.<$> underflowCount,
...
newParameterMetadataEnumOption =
  ParameterMetadataEnumOption
    {description = Core.Nothing, label = Core.Nothing, value = Core.Nothing}

instance Core.FromJSON ParameterMetadataEnumOption
         where
        parseJSON
...
instance Core.ToJSON ParameterMetadataEnumOption
         where
...
newPerWorkerMetrics 
    ::  PerWorkerMetrics
newPerWorkerMetrics = PerWorkerMetrics {perStepNamespaceMetrics = Core.Nothing}

instance Core.FromJSON PerWorkerMetrics where
        parseJSON
          = Core.withObject "PerWorkerMetrics"
              (\ o ->
                 PerWorkerMetrics Core.<$>
                   (o Core..:? "perStepNamespaceMetrics"))
          ...
          = Core.object
              (Core.catMaybes
                 [("maxNumWorkers" Core..=) Core.<$> maxNumWorkers,
                  ...
                  ("workerUtilizationHint" Core..=) Core.<$>
...
newSdkBug 
    ::  SdkBug
newSdkBug =
  SdkBug {severity = Core.Nothing, type' = Core.Nothing, uri = Core.Nothing}
...
instance Core.FromJSON SdkBug where
        parseJSON
          = Core.withObject "SdkBug"
              (\ o ->
                 SdkBug Core.<$>
                   (o Core..:? "severity") Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "uri"))
...
instance Core.FromJSON ServiceResources where
        parseJSON
          = Core.withObject "ServiceResources"
              (\ o ->
                 ServiceResources Core.<$> (o Core..:? "zones"))

instance Core.ToJSON ServiceResources where
        toJSON ServiceResources{..}
          = Core.object
              (Core.catMaybes [("zones" Core..=) Core.<$> zones])
...
instance Core.FromJSON StreamingOperationalLimits
         where
        parseJSON
                 ...
                 StreamingOperationalLimits Core.<$>
                   (o Core..:? "maxBagElementBytes" Core.<&>
                     ...
                     (o Core..:? "maxSourceStateBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxTagBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxValueBytes" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON StreamingOperationalLimits where
        toJSON StreamingOperationalLimits{..}
          = Core.object
              (Core.catMaybes
                 [("maxBagElementBytes" Core..=) Core.. Core.AsText
                    Core.<$> maxBagElementBytes,
                  ("maxGlobalDataBytes" Core..=) Core.. Core.AsText
                    Core.<$> maxGlobalDataBytes,
                  ("maxKeyBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxKeyBytes,
                  ("maxProductionOutputBytes" Core..=) Core..
                    Core.AsText
                    Core.<$> maxProductionOutputBytes,
                  ("maxSortedListElementBytes" Core..=) Core..
                    Core.AsText
                    Core.<$> maxSortedListElementBytes,
                  ("maxSourceStateBytes" Core..=) Core.. Core.AsText
                    Core.<$> maxSourceStateBytes,
                  ("maxTagBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxTagBytes,
...
instance Core.ToJSON StreamingScalingReport where
        toJSON StreamingScalingReport{..}
          = Core.object
              (Core.catMaybes
                 [("activeBundleCount" Core..=) Core.<$>
                    activeBundleCount,
                  ("activeThreadCount" Core..=) Core.<$>
                    activeThreadCount,
                  ("maximumBundleCount" Core..=) Core.<$>
                    maximumBundleCount,
                  ("maximumBytes" Core..=) Core.. Core.AsText Core.<$>
                    maximumBytes,
                  ("maximumBytesCount" Core..=) Core.<$>
                    maximumBytesCount,
                  ("maximumThreadCount" Core..=) Core.<$>
                    maximumThreadCount,
                  ("outstandingBundleCount" Core..=) Core.<$>
                    outstandingBundleCount,
                  ("outstandingBytes" Core..=) Core.. Core.AsText
                    Core.<$> outstandingBytes,
                  ("outstandingBytesCount" Core..=) Core.<$>
...
instance Core.FromJSON StreamingScalingReportResponse
         where
        parseJSON
...
instance Core.ToJSON StreamingScalingReportResponse
         where
...
instance Core.ToJSON TemplateMetadata where
        toJSON TemplateMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("defaultStreamingMode" Core..=) Core.<$>
                    defaultStreamingMode,
                  ("description" Core..=) Core.<$> description,
                  ("name" Core..=) Core.<$> name,
                  ("parameters" Core..=) Core.<$> parameters,
                  ("streaming" Core..=) Core.<$> streaming,
                  ("supportsAtLeastOnce" Core..=) Core.<$>
                    supportsAtLeastOnce,
                  ("supportsExactlyOnce" Core..=) Core.<$>
                    supportsExactlyOnce])
...
instance Core.FromJSON WorkerMessage where
        parseJSON
          = Core.withObject "WorkerMessage"
              (\ o ->
                 WorkerMessage Core.<$>
                   (o Core..:? "dataSamplingReport") Core.<*>
                     (o Core..:? "labels")
...
instance Core.ToJSON WorkerMessage where
        toJSON WorkerMessage{..}
          = Core.object
              (Core.catMaybes
                 [("dataSamplingReport" Core..=) Core.<$>
                    dataSamplingReport,
                  ("labels" Core..=) Core.<$> labels,
                  ("perWorkerMetrics" Core..=) Core.<$>
                    perWorkerMetrics,
                  ("streamingScalingReport" Core..=) Core.<$>
                    streamingScalingReport,
                  ("time" Core..=) Core.<$> time,
...
newWorkerMessageResponse =
  WorkerMessageResponse
    { streamingScalingReportResponse = Core.Nothing
          ...
          = Core.withObject "WorkerMessageResponse"
              (\ o ->
                 WorkerMessageResponse Core.<$>
                   (o Core..:? "streamingScalingReportResponse")
