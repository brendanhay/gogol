...
-- |
-- Module      : Gogol.Dataflow.Projects.Locations.Sql.Validate
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ValidateResponse
...
instance Core.GoogleRequest
           DataflowProjectsLocationsSqlValidate
         where
        type Rs DataflowProjectsLocationsSqlValidate =
             ValidateResponse
        type Scopes DataflowProjectsLocationsSqlValidate =
