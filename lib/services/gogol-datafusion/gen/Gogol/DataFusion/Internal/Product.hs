              ...
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "accelerators" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "availableVersion" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "cryptoKeyConfig")
                     Core.<*> (o Core..:? "dataprocServiceAccount")
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "disabledReason" Core..!= Core.mempty)
          ...
          = Core.withObject "ListAvailableVersionsResponse"
              (\ o ->
                 ListAvailableVersionsResponse Core.<$>
                   (o Core..:? "availableVersions" Core..!= Core.mempty)
...
instance Core.FromJSON Version where
        parseJSON
          = Core.withObject "Version"
              (\ o ->
                 Version Core.<$>
                   (o Core..:? "availableFeatures" Core..!= Core.mempty)
