              ...
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "accelerators") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "dataplexDataLineageIntegrationEnabled")
                     ...
                     Core.<*> (o Core..:? "version")
                     Core.<*>
                     (o Core..:? "workforceIdentityServiceEndpoint")
                     Core.<*> (o Core..:? "zone"))
...
newMaintenanceWindow 
    ::  MaintenanceWindow
newMaintenanceWindow = MaintenanceWindow {recurringTimeWindow = Core.Nothing}
...
newPrivateServiceConnectConfig =
  PrivateServiceConnectConfig
    { effectiveUnreachableCidrBlock = Core.Nothing
    , networkAttachment = Core.Nothing
    , unreachableCidrBlock = Core.Nothing
    }

instance Core.FromJSON PrivateServiceConnectConfig
         where
        parseJSON
...
instance Core.ToJSON PrivateServiceConnectConfig
         where
              ...
              (Core.catMaybes
                 [("effectiveUnreachableCidrBlock" Core..=) Core.<$>
                  ...
                  ("networkAttachment" Core..=) Core.<$>
                    networkAttachment,
                  ("unreachableCidrBlock" Core..=) Core.<$>
...
newTimeWindow 
    ::  TimeWindow
newTimeWindow = TimeWindow {endTime = Core.Nothing, startTime = Core.Nothing}
