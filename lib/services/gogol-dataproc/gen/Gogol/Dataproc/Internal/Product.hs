...
newAccessSessionSparkApplicationSqlQueryResponse 
    ::  AccessSessionSparkApplicationSqlQueryResponse
newAccessSessionSparkApplicationSqlQueryResponse =
  AccessSessionSparkApplicationSqlQueryResponse {executionData = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("executionData" Core..=) Core.<$> executionData])
...
newAccessSessionSparkApplicationStageAttemptResponse 
    ::  AccessSessionSparkApplicationStageAttemptResponse
newAccessSessionSparkApplicationStageAttemptResponse =
  AccessSessionSparkApplicationStageAttemptResponse {stageData = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "AccessSparkApplicationJobResponse"
              (\ o ->
                 AccessSparkApplicationJobResponse Core.<$>
                   (o Core..:? "jobData"))
...
instance Core.FromJSON AccessSparkApplicationResponse
         where
        parseJSON
          = Core.withObject "AccessSparkApplicationResponse"
              (\ o ->
                 AccessSparkApplicationResponse Core.<$>
                   (o Core..:? "application"))

instance Core.ToJSON AccessSparkApplicationResponse
         where
...
newAccessSparkApplicationSqlQueryResponse 
    ::  AccessSparkApplicationSqlQueryResponse
newAccessSparkApplicationSqlQueryResponse =
  AccessSparkApplicationSqlQueryResponse {executionData = Core.Nothing}
...
newAccessSparkApplicationStageAttemptResponse 
    ::  AccessSparkApplicationStageAttemptResponse
newAccessSparkApplicationStageAttemptResponse =
  AccessSparkApplicationStageAttemptResponse {stageData = Core.Nothing}
...
instance Core.ToJSON AccumulableInfo where
        toJSON AccumulableInfo{..}
          = Core.object
              (Core.catMaybes
                 [("accumullableInfoId" Core..=) Core.. Core.AsText
...
newAnalyzeBatchRequest 
    ::  AnalyzeBatchRequest
newAnalyzeBatchRequest = AnalyzeBatchRequest {requestId = Core.Nothing}
...
instance Core.ToJSON AnalyzeOperationMetadata where
        toJSON AnalyzeOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("analyzedWorkloadName" Core..=) Core.<$>
                    analyzedWorkloadName,
                  ("analyzedWorkloadType" Core..=) Core.<$>
                    analyzedWorkloadType,
                  ("analyzedWorkloadUuid" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "AnalyzeOperationMetadata_Labels"
              (\ o ->
                 AnalyzeOperationMetadata_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON AnalyzeOperationMetadata_Labels
         where
        toJSON AnalyzeOperationMetadata_Labels{..}
...
newAppSummary =
  AppSummary
    {numCompletedJobs = Core.Nothing, numCompletedStages = Core.Nothing}
...
instance Core.ToJSON AppSummary where
        toJSON AppSummary{..}
          = Core.object
              (Core.catMaybes
                 [("numCompletedJobs" Core..=) Core.<$>
                    numCompletedJobs,
                  ("numCompletedStages" Core..=) Core.<$>
                    numCompletedStages])
...
instance Core.FromJSON ApplicationEnvironmentInfo
         where
        parseJSON
...
instance Core.ToJSON ApplicationEnvironmentInfo where
        toJSON ApplicationEnvironmentInfo{..}
          = Core.object
              (Core.catMaybes
                 [("classpathEntries" Core..=) Core.<$>
                    classpathEntries,
                  ("hadoopProperties" Core..=) Core.<$>
                    hadoopProperties,
                  ("metricsProperties" Core..=) Core.<$>
                    metricsProperties,
                  ("resourceProfiles" Core..=) Core.<$>
                    resourceProfiles,
...
newApplicationEnvironmentInfo_ClasspathEntries additional =
  ApplicationEnvironmentInfo_ClasspathEntries {additional = additional}
...
newApplicationEnvironmentInfo_HadoopProperties additional =
  ApplicationEnvironmentInfo_HadoopProperties {additional = additional}
...
newApplicationEnvironmentInfo_MetricsProperties additional =
  ApplicationEnvironmentInfo_MetricsProperties {additional = additional}
...
newApplicationEnvironmentInfo_SparkProperties additional =
  ApplicationEnvironmentInfo_SparkProperties {additional = additional}
...
newApplicationEnvironmentInfo_SystemProperties additional =
  ApplicationEnvironmentInfo_SystemProperties {additional = additional}
          ...
          = Core.withObject "ApplicationInfo"
              (\ o ->
                 ApplicationInfo Core.<$>
                   (o Core..:? "applicationContextIngestionStatus")
          ...
          = Core.object
              (Core.catMaybes
                 [("applicationContextIngestionStatus" Core..=)
                  ...
                  ("coresPerExecutor" Core..=) Core.<$>
                    coresPerExecutor,
                  ("maxCores" Core..=) Core.<$> maxCores,
                  ("memoryPerExecutorMb" Core..=) Core.<$>
                    memoryPerExecutorMb,
                  ("name" Core..=) Core.<$> name,
                  ("quantileDataStatus" Core..=) Core.<$>
                    quantileDataStatus])
...
instance Core.FromJSON AutotuningConfig where
        parseJSON
          = Core.withObject "AutotuningConfig"
              (\ o ->
                 AutotuningConfig Core.<$> (o Core..:? "scenarios"))
...
newClusterToRepair 
    ::  ClusterToRepair
newClusterToRepair = ClusterToRepair {clusterRepairAction = Core.Nothing}

instance Core.FromJSON ClusterToRepair where
        parseJSON
          = Core.withObject "ClusterToRepair"
              (\ o ->
                 ClusterToRepair Core.<$>
                   (o Core..:? "clusterRepairAction"))

instance Core.ToJSON ClusterToRepair where
        toJSON ClusterToRepair{..}
          = Core.object
              (Core.catMaybes
                 [("clusterRepairAction" Core..=) Core.<$>
                    clusterRepairAction])
...
instance Core.FromJSON ConsolidatedExecutorSummary
         where
        parseJSON
          = Core.withObject "ConsolidatedExecutorSummary"
              (\ o ->
                 ConsolidatedExecutorSummary Core.<$>
                   (o Core..:? "activeTasks") Core.<*>
                     (o Core..:? "completedTasks")
                     Core.<*> (o Core..:? "count")
                     Core.<*>
                     (o Core..:? "diskUsed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "failedTasks")
                     Core.<*> (o Core..:? "isExcluded")
                     Core.<*>
                     (o Core..:? "maxMemory" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "memoryMetrics")
                     Core.<*>
                     (o Core..:? "memoryUsed" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     (o Core..:? "totalDurationMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalGcTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalInputBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalShuffleRead" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalShuffleWrite" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "totalTasks"))

instance Core.ToJSON ConsolidatedExecutorSummary
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("activeTasks" Core..=) Core.<$> activeTasks,
                  ...
                  ("diskUsed" Core..=) Core.. Core.AsText Core.<$>
                    diskUsed,
                  ("failedTasks" Core..=) Core.<$> failedTasks,
                  ("isExcluded" Core..=) Core.<$> isExcluded,
                  ("maxMemory" Core..=) Core.. Core.AsText Core.<$>
                    maxMemory,
                  ("memoryMetrics" Core..=) Core.<$> memoryMetrics,
                  ("memoryUsed" Core..=) Core.. Core.AsText Core.<$>
                    memoryUsed,
                  ("rddBlocks" Core..=) Core.<$> rddBlocks,
                  ("totalCores" Core..=) Core.<$> totalCores,
                  ("totalDurationMillis" Core..=) Core.. Core.AsText
                    Core.<$> totalDurationMillis,
                  ("totalGcTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> totalGcTimeMillis,
                  ("totalInputBytes" Core..=) Core.. Core.AsText
                    Core.<$> totalInputBytes,
                  ("totalShuffleRead" Core..=) Core.. Core.AsText
                    Core.<$> totalShuffleRead,
                  ("totalShuffleWrite" Core..=) Core.. Core.AsText
...
instance Core.ToJSON DiskConfig where
        toJSON DiskConfig{..}
          = Core.object
              (Core.catMaybes
                 [("bootDiskProvisionedIops" Core..=) Core..
                    Core.AsText
                    Core.<$> bootDiskProvisionedIops,
                  ("bootDiskProvisionedThroughput" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON ExecutorMetrics where
        parseJSON
          = Core.withObject "ExecutorMetrics"
              (\ o ->
                 ExecutorMetrics Core.<$> (o Core..:? "metrics"))
...
instance Core.FromJSON ExecutorMetrics_Metrics where
        parseJSON
          = Core.withObject "ExecutorMetrics_Metrics"
              (\ o ->
                 ExecutorMetrics_Metrics Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExecutorMetrics_Metrics where
        toJSON ExecutorMetrics_Metrics{..}
          = Core.toJSON additional
...
instance Core.FromJSON ExecutorMetricsDistributions
         where
        parseJSON
...
newExecutorPeakMetricsDistributions =
  ExecutorPeakMetricsDistributions
    {executorMetrics = Core.Nothing, quantiles = Core.Nothing}
          ...
          = Core.withObject "ExecutorPeakMetricsDistributions"
              (\ o ->
                 ExecutorPeakMetricsDistributions Core.<$>
                   (o Core..:? "executorMetrics") Core.<*>
                     (o Core..:? "quantiles"))

instance Core.ToJSON ExecutorPeakMetricsDistributions
         where
        toJSON ExecutorPeakMetricsDistributions{..}
          = Core.object
              (Core.catMaybes
                 [("executorMetrics" Core..=) Core.<$>
                    executorMetrics,
                  ("quantiles" Core..=) Core.<$> quantiles])
...
instance Core.ToJSON ExecutorResourceRequest where
        toJSON ExecutorResourceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("amount" Core..=) Core.. Core.AsText Core.<$>
                    amount,
                 ...
                 ExecutorStageSummary Core.<$>
                   (o Core..:? "diskBytesSpilled" Core.<&>
                     ...
                     (o Core..:? "outputBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "outputRecords" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "peakMemoryMetrics")
                     Core.<*>
                     (o Core..:? "shuffleRead" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleReadRecords" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shuffleWrite" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON ExecutorStageSummary where
        toJSON ExecutorStageSummary{..}
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.. Core.AsText
                    Core.<$> diskBytesSpilled,
                  ("executorId" Core..=) Core.<$> executorId,
                  ("failedTasks" Core..=) Core.<$> failedTasks,
                  ("inputBytes" Core..=) Core.. Core.AsText Core.<$>
                    inputBytes,
                  ("inputRecords" Core..=) Core.. Core.AsText Core.<$>
                    inputRecords,
                  ("isExcludedForStage" Core..=) Core.<$>
                    isExcludedForStage,
                  ("killedTasks" Core..=) Core.<$> killedTasks,
                  ("memoryBytesSpilled" Core..=) Core.. Core.AsText
                  ...
                  ("peakMemoryMetrics" Core..=) Core.<$>
                    peakMemoryMetrics,
                  ("shuffleRead" Core..=) Core.. Core.AsText Core.<$>
                    shuffleRead,
                  ("shuffleReadRecords" Core..=) Core.. Core.AsText
                    Core.<$> shuffleReadRecords,
                  ("shuffleWrite" Core..=) Core.. Core.AsText Core.<$>
                    shuffleWrite,
                  ("shuffleWriteRecords" Core..=) Core.. Core.AsText
                    Core.<$> shuffleWriteRecords,
                  ("stageAttemptId" Core..=) Core.<$> stageAttemptId,
                  ("stageId" Core..=) Core.. Core.AsText Core.<$>
                    stageId,
                  ("succeededTasks" Core..=) Core.<$> succeededTasks,
                  ("taskTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> taskTimeMillis])
...
instance Core.FromJSON ExecutorSummary_Attributes
         where
        parseJSON
          = Core.withObject "ExecutorSummary_Attributes"
              (\ o ->
                 ExecutorSummary_Attributes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExecutorSummary_Attributes where
        toJSON ExecutorSummary_Attributes{..}
          = Core.toJSON additional
...
instance Core.FromJSON ExecutorSummary_ExecutorLogs
         where
        parseJSON
          = Core.withObject "ExecutorSummary_ExecutorLogs"
              (\ o ->
                 ExecutorSummary_ExecutorLogs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExecutorSummary_ExecutorLogs
         where
        toJSON ExecutorSummary_ExecutorLogs{..}
          = Core.toJSON additional
...
instance Core.FromJSON ExecutorSummary_Resources
         where
        parseJSON
          = Core.withObject "ExecutorSummary_Resources"
              (\ o ->
                 ExecutorSummary_Resources Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExecutorSummary_Resources where
        toJSON ExecutorSummary_Resources{..}
          = Core.toJSON additional
...
instance Core.FromJSON FlinkJob_Properties where
        parseJSON
          = Core.withObject "FlinkJob_Properties"
              (\ o ->
                 FlinkJob_Properties Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON FlinkJob_Properties where
        toJSON FlinkJob_Properties{..}
          = Core.toJSON additional
...
newGoogleCloudDataprocV1WorkflowTemplateEncryptionConfig 
    ::  GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig
newGoogleCloudDataprocV1WorkflowTemplateEncryptionConfig =
  GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig {kmsKey = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          GoogleCloudDataprocV1WorkflowTemplateEncryptionConfig{..}
          = Core.object
              (Core.catMaybes [("kmsKey" Core..=) Core.<$> kmsKey])
...
newInputMetrics 
    ::  InputMetrics
newInputMetrics =
  InputMetrics {bytesRead = Core.Nothing, recordsRead = Core.Nothing}
...
instance Core.ToJSON InputMetrics where
        toJSON InputMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("bytesRead" Core..=) Core.. Core.AsText Core.<$>
                    bytesRead,
...
newInputQuantileMetrics 
    ::  InputQuantileMetrics
newInputQuantileMetrics =
  InputQuantileMetrics {bytesRead = Core.Nothing, recordsRead = Core.Nothing}
...
instance Core.FromJSON InstanceFlexibilityPolicy
         where
        parseJSON
...
instance Core.ToJSON InstanceFlexibilityPolicy where
        toJSON InstanceFlexibilityPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("instanceSelectionList" Core..=) Core.<$>
                    instanceSelectionList,
                  ("instanceSelectionResults" Core..=) Core.<$>
                    instanceSelectionResults,
                  ("provisioningModelMix" Core..=) Core.<$>
                    provisioningModelMix])
...
newInstanceSelection 
    ::  InstanceSelection
newInstanceSelection =
  InstanceSelection {machineTypes = Core.Nothing, rank = Core.Nothing}
...
newInstanceSelectionResult 
    ::  InstanceSelectionResult
newInstanceSelectionResult =
  InstanceSelectionResult {machineType = Core.Nothing, vmCount = Core.Nothing}
...
instance Core.FromJSON JobData_KillTasksSummary where
        parseJSON
          = Core.withObject "JobData_KillTasksSummary"
              (\ o ->
                 JobData_KillTasksSummary Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON JobData_KillTasksSummary where
        toJSON JobData_KillTasksSummary{..}
          = Core.toJSON additional
...
newListSessionTemplatesResponse =
  ListSessionTemplatesResponse
    {nextPageToken = Core.Nothing, sessionTemplates = Core.Nothing}

instance Core.FromJSON ListSessionTemplatesResponse
         where
        parseJSON
...
instance Core.ToJSON ListSessionTemplatesResponse
         where
        toJSON ListSessionTemplatesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sessionTemplates" Core..=) Core.<$>
                    sessionTemplates])
...
instance Core.ToJSON MemoryMetrics where
        toJSON MemoryMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("totalOffHeapStorageMemory" Core..=) Core..
                    Core.AsText
                    Core.<$> totalOffHeapStorageMemory,
                  ("totalOnHeapStorageMemory" Core..=) Core..
                    Core.AsText
                    Core.<$> totalOnHeapStorageMemory,
                  ("usedOffHeapStorageMemory" Core..=) Core..
                    Core.AsText
                    Core.<$> usedOffHeapStorageMemory,
                  ("usedOnHeapStorageMemory" Core..=) Core..
                    Core.AsText
...
newOutputMetrics 
    ::  OutputMetrics
newOutputMetrics =
  OutputMetrics {bytesWritten = Core.Nothing, recordsWritten = Core.Nothing}
...
instance Core.ToJSON OutputMetrics where
        toJSON OutputMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("bytesWritten" Core..=) Core.. Core.AsText Core.<$>
                    bytesWritten,
...
newOutputQuantileMetrics =
  OutputQuantileMetrics
    {bytesWritten = Core.Nothing, recordsWritten = Core.Nothing}
...
newPoolData 
    ::  PoolData
newPoolData = PoolData {name = Core.Nothing, stageIds = Core.Nothing}
...
instance Core.FromJSON ProcessSummary_ProcessLogs
         where
        parseJSON
          = Core.withObject "ProcessSummary_ProcessLogs"
              (\ o ->
                 ProcessSummary_ProcessLogs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ProcessSummary_ProcessLogs where
        toJSON ProcessSummary_ProcessLogs{..}
          = Core.toJSON additional
...
instance Core.ToJSON ProvisioningModelMix where
        toJSON ProvisioningModelMix{..}
          = Core.object
              (Core.catMaybes
                 [("standardCapacityBase" Core..=) Core.<$>
...
newPyPiRepositoryConfig 
    ::  PyPiRepositoryConfig
newPyPiRepositoryConfig = PyPiRepositoryConfig {pypiRepository = Core.Nothing}

instance Core.FromJSON PyPiRepositoryConfig where
        parseJSON
          = Core.withObject "PyPiRepositoryConfig"
              (\ o ->
                 PyPiRepositoryConfig Core.<$>
                   (o Core..:? "pypiRepository"))
                 ...
                 Quantiles Core.<$>
                   (o Core..:? "count" Core.<&>
                     ...
                     (o Core..:? "minimum" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentile25" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentile50" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "percentile75" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "sum" Core.<&>
                        Core.fmap Core.fromAsText))
              ...
              (Core.catMaybes
                 [("count" Core..=) Core.. Core.AsText Core.<$> count,
                  ...
                  ("minimum" Core..=) Core.. Core.AsText Core.<$>
                    minimum,
                  ("percentile25" Core..=) Core.. Core.AsText Core.<$>
                    percentile25,
                  ("percentile50" Core..=) Core.. Core.AsText Core.<$>
                    percentile50,
                  ("percentile75" Core..=) Core.. Core.AsText Core.<$>
                    percentile75,
                 ...
                 RddDataDistribution Core.<$>
                   (o Core..:? "address") Core.<*>
                     ...
                     (o Core..:? "offHeapMemoryRemaining" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "offHeapMemoryUsed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "onHeapMemoryRemaining" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "onHeapMemoryUsed" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ("diskUsed" Core..=) Core.. Core.AsText Core.<$>
                    diskUsed,
                  ("memoryRemaining" Core..=) Core.. Core.AsText
                    Core.<$> memoryRemaining,
                  ("memoryUsed" Core..=) Core.. Core.AsText Core.<$>
                    memoryUsed,
                  ("offHeapMemoryRemaining" Core..=) Core.. Core.AsText
                    Core.<$> offHeapMemoryRemaining,
                  ("offHeapMemoryUsed" Core..=) Core.. Core.AsText
                    Core.<$> offHeapMemoryUsed,
                  ("onHeapMemoryRemaining" Core..=) Core.. Core.AsText
                    Core.<$> onHeapMemoryRemaining,
                  ("onHeapMemoryUsed" Core..=) Core.. Core.AsText
          ...
          = Core.withObject "RddOperationNode"
              (\ o ->
                 RddOperationNode Core.<$>
                   (o Core..:? "barrier") Core.<*> (o Core..:? "cached")
...
newRepositoryConfig 
    ::  RepositoryConfig
newRepositoryConfig = RepositoryConfig {pypiRepositoryConfig = Core.Nothing}

instance Core.FromJSON RepositoryConfig where
        parseJSON
          = Core.withObject "RepositoryConfig"
              (\ o ->
                 RepositoryConfig Core.<$>
                   (o Core..:? "pypiRepositoryConfig"))

instance Core.ToJSON RepositoryConfig where
        toJSON RepositoryConfig{..}
          = Core.object
              (Core.catMaybes
                 [("pypiRepositoryConfig" Core..=) Core.<$>
                    pypiRepositoryConfig])
...
newResourceInformation 
    ::  ResourceInformation
newResourceInformation =
  ResourceInformation {addresses = Core.Nothing, name = Core.Nothing}
...
newSearchSessionSparkApplicationExecutorStageSummaryResponse =
  SearchSessionSparkApplicationExecutorStageSummaryResponse
    { nextPageToken = Core.Nothing
    , sparkApplicationStageExecutors = Core.Nothing
    }
...
newSearchSessionSparkApplicationExecutorsResponse =
  SearchSessionSparkApplicationExecutorsResponse
    {nextPageToken = Core.Nothing, sparkApplicationExecutors = Core.Nothing}
...
newSearchSessionSparkApplicationJobsResponse =
  SearchSessionSparkApplicationJobsResponse
    {nextPageToken = Core.Nothing, sparkApplicationJobs = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON SearchSessionSparkApplicationJobsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("sparkApplicationJobs" Core..=) Core.<$>
...
newSearchSessionSparkApplicationSqlQueriesResponse =
  SearchSessionSparkApplicationSqlQueriesResponse
    {nextPageToken = Core.Nothing, sparkApplicationSqlQueries = Core.Nothing}
...
newSearchSessionSparkApplicationStageAttemptTasksResponse =
  SearchSessionSparkApplicationStageAttemptTasksResponse
    { nextPageToken = Core.Nothing
    , sparkApplicationStageAttemptTasks = Core.Nothing
    }
...
newSearchSessionSparkApplicationStageAttemptsResponse =
  SearchSessionSparkApplicationStageAttemptsResponse
    {nextPageToken = Core.Nothing, sparkApplicationStageAttempts = Core.Nothing}
...
newSearchSessionSparkApplicationStagesResponse =
  SearchSessionSparkApplicationStagesResponse
    {nextPageToken = Core.Nothing, sparkApplicationStages = Core.Nothing}
...
newSearchSessionSparkApplicationsResponse =
  SearchSessionSparkApplicationsResponse
    {nextPageToken = Core.Nothing, sparkApplications = Core.Nothing}
...
instance Core.ToJSON SearchSparkApplicationsResponse
         where
...
instance Core.FromJSON SessionTemplate_Labels where
        parseJSON
          = Core.withObject "SessionTemplate_Labels"
              (\ o ->
                 SessionTemplate_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SessionTemplate_Labels where
        toJSON SessionTemplate_Labels{..}
          = Core.toJSON additional
          ...
          = Core.object
              (Core.catMaybes
                 [("corruptMergedBlockChunks" Core..=) Core..
                  ...
                  ("localMergedBytesRead" Core..=) Core.. Core.AsText
                  ...
                  ("remoteMergedBytesRead" Core..=) Core.. Core.AsText
...
instance Core.FromJSON ShufflePushReadQuantileMetrics
         where
        parseJSON
...
instance Core.ToJSON ShufflePushReadQuantileMetrics
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("corruptMergedBlockChunks" Core..=) Core.<$>
                  ...
                  ("localMergedBytesRead" Core..=) Core.<$>
                  ...
                  ("remoteMergedBytesRead" Core..=) Core.<$>
...
instance Core.ToJSON ShuffleReadMetrics where
        toJSON ShuffleReadMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("fetchWaitTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> fetchWaitTimeMillis,
                  ("localBlocksFetched" Core..=) Core.. Core.AsText
                    Core.<$> localBlocksFetched,
                  ("localBytesRead" Core..=) Core.. Core.AsText
                    Core.<$> localBytesRead,
                  ("recordsRead" Core..=) Core.. Core.AsText Core.<$>
                    recordsRead,
                  ("remoteBlocksFetched" Core..=) Core.. Core.AsText
                    Core.<$> remoteBlocksFetched,
                  ("remoteBytesRead" Core..=) Core.. Core.AsText
                    Core.<$> remoteBytesRead,
                  ("remoteBytesReadToDisk" Core..=) Core.. Core.AsText
                    Core.<$> remoteBytesReadToDisk,
                  ("remoteReqsDuration" Core..=) Core.. Core.AsText
...
instance Core.FromJSON ShuffleReadQuantileMetrics
         where
        parseJSON
...
instance Core.ToJSON ShuffleReadQuantileMetrics where
        toJSON ShuffleReadQuantileMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("fetchWaitTimeMillis" Core..=) Core.<$>
                    fetchWaitTimeMillis,
                  ("localBlocksFetched" Core..=) Core.<$>
                    localBlocksFetched,
                  ("readBytes" Core..=) Core.<$> readBytes,
                  ("readRecords" Core..=) Core.<$> readRecords,
                  ("remoteBlocksFetched" Core..=) Core.<$>
                    remoteBlocksFetched,
                  ("remoteBytesRead" Core..=) Core.<$> remoteBytesRead,
                  ("remoteBytesReadToDisk" Core..=) Core.<$>
                    remoteBytesReadToDisk,
                  ("remoteReqsDuration" Core..=) Core.<$>
                    remoteReqsDuration,
                  ("shufflePushReadMetrics" Core..=) Core.<$>
                    shufflePushReadMetrics,
                  ("totalBlocksFetched" Core..=) Core.<$>
                    totalBlocksFetched])
          ...
          = Core.object
              (Core.catMaybes
                 [("bytesWritten" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("recordsWritten" Core..=) Core.. Core.AsText
                    Core.<$> recordsWritten,
                  ("writeTimeNanos" Core..=) Core.. Core.AsText
                    Core.<$> writeTimeNanos])
...
instance Core.FromJSON ShuffleWriteQuantileMetrics
         where
        parseJSON
          = Core.withObject "ShuffleWriteQuantileMetrics"
              (\ o ->
                 ShuffleWriteQuantileMetrics Core.<$>
                   (o Core..:? "writeBytes") Core.<*>
                     (o Core..:? "writeRecords")
                     Core.<*> (o Core..:? "writeTimeNanos"))

instance Core.ToJSON ShuffleWriteQuantileMetrics
         where
...
instance Core.FromJSON SinkProgress_Metrics where
        parseJSON
          = Core.withObject "SinkProgress_Metrics"
              (\ o ->
                 SinkProgress_Metrics Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SinkProgress_Metrics where
        toJSON SinkProgress_Metrics{..}
          = Core.toJSON additional
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("inputRowsPerSecond" Core..=) Core.<$>
                    inputRowsPerSecond,
                  ("latestOffset" Core..=) Core.<$> latestOffset,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("numInputRows" Core..=) Core.. Core.AsText Core.<$>
                    numInputRows,
                  ("processedRowsPerSecond" Core..=) Core.<$>
...
instance Core.FromJSON SourceProgress_Metrics where
        parseJSON
          = Core.withObject "SourceProgress_Metrics"
              (\ o ->
                 SourceProgress_Metrics Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SourceProgress_Metrics where
        toJSON SourceProgress_Metrics{..}
          = Core.toJSON additional
...
newSparkPlanGraph =
  SparkPlanGraph
    {edges = Core.Nothing, executionId = Core.Nothing, nodes = Core.Nothing}
...
instance Core.ToJSON SparkPlanGraph where
        toJSON SparkPlanGraph{..}
          = Core.object
              (Core.catMaybes
                 [("edges" Core..=) Core.<$> edges,
                  ("executionId" Core..=) Core.. Core.AsText Core.<$>
                    executionId,
          ...
          = Core.withObject "SparkPlanGraphCluster"
              (\ o ->
                 SparkPlanGraphCluster Core.<$>
                   (o Core..:? "desc") Core.<*> (o Core..:? "metrics")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "nodes")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("desc" Core..=) Core.<$> desc,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("nodes" Core..=) Core.<$> nodes,
                  ("sparkPlanGraphClusterId" Core..=) Core..
                    Core.AsText
...
instance Core.ToJSON SparkPlanGraphEdge where
        toJSON SparkPlanGraphEdge{..}
          = Core.object
              (Core.catMaybes
                 [("fromId" Core..=) Core.. Core.AsText Core.<$>
                    fromId,
          ...
          = Core.object
              (Core.catMaybes
                 [("desc" Core..=) Core.<$> desc,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("name" Core..=) Core.<$> name,
                  ("sparkPlanGraphNodeId" Core..=) Core.. Core.AsText
...
newSparkPlanGraphNodeWrapper 
    ::  SparkPlanGraphNodeWrapper
newSparkPlanGraphNodeWrapper =
  SparkPlanGraphNodeWrapper {cluster = Core.Nothing, node = Core.Nothing}

instance Core.FromJSON SparkPlanGraphNodeWrapper
         where
        parseJSON
        ...
        toJSON SparkStandaloneAutoscalingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("gracefulDecommissionTimeout" Core..=) Core.<$>
                    gracefulDecommissionTimeout,
                  ("removeOnlyIdleWorkers" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("appSummary" Core..=) Core.<$> appSummary,
                  ...
                  ("executorStageSummary" Core..=) Core.<$>
                    executorStageSummary,
                  ...
                  ("resourceProfileInfo" Core..=) Core.<$>
                    resourceProfileInfo,
                  ("sparkPlanGraph" Core..=) Core.<$> sparkPlanGraph,
                  ("speculationStageSummary" Core..=) Core.<$>
                    speculationStageSummary,
                  ("sqlExecutionUiData" Core..=) Core.<$>
                    sqlExecutionUiData,
                  ("stageData" Core..=) Core.<$> stageData,
                  ("streamBlockData" Core..=) Core.<$> streamBlockData,
                  ("streamingQueryData" Core..=) Core.<$>
                    streamingQueryData,
                  ("streamingQueryProgress" Core..=) Core.<$>
                    streamingQueryProgress,
          ...
          = Core.object
              (Core.catMaybes
                 [("completionTime" Core..=) Core.<$> completionTime,
                  ...
                  ("metricValuesIsNull" Core..=) Core.<$>
                    metricValuesIsNull,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("modifiedConfigs" Core..=) Core.<$> modifiedConfigs,
                  ("physicalPlanDescription" Core..=) Core.<$>
                    physicalPlanDescription,
                  ("rootExecutionId" Core..=) Core.. Core.AsText
                    Core.<$> rootExecutionId,
                  ("stages" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> stages,
                  ("submissionTime" Core..=) Core.<$> submissionTime])
...
instance Core.FromJSON SqlExecutionUiData_Jobs where
        parseJSON
          = Core.withObject "SqlExecutionUiData_Jobs"
              (\ o ->
                 SqlExecutionUiData_Jobs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SqlExecutionUiData_Jobs where
        toJSON SqlExecutionUiData_Jobs{..}
          = Core.toJSON additional
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "SqlExecutionUiData_MetricValues"
              (\ o ->
                 SqlExecutionUiData_MetricValues Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SqlExecutionUiData_MetricValues
         where
        toJSON SqlExecutionUiData_MetricValues{..}
          = Core.toJSON additional
...
instance Core.ToJSON SqlPlanMetric where
        toJSON SqlPlanMetric{..}
          = Core.object
              (Core.catMaybes
                 [("accumulatorId" Core..=) Core.. Core.AsText
                    Core.<$> accumulatorId,
          ...
          = Core.object
              (Core.catMaybes
                 [("accumulatorUpdates" Core..=) Core.<$>
                  ...
                  ("firstTaskLaunchedTime" Core..=) Core.<$>
                    firstTaskLaunchedTime,
                  ("isShufflePushEnabled" Core..=) Core.<$>
                    isShufflePushEnabled,
                  ("jobIds" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> jobIds,
                  ("killedTasksSummary" Core..=) Core.<$>
                    killedTasksSummary,
                  ("locality" Core..=) Core.<$> locality,
                  ("name" Core..=) Core.<$> name,
                  ("numActiveTasks" Core..=) Core.<$> numActiveTasks,
                  ("numCompleteTasks" Core..=) Core.<$>
                    numCompleteTasks,
                  ("numCompletedIndices" Core..=) Core.<$>
                    numCompletedIndices,
                  ("numFailedTasks" Core..=) Core.<$> numFailedTasks,
                  ("numKilledTasks" Core..=) Core.<$> numKilledTasks,
                  ("numTasks" Core..=) Core.<$> numTasks,
                  ("parentStageIds" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> parentStageIds,
                  ("peakExecutorMetrics" Core..=) Core.<$>
                    peakExecutorMetrics,
                  ("rddIds" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> rddIds,
                  ("resourceProfileId" Core..=) Core.<$>
                    resourceProfileId,
                  ("schedulingPool" Core..=) Core.<$> schedulingPool,
                  ("shuffleMergersCount" Core..=) Core.<$>
                    shuffleMergersCount,
                  ("speculationSummary" Core..=) Core.<$>
                    speculationSummary,
                  ("stageAttemptId" Core..=) Core.<$> stageAttemptId,
                  ("stageId" Core..=) Core.. Core.AsText Core.<$>
                    stageId,
...
instance Core.FromJSON StageData_ExecutorSummary
         where
        parseJSON
          = Core.withObject "StageData_ExecutorSummary"
              (\ o ->
                 StageData_ExecutorSummary Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON StageData_ExecutorSummary where
        toJSON StageData_ExecutorSummary{..}
          = Core.toJSON additional
...
instance Core.FromJSON StageData_KilledTasksSummary
         where
        parseJSON
          = Core.withObject "StageData_KilledTasksSummary"
              (\ o ->
                 StageData_KilledTasksSummary Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON StageData_KilledTasksSummary
         where
        toJSON StageData_KilledTasksSummary{..}
          = Core.toJSON additional
...
newStageData_Locality 
    ::  Core.HashMap Core.Text Core.Int64
       -- ^  See 'additional'.
    -> StageData_Locality
newStageData_Locality additional = StageData_Locality {additional = additional}

instance Core.FromJSON StageData_Locality where
        parseJSON
          = Core.withObject "StageData_Locality"
              (\ o ->
                 StageData_Locality Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON StageData_Locality where
        toJSON StageData_Locality{..}
          = Core.toJSON additional
...
newStageData_Tasks 
    ::  Core.HashMap Core.Text TaskData
       -- ^  See 'additional'.
    -> StageData_Tasks
newStageData_Tasks additional = StageData_Tasks {additional = additional}

instance Core.FromJSON StageData_Tasks where
        parseJSON
          = Core.withObject "StageData_Tasks"
              (\ o ->
                 StageData_Tasks Core.<$> (Core.parseJSONObject o))
...
newStageInputMetrics 
    ::  StageInputMetrics
newStageInputMetrics =
  StageInputMetrics {bytesRead = Core.Nothing, recordsRead = Core.Nothing}
                 ...
                 StageMetrics Core.<$>
                   (o Core..:? "diskBytesSpilled" Core.<&>
                     ...
                     (o Core..:? "executorCpuTimeNanos" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "executorDeserializeCpuTimeNanos"
        ...
        toJSON StageMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.. Core.AsText
                    Core.<$> diskBytesSpilled,
                  ("executorCpuTimeNanos" Core..=) Core.. Core.AsText
                  ...
                  ("executorRunTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> executorRunTimeMillis,
                  ("jvmGcTimeMillis" Core..=) Core.. Core.AsText
                  ...
                  ("resultSize" Core..=) Core.. Core.AsText Core.<$>
                    resultSize,
                  ("stageInputMetrics" Core..=) Core.<$>
                    stageInputMetrics,
                  ("stageOutputMetrics" Core..=) Core.<$>
                    stageOutputMetrics,
...
instance Core.FromJSON StageShufflePushReadMetrics
         where
        parseJSON
...
instance Core.ToJSON StageShufflePushReadMetrics
         where
...
newStartupConfig 
    ::  StartupConfig
newStartupConfig = StartupConfig {requiredRegistrationFraction = Core.Nothing}
...
instance Core.FromJSON StartupConfig where
        parseJSON
          = Core.withObject "StartupConfig"
              (\ o ->
                 StartupConfig Core.<$>
                   (o Core..:? "requiredRegistrationFraction"))
          ...
          = Core.withObject "StateOperatorProgress"
              (\ o ->
                 StateOperatorProgress Core.<$>
                   (o Core..:? "allRemovalsTimeMs" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "allUpdatesTimeMs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "commitTimeMs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "customMetrics")
                     Core.<*>
                     (o Core..:? "memoryUsedBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsDroppedByWatermark" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsRemoved" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsTotal" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsUpdated" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON StateOperatorProgress where
        toJSON StateOperatorProgress{..}
          = Core.object
              (Core.catMaybes
                 [("allRemovalsTimeMs" Core..=) Core.. Core.AsText
                    Core.<$> allRemovalsTimeMs,
                  ("allUpdatesTimeMs" Core..=) Core.. Core.AsText
                    Core.<$> allUpdatesTimeMs,
                  ("commitTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    commitTimeMs,
                  ("customMetrics" Core..=) Core.<$> customMetrics,
                  ("memoryUsedBytes" Core..=) Core.. Core.AsText
                    Core.<$> memoryUsedBytes,
                  ("numRowsDroppedByWatermark" Core..=) Core..
                    Core.AsText
                    Core.<$> numRowsDroppedByWatermark,
                  ("numRowsRemoved" Core..=) Core.. Core.AsText
                    Core.<$> numRowsRemoved,
                  ("numRowsTotal" Core..=) Core.. Core.AsText Core.<$>
                    numRowsTotal,
                  ("numRowsUpdated" Core..=) Core.. Core.AsText
                    Core.<$> numRowsUpdated,
                  ("numShufflePartitions" Core..=) Core.. Core.AsText
                    Core.<$> numShufflePartitions,
                  ("numStateStoreInstances" Core..=) Core.. Core.AsText
          ...
          = Core.object
              (Core.catMaybes
                 [("deserialized" Core..=) Core.<$> deserialized,
                  ("diskSize" Core..=) Core.. Core.AsText Core.<$>
                    diskSize,
                  ("executorId" Core..=) Core.<$> executorId,
                  ("hostPort" Core..=) Core.<$> hostPort,
                  ("memSize" Core..=) Core.. Core.AsText Core.<$>
                    memSize,
                  ("name" Core..=) Core.<$> name,
                  ("storageLevel" Core..=) Core.<$> storageLevel,
...
instance Core.ToJSON StreamingQueryData where
        toJSON StreamingQueryData{..}
          = Core.object
              (Core.catMaybes
                 [("endTimestamp" Core..=) Core.. Core.AsText Core.<$>
                    endTimestamp,
                  ("exception" Core..=) Core.<$> exception,
                  ("isActive" Core..=) Core.<$> isActive,
                  ("name" Core..=) Core.<$> name,
                  ("runId" Core..=) Core.<$> runId,
                  ("startTimestamp" Core..=) Core.. Core.AsText
                    Core.<$> startTimestamp,
                  ("streamingQueryId" Core..=) Core.<$>
                    streamingQueryId])
...
instance Core.ToJSON StreamingQueryProgress where
        toJSON StreamingQueryProgress{..}
          = Core.object
              (Core.catMaybes
                 [("batchDuration" Core..=) Core.. Core.AsText
                    Core.<$> batchDuration,
                  ("batchId" Core..=) Core.. Core.AsText Core.<$>
                    batchId,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "StreamingQueryProgress_EventTime"
              (\ o ->
                 StreamingQueryProgress_EventTime Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON StreamingQueryProgress_EventTime
         where
...
newSummarizeSessionSparkApplicationExecutorsResponse =
  SummarizeSessionSparkApplicationExecutorsResponse
    { activeExecutorSummary = Core.Nothing
    , applicationId = Core.Nothing
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("activeExecutorSummary" Core..=) Core.<$>
                    activeExecutorSummary,
                  ("applicationId" Core..=) Core.<$> applicationId,
                  ("deadExecutorSummary" Core..=) Core.<$>
                    deadExecutorSummary,
                  ("totalExecutorSummary" Core..=) Core.<$>
...
newSummarizeSessionSparkApplicationJobsResponse 
    ::  SummarizeSessionSparkApplicationJobsResponse
newSummarizeSessionSparkApplicationJobsResponse =
  SummarizeSessionSparkApplicationJobsResponse {jobsSummary = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("jobsSummary" Core..=) Core.<$> jobsSummary])
...
newSummarizeSessionSparkApplicationStageAttemptTasksResponse =
  SummarizeSessionSparkApplicationStageAttemptTasksResponse
    {stageAttemptTasksSummary = Core.Nothing}
...
newSummarizeSessionSparkApplicationStagesResponse 
    ::  SummarizeSessionSparkApplicationStagesResponse
newSummarizeSessionSparkApplicationStagesResponse =
  SummarizeSessionSparkApplicationStagesResponse {stagesSummary = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("stagesSummary" Core..=) Core.<$> stagesSummary])
...
newSummarizeSparkApplicationStagesResponse 
    ::  SummarizeSparkApplicationStagesResponse
newSummarizeSparkApplicationStagesResponse =
  SummarizeSparkApplicationStagesResponse {stagesSummary = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accumulatorUpdates" Core..=) Core.<$>
                  ...
                  ("resultFetchStart" Core..=) Core.<$>
                    resultFetchStart,
                  ("schedulerDelayMillis" Core..=) Core.. Core.AsText
...
instance Core.FromJSON TaskData_ExecutorLogs where
        parseJSON
          = Core.withObject "TaskData_ExecutorLogs"
              (\ o ->
                 TaskData_ExecutorLogs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TaskData_ExecutorLogs where
        toJSON TaskData_ExecutorLogs{..}
          = Core.toJSON additional
          ...
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.. Core.AsText
                  ...
                  ("resultSize" Core..=) Core.. Core.AsText Core.<$>
                    resultSize,
                  ("shuffleReadMetrics" Core..=) Core.<$>
                    shuffleReadMetrics,
                  ("shuffleWriteMetrics" Core..=) Core.<$>
                    shuffleWriteMetrics])
          ...
          = Core.object
              (Core.catMaybes
                 [("diskBytesSpilled" Core..=) Core.<$>
                  ...
                  ("schedulerDelayMillis" Core..=) Core.<$>
...
newTaskResourceRequest 
    ::  TaskResourceRequest
newTaskResourceRequest =
  TaskResourceRequest {amount = Core.Nothing, resourceName = Core.Nothing}
...
newTerminateSessionRequest 
    ::  TerminateSessionRequest
newTerminateSessionRequest = TerminateSessionRequest {requestId = Core.Nothing}

instance Core.FromJSON TerminateSessionRequest where
        parseJSON
          = Core.withObject "TerminateSessionRequest"
              (\ o ->
                 TerminateSessionRequest Core.<$>
                   (o Core..:? "requestId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("acceleratorType" Core..=) Core.<$>
                    acceleratorType,
                  ("milliAcceleratorSeconds" Core..=) Core..
                    Core.AsText
        ...
        parseJSON
          = Core.withObject "UsageSnapshot"
              (\ o ->
                 UsageSnapshot Core.<$>
                   (o Core..:? "acceleratorType") Core.<*>
                     (o Core..:? "milliAccelerator" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "milliDcu" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "milliDcuPremium" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
newWriteSessionSparkApplicationContextRequest =
  WriteSessionSparkApplicationContextRequest
    {parent = Core.Nothing, sparkWrapperObjects = Core.Nothing}
...
newWriteSparkApplicationContextResponse 
    ::  WriteSparkApplicationContextResponse
newWriteSparkApplicationContextResponse = WriteSparkApplicationContextResponse
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "WriteSparkApplicationContextResponse"
              (\ o ->
                 Core.pure WriteSparkApplicationContextResponse)
