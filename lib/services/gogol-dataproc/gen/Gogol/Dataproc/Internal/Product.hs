              ...
              (\ o ->
                 Batch Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "stateHistory" Core..!= Core.mempty)
              ...
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "clusterName") Core.<*>
                     ...
                     Core.<*> (o Core..:? "status")
                     Core.<*>
                     (o Core..:? "statusHistory" Core..!= Core.mempty))
              ...
              (\ o ->
                 ClusterConfig Core.<$>
                   (o Core..:? "autoscalingConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "initializationActions" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "ExecutionConfig"
              (\ o ->
                 ExecutionConfig Core.<$>
                   (o Core..:? "kmsKey") Core.<*>
                     (o Core..:? "networkTags" Core..!= Core.mempty)
              ...
              (\ o ->
                 GceClusterConfig Core.<$>
                   (o Core..:? "confidentialInstanceConfig") Core.<*>
                     ...
                     Core.<*> (o Core..:? "serviceAccount")
                     Core.<*>
                     (o Core..:? "serviceAccountScopes" Core..!=
                        Core.mempty)
...
instance Core.FromJSON HadoopJob where
        parseJSON
          = Core.withObject "HadoopJob"
              (\ o ->
                 HadoopJob Core.<$>
                   (o Core..:? "archiveUris" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "args" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fileUris" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "jarFileUris" Core..!= Core.mempty)
              ...
              (\ o ->
                 InstanceGroupConfig Core.<$>
                   (o Core..:? "accelerators" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "instanceNames" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "instanceReferences" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "done") Core.<*>
                     ...
                     (o Core..:? "statusHistory" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "yarnApplications" Core..!= Core.mempty))
          ...
          = Core.withObject "ListBatchesResponse"
              (\ o ->
                 ListBatchesResponse Core.<$>
                   (o Core..:? "batches" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListWorkflowTemplatesResponse"
              (\ o ->
                 ListWorkflowTemplatesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "templates" Core..!= Core.mempty))
...
instance Core.FromJSON Metric where
        parseJSON
          = Core.withObject "Metric"
              (\ o ->
                 Metric Core.<$>
                   (o Core..:? "metricOverrides" Core..!= Core.mempty)
              ...
              (\ o ->
                 OrderedJob Core.<$>
                   (o Core..:? "hadoopJob") Core.<*>
                     ...
                     Core.<*> (o Core..:? "pigJob")
                     Core.<*>
                     (o Core..:? "prerequisiteStepIds" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "prestoJob")
                     Core.<*> (o Core..:? "pysparkJob")
                     Core.<*> (o Core..:? "scheduling")
...
instance Core.FromJSON PrestoJob where
        parseJSON
          = Core.withObject "PrestoJob"
              (\ o ->
                 PrestoJob Core.<$>
                   (o Core..:? "clientTags" Core..!= Core.mempty)
              ...
              (\ o ->
                 PySparkBatch Core.<$>
                   (o Core..:? "archiveUris" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "pythonFileUris" Core..!= Core.mempty))
...
instance Core.FromJSON QueryList where
        parseJSON
          = Core.withObject "QueryList"
              (\ o ->
                 QueryList Core.<$>
                   (o Core..:? "queries" Core..!= Core.mempty))
...
instance Core.FromJSON RegexValidation where
        parseJSON
          = Core.withObject "RegexValidation"
              (\ o ->
                 RegexValidation Core.<$>
                   (o Core..:? "regexes" Core..!= Core.mempty))
...
instance Core.FromJSON RuntimeInfo where
        parseJSON
          = Core.withObject "RuntimeInfo"
              (\ o ->
                 RuntimeInfo Core.<$>
                   (o Core..:? "diagnosticOutputUri") Core.<*>
                     (o Core..:? "endpoints")
              ...
              (\ o ->
                 SoftwareConfig Core.<$>
                   (o Core..:? "imageVersion") Core.<*>
                     (o Core..:? "optionalComponents" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "properties"))
