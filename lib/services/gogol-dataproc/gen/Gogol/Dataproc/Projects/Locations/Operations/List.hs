...
instance Core.GoogleRequest DataprocProjectsLocationsOperationsList where
  type
    Rs DataprocProjectsLocationsOperationsList =
      ListOperationsResponse
  type
    Scopes DataprocProjectsLocationsOperationsList =
