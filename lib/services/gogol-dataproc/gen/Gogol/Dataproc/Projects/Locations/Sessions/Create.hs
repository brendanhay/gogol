...
type DataprocProjectsLocationsSessionsCreateResource =
  "v1"
    ...
    Core.:> Core.QueryParam "sessionId" Core.Text
...
instance Core.GoogleRequest DataprocProjectsLocationsSessionsCreate where
  type Rs DataprocProjectsLocationsSessionsCreate = Operation
  type
    Scopes DataprocProjectsLocationsSessionsCreate =
