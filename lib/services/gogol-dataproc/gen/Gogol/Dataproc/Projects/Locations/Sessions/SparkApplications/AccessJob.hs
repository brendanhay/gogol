...
type DataprocProjectsLocationsSessionsSparkApplicationsAccessJobResource =
  "v1"
    Core.:> Core.CaptureMode "name" "accessJob" Core.Text
    Core.:> Core.QueryParam "$.xgafv" Xgafv
    Core.:> Core.QueryParam "access_token" Core.Text
    Core.:> Core.QueryParam "callback" Core.Text
    Core.:> Core.QueryParam "jobId" Core.Int64
    Core.:> Core.QueryParam "parent" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.Get '[Core.JSON] AccessSessionSparkApplicationJobResponse
...
instance
  ...
  where
  type
    Rs DataprocProjectsLocationsSessionsSparkApplicationsAccessJob =
