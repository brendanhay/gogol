...
type DataprocProjectsLocationsSessionsSparkApplicationsSearchJobsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "searchJobs" Core.Text
         Core.:>
...
newDataprocProjectsLocationsSessionsSparkApplicationsSearchJobs 
    ...
    -> DataprocProjectsLocationsSessionsSparkApplicationsSearchJobs
newDataprocProjectsLocationsSessionsSparkApplicationsSearchJobs name =
  DataprocProjectsLocationsSessionsSparkApplicationsSearchJobs
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsSearchJobs{..}
          = go name xgafv accessToken callback jobStatus
              pageSize
              pageToken
              parent
              uploadType
