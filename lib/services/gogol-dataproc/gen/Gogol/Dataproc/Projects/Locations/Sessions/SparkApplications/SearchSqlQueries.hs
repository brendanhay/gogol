...
type DataprocProjectsLocationsSessionsSparkApplicationsSearchSqlQueriesResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "searchSqlQueries" Core.Text
         Core.:>
...
newDataprocProjectsLocationsSessionsSparkApplicationsSearchSqlQueries 
    ...
    -> DataprocProjectsLocationsSessionsSparkApplicationsSearchSqlQueries
newDataprocProjectsLocationsSessionsSparkApplicationsSearchSqlQueries name =
  DataprocProjectsLocationsSessionsSparkApplicationsSearchSqlQueries
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsSearchSqlQueries{..}
          = go name xgafv accessToken callback details pageSize
              pageToken
              parent
              planDescription
              uploadType
