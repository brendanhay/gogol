...
type DataprocProjectsRegionsClustersInjectCredentialsResource =
  "v1"
    ...
    Core.:> Core.CaptureMode "cluster" "injectCredentials" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] InjectCredentialsRequest
...
instance
  ...
  where
  type
    Rs DataprocProjectsRegionsClustersInjectCredentials =
      Operation
  type
    Scopes DataprocProjectsRegionsClustersInjectCredentials =
