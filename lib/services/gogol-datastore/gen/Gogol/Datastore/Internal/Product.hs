...
newCommitRequest =
  CommitRequest
    {mode = Core.Nothing, mutations = Core.Nothing, transaction = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "CommitRequest"
              (\ o ->
                 CommitRequest Core.<$>
                   (o Core..:? "mode") Core.<*>
                     (o Core..:? "mutations" Core..!= Core.mempty)
...
instance Core.FromJSON CommitResponse where
        parseJSON
          = Core.withObject "CommitResponse"
              (\ o ->
                 CommitResponse Core.<$>
                   (o Core..:? "indexUpdates") Core.<*>
                     (o Core..:? "mutationResults" Core..!= Core.mempty))
...
newEntity_Properties 
    ::  Core.HashMap Core.Text Value
       -- ^  See 'addtional'.
    -> Entity_Properties
newEntity_Properties addtional = Entity_Properties {addtional = addtional}
...
instance Core.ToJSON Entity_Properties where
        toJSON Entity_Properties{..} = Core.toJSON addtional
...
newEntityResult =
  EntityResult
    {cursor = Core.Nothing, entity = Core.Nothing, version = Core.Nothing}
...
instance Core.FromJSON EntityResult where
        parseJSON
          = Core.withObject "EntityResult"
              (\ o ->
                 EntityResult Core.<$>
                   (o Core..:? "cursor") Core.<*> (o Core..:? "entity")
                     Core.<*> (o Core..:? "version"))
...
newGoogleDatastoreAdminV1CommonMetadata_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> GoogleDatastoreAdminV1CommonMetadata_Labels
newGoogleDatastoreAdminV1CommonMetadata_Labels addtional =
  GoogleDatastoreAdminV1CommonMetadata_Labels {addtional = addtional}
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleDatastoreAdminV1EntityFilter Core.<$>
                   (o Core..:? "kinds" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "namespaceIds" Core..!= Core.mempty))
...
newGoogleDatastoreAdminV1ExportEntitiesRequest_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> GoogleDatastoreAdminV1ExportEntitiesRequest_Labels
newGoogleDatastoreAdminV1ExportEntitiesRequest_Labels addtional =
  GoogleDatastoreAdminV1ExportEntitiesRequest_Labels {addtional = addtional}
...
newGoogleDatastoreAdminV1ImportEntitiesRequest_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> GoogleDatastoreAdminV1ImportEntitiesRequest_Labels
newGoogleDatastoreAdminV1ImportEntitiesRequest_Labels addtional =
  GoogleDatastoreAdminV1ImportEntitiesRequest_Labels {addtional = addtional}
...
newGoogleDatastoreAdminV1beta1CommonMetadata_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> GoogleDatastoreAdminV1beta1CommonMetadata_Labels
newGoogleDatastoreAdminV1beta1CommonMetadata_Labels addtional =
  GoogleDatastoreAdminV1beta1CommonMetadata_Labels {addtional = addtional}
              ...
              (\ o ->
                 GqlQuery Core.<$>
                   (o Core..:? "allowLiterals") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "positionalBindings" Core..!=
                        Core.mempty)
...
newtype GqlQuery_NamedBindings = GqlQuery_NamedBindings
    {
      -- | 
      addtional :: (Core.HashMap Core.Text GqlQueryParameter)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGqlQuery_NamedBindings 
    ::  Core.HashMap Core.Text GqlQueryParameter
       -- ^  See 'addtional'.
    -> GqlQuery_NamedBindings
newGqlQuery_NamedBindings addtional =
  GqlQuery_NamedBindings {addtional = addtional}
...
instance Core.FromJSON LookupRequest where
        parseJSON
          = Core.withObject "LookupRequest"
              (\ o ->
                 LookupRequest Core.<$>
                   (o Core..:? "keys" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "readOptions"))
...
newLookupResponse =
  LookupResponse
    {deferred = Core.Nothing, found = Core.Nothing, missing = Core.Nothing}
...
instance Core.FromJSON LookupResponse where
        parseJSON
          = Core.withObject "LookupResponse"
              (\ o ->
                 LookupResponse Core.<$>
                   (o Core..:? "deferred" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "found" Core..!= Core.mempty)
...
instance Core.FromJSON Query where
        parseJSON
          = Core.withObject "Query"
              (\ o ->
                 Query Core.<$>
                   (o Core..:? "distinctOn" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "projection" Core..!= Core.mempty)
              ...
              (\ o ->
                 QueryResultBatch Core.<$>
                   (o Core..:? "endCursor") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "entityResults" Core..!= Core.mempty)
