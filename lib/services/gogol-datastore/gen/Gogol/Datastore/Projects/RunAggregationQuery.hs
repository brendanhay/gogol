...
type DatastoreProjectsRunAggregationQueryResource =
  "v1"
    Core.:> "projects"
    Core.:> Core.CaptureMode "projectId" "runAggregationQuery" Core.Text
...
instance Core.GoogleRequest DatastoreProjectsRunAggregationQuery where
  type
    Rs DatastoreProjectsRunAggregationQuery =
      RunAggregationQueryResponse
  type
    Scopes DatastoreProjectsRunAggregationQuery =
