...
newBreakpoint_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Breakpoint_Labels
newBreakpoint_Labels additional = Breakpoint_Labels {additional = additional}
...
newDebuggee_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Debuggee_Labels
newDebuggee_Labels additional = Debuggee_Labels {additional = additional}
          ...
          = Core.withObject "ListActiveBreakpointsResponse"
              (\ o ->
                 ListActiveBreakpointsResponse Core.<$>
                   (o Core..:? "breakpoints") Core.<*>
                     (o Core..:? "nextWaitToken")
...
instance Core.FromJSON Variable where
        parseJSON
          = Core.withObject "Variable"
              (\ o ->
                 Variable Core.<$>
                   (o Core..:? "members") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value")
