        ...
        parseJSON
          = Core.withObject "Breakpoint"
              (\ o ->
                 Breakpoint Core.<$>
                   (o Core..:? "action") Core.<*>
                     (o Core..:? "canaryExpireTime")
                     Core.<*> (o Core..:? "condition")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*>
                     (o Core..:? "evaluatedExpressions" Core..!=
                        Core.mempty)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "variableTable" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("canaryExpireTime" Core..=) Core.<$>
                    canaryExpireTime,
                  ("condition" Core..=) Core.<$> condition,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("evaluatedExpressions" Core..=) Core.<$>
...
newCloudWorkspaceSourceContext =
  CloudWorkspaceSourceContext
    {snapshotId = Core.Nothing, workspaceId = Core.Nothing}

instance Core.FromJSON CloudWorkspaceSourceContext
         where
        parseJSON
          = Core.withObject "CloudWorkspaceSourceContext"
              (\ o ->
                 CloudWorkspaceSourceContext Core.<$>
                   (o Core..:? "snapshotId") Core.<*>
                     (o Core..:? "workspaceId"))

instance Core.ToJSON CloudWorkspaceSourceContext
         where
...
instance Core.FromJSON Debuggee where
        parseJSON
          = Core.withObject "Debuggee"
              (\ o ->
                 Debuggee Core.<$>
                   (o Core..:? "agentVersion") Core.<*>
                     (o Core..:? "canaryMode")
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "extSourceContexts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     ...
                     Core.<*> (o Core..:? "project")
                     Core.<*>
                     (o Core..:? "sourceContexts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "status")
...
instance Core.FromJSON ExtendedSourceContext_Labels
         where
        parseJSON
          = Core.withObject "ExtendedSourceContext_Labels"
              (\ o ->
                 ExtendedSourceContext_Labels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExtendedSourceContext_Labels
         where
...
instance Core.FromJSON ListActiveBreakpointsResponse
         where
        parseJSON
          = Core.withObject "ListActiveBreakpointsResponse"
              (\ o ->
                 ListActiveBreakpointsResponse Core.<$>
                   (o Core..:? "breakpoints" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextWaitToken")
                     Core.<*> (o Core..:? "waitExpired"))

instance Core.ToJSON ListActiveBreakpointsResponse
         where
...
newListBreakpointsResponse =
  ListBreakpointsResponse
    {breakpoints = Core.Nothing, nextWaitToken = Core.Nothing}
...
instance Core.FromJSON ListDebuggeesResponse where
        parseJSON
          = Core.withObject "ListDebuggeesResponse"
              (\ o ->
                 ListDebuggeesResponse Core.<$>
                   (o Core..:? "debuggees" Core..!= Core.mempty))
...
newSourceLocation =
  SourceLocation
    {column = Core.Nothing, line = Core.Nothing, path = Core.Nothing}
...
instance Core.FromJSON SourceLocation where
        parseJSON
          = Core.withObject "SourceLocation"
              (\ o ->
                 SourceLocation Core.<$>
                   (o Core..:? "column") Core.<*> (o Core..:? "line")
                     Core.<*> (o Core..:? "path"))
...
instance Core.FromJSON UpdateActiveBreakpointRequest
         where
        parseJSON
          = Core.withObject "UpdateActiveBreakpointRequest"
              (\ o ->
                 UpdateActiveBreakpointRequest Core.<$>
                   (o Core..:? "breakpoint"))

instance Core.ToJSON UpdateActiveBreakpointRequest
         where
...
instance Core.FromJSON UpdateActiveBreakpointResponse
         where
        parseJSON
          = Core.withObject "UpdateActiveBreakpointResponse"
              (\ o -> Core.pure UpdateActiveBreakpointResponse)

instance Core.ToJSON UpdateActiveBreakpointResponse
         where
        toJSON = Core.const Core.emptyObject
