...
instance Core.FromJSON BulkInsertOperationStatus where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          BulkInsertOperationStatus
            Core.<$> (o Core..:? "createdVmCount")
            Core.<*> (o Core..:? "deletedVmCount")
...
newErrorInfo_Metadata ::
  ...
  ErrorInfo_Metadata
newErrorInfo_Metadata additional =
  ErrorInfo_Metadata {additional = additional}

instance Core.FromJSON ErrorInfo_Metadata where
  parseJSON =
    Core.withObject
      "ErrorInfo_Metadata"
      (\o -> ErrorInfo_Metadata Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ErrorInfo_Metadata where
  toJSON ErrorInfo_Metadata {..} = Core.toJSON additional
    ...
    Core.withObject
      ...
      ( \o ->
          Manifest
            ...
            Core.<*> (o Core..:? "insertTime")
            Core.<*> (o Core..:? "layout")
            Core.<*> (o Core..:? "manifestSizeBytes" Core.<&> Core.fmap Core.fromAsText)
            Core.<*> ( o
    ...
    Core.object
      ( Core.catMaybes
          [ ("config" Core..=) Core.<$> config,
            ...
            ("manifestSizeBytes" Core..=)
              Core.. Core.AsText
              Core.<$> manifestSizeBytes,
            ("manifestSizeLimitBytes" Core..=)
              Core.. Core.AsText
              Core.<$> manifestSizeLimitBytes,
            ("name" Core..=) Core.<$> name,
            ("selfLink" Core..=) Core.<$> selfLink
...
instance Core.FromJSON Operation_Error_ErrorsItem_ErrorDetailsItem where
  parseJSON =
    Core.withObject
      "Operation_Error_ErrorsItem_ErrorDetailsItem"
      ( \o ->
...
instance Core.ToJSON Operation_Error_ErrorsItem_ErrorDetailsItem where
...
instance Core.FromJSON SetCommonInstanceMetadataOperationMetadata where
  parseJSON =
    Core.withObject
      "SetCommonInstanceMetadataOperationMetadata"
      ( \o ->
          SetCommonInstanceMetadataOperationMetadata
            Core.<$> (o Core..:? "clientOperationId")
            Core.<*> (o Core..:? "perLocationOperations")
      )

instance Core.ToJSON SetCommonInstanceMetadataOperationMetadata where
