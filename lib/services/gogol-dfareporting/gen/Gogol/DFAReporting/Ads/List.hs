                   ...
                   Core.QueryParam "active" Core.Bool Core.:>
                     Core.QueryParam "advertiserId" Core.Int64 Core.:>
                       Core.QueryParam "archived" Core.Bool Core.:>
                         Core.QueryParams "audienceSegmentIds" Core.Int64
                           Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParams "campaignIds" Core.Int64 Core.:>
                               Core.QueryParam "compatibility"
                                 AdsListCompatibility
                                 Core.:>
                                 Core.QueryParams "creativeIds" Core.Int64
                                   Core.:>
                                   Core.QueryParams
                                     "creativeOptimizationConfigurationIds"
                                     Core.Int64
                                     Core.:>
                                     Core.QueryParam "dynamicClickTracker"
                                       Core.Bool
                                       Core.:>
                                       Core.QueryParams "ids" Core.Int64 Core.:>
                                         Core.QueryParams "landingPageIds"
                                           Core.Int64
                                           Core.:>
                                           Core.QueryParam "maxResults"
                                             Core.Int32
                                             Core.:>
                                             Core.QueryParam
...
instance Core.GoogleRequest DFAReportingAdsList where
        ...
        type Scopes DFAReportingAdsList =
             '[Dfatrafficking'FullControl]
        requestClient DFAReportingAdsList{..}
          = go profileId xgafv accessToken active advertiserId
              archived
              ...
              (creativeOptimizationConfigurationIds Core.^.
                 Core._Default)
              dynamicClickTracker
