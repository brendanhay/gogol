                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "advertiserGroupIds" Core.Int64
                     ...
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParams "floodlightConfigurationIds"
                         Core.Int64
                         Core.:>
                         Core.QueryParams "ids" Core.Int64 Core.:>
                           Core.QueryParam "includeAdvertisersWithoutGroupsOnly"
                             Core.Bool
                             Core.:>
...
instance Core.GoogleRequest
           DFAReportingAdvertisersList
         where
        type Rs DFAReportingAdvertisersList =
             AdvertisersListResponse
