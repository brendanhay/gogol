             ...
             "campaigns" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "advertiserGroupIds" Core.Int64
                     Core.:>
                     Core.QueryParams "advertiserIds" Core.Int64 Core.:>
                       Core.QueryParam "archived" Core.Bool Core.:>
                         Core.QueryParam "atLeastOneOptimizationActivity"
                           Core.Bool
                           Core.:>
                             ...
                             Core.QueryParams "excludedIds" Core.Int64 Core.:>
                               Core.QueryParams "ids" Core.Int64 Core.:>
                                 Core.QueryParam "maxResults" Core.Int32 Core.:>
                                   Core.QueryParam "overriddenEventTagId"
                                     Core.Int64
                                     Core.:>
...
instance Core.GoogleRequest DFAReportingCampaignsList
         where
        type Rs DFAReportingCampaignsList =
             CampaignsListResponse
