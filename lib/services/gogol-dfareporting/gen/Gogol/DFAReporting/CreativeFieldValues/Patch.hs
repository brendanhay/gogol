                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] CreativeFieldValue
                                   Core.:>
...
newDFAReportingCreativeFieldValuesPatch 
    ...
    -> DFAReportingCreativeFieldValuesPatch
newDFAReportingCreativeFieldValuesPatch creativeFieldId id payload profileId =
  DFAReportingCreativeFieldValuesPatch
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DFAReportingCreativeFieldValuesPatch
         where
        type Rs DFAReportingCreativeFieldValuesPatch =
             CreativeFieldValue
        type Scopes DFAReportingCreativeFieldValuesPatch =
             '[Dfatrafficking'FullControl]
        requestClient
          DFAReportingCreativeFieldValuesPatch{..}
          = go profileId creativeFieldId (Core.Just id) xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
