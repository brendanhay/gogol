                       ...
                       Core.QueryParam "archived" Core.Bool Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "campaignId" Core.Int64 Core.:>
                             Core.QueryParams "companionCreativeIds" Core.Int64
                               Core.:>
                               Core.QueryParams "creativeFieldIds" Core.Int64
                                 Core.:>
...
instance Core.GoogleRequest DFAReportingCreativesList
         where
        type Rs DFAReportingCreativesList =
             CreativesListResponse
