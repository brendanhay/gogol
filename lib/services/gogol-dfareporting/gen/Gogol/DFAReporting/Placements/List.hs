                     ...
                     Core.QueryParams "advertiserIds" Core.Int64 Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParams "campaignIds" Core.Int64 Core.:>
                           Core.QueryParams "compatibilities"
                             PlacementsListCompatibilities
                             Core.:>
                             Core.QueryParams "contentCategoryIds" Core.Int64
                               Core.:>
                               Core.QueryParams "directorySiteIds" Core.Int64
                                 ...
                                 Core.QueryParams "groupIds" Core.Int64 Core.:>
                                   Core.QueryParams "ids" Core.Int64 Core.:>
                                     Core.QueryParam "maxEndDate" Core.Text
                                       Core.:>
                                       Core.QueryParam "maxResults" Core.Int32
                                         Core.:>
                                         Core.QueryParam "maxStartDate"
                                           Core.Text
                                           Core.:>
                                           Core.QueryParam "minEndDate"
                                             Core.Text
                                             Core.:>
                                             Core.QueryParam "minStartDate"
                                               Core.Text
                                               Core.:>
...
instance Core.GoogleRequest
           DFAReportingPlacementsList
         where
        type Rs DFAReportingPlacementsList =
             PlacementsListResponse
