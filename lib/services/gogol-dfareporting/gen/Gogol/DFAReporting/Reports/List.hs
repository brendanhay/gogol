                     ...
                     Core.QueryParam "maxResults" Core.Int32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "scope" ReportsListScope Core.:>
                           Core.QueryParam "sortField" ReportsListSortField
                             Core.:>
                             Core.QueryParam "sortOrder" ReportsListSortOrder
                               Core.:>
...
instance Core.GoogleRequest DFAReportingReportsList
         where
        type Rs DFAReportingReportsList = ReportList
        type Scopes DFAReportingReportsList =
