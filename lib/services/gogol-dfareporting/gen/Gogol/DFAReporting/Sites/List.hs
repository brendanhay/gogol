           ...
           Core.Capture "profileId" Core.Int64 Core.:>
             "sites" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "acceptsInStreamVideoPlacements"
                   Core.Bool
                   Core.:>
                   Core.QueryParam "acceptsInterstitialPlacements"
                     Core.Bool
                     Core.:>
                     Core.QueryParam "acceptsPublisherPaidPlacements"
                       Core.Bool
                       Core.:>
                           ...
                           Core.QueryParam "approved" Core.Bool Core.:>
                             Core.QueryParam "callback" Core.Text Core.:>
                               Core.QueryParams "campaignIds" Core.Int64 Core.:>
                                 Core.QueryParams "directorySiteIds" Core.Int64
                                   Core.:>
                                         ...
                                         Core.QueryParam "searchString"
                                           ...
                                           Core.QueryParam "sortField"
                                             ...
                                             Core.QueryParam "sortOrder"
                                               SitesListSortOrder
                                               Core.:>
                                               Core.QueryParam "subaccountId"
                                                 Core.Int64
                                                 Core.:>
                                                 Core.QueryParam "unmappedSite"
                                                   Core.Bool
                                                   Core.:>
...
instance Core.GoogleRequest DFAReportingSitesList
         where
        type Rs DFAReportingSitesList = SitesListResponse
        type Scopes DFAReportingSitesList =
