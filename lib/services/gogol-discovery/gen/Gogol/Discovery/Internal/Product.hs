              ...
              (\ o ->
                 JsonSchema Core.<$>
                   (o Core..:? "$ref") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "enumDescriptions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "format")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "items")
          ...
          = Core.withObject "JsonSchema_Annotations"
              (\ o ->
                 JsonSchema_Annotations Core.<$>
                   (o Core..:? "required" Core..!= Core.mempty))
...
newtype JsonSchema_Properties = JsonSchema_Properties
    {
      ...
      addtional :: (Core.HashMap Core.Text JsonSchema)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newJsonSchema_Properties 
    ::  Core.HashMap Core.Text JsonSchema
       -- ^  A single property of this object. The value is itself a JSON Schema object describing this property. See 'addtional'.
    -> JsonSchema_Properties
newJsonSchema_Properties addtional =
  JsonSchema_Properties {addtional = addtional}
...
newtype RestDescription_Auth_Oauth2_Scopes = RestDescription_Auth_Oauth2_Scopes
    {
      -- | The scope value.
      addtional :: (Core.HashMap Core.Text
   RestDescription_Auth_Oauth2_ScopesAdditional)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRestDescription_Auth_Oauth2_Scopes 
    ::  Core.HashMap Core.Text RestDescription_Auth_Oauth2_ScopesAdditional
       -- ^  The scope value. See 'addtional'.
    -> RestDescription_Auth_Oauth2_Scopes
newRestDescription_Auth_Oauth2_Scopes addtional =
  RestDescription_Auth_Oauth2_Scopes {addtional = addtional}
...
newtype RestDescription_Methods = RestDescription_Methods
    {
      ...
      addtional :: (Core.HashMap Core.Text RestMethod)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRestDescription_Methods 
    ::  Core.HashMap Core.Text RestMethod
       -- ^  An individual method description. See 'addtional'.
    -> RestDescription_Methods
newRestDescription_Methods addtional =
  RestDescription_Methods {addtional = addtional}
...
newRestDescription_Parameters 
    ::  Core.HashMap Core.Text JsonSchema
       -- ^  Description of a single parameter. See 'addtional'.
    -> RestDescription_Parameters
newRestDescription_Parameters addtional =
  RestDescription_Parameters {addtional = addtional}
...
newtype RestDescription_Resources = RestDescription_Resources
    {
      ...
      addtional :: (Core.HashMap Core.Text RestResource)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRestDescription_Resources 
    ::  Core.HashMap Core.Text RestResource
       -- ^  An individual resource description. Contains methods and sub-resources related to this resource. See 'addtional'.
    -> RestDescription_Resources
newRestDescription_Resources addtional =
  RestDescription_Resources {addtional = addtional}
...
newRestDescription_Schemas 
    ::  Core.HashMap Core.Text JsonSchema
       -- ^  An individual schema description. See 'addtional'.
    -> RestDescription_Schemas
newRestDescription_Schemas addtional =
  RestDescription_Schemas {addtional = addtional}
              ...
              (\ o ->
                 RestMethod Core.<$>
                   (o Core..:? "description") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "parameterOrder" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "parameters")
                     Core.<*> (o Core..:? "path")
                     Core.<*> (o Core..:? "request")
          ...
          = Core.withObject "RestMethod_MediaUpload"
              (\ o ->
                 RestMethod_MediaUpload Core.<$>
                   (o Core..:? "accept" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "maxSize")
...
newRestMethod_Parameters 
    ::  Core.HashMap Core.Text JsonSchema
       -- ^  Details for a single parameter in this method. See 'addtional'.
    -> RestMethod_Parameters
newRestMethod_Parameters addtional =
  RestMethod_Parameters {addtional = addtional}
...
newRestResource_Methods 
    ::  Core.HashMap Core.Text RestMethod
       -- ^  Description for any methods on this resource. See 'addtional'.
    -> RestResource_Methods
newRestResource_Methods addtional = RestResource_Methods {addtional = addtional}
...
newRestResource_Resources 
    ::  Core.HashMap Core.Text RestResource
       -- ^  Description for any sub-resources on this resource. See 'addtional'.
    -> RestResource_Resources
newRestResource_Resources addtional =
  RestResource_Resources {addtional = addtional}
