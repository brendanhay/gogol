...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2AllOtherBigQueryTables"
              (\ o ->
                 Core.pure GooglePrivacyDlpV2AllOtherBigQueryTables)
...
newGooglePrivacyDlpV2AllOtherResources 
    ::  GooglePrivacyDlpV2AllOtherResources
newGooglePrivacyDlpV2AllOtherResources = GooglePrivacyDlpV2AllOtherResources
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2AllOtherResources"
              (\ o ->
                 Core.pure GooglePrivacyDlpV2AllOtherResources)
...
newGooglePrivacyDlpV2AmazonS3Bucket =
  GooglePrivacyDlpV2AmazonS3Bucket
    {awsAccount = Core.Nothing, bucketName = Core.Nothing}
          ...
          = Core.withObject "GooglePrivacyDlpV2AmazonS3Bucket"
              (\ o ->
                 GooglePrivacyDlpV2AmazonS3Bucket Core.<$>
                   (o Core..:? "awsAccount") Core.<*>
                     (o Core..:? "bucketName"))

instance Core.ToJSON GooglePrivacyDlpV2AmazonS3Bucket
         where
...
newGooglePrivacyDlpV2AmazonS3BucketConditions =
  GooglePrivacyDlpV2AmazonS3BucketConditions
    {bucketTypes = Core.Nothing, objectStorageClasses = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("bucketTypes" Core..=) Core.<$> bucketTypes,
                  ("objectStorageClasses" Core..=) Core.<$>
...
newGooglePrivacyDlpV2AmazonS3BucketRegex =
  GooglePrivacyDlpV2AmazonS3BucketRegex
    {awsAccountRegex = Core.Nothing, bucketNameRegex = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON GooglePrivacyDlpV2AmazonS3BucketRegex{..}
          = Core.object
              (Core.catMaybes
                 [("awsAccountRegex" Core..=) Core.<$>
                    awsAccountRegex,
                  ("bucketNameRegex" Core..=) Core.<$>
                    bucketNameRegex])
...
instance Core.FromJSON GooglePrivacyDlpV2AwsAccount
         where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2AwsAccount"
              (\ o ->
                 GooglePrivacyDlpV2AwsAccount Core.<$>
                   (o Core..:? "accountId"))

instance Core.ToJSON GooglePrivacyDlpV2AwsAccount
         where
...
newGooglePrivacyDlpV2AwsDiscoveryStartingLocation =
  GooglePrivacyDlpV2AwsDiscoveryStartingLocation
    {accountId = Core.Nothing, allAssetInventoryAssets = Core.Nothing}
...
instance Core.ToJSON GooglePrivacyDlpV2BigQueryRegex
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2BigQueryRegexes"
              (\ o ->
                 GooglePrivacyDlpV2BigQueryRegexes Core.<$>
                   (o Core..:? "patterns"))
...
newGooglePrivacyDlpV2BigQueryTableCollection 
    ::  GooglePrivacyDlpV2BigQueryTableCollection
newGooglePrivacyDlpV2BigQueryTableCollection =
  GooglePrivacyDlpV2BigQueryTableCollection {includeRegexes = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2BigQueryTableTypes"
              (\ o ->
                 GooglePrivacyDlpV2BigQueryTableTypes Core.<$>
                   (o Core..:? "types"))
...
instance Core.ToJSON
        ...
        toJSON GooglePrivacyDlpV2BigQueryTableTypes{..}
          = Core.object
              (Core.catMaybes [("types" Core..=) Core.<$> types])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2CloudSqlIamCredential"
              (\ o ->
                 Core.pure GooglePrivacyDlpV2CloudSqlIamCredential)
          ...
          = Core.withObject
              ...
              (\ o ->
                 GooglePrivacyDlpV2CloudSqlProperties Core.<$>
                   (o Core..:? "cloudSqlIam") Core.<*>
                     (o Core..:? "connectionName")
...
newGooglePrivacyDlpV2CloudStorageRegex =
  GooglePrivacyDlpV2CloudStorageRegex
    {bucketNameRegex = Core.Nothing, projectIdRegex = Core.Nothing}
...
newGooglePrivacyDlpV2CloudStorageResourceReference =
  GooglePrivacyDlpV2CloudStorageResourceReference
    {bucketName = Core.Nothing, projectId = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("column" Core..=) Core.<$> column,
                  ...
                  ("tableDataProfile" Core..=) Core.<$>
                    tableDataProfile,
                  ("tableFullResource" Core..=) Core.<$>
                    tableFullResource,
                  ("tableId" Core..=) Core.<$> tableId])
...
instance Core.FromJSON GooglePrivacyDlpV2Connection
         where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2Connection"
              (\ o ->
                 GooglePrivacyDlpV2Connection Core.<$>
                   (o Core..:? "cloudSql") Core.<*>
                     (o Core..:? "errors")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON GooglePrivacyDlpV2Connection
         where
...
newGooglePrivacyDlpV2CreateConnectionRequest 
    ::  GooglePrivacyDlpV2CreateConnectionRequest
newGooglePrivacyDlpV2CreateConnectionRequest =
  GooglePrivacyDlpV2CreateConnectionRequest {connection = Core.Nothing}
...
newGooglePrivacyDlpV2CreateDiscoveryConfigRequest =
  GooglePrivacyDlpV2CreateDiscoveryConfigRequest
    {configId = Core.Nothing, discoveryConfig = Core.Nothing}
...
instance Core.ToJSON GooglePrivacyDlpV2DataSourceType
         where
...
newGooglePrivacyDlpV2DatabaseResourceCollection 
    ::  GooglePrivacyDlpV2DatabaseResourceCollection
newGooglePrivacyDlpV2DatabaseResourceCollection =
  GooglePrivacyDlpV2DatabaseResourceCollection {includeRegexes = Core.Nothing}
...
newGooglePrivacyDlpV2DatabaseResourceRegexes 
    ::  GooglePrivacyDlpV2DatabaseResourceRegexes
newGooglePrivacyDlpV2DatabaseResourceRegexes =
  GooglePrivacyDlpV2DatabaseResourceRegexes {patterns = Core.Nothing}
...
instance Core.FromJSON GooglePrivacyDlpV2Disabled
         where
        parseJSON
          ...
          = Core.withObject
              ...
              (\ o ->
                 GooglePrivacyDlpV2DiscoveryBigQueryFilter Core.<$>
                   (o Core..:? "otherTables") Core.<*>
                     (o Core..:? "tableReference")
                     Core.<*> (o Core..:? "tables"))
...
newGooglePrivacyDlpV2DiscoveryCloudSqlConditions =
  GooglePrivacyDlpV2DiscoveryCloudSqlConditions
    {databaseEngines = Core.Nothing, types = Core.Nothing}
...
newGooglePrivacyDlpV2DiscoveryCloudSqlGenerationCadence =
  GooglePrivacyDlpV2DiscoveryCloudSqlGenerationCadence
    { inspectTemplateModifiedCadence = Core.Nothing
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GooglePrivacyDlpV2DiscoveryCloudSqlGenerationCadence
                   Core.<$>
                   (o Core..:? "inspectTemplateModifiedCadence")
          ...
          = Core.object
              (Core.catMaybes
                 [("inspectTemplateModifiedCadence" Core..=) Core.<$>
                  ...
                  ("refreshFrequency" Core..=) Core.<$>
                    refreshFrequency,
                  ("schemaModifiedCadence" Core..=) Core.<$>
...
newGooglePrivacyDlpV2DiscoveryCloudStorageConditions =
  GooglePrivacyDlpV2DiscoveryCloudStorageConditions
    { includedBucketAttributes = Core.Nothing
...
newGooglePrivacyDlpV2DiscoveryCloudStorageFilter =
  GooglePrivacyDlpV2DiscoveryCloudStorageFilter
    { cloudStorageResourceReference = Core.Nothing
    , collection = Core.Nothing
    , others = Core.Nothing
    }
...
newGooglePrivacyDlpV2DiscoveryFileStoreConditions =
  GooglePrivacyDlpV2DiscoveryFileStoreConditions
    { cloudStorageConditions = Core.Nothing
    , createdAfter = Core.Nothing
    , minAge = Core.Nothing
    }
          ...
          = Core.object
              (Core.catMaybes
                 [("inspectTemplateModifiedCadence" Core..=) Core.<$>
                  ...
                  ("schemaModifiedCadence" Core..=) Core.<$>
                    schemaModifiedCadence,
                  ("tableModifiedCadence" Core..=) Core.<$>
...
newGooglePrivacyDlpV2DiscoveryOtherCloudConditions =
  GooglePrivacyDlpV2DiscoveryOtherCloudConditions
    {amazonS3BucketConditions = Core.Nothing, minAge = Core.Nothing}
...
newGooglePrivacyDlpV2DiscoverySchemaModifiedCadence =
  GooglePrivacyDlpV2DiscoverySchemaModifiedCadence
    {frequency = Core.Nothing, types = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("bigQueryTarget" Core..=) Core.<$> bigQueryTarget,
                  ...
                  ("cloudStorageTarget" Core..=) Core.<$>
                    cloudStorageTarget,
                  ("otherCloudTarget" Core..=) Core.<$>
                    otherCloudTarget,
          ...
          = Core.object
              (Core.catMaybes
                 [("dataRiskLevel" Core..=) Core.<$> dataRiskLevel,
                  ...
                  ("fileExtensionsScanned" Core..=) Core.<$>
                    fileExtensionsScanned,
                  ("fileExtensionsSeen" Core..=) Core.<$>
                    fileExtensionsSeen,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2FileClusterType"
              (\ o ->
                 GooglePrivacyDlpV2FileClusterType Core.<$>
                   (o Core..:? "cluster"))
...
newGooglePrivacyDlpV2FileStoreCollection 
    ::  GooglePrivacyDlpV2FileStoreCollection
newGooglePrivacyDlpV2FileStoreCollection =
  GooglePrivacyDlpV2FileStoreCollection {includeRegexes = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("configSnapshot" Core..=) Core.<$> configSnapshot,
                  ...
                  ("dataStorageLocations" Core..=) Core.<$>
                    dataStorageLocations,
                  ("fileClusterSummaries" Core..=) Core.<$>
                    fileClusterSummaries,
                  ("fileStoreInfoTypeSummaries" Core..=) Core.<$>
                    fileStoreInfoTypeSummaries,
                  ("fileStoreIsEmpty" Core..=) Core.<$>
                    fileStoreIsEmpty,
                  ("fileStoreLocation" Core..=) Core.<$>
                    fileStoreLocation,
...
newGooglePrivacyDlpV2FileStoreDataProfile_ResourceAttributes 
    ::  Core.HashMap Core.Text GooglePrivacyDlpV2Value
       -- ^  See 'additional'.
    -> GooglePrivacyDlpV2FileStoreDataProfile_ResourceAttributes
newGooglePrivacyDlpV2FileStoreDataProfile_ResourceAttributes additional =
  GooglePrivacyDlpV2FileStoreDataProfile_ResourceAttributes
...
newGooglePrivacyDlpV2FileStoreInfoTypeSummary 
    ::  GooglePrivacyDlpV2FileStoreInfoTypeSummary
newGooglePrivacyDlpV2FileStoreInfoTypeSummary =
  GooglePrivacyDlpV2FileStoreInfoTypeSummary {infoType = Core.Nothing}
...
newGooglePrivacyDlpV2FileStoreRegex 
    ::  GooglePrivacyDlpV2FileStoreRegex
newGooglePrivacyDlpV2FileStoreRegex =
  GooglePrivacyDlpV2FileStoreRegex {cloudStorageRegex = Core.Nothing}
...
instance Core.ToJSON GooglePrivacyDlpV2FileStoreRegex
         where
        toJSON GooglePrivacyDlpV2FileStoreRegex{..}
          = Core.object
              (Core.catMaybes
                 [("cloudStorageRegex" Core..=) Core.<$>
                    cloudStorageRegex])
...
newGooglePrivacyDlpV2InfoTypeLikelihood =
  GooglePrivacyDlpV2InfoTypeLikelihood
    {infoType = Core.Nothing, minLikelihood = Core.Nothing}
...
newGooglePrivacyDlpV2ListColumnDataProfilesResponse =
  GooglePrivacyDlpV2ListColumnDataProfilesResponse
    {columnDataProfiles = Core.Nothing, nextPageToken = Core.Nothing}
...
newGooglePrivacyDlpV2ListDiscoveryConfigsResponse =
  GooglePrivacyDlpV2ListDiscoveryConfigsResponse
    {discoveryConfigs = Core.Nothing, nextPageToken = Core.Nothing}
...
newGooglePrivacyDlpV2ListFileStoreDataProfilesResponse =
  GooglePrivacyDlpV2ListFileStoreDataProfilesResponse
    {fileStoreDataProfiles = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("fileStoreDataProfiles" Core..=) Core.<$>
...
newGooglePrivacyDlpV2ListProjectDataProfilesResponse =
  GooglePrivacyDlpV2ListProjectDataProfilesResponse
    {nextPageToken = Core.Nothing, projectDataProfiles = Core.Nothing}
...
newGooglePrivacyDlpV2ListTableDataProfilesResponse =
  GooglePrivacyDlpV2ListTableDataProfilesResponse
    {nextPageToken = Core.Nothing, tableDataProfiles = Core.Nothing}
...
newGooglePrivacyDlpV2OrConditions =
  GooglePrivacyDlpV2OrConditions
    {minAge = Core.Nothing, minRowCount = Core.Nothing}

instance Core.FromJSON GooglePrivacyDlpV2OrConditions
         where
        parseJSON
...
instance Core.ToJSON GooglePrivacyDlpV2OrConditions
         where
...
newGooglePrivacyDlpV2OrgConfig =
  GooglePrivacyDlpV2OrgConfig
    {location = Core.Nothing, projectId = Core.Nothing}

instance Core.FromJSON GooglePrivacyDlpV2OrgConfig
         where
        parseJSON
...
instance Core.ToJSON GooglePrivacyDlpV2OrgConfig
         where
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("awsLocation" Core..=) Core.<$> awsLocation])
...
newGooglePrivacyDlpV2OtherCloudResourceCollection 
    ::  GooglePrivacyDlpV2OtherCloudResourceCollection
newGooglePrivacyDlpV2OtherCloudResourceCollection =
  GooglePrivacyDlpV2OtherCloudResourceCollection {includeRegexes = Core.Nothing}
...
newGooglePrivacyDlpV2OtherCloudResourceRegex 
    ::  GooglePrivacyDlpV2OtherCloudResourceRegex
newGooglePrivacyDlpV2OtherCloudResourceRegex =
  GooglePrivacyDlpV2OtherCloudResourceRegex {amazonS3BucketRegex = Core.Nothing}
...
newGooglePrivacyDlpV2OtherCloudResourceRegexes 
    ::  GooglePrivacyDlpV2OtherCloudResourceRegexes
newGooglePrivacyDlpV2OtherCloudResourceRegexes =
  GooglePrivacyDlpV2OtherCloudResourceRegexes {patterns = Core.Nothing}
        ...
        toJSON GooglePrivacyDlpV2OtherInfoTypeSummary{..}
          = Core.object
              (Core.catMaybes
                 [("estimatedPrevalence" Core..=) Core.<$>
                    estimatedPrevalence,
                  ("excludedFromAnalysis" Core..=) Core.<$>
...
instance Core.ToJSON
        ...
        toJSON GooglePrivacyDlpV2ProjectDataProfile{..}
          = Core.object
              (Core.catMaybes
                 [("dataRiskLevel" Core..=) Core.<$> dataRiskLevel,
                  ("fileStoreDataProfileCount" Core..=) Core..
                    Core.AsText
                  ...
                  ("sensitivityScore" Core..=) Core.<$>
                    sensitivityScore,
                  ("tableDataProfileCount" Core..=) Core.. Core.AsText
...
newGooglePrivacyDlpV2PublishToChronicle 
    ::  GooglePrivacyDlpV2PublishToChronicle
newGooglePrivacyDlpV2PublishToChronicle = GooglePrivacyDlpV2PublishToChronicle
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2PublishToChronicle"
              (\ o ->
                 Core.pure GooglePrivacyDlpV2PublishToChronicle)
          ...
          = Core.object
              (Core.catMaybes
                 [("hybridStats" Core..=) Core.<$> hybridStats,
                  ...
                  ("numRowsProcessed" Core..=) Core.. Core.AsText
...
newGooglePrivacyDlpV2SecretManagerCredential =
  GooglePrivacyDlpV2SecretManagerCredential
    {passwordSecretVersionName = Core.Nothing, username = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2SecretsDiscoveryTarget"
              (\ o ->
                 Core.pure GooglePrivacyDlpV2SecretsDiscoveryTarget)
...
newGooglePrivacyDlpV2TableReference =
  GooglePrivacyDlpV2TableReference
    {datasetId = Core.Nothing, tableId = Core.Nothing}
...
instance Core.ToJSON GooglePrivacyDlpV2TableReference
         where
...
newGooglePrivacyDlpV2TagCondition =
  GooglePrivacyDlpV2TagCondition
    {sensitivityScore = Core.Nothing, tag = Core.Nothing}

instance Core.FromJSON GooglePrivacyDlpV2TagCondition
         where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2TagCondition"
              (\ o ->
                 GooglePrivacyDlpV2TagCondition Core.<$>
                   (o Core..:? "sensitivityScore") Core.<*>
                     (o Core..:? "tag"))

instance Core.ToJSON GooglePrivacyDlpV2TagCondition
         where
...
instance Core.FromJSON GooglePrivacyDlpV2TagResources
         where
        parseJSON
...
instance Core.ToJSON GooglePrivacyDlpV2TagResources
         where
        toJSON GooglePrivacyDlpV2TagResources{..}
          = Core.object
              (Core.catMaybes
                 [("lowerDataRiskToLow" Core..=) Core.<$>
                    lowerDataRiskToLow,
...
newGooglePrivacyDlpV2UpdateConnectionRequest =
  GooglePrivacyDlpV2UpdateConnectionRequest
    {connection = Core.Nothing, updateMask = Core.Nothing}
...
newGooglePrivacyDlpV2UpdateDiscoveryConfigRequest =
  GooglePrivacyDlpV2UpdateDiscoveryConfigRequest
    {discoveryConfig = Core.Nothing, updateMask = Core.Nothing}
