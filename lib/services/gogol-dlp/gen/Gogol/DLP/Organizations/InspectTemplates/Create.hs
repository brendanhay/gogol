...
instance Core.GoogleRequest DLPOrganizationsInspectTemplatesCreate where
  type
    Rs DLPOrganizationsInspectTemplatesCreate =
      GooglePrivacyDlpV2InspectTemplate
  type
    Scopes DLPOrganizationsInspectTemplatesCreate =
