...
type DLPOrganizationsLocationsDlpJobsListResource =
  "v2"
    ...
    Core.:> Core.QueryParam "type" OrganizationsLocationsDlpJobsListType
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.Get '[Core.JSON] GooglePrivacyDlpV2ListDlpJobsResponse
...
instance Core.GoogleRequest DLPOrganizationsLocationsDlpJobsList where
  type
    Rs DLPOrganizationsLocationsDlpJobsList =
      GooglePrivacyDlpV2ListDlpJobsResponse
  type
    Scopes DLPOrganizationsLocationsDlpJobsList =
