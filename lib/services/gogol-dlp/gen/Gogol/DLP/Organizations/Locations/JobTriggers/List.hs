...
type DLPOrganizationsLocationsJobTriggersListResource =
  "v2"
    ...
    Core.:> Core.QueryParam "type" OrganizationsLocationsJobTriggersListType
...
instance
  ...
  where
  type
    Rs DLPOrganizationsLocationsJobTriggersList =
      GooglePrivacyDlpV2ListJobTriggersResponse
  type
    Scopes DLPOrganizationsLocationsJobTriggersList =
