...
instance Core.GoogleRequest DLPProjectsDeidentifyTemplatesCreate where
  type
    Rs DLPProjectsDeidentifyTemplatesCreate =
      GooglePrivacyDlpV2DeidentifyTemplate
  type
    Scopes DLPProjectsDeidentifyTemplatesCreate =
