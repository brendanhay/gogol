...
type DLPProjectsLocationsConnectionsListResource =
  "v2"
    ...
    Core.:> Core.Get '[Core.JSON] GooglePrivacyDlpV2ListConnectionsResponse
...
instance Core.GoogleRequest DLPProjectsLocationsConnectionsList where
  type
    Rs DLPProjectsLocationsConnectionsList =
      GooglePrivacyDlpV2ListConnectionsResponse
  type
    Scopes DLPProjectsLocationsConnectionsList =
