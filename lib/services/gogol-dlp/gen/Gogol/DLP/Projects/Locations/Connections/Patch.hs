...
instance Core.GoogleRequest DLPProjectsLocationsConnectionsPatch where
  type
    Rs DLPProjectsLocationsConnectionsPatch =
      GooglePrivacyDlpV2Connection
  type
    Scopes DLPProjectsLocationsConnectionsPatch =
