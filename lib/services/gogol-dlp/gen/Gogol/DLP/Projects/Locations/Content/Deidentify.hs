...
instance Core.GoogleRequest DLPProjectsLocationsContentDeidentify where
  type
    Rs DLPProjectsLocationsContentDeidentify =
      GooglePrivacyDlpV2DeidentifyContentResponse
  type
    Scopes DLPProjectsLocationsContentDeidentify =
