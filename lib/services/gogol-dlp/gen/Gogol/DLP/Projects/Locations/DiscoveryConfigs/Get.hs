...
instance Core.GoogleRequest DLPProjectsLocationsDiscoveryConfigsGet where
  type
    Rs DLPProjectsLocationsDiscoveryConfigsGet =
      GooglePrivacyDlpV2DiscoveryConfig
  type
    Scopes DLPProjectsLocationsDiscoveryConfigsGet =
