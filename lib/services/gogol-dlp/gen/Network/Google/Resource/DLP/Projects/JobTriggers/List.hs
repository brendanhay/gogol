                     ...
                     QueryParam "filter" Text :>
                       QueryParam "pageToken" Text :>
                         QueryParam "locationId" Text :>
                           QueryParam "type" ProjectsJobTriggersListType :>
...
data ProjectsJobTriggersList =
  ProjectsJobTriggersList'
    ...
    , _pjtlType :: !(Maybe ProjectsJobTriggersListType)
...
pjtlType :: Lens' ProjectsJobTriggersList (Maybe ProjectsJobTriggersListType)
pjtlType = lens _pjtlType (\ s a -> s{_pjtlType = a})
