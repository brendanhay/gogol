              ...
              (\ o ->
                 Change Core.<$>
                   (o Core..:? "additions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "deletions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
          ...
          = Core.withObject "ChangesListResponse"
              (\ o ->
                 ChangesListResponse Core.<$>
                   (o Core..:? "changes" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "header")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#changesListResponse")
              ...
              (\ o ->
                 DnsKeySpec Core.<$>
                   (o Core..:? "algorithm") Core.<*>
                     ...
                     Core.<*> (o Core..:? "keyType")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "dns#dnsKeySpec"))
          ...
          = Core.withObject "DnsKeysListResponse"
              (\ o ->
                 DnsKeysListResponse Core.<$>
                   (o Core..:? "dnsKeys" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "header")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#dnsKeysListResponse")
                     Core.<*> (o Core..:? "nextPageToken"))
              ...
              (\ o ->
                 ManagedZone Core.<$>
                   (o Core..:? "cloudLoggingConfig") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "dns#managedZone")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "nameServerSet")
                     Core.<*>
                     (o Core..:? "nameServers" Core..!= Core.mempty)
...
newManagedZone_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> ManagedZone_Labels
newManagedZone_Labels addtional = ManagedZone_Labels {addtional = addtional}
...
instance Core.ToJSON ManagedZone_Labels where
        toJSON ManagedZone_Labels{..} = Core.toJSON addtional
...
newManagedZoneCloudLoggingConfig =
  ManagedZoneCloudLoggingConfig
    {enableLogging = Core.Nothing, kind = "dns#managedZoneCloudLoggingConfig"}

instance Core.FromJSON ManagedZoneCloudLoggingConfig
         where
        parseJSON
...
instance Core.ToJSON ManagedZoneCloudLoggingConfig
         where
          ...
          = Core.withObject "ManagedZoneDnsSecConfig"
              (\ o ->
                 ManagedZoneDnsSecConfig Core.<$>
                   (o Core..:? "defaultKeySpecs" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
newManagedZoneForwardingConfig =
  ManagedZoneForwardingConfig
    {kind = "dns#managedZoneForwardingConfig", targetNameServers = Core.Nothing}

instance Core.FromJSON ManagedZoneForwardingConfig
         where
        parseJSON
              ...
              (\ o ->
                 ManagedZoneForwardingConfig Core.<$>
                   (o Core..:? "kind" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "targetNameServers" Core..!=
                        Core.mempty))

instance Core.ToJSON ManagedZoneForwardingConfig
         where
        toJSON ManagedZoneForwardingConfig{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("targetNameServers" Core..=) Core.<$>
                    targetNameServers])
...
newManagedZonePeeringConfig =
  ManagedZonePeeringConfig
    {kind = "dns#managedZonePeeringConfig", targetNetwork = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 ManagedZonePrivateVisibilityConfig Core.<$>
                   (o Core..:? "gkeClusters" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#managedZonePrivateVisibilityConfig")
                     Core.<*>
                     (o Core..:? "networks" Core..!= Core.mempty))
...
instance Core.FromJSON ManagedZoneReverseLookupConfig
         where
        parseJSON
...
instance Core.ToJSON ManagedZoneReverseLookupConfig
         where
...
newManagedZoneServiceDirectoryConfig =
  ManagedZoneServiceDirectoryConfig
    {kind = "dns#managedZoneServiceDirectoryConfig", namespace = Core.Nothing}
              ...
              (\ o ->
                 ManagedZonesListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "managedZones" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON OperationManagedZoneContext
         where
        parseJSON
...
instance Core.ToJSON OperationManagedZoneContext
         where
...
instance Core.FromJSON PolicyNetwork where
        parseJSON
          = Core.withObject "PolicyNetwork"
              (\ o ->
                 PolicyNetwork Core.<$>
                   (o Core..:? "kind" Core..!= "dns#policyNetwork")
                     Core.<*> (o Core..:? "networkUrl"))
        ...
        toJSON Project{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("number" Core..=) Core.. Core.AsText Core.<$>
                    number,
...
instance Core.ToJSON Quota where
        toJSON Quota{..}
          = Core.object
              (Core.catMaybes
                 [("dnsKeysPerManagedZone" Core..=) Core.<$>
                    dnsKeysPerManagedZone,
                  ("itemsPerRoutingPolicy" Core..=) Core.<$>
                    itemsPerRoutingPolicy,
                  Core.Just ("kind" Core..= kind),
                  ("managedZones" Core..=) Core.<$> managedZones,
                  ("managedZonesPerNetwork" Core..=) Core.<$>
                    managedZonesPerNetwork,
                  ("networksPerManagedZone" Core..=) Core.<$>
                    networksPerManagedZone,
                  ("networksPerPolicy" Core..=) Core.<$>
                    networksPerPolicy,
                  ...
                  ("rrsetsPerManagedZone" Core..=) Core.<$>
...
newRRSetRoutingPolicy =
  RRSetRoutingPolicy
    {geo = Core.Nothing, kind = "dns#rRSetRoutingPolicy", wrr = Core.Nothing}
...
newRRSetRoutingPolicyGeoPolicy =
  RRSetRoutingPolicyGeoPolicy
    {items = Core.Nothing, kind = "dns#rRSetRoutingPolicyGeoPolicy"}

instance Core.FromJSON RRSetRoutingPolicyGeoPolicy
         where
        parseJSON
...
instance Core.ToJSON RRSetRoutingPolicyGeoPolicy
         where
              ...
              (\ o ->
                 RRSetRoutingPolicyGeoPolicyGeoPolicyItem Core.<$>
                   (o Core..:? "kind" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "signatureRrdatas" Core..!= Core.mempty))
...
newRRSetRoutingPolicyWrrPolicy =
  RRSetRoutingPolicyWrrPolicy
    {items = Core.Nothing, kind = "dns#rRSetRoutingPolicyWrrPolicy"}

instance Core.FromJSON RRSetRoutingPolicyWrrPolicy
         where
        parseJSON
...
instance Core.ToJSON RRSetRoutingPolicyWrrPolicy
         where
          ...
          = Core.withObject "ResourceRecordSet"
              (\ o ->
                 ResourceRecordSet Core.<$>
                   (o Core..:? "kind" Core..!= "dns#resourceRecordSet")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON ResourceRecordSetsListResponse
         where
        parseJSON
...
instance Core.ToJSON ResourceRecordSetsListResponse
         where
...
instance Core.FromJSON ResponsePoliciesListResponse
         where
        parseJSON
              ...
              (\ o ->
                 ResponsePoliciesListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "responsePolicies" Core..!= Core.mempty))

instance Core.ToJSON ResponsePoliciesListResponse
         where
...
newResponsePoliciesPatchResponse =
  ResponsePoliciesPatchResponse
    {header = Core.Nothing, responsePolicy = Core.Nothing}

instance Core.FromJSON ResponsePoliciesPatchResponse
         where
        parseJSON
          = Core.withObject "ResponsePoliciesPatchResponse"
              (\ o ->
                 ResponsePoliciesPatchResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "responsePolicy"))

instance Core.ToJSON ResponsePoliciesPatchResponse
         where
...
instance Core.FromJSON ResponsePoliciesUpdateResponse
         where
        parseJSON
...
instance Core.ToJSON ResponsePoliciesUpdateResponse
         where
              ...
              (\ o ->
                 ResponsePolicy Core.<$>
                   (o Core..:? "description") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "dns#responsePolicy")
...
newResponsePolicyGKECluster =
  ResponsePolicyGKECluster
    {gkeClusterName = Core.Nothing, kind = "dns#responsePolicyGKECluster"}
...
newResponsePolicyNetwork =
  ResponsePolicyNetwork
    {kind = "dns#responsePolicyNetwork", networkUrl = Core.Nothing}
...
instance Core.FromJSON ResponsePolicyRuleLocalData
         where
        parseJSON
          = Core.withObject "ResponsePolicyRuleLocalData"
              (\ o ->
                 ResponsePolicyRuleLocalData Core.<$>
                   (o Core..:? "localDatas" Core..!= Core.mempty))

instance Core.ToJSON ResponsePolicyRuleLocalData
         where
              ...
              (\ o ->
                 ResponsePolicyRulesListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "responsePolicyRules" Core..!=
                        Core.mempty))

instance Core.ToJSON ResponsePolicyRulesListResponse
         where
...
newResponsePolicyRulesPatchResponse =
  ResponsePolicyRulesPatchResponse
    {header = Core.Nothing, responsePolicyRule = Core.Nothing}
          ...
          = Core.withObject "ResponsePolicyRulesPatchResponse"
              (\ o ->
                 ResponsePolicyRulesPatchResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "responsePolicyRule"))

instance Core.ToJSON ResponsePolicyRulesPatchResponse
         where
        toJSON ResponsePolicyRulesPatchResponse{..}
          = Core.object
              (Core.catMaybes
                 [("header" Core..=) Core.<$> header,
                  ("responsePolicyRule" Core..=) Core.<$>
                    responsePolicyRule])
