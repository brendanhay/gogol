...
newDNSResponsePolicyRulesGet 
    ...
    -> DNSResponsePolicyRulesGet
newDNSResponsePolicyRulesGet project responsePolicy responsePolicyRule =
  DNSResponsePolicyRulesGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest DNSResponsePolicyRulesGet
         where
        type Rs DNSResponsePolicyRulesGet =
             ResponsePolicyRule
        ...
        requestClient DNSResponsePolicyRulesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DNSResponsePolicyRulesGetResource)
                      Core.mempty
