...
type DocsDocumentsBatchUpdateResource =
     "v1" Core.:>
       "documents" Core.:>
         Core.CaptureMode "documentId" "batchUpdate" Core.Text
           Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchUpdateDocumentRequest
                         Core.:>
...
instance Core.GoogleRequest DocsDocumentsBatchUpdate
         where
        type Rs DocsDocumentsBatchUpdate =
