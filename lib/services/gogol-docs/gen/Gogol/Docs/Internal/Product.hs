...
newBookmarkLink 
    ::  BookmarkLink
newBookmarkLink = BookmarkLink {id = Core.Nothing, tabId = Core.Nothing}
...
newDeleteFooterRequest 
    ::  DeleteFooterRequest
newDeleteFooterRequest =
  DeleteFooterRequest {footerId = Core.Nothing, tabId = Core.Nothing}
...
newDeleteHeaderRequest 
    ::  DeleteHeaderRequest
newDeleteHeaderRequest =
  DeleteHeaderRequest {headerId = Core.Nothing, tabId = Core.Nothing}
...
newDeletePositionedObjectRequest 
    ::  DeletePositionedObjectRequest
newDeletePositionedObjectRequest =
  DeletePositionedObjectRequest {objectId = Core.Nothing, tabId = Core.Nothing}
...
instance Core.FromJSON DocumentTab_Footers where
        parseJSON
          = Core.withObject "DocumentTab_Footers"
              (\ o ->
                 DocumentTab_Footers Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_Footers where
        toJSON DocumentTab_Footers{..}
          = Core.toJSON additional
...
instance Core.FromJSON DocumentTab_Footnotes where
        parseJSON
          = Core.withObject "DocumentTab_Footnotes"
              (\ o ->
                 DocumentTab_Footnotes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_Footnotes where
        toJSON DocumentTab_Footnotes{..}
          = Core.toJSON additional
...
instance Core.FromJSON DocumentTab_Headers where
        parseJSON
          = Core.withObject "DocumentTab_Headers"
              (\ o ->
                 DocumentTab_Headers Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_Headers where
        toJSON DocumentTab_Headers{..}
          = Core.toJSON additional
...
instance Core.FromJSON DocumentTab_InlineObjects
         where
        parseJSON
          = Core.withObject "DocumentTab_InlineObjects"
              (\ o ->
                 DocumentTab_InlineObjects Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_InlineObjects where
        toJSON DocumentTab_InlineObjects{..}
          = Core.toJSON additional
...
newDocumentTab_Lists 
    ::  Core.HashMap Core.Text List
       -- ^  See 'additional'.
    -> DocumentTab_Lists
newDocumentTab_Lists additional = DocumentTab_Lists {additional = additional}

instance Core.FromJSON DocumentTab_Lists where
        parseJSON
          = Core.withObject "DocumentTab_Lists"
              (\ o ->
                 DocumentTab_Lists Core.<$> (Core.parseJSONObject o))
...
instance Core.FromJSON DocumentTab_NamedRanges where
        parseJSON
          = Core.withObject "DocumentTab_NamedRanges"
              (\ o ->
                 DocumentTab_NamedRanges Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_NamedRanges where
        toJSON DocumentTab_NamedRanges{..}
          = Core.toJSON additional
...
instance Core.FromJSON DocumentTab_PositionedObjects
         where
        parseJSON
          = Core.withObject "DocumentTab_PositionedObjects"
              (\ o ->
                 DocumentTab_PositionedObjects Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON DocumentTab_PositionedObjects
         where
        toJSON DocumentTab_PositionedObjects{..}
          = Core.toJSON additional
...
newDocumentTab_SuggestedDocumentStyleChanges additional =
  DocumentTab_SuggestedDocumentStyleChanges {additional = additional}
...
newEndOfSegmentLocation 
    ::  EndOfSegmentLocation
newEndOfSegmentLocation =
  EndOfSegmentLocation {segmentId = Core.Nothing, tabId = Core.Nothing}
...
newHeadingLink 
    ::  HeadingLink
newHeadingLink = HeadingLink {id = Core.Nothing, tabId = Core.Nothing}
...
newLocation =
  Location
    {index = Core.Nothing, segmentId = Core.Nothing, tabId = Core.Nothing}
...
instance Core.ToJSON TabsCriteria where
        toJSON TabsCriteria{..}
          = Core.object
              (Core.catMaybes [("tabIds" Core..=) Core.<$> tabIds])
...
newUpdateDocumentStyleRequest =
  UpdateDocumentStyleRequest
    {documentStyle = Core.Nothing, fields = Core.Nothing, tabId = Core.Nothing}
