              ...
              (\ o ->
                 AutoText Core.<$>
                   (o Core..:? "suggestedDeletionIds" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "suggestedInsertionIds" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "BatchUpdateDocumentRequest"
              (\ o ->
                 BatchUpdateDocumentRequest Core.<$>
                   (o Core..:? "requests" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "writeControl"))
              ...
              (\ o ->
                 BatchUpdateDocumentResponse Core.<$>
                   (o Core..:? "documentId") Core.<*>
                     (o Core..:? "replies" Core..!= Core.mempty)
...
instance Core.FromJSON Body where
        parseJSON
          = Core.withObject "Body"
              (\ o ->
                 Body Core.<$>
                   (o Core..:? "content" Core..!= Core.mempty))
...
instance Core.FromJSON Footer where
        parseJSON
          = Core.withObject "Footer"
              (\ o ->
                 Footer Core.<$>
                   (o Core..:? "content" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "footerId"))
...
instance Core.FromJSON ListProperties where
        parseJSON
          = Core.withObject "ListProperties"
              (\ o ->
                 ListProperties Core.<$>
                   (o Core..:? "nestingLevels" Core..!= Core.mempty))
          ...
          = Core.withObject "ListPropertiesSuggestionState"
              (\ o ->
                 ListPropertiesSuggestionState Core.<$>
                   (o Core..:? "nestingLevelsSuggestionStates" Core..!=
                      Core.mempty))
        ...
        parseJSON
          = Core.withObject "NamedRanges"
              (\ o ->
                 NamedRanges Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "namedRanges" Core..!= Core.mempty))
...
instance Core.FromJSON NamedStyles where
        parseJSON
          = Core.withObject "NamedStyles"
              (\ o ->
                 NamedStyles Core.<$>
                   (o Core..:? "styles" Core..!= Core.mempty))
          ...
          = Core.withObject "NamedStylesSuggestionState"
              (\ o ->
                 NamedStylesSuggestionState Core.<$>
                   (o Core..:? "stylesSuggestionStates" Core..!=
                      Core.mempty))
              ...
              (\ o ->
                 Paragraph Core.<$>
                   (o Core..:? "bullet") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "positionedObjectIds" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 ParagraphStyle Core.<$>
                   (o Core..:? "alignment") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "tabStops" Core..!= Core.mempty))
...
instance Core.FromJSON SectionStyle where
        parseJSON
          = Core.withObject "SectionStyle"
              (\ o ->
                 SectionStyle Core.<$>
                   (o Core..:? "columnProperties" Core..!= Core.mempty)
                 ...
                 Table Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "rows")
                     ...
                     (o Core..:? "suggestedInsertionIds" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "tableRows" Core..!= Core.mempty)
              ...
              (\ o ->
                 TableRow Core.<$>
                   (o Core..:? "endIndex") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "tableCells" Core..!= Core.mempty)
...
instance Core.FromJSON TableStyle where
        parseJSON
          = Core.withObject "TableStyle"
              (\ o ->
                 TableStyle Core.<$>
                   (o Core..:? "tableColumnProperties" Core..!=
                      Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 UpdateTableColumnPropertiesRequest Core.<$>
                   (o Core..:? "columnIndices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fields")
          ...
          = Core.withObject "UpdateTableRowStyleRequest"
              (\ o ->
                 UpdateTableRowStyleRequest Core.<$>
                   (o Core..:? "fields") Core.<*>
                     (o Core..:? "rowIndices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "tableRowStyle")
                     Core.<*> (o Core..:? "tableStartLocation"))
