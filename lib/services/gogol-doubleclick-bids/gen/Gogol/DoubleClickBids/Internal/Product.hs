...
newListQueriesResponse =
  ListQueriesResponse
    {kind = Core.Nothing, nextPageToken = Core.Nothing, queries = Core.Nothing}
...
newListReportsResponse =
  ListReportsResponse
    {kind = Core.Nothing, nextPageToken = Core.Nothing, reports = Core.Nothing}
              ...
              (\ o ->
                 Parameters Core.<$>
                   (o Core..:? "filters" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "groupBys" Core..!= Core.mempty)
...
instance Core.FromJSON Query where
        parseJSON
          = Core.withObject "Query"
              (\ o ->
                 Query Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "params")
                     Core.<*> (o Core..:? "queryId")
              ...
              (\ o ->
                 QueryMetadata Core.<$>
                   (o Core..:? "dataRange") Core.<*>
                     (o Core..:? "format")
                     Core.<*>
                     (o Core..:? "googleCloudStoragePathForLatestReport")
                     Core.<*>
                     (o Core..:? "googleDrivePathForLatestReport")
                     ...
                     Core.<*>
                     (o Core..:? "shareEmailAddress" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "title"))
          ...
          = Core.object
              (Core.catMaybes
                 [("dataRange" Core..=) Core.<$> dataRange,
                  ...
                  ("googleDrivePathForLatestReport" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("failure" Core..=) Core.<$> failure,
                  ("finishTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    finishTimeMs,
                  ("format" Core..=) Core.<$> format,
