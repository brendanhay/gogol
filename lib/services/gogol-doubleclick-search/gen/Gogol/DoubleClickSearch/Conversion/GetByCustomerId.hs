                                 ...
                                 Core.QueryParam "agencyId" Core.Int64 Core.:>
                                   Core.QueryParam "callback" Core.Text Core.:>
                                     Core.QueryParam "campaignId" Core.Int64
                                       Core.:>
                                       Core.QueryParam "criterionId" Core.Int64
                                         Core.:>
                                         Core.QueryParam "engineAccountId"
                                           Core.Int64
                                           Core.:>
...
newDoubleClickSearchConversionGetByCustomerId 
    ...
    -> DoubleClickSearchConversionGetByCustomerId
newDoubleClickSearchConversionGetByCustomerId customerId endDate rowCount startDate startRow =
  DoubleClickSearchConversionGetByCustomerId
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           DoubleClickSearchConversionGetByCustomerId
         where
        type Rs DoubleClickSearchConversionGetByCustomerId =
             ConversionList
        type Scopes
               DoubleClickSearchConversionGetByCustomerId
        ...
        requestClient
          DoubleClickSearchConversionGetByCustomerId{..}
          = go customerId (Core.Just endDate)
              (Core.Just rowCount)
              (Core.Just startDate)
              (Core.Just startRow)
              xgafv
