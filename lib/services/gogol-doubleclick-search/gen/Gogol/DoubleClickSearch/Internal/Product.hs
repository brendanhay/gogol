...
instance Core.FromJSON Conversion where
        parseJSON
          = Core.withObject "Conversion"
              (\ o ->
                 Conversion Core.<$>
                   (o Core..:? "adGroupId") Core.<*> (o Core..:? "adId")
                     ...
                     Core.<*>
                     (o Core..:? "customMetric" Core..!= Core.mempty)
...
instance Core.FromJSON ConversionList where
        parseJSON
          = Core.withObject "ConversionList"
              (\ o ->
                 ConversionList Core.<$>
                   (o Core..:? "conversion" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kind"))
          ...
          = Core.withObject "Report_FilesItem"
              (\ o ->
                 Report_FilesItem Core.<$>
                   (o Core..:? "byteCount") Core.<*> (o Core..:? "url"))
          ...
          = Core.withObject "UpdateAvailabilityRequest"
              (\ o ->
                 UpdateAvailabilityRequest Core.<$>
                   (o Core..:? "availabilities" Core..!= Core.mempty))
