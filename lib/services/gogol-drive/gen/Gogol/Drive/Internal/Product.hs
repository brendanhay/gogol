              ...
              (\ o ->
                 About Core.<$>
                   (o Core..:? "appInstalled") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "driveThemes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "exportFormats")
                     Core.<*>
                     (o Core..:? "folderColorPalette" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "teamDriveThemes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "user"))
          ...
          = Core.withObject "About_StorageQuota"
              (\ o ->
                 About_StorageQuota Core.<$>
                   (o Core..:? "limit") Core.<*> (o Core..:? "usage")
...
instance Core.FromJSON CommentList where
        parseJSON
          = Core.withObject "CommentList"
              (\ o ->
                 CommentList Core.<$>
                   (o Core..:? "comments" Core..!= Core.mempty) Core.<*>
...
instance Core.FromJSON DriveList where
        parseJSON
          = Core.withObject "DriveList"
              (\ o ->
                 DriveList Core.<$>
                   (o Core..:? "drives" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 File Core.<$>
                   (o Core..:? "appProperties") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "contentRestrictions" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "permissionIds" Core..!= Core.mempty)
                     Core.<*>
...
instance Core.FromJSON GeneratedIds where
        parseJSON
          = Core.withObject "GeneratedIds"
              (\ o ->
                 GeneratedIds Core.<$>
                   (o Core..:? "ids" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 Permission Core.<$>
                   (o Core..:? "allowFileDiscovery") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "permissionDetails" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "photoLink")
                     Core.<*> (o Core..:? "role")
                     Core.<*>
                     (o Core..:? "teamDrivePermissionDetails" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "view"))
              ...
              (\ o ->
                 TeamDriveList Core.<$>
                   (o Core..:? "kind" Core..!= "drive#teamDriveList")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "teamDrives" Core..!= Core.mempty))
