...
instance Core.FromJSON ActionDetail where
        parseJSON
          = Core.withObject "ActionDetail"
              (\ o ->
                 ActionDetail Core.<$>
                   (o Core..:? "appliedLabelChange") Core.<*>
                     (o Core..:? "comment")
                     Core.<*> (o Core..:? "create")
                     Core.<*> (o Core..:? "delete")
...
instance Core.FromJSON DriveActivity where
        parseJSON
          = Core.withObject "DriveActivity"
              (\ o ->
                 DriveActivity Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "actors")
...
instance Core.FromJSON FieldValue where
        parseJSON
          = Core.withObject "FieldValue"
              (\ o ->
                 FieldValue Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "integer")
...
instance Core.ToJSON Integer where
        toJSON Integer{..}
          = Core.object
              (Core.catMaybes
                 [("value" Core..=) Core.. Core.AsText Core.<$>
                    value])
...
instance Core.FromJSON Move where
        parseJSON
          = Core.withObject "Move"
              (\ o ->
                 Move Core.<$>
                   (o Core..:? "addedParents") Core.<*>
                     (o Core..:? "removedParents"))
