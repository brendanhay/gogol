...
instance Core.FromJSON Action where
        parseJSON
          = Core.withObject "Action"
              (\ o ->
                 Action Core.<$>
                   (o Core..:? "actor") Core.<*> (o Core..:? "detail")
                     Core.<*> (o Core..:? "target")
...
instance Core.FromJSON ActionDetail where
        parseJSON
          = Core.withObject "ActionDetail"
              (\ o ->
                 ActionDetail Core.<$>
                   (o Core..:? "comment") Core.<*> (o Core..:? "create")
                     Core.<*> (o Core..:? "delete")
...
instance Core.FromJSON Comment where
        parseJSON
          = Core.withObject "Comment"
              (\ o ->
                 Comment Core.<$>
                   (o Core..:? "assignment") Core.<*>
                     (o Core..:? "mentionedUsers" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "post")
              ...
              (\ o ->
                 DriveActivity Core.<$>
                   (o Core..:? "actions" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "actors" Core..!= Core.mempty)
...
instance Core.ToJSON FileComment where
        toJSON FileComment{..}
          = Core.object
              (Core.catMaybes
                 [("legacyCommentId" Core..=) Core.<$>
                    legacyCommentId,
                  ("legacyDiscussionId" Core..=) Core.<$>
                    legacyDiscussionId,
                  ("linkToDiscussion" Core..=) Core.<$>
                    linkToDiscussion,
...
instance Core.FromJSON Group where
        parseJSON
          = Core.withObject "Group"
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON Move where
        parseJSON
          = Core.withObject "Move"
              (\ o ->
                 Move Core.<$>
                   (o Core..:? "addedParents" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "removedParents" Core..!= Core.mempty))
...
instance Core.FromJSON Owner where
        parseJSON
          = Core.withObject "Owner"
              (\ o ->
                 Owner Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "drive")
...
instance Core.FromJSON QueryDriveActivityRequest
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("ancestorName" Core..=) Core.<$> ancestorName,
                  ("consolidationStrategy" Core..=) Core.<$>
                    consolidationStrategy,
...
newQueryDriveActivityResponse =
  QueryDriveActivityResponse
    {activities = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON QueryDriveActivityResponse
         where
        parseJSON
...
instance Core.FromJSON SettingsChange where
        parseJSON
          = Core.withObject "SettingsChange"
              (\ o ->
                 SettingsChange Core.<$>
                   (o Core..:? "restrictionChanges" Core..!=
                      Core.mempty))
...
newTargetReference =
  TargetReference
    {drive = Core.Nothing, driveItem = Core.Nothing, teamDrive = Core.Nothing}
