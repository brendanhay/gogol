...
newBackup =
  Backup
    ...
    , fileSystemProtocol = Core.Nothing
    , kmsKey = Core.Nothing
    , labels = Core.Nothing
    , name = Core.Nothing
...
instance Core.FromJSON Backup_Tags where
        parseJSON
          = Core.withObject "Backup_Tags"
              (\ o ->
                 Backup_Tags Core.<$> (Core.parseJSONObject o))
...
instance Core.ToJSON FixedIOPS where
        toJSON FixedIOPS{..}
          = Core.object
              (Core.catMaybes
                 [("maxIops" Core..=) Core.. Core.AsText Core.<$>
                    maxIops])
...
newInstance =
  Instance
    ...
    , performanceConfig = Core.Nothing
    , performanceLimits = Core.Nothing
...
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "configurablePerformanceEnabled")
                     Core.<*> (o Core..:? "createTime")
...
instance Core.ToJSON Instance where
        toJSON Instance{..}
          = Core.object
              (Core.catMaybes
                 [("configurablePerformanceEnabled" Core..=) Core.<$>
                  ...
                  ("performanceConfig" Core..=) Core.<$>
                    performanceConfig,
                  ("performanceLimits" Core..=) Core.<$>
                    performanceLimits,
...
newInstance_Tags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Instance_Tags
newInstance_Tags additional = Instance_Tags {additional = additional}

instance Core.FromJSON Instance_Tags where
        parseJSON
          = Core.withObject "Instance_Tags"
              (\ o ->
                 Instance_Tags Core.<$> (Core.parseJSONObject o))
...
newPerformanceConfig 
    ::  PerformanceConfig
newPerformanceConfig =
  PerformanceConfig {fixedIops = Core.Nothing, iopsPerTb = Core.Nothing}
          ...
          = Core.withObject "PerformanceLimits"
              (\ o ->
                 PerformanceLimits Core.<$>
                   (o Core..:? "maxReadIops" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxReadThroughputBps" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxWriteIops" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON PerformanceLimits where
        toJSON PerformanceLimits{..}
          = Core.object
              (Core.catMaybes
                 [("maxReadIops" Core..=) Core.. Core.AsText Core.<$>
                    maxReadIops,
                  ("maxReadThroughputBps" Core..=) Core.. Core.AsText
                    Core.<$> maxReadThroughputBps,
                  ("maxWriteIops" Core..=) Core.. Core.AsText Core.<$>
                    maxWriteIops,
                  ("maxWriteThroughputBps" Core..=) Core.. Core.AsText
                    Core.<$> maxWriteThroughputBps])
...
newReplicaConfig =
  ReplicaConfig
    { lastActiveSyncTime = Core.Nothing
    , peerInstance = Core.Nothing
    , state = Core.Nothing
...
newReplication 
    ::  Replication
newReplication = Replication {replicas = Core.Nothing, role' = Core.Nothing}
...
newSnapshot_Tags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Snapshot_Tags
newSnapshot_Tags additional = Snapshot_Tags {additional = additional}

instance Core.FromJSON Snapshot_Tags where
        parseJSON
          = Core.withObject "Snapshot_Tags"
              (\ o ->
                 Snapshot_Tags Core.<$> (Core.parseJSONObject o))
