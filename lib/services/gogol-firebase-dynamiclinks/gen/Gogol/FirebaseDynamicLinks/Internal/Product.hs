...
newAnalyticsInfo =
  AnalyticsInfo
    { googlePlayAnalytics = Core.Nothing,
...
instance Core.FromJSON AnalyticsInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AnalyticsInfo
            Core.<$> (o Core..:? "googlePlayAnalytics")
            Core.<*> (o Core..:? "itunesConnectAnalytics")
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("googlePlayAnalytics" Core..=)
              Core.<$> googlePlayAnalytics,
            ("itunesConnectAnalytics" Core..=)
              Core.<$> itunesConnectAnalytics
          ]
      )
...
instance Core.FromJSON AndroidInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AndroidInfo
            Core.<$> (o Core..:? "androidFallbackLink")
            Core.<*> (o Core..:? "androidLink")
...
instance Core.ToJSON AndroidInfo where
  toJSON AndroidInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("androidFallbackLink" Core..=)
              Core.<$> androidFallbackLink,
            ("androidLink" Core..=) Core.<$> androidLink,
            ("androidMinPackageVersionCode" Core..=)
              Core.<$> androidMinPackageVersionCode,
...
instance Core.FromJSON CreateManagedShortLinkRequest where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          CreateManagedShortLinkRequest
            Core.<$> (o Core..:? "dynamicLinkInfo")
            Core.<*> (o Core..:? "longDynamicLink")
            Core.<*> (o Core..:? "name")
...
instance Core.FromJSON DesktopInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          DesktopInfo
            Core.<$> (o Core..:? "desktopFallbackLink")
      )
...
instance Core.ToJSON DesktopInfo where
  toJSON DesktopInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("desktopFallbackLink" Core..=)
              Core.<$> desktopFallbackLink
          ]
      )
...
instance Core.ToJSON DeviceInfo where
  toJSON DeviceInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("deviceModelName" Core..=)
              Core.<$> deviceModelName,
            ("languageCode" Core..=) Core.<$> languageCode,
            ("languageCodeFromWebview" Core..=)
              Core.<$> languageCodeFromWebview,
...
instance Core.FromJSON DynamicLinkInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          DynamicLinkInfo
            Core.<$> (o Core..:? "analyticsInfo")
            Core.<*> (o Core..:? "androidInfo")
...
instance Core.FromJSON DynamicLinkWarning where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          DynamicLinkWarning
            Core.<$> (o Core..:? "warningCode")
            Core.<*> (o Core..:? "warningDocumentLink")
    ...
    Core.object
      ( Core.catMaybes
          [ ("warningCode" Core..=) Core.<$> warningCode,
            ("warningDocumentLink" Core..=)
              Core.<$> warningDocumentLink,
    ...
    Core.object
      ( Core.catMaybes
          [ ("appInstallationTime" Core..=) Core.. Core.AsText
            ...
            ("sdkVersion" Core..=) Core.<$> sdkVersion,
            ("uniqueMatchLinkToCheck" Core..=)
              Core.<$> uniqueMatchLinkToCheck,
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GetIosPostInstallAttributionResponse
            Core.<$> (o Core..:? "appMinimumVersion")
            Core.<*> (o Core..:? "attributionConfidence")
...
instance
  ...
  toJSON GetIosPostInstallAttributionResponse {..} =
    Core.object
      ( Core.catMaybes
          [ ("appMinimumVersion" Core..=)
              Core.<$> appMinimumVersion,
            ("attributionConfidence" Core..=)
              Core.<$> attributionConfidence,
            ("deepLink" Core..=) Core.<$> deepLink,
            ("externalBrowserDestinationLink" Core..=)
              Core.<$> externalBrowserDestinationLink,
            ("fallbackLink" Core..=) Core.<$> fallbackLink,
            ("invitationId" Core..=) Core.<$> invitationId,
            ("isStrongMatchExecutable" Core..=)
              Core.<$> isStrongMatchExecutable,
            ("matchMessage" Core..=) Core.<$> matchMessage,
            ("requestIpVersion" Core..=)
              Core.<$> requestIpVersion,
  ...
  toJSON GetIosReopenAttributionResponse {..} =
    Core.object
      ( Core.catMaybes
          [ ("deepLink" Core..=) Core.<$> deepLink,
            ("invitationId" Core..=) Core.<$> invitationId,
            ("iosMinAppVersion" Core..=)
              Core.<$> iosMinAppVersion,
            ("resolvedLink" Core..=) Core.<$> resolvedLink,
            ("utmCampaign" Core..=) Core.<$> utmCampaign,
            ("utmContent" Core..=) Core.<$> utmContent,
            ("utmMedium" Core..=) Core.<$> utmMedium,
    ...
    Core.object
      ( Core.catMaybes
          [ ("iosAppStoreId" Core..=) Core.<$> iosAppStoreId,
            ...
            ("iosIpadFallbackLink" Core..=)
              Core.<$> iosIpadFallbackLink,
            ("iosMinimumVersion" Core..=)
              Core.<$> iosMinimumVersion
          ]
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("creationTime" Core..=) Core.<$> creationTime,
            ("flaggedAttribute" Core..=)
              Core.<$> flaggedAttribute,
            ("info" Core..=) Core.<$> info,
            ("link" Core..=) Core.<$> link,
...
instance Core.FromJSON NavigationInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          NavigationInfo
            Core.<$> (o Core..:? "enableForcedRedirect")
      )
...
instance Core.ToJSON NavigationInfo where
  toJSON NavigationInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("enableForcedRedirect" Core..=)
              Core.<$> enableForcedRedirect
          ]
      )
...
instance Core.FromJSON SocialMetaTagInfo where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          SocialMetaTagInfo
            Core.<$> (o Core..:? "socialDescription")
            Core.<*> (o Core..:? "socialImageLink")
...
instance Core.ToJSON SocialMetaTagInfo where
  toJSON SocialMetaTagInfo {..} =
    Core.object
      ( Core.catMaybes
          [ ("socialDescription" Core..=)
              Core.<$> socialDescription,
