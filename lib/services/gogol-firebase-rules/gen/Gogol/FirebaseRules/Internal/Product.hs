              ...
              (\ o ->
                 ListReleasesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "releases" Core..!= Core.mempty))
          ...
          = Core.withObject "ListRulesetsResponse"
              (\ o ->
                 ListRulesetsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "rulesets" Core..!= Core.mempty))
              ...
              (\ o ->
                 TestCase Core.<$>
                   (o Core..:? "expectation") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "functionMocks" Core..!= Core.mempty)
...
instance Core.FromJSON TestResult where
        parseJSON
          = Core.withObject "TestResult"
              (\ o ->
                 TestResult Core.<$>
                   (o Core..:? "debugMessages" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "errorPosition")
                     Core.<*>
                     (o Core..:? "expressionReports" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "functionCalls" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "visitedExpressions" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "TestRulesetResponse"
              (\ o ->
                 TestRulesetResponse Core.<$>
                   (o Core..:? "issues" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "testResults" Core..!= Core.mempty))
...
instance Core.FromJSON TestSuite where
        parseJSON
          = Core.withObject "TestSuite"
              (\ o ->
                 TestSuite Core.<$>
                   (o Core..:? "testCases" Core..!= Core.mempty))
