...
newRemoteConfig 
    ::  RemoteConfig
newRemoteConfig =
  RemoteConfig {conditions = Core.Nothing, parameters = Core.Nothing}
...
newtype RemoteConfig_Parameters = RemoteConfig_Parameters
    {
      -- | 
      addtional :: (Core.HashMap Core.Text RemoteConfigParameter)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newtype RemoteConfigParameter_ConditionalValues = RemoteConfigParameter_ConditionalValues
    {
      -- | 
      addtional :: (Core.HashMap Core.Text RemoteConfigParameterValue)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRemoteConfigParameter_ConditionalValues 
    ::  Core.HashMap Core.Text RemoteConfigParameterValue
       -- ^  See 'addtional'.
    -> RemoteConfigParameter_ConditionalValues
newRemoteConfigParameter_ConditionalValues addtional =
  RemoteConfigParameter_ConditionalValues {addtional = addtional}
...
newRemoteConfigParameterValue =
  RemoteConfigParameterValue
    {useInAppDefault = Core.Nothing, value = Core.Nothing}

instance Core.FromJSON RemoteConfigParameterValue
         where
        parseJSON
          = Core.withObject "RemoteConfigParameterValue"
              (\ o ->
                 RemoteConfigParameterValue Core.<$>
                   (o Core..:? "useInAppDefault") Core.<*>
                     (o Core..:? "value"))
