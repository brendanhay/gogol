...
instance Core.FromJSON ExecutionStats where
        parseJSON
          = Core.withObject "ExecutionStats"
              (\ o ->
                 ExecutionStats Core.<$>
                   (o Core..:? "debugStats") Core.<*>
                     (o Core..:? "executionDuration")
                     Core.<*>
                     (o Core..:? "readOperations" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resultsReturned" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("debugStats" Core..=) Core.<$> debugStats,
                  ("executionDuration" Core..=) Core.<$>
                    executionDuration,
                  ("readOperations" Core..=) Core.. Core.AsText
                    Core.<$> readOperations,
                  ("resultsReturned" Core..=) Core.. Core.AsText
...
instance Core.FromJSON ExecutionStats_DebugStats
         where
        parseJSON
          = Core.withObject "ExecutionStats_DebugStats"
              (\ o ->
                 ExecutionStats_DebugStats Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ExecutionStats_DebugStats where
        toJSON ExecutionStats_DebugStats{..}
          = Core.toJSON additional
...
newExplainMetrics 
    ::  ExplainMetrics
newExplainMetrics =
  ExplainMetrics {executionStats = Core.Nothing, planSummary = Core.Nothing}
...
instance Core.ToJSON FindNearest where
        toJSON FindNearest{..}
          = Core.object
              (Core.catMaybes
                 [("distanceMeasure" Core..=) Core.<$>
                    distanceMeasure,
                  ("distanceResultField" Core..=) Core.<$>
                    distanceResultField,
                  ("distanceThreshold" Core..=) Core.<$>
                    distanceThreshold,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleFirestoreAdminV1BackupSource"
              (\ o ->
                 GoogleFirestoreAdminV1BackupSource Core.<$>
                   (o Core..:? "backup"))
...
newGoogleFirestoreAdminV1BulkDeleteDocumentsRequest =
  GoogleFirestoreAdminV1BulkDeleteDocumentsRequest
    {collectionIds = Core.Nothing, namespaceIds = Core.Nothing}
...
newGoogleFirestoreAdminV1CmekConfig =
  GoogleFirestoreAdminV1CmekConfig
    {activeKeyVersion = Core.Nothing, kmsKeyName = Core.Nothing}
...
instance Core.ToJSON GoogleFirestoreAdminV1CmekConfig
         where
...
newGoogleFirestoreAdminV1FlatIndex 
    ::  GoogleFirestoreAdminV1FlatIndex
newGoogleFirestoreAdminV1FlatIndex = GoogleFirestoreAdminV1FlatIndex
...
instance Core.ToJSON GoogleFirestoreAdminV1FlatIndex
         where
        toJSON = Core.const Core.emptyObject
...
newGoogleFirestoreAdminV1ListDatabasesResponse =
  GoogleFirestoreAdminV1ListDatabasesResponse
    {databases = Core.Nothing, unreachable = Core.Nothing}
...
newGoogleFirestoreAdminV1SourceInfo =
  GoogleFirestoreAdminV1SourceInfo
    {backup = Core.Nothing, operation = Core.Nothing}
...
instance Core.ToJSON GoogleFirestoreAdminV1SourceInfo
         where
...
newGoogleFirestoreAdminV1VectorConfig =
  GoogleFirestoreAdminV1VectorConfig
    {dimension = Core.Nothing, flat = Core.Nothing}
...
instance Core.FromJSON PlanSummary where
        parseJSON
          = Core.withObject "PlanSummary"
              (\ o ->
                 PlanSummary Core.<$> (o Core..:? "indexesUsed"))

instance Core.ToJSON PlanSummary where
        toJSON PlanSummary{..}
          = Core.object
              (Core.catMaybes
                 [("indexesUsed" Core..=) Core.<$> indexesUsed])
...
instance Core.FromJSON PlanSummary_IndexesUsedItem
         where
        parseJSON
          = Core.withObject "PlanSummary_IndexesUsedItem"
              (\ o ->
                 PlanSummary_IndexesUsedItem Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PlanSummary_IndexesUsedItem
         where
        toJSON PlanSummary_IndexesUsedItem{..}
          = Core.toJSON additional
