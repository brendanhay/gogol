...
type FireStoreProjectsDatabasesCollectionGroupsIndexesGetResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] GoogleFirestoreAdminV1Index
...
instance
  ...
  where
  type
    Rs FireStoreProjectsDatabasesCollectionGroupsIndexesGet =
      GoogleFirestoreAdminV1Index
  type
    Scopes FireStoreProjectsDatabasesCollectionGroupsIndexesGet =
