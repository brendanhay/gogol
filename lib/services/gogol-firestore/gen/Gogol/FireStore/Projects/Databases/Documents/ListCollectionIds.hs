...
type FireStoreProjectsDatabasesDocumentsListCollectionIdsResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "listCollectionIds" Core.Text
...
instance
  ...
  where
  type
    Rs FireStoreProjectsDatabasesDocumentsListCollectionIds =
      ListCollectionIdsResponse
  type
    Scopes FireStoreProjectsDatabasesDocumentsListCollectionIds =
