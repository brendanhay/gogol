         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "currentDocument.exists" Core.Bool
                 Core.:>
                 Core.QueryParam "currentDocument.updateTime"
                   Core.DateTime'
                   Core.:>
                   Core.QueryParams "mask.fieldPaths" Core.Text Core.:>
                     Core.QueryParams "updateMask.fieldPaths" Core.Text
                       Core.:>
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsPatch
         where
        type Rs FireStoreProjectsDatabasesDocumentsPatch =
             Document
