...
type FireStoreProjectsDatabasesDocumentsRunAggregationQueryResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "runAggregationQuery" Core.Text
...
instance
  ...
  where
  type
    Rs FireStoreProjectsDatabasesDocumentsRunAggregationQuery =
      RunAggregationQueryResponse
  type
    Scopes FireStoreProjectsDatabasesDocumentsRunAggregationQuery =
