              ...
              (\ o ->
                 DataPoint Core.<$>
                   (o Core..:? "computationTimeMillis" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "rawTimestampNanos" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "startTimeNanos" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
        ...
        parseJSON
          = Core.withObject "Dataset"
              (\ o ->
                 Dataset Core.<$>
                   (o Core..:? "dataSourceId") Core.<*>
                     (o Core..:? "maxEndTimeNs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minStartTimeNs" Core.<&>
                        Core.fmap Core.fromAsText)
