          ...
          = Core.withObject "AggregateBucket"
              (\ o ->
                 AggregateBucket Core.<$>
                   (o Core..:? "activity") Core.<*>
                     (o Core..:? "dataset" Core..!= Core.mempty)
...
newAggregateBy 
    ::  AggregateBy
newAggregateBy =
  AggregateBy {dataSourceId = Core.Nothing, dataTypeName = Core.Nothing}
          ...
          = Core.withObject "AggregateRequest"
              (\ o ->
                 AggregateRequest Core.<$>
                   (o Core..:? "aggregateBy" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "endTimeMillis")
                     Core.<*>
                     (o Core..:? "filteredDataQualityStandard" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "startTimeMillis"))
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregateBy" Core..=) Core.<$> aggregateBy,
                  ...
                  ("bucketByActivityType" Core..=) Core.<$>
...
instance Core.FromJSON AggregateResponse where
        parseJSON
          = Core.withObject "AggregateResponse"
              (\ o ->
                 AggregateResponse Core.<$>
                   (o Core..:? "bucket" Core..!= Core.mempty))

instance Core.ToJSON AggregateResponse where
        toJSON AggregateResponse{..}
          = Core.object
              (Core.catMaybes [("bucket" Core..=) Core.<$> bucket])
...
newBucketByActivity =
  BucketByActivity
    {activityDataSourceId = Core.Nothing, minDurationMillis = Core.Nothing}
              ...
              (\ o ->
                 BucketByActivity Core.<$>
                   (o Core..:? "activityDataSourceId") Core.<*>
                     (o Core..:? "minDurationMillis"))

instance Core.ToJSON BucketByActivity where
        toJSON BucketByActivity{..}
          = Core.object
              (Core.catMaybes
                 [("activityDataSourceId" Core..=) Core.<$>
                    activityDataSourceId,
                  ("minDurationMillis" Core..=) Core.. Core.AsText
...
newBucketBySession 
    ::  BucketBySession
newBucketBySession = BucketBySession {minDurationMillis = Core.Nothing}
...
newBucketByTime 
    ::  BucketByTime
newBucketByTime =
  BucketByTime {durationMillis = Core.Nothing, period = Core.Nothing}
...
newBucketByTimePeriod =
  BucketByTimePeriod
    {timeZoneId = Core.Nothing, type' = Core.Nothing, value = Core.Nothing}
...
instance Core.ToJSON DataPoint where
        toJSON DataPoint{..}
          = Core.object
              (Core.catMaybes
                 [("computationTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> computationTimeMillis,
                  ("dataTypeName" Core..=) Core.<$> dataTypeName,
                  ("endTimeNanos" Core..=) Core.. Core.AsText Core.<$>
                    endTimeNanos,
                  ("modifiedTimeMillis" Core..=) Core.. Core.AsText
                    Core.<$> modifiedTimeMillis,
                  ("originDataSourceId" Core..=) Core.<$>
                    originDataSourceId,
                  ("rawTimestampNanos" Core..=) Core.. Core.AsText
                    Core.<$> rawTimestampNanos,
                  ("startTimeNanos" Core..=) Core.. Core.AsText
                    Core.<$> startTimeNanos,
                  ("value" Core..=) Core.<$> value])
              ...
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "application") Core.<*>
                     (o Core..:? "dataQualityStandard" Core..!=
                        Core.mempty)
...
instance Core.FromJSON DataType where
        parseJSON
          = Core.withObject "DataType"
              (\ o ->
                 DataType Core.<$>
                   (o Core..:? "field" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "name"))
...
newDataTypeField =
  DataTypeField
    {format = Core.Nothing, name = Core.Nothing, optional = Core.Nothing}
...
instance Core.FromJSON DataTypeField where
        parseJSON
          = Core.withObject "DataTypeField"
              (\ o ->
                 DataTypeField Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "name")
...
instance Core.ToJSON Dataset where
        toJSON Dataset{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ("maxEndTimeNs" Core..=) Core.. Core.AsText Core.<$>
                    maxEndTimeNs,
                  ("minStartTimeNs" Core..=) Core.. Core.AsText
                    Core.<$> minStartTimeNs,
...
instance Core.FromJSON ListDataPointChangesResponse
         where
        parseJSON
          = Core.withObject "ListDataPointChangesResponse"
              (\ o ->
                 ListDataPointChangesResponse Core.<$>
                   (o Core..:? "dataSourceId") Core.<*>
                     (o Core..:? "deletedDataPoint" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "insertedDataPoint" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON ListDataPointChangesResponse
         where
        toJSON ListDataPointChangesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ("deletedDataPoint" Core..=) Core.<$>
                    deletedDataPoint,
                  ("insertedDataPoint" Core..=) Core.<$>
                    insertedDataPoint,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListDataSourcesResponse 
    ::  ListDataSourcesResponse
newListDataSourcesResponse = ListDataSourcesResponse {dataSource = Core.Nothing}
          ...
          = Core.withObject "ListDataSourcesResponse"
              (\ o ->
                 ListDataSourcesResponse Core.<$>
                   (o Core..:? "dataSource" Core..!= Core.mempty))
          ...
          = Core.withObject "ListSessionsResponse"
              (\ o ->
                 ListSessionsResponse Core.<$>
                   (o Core..:? "deletedSession" Core..!= Core.mempty)
...
instance Core.ToJSON MapValue where
        toJSON MapValue{..}
          = Core.object
              (Core.catMaybes [("fpVal" Core..=) Core.<$> fpVal])
...
instance Core.ToJSON Session where
        toJSON Session{..}
          = Core.object
              (Core.catMaybes
                 [("activeTimeMillis" Core..=) Core.. Core.AsText
...
instance Core.FromJSON Value where
        parseJSON
          = Core.withObject "Value"
              (\ o ->
                 Value Core.<$>
                   (o Core..:? "fpVal") Core.<*> (o Core..:? "intVal")
