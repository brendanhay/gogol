...
type GamesConfigurationAchievementConfigurationsListResource =
  "games"
    ...
    Core.:> Core.Get '[Core.JSON] AchievementConfigurationListResponse
...
instance
  ...
  where
  type
    Rs GamesConfigurationAchievementConfigurationsList =
      AchievementConfigurationListResponse
  type
    Scopes GamesConfigurationAchievementConfigurationsList =
