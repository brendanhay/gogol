                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Post '[Core.JSON] ImageConfiguration
       Core.:<|>
       "upload" Core.:>
         "games" Core.:>
           "v1configuration" Core.:>
...
instance Core.GoogleRequest
           GamesConfigurationImageConfigurationsUpload
         where
        type Rs GamesConfigurationImageConfigurationsUpload =
             ImageConfiguration
        type Scopes
               GamesConfigurationImageConfigurationsUpload
             =
        ...
        requestClient
          GamesConfigurationImageConfigurationsUpload{..}
          = go resourceId imageType xgafv accessToken callback
              uploadType
              uploadProtocol
...
instance Core.GoogleRequest
        ...
        requestClient
          (Core.MediaUpload
             GamesConfigurationImageConfigurationsUpload{..} body)
          = go resourceId imageType xgafv accessToken callback
              uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
