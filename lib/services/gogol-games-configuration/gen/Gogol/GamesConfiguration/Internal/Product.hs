...
instance Core.FromJSON AchievementConfigurationDetail
         where
        parseJSON
...
instance Core.ToJSON AchievementConfigurationDetail
         where
...
instance Core.FromJSON GamesNumberAffixConfiguration
         where
        parseJSON
          = Core.withObject "GamesNumberAffixConfiguration"
              (\ o ->
                 GamesNumberAffixConfiguration Core.<$>
                   (o Core..:? "few") Core.<*> (o Core..:? "many")
                     Core.<*> (o Core..:? "one")
                     Core.<*> (o Core..:? "other")
                     Core.<*> (o Core..:? "two")
                     Core.<*> (o Core..:? "zero"))

instance Core.ToJSON GamesNumberAffixConfiguration
         where
...
instance Core.FromJSON GamesNumberFormatConfiguration
         where
        parseJSON
...
instance Core.ToJSON GamesNumberFormatConfiguration
         where
        toJSON GamesNumberFormatConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("currencyCode" Core..=) Core.<$> currencyCode,
                  ("numDecimalPlaces" Core..=) Core.<$>
                    numDecimalPlaces,
                  ("numberFormatType" Core..=) Core.<$>
                    numberFormatType,
...
instance Core.FromJSON ImageConfiguration where
        parseJSON
          = Core.withObject "ImageConfiguration"
              (\ o ->
                 ImageConfiguration Core.<$>
                   (o Core..:? "imageType") Core.<*> (o Core..:? "kind")
          ...
          = Core.object
              (Core.catMaybes
                 [("draft" Core..=) Core.<$> draft,
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("published" Core..=) Core.<$> published,
                  ("scoreMax" Core..=) Core.. Core.AsText Core.<$>
                    scoreMax,
                  ("scoreMin" Core..=) Core.. Core.AsText Core.<$>
                    scoreMin,
...
instance Core.FromJSON LeaderboardConfigurationDetail
         where
        parseJSON
          = Core.withObject "LeaderboardConfigurationDetail"
              (\ o ->
                 LeaderboardConfigurationDetail Core.<$>
                   (o Core..:? "iconUrl") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "scoreFormat")
                     Core.<*> (o Core..:? "sortRank"))

instance Core.ToJSON LeaderboardConfigurationDetail
         where
...
newLocalizedString =
  LocalizedString
    {kind = Core.Nothing, locale = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject "LocalizedString"
              (\ o ->
                 LocalizedString Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "value"))
          ...
          = Core.withObject "LocalizedStringBundle"
              (\ o ->
                 LocalizedStringBundle Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "translations" Core..!= Core.mempty))
