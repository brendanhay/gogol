...
type GamesAccesstokensGeneratePlayGroupingApiTokenResource =
  "games"
    Core.:> "v1"
    Core.:> "accesstokens"
    Core.:> "generatePlayGroupingApiToken"
    ...
    Core.:> Core.Post '[Core.JSON] GeneratePlayGroupingApiTokenResponse
...
instance
  ...
  where
  type
    Rs GamesAccesstokensGeneratePlayGroupingApiToken =
      GeneratePlayGroupingApiTokenResponse
  type
    Scopes GamesAccesstokensGeneratePlayGroupingApiToken =
      '[Games'FullControl]
