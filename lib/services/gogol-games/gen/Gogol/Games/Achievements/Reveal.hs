...
instance Core.GoogleRequest GamesAchievementsReveal
         where
        type Rs GamesAchievementsReveal =
             AchievementRevealResponse
        type Scopes GamesAchievementsReveal =
             '[Games'FullControl]
        requestClient GamesAchievementsReveal{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesAchievementsRevealResource)
                      Core.mempty
