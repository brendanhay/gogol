...
instance Core.GoogleRequest GamesEventsListByPlayer
         where
        type Rs GamesEventsListByPlayer =
             PlayerEventListResponse
        type Scopes GamesEventsListByPlayer =
             '[Games'FullControl]
        requestClient GamesEventsListByPlayer{..}
          = go xgafv accessToken callback language maxResults
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesEventsListByPlayerResource)
                      Core.mempty
