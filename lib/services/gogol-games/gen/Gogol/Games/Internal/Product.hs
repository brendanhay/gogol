...
newGamePlayerToken 
    ::  GamePlayerToken
newGamePlayerToken =
  GamePlayerToken {applicationId = Core.Nothing, recallToken = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GeneratePlayGroupingApiTokenResponse"
              (\ o ->
                 GeneratePlayGroupingApiTokenResponse Core.<$>
                   (o Core..:? "token"))
...
instance Core.ToJSON LinkPersonaRequest where
        toJSON LinkPersonaRequest{..}
          = Core.object
              (Core.catMaybes
                 [("cardinalityConstraint" Core..=) Core.<$>
...
instance Core.FromJSON LinkPersonaResponse where
        parseJSON
          = Core.withObject "LinkPersonaResponse"
              (\ o ->
                 LinkPersonaResponse Core.<$> (o Core..:? "state"))
...
newPlayGroupingApiToken 
    ::  PlayGroupingApiToken
newPlayGroupingApiToken = PlayGroupingApiToken {tokenValue = Core.Nothing}

instance Core.FromJSON PlayGroupingApiToken where
        parseJSON
          = Core.withObject "PlayGroupingApiToken"
              (\ o ->
                 PlayGroupingApiToken Core.<$>
                   (o Core..:? "tokenValue"))
...
instance Core.ToJSON PlayGroupingApiToken where
        toJSON PlayGroupingApiToken{..}
          = Core.object
              (Core.catMaybes
                 [("tokenValue" Core..=) Core.<$> tokenValue])
...
newResetPersonaRequest 
    ::  ResetPersonaRequest
newResetPersonaRequest = ResetPersonaRequest {persona = Core.Nothing}

instance Core.FromJSON ResetPersonaRequest where
        parseJSON
          = Core.withObject "ResetPersonaRequest"
              (\ o ->
                 ResetPersonaRequest Core.<$> (o Core..:? "persona"))
...
newResetPersonaResponse 
    ::  ResetPersonaResponse
newResetPersonaResponse = ResetPersonaResponse {unlinked = Core.Nothing}

instance Core.FromJSON ResetPersonaResponse where
        parseJSON
          = Core.withObject "ResetPersonaResponse"
              (\ o ->
                 ResetPersonaResponse Core.<$>
                   (o Core..:? "unlinked"))
...
newRetrieveDeveloperGamesLastPlayerTokenResponse 
    ::  RetrieveDeveloperGamesLastPlayerTokenResponse
newRetrieveDeveloperGamesLastPlayerTokenResponse =
  RetrieveDeveloperGamesLastPlayerTokenResponse {gamePlayerToken = Core.Nothing}
...
newRetrieveGamesPlayerTokensResponse 
    ::  RetrieveGamesPlayerTokensResponse
newRetrieveGamesPlayerTokensResponse =
  RetrieveGamesPlayerTokensResponse {gamePlayerTokens = Core.Nothing}
...
instance Core.FromJSON RetrievePlayerTokensResponse
         where
        parseJSON
          = Core.withObject "RetrievePlayerTokensResponse"
              (\ o ->
                 RetrievePlayerTokensResponse Core.<$>
                   (o Core..:? "tokens"))

instance Core.ToJSON RetrievePlayerTokensResponse
         where
        toJSON RetrievePlayerTokensResponse{..}
          = Core.object
              (Core.catMaybes [("tokens" Core..=) Core.<$> tokens])
...
newUnlinkPersonaRequest =
  UnlinkPersonaRequest
    {persona = Core.Nothing, sessionId = Core.Nothing, token = Core.Nothing}
...
newUnlinkPersonaResponse 
    ::  UnlinkPersonaResponse
newUnlinkPersonaResponse = UnlinkPersonaResponse {unlinked = Core.Nothing}

instance Core.FromJSON UnlinkPersonaResponse where
        parseJSON
          = Core.withObject "UnlinkPersonaResponse"
              (\ o ->
                 UnlinkPersonaResponse Core.<$>
                   (o Core..:? "unlinked"))
