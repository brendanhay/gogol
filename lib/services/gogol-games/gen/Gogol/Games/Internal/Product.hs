          ...
          = Core.withObject "AchievementUpdateMultipleRequest"
              (\ o ->
                 AchievementUpdateMultipleRequest Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "updates" Core..!= Core.mempty))
          ...
          = Core.withObject "AchievementUpdateMultipleResponse"
              (\ o ->
                 AchievementUpdateMultipleResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "updatedAchievements" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "achievement_count") Core.<*>
                     (o Core..:? "assets" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "author")
          ...
          = Core.withObject "EventDefinition"
              (\ o ->
                 EventDefinition Core.<$>
                   (o Core..:? "childEvents" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "description")
              ...
              (\ o ->
                 EventRecordRequest Core.<$>
                   (o Core..:? "currentTimeMillis") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "timePeriods" Core..!= Core.mempty))
          ...
          = Core.withObject "EventUpdateResponse"
              (\ o ->
                 EventUpdateResponse Core.<$>
                   (o Core..:? "batchFailures" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "eventFailures" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "playerEvents" Core..!= Core.mempty))
          ...
          = Core.withObject "GamesAchievementIncrement"
              (\ o ->
                 GamesAchievementIncrement Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "requestId")
                     Core.<*> (o Core..:? "steps"))
              ...
              (\ o ->
                 MetagameConfig Core.<$>
                   (o Core..:? "currentVersion") Core.<*>
                     (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "playerLevels" Core..!= Core.mempty))
          ...
          = Core.withObject "PlayerScoreListResponse"
              (\ o ->
                 PlayerScoreListResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "submittedScores" Core..!= Core.mempty))
              ...
              (\ o ->
                 PlayerScoreResponse Core.<$>
                   (o Core..:? "beatenScoreTimeSpans" Core..!=
                     ...
                     Core.<*> (o Core..:? "scoreTag")
                     Core.<*>
                     (o Core..:? "unbeatenScores" Core..!= Core.mempty))
          ...
          = Core.withObject "PlayerScoreSubmissionList"
              (\ o ->
                 PlayerScoreSubmissionList Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "scores" Core..!= Core.mempty))
