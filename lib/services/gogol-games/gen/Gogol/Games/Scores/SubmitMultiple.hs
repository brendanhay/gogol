                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PlayerScoreSubmissionList
                             Core.:>
...
instance Core.GoogleRequest GamesScoresSubmitMultiple
         where
        type Rs GamesScoresSubmitMultiple =
             PlayerScoreListResponse
        type Scopes GamesScoresSubmitMultiple =
             '[Games'FullControl]
        requestClient GamesScoresSubmitMultiple{..}
          = go xgafv accessToken callback language uploadType
              uploadProtocol
