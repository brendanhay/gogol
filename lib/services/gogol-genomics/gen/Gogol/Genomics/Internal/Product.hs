          ...
          = Core.object
              (Core.catMaybes
                 [("commands" Core..=) Core.<$> commands,
                  ...
                  ("encryptedEnvironment" Core..=) Core.<$>
...
newAction_Environment 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Action_Environment
newAction_Environment additional = Action_Environment {additional = additional}
...
newAction_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Action_Labels
newAction_Labels additional = Action_Labels {additional = additional}
...
newCheckInResponse =
  CheckInResponse
    {deadline = Core.Nothing, features = Core.Nothing, metadata = Core.Nothing}
...
newContainerStoppedEvent =
  ContainerStoppedEvent
    {actionId = Core.Nothing, exitStatus = Core.Nothing, stderr = Core.Nothing}
...
instance Core.FromJSON DiskStatus where
        parseJSON
          = Core.withObject "DiskStatus"
              (\ o ->
                 DiskStatus Core.<$>
                   (o Core..:? "freeSpaceBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalSpaceBytes" Core.<&>
                        Core.fmap Core.fromAsText))
...
newEvent_Details 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> Event_Details
newEvent_Details additional = Event_Details {additional = additional}
...
newMetadata_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Metadata_Labels
newMetadata_Labels additional = Metadata_Labels {additional = additional}
...
newPersistentDisk =
  PersistentDisk
    {sizeGb = Core.Nothing, sourceImage = Core.Nothing, type' = Core.Nothing}
...
newRunPipelineRequest =
  RunPipelineRequest
    {labels = Core.Nothing, pipeline = Core.Nothing, pubSubTopic = Core.Nothing}
...
instance Core.FromJSON RunPipelineRequest_Labels
         where
        parseJSON
          = Core.withObject "RunPipelineRequest_Labels"
              (\ o ->
                 RunPipelineRequest_Labels Core.<$>
                   (Core.parseJSONObject o))
...
instance Core.FromJSON UnexpectedExitStatusEvent
         where
        parseJSON
...
newWorkerAssignedEvent =
  WorkerAssignedEvent
    {instance' = Core.Nothing, machineType = Core.Nothing, zone = Core.Nothing}
...
instance Core.FromJSON WorkerStatus where
        parseJSON
          = Core.withObject "WorkerStatus"
              (\ o ->
                 WorkerStatus Core.<$>
                   (o Core..:? "attachedDisks") Core.<*>
                     (o Core..:? "bootDisk")
                     Core.<*>
                     (o Core..:? "freeRamBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalRamBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "uptimeSeconds" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("attachedDisks" Core..=) Core.<$> attachedDisks,
                  ...
                  ("freeRamBytes" Core..=) Core.. Core.AsText Core.<$>
                    freeRamBytes,
...
instance Core.FromJSON WorkerStatus_AttachedDisks
         where
        parseJSON
          = Core.withObject "WorkerStatus_AttachedDisks"
              (\ o ->
                 WorkerStatus_AttachedDisks Core.<$>
                   (Core.parseJSONObject o))
