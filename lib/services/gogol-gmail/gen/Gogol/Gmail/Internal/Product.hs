          ...
          = Core.withObject "BatchModifyMessagesRequest"
              (\ o ->
                 BatchModifyMessagesRequest Core.<$>
                   (o Core..:? "addLabelIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "ids" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "removeLabelIds" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject "History"
              (\ o ->
                 History Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "labelsAdded" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "labelsRemoved" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "messages" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "messagesAdded" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "messagesDeleted" Core..!= Core.mempty))
          ...
          = Core.withObject "HistoryLabelAdded"
              (\ o ->
                 HistoryLabelAdded Core.<$>
                   (o Core..:? "labelIds" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "message"))
          ...
          = Core.withObject "ListDraftsResponse"
              (\ o ->
                 ListDraftsResponse Core.<$>
                   (o Core..:? "drafts" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListFiltersResponse"
              (\ o ->
                 ListFiltersResponse Core.<$>
                   (o Core..:? "filter" Core..!= Core.mempty))
          ...
          = Core.withObject "ListForwardingAddressesResponse"
              (\ o ->
                 ListForwardingAddressesResponse Core.<$>
                   (o Core..:? "forwardingAddresses" Core..!=
                      Core.mempty))
          ...
          = Core.withObject "ListHistoryResponse"
              (\ o ->
                 ListHistoryResponse Core.<$>
                   (o Core..:? "history" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "historyId")
...
instance Core.FromJSON ListLabelsResponse where
        parseJSON
          = Core.withObject "ListLabelsResponse"
              (\ o ->
                 ListLabelsResponse Core.<$>
                   (o Core..:? "labels" Core..!= Core.mempty))
          ...
          = Core.withObject "ListMessagesResponse"
              (\ o ->
                 ListMessagesResponse Core.<$>
                   (o Core..:? "messages" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "resultSizeEstimate"))
...
instance Core.FromJSON ListSendAsResponse where
        parseJSON
          = Core.withObject "ListSendAsResponse"
              (\ o ->
                 ListSendAsResponse Core.<$>
                   (o Core..:? "sendAs" Core..!= Core.mempty))
          ...
          = Core.withObject "ListSmimeInfoResponse"
              (\ o ->
                 ListSmimeInfoResponse Core.<$>
                   (o Core..:? "smimeInfo" Core..!= Core.mempty))
...
instance Core.FromJSON Message where
        parseJSON
          = Core.withObject "Message"
              (\ o ->
                 Message Core.<$>
                   (o Core..:? "historyId") Core.<*> (o Core..:? "id")
