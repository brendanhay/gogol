...
newHardwareKeyMetadata 
    ::  HardwareKeyMetadata
newHardwareKeyMetadata = HardwareKeyMetadata {description = Core.Nothing}

instance Core.FromJSON HardwareKeyMetadata where
        parseJSON
          = Core.withObject "HardwareKeyMetadata"
              (\ o ->
                 HardwareKeyMetadata Core.<$>
                   (o Core..:? "description"))
...
newSignAndEncryptKeyPairs =
  SignAndEncryptKeyPairs
    {encryptionKeyPairId = Core.Nothing, signingKeyPairId = Core.Nothing}
...
instance Core.ToJSON SignAndEncryptKeyPairs where
        toJSON SignAndEncryptKeyPairs{..}
          = Core.object
              (Core.catMaybes
                 [("encryptionKeyPairId" Core..=) Core.<$>
                    encryptionKeyPairId,
                  ("signingKeyPairId" Core..=) Core.<$>
                    signingKeyPairId])
