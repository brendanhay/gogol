...
instance Core.GoogleRequest GmailUsersMessagesList
         where
        type Rs GmailUsersMessagesList = ListMessagesResponse
        type Scopes GmailUsersMessagesList =
             '[Gmail'FullControl, Gmail'Metadata, Gmail'Modify,
               Gmail'Readonly]
