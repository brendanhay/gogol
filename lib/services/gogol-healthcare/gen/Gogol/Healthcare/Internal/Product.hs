...
instance Core.FromJSON AccessDeterminationLogConfig
         where
        parseJSON
          = Core.withObject "AccessDeterminationLogConfig"
              (\ o ->
                 AccessDeterminationLogConfig Core.<$>
                   (o Core..:? "logLevel"))

instance Core.ToJSON AccessDeterminationLogConfig
         where
...
newAnalyzeEntitiesRequest =
  AnalyzeEntitiesRequest
    { alternativeOutputFormat = Core.Nothing
...
newApplyAdminConsentsErrorDetail =
  ApplyAdminConsentsErrorDetail
    {consentErrors = Core.Nothing, existingOperationId = Core.Nothing}

instance Core.FromJSON ApplyAdminConsentsErrorDetail
         where
        parseJSON
...
instance Core.ToJSON ApplyAdminConsentsErrorDetail
         where
        toJSON ApplyAdminConsentsErrorDetail{..}
          = Core.object
              (Core.catMaybes
                 [("consentErrors" Core..=) Core.<$> consentErrors,
                  ("existingOperationId" Core..=) Core.. Core.AsText
                    Core.<$> existingOperationId])
...
newApplyAdminConsentsRequest =
  ApplyAdminConsentsRequest
    {newConsentsList' = Core.Nothing, validateOnly = Core.Nothing}

instance Core.FromJSON ApplyAdminConsentsRequest
         where
        parseJSON
...
newApplyAdminConsentsResponse =
  ApplyAdminConsentsResponse
    { affectedResources = Core.Nothing
    , consentApplySuccess = Core.Nothing
    , failedResources = Core.Nothing
    }

instance Core.FromJSON ApplyAdminConsentsResponse
         where
        parseJSON
          = Core.withObject "ApplyAdminConsentsResponse"
              (\ o ->
                 ApplyAdminConsentsResponse Core.<$>
                   (o Core..:? "affectedResources" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "consentApplySuccess" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "failedResources" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON ApplyAdminConsentsResponse where
        toJSON ApplyAdminConsentsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("affectedResources" Core..=) Core.. Core.AsText
                    Core.<$> affectedResources,
                  ("consentApplySuccess" Core..=) Core.. Core.AsText
                    Core.<$> consentApplySuccess,
                  ("failedResources" Core..=) Core.. Core.AsText
                    Core.<$> failedResources])
        ...
        toJSON ApplyConsentsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("affectedResources" Core..=) Core.. Core.AsText
                    Core.<$> affectedResources,
                  ("consentApplyFailure" Core..=) Core.. Core.AsText
                    Core.<$> consentApplyFailure,
                  ("consentApplySuccess" Core..=) Core.. Core.AsText
                    Core.<$> consentApplySuccess,
                  ("failedResources" Core..=) Core.. Core.AsText
                    Core.<$> failedResources])
...
newBlobStorageInfo =
  BlobStorageInfo
    ...
    , storageClassUpdateTime = Core.Nothing
    }
...
newConsentAccessorScope =
  ConsentAccessorScope
    {actor = Core.Nothing, environment = Core.Nothing, purpose = Core.Nothing}
...
newConsentConfig =
  ConsentConfig
    { accessDeterminationLogConfig = Core.Nothing
    , accessEnforced = Core.Nothing
    , consentHeaderHandling = Core.Nothing
    , enforcedAdminConsents = Core.Nothing
          ...
          = Core.object
              (Core.catMaybes
                 [("accessDeterminationLogConfig" Core..=) Core.<$>
                  ...
                  ("consentHeaderHandling" Core..=) Core.<$>
                    consentHeaderHandling,
                  ("enforcedAdminConsents" Core..=) Core.<$>
...
newConsentErrors 
    ::  ConsentErrors
newConsentErrors = ConsentErrors {error = Core.Nothing, name = Core.Nothing}
...
newConsentHeaderHandling 
    ::  ConsentHeaderHandling
newConsentHeaderHandling = ConsentHeaderHandling {profile = Core.Nothing}

instance Core.FromJSON ConsentHeaderHandling where
        parseJSON
          = Core.withObject "ConsentHeaderHandling"
              (\ o ->
                 ConsentHeaderHandling Core.<$>
                   (o Core..:? "profile"))
...
newDicomStoreMetrics =
  DicomStoreMetrics
    { blobStorageSizeBytes = Core.Nothing
              ...
              (\ o ->
                 DicomStoreMetrics Core.<$>
                   (o Core..:? "blobStorageSizeBytes" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "instanceCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "seriesCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "structuredStorageSizeBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "studyCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON DicomStoreMetrics where
        toJSON DicomStoreMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("blobStorageSizeBytes" Core..=) Core.. Core.AsText
                    Core.<$> blobStorageSizeBytes,
                  ("instanceCount" Core..=) Core.. Core.AsText Core.<$>
                    instanceCount,
                  ("name" Core..=) Core.<$> name,
                  ("seriesCount" Core..=) Core.. Core.AsText Core.<$>
                    seriesCount,
                  ("structuredStorageSizeBytes" Core..=) Core..
                    Core.AsText
                    Core.<$> structuredStorageSizeBytes,
                  ("studyCount" Core..=) Core.. Core.AsText Core.<$>
                    studyCount])
...
instance Core.FromJSON EncryptionSpec where
        parseJSON
          = Core.withObject "EncryptionSpec"
              (\ o ->
                 EncryptionSpec Core.<$> (o Core..:? "kmsKeyName"))
...
newExplainDataAccessConsentInfo =
  ExplainDataAccessConsentInfo
    { cascadeOrigins = Core.Nothing
    , consentResource = Core.Nothing
    , enforcementTime = Core.Nothing
    , matchingAccessorScopes = Core.Nothing
    , patientConsentOwner = Core.Nothing
    , type' = Core.Nothing
    , variants = Core.Nothing
    }

instance Core.FromJSON ExplainDataAccessConsentInfo
         where
        parseJSON
...
instance Core.ToJSON ExplainDataAccessConsentInfo
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("cascadeOrigins" Core..=) Core.<$> cascadeOrigins,
                  ...
                  ("matchingAccessorScopes" Core..=) Core.<$>
                    matchingAccessorScopes,
                  ("patientConsentOwner" Core..=) Core.<$>
                    patientConsentOwner,
                  ("type" Core..=) Core.<$> type',
...
newExplainDataAccessConsentScope =
  ExplainDataAccessConsentScope
    { accessorScope = Core.Nothing
    , decision = Core.Nothing
    , enforcingConsents = Core.Nothing
    , exceptions = Core.Nothing
    }

instance Core.FromJSON ExplainDataAccessConsentScope
         where
        parseJSON
          = Core.withObject "ExplainDataAccessConsentScope"
              (\ o ->
                 ExplainDataAccessConsentScope Core.<$>
                   (o Core..:? "accessorScope") Core.<*>
                     (o Core..:? "decision")
                     Core.<*> (o Core..:? "enforcingConsents")
                     Core.<*> (o Core..:? "exceptions"))

instance Core.ToJSON ExplainDataAccessConsentScope
         where
...
newExplainDataAccessResponse =
  ExplainDataAccessResponse
    {consentScopes = Core.Nothing, warning = Core.Nothing}

instance Core.FromJSON ExplainDataAccessResponse
         where
        parseJSON
          = Core.withObject "ExplainDataAccessResponse"
              (\ o ->
                 ExplainDataAccessResponse Core.<$>
                   (o Core..:? "consentScopes") Core.<*>
                     (o Core..:? "warning"))
...
newExportMessagesRequest =
  ExportMessagesRequest
    ...
    , pubsubDestination = Core.Nothing
          ...
          = Core.withObject "ExportMessagesRequest"
              (\ o ->
                 ExportMessagesRequest Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "filter")
...
newGoogleCloudHealthcareV1DicomStreamConfig 
    ::  GoogleCloudHealthcareV1DicomStreamConfig
newGoogleCloudHealthcareV1DicomStreamConfig =
  GoogleCloudHealthcareV1DicomStreamConfig {bigqueryDestination = Core.Nothing}
...
newImportDicomDataRequest =
  ImportDicomDataRequest
    {blobStorageSettings = Core.Nothing, gcsSource = Core.Nothing}
...
newNotificationConfig =
  NotificationConfig
    {pubsubTopic = Core.Nothing, sendForBulkImport = Core.Nothing}
...
instance Core.FromJSON PatientScope where
        parseJSON
          = Core.withObject "PatientScope"
              (\ o ->
                 PatientScope Core.<$> (o Core..:? "patientIds"))
...
newPubsubDestination 
    ::  PubsubDestination
newPubsubDestination = PubsubDestination {pubsubTopic = Core.Nothing}

instance Core.FromJSON PubsubDestination where
        parseJSON
          = Core.withObject "PubsubDestination"
              (\ o ->
                 PubsubDestination Core.<$>
                   (o Core..:? "pubsubTopic"))
...
newRollbackFhirResourceFilteringFields =
  RollbackFhirResourceFilteringFields
    {metadataFilter = Core.Nothing, operationIds = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("metadataFilter" Core..=) Core.<$> metadataFilter,
                  ("operationIds" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> operationIds])
...
newRollbackFhirResourcesRequest =
  RollbackFhirResourcesRequest
    ...
    , excludeRollbacks = Core.Nothing
    , filteringFields = Core.Nothing
    , force = Core.Nothing
    , inputGcsObject = Core.Nothing
    , resultGcsBucket = Core.Nothing
    , rollbackTime = Core.Nothing
    , type' = Core.Nothing
    }

instance Core.FromJSON RollbackFhirResourcesRequest
         where
        parseJSON
...
instance Core.ToJSON RollbackFhirResourcesRequest
         where
        toJSON RollbackFhirResourcesRequest{..}
          = Core.object
              (Core.catMaybes
                 [("changeType" Core..=) Core.<$> changeType,
                  ("excludeRollbacks" Core..=) Core.<$>
                    excludeRollbacks,
...
instance Core.FromJSON RollbackFhirResourcesResponse
         where
        parseJSON
          = Core.withObject "RollbackFhirResourcesResponse"
              (\ o ->
                 RollbackFhirResourcesResponse Core.<$>
                   (o Core..:? "fhirStore"))

instance Core.ToJSON RollbackFhirResourcesResponse
         where
        toJSON RollbackFhirResourcesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("fhirStore" Core..=) Core.<$> fhirStore])
...
instance Core.FromJSON RollbackHl7V2MessagesRequest
         where
        parseJSON
...
instance Core.ToJSON RollbackHl7V2MessagesRequest
         where
...
instance Core.FromJSON RollbackHl7V2MessagesResponse
         where
        parseJSON
          = Core.withObject "RollbackHl7V2MessagesResponse"
              (\ o ->
                 RollbackHl7V2MessagesResponse Core.<$>
                   (o Core..:? "hl7v2Store"))

instance Core.ToJSON RollbackHl7V2MessagesResponse
         where
        toJSON RollbackHl7V2MessagesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("hl7v2Store" Core..=) Core.<$> hl7v2Store])
...
newSetBlobStorageSettingsRequest =
  SetBlobStorageSettingsRequest
    {blobStorageSettings = Core.Nothing, filterConfig = Core.Nothing}

instance Core.FromJSON SetBlobStorageSettingsRequest
         where
        parseJSON
...
instance Core.ToJSON SetBlobStorageSettingsRequest
         where
...
instance Core.FromJSON SetBlobStorageSettingsResponse
         where
        parseJSON
          = Core.withObject "SetBlobStorageSettingsResponse"
              (\ o -> Core.pure SetBlobStorageSettingsResponse)

instance Core.ToJSON SetBlobStorageSettingsResponse
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.ToJSON StorageInfo where
        toJSON StorageInfo{..}
          = Core.object
              (Core.catMaybes
                 [("blobStorageInfo" Core..=) Core.<$>
                    blobStorageInfo,
                  ("referencedResource" Core..=) Core.<$>
                    referencedResource,
                  ("structuredStorageInfo" Core..=) Core.<$>
                    structuredStorageInfo])
...
data StreamConfig = StreamConfig
    {
      ...
      -- must have disable/referential/integrity set to true. If a resource cannot be de-identified, errors will be logged to Cloud Logging (see <https://cloud.google.com/healthcare/docs/how-tos/logging Viewing error logs in Cloud Logging>).
...
newStructuredStorageInfo 
    ::  StructuredStorageInfo
newStructuredStorageInfo = StructuredStorageInfo {sizeBytes = Core.Nothing}
