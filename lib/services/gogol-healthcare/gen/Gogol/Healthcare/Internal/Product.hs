              ...
              (\ o ->
                 AnalyzeEntitiesRequest Core.<$>
                   (o Core..:? "documentContent") Core.<*>
                     (o Core..:? "licensedVocabularies" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "AnalyzeEntitiesResponse"
              (\ o ->
                 AnalyzeEntitiesResponse Core.<$>
                   (o Core..:? "entities" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "entityMentions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "relationships" Core..!= Core.mempty))
          ...
          = Core.withObject "AttributeDefinition"
              (\ o ->
                 AttributeDefinition Core.<$>
                   (o Core..:? "allowedValues" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "category")
                     Core.<*>
                     (o Core..:? "consentDefaultValues" Core..!=
                        Core.mempty)
...
newCheckDataAccessRequest_RequestAttributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> CheckDataAccessRequest_RequestAttributes
newCheckDataAccessRequest_RequestAttributes addtional =
  CheckDataAccessRequest_RequestAttributes {addtional = addtional}
...
newtype CheckDataAccessResponse_ConsentDetails = CheckDataAccessResponse_ConsentDetails
    {
      -- | 
      addtional :: (Core.HashMap Core.Text ConsentEvaluation)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCheckDataAccessResponse_ConsentDetails 
    ::  Core.HashMap Core.Text ConsentEvaluation
       -- ^  See 'addtional'.
    -> CheckDataAccessResponse_ConsentDetails
newCheckDataAccessResponse_ConsentDetails addtional =
  CheckDataAccessResponse_ConsentDetails {addtional = addtional}
...
newConsent_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Consent_Metadata
newConsent_Metadata addtional = Consent_Metadata {addtional = addtional}
...
instance Core.ToJSON Consent_Metadata where
        toJSON Consent_Metadata{..} = Core.toJSON addtional
...
newConsentArtifact_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> ConsentArtifact_Metadata
newConsentArtifact_Metadata addtional =
  ConsentArtifact_Metadata {addtional = addtional}
...
instance Core.FromJSON ConsentList where
        parseJSON
          = Core.withObject "ConsentList"
              (\ o ->
                 ConsentList Core.<$>
                   (o Core..:? "consents" Core..!= Core.mempty))
...
newConsentStore_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> ConsentStore_Labels
newConsentStore_Labels addtional = ConsentStore_Labels {addtional = addtional}
...
newDeidentifyDatasetRequest =
  DeidentifyDatasetRequest
    {config = Core.Nothing, destinationDataset = Core.Nothing}
...
newDicomStore_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> DicomStore_Labels
newDicomStore_Labels addtional = DicomStore_Labels {addtional = addtional}
...
instance Core.ToJSON DicomStore_Labels where
        toJSON DicomStore_Labels{..} = Core.toJSON addtional
              ...
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "entityId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "vocabularyCodes" Core..!= Core.mempty))
              ...
              (\ o ->
                 EntityMention Core.<$>
                   (o Core..:? "certaintyAssessment") Core.<*>
                     (o Core..:? "confidence")
                     Core.<*>
                     (o Core..:? "linkedEntities" Core..!= Core.mempty)
...
newEvaluateUserConsentsRequest_RequestAttributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> EvaluateUserConsentsRequest_RequestAttributes
newEvaluateUserConsentsRequest_RequestAttributes addtional =
  EvaluateUserConsentsRequest_RequestAttributes {addtional = addtional}
...
newEvaluateUserConsentsRequest_ResourceAttributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> EvaluateUserConsentsRequest_ResourceAttributes
newEvaluateUserConsentsRequest_ResourceAttributes addtional =
  EvaluateUserConsentsRequest_ResourceAttributes {addtional = addtional}
...
instance Core.FromJSON FhirStore where
        parseJSON
          = Core.withObject "FhirStore"
              (\ o ->
                 FhirStore Core.<$>
                   (o Core..:? "defaultSearchHandlingStrict") Core.<*>
                     (o Core..:? "disableReferentialIntegrity")
                     ...
                     Core.<*> (o Core..:? "notificationConfig")
                     Core.<*>
                     (o Core..:? "streamConfigs" Core..!= Core.mempty)
...
newFhirStore_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> FhirStore_Labels
newFhirStore_Labels addtional = FhirStore_Labels {addtional = addtional}
...
instance Core.ToJSON FhirStore_Labels where
        toJSON FhirStore_Labels{..} = Core.toJSON addtional
              ...
              (\ o ->
                 GoogleCloudHealthcareV1ConsentPolicy Core.<$>
                   (o Core..:? "authorizationRule") Core.<*>
                     (o Core..:? "resourceAttributes" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 Hl7SchemaConfig Core.<$>
                   (o Core..:? "messageSchemaConfigs") Core.<*>
                     (o Core..:? "version" Core..!= Core.mempty))
...
newtype Hl7SchemaConfig_MessageSchemaConfigs = Hl7SchemaConfig_MessageSchemaConfigs
    {
      -- | 
      addtional :: (Core.HashMap Core.Text SchemaGroup)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newHl7SchemaConfig_MessageSchemaConfigs 
    ::  Core.HashMap Core.Text SchemaGroup
       -- ^  See 'addtional'.
    -> Hl7SchemaConfig_MessageSchemaConfigs
newHl7SchemaConfig_MessageSchemaConfigs addtional =
  Hl7SchemaConfig_MessageSchemaConfigs {addtional = addtional}
...
instance Core.FromJSON Hl7TypesConfig where
        parseJSON
          = Core.withObject "Hl7TypesConfig"
              (\ o ->
                 Hl7TypesConfig Core.<$>
                   (o Core..:? "type" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "version" Core..!= Core.mempty))
          ...
          = Core.withObject "Hl7V2Store"
              (\ o ->
                 Hl7V2Store Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "notificationConfigs" Core..!=
                        Core.mempty)
...
newHl7V2Store_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Hl7V2Store_Labels
newHl7V2Store_Labels addtional = Hl7V2Store_Labels {addtional = addtional}
...
instance Core.ToJSON Hl7V2Store_Labels where
        toJSON Hl7V2Store_Labels{..} = Core.toJSON addtional
              ...
              (\ o ->
                 HttpBody Core.<$>
                   (o Core..:? "contentType") Core.<*>
                     (o Core..:? "data")
                     Core.<*>
                     (o Core..:? "extensions" Core..!= Core.mempty))
...
newHttpBody_ExtensionsItem 
    ...
    -> HttpBody_ExtensionsItem
newHttpBody_ExtensionsItem addtional =
  HttpBody_ExtensionsItem {addtional = addtional}
              ...
              (\ o ->
                 InfoTypeTransformation Core.<$>
                   (o Core..:? "characterMaskConfig") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "infoTypes" Core..!= Core.mempty)
          ...
          = Core.withObject "ListConsentArtifactsResponse"
              (\ o ->
                 ListConsentArtifactsResponse Core.<$>
                   (o Core..:? "consentArtifacts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListConsentRevisionsResponse"
              (\ o ->
                 ListConsentRevisionsResponse Core.<$>
                   (o Core..:? "consents" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListConsentStoresResponse"
              (\ o ->
                 ListConsentStoresResponse Core.<$>
                   (o Core..:? "consentStores" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListDicomStoresResponse"
              (\ o ->
                 ListDicomStoresResponse Core.<$>
                   (o Core..:? "dicomStores" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListFhirStoresResponse"
              (\ o ->
                 ListFhirStoresResponse Core.<$>
                   (o Core..:? "fhirStores" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListHl7V2StoresResponse"
              (\ o ->
                 ListHl7V2StoresResponse Core.<$>
                   (o Core..:? "hl7V2Stores" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListMessagesResponse"
              (\ o ->
                 ListMessagesResponse Core.<$>
                   (o Core..:? "hl7V2Messages" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListUserDataMappingsResponse"
              (\ o ->
                 ListUserDataMappingsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "userDataMappings" Core..!= Core.mempty))
              ...
              (\ o ->
                 Message Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "patientIds" Core..!= Core.mempty)
...
newMessage_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Message_Labels
newMessage_Labels addtional = Message_Labels {addtional = addtional}
...
instance Core.ToJSON Message_Labels where
        toJSON Message_Labels{..} = Core.toJSON addtional
...
instance Core.FromJSON ParsedData where
        parseJSON
          = Core.withObject "ParsedData"
              (\ o ->
                 ParsedData Core.<$>
                   (o Core..:? "segments" Core..!= Core.mempty))
...
newQueryAccessibleDataRequest_RequestAttributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> QueryAccessibleDataRequest_RequestAttributes
newQueryAccessibleDataRequest_RequestAttributes addtional =
  QueryAccessibleDataRequest_RequestAttributes {addtional = addtional}
...
newQueryAccessibleDataRequest_ResourceAttributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> QueryAccessibleDataRequest_ResourceAttributes
newQueryAccessibleDataRequest_ResourceAttributes addtional =
  QueryAccessibleDataRequest_ResourceAttributes {addtional = addtional}
          ...
          = Core.withObject "QueryAccessibleDataResponse"
              (\ o ->
                 QueryAccessibleDataResponse Core.<$>
                   (o Core..:? "gcsUris" Core..!= Core.mempty))
...
newResult_ConsentDetails 
    ::  Core.HashMap Core.Text ConsentEvaluation
       -- ^  See 'addtional'.
    -> Result_ConsentDetails
newResult_ConsentDetails addtional =
  Result_ConsentDetails {addtional = addtional}
              ...
              (\ o ->
                 SchemaPackage Core.<$>
                   (o Core..:? "ignoreMinOccurs") Core.<*>
                     (o Core..:? "schemas" Core..!= Core.mempty)
...
newSegment_Fields 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Segment_Fields
newSegment_Fields addtional = Segment_Fields {addtional = addtional}
...
instance Core.ToJSON Segment_Fields where
        toJSON Segment_Fields{..} = Core.toJSON addtional
...
newSignature_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Signature_Metadata
newSignature_Metadata addtional = Signature_Metadata {addtional = addtional}
...
instance Core.ToJSON Signature_Metadata where
        toJSON Signature_Metadata{..} = Core.toJSON addtional
...
newStreamConfig =
  StreamConfig
    {bigqueryDestination = Core.Nothing, resourceTypes = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "StreamConfig"
              (\ o ->
                 StreamConfig Core.<$>
                   (o Core..:? "bigqueryDestination") Core.<*>
                     (o Core..:? "resourceTypes" Core..!= Core.mempty))
...
instance Core.FromJSON TextConfig where
        parseJSON
          = Core.withObject "TextConfig"
              (\ o ->
                 TextConfig Core.<$>
                   (o Core..:? "transformations" Core..!= Core.mempty))
              ...
              (\ o ->
                 ValidationConfig Core.<$>
                   (o Core..:? "disableFhirpathValidation") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "enabledImplementationGuides" Core..!=
                        Core.mempty))
