...
newHealthcareProjectsLocationsDatasetsFhirStoresDeidentify ::
  ...
  -- |  Required. Source FHIR store resource name. For example, @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/fhirStores\/{fhir_store_id}@. See 'sourceStore'.
  Core.Text ->
  HealthcareProjectsLocationsDatasetsFhirStoresDeidentify
newHealthcareProjectsLocationsDatasetsFhirStoresDeidentify
  payload
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsFhirStoresDeidentify =
      Operation
  type
    Scopes HealthcareProjectsLocationsDatasetsFhirStoresDeidentify =
