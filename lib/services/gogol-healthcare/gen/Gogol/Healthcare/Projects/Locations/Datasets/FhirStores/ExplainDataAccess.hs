...
type HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccessResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "explainDataAccess" Core.Text
         Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess 
    ...
    -> HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess
newHealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess name =
  HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess{..}
          = go name xgafv accessToken callback resourceId
              uploadType
              uploadProtocol
