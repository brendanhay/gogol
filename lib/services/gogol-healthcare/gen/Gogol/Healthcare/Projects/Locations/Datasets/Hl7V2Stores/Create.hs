...
type HealthcareProjectsLocationsDatasetsHl7V2StoresCreateResource =
  "v1"
    ...
    Core.:> Core.QueryParam "hl7V2StoreId" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.ReqBody '[Core.JSON] Hl7V2Store
    Core.:> Core.Post '[Core.JSON] Hl7V2Store
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsHl7V2StoresCreate =
      Hl7V2Store
  type
    Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresCreate =
