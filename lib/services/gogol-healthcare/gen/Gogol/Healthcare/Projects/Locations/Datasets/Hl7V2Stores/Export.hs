...
type HealthcareProjectsLocationsDatasetsHl7V2StoresExportResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] ExportMessagesRequest
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsHl7V2StoresExport =
      Operation
  type
    Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresExport =
