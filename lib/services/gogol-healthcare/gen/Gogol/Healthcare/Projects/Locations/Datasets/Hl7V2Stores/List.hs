...
type HealthcareProjectsLocationsDatasetsHl7V2StoresListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListHl7V2StoresResponse
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsHl7V2StoresList =
      ListHl7V2StoresResponse
  type
    Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresList =
