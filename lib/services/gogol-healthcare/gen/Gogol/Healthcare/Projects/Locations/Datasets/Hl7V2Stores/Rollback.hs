...
type HealthcareProjectsLocationsDatasetsHl7V2StoresRollbackResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] RollbackHl7V2MessagesRequest
...
instance
  ...
  where
  type
    Rs HealthcareProjectsLocationsDatasetsHl7V2StoresRollback =
      Operation
  type
    Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresRollback =
