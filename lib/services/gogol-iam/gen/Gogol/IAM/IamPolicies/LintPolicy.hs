               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] LintPolicyRequest Core.:>
                       Core.Post '[Core.JSON] LintPolicyResponse
...
instance Core.GoogleRequest IAMIamPoliciesLintPolicy
         where
        type Rs IAMIamPoliciesLintPolicy = LintPolicyResponse
        type Scopes IAMIamPoliciesLintPolicy =
