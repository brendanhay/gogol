...
instance Core.FromJSON AdminAuditData where
        parseJSON
          = Core.withObject "AdminAuditData"
              (\ o ->
                 AdminAuditData Core.<$>
...
instance Core.FromJSON AuditableService where
        parseJSON
          = Core.withObject "AuditableService"
              (\ o ->
...
instance Core.FromJSON CreateRoleRequest where
        parseJSON
          = Core.withObject "CreateRoleRequest"
              (\ o ->
                 CreateRoleRequest Core.<$>
                   (o Core..:? "role") Core.<*> (o Core..:? "roleId"))
...
newCreateServiceAccountKeyRequest =
  CreateServiceAccountKeyRequest
    {keyAlgorithm = Core.Nothing, privateKeyType = Core.Nothing}

instance Core.FromJSON CreateServiceAccountKeyRequest
         where
        parseJSON
          = Core.withObject "CreateServiceAccountKeyRequest"
              (\ o ->
                 CreateServiceAccountKeyRequest Core.<$>
                   (o Core..:? "keyAlgorithm") Core.<*>
                     (o Core..:? "privateKeyType"))

instance Core.ToJSON CreateServiceAccountKeyRequest
         where
...
newCreateServiceAccountRequest =
  CreateServiceAccountRequest
    {accountId = Core.Nothing, serviceAccount = Core.Nothing}

instance Core.FromJSON CreateServiceAccountRequest
         where
        parseJSON
          = Core.withObject "CreateServiceAccountRequest"
              (\ o ->
                 CreateServiceAccountRequest Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "serviceAccount"))

instance Core.ToJSON CreateServiceAccountRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "DisableServiceAccountKeyRequest"
              (\ o -> Core.pure DisableServiceAccountKeyRequest)

instance Core.ToJSON DisableServiceAccountKeyRequest
         where
...
instance Core.FromJSON DisableServiceAccountRequest
         where
        parseJSON
          = Core.withObject "DisableServiceAccountRequest"
              (\ o -> Core.pure DisableServiceAccountRequest)

instance Core.ToJSON DisableServiceAccountRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON EnableServiceAccountKeyRequest
         where
        parseJSON
          = Core.withObject "EnableServiceAccountKeyRequest"
              (\ o -> Core.pure EnableServiceAccountKeyRequest)

instance Core.ToJSON EnableServiceAccountKeyRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON EnableServiceAccountRequest
         where
        parseJSON
          = Core.withObject "EnableServiceAccountRequest"
              (\ o -> Core.pure EnableServiceAccountRequest)

instance Core.ToJSON EnableServiceAccountRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON LintPolicyRequest where
        parseJSON
          = Core.withObject "LintPolicyRequest"
              (\ o ->
                 LintPolicyRequest Core.<$>
                   (o Core..:? "condition") Core.<*>
...
instance Core.FromJSON LintPolicyResponse where
        parseJSON
          = Core.withObject "LintPolicyResponse"
              (\ o ->
                 LintPolicyResponse Core.<$>
                   (o Core..:? "lintResults" Core..!= Core.mempty))
...
instance Core.FromJSON LintResult where
        parseJSON
          = Core.withObject "LintResult"
              (\ o ->
                 LintResult Core.<$>
                   (o Core..:? "debugMessage") Core.<*>
                     (o Core..:? "fieldName")
                     Core.<*> (o Core..:? "level")
...
instance Core.FromJSON ListRolesResponse where
        parseJSON
          = Core.withObject "ListRolesResponse"
              (\ o ->
                 ListRolesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "roles" Core..!= Core.mempty))
...
instance Core.FromJSON ListServiceAccountKeysResponse
         where
        parseJSON
          = Core.withObject "ListServiceAccountKeysResponse"
              (\ o ->
                 ListServiceAccountKeysResponse Core.<$>
                   (o Core..:? "keys" Core..!= Core.mempty))

instance Core.ToJSON ListServiceAccountKeysResponse
         where
...
instance Core.FromJSON ListServiceAccountsResponse
         where
        parseJSON
          = Core.withObject "ListServiceAccountsResponse"
              (\ o ->
                 ListServiceAccountsResponse Core.<$>
                   (o Core..:? "accounts" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListServiceAccountsResponse
         where
...
newListWorkloadIdentityPoolProvidersResponse =
  ListWorkloadIdentityPoolProvidersResponse
    {nextPageToken = Core.Nothing, workloadIdentityPoolProviders = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListWorkloadIdentityPoolProvidersResponse"
              (\ o ->
                 ListWorkloadIdentityPoolProvidersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "workloadIdentityPoolProviders" Core..!=
                        Core.mempty))
...
instance Core.ToJSON
        ...
        toJSON ListWorkloadIdentityPoolProvidersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("workloadIdentityPoolProviders" Core..=) Core.<$>
...
newListWorkloadIdentityPoolsResponse =
  ListWorkloadIdentityPoolsResponse
    {nextPageToken = Core.Nothing, workloadIdentityPools = Core.Nothing}

instance Core.FromJSON
           ListWorkloadIdentityPoolsResponse
         where
        parseJSON
          = Core.withObject "ListWorkloadIdentityPoolsResponse"
              (\ o ->
                 ListWorkloadIdentityPoolsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "workloadIdentityPools" Core..!=
                        Core.mempty))
...
instance Core.ToJSON
        ...
        toJSON ListWorkloadIdentityPoolsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("workloadIdentityPools" Core..=) Core.<$>
...
instance Core.FromJSON Oidc where
        parseJSON
          = Core.withObject "Oidc"
              (\ o ->
                 Oidc Core.<$>
                   (o Core..:? "allowedAudiences" Core..!= Core.mempty)
...
newPatchServiceAccountRequest =
  PatchServiceAccountRequest
    {serviceAccount = Core.Nothing, updateMask = Core.Nothing}

instance Core.FromJSON PatchServiceAccountRequest
         where
        parseJSON
          = Core.withObject "PatchServiceAccountRequest"
              (\ o ->
                 PatchServiceAccountRequest Core.<$>
                   (o Core..:? "serviceAccount") Core.<*>
                     (o Core..:? "updateMask"))
...
instance Core.FromJSON Permission where
        parseJSON
          = Core.withObject "Permission"
              (\ o ->
                 Permission Core.<$>
                   (o Core..:? "apiDisabled") Core.<*>
                     (o Core..:? "customRolesSupportLevel")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiDisabled" Core..=) Core.<$> apiDisabled,
                  ("customRolesSupportLevel" Core..=) Core.<$>
                    customRolesSupportLevel,
                  ("description" Core..=) Core.<$> description,
                  ("name" Core..=) Core.<$> name,
                  ("onlyInPredefinedRoles" Core..=) Core.<$>
                    onlyInPredefinedRoles,
                  ("primaryPermission" Core..=) Core.<$>
                    primaryPermission,
...
instance Core.FromJSON PermissionDelta where
        parseJSON
          = Core.withObject "PermissionDelta"
              (\ o ->
                 PermissionDelta Core.<$>
                   (o Core..:? "addedPermissions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "removedPermissions" Core..!=
                        Core.mempty))
...
instance Core.FromJSON PolicyDelta where
        parseJSON
          = Core.withObject "PolicyDelta"
              (\ o ->
                 PolicyDelta Core.<$>
                   (o Core..:? "bindingDeltas" Core..!= Core.mempty))
...
instance Core.FromJSON QueryAuditableServicesRequest
         where
        parseJSON
          = Core.withObject "QueryAuditableServicesRequest"
              (\ o ->
                 QueryAuditableServicesRequest Core.<$>
                   (o Core..:? "fullResourceName"))

instance Core.ToJSON QueryAuditableServicesRequest
         where
...
instance Core.FromJSON QueryAuditableServicesResponse
         where
        parseJSON
          = Core.withObject "QueryAuditableServicesResponse"
              (\ o ->
                 QueryAuditableServicesResponse Core.<$>
                   (o Core..:? "services" Core..!= Core.mempty))

instance Core.ToJSON QueryAuditableServicesResponse
         where
...
instance Core.FromJSON QueryGrantableRolesRequest
         where
        parseJSON
          = Core.withObject "QueryGrantableRolesRequest"
              (\ o ->
                 QueryGrantableRolesRequest Core.<$>
...
newQueryGrantableRolesResponse =
  QueryGrantableRolesResponse
    {nextPageToken = Core.Nothing, roles = Core.Nothing}

instance Core.FromJSON QueryGrantableRolesResponse
         where
        parseJSON
          = Core.withObject "QueryGrantableRolesResponse"
              (\ o ->
                 QueryGrantableRolesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "roles" Core..!= Core.mempty))

instance Core.ToJSON QueryGrantableRolesResponse
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "QueryTestablePermissionsRequest"
              (\ o ->
                 QueryTestablePermissionsRequest Core.<$>
                   (o Core..:? "fullResourceName") Core.<*>
                     (o Core..:? "pageSize")
                     Core.<*> (o Core..:? "pageToken"))

instance Core.ToJSON QueryTestablePermissionsRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "QueryTestablePermissionsResponse"
              (\ o ->
                 QueryTestablePermissionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "permissions" Core..!= Core.mempty))

instance Core.ToJSON QueryTestablePermissionsResponse
         where
              ...
              (\ o ->
                 Role Core.<$>
                   (o Core..:? "deleted") Core.<*>
                     ...
                     Core.<*> (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "includedPermissions" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "stage")
                     Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON UndeleteRoleRequest where
        parseJSON
          = Core.withObject "UndeleteRoleRequest"
              (\ o ->
...
instance Core.FromJSON UndeleteServiceAccountRequest
         where
        parseJSON
          = Core.withObject "UndeleteServiceAccountRequest"
              (\ o -> Core.pure UndeleteServiceAccountRequest)

instance Core.ToJSON UndeleteServiceAccountRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON UndeleteServiceAccountResponse
         where
        parseJSON
          = Core.withObject "UndeleteServiceAccountResponse"
              (\ o ->
                 UndeleteServiceAccountResponse Core.<$>
                   (o Core..:? "restoredAccount"))

instance Core.ToJSON UndeleteServiceAccountResponse
         where
        toJSON UndeleteServiceAccountResponse{..}
          = Core.object
              (Core.catMaybes
                 [("restoredAccount" Core..=) Core.<$>
                    restoredAccount])
...
instance Core.FromJSON UploadServiceAccountKeyRequest
         where
        parseJSON
          = Core.withObject "UploadServiceAccountKeyRequest"
              (\ o ->
                 UploadServiceAccountKeyRequest Core.<$>
                   (o Core..:? "publicKeyData"))

instance Core.ToJSON UploadServiceAccountKeyRequest
         where
...
instance Core.FromJSON WorkloadIdentityPool where
        parseJSON
          = Core.withObject "WorkloadIdentityPool"
              (\ o ->
                 WorkloadIdentityPool Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "disabled")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON WorkloadIdentityPoolProvider
         where
        parseJSON
          = Core.withObject "WorkloadIdentityPoolProvider"
              (\ o ->
                 WorkloadIdentityPoolProvider Core.<$>
                   (o Core..:? "attributeCondition") Core.<*>
                     (o Core..:? "attributeMapping")
                     Core.<*> (o Core..:? "aws")
                     Core.<*> (o Core..:? "description")
...
instance Core.ToJSON WorkloadIdentityPoolProvider
         where
        toJSON WorkloadIdentityPoolProvider{..}
          = Core.object
              (Core.catMaybes
                 [("attributeCondition" Core..=) Core.<$>
                    attributeCondition,
                  ("attributeMapping" Core..=) Core.<$>
                    attributeMapping,
                  ("aws" Core..=) Core.<$> aws,
                  ("description" Core..=) Core.<$> description,
                  ("disabled" Core..=) Core.<$> disabled,
...
newWorkloadIdentityPoolProvider_AttributeMapping 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> WorkloadIdentityPoolProvider_AttributeMapping
newWorkloadIdentityPoolProvider_AttributeMapping addtional =
  WorkloadIdentityPoolProvider_AttributeMapping {addtional = addtional}
