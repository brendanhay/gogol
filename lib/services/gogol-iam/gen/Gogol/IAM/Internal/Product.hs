...
instance Core.FromJSON GoogleIamV3OperationMetadata
         where
        parseJSON
...
instance Core.ToJSON GoogleIamV3OperationMetadata
         where
...
instance Core.ToJSON GoogleIamV3betaOperationMetadata
         where
...
instance Core.ToJSON GoogleIamV3mainOperationMetadata
         where
