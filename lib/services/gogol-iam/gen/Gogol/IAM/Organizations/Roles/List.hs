...
-- |
-- Module      : Gogol.IAM.Organizations.Roles.List
                     ...
                     Core.QueryParam "showDeleted" Core.Bool Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" OrganizationsRolesListView
                             Core.:>
...
instance Core.GoogleRequest IAMOrganizationsRolesList
         where
        type Rs IAMOrganizationsRolesList = ListRolesResponse
        type Scopes IAMOrganizationsRolesList =
