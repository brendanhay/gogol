...
instance Core.GoogleRequest IAMPoliciesListPolicies
         where
        type Rs IAMPoliciesListPolicies =
             GoogleIamV2ListPoliciesResponse
        type Scopes IAMPoliciesListPolicies =
        ...
        requestClient IAMPoliciesListPolicies{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy IAMPoliciesListPoliciesResource)
                      Core.mempty
