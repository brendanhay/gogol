...
-- |
-- Module      : Gogol.IAM.Projects.ServiceAccounts.GetIamPolicy
...
instance Core.GoogleRequest
           IAMProjectsServiceAccountsGetIamPolicy
         where
        type Rs IAMProjectsServiceAccountsGetIamPolicy =
             Policy
        type Scopes IAMProjectsServiceAccountsGetIamPolicy =
