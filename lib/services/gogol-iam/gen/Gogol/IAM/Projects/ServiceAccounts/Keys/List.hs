           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParams "keyTypes"
                   ProjectsServiceAccountsKeysListKeyTypes
                   Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListServiceAccountKeysResponse
...
instance Core.GoogleRequest
           IAMProjectsServiceAccountsKeysList
         where
        type Rs IAMProjectsServiceAccountsKeysList =
             ListServiceAccountKeysResponse
        type Scopes IAMProjectsServiceAccountsKeysList =
