...
-- |
-- Module      : Gogol.IAM.Projects.ServiceAccounts.Undelete
                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON]
                       ...
                       Core.:>
                       Core.Post '[Core.JSON] UndeleteServiceAccountResponse
...
instance Core.GoogleRequest
           IAMProjectsServiceAccountsUndelete
         where
        type Rs IAMProjectsServiceAccountsUndelete =
             UndeleteServiceAccountResponse
        type Scopes IAMProjectsServiceAccountsUndelete =
