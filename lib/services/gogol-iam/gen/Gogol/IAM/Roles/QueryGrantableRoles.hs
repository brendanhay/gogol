...
type IAMRolesQueryGrantableRolesResource =
     "v1" Core.:>
       "roles:queryGrantableRoles" Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] QueryGrantableRolesRequest
                       Core.:>
                       Core.Post '[Core.JSON] QueryGrantableRolesResponse
...
instance Core.GoogleRequest
           IAMRolesQueryGrantableRoles
         where
        type Rs IAMRolesQueryGrantableRoles =
             QueryGrantableRolesResponse
        type Scopes IAMRolesQueryGrantableRoles =
