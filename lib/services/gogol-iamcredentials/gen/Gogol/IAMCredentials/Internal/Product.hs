...
newServiceAccountAllowedLocations =
  ServiceAccountAllowedLocations
    {encodedLocations = Core.Nothing, locations = Core.Nothing}

instance Core.FromJSON ServiceAccountAllowedLocations
         where
        parseJSON
          = Core.withObject "ServiceAccountAllowedLocations"
              (\ o ->
                 ServiceAccountAllowedLocations Core.<$>
                   (o Core..:? "encodedLocations") Core.<*>
                     (o Core..:? "locations"))

instance Core.ToJSON ServiceAccountAllowedLocations
         where
        toJSON ServiceAccountAllowedLocations{..}
          = Core.object
              (Core.catMaybes
                 [("encodedLocations" Core..=) Core.<$>
                    encodedLocations,
