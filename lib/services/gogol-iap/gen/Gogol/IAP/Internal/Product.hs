...
newOAuthSettings 
    ::  OAuthSettings
newOAuthSettings =
  OAuthSettings {loginHint = Core.Nothing, programmaticClients = Core.Nothing}
...
newTagsFullState_Tags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> TagsFullState_Tags
newTagsFullState_Tags additional = TagsFullState_Tags {additional = additional}

instance Core.FromJSON TagsFullState_Tags where
        parseJSON
          = Core.withObject "TagsFullState_Tags"
              (\ o ->
                 TagsFullState_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TagsFullState_Tags where
        toJSON TagsFullState_Tags{..}
          = Core.toJSON additional
...
instance Core.FromJSON TagsFullStateForChildResource
         where
        parseJSON
...
instance Core.ToJSON TagsFullStateForChildResource
         where
...
newTagsPartialState 
    ::  TagsPartialState
newTagsPartialState =
  TagsPartialState {tagKeysToRemove = Core.Nothing, tagsToUpsert = Core.Nothing}
...
instance Core.FromJSON TagsPartialState_TagsToUpsert
         where
        parseJSON
          = Core.withObject "TagsPartialState_TagsToUpsert"
              (\ o ->
                 TagsPartialState_TagsToUpsert Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON TagsPartialState_TagsToUpsert
         where
        toJSON TagsPartialState_TagsToUpsert{..}
          = Core.toJSON additional
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ValidateIapAttributeExpressionResponse"
              (\ o ->
                 Core.pure ValidateIapAttributeExpressionResponse)
...
newWorkforceIdentitySettings =
  WorkforceIdentitySettings
    {oauth2 = Core.Nothing, workforcePools = Core.Nothing}

instance Core.FromJSON WorkforceIdentitySettings
         where
        parseJSON
