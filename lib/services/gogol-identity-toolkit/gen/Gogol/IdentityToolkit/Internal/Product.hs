          ...
          = Core.withObject "CreateAuthUriResponse"
              (\ o ->
                 CreateAuthUriResponse Core.<$>
                   (o Core..:? "allProviders" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "authUri")
                     ...
                     Core.<*>
                     (o Core..:? "signinMethods" Core..!= Core.mempty))
...
instance Core.FromJSON EmailTemplate where
        parseJSON
          = Core.withObject "EmailTemplate"
              (\ o ->
                 EmailTemplate Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "format")
                     Core.<*> (o Core..:? "from")
...
newGetAccountInfoResponse =
  GetAccountInfoResponse
    {kind = "identitytoolkit#GetAccountInfoResponse", users = Core.Nothing}
...
instance Core.FromJSON GetOobConfirmationCodeResponse
         where
        parseJSON
...
instance Core.ToJSON GetOobConfirmationCodeResponse
         where
...
instance Core.FromJSON GetRecaptchaParamResponse
         where
        parseJSON
...
instance Core.ToJSON GetRecaptchaParamResponse where
        toJSON GetRecaptchaParamResponse{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("recaptchaSiteKey" Core..=) Core.<$>
                    recaptchaSiteKey,
                  ("recaptchaStoken" Core..=) Core.<$>
                    recaptchaStoken])
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("delegatedProjectNumber" Core..=) Core..
                    Core.AsText
...
newIdentitytoolkitRelyingpartyEmailLinkSigninRequest =
  IdentitytoolkitRelyingpartyEmailLinkSigninRequest
    {email = Core.Nothing, idToken = Core.Nothing, oobCode = Core.Nothing}
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 IdentitytoolkitRelyingpartyEmailLinkSigninRequest
                   Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "idToken")
                     Core.<*> (o Core..:? "oobCode"))
          ...
          = Core.withObject
              ...
              (\ o ->
                 IdentitytoolkitRelyingpartyGetAccountInfoRequest
                   Core.<$>
                   (o Core..:? "delegatedProjectNumber") Core.<*>
                     (o Core..:? "email" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*> (o Core..:? "localId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "phoneNumber" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 IdentitytoolkitRelyingpartyGetProjectConfigResponse
                   Core.<$>
                   (o Core..:? "allowPasswordUser") Core.<*>
                     (o Core..:? "apiKey")
                     Core.<*>
                     (o Core..:? "authorizedDomains" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "changeEmailTemplate")
                     Core.<*> (o Core..:? "dynamicLinksDomain")
                     Core.<*> (o Core..:? "enableAnonymousUser")
                     Core.<*>
                     (o Core..:? "idpConfig" Core..!= Core.mempty)
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("allowPasswordUser" Core..=) Core.<$>
                    allowPasswordUser,
                  ("apiKey" Core..=) Core.<$> apiKey,
                  ("authorizedDomains" Core..=) Core.<$>
                    authorizedDomains,
                  ("changeEmailTemplate" Core..=) Core.<$>
                    changeEmailTemplate,
                  ("dynamicLinksDomain" Core..=) Core.<$>
                    dynamicLinksDomain,
                  ("enableAnonymousUser" Core..=) Core.<$>
                    enableAnonymousUser,
                  ("idpConfig" Core..=) Core.<$> idpConfig,
                  ("legacyResetPasswordTemplate" Core..=) Core.<$>
                    legacyResetPasswordTemplate,
                  ("projectId" Core..=) Core.<$> projectId,
                  ("resetPasswordTemplate" Core..=) Core.<$>
                    resetPasswordTemplate,
                  ("useEmailSending" Core..=) Core.<$> useEmailSending,
                  ("verifyEmailTemplate" Core..=) Core.<$>
                    verifyEmailTemplate])
              ...
              (\ o ->
                 IdentitytoolkitRelyingpartySetAccountInfoRequest
                   ...
                   (o Core..:? "captchaChallenge") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "deleteAttribute" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "deleteProvider" Core..!= Core.mempty)
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("captchaChallenge" Core..=) Core.<$>
                    captchaChallenge,
                  ("captchaResponse" Core..=) Core.<$> captchaResponse,
                  ("createdAt" Core..=) Core.. Core.AsText Core.<$>
                    createdAt,
                  ...
                  ("lastLoginAt" Core..=) Core.. Core.AsText Core.<$>
                    lastLoginAt,
                  ("localId" Core..=) Core.<$> localId,
                  ("oobCode" Core..=) Core.<$> oobCode,
                  ...
                  ("returnSecureToken" Core..=) Core.<$>
                    returnSecureToken,
                  ("upgradeToFederatedLogin" Core..=) Core.<$>
                    upgradeToFederatedLogin,
                  ("validSince" Core..=) Core.. Core.AsText Core.<$>
                    validSince])
...
newIdentitytoolkitRelyingpartySignOutUserRequest =
  IdentitytoolkitRelyingpartySignOutUserRequest
    {instanceId = Core.Nothing, localId = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("autoCreate" Core..=) Core.<$> autoCreate,
                  ...
                  ("returnIdpCredential" Core..=) Core.<$>
                    returnIdpCredential,
                  ("returnRefreshToken" Core..=) Core.<$>
                    returnRefreshToken,
                  ("returnSecureToken" Core..=) Core.<$>
                    returnSecureToken,
                  ("sessionId" Core..=) Core.<$> sessionId,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest
                   Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "idToken")
          ...
          = Core.object
              (Core.catMaybes
                 [("expiresIn" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("refreshToken" Core..=) Core.<$> refreshToken,
                  ("temporaryProof" Core..=) Core.<$> temporaryProof,
                  ("temporaryProofExpiresIn" Core..=) Core..
                    Core.AsText
                    Core.<$> temporaryProofExpiresIn,
                  ("verificationProof" Core..=) Core.<$>
                    verificationProof,
                  ("verificationProofExpiresIn" Core..=) Core..
                    Core.AsText
              ...
              (\ o ->
                 IdpConfig Core.<$>
                   (o Core..:? "clientId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "secret")
                     Core.<*>
                     (o Core..:? "whitelistedAudiences" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("clientId" Core..=) Core.<$> clientId,
                  ...
                  ("experimentPercent" Core..=) Core.<$>
                    experimentPercent,
                  ("provider" Core..=) Core.<$> provider,
                  ("secret" Core..=) Core.<$> secret,
                  ("whitelistedAudiences" Core..=) Core.<$>
...
instance Core.ToJSON Relyingparty where
        toJSON Relyingparty{..}
          = Core.object
              (Core.catMaybes
                 [("androidInstallApp" Core..=) Core.<$>
                    androidInstallApp,
                  ("androidMinimumVersion" Core..=) Core.<$>
                    androidMinimumVersion,
                  ("androidPackageName" Core..=) Core.<$>
                    androidPackageName,
                  ("canHandleCodeInApp" Core..=) Core.<$>
                    canHandleCodeInApp,
              ...
              (\ o ->
                 SetAccountInfoResponse Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     ...
                     Core.<*> (o Core..:? "photoUrl")
                     Core.<*>
                     (o Core..:? "providerUserInfo" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "refreshToken"))
...
newUploadAccountResponse =
  UploadAccountResponse
    {error = Core.Nothing, kind = "identitytoolkit#UploadAccountResponse"}
          ...
          = Core.withObject "UploadAccountResponse"
              (\ o ->
                 UploadAccountResponse Core.<$>
                   (o Core..:? "error" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON UploadAccountResponse_ErrorItem
         where
...
instance Core.FromJSON UserInfo_ProviderUserInfoItem
         where
        parseJSON
...
instance Core.ToJSON UserInfo_ProviderUserInfoItem
         where
              ...
              (\ o ->
                 VerifyAssertionResponse Core.<$>
                   (o Core..:? "action") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "verifiedProvider" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ...
                  ("localId" Core..=) Core.<$> localId,
                  ("needConfirmation" Core..=) Core.<$>
                    needConfirmation,
                  ("needEmail" Core..=) Core.<$> needEmail,
                  ("nickName" Core..=) Core.<$> nickName,
                  ("oauthAccessToken" Core..=) Core.<$>
                    oauthAccessToken,
                  ("oauthAuthorizationCode" Core..=) Core.<$>
                    oauthAuthorizationCode,
                  ("oauthExpireIn" Core..=) Core.<$> oauthExpireIn,
                  ("oauthIdToken" Core..=) Core.<$> oauthIdToken,
                  ("oauthRequestToken" Core..=) Core.<$>
                    oauthRequestToken,
                  ("oauthScope" Core..=) Core.<$> oauthScope,
                  ("oauthTokenSecret" Core..=) Core.<$>
                    oauthTokenSecret,
...
instance Core.FromJSON VerifyCustomTokenResponse
         where
        parseJSON
