...
instance Core.FromJSON PublishUrlNotificationResponse
         where
        parseJSON
...
instance Core.ToJSON PublishUrlNotificationResponse
         where
...
newUrlNotification =
  UrlNotification
    {notifyTime = Core.Nothing, type' = Core.Nothing, url = Core.Nothing}
