          ...
          = Core.withObject "ApplicationInfo"
              (\ o ->
                 ApplicationInfo Core.<$>
                   (o Core..:? "emails" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "instruction")
          ...
          = Core.withObject "BatchCreateJobsResponse"
              (\ o ->
                 BatchCreateJobsResponse Core.<$>
                   (o Core..:? "jobResults" Core..!= Core.mempty))
          ...
          = Core.withObject "CompleteQueryResponse"
              (\ o ->
                 CompleteQueryResponse Core.<$>
                   (o Core..:? "completionResults" Core..!= Core.mempty)
              ...
              (\ o ->
                 CustomAttribute Core.<$>
                   (o Core..:? "filterable") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "longValues" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "stringValues" Core..!= Core.mempty))
              ...
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "addresses" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "degreeTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "department")
                     Core.<*> (o Core..:? "derivedInfo")
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "employmentTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "incentives")
                     Core.<*>
                     (o Core..:? "jobBenefits" Core..!= Core.mempty)
...
instance Core.FromJSON JobDerivedInfo where
        parseJSON
          = Core.withObject "JobDerivedInfo"
              (\ o ->
                 JobDerivedInfo Core.<$>
                   (o Core..:? "jobCategories" Core..!= Core.mempty)
                     Core.<*>
              ...
              (\ o ->
                 JobQuery Core.<$>
                   (o Core..:? "commuteFilter") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "companyDisplayNames" Core..!=
                        Core.mempty)
                     ...
                     (o Core..:? "employmentTypes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "excludedJobs" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "jobCategories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "languageCodes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "locationFilters" Core..!= Core.mempty)
              ...
              (\ o ->
                 NamespacedDebugInput Core.<$>
                   (o Core..:? "absolutelyForcedExpNames" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "absolutelyForcedExpTags" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "absolutelyForcedExps" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "conditionallyForcedExpNames" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "conditionallyForcedExpTags" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "conditionallyForcedExps" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "disableAutomaticEnrollmentSelection")
                     Core.<*>
                     (o Core..:? "disableExpNames" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "disableExpTags" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "disableExps" Core..!= Core.mempty)
                     Core.<*>
              ...
              (\ o ->
                 SearchJobsRequest Core.<$>
                   (o Core..:? "customRankingInfo") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "histogramQueries" Core..!= Core.mempty)
              ...
              (\ o ->
                 SearchJobsResponse Core.<$>
                   (o Core..:? "broadenedQueryJobsCount") Core.<*>
                     (o Core..:? "histogramQueryResults" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "locationFilters" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "matchingJobs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "nextPageToken")
