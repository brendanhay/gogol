...
type LanguageDocumentsModerateTextResource =
  "v2"
    ...
    Core.:> Core.ReqBody '[Core.JSON] ModerateTextRequest
    Core.:> Core.Post '[Core.JSON] ModerateTextResponse
...
instance Core.GoogleRequest LanguageDocumentsModerateText where
  ...
  type
    Scopes LanguageDocumentsModerateText =
