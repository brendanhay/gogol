...
instance Core.FromJSON AnnotateTextRequestFeatures
         where
        parseJSON
...
instance Core.ToJSON AnnotateTextRequestFeatures
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("categories" Core..=) Core.<$> categories,
                  ...
                  ("languageSupported" Core..=) Core.<$>
                    languageSupported,
                  ("moderationCategories" Core..=) Core.<$>
...
newClassificationCategory =
  ClassificationCategory
    {confidence = Core.Nothing, name = Core.Nothing, severity = Core.Nothing}
...
instance Core.ToJSON CpuMetric where
        toJSON CpuMetric{..}
          = Core.object
              (Core.catMaybes
                 [("coreNumber" Core..=) Core.. Core.AsText Core.<$>
                    coreNumber,
                  ("coreSec" Core..=) Core.. Core.AsText Core.<$>
                    coreSec,
...
newDiskMetric 
    ::  DiskMetric
newDiskMetric = DiskMetric {diskType = Core.Nothing, gibSec = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("diskType" Core..=) Core.<$> diskType,
                  ("gibSec" Core..=) Core.. Core.AsText Core.<$>
                    gibSec])
...
instance Core.ToJSON GpuMetric where
        toJSON GpuMetric{..}
          = Core.object
              (Core.catMaybes
                 [("gpuSec" Core..=) Core.. Core.AsText Core.<$>
                    gpuSec,
...
instance Core.FromJSON GpuMetric_TrackingLabels where
        parseJSON
          = Core.withObject "GpuMetric_TrackingLabels"
              (\ o ->
                 GpuMetric_TrackingLabels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GpuMetric_TrackingLabels where
        toJSON GpuMetric_TrackingLabels{..}
          = Core.toJSON additional
...
newModerateTextRequest 
    ::  ModerateTextRequest
newModerateTextRequest =
  ModerateTextRequest {document = Core.Nothing, modelVersion = Core.Nothing}
...
instance Core.FromJSON RamMetric_TrackingLabels where
        parseJSON
          = Core.withObject "RamMetric_TrackingLabels"
              (\ o ->
                 RamMetric_TrackingLabels Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON RamMetric_TrackingLabels where
        toJSON RamMetric_TrackingLabels{..}
          = Core.toJSON additional
...
newTpuMetric 
    ::  TpuMetric
newTpuMetric = TpuMetric {tpuSec = Core.Nothing, tpuType = Core.Nothing}
...
instance Core.ToJSON TpuMetric where
        toJSON TpuMetric{..}
          = Core.object
              (Core.catMaybes
                 [("tpuSec" Core..=) Core.. Core.AsText Core.<$>
                    tpuSec,
...
newXPSArrayStats 
    ::  XPSArrayStats
newXPSArrayStats =
  XPSArrayStats {commonStats = Core.Nothing, memberStats = Core.Nothing}
...
newXPSBatchPredictResponse 
    ::  XPSBatchPredictResponse
newXPSBatchPredictResponse = XPSBatchPredictResponse {exampleSet = Core.Nothing}

instance Core.FromJSON XPSBatchPredictResponse where
        parseJSON
          = Core.withObject "XPSBatchPredictResponse"
              (\ o ->
                 XPSBatchPredictResponse Core.<$>
                   (o Core..:? "exampleSet"))
...
instance Core.ToJSON XPSBatchPredictResponse where
        toJSON XPSBatchPredictResponse{..}
          = Core.object
              (Core.catMaybes
                 [("exampleSet" Core..=) Core.<$> exampleSet])
...
instance Core.FromJSON XPSBoundingBoxMetricsEntry
         where
        parseJSON
...
newXPSCategoryStats 
    ::  XPSCategoryStats
newXPSCategoryStats =
  XPSCategoryStats {commonStats = Core.Nothing, topCategoryStats = Core.Nothing}
...
newXPSCategoryStatsSingleCategoryStats =
  XPSCategoryStatsSingleCategoryStats
    {count = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 XPSClassificationEvaluationMetrics Core.<$>
                   (o Core..:? "auPrc") Core.<*> (o Core..:? "auRoc")
          ...
          = Core.object
              (Core.catMaybes
                 [("auPrc" Core..=) Core.<$> auPrc,
                  ...
                  ("evaluatedExamplesCount" Core..=) Core.<$>
...
instance Core.ToJSON XPSColorMap where
        toJSON XPSColorMap{..}
          = Core.object
              (Core.catMaybes
                 [("annotationSpecIdToken" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("columnId" Core..=) Core.<$> columnId,
                  ...
                  ("displayName" Core..=) Core.<$> displayName,
                  ("forecastingMetadata" Core..=) Core.<$>
                    forecastingMetadata,
                  ("topCorrelatedColumns" Core..=) Core.<$>
...
newXPSColumnSpecCorrelatedColumn =
  XPSColumnSpecCorrelatedColumn
    {columnId = Core.Nothing, correlationStats = Core.Nothing}

instance Core.FromJSON XPSColumnSpecCorrelatedColumn
         where
        parseJSON
          = Core.withObject "XPSColumnSpecCorrelatedColumn"
              (\ o ->
                 XPSColumnSpecCorrelatedColumn Core.<$>
                   (o Core..:? "columnId") Core.<*>
                     (o Core..:? "correlationStats"))

instance Core.ToJSON XPSColumnSpecCorrelatedColumn
         where
        toJSON XPSColumnSpecCorrelatedColumn{..}
          = Core.object
              (Core.catMaybes
                 [("columnId" Core..=) Core.<$> columnId,
                  ("correlationStats" Core..=) Core.<$>
                    correlationStats])
...
instance Core.ToJSON XPSColumnSpecForecastingMetadata
         where
              ...
              (\ o ->
                 XPSCommonStats Core.<$>
                   (o Core..:? "distinctValueCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "nullValueCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "validValueCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON XPSCommonStats where
        toJSON XPSCommonStats{..}
          = Core.object
              (Core.catMaybes
                 [("distinctValueCount" Core..=) Core.. Core.AsText
                    Core.<$> distinctValueCount,
                  ("nullValueCount" Core..=) Core.. Core.AsText
                    Core.<$> nullValueCount,
                  ("validValueCount" Core..=) Core.. Core.AsText
...
instance Core.FromJSON XPSConfidenceMetricsEntry
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("confidenceThreshold" Core..=) Core.<$>
                  ...
                  ("falseNegativeCount" Core..=) Core.. Core.AsText
                    Core.<$> falseNegativeCount,
                  ("falsePositiveCount" Core..=) Core.. Core.AsText
                    Core.<$> falsePositiveCount,
                  ("falsePositiveRate" Core..=) Core.<$>
                    falsePositiveRate,
                  ("falsePositiveRateAt1" Core..=) Core.<$>
                    falsePositiveRateAt1,
                  ("positionThreshold" Core..=) Core.<$>
                    positionThreshold,
                  ("precision" Core..=) Core.<$> precision,
                  ("precisionAt1" Core..=) Core.<$> precisionAt1,
                  ("recall" Core..=) Core.<$> recall,
                  ("recallAt1" Core..=) Core.<$> recallAt1,
                  ("trueNegativeCount" Core..=) Core.. Core.AsText
                    Core.<$> trueNegativeCount,
                  ("truePositiveCount" Core..=) Core.. Core.AsText
...
newXPSConfusionMatrixRow 
    ::  XPSConfusionMatrixRow
newXPSConfusionMatrixRow =
  XPSConfusionMatrixRow {count = Core.Nothing, exampleCount = Core.Nothing}
...
instance Core.ToJSON XPSConfusionMatrixRow where
        toJSON XPSConfusionMatrixRow{..}
          = Core.object
              (Core.catMaybes
                 [("count" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> count,
...
instance Core.FromJSON XPSDataStats where
        parseJSON
          = Core.withObject "XPSDataStats"
              (\ o ->
                 XPSDataStats Core.<$>
                   (o Core..:? "arrayStats") Core.<*>
                     (o Core..:? "categoryStats")
                     Core.<*>
                     (o Core..:? "distinctValueCount" Core.<&>
                        Core.fmap Core.fromAsText)
...
newXPSDockerFormat =
  XPSDockerFormat
    {cpuArchitecture = Core.Nothing, gpuArchitecture = Core.Nothing}
...
instance Core.ToJSON XPSDockerFormat where
        toJSON XPSDockerFormat{..}
          = Core.object
              (Core.catMaybes
                 [("cpuArchitecture" Core..=) Core.<$>
                    cpuArchitecture,
                  ("gpuArchitecture" Core..=) Core.<$>
                    gpuArchitecture])
              ...
              (\ o ->
                 XPSEvaluationMetrics Core.<$>
                   (o Core..:? "annotationSpecIdToken") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "imageClassificationEvalMetrics")
                     Core.<*>
                     (o Core..:? "imageObjectDetectionEvalMetrics")
                     Core.<*> (o Core..:? "imageSegmentationEvalMetrics")
                     Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "regressionEvalMetrics")
                     Core.<*>
                     (o Core..:? "tablesClassificationEvalMetrics")
                     ...
                     Core.<*>
                     (o Core..:? "videoActionRecognitionEvalMetrics")
                     Core.<*>
                     (o Core..:? "videoClassificationEvalMetrics")
                     Core.<*>
                     (o Core..:? "videoObjectTrackingEvalMetrics"))
          ...
          = Core.object
              (Core.catMaybes
                 [("annotationSpecIdToken" Core..=) Core.<$>
                    annotationSpecIdToken,
                  ("category" Core..=) Core.<$> category,
                  ("evaluatedExampleCount" Core..=) Core.<$>
                  ...
                  ("translationEvalMetrics" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("evaluationMetrics" Core..=) Core.<$>
                  ...
                  ("numEvaluationMetrics" Core..=) Core.. Core.AsText
                 ...
                 XPSExampleSet Core.<$>
                   (o Core..:? "fileSpec") Core.<*>
                     (o Core..:? "fingerprint" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numExamples" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numInputSources" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON XPSExampleSet where
        toJSON XPSExampleSet{..}
          = Core.object
              (Core.catMaybes
                 [("fileSpec" Core..=) Core.<$> fileSpec,
                  ("fingerprint" Core..=) Core.. Core.AsText Core.<$>
                    fingerprint,
                  ("numExamples" Core..=) Core.. Core.AsText Core.<$>
                    numExamples,
                  ("numInputSources" Core..=) Core.. Core.AsText
...
instance Core.FromJSON XPSExportModelOutputConfig
         where
        parseJSON
          = Core.withObject "XPSExportModelOutputConfig"
              (\ o ->
                 XPSExportModelOutputConfig Core.<$>
                   (o Core..:? "coreMlFormat") Core.<*>
                     (o Core..:? "dockerFormat")
...
instance Core.ToJSON XPSFloat64Stats where
        toJSON XPSFloat64Stats{..}
          = Core.object
              (Core.catMaybes
                 [("commonStats" Core..=) Core.<$> commonStats,
                  ("histogramBuckets" Core..=) Core.<$>
                    histogramBuckets,
                  ("mean" Core..=) Core.<$> mean,
                  ("quantiles" Core..=) Core.<$> quantiles,
                  ("standardDeviation" Core..=) Core.<$>
                    standardDeviation])
...
newXPSFloat64StatsHistogramBucket =
  XPSFloat64StatsHistogramBucket
    {count = Core.Nothing, max = Core.Nothing, min = Core.Nothing}

instance Core.FromJSON XPSFloat64StatsHistogramBucket
         where
        parseJSON
...
instance Core.ToJSON XPSFloat64StatsHistogramBucket
         where
...
instance Core.ToJSON
        ...
        toJSON XPSImageClassificationTrainResponse{..}
          = Core.object
              (Core.catMaybes
                 [("classCount" Core..=) Core.. Core.AsText Core.<$>
                    classCount,
                  ("exportModelSpec" Core..=) Core.<$> exportModelSpec,
                  ("modelArtifactSpec" Core..=) Core.<$>
                    modelArtifactSpec,
                  ("modelServingSpec" Core..=) Core.<$>
                    modelServingSpec,
                  ("stopReason" Core..=) Core.<$> stopReason,
                  ("trainCostInNodeTime" Core..=) Core.<$>
                    trainCostInNodeTime,
                  ("trainCostNodeSeconds" Core..=) Core.. Core.AsText
...
instance Core.FromJSON XPSImageModelArtifactSpec
         where
        parseJSON
...
newXPSImageModelServingSpec =
  XPSImageModelServingSpec
    { modelThroughputEstimation = Core.Nothing
...
newXPSImageModelServingSpecModelThroughputEstimation =
  XPSImageModelServingSpecModelThroughputEstimation
    { computeEngineAcceleratorType = Core.Nothing
          ...
          = Core.object
              (Core.catMaybes
                 [("computeEngineAcceleratorType" Core..=) Core.<$>
                  ...
                  ("latencyInMilliseconds" Core..=) Core.<$>
...
newXPSImageObjectDetectionEvaluationMetrics =
  XPSImageObjectDetectionEvaluationMetrics
    { boundingBoxMeanAveragePrecision = Core.Nothing
          ...
          = Core.withObject
              ...
              (\ o ->
                 XPSImageObjectDetectionEvaluationMetrics Core.<$>
                   (o Core..:? "boundingBoxMeanAveragePrecision")
...
instance Core.ToJSON XPSImageObjectDetectionModelSpec
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("classCount" Core..=) Core.. Core.AsText Core.<$>
                    classCount,
                  ("exportModelSpec" Core..=) Core.<$> exportModelSpec,
                  ("maxBoundingBoxCount" Core..=) Core.. Core.AsText
          ...
          = Core.object
              (Core.catMaybes
                 [("confidenceThreshold" Core..=) Core.<$>
                    confidenceThreshold,
                  ("confusionMatrix" Core..=) Core.<$> confusionMatrix,
                  ("diceScoreCoefficient" Core..=) Core.<$>
          ...
          = Core.withObject "XPSImageSegmentationTrainResponse"
              (\ o ->
                 XPSImageSegmentationTrainResponse Core.<$>
                   (o Core..:? "colorMaps") Core.<*>
                     (o Core..:? "exportModelSpec")
                     Core.<*> (o Core..:? "modelArtifactSpec")
                     Core.<*> (o Core..:? "modelServingSpec")
                     Core.<*> (o Core..:? "stopReason")
                     Core.<*>
...
newXPSMetricEntryLabel 
    ::  XPSMetricEntryLabel
newXPSMetricEntryLabel =
  XPSMetricEntryLabel {labelName = Core.Nothing, labelValue = Core.Nothing}
...
newXPSModelArtifactItem 
    ::  XPSModelArtifactItem
newXPSModelArtifactItem =
  XPSModelArtifactItem {artifactFormat = Core.Nothing, gcsUri = Core.Nothing}
...
instance Core.ToJSON XPSPreprocessResponse where
        toJSON XPSPreprocessResponse{..}
          = Core.object
              (Core.catMaybes
                 [("outputExampleSet" Core..=) Core.<$>
                    outputExampleSet,
                  ("speechPreprocessResp" Core..=) Core.<$>
...
instance Core.FromJSON XPSRegressionEvaluationMetrics
         where
        parseJSON
...
instance Core.ToJSON XPSRegressionEvaluationMetrics
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("meanAbsoluteError" Core..=) Core.<$>
                  ...
                  ("rootMeanSquaredError" Core..=) Core.<$>
...
newXPSRegressionMetricsEntry =
  XPSRegressionMetricsEntry
    {predictedValue = Core.Nothing, trueValue = Core.Nothing}

instance Core.FromJSON XPSRegressionMetricsEntry
         where
        parseJSON
          = Core.withObject "XPSRegressionMetricsEntry"
              (\ o ->
                 XPSRegressionMetricsEntry Core.<$>
                   (o Core..:? "predictedValue") Core.<*>
                     (o Core..:? "trueValue"))
...
newXPSReportingMetrics =
  XPSReportingMetrics
    {effectiveTrainingDuration = Core.Nothing, metricEntries = Core.Nothing}
...
newXPSResponseExplanationMetadata 
    ::  XPSResponseExplanationMetadata
newXPSResponseExplanationMetadata =
  XPSResponseExplanationMetadata {inputs = Core.Nothing, outputs = Core.Nothing}

instance Core.FromJSON XPSResponseExplanationMetadata
         where
        parseJSON
...
instance Core.ToJSON XPSResponseExplanationMetadata
         where
...
newXPSResponseExplanationMetadata_Inputs 
    ::  Core.HashMap Core.Text XPSResponseExplanationMetadataInputMetadata
       -- ^  See 'additional'.
    -> XPSResponseExplanationMetadata_Inputs
...
newXPSResponseExplanationMetadata_Outputs 
    ::  Core.HashMap Core.Text XPSResponseExplanationMetadataOutputMetadata
       -- ^  See 'additional'.
    -> XPSResponseExplanationMetadata_Outputs
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("inputTensorName" Core..=) Core.<$>
                    inputTensorName,
                  ("modality" Core..=) Core.<$> modality,
                  ("visualizationConfig" Core..=) Core.<$>
                    visualizationConfig])
...
newXPSResponseExplanationMetadataOutputMetadata 
    ::  XPSResponseExplanationMetadataOutputMetadata
newXPSResponseExplanationMetadataOutputMetadata =
  XPSResponseExplanationMetadataOutputMetadata {outputTensorName = Core.Nothing}
...
instance Core.ToJSON XPSResponseExplanationParameters
         where
...
instance Core.FromJSON XPSResponseExplanationSpec
         where
        parseJSON
          = Core.withObject "XPSResponseExplanationSpec"
              (\ o ->
                 XPSResponseExplanationSpec Core.<$>
                   (o Core..:? "explanationType") Core.<*>
                     (o Core..:? "metadata")
...
newXPSSpeechEvaluationMetrics 
    ::  XPSSpeechEvaluationMetrics
newXPSSpeechEvaluationMetrics =
  XPSSpeechEvaluationMetrics {subModelEvaluationMetrics = Core.Nothing}

instance Core.FromJSON XPSSpeechEvaluationMetrics
         where
        parseJSON
...
instance Core.FromJSON XPSSpeechModelSpecSubModelSpec
         where
        parseJSON
...
instance Core.ToJSON XPSSpeechModelSpecSubModelSpec
         where
...
instance Core.FromJSON XPSSpeechPreprocessResponse
         where
        parseJSON
              ...
              (\ o ->
                 XPSSpeechPreprocessResponse Core.<$>
                   (o Core..:? "cnsTestDataPath") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "prebuiltModelEvaluationMetrics")
                     Core.<*> (o Core..:? "speechPreprocessStats"))

instance Core.ToJSON XPSSpeechPreprocessResponse
         where
        toJSON XPSSpeechPreprocessResponse{..}
          = Core.object
              (Core.catMaybes
                 [("cnsTestDataPath" Core..=) Core.<$>
                    cnsTestDataPath,
                  ("cnsTrainDataPath" Core..=) Core.<$>
                    cnsTrainDataPath,
                  ("prebuiltModelEvaluationMetrics" Core..=) Core.<$>
                    prebuiltModelEvaluationMetrics,
                  ("speechPreprocessStats" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("dataErrors" Core..=) Core.<$> dataErrors,
                  ...
                  ("testExamplesCount" Core..=) Core.<$>
                    testExamplesCount,
                  ("testSentencesCount" Core..=) Core.<$>
                    testSentencesCount,
                  ("testWordsCount" Core..=) Core.<$> testWordsCount,
                  ("trainExamplesCount" Core..=) Core.<$>
                    trainExamplesCount,
                  ("trainSentencesCount" Core..=) Core.<$>
                    trainSentencesCount,
                  ("trainWordsCount" Core..=) Core.<$>
                    trainWordsCount])
...
newXPSStringStats 
    ::  XPSStringStats
newXPSStringStats =
  XPSStringStats {commonStats = Core.Nothing, topUnigramStats = Core.Nothing}
...
newXPSStringStatsUnigramStats 
    ::  XPSStringStatsUnigramStats
newXPSStringStatsUnigramStats =
  XPSStringStatsUnigramStats {count = Core.Nothing, value = Core.Nothing}

instance Core.FromJSON XPSStringStatsUnigramStats
         where
        parseJSON
...
newXPSStructStats 
    ::  XPSStructStats
newXPSStructStats =
  XPSStructStats {commonStats = Core.Nothing, fieldStats = Core.Nothing}
...
instance Core.FromJSON XPSStructStats_FieldStats
         where
        parseJSON
          = Core.withObject "XPSStructStats_FieldStats"
              (\ o ->
                 XPSStructStats_FieldStats Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON XPSStructStats_FieldStats where
        toJSON XPSStructStats_FieldStats{..}
          = Core.toJSON additional
...
instance Core.FromJSON XPSStructType_Fields where
        parseJSON
          = Core.withObject "XPSStructType_Fields"
              (\ o ->
                 XPSStructType_Fields Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON XPSStructType_Fields where
        toJSON XPSStructType_Fields{..}
          = Core.toJSON additional
          ...
          = Core.object
              (Core.catMaybes
                 [("columnSpecs" Core..=) Core.<$> columnSpecs,
                  ("importedDataSizeInBytes" Core..=) Core..
                    Core.AsText
...
instance Core.FromJSON XPSTableSpec_ColumnSpecs where
        parseJSON
          = Core.withObject "XPSTableSpec_ColumnSpecs"
              (\ o ->
                 XPSTableSpec_ColumnSpecs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON XPSTableSpec_ColumnSpecs where
        toJSON XPSTableSpec_ColumnSpecs{..}
          = Core.toJSON additional
...
instance Core.FromJSON XPSTablesClassificationMetrics
         where
        parseJSON
...
instance Core.ToJSON XPSTablesClassificationMetrics
         where
        toJSON XPSTablesClassificationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("curveMetrics" Core..=) Core.<$> curveMetrics])
          ...
          = Core.withObject
              ...
              (\ o ->
                 XPSTablesClassificationMetricsCurveMetrics Core.<$>
                   (o Core..:? "aucPr") Core.<*> (o Core..:? "aucRoc")
                     Core.<*> (o Core..:? "confidenceMetricsEntries")
                     Core.<*> (o Core..:? "logLoss")
                     Core.<*> (o Core..:? "positionThreshold")
                     Core.<*> (o Core..:? "value"))
...
instance Core.ToJSON XPSTablesConfidenceMetricsEntry
         where
...
newXPSTablesDatasetMetadata_TargetColumnCorrelations additional =
  XPSTablesDatasetMetadata_TargetColumnCorrelations {additional = additional}
...
newXPSTablesEvaluationMetrics =
  XPSTablesEvaluationMetrics
    {classificationMetrics = Core.Nothing, regressionMetrics = Core.Nothing}

instance Core.FromJSON XPSTablesEvaluationMetrics
         where
        parseJSON
...
instance Core.ToJSON XPSTablesEvaluationMetrics where
        toJSON XPSTablesEvaluationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("classificationMetrics" Core..=) Core.<$>
...
newXPSTablesModelColumnInfo =
  XPSTablesModelColumnInfo
    {columnId = Core.Nothing, featureImportance = Core.Nothing}
...
newXPSTablesModelStructureModelParameters 
    ::  XPSTablesModelStructureModelParameters
newXPSTablesModelStructureModelParameters =
  XPSTablesModelStructureModelParameters {hyperparameters = Core.Nothing}
...
instance Core.FromJSON XPSTablesPreprocessResponse
         where
        parseJSON
...
instance Core.ToJSON XPSTablesPreprocessResponse
         where
        toJSON XPSTablesPreprocessResponse{..}
          = Core.object
              (Core.catMaybes
                 [("tablesDatasetMetadata" Core..=) Core.<$>
...
instance Core.FromJSON XPSTablesRegressionMetrics
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("modelStructure" Core..=) Core.<$> modelStructure,
                  ("predictionSampleRows" Core..=) Core.<$>
                    predictionSampleRows,
                  ("tablesModelColumnInfo" Core..=) Core.<$>
                    tablesModelColumnInfo,
                  ("trainCostMilliNodeHours" Core..=) Core..
                    Core.AsText
...
instance Core.ToJSON
        ...
        toJSON XPSTablesTrainingOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("createModelStage" Core..=) Core.<$>
                    createModelStage,
                  ("optimizationObjective" Core..=) Core.<$>
                    optimizationObjective,
                  ("topTrials" Core..=) Core.<$> topTrials,
                  ("trainBudgetMilliNodeHours" Core..=) Core..
                    Core.AsText
                    Core.<$> trainBudgetMilliNodeHours,
                  ("trainingObjectivePoints" Core..=) Core.<$>
                    trainingObjectivePoints,
                  ("trainingStartTime" Core..=) Core.<$>
                    trainingStartTime])
...
newXPSTextExtractionEvaluationMetrics =
  XPSTextExtractionEvaluationMetrics
    { bestF1ConfidenceMetrics = Core.Nothing
    , confidenceMetricsEntries = Core.Nothing
    , confusionMatrix = Core.Nothing
...
newXPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics 
    ::  Core.HashMap Core.Text XPSConfidenceMetricsEntry
       -- ^  See 'additional'.
    -> XPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics
newXPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics additional =
  XPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics
...
instance Core.FromJSON XPSTextToSpeechTrainResponse
         where
        parseJSON
          = Core.withObject "XPSTextToSpeechTrainResponse"
              (\ o -> Core.pure XPSTextToSpeechTrainResponse)

instance Core.ToJSON XPSTextToSpeechTrainResponse
         where
        toJSON = Core.const Core.emptyObject
...
newXPSTextTrainResponse 
    ::  XPSTextTrainResponse
newXPSTextTrainResponse = XPSTextTrainResponse {componentModel = Core.Nothing}

instance Core.FromJSON XPSTextTrainResponse where
        parseJSON
          = Core.withObject "XPSTextTrainResponse"
              (\ o ->
                 XPSTextTrainResponse Core.<$>
                   (o Core..:? "componentModel"))
...
instance Core.FromJSON XPSTfJsFormat where
        parseJSON
          = Core.withObject "XPSTfJsFormat"
              (\ o -> Core.pure XPSTfJsFormat)
          ...
          = Core.object
              (Core.catMaybes
                 [("commonStats" Core..=) Core.<$> commonStats,
                  ...
                  ("medianTimestampNanos" Core..=) Core.. Core.AsText
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "XPSTimestampStats_GranularStats"
              (\ o ->
                 XPSTimestampStats_GranularStats Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON XPSTimestampStats_GranularStats
         where
        toJSON XPSTimestampStats_GranularStats{..}
          = Core.toJSON additional
...
instance Core.FromJSON XPSTimestampStatsGranularStats
         where
        parseJSON
          = Core.withObject "XPSTimestampStatsGranularStats"
              (\ o ->
                 XPSTimestampStatsGranularStats Core.<$>
                   (o Core..:? "buckets"))

instance Core.ToJSON XPSTimestampStatsGranularStats
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("confidenceMetricsEntries" Core..=) Core.<$>
                    confidenceMetricsEntries,
                  ("iouThreshold" Core..=) Core.<$> iouThreshold,
                  ("meanBoundingBoxIou" Core..=) Core.<$>
                    meanBoundingBoxIou,
                  ("meanMismatchRate" Core..=) Core.<$>
                    meanMismatchRate,
              ...
              (\ o ->
                 XPSTrainResponse Core.<$>
                   (o Core..:? "deployedModelSizeBytes" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "videoActionRecognitionTrainResp")
...
instance Core.ToJSON XPSTrainResponse where
        toJSON XPSTrainResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deployedModelSizeBytes" Core..=) Core..
                    Core.AsText
                    Core.<$> deployedModelSizeBytes,
                  ("errorAnalysisConfigs" Core..=) Core.<$>
                    errorAnalysisConfigs,
                  ("evaluatedExampleSet" Core..=) Core.<$>
                    evaluatedExampleSet,
                  ("evaluationMetricsSet" Core..=) Core.<$>
                    evaluationMetricsSet,
                  ("explanationConfigs" Core..=) Core.<$>
                    explanationConfigs,
                  ...
                  ("textToSpeechTrainResp" Core..=) Core.<$>
                    textToSpeechTrainResp,
                  ("textTrainResp" Core..=) Core.<$> textTrainResp,
                  ("translationTrainResp" Core..=) Core.<$>
...
newXPSTrainingObjectivePoint 
    ::  XPSTrainingObjectivePoint
newXPSTrainingObjectivePoint =
  XPSTrainingObjectivePoint {createTime = Core.Nothing, value = Core.Nothing}

instance Core.FromJSON XPSTrainingObjectivePoint
         where
        parseJSON
...
newXPSTranslationEvaluationMetrics =
  XPSTranslationEvaluationMetrics
    {baseBleuScore = Core.Nothing, bleuScore = Core.Nothing}
          ...
          = Core.withObject "XPSTranslationEvaluationMetrics"
              (\ o ->
                 XPSTranslationEvaluationMetrics Core.<$>
                   (o Core..:? "baseBleuScore") Core.<*>
                     (o Core..:? "bleuScore"))

instance Core.ToJSON XPSTranslationEvaluationMetrics
         where
...
newXPSTranslationPreprocessResponse =
  XPSTranslationPreprocessResponse
    {parsedExampleCount = Core.Nothing, validExampleCount = Core.Nothing}
...
instance Core.ToJSON XPSTranslationPreprocessResponse
         where
        toJSON XPSTranslationPreprocessResponse{..}
          = Core.object
              (Core.catMaybes
                 [("parsedExampleCount" Core..=) Core.. Core.AsText
                    Core.<$> parsedExampleCount,
                  ("validExampleCount" Core..=) Core.. Core.AsText
...
instance Core.FromJSON XPSTranslationTrainResponse
         where
        parseJSON
          = Core.withObject "XPSTranslationTrainResponse"
              (\ o ->
                 XPSTranslationTrainResponse Core.<$>
                   (o Core..:? "modelType"))

instance Core.ToJSON XPSTranslationTrainResponse
         where
...
newXPSTuningTrial =
  XPSTuningTrial
    {modelStructure = Core.Nothing, trainingObjectivePoint = Core.Nothing}
...
instance Core.FromJSON XPSVideoActionMetricsEntry
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("confidenceMetricsEntries" Core..=) Core.<$>
                  ...
                  ("meanAveragePrecision" Core..=) Core.<$>
                    meanAveragePrecision,
                  ("precisionWindowLength" Core..=) Core.<$>
...
newXPSVideoActionRecognitionEvaluationMetrics =
  XPSVideoActionRecognitionEvaluationMetrics
    { evaluatedActionCount = Core.Nothing
...
instance Core.ToJSON
        ...
        toJSON XPSVideoActionRecognitionEvaluationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("evaluatedActionCount" Core..=) Core.<$>
...
newXPSVideoActionRecognitionTrainResponse =
  XPSVideoActionRecognitionTrainResponse
    {modelArtifactSpec = Core.Nothing, trainCostNodeSeconds = Core.Nothing}
...
newXPSVideoBatchPredictOperationMetadata 
    ::  XPSVideoBatchPredictOperationMetadata
newXPSVideoBatchPredictOperationMetadata =
  XPSVideoBatchPredictOperationMetadata {outputExamples = Core.Nothing}
...
newXPSVideoModelArtifactSpec =
  XPSVideoModelArtifactSpec
    {exportArtifact = Core.Nothing, servingArtifact = Core.Nothing}

instance Core.FromJSON XPSVideoModelArtifactSpec
         where
        parseJSON
...
newXPSVideoTrainingOperationMetadata 
    ::  XPSVideoTrainingOperationMetadata
newXPSVideoTrainingOperationMetadata =
  XPSVideoTrainingOperationMetadata {trainCostMilliNodeHour = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON XPSVideoTrainingOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("trainCostMilliNodeHour" Core..=) Core..
                    Core.AsText
...
newXPSVisionErrorAnalysisConfig =
  XPSVisionErrorAnalysisConfig
    {exampleCount = Core.Nothing, queryType = Core.Nothing}

instance Core.FromJSON XPSVisionErrorAnalysisConfig
         where
        parseJSON
          = Core.withObject "XPSVisionErrorAnalysisConfig"
              (\ o ->
                 XPSVisionErrorAnalysisConfig Core.<$>
                   (o Core..:? "exampleCount") Core.<*>
                     (o Core..:? "queryType"))

instance Core.ToJSON XPSVisionErrorAnalysisConfig
         where
...
newXPSVisionTrainingOperationMetadata 
    ::  XPSVisionTrainingOperationMetadata
newXPSVisionTrainingOperationMetadata =
  XPSVisionTrainingOperationMetadata {explanationUsage = Core.Nothing}
...
instance Core.ToJSON XPSVisualization where
        toJSON XPSVisualization{..}
          = Core.object
              (Core.catMaybes
                 [("clipPercentLowerbound" Core..=) Core.<$>
                    clipPercentLowerbound,
                  ("clipPercentUpperbound" Core..=) Core.<$>
              ...
              (\ o ->
                 XPSXpsOperationMetadata Core.<$>
                   (o Core..:? "exampleCount" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "tablesTrainingOperationMetadata")
                     Core.<*>
                     (o Core..:? "videoBatchPredictOperationMetadata")
                     Core.<*>
                     (o Core..:? "videoTrainingOperationMetadata")
                     Core.<*>
                     (o Core..:? "visionTrainingOperationMetadata"))

instance Core.ToJSON XPSXpsOperationMetadata where
        toJSON XPSXpsOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("exampleCount" Core..=) Core.. Core.AsText Core.<$>
                    exampleCount,
                  ("reportingMetrics" Core..=) Core.<$>
                    reportingMetrics,
...
newXPSXraiAttribution 
    ::  XPSXraiAttribution
newXPSXraiAttribution = XPSXraiAttribution {stepCount = Core.Nothing}

instance Core.FromJSON XPSXraiAttribution where
        parseJSON
          = Core.withObject "XPSXraiAttribution"
              (\ o ->
                 XPSXraiAttribution Core.<$> (o Core..:? "stepCount"))
