              ...
              (\ o ->
                 AnalyzeSentimentResponse Core.<$>
                   (o Core..:? "documentSentiment") Core.<*>
                     (o Core..:? "language")
                     Core.<*>
                     (o Core..:? "sentences" Core..!= Core.mempty))
...
instance Core.FromJSON Entity where
        parseJSON
          = Core.withObject "Entity"
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "mentions" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "metadata")
                     Core.<*> (o Core..:? "name")
...
newEntity_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Entity_Metadata
newEntity_Metadata addtional = Entity_Metadata {addtional = addtional}
...
instance Core.ToJSON Entity_Metadata where
        toJSON Entity_Metadata{..} = Core.toJSON addtional
