...
-- |
-- Module      : Gogol.Logging.BillingAccounts.Buckets.Views.Get
...
-- 'LoggingBillingAccountsBucketsViewsGet' request conforms to.
type LoggingBillingAccountsBucketsViewsGetResource =
     "v2" Core.:>
...
-- | Gets a view on a log bucket..
--
-- /See:/ 'newLoggingBillingAccountsBucketsViewsGet' smart constructor.
data LoggingBillingAccountsBucketsViewsGet = LoggingBillingAccountsBucketsViewsGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingBillingAccountsBucketsViewsGet' with the minimum fields required to make a request.
newLoggingBillingAccountsBucketsViewsGet 
    ::  Core.Text
    ...
    -> LoggingBillingAccountsBucketsViewsGet
newLoggingBillingAccountsBucketsViewsGet name =
  LoggingBillingAccountsBucketsViewsGet
    { xgafv = Core.Nothing
...
instance Core.GoogleRequest
           LoggingBillingAccountsBucketsViewsGet
         where
        type Rs LoggingBillingAccountsBucketsViewsGet =
             LogView
        type Scopes LoggingBillingAccountsBucketsViewsGet =
