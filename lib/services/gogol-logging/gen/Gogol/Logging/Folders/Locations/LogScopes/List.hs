...
instance Core.GoogleRequest LoggingFoldersLocationsLogScopesList where
  type
    Rs LoggingFoldersLocationsLogScopesList =
      ListLogScopesResponse
  type
    Scopes LoggingFoldersLocationsLogScopesList =
