...
instance Core.GoogleRequest LoggingFoldersLocationsSavedQueriesList where
  type
    Rs LoggingFoldersLocationsSavedQueriesList =
      ListSavedQueriesResponse
  type
    Scopes LoggingFoldersLocationsSavedQueriesList =
