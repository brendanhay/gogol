...
newDefaultSinkConfig =
  DefaultSinkConfig
    {exclusions = Core.Nothing, filter = Core.Nothing, mode = Core.Nothing}
...
newListLogScopesResponse 
    ::  ListLogScopesResponse
newListLogScopesResponse =
  ListLogScopesResponse {logScopes = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.FromJSON ListRecentQueriesResponse
         where
        parseJSON
...
newOpsAnalyticsQuery 
    ::  OpsAnalyticsQuery
newOpsAnalyticsQuery = OpsAnalyticsQuery {sqlQueryText = Core.Nothing}

instance Core.FromJSON OpsAnalyticsQuery where
        parseJSON
          = Core.withObject "OpsAnalyticsQuery"
              (\ o ->
                 OpsAnalyticsQuery Core.<$>
                   (o Core..:? "sqlQueryText"))
...
instance Core.ToJSON OpsAnalyticsQuery where
        toJSON OpsAnalyticsQuery{..}
          = Core.object
              (Core.catMaybes
                 [("sqlQueryText" Core..=) Core.<$> sqlQueryText])
