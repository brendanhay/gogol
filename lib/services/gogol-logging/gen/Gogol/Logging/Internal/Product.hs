          ...
          = Core.withObject "ListLogsResponse"
              (\ o ->
                 ListLogsResponse Core.<$>
                   (o Core..:? "logNames" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
              ...
              (\ o ->
                 LogBucket Core.<$>
                   (o Core..:? "cmekSettings") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "restrictedFields" Core..!= Core.mempty)
...
newLogEntry_JsonPayload 
    ...
    -> LogEntry_JsonPayload
newLogEntry_JsonPayload addtional = LogEntry_JsonPayload {addtional = addtional}
...
newLogEntry_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> LogEntry_Labels
newLogEntry_Labels addtional = LogEntry_Labels {addtional = addtional}
...
instance Core.ToJSON LogEntry_Labels where
        toJSON LogEntry_Labels{..} = Core.toJSON addtional
...
newLogEntry_ProtoPayload 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'addtional'.
    -> LogEntry_ProtoPayload
newLogEntry_ProtoPayload addtional =
  LogEntry_ProtoPayload {addtional = addtional}
...
newLogMetric_LabelExtractors 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> LogMetric_LabelExtractors
newLogMetric_LabelExtractors addtional =
  LogMetric_LabelExtractors {addtional = addtional}
              ...
              (\ o ->
                 RequestLog Core.<$>
                   (o Core..:? "appEngineRelease") Core.<*>
                     ...
                     Core.<*> (o Core..:? "responseSize")
                     Core.<*>
                     (o Core..:? "sourceReference" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "status")
          ...
          = Core.withObject "TailLogEntriesResponse"
              (\ o ->
                 TailLogEntriesResponse Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "suppressionInfo" Core..!= Core.mempty))
...
newWriteLogEntriesRequest_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> WriteLogEntriesRequest_Labels
newWriteLogEntriesRequest_Labels addtional =
  WriteLogEntriesRequest_Labels {addtional = addtional}
