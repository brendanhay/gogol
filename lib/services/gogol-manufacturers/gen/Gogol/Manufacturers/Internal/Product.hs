              ...
              (\ o ->
                 Attributes Core.<$>
                   (o Core..:? "additionalImageLink" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "excludedDestination" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "featureDescription" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "flavor")
                     Core.<*> (o Core..:? "format")
                     Core.<*> (o Core..:? "gender")
                     ...
                     Core.<*>
                     (o Core..:? "includedDestination" Core..!=
                        Core.mempty)
                     ...
                     Core.<*> (o Core..:? "pattern")
                     Core.<*>
                     (o Core..:? "productDetail" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "productHighlight" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "richProductContent" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "scent")
                     Core.<*> (o Core..:? "size")
                     ...
                     Core.<*> (o Core..:? "title")
                     Core.<*>
                     (o Core..:? "videoLink" Core..!= Core.mempty))
