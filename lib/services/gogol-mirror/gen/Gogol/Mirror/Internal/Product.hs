...
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "authTokens" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "features" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "password")
                     Core.<*>
                     (o Core..:? "userData" Core..!= Core.mempty))
...
newAttachmentsListResponse =
  AttachmentsListResponse
    {items = Core.Nothing, kind = "mirror#attachmentsList"}
...
instance Core.FromJSON Contact where
        parseJSON
          = Core.withObject "Contact"
              (\ o ->
                 Contact Core.<$>
                   (o Core..:? "acceptCommands" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "acceptTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "imageUrls" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#contact")
                     Core.<*> (o Core..:? "phoneNumber")
                     Core.<*> (o Core..:? "priority")
                     Core.<*>
                     (o Core..:? "sharingFeatures" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "source")
              ...
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "accuracy") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#location")
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("contextual_command" Core..=) Core.<$>
                    contextualCommand,
                  ("id" Core..=) Core.<$> id,
                  ("payload" Core..=) Core.<$> payload,
                  ("removeWhenSelected" Core..=) Core.<$>
                    removeWhenSelected,
...
newMenuValue =
  MenuValue
    {displayName = Core.Nothing, iconUrl = Core.Nothing, state = Core.Nothing}
              ...
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "collection") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "userActions" Core..!= Core.mempty)
...
instance Core.FromJSON Subscription where
        parseJSON
          = Core.withObject "Subscription"
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "callbackUrl") Core.<*>
                     (o Core..:? "collection")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#subscription")
                     Core.<*> (o Core..:? "notification")
                     Core.<*>
                     (o Core..:? "operation" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "updated")
                     Core.<*> (o Core..:? "userToken")
                     Core.<*> (o Core..:? "verifyToken"))
...
newSubscriptionsListResponse =
  SubscriptionsListResponse
    {items = Core.Nothing, kind = "mirror#subscriptionsList"}

instance Core.FromJSON SubscriptionsListResponse
         where
        parseJSON
              ...
              (\ o ->
                 TimelineItem Core.<$>
                   (o Core..:? "attachments" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#timelineItem")
                     Core.<*> (o Core..:? "location")
                     Core.<*>
                     (o Core..:? "menuItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "notification")
