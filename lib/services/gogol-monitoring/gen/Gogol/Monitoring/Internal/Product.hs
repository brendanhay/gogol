...
instance Core.ToJSON BooleanTest where
        toJSON BooleanTest{..}
          = Core.object
              (Core.catMaybes [("column" Core..=) Core.<$> column])
...
newCloudFunctionV2Target 
    ::  CloudFunctionV2Target
newCloudFunctionV2Target =
  CloudFunctionV2Target {cloudRunRevision = Core.Nothing, name = Core.Nothing}
              ...
              (\ o ->
                 Condition Core.<$>
                   (o Core..:? "conditionAbsent") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "conditionPrometheusQueryLanguage")
...
newDaily 
    ::  Daily
newDaily = Daily {executionTime = Core.Nothing, periodicity = Core.Nothing}
...
instance Core.FromJSON Documentation where
        parseJSON
          = Core.withObject "Documentation"
              (\ o ->
                 Documentation Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "links")
...
newHourly 
    ::  Hourly
newHourly = Hourly {minuteOffset = Core.Nothing, periodicity = Core.Nothing}
...
instance Core.ToJSON PrometheusQueryLanguageCondition
         where
...
instance Core.FromJSON ServiceAgentAuthentication
         where
        parseJSON
