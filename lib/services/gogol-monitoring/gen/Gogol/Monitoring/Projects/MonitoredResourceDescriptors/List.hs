...
type MonitoringProjectsMonitoredResourceDescriptorsListResource =
  "v3"
    ...
    Core.:> Core.Get '[Core.JSON] ListMonitoredResourceDescriptorsResponse
...
instance
  ...
  where
  type
    Rs MonitoringProjectsMonitoredResourceDescriptorsList =
      ListMonitoredResourceDescriptorsResponse
  type
    Scopes MonitoringProjectsMonitoredResourceDescriptorsList =
