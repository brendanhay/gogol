                     ...
                     Core.QueryParam "aggregation.perSeriesAligner"
                       ...
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "filter" Core.Text Core.:>
                           Core.QueryParam "interval.endTime" Core.DateTime
                             Core.:>
                             Core.QueryParam "interval.startTime" Core.DateTime
                               Core.:>
...
instance Core.GoogleRequest
           MonitoringProjectsTimeSeriesList
         where
        type Rs MonitoringProjectsTimeSeriesList =
             ListTimeSeriesResponse
        ...
        requestClient MonitoringProjectsTimeSeriesList{..}
          = go name xgafv accessToken
              ...
              (secondaryAggregationGroupByFields Core.^.
                 Core._Default)
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsTimeSeriesListResource)
                      Core.mempty
