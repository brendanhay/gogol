...
newImportSshPublicKeyResponse =
  ImportSshPublicKeyResponse
    {details = Core.Nothing, loginProfile = Core.Nothing}

instance Core.FromJSON ImportSshPublicKeyResponse
         where
        parseJSON
        ...
        parseJSON
          = Core.withObject "LoginProfile"
              (\ o ->
                 LoginProfile Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "posixAccounts" Core..!= Core.mempty)
...
newtype LoginProfile_SshPublicKeys = LoginProfile_SshPublicKeys
    {
      -- | 
      addtional :: (Core.HashMap Core.Text SshPublicKey)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newLoginProfile_SshPublicKeys 
    ::  Core.HashMap Core.Text SshPublicKey
       -- ^  See 'addtional'.
    -> LoginProfile_SshPublicKeys
newLoginProfile_SshPublicKeys addtional =
  LoginProfile_SshPublicKeys {addtional = addtional}

instance Core.FromJSON LoginProfile_SshPublicKeys
         where
        parseJSON
          = Core.withObject "LoginProfile_SshPublicKeys"
              (\ o ->
                 LoginProfile_SshPublicKeys Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LoginProfile_SshPublicKeys where
        toJSON LoginProfile_SshPublicKeys{..}
