              ...
              (\ o ->
                 AuditRefs Core.<$>
                   (o Core..:? "acronym") Core.<*> (o Core..:? "group")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "relevantAudits" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "weight"))
...
newLighthouseAuditResultV5_Details 
    ...
    -> LighthouseAuditResultV5_Details
newLighthouseAuditResultV5_Details addtional =
  LighthouseAuditResultV5_Details {addtional = addtional}
          ...
          = Core.withObject "LighthouseCategoryV5"
              (\ o ->
                 LighthouseCategoryV5 Core.<$>
                   (o Core..:? "auditRefs" Core..!= Core.mempty)
              ...
              (\ o ->
                 LighthouseResultV5 Core.<$>
                   (o Core..:? "audits") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "runWarnings" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "runtimeError")
                     Core.<*>
                     (o Core..:? "stackPacks" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "timing")
...
newtype LighthouseResultV5_Audits = LighthouseResultV5_Audits
    {
      -- | 
      addtional :: (Core.HashMap Core.Text LighthouseAuditResultV5)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newLighthouseResultV5_Audits 
    ::  Core.HashMap Core.Text LighthouseAuditResultV5
       -- ^  See 'addtional'.
    -> LighthouseResultV5_Audits
newLighthouseResultV5_Audits addtional =
  LighthouseResultV5_Audits {addtional = addtional}
...
newtype LighthouseResultV5_CategoryGroups = LighthouseResultV5_CategoryGroups
    {
      -- | 
      addtional :: (Core.HashMap Core.Text CategoryGroupV5)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newLighthouseResultV5_CategoryGroups 
    ::  Core.HashMap Core.Text CategoryGroupV5
       -- ^  See 'addtional'.
    -> LighthouseResultV5_CategoryGroups
newLighthouseResultV5_CategoryGroups addtional =
  LighthouseResultV5_CategoryGroups {addtional = addtional}
...
newtype PagespeedApiLoadingExperienceV5_Metrics = PagespeedApiLoadingExperienceV5_Metrics
    {
      -- | 
      addtional :: (Core.HashMap Core.Text UserPageLoadMetricV5)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPagespeedApiLoadingExperienceV5_Metrics 
    ::  Core.HashMap Core.Text UserPageLoadMetricV5
       -- ^  See 'addtional'.
    -> PagespeedApiLoadingExperienceV5_Metrics
newPagespeedApiLoadingExperienceV5_Metrics addtional =
  PagespeedApiLoadingExperienceV5_Metrics {addtional = addtional}
...
newStackPack_Descriptions 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> StackPack_Descriptions
newStackPack_Descriptions addtional =
  StackPack_Descriptions {addtional = addtional}
