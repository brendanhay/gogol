...
type PartnersCompaniesListResource =
  "v2"
    ...
    Core.:> Core.QueryParam "companyName" Core.Text
    Core.:> Core.QueryParams "gpsMotivations" Core.Text
    Core.:> Core.QueryParams "industries" Core.Text
    Core.:> Core.QueryParams "languageCodes" Core.Text
    Core.:> Core.QueryParam "maxMonthlyBudget.currencyCode" Core.Text
    Core.:> Core.QueryParam "maxMonthlyBudget.nanos" Core.Int32
    Core.:> Core.QueryParam "maxMonthlyBudget.units" Core.Int64
    Core.:> Core.QueryParam "minMonthlyBudget.currencyCode" Core.Text
    Core.:> Core.QueryParam "minMonthlyBudget.nanos" Core.Int32
    Core.:> Core.QueryParam "minMonthlyBudget.units" Core.Int64
    ...
    Core.:> Core.QueryParam
              ...
              Core.Text
    Core.:> Core.QueryParams "services" Core.Text
    Core.:> Core.QueryParams
              "specializations"
              Core.Text
