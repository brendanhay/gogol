...
instance Core.FromJSON AdWordsManagerAccountInfo
         where
        parseJSON
          ...
          = Core.withObject "AnalyticsDataPoint"
              (\ o ->
                 AnalyticsDataPoint Core.<$>
                   (o Core..:? "eventCount") Core.<*>
                     (o Core..:? "eventLocations" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("contactsCount" Core..=) Core.<$> contactsCount,
                  ("profileViewsCount" Core..=) Core.<$>
                    profileViewsCount,
                  ("searchViewsCount" Core..=) Core.<$>
                    searchViewsCount])
              ...
              (\ o ->
                 AvailableOffer Core.<$>
                   (o Core..:? "available") Core.<*>
                     (o Core..:? "countryOfferInfos" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "qualifiedCustomer" Core..!= Core.mempty)
...
instance Core.FromJSON Certification where
        parseJSON
          = Core.withObject "Certification"
              (\ o ->
                 Certification Core.<$>
                   (o Core..:? "achieved") Core.<*>
                     (o Core..:? "certificationType")
          ...
          = Core.withObject "CertificationStatus"
              (\ o ->
                 CertificationStatus Core.<$>
                   (o Core..:? "examStatuses" Core..!= Core.mempty)
              ...
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "additionalWebsites" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "autoApprovalEmailDomains" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "badgeAuthorityInAwn")
                     Core.<*> (o Core..:? "badgeTier")
                     Core.<*>
                     (o Core..:? "certificationStatuses" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "companyTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "convertedMinMonthlyBudget")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "industries" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "localizedInfos" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "locations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "originalMinMonthlyBudget")
                     Core.<*>
                     (o Core..:? "primaryAdwordsManagerAccountId")
                     ...
                     Core.<*>
                     (o Core..:? "specializationStatus" Core..!=
                        Core.mempty)
...
instance Core.ToJSON Company where
        toJSON Company{..}
          = Core.object
              (Core.catMaybes
                 [("additionalWebsites" Core..=) Core.<$>
                    additionalWebsites,
                  ("autoApprovalEmailDomains" Core..=) Core.<$>
                    autoApprovalEmailDomains,
                  ("badgeAuthorityInAwn" Core..=) Core.<$>
                    badgeAuthorityInAwn,
                  ("badgeTier" Core..=) Core.<$> badgeTier,
                  ("certificationStatuses" Core..=) Core.<$>
                  ...
                  ("primaryAdwordsManagerAccountId" Core..=) Core..
                    Core.AsText
                  ...
                  ("specializationStatus" Core..=) Core.<$>
                    specializationStatus,
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("primaryCountryCode" Core..=) Core.<$>
                    primaryCountryCode,
                  ("primaryLanguageCode" Core..=) Core.<$>
                    primaryLanguageCode,
                  ("resolvedTimestamp" Core..=) Core.<$>
                    resolvedTimestamp,
          ...
          = Core.withObject "CountryOfferInfo"
              (\ o ->
                 CountryOfferInfo Core.<$>
                   (o Core..:? "getYAmount") Core.<*>
                     (o Core..:? "offerCountryCode")
                     Core.<*> (o Core..:? "offerType")
...
instance Core.ToJSON CreateLeadRequest where
        toJSON CreateLeadRequest{..}
          = Core.object
              (Core.catMaybes
                 [("lead" Core..=) Core.<$> lead,
                  ("recaptchaChallenge" Core..=) Core.<$>
                    recaptchaChallenge,
                  ("requestMetadata" Core..=) Core.<$>
                    requestMetadata])
...
instance Core.FromJSON DebugInfo where
        parseJSON
          = Core.withObject "DebugInfo"
              (\ o ->
                 DebugInfo Core.<$>
                   (o Core..:? "serverInfo") Core.<*>
                     (o Core..:? "serverTraceInfo")
...
instance Core.FromJSON GetPartnersStatusResponse
         where
        parseJSON
          = Core.withObject "GetPartnersStatusResponse"
              (\ o ->
                 GetPartnersStatusResponse Core.<$>
                   (o Core..:? "responseMetadata"))
          ...
          = Core.object
              (Core.catMaybes
                 [("adwordsUrl" Core..=) Core.<$> adwordsUrl,
                  ...
                  ("clientId" Core..=) Core.. Core.AsText Core.<$>
                    clientId,
              ...
              (\ o ->
                 Lead Core.<$>
                   (o Core..:? "adwordsCustomerId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "gpsMotivations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
          ...
          = Core.withObject "ListAnalyticsResponse"
              (\ o ->
                 ListAnalyticsResponse Core.<$>
                   (o Core..:? "analytics" Core..!= Core.mempty)
          ...
          = Core.withObject "ListCompaniesResponse"
              (\ o ->
                 ListCompaniesResponse Core.<$>
                   (o Core..:? "companies" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "responseMetadata"))
          ...
          = Core.withObject "ListLeadsResponse"
              (\ o ->
                 ListLeadsResponse Core.<$>
                   (o Core..:? "leads" Core..!= Core.mempty) Core.<*>
...
instance Core.FromJSON ListOffersHistoryResponse
         where
        parseJSON
...
instance Core.ToJSON ListOffersHistoryResponse where
        toJSON ListOffersHistoryResponse{..}
          = Core.object
              (Core.catMaybes
                 [("canShowEntireCompany" Core..=) Core.<$>
                    canShowEntireCompany,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("offers" Core..=) Core.<$> offers,
                  ("responseMetadata" Core..=) Core.<$>
                    responseMetadata,
                  ("showingEntireCompany" Core..=) Core.<$>
          ...
          = Core.withObject "ListOffersResponse"
              (\ o ->
                 ListOffersResponse Core.<$>
                   (o Core..:? "availableOffers" Core..!= Core.mempty)
...
newListUserStatesResponse =
  ListUserStatesResponse
    {responseMetadata = Core.Nothing, userStates = Core.Nothing}
          ...
          = Core.withObject "ListUserStatesResponse"
              (\ o ->
                 ListUserStatesResponse Core.<$>
                   (o Core..:? "responseMetadata") Core.<*>
                     (o Core..:? "userStates" Core..!= Core.mempty))
          ...
          = Core.withObject "LocalizedCompanyInfo"
              (\ o ->
                 LocalizedCompanyInfo Core.<$>
                   (o Core..:? "countryCodes" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "addressLine" Core..!= Core.mempty)
...
newLogMessageRequest_ClientInfo 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> LogMessageRequest_ClientInfo
newLogMessageRequest_ClientInfo addtional =
  LogMessageRequest_ClientInfo {addtional = addtional}

instance Core.FromJSON LogMessageRequest_ClientInfo
         where
        parseJSON
          = Core.withObject "LogMessageRequest_ClientInfo"
              (\ o ->
                 LogMessageRequest_ClientInfo Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON LogMessageRequest_ClientInfo
         where
              ...
              (\ o ->
                 LogUserEventRequest Core.<$>
                   (o Core..:? "eventAction") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "eventDatas" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("adwordsUrl" Core..=) Core.<$> adwordsUrl,
                  ...
                  ("creationTime" Core..=) Core.<$> creationTime,
                  ("eligibilityDaysLeft" Core..=) Core.<$>
                    eligibilityDaysLeft,
                  ("externalCid" Core..=) Core.. Core.AsText Core.<$>
                    externalCid,
                  ("getYAmount" Core..=) Core.<$> getYAmount,
                  ("name" Core..=) Core.<$> name,
                  ("offerType" Core..=) Core.<$> offerType,
          ...
          = Core.object
              (Core.catMaybes
                 [("marketComm" Core..=) Core.<$> marketComm,
                  ("performanceSuggestions" Core..=) Core.<$>
          ...
          = Core.withObject "RequestMetadata"
              (\ o ->
                 RequestMetadata Core.<$>
                   (o Core..:? "experimentIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "locale")
                 ...
                 User Core.<$>
                   (o Core..:? "afaInfoShared") Core.<*>
                     (o Core..:? "availableAdwordsManagerAccounts"
                        Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "certificationStatus" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "company")
                     Core.<*> (o Core..:? "companyVerificationEmail")
                     Core.<*>
                     (o Core..:? "examStatus" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "internalId")
                     Core.<*> (o Core..:? "lastAccessTime")
                     Core.<*>
                     (o Core..:? "primaryEmails" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "profile")
                     Core.<*> (o Core..:? "publicProfile"))
              ...
              (\ o ->
                 UserProfile Core.<$>
                   (o Core..:? "address") Core.<*>
                     ...
                     (o Core..:? "industries" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "jobFunctions" Core..!= Core.mempty)
                     Core.<*>
