               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateContactGroupRequest
...
instance Core.GoogleRequest PeopleContactGroupsUpdate
         where
        type Rs PeopleContactGroupsUpdate = ContactGroup
        type Scopes PeopleContactGroupsUpdate =
        ...
        requestClient PeopleContactGroupsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PeopleContactGroupsUpdateResource)
                      Core.mempty
