...
instance Core.FromJSON Address where
        parseJSON
          = Core.withObject "Address"
              (\ o ->
                 Address Core.<$>
                   (o Core..:? "city") Core.<*> (o Core..:? "country")
...
newBatchCreateContactsRequest =
  BatchCreateContactsRequest
    {contacts = Core.Nothing, readMask = Core.Nothing, sources = Core.Nothing}

instance Core.FromJSON BatchCreateContactsRequest
         where
        parseJSON
          = Core.withObject "BatchCreateContactsRequest"
              (\ o ->
                 BatchCreateContactsRequest Core.<$>
                   (o Core..:? "contacts" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "readMask")
...
instance Core.FromJSON BatchCreateContactsResponse
         where
        parseJSON
          = Core.withObject "BatchCreateContactsResponse"
              (\ o ->
                 BatchCreateContactsResponse Core.<$>
                   (o Core..:? "createdPeople" Core..!= Core.mempty))

instance Core.ToJSON BatchCreateContactsResponse
         where
...
instance Core.FromJSON BatchDeleteContactsRequest
         where
        parseJSON
          = Core.withObject "BatchDeleteContactsRequest"
              (\ o ->
                 BatchDeleteContactsRequest Core.<$>
...
instance Core.FromJSON BatchGetContactGroupsResponse
         where
        parseJSON
          = Core.withObject "BatchGetContactGroupsResponse"
              (\ o ->
                 BatchGetContactGroupsResponse Core.<$>
                   (o Core..:? "responses" Core..!= Core.mempty))

instance Core.ToJSON BatchGetContactGroupsResponse
         where
...
newtype BatchUpdateContactsRequest_Contacts = BatchUpdateContactsRequest_Contacts
    {
      -- | 
      addtional :: (Core.HashMap Core.Text Person)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newBatchUpdateContactsRequest_Contacts 
    ::  Core.HashMap Core.Text Person
       -- ^  See 'addtional'.
    -> BatchUpdateContactsRequest_Contacts
newBatchUpdateContactsRequest_Contacts addtional =
  BatchUpdateContactsRequest_Contacts {addtional = addtional}
...
instance Core.FromJSON BatchUpdateContactsResponse
         where
        parseJSON
          = Core.withObject "BatchUpdateContactsResponse"
              (\ o ->
                 BatchUpdateContactsResponse Core.<$>
                   (o Core..:? "updateResult"))

instance Core.ToJSON BatchUpdateContactsResponse
         where
...
newtype BatchUpdateContactsResponse_UpdateResult = BatchUpdateContactsResponse_UpdateResult
    {
      -- | 
      addtional :: (Core.HashMap Core.Text PersonResponse)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newBatchUpdateContactsResponse_UpdateResult 
    ::  Core.HashMap Core.Text PersonResponse
       -- ^  See 'addtional'.
    -> BatchUpdateContactsResponse_UpdateResult
newBatchUpdateContactsResponse_UpdateResult addtional =
  BatchUpdateContactsResponse_UpdateResult {addtional = addtional}
...
newBiography =
  Biography
    {contentType = Core.Nothing, metadata = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON Birthday where
        parseJSON
          = Core.withObject "Birthday"
              (\ o ->
                 Birthday Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "text"))
...
newContactGroupMembership =
  ContactGroupMembership
    {contactGroupId = Core.Nothing, contactGroupResourceName = Core.Nothing}
...
instance Core.FromJSON ContactToCreate where
        parseJSON
          = Core.withObject "ContactToCreate"
              (\ o ->
                 ContactToCreate Core.<$>
                   (o Core..:? "contactPerson"))
...
newCopyOtherContactToMyContactsGroupRequest =
  CopyOtherContactToMyContactsGroupRequest
    {copyMask = Core.Nothing, readMask = Core.Nothing, sources = Core.Nothing}
...
newCoverPhoto =
  CoverPhoto
    {default' = Core.Nothing, metadata = Core.Nothing, url = Core.Nothing}
...
newCreateContactGroupRequest =
  CreateContactGroupRequest
    {contactGroup = Core.Nothing, readGroupFields = Core.Nothing}

instance Core.FromJSON CreateContactGroupRequest
         where
        parseJSON
...
instance Core.FromJSON DeleteContactPhotoResponse
         where
        parseJSON
          = Core.withObject "DeleteContactPhotoResponse"
              (\ o ->
                 DeleteContactPhotoResponse Core.<$>
                   (o Core..:? "person"))
...
instance Core.FromJSON FieldMetadata where
        parseJSON
          = Core.withObject "FieldMetadata"
              (\ o ->
                 FieldMetadata Core.<$>
                   (o Core..:? "primary") Core.<*> (o Core..:? "source")
...
instance Core.FromJSON ListContactGroupsResponse
         where
        parseJSON
          = Core.withObject "ListContactGroupsResponse"
              (\ o ->
                 ListContactGroupsResponse Core.<$>
                   (o Core..:? "contactGroups" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "nextSyncToken")
                     Core.<*> (o Core..:? "totalItems"))
...
instance Core.FromJSON ListDirectoryPeopleResponse
         where
        parseJSON
              ...
              (\ o ->
                 ListDirectoryPeopleResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "nextSyncToken")
                     Core.<*> (o Core..:? "people" Core..!= Core.mempty))

instance Core.ToJSON ListDirectoryPeopleResponse
         where
...
instance Core.FromJSON ListOtherContactsResponse
         where
        parseJSON
              ...
              (\ o ->
                 ListOtherContactsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "nextSyncToken")
                     Core.<*>
                     (o Core..:? "otherContacts" Core..!= Core.mempty)
...
newModifyContactGroupMembersRequest =
  ModifyContactGroupMembersRequest
    {resourceNamesToAdd = Core.Nothing, resourceNamesToRemove = Core.Nothing}
              ...
              (\ o ->
                 ModifyContactGroupMembersRequest Core.<$>
                   (o Core..:? "resourceNamesToAdd" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "resourceNamesToRemove" Core..!=
                        Core.mempty))

instance Core.ToJSON ModifyContactGroupMembersRequest
         where
        toJSON ModifyContactGroupMembersRequest{..}
          = Core.object
              (Core.catMaybes
                 [("resourceNamesToAdd" Core..=) Core.<$>
                    resourceNamesToAdd,
                  ("resourceNamesToRemove" Core..=) Core.<$>
              ...
              (\ o ->
                 ModifyContactGroupMembersResponse Core.<$>
                   (o Core..:?
                      ...
                      Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "notFoundResourceNames" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("canNotRemoveLastContactGroupResourceNames"
                  ...
                  ("notFoundResourceNames" Core..=) Core.<$>
...
instance Core.ToJSON Name where
        toJSON Name{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("displayNameLastFirst" Core..=) Core.<$>
                  ...
                  ("phoneticFamilyName" Core..=) Core.<$>
                    phoneticFamilyName,
                  ("phoneticFullName" Core..=) Core.<$>
                    phoneticFullName,
                  ("phoneticGivenName" Core..=) Core.<$>
                    phoneticGivenName,
                  ("phoneticHonorificPrefix" Core..=) Core.<$>
                    phoneticHonorificPrefix,
                  ("phoneticHonorificSuffix" Core..=) Core.<$>
                    phoneticHonorificSuffix,
                  ("phoneticMiddleName" Core..=) Core.<$>
                    phoneticMiddleName,
                  ("unstructuredName" Core..=) Core.<$>
                    unstructuredName])
...
instance Core.FromJSON Nickname where
        parseJSON
          = Core.withObject "Nickname"
              (\ o ->
                 Nickname Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value"))
              ...
              (\ o ->
                 Organization Core.<$>
                   (o Core..:? "costCenter") Core.<*>
                     ...
                     Core.<*> (o Core..:? "formattedType")
                     Core.<*>
                     (o Core..:? "fullTimeEquivalentMillipercent")
...
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "addresses" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "ageRange")
                     Core.<*>
                     (o Core..:? "ageRanges" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "biographies" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "birthdays" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "braggingRights" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "calendarUrls" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "clientData" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "coverPhotos" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "emailAddresses" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "events" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "externalIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fileAses" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "genders" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "imClients" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "interests" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "metadata")
                     Core.<*>
                     (o Core..:? "miscKeywords" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "names" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "nicknames" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "occupations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "organizations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "phoneNumbers" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "photos" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "relations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "relationshipInterests" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "relationshipStatuses" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "residences" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "resourceName")
                     Core.<*>
                     (o Core..:? "sipAddresses" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "skills" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "taglines" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "urls" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "userDefined" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("addresses" Core..=) Core.<$> addresses,
                  ...
                  ("relationshipInterests" Core..=) Core.<$>
                    relationshipInterests,
                  ("relationshipStatuses" Core..=) Core.<$>
        ...
        parseJSON
          = Core.withObject "PersonMetadata"
              (\ o ->
                 PersonMetadata Core.<$>
                   (o Core..:? "deleted") Core.<*>
                     (o Core..:? "linkedPeopleResourceNames" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "objectType")
                     Core.<*>
                     (o Core..:? "previousResourceNames" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "sources" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("deleted" Core..=) Core.<$> deleted,
                  ...
                  ("previousResourceNames" Core..=) Core.<$>
          ...
          = Core.withObject "ProfileMetadata"
              (\ o ->
                 ProfileMetadata Core.<$>
                   (o Core..:? "objectType") Core.<*>
                     (o Core..:? "userTypes" Core..!= Core.mempty))
...
newResidence =
  Residence
    {current = Core.Nothing, metadata = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON SearchDirectoryPeopleResponse
         where
        parseJSON
          = Core.withObject "SearchDirectoryPeopleResponse"
              (\ o ->
                 SearchDirectoryPeopleResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "people" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "totalSize"))

instance Core.ToJSON SearchDirectoryPeopleResponse
         where
...
instance Core.FromJSON UpdateContactGroupRequest
         where
        parseJSON
...
instance Core.FromJSON UpdateContactPhotoRequest
         where
        parseJSON
          = Core.withObject "UpdateContactPhotoRequest"
              (\ o ->
                 UpdateContactPhotoRequest Core.<$>
                   (o Core..:? "personFields") Core.<*>
                     (o Core..:? "photoBytes")
                     Core.<*> (o Core..:? "sources" Core..!= Core.mempty))
...
instance Core.FromJSON UpdateContactPhotoResponse
         where
        parseJSON
          = Core.withObject "UpdateContactPhotoResponse"
              (\ o ->
                 UpdateContactPhotoResponse Core.<$>
                   (o Core..:? "person"))
...
newUserDefined =
  UserDefined
    {key = Core.Nothing, metadata = Core.Nothing, value = Core.Nothing}
