                 ...
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "readMask" Core.GFieldMask Core.:>
                     Core.QueryParam "requestSyncToken" Core.Bool Core.:>
                       Core.QueryParams "sources" OtherContactsListSources
                         Core.:>
...
instance Core.GoogleRequest PeopleOtherContactsList
         where
        type Rs PeopleOtherContactsList =
             ListOtherContactsResponse
        type Scopes PeopleOtherContactsList =
