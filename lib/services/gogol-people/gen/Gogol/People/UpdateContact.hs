...
type PeoplePeopleUpdateContactResource =
     "v1" Core.:>
       Core.CaptureMode "resourceName" "updateContact"
         Core.Text
         Core.:>
           ...
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "personFields" Core.GFieldMask
                 Core.:>
                 Core.QueryParams "sources" PeopleUpdateContactSources
                   Core.:>
                   Core.QueryParam "updatePersonFields" Core.GFieldMask
                     Core.:>
...
instance Core.GoogleRequest PeoplePeopleUpdateContact
         where
        type Rs PeoplePeopleUpdateContact = Person
        type Scopes PeoplePeopleUpdateContact =
        ...
        requestClient PeoplePeopleUpdateContact{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PeoplePeopleUpdateContactResource)
                      Core.mempty
