...
type PlayMoviesPartnerAccountsOrdersListResource =
  "v1"
    ...
    Core.:> Core.QueryParam "customId" Core.Text
...
instance Core.GoogleRequest PlayMoviesPartnerAccountsOrdersList where
