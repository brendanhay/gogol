...
instance Core.FromJSON Avail where
        parseJSON
          = Core.withObject "Avail"
              (\ o ->
                 Avail Core.<$>
                   (o Core..:? "altId") Core.<*> (o Core..:? "availId")
          ...
          = Core.object
              (Core.catMaybes
                 [("altId" Core..=) Core.<$> altId,
                  ...
                  ("suppressionLiftDate" Core..=) Core.<$>
                    suppressionLiftDate,
                  ("territory" Core..=) Core.<$> territory,
                  ("titleInternalAlias" Core..=) Core.<$>
                    titleInternalAlias,
          ...
          = Core.withObject "ListAvailsResponse"
              (\ o ->
                 ListAvailsResponse Core.<$>
                   (o Core..:? "avails" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 ListOrdersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "orders" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "totalSize"))
          ...
          = Core.withObject "ListStoreInfosResponse"
              (\ o ->
                 ListStoreInfosResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "storeInfos" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "totalSize"))
              ...
              (\ o ->
                 StoreInfo Core.<$>
                   (o Core..:? "audioTracks" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "studioName")
                     Core.<*>
                     (o Core..:? "subtitles" Core..!= Core.mempty)
