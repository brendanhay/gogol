                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.QueryParam "uploadType" Core.Multipart
                                 Core.:>
                                 Core.MultipartRelated '[Core.JSON] CustomApp
...
instance Core.GoogleRequest
           PlayCustomAppAccountsCustomAppsCreate
         where
        type Rs PlayCustomAppAccountsCustomAppsCreate =
             CustomApp
        type Scopes PlayCustomAppAccountsCustomAppsCreate =
             '["https://www.googleapis.com/auth/androidpublisher"]
        requestClient
          PlayCustomAppAccountsCustomAppsCreate{..}
          = go account xgafv accessToken callback uploadType
              uploadProtocol
...
instance Core.GoogleRequest
        ...
        requestClient
          (Core.MediaUpload
             PlayCustomAppAccountsCustomAppsCreate{..} body)
          = go account xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
