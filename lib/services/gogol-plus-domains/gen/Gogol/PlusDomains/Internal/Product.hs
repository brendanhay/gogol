              ...
              (\ o ->
                 Activity_Object_AttachmentsItem Core.<$>
                   (o Core..:? "content") Core.<*>
                     ...
                     Core.<*> (o Core..:? "objectType")
                     Core.<*>
                     (o Core..:? "previewThumbnails" Core..!= Core.mempty)
                     Core.<*>
          ...
          = Core.withObject "Activity_Object_StatusForViewer"
              (\ o ->
                 Activity_Object_StatusForViewer Core.<$>
                   (o Core..:? "canComment") Core.<*>
                     (o Core..:? "canPlusone")
                     Core.<*> (o Core..:? "canUpdate")
                     Core.<*> (o Core..:? "isPlusOned")
                     Core.<*> (o Core..:? "resharingDisabled"))

instance Core.ToJSON Activity_Object_StatusForViewer
         where
...
instance Core.FromJSON PlusDomainsAclentryResource
         where
        parseJSON
...
instance Core.ToJSON PlusDomainsAclentryResource
         where
