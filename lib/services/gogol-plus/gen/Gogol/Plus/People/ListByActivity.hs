...
instance Core.GoogleRequest PlusPeopleListByActivity
         where
        type Rs PlusPeopleListByActivity = PeopleFeed
        type Scopes PlusPeopleListByActivity =
             '["https://www.googleapis.com/auth/plus.login",
               "https://www.googleapis.com/auth/plus.me"]
        requestClient PlusPeopleListByActivity{..}
          = go activityId collection (Core.Just maxResults)
              pageToken
