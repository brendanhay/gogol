...
type PolyAssetsListResource =
  "v1"
    ...
    Core.:> Core.QueryParam "curated" Core.Bool
    Core.:> Core.QueryParam "format" Core.Text
    Core.:> Core.QueryParam "keywords" Core.Text
    Core.:> Core.QueryParam "maxComplexity" AssetsListMaxComplexity
    ...
    Core.:> Core.Get '[Core.JSON] ListAssetsResponse
