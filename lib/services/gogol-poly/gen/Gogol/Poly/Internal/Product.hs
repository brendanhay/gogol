              ...
              (\ o ->
                 ListUserAssetsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "totalSize")
                     Core.<*>
                     (o Core..:? "userAssets" Core..!= Core.mempty))
...
instance Core.FromJSON ObjParseError where
        parseJSON
          = Core.withObject "ObjParseError"
              (\ o ->
                 ObjParseError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "endIndex")
...
newQuaternion =
  Quaternion
    {w = Core.Nothing, x = Core.Nothing, y = Core.Nothing, z = Core.Nothing}
...
instance Core.FromJSON RemixInfo where
        parseJSON
          = Core.withObject "RemixInfo"
              (\ o ->
                 RemixInfo Core.<$>
                   (o Core..:? "sourceAsset" Core..!= Core.mempty))
          ...
          = Core.withObject "StartAssetImportResponse"
              (\ o ->
                 StartAssetImportResponse Core.<$>
                   (o Core..:? "assetId") Core.<*>
                     (o Core..:? "assetImportId")
                     Core.<*>
                     (o Core..:? "assetImportMessages" Core..!=
                        Core.mempty)
