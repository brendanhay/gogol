...
type ProximityBeaconBeaconsDiagnosticsListResource =
  "v1beta1"
    ...
    Core.:> Core.QueryParam "alertFilter" Core.Text
    ...
    Core.:> Core.Get '[Core.JSON] ListDiagnosticsResponse
...
instance Core.GoogleRequest ProximityBeaconBeaconsDiagnosticsList where
  type
    Rs ProximityBeaconBeaconsDiagnosticsList =
