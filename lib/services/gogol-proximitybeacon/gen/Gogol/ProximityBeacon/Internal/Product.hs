...
newBeacon_Properties 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Beacon_Properties
newBeacon_Properties addtional = Beacon_Properties {addtional = addtional}
...
instance Core.ToJSON Beacon_Properties where
        toJSON Beacon_Properties{..} = Core.toJSON addtional
...
instance Core.FromJSON DeleteAttachmentsResponse
         where
        parseJSON
          = Core.withObject "DeleteAttachmentsResponse"
              (\ o ->
                 DeleteAttachmentsResponse Core.<$>
                   (o Core..:? "numDeleted"))
...
instance Core.ToJSON EphemeralIdRegistration where
        toJSON EphemeralIdRegistration{..}
          = Core.object
              (Core.catMaybes
                 [("beaconEcdhPublicKey" Core..=) Core.<$>
                    beaconEcdhPublicKey,
                  ("beaconIdentityKey" Core..=) Core.<$>
                    beaconIdentityKey,
                  ("initialClockValue" Core..=) Core.. Core.AsText
                    Core.<$> initialClockValue,
                  ("initialEid" Core..=) Core.<$> initialEid,
                  ("rotationPeriodExponent" Core..=) Core.<$>
                    rotationPeriodExponent,
                  ("serviceEcdhPublicKey" Core..=) Core.<$>
...
instance Core.FromJSON EphemeralIdRegistrationParams
         where
        parseJSON
...
instance Core.ToJSON EphemeralIdRegistrationParams
         where
...
newGetInfoForObservedBeaconsRequest =
  GetInfoForObservedBeaconsRequest
    {namespacedTypes = Core.Nothing, observations = Core.Nothing}
          ...
          = Core.withObject "GetInfoForObservedBeaconsRequest"
              (\ o ->
                 GetInfoForObservedBeaconsRequest Core.<$>
                   (o Core..:? "namespacedTypes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "observations" Core..!= Core.mempty))

instance Core.ToJSON GetInfoForObservedBeaconsRequest
         where
        toJSON GetInfoForObservedBeaconsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("namespacedTypes" Core..=) Core.<$>
                    namespacedTypes,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GetInfoForObservedBeaconsResponse"
              (\ o ->
                 GetInfoForObservedBeaconsResponse Core.<$>
                   (o Core..:? "beacons" Core..!= Core.mempty))
...
instance Core.FromJSON ListBeaconAttachmentsResponse
         where
        parseJSON
          = Core.withObject "ListBeaconAttachmentsResponse"
              (\ o ->
                 ListBeaconAttachmentsResponse Core.<$>
                   (o Core..:? "attachments" Core..!= Core.mempty))

instance Core.ToJSON ListBeaconAttachmentsResponse
         where
          ...
          = Core.withObject "ListBeaconsResponse"
              (\ o ->
                 ListBeaconsResponse Core.<$>
                   (o Core..:? "beacons" Core..!= Core.mempty) Core.<*>
...
newListDiagnosticsResponse =
  ListDiagnosticsResponse
    {diagnostics = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListDiagnosticsResponse"
              (\ o ->
                 ListDiagnosticsResponse Core.<$>
                   (o Core..:? "diagnostics" Core..!= Core.mempty)
          ...
          = Core.withObject "ListNamespacesResponse"
              (\ o ->
                 ListNamespacesResponse Core.<$>
                   (o Core..:? "namespaces" Core..!= Core.mempty))
