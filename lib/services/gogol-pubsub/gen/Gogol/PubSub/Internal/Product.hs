...
instance Core.FromJSON AcknowledgeRequest where
        parseJSON
          = Core.withObject "AcknowledgeRequest"
              (\ o ->
                 AcknowledgeRequest Core.<$>
                   (o Core..:? "ackIds" Core..!= Core.mempty))
...
newCreateSnapshotRequest_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> CreateSnapshotRequest_Labels
newCreateSnapshotRequest_Labels addtional =
  CreateSnapshotRequest_Labels {addtional = addtional}
          ...
          = Core.withObject "ListTopicsResponse"
              (\ o ->
                 ListTopicsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "topics" Core..!= Core.mempty))
          ...
          = Core.withObject "PublishResponse"
              (\ o ->
                 PublishResponse Core.<$>
                   (o Core..:? "messageIds" Core..!= Core.mempty))
...
instance Core.FromJSON PullResponse where
        parseJSON
          = Core.withObject "PullResponse"
              (\ o ->
                 PullResponse Core.<$>
                   (o Core..:? "receivedMessages" Core..!= Core.mempty))
...
newPushConfig_Attributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> PushConfig_Attributes
newPushConfig_Attributes addtional =
  PushConfig_Attributes {addtional = addtional}
...
newSubscription_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Subscription_Labels
newSubscription_Labels addtional = Subscription_Labels {addtional = addtional}
...
newTopic_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Topic_Labels
newTopic_Labels addtional = Topic_Labels {addtional = addtional}
...
instance Core.ToJSON Topic_Labels where
        toJSON Topic_Labels{..} = Core.toJSON addtional
