...
newAnalyticsHubSubscriptionInfo =
  AnalyticsHubSubscriptionInfo
    {listing = Core.Nothing, subscription = Core.Nothing}

instance Core.FromJSON AnalyticsHubSubscriptionInfo
         where
        parseJSON
...
instance Core.ToJSON AnalyticsHubSubscriptionInfo
         where
...
newAvroConfig 
    ::  AvroConfig
newAvroConfig =
  AvroConfig {useTopicSchema = Core.Nothing, writeMetadata = Core.Nothing}
...
instance Core.FromJSON AvroFormat where
        parseJSON
          = Core.withObject "AvroFormat"
              (\ o -> Core.pure AvroFormat)
          ...
          = Core.object
              (Core.catMaybes
                 [("avroConfig" Core..=) Core.<$> avroConfig,
                  ("bucket" Core..=) Core.<$> bucket,
                  ("filenameDatetimeFormat" Core..=) Core.<$>
                  ...
                  ("maxMessages" Core..=) Core.. Core.AsText Core.<$>
                    maxMessages,
                  ("serviceAccountEmail" Core..=) Core.<$>
                    serviceAccountEmail,
                  ("state" Core..=) Core.<$> state,
...
instance Core.FromJSON IngestionDataSourceSettings
         where
        parseJSON
          = Core.withObject "IngestionDataSourceSettings"
              (\ o ->
                 IngestionDataSourceSettings Core.<$>
                   (o Core..:? "awsKinesis") Core.<*>
                     (o Core..:? "cloudStorage")
                     Core.<*> (o Core..:? "platformLogsSettings"))

instance Core.ToJSON IngestionDataSourceSettings
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("awsKinesis" Core..=) Core.<$> awsKinesis,
                  ...
                  ("platformLogsSettings" Core..=) Core.<$>
                    platformLogsSettings])
...
newMessageStoragePolicy =
  MessageStoragePolicy
    {allowedPersistenceRegions = Core.Nothing, enforceInTransit = Core.Nothing}
...
instance Core.FromJSON NoWrapper where
        parseJSON
          = Core.withObject "NoWrapper"
              (\ o ->
                 NoWrapper Core.<$> (o Core..:? "writeMetadata"))
...
newPlatformLogsSettings 
    ::  PlatformLogsSettings
newPlatformLogsSettings = PlatformLogsSettings {severity = Core.Nothing}

instance Core.FromJSON PlatformLogsSettings where
        parseJSON
          = Core.withObject "PlatformLogsSettings"
              (\ o ->
                 PlatformLogsSettings Core.<$>
                   (o Core..:? "severity"))
...
instance Core.FromJSON PubsubWrapper where
        parseJSON
          = Core.withObject "PubsubWrapper"
              (\ o -> Core.pure PubsubWrapper)
