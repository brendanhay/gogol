                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" ProjectsSchemasListView
                           Core.:>
...
instance Core.GoogleRequest PubSubProjectsSchemasList
         where
        type Rs PubSubProjectsSchemasList =
             ListSchemasResponse
        ...
        requestClient PubSubProjectsSchemasList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSchemasListResource)
                      Core.mempty
