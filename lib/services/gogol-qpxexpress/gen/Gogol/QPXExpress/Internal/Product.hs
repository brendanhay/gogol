...
newAircraftData =
  AircraftData
    {code = Core.Nothing, kind = "qpxexpress#aircraftData", name = Core.Nothing}
...
instance Core.FromJSON BagDescriptor where
        parseJSON
          = Core.withObject "BagDescriptor"
              (\ o ->
                 BagDescriptor Core.<$>
                   (o Core..:? "commercialName") Core.<*>
                     (o Core..:? "count")
                     Core.<*>
                     (o Core..:? "description" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
newCarrierData =
  CarrierData
    {code = Core.Nothing, kind = "qpxexpress#carrierData", name = Core.Nothing}
...
instance Core.FromJSON Data' where
        parseJSON
          = Core.withObject "Data'"
              (\ o ->
                 Data' Core.<$>
                   (o Core..:? "aircraft" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "airport" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "carrier" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "city" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#data")
...
instance Core.FromJSON FareInfo where
        parseJSON
          = Core.withObject "FareInfo"
              (\ o ->
                 FareInfo Core.<$>
                   (o Core..:? "basisCode") Core.<*>
                     (o Core..:? "carrier")
                     Core.<*> (o Core..:? "destination")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#fareInfo")
                     Core.<*> (o Core..:? "origin")
                     Core.<*> (o Core..:? "private"))
...
newFlightInfo 
    ::  FlightInfo
newFlightInfo = FlightInfo {carrier = Core.Nothing, number = Core.Nothing}
          ...
          = Core.withObject "FreeBaggageAllowance"
              (\ o ->
                 FreeBaggageAllowance Core.<$>
                   (o Core..:? "bagDescriptor" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kilos")
                     Core.<*> (o Core..:? "kilosPerPiece")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "qpxexpress#freeBaggageAllowance")
                     Core.<*> (o Core..:? "pieces")
                     Core.<*> (o Core..:? "pounds"))
              ...
              (\ o ->
                 LegInfo Core.<$>
                   (o Core..:? "aircraft") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#legInfo")
                     Core.<*> (o Core..:? "meal")
                     Core.<*> (o Core..:? "mileage")
          ...
          = Core.object
              (Core.catMaybes
                 [("aircraft" Core..=) Core.<$> aircraft,
                  ...
                  ("connectionDuration" Core..=) Core.<$>
                    connectionDuration,
                  ("departureTime" Core..=) Core.<$> departureTime,
                  ("destination" Core..=) Core.<$> destination,
                  ("destinationTerminal" Core..=) Core.<$>
                    destinationTerminal,
                  ...
                  ("onTimePerformance" Core..=) Core.<$>
                    onTimePerformance,
                  ("operatingDisclosure" Core..=) Core.<$>
                    operatingDisclosure,
                  ("origin" Core..=) Core.<$> origin,
          ...
          = Core.object
              (Core.catMaybes
                 [("adultCount" Core..=) Core.<$> adultCount,
                  ...
                  ("infantInLapCount" Core..=) Core.<$>
                    infantInLapCount,
                  ("infantInSeatCount" Core..=) Core.<$>
                    infantInSeatCount,
                  Core.Just ("kind" Core..= kind),
...
instance Core.FromJSON PricingInfo where
        parseJSON
          = Core.withObject "PricingInfo"
              (\ o ->
                 PricingInfo Core.<$>
                   (o Core..:? "baseFareTotal") Core.<*>
                     (o Core..:? "fare" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fareCalculation")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#pricingInfo")
                     ...
                     Core.<*>
                     (o Core..:? "segmentPricing" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "tax" Core..!= Core.mempty))
...
instance Core.FromJSON SegmentInfo where
        parseJSON
          = Core.withObject "SegmentInfo"
              (\ o ->
                 SegmentInfo Core.<$>
                   (o Core..:? "bookingCode") Core.<*>
                     (o Core..:? "bookingCodeCount")
                     Core.<*> (o Core..:? "cabin")
                     Core.<*> (o Core..:? "connectionDuration")
                     Core.<*> (o Core..:? "duration")
                     Core.<*> (o Core..:? "flight")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#segmentInfo")
        ...
        parseJSON
          = Core.withObject "SegmentPricing"
              (\ o ->
                 SegmentPricing Core.<$>
                   (o Core..:? "fareId") Core.<*>
                     (o Core..:? "freeBaggageOption" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.FromJSON SliceInput where
        parseJSON
          = Core.withObject "SliceInput"
              (\ o ->
                 SliceInput Core.<$>
                   (o Core..:? "alliance") Core.<*> (o Core..:? "date")
                     Core.<*> (o Core..:? "destination")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#sliceInput")
                     Core.<*> (o Core..:? "maxConnectionDuration")
                     Core.<*> (o Core..:? "maxStops")
                     Core.<*> (o Core..:? "origin")
                     Core.<*>
                     (o Core..:? "permittedCarrier" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "permittedDepartureTime")
                     Core.<*> (o Core..:? "preferredCabin")
                     Core.<*>
                     (o Core..:? "prohibitedCarrier" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("alliance" Core..=) Core.<$> alliance,
                  ...
                  ("destination" Core..=) Core.<$> destination,
                  Core.Just ("kind" Core..= kind),
                  ("maxConnectionDuration" Core..=) Core.<$>
                    maxConnectionDuration,
                  ("maxStops" Core..=) Core.<$> maxStops,
                  ("origin" Core..=) Core.<$> origin,
                  ("permittedCarrier" Core..=) Core.<$>
                    permittedCarrier,
                  ("permittedDepartureTime" Core..=) Core.<$>
                    permittedDepartureTime,
                  ("preferredCabin" Core..=) Core.<$> preferredCabin,
                  ("prohibitedCarrier" Core..=) Core.<$>
                    prohibitedCarrier])
...
newTaxData 
    ::  TaxData
newTaxData =
  TaxData {id = Core.Nothing, kind = "qpxexpress#taxData", name = Core.Nothing}
...
instance Core.FromJSON TaxInfo where
        parseJSON
          = Core.withObject "TaxInfo"
              (\ o ->
                 TaxInfo Core.<$>
                   (o Core..:? "chargeType") Core.<*>
                     (o Core..:? "code")
                     Core.<*> (o Core..:? "country")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#taxInfo")
              ...
              (\ o ->
                 TripOptionsResponse Core.<$>
                   (o Core..:? "data") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "tripOption" Core..!= Core.mempty))
...
instance Core.FromJSON TripsSearchRequest where
        parseJSON
          = Core.withObject "TripsSearchRequest"
              (\ o ->
                 TripsSearchRequest Core.<$> (o Core..:? "request"))
...
newTripsSearchResponse 
    ::  TripsSearchResponse
newTripsSearchResponse =
  TripsSearchResponse {kind = "qpxExpress#tripsSearch", trips = Core.Nothing}
          ...
          = Core.withObject "TripsSearchResponse"
              (\ o ->
                 TripsSearchResponse Core.<$>
                   (o Core..:? "kind" Core..!= "qpxExpress#tripsSearch")
                     Core.<*> (o Core..:? "trips"))
