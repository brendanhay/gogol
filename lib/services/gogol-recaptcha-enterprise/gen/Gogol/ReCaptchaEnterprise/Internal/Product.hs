...
newGoogleCloudRecaptchaenterpriseV1AndroidKeySettings =
  GoogleCloudRecaptchaenterpriseV1AndroidKeySettings
    { allowAllPackageNames = Core.Nothing
    , allowedPackageNames = Core.Nothing
    , supportNonGoogleAppStoreDistribution = Core.Nothing
    }
              ...
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1AndroidKeySettings
                   ...
                   (o Core..:? "allowAllPackageNames") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "supportNonGoogleAppStoreDistribution"))
...
newGoogleCloudRecaptchaenterpriseV1AppleDeveloperId =
  GoogleCloudRecaptchaenterpriseV1AppleDeveloperId
    {keyId = Core.Nothing, privateKey = Core.Nothing, teamId = Core.Nothing}
              ...
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1Assessment Core.<$>
                   (o Core..:? "accountDefenderAssessment") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "privatePasswordLeakVerification")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountDefenderAssessment" Core..=) Core.<$>
                  ...
                  ("accountVerification" Core..=) Core.<$>
                    accountVerification,
                  ("assessmentEnvironment" Core..=) Core.<$>
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("phoneFraudAssessment" Core..=) Core.<$>
...
newGoogleCloudRecaptchaenterpriseV1AssessmentEnvironment =
  GoogleCloudRecaptchaenterpriseV1AssessmentEnvironment
    {client = Core.Nothing, version = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("emailAddress" Core..=) Core.<$> emailAddress,
                  ("lastVerificationTime" Core..=) Core.<$>
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1FirewallAction
                   Core.<$>
                   (o Core..:? "allow") Core.<*> (o Core..:? "block")
          ...
          = Core.object
              (Core.catMaybes
                 [("allow" Core..=) Core.<$> allow,
                  ...
                  ("includeRecaptchaScript" Core..=) Core.<$>
...
newGoogleCloudRecaptchaenterpriseV1FirewallPolicyAssessment =
  GoogleCloudRecaptchaenterpriseV1FirewallPolicyAssessment
    {error = Core.Nothing, firewallPolicy = Core.Nothing}
...
newGoogleCloudRecaptchaenterpriseV1FraudPreventionAssessment =
  GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessment
    { behavioralTrustVerdict = Core.Nothing
    , cardTestingVerdict = Core.Nothing
    , stolenInstrumentVerdict = Core.Nothing
          ...
          = Core.object
              (Core.catMaybes
                 [("behavioralTrustVerdict" Core..=) Core.<$>
                  ...
                  ("cardTestingVerdict" Core..=) Core.<$>
                    cardTestingVerdict,
                  ("stolenInstrumentVerdict" Core..=) Core.<$>
                    stolenInstrumentVerdict,
                  ("transactionRisk" Core..=) Core.<$>
                    transactionRisk])
...
instance Core.ToJSON
        ...
        toJSON
          GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentBehavioralTrustVerdict{..}
          = Core.object
              (Core.catMaybes [("trust" Core..=) Core.<$> trust])
...
instance Core.ToJSON
        ...
        toJSON
          GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentCardTestingVerdict{..}
          = Core.object
              (Core.catMaybes [("risk" Core..=) Core.<$> risk])
...
newGoogleCloudRecaptchaenterpriseV1FraudSignals =
  GoogleCloudRecaptchaenterpriseV1FraudSignals
    {cardSignals = Core.Nothing, userSignals = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("cardLabels" Core..=) Core.<$> cardLabels])
...
newGoogleCloudRecaptchaenterpriseV1FraudSignalsUserSignals =
  GoogleCloudRecaptchaenterpriseV1FraudSignalsUserSignals
    {activeDaysLowerBound = Core.Nothing, syntheticRisk = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("activeDaysLowerBound" Core..=) Core.<$>
...
newGoogleCloudRecaptchaenterpriseV1IOSKeySettings =
  GoogleCloudRecaptchaenterpriseV1IOSKeySettings
    { allowAllBundleIds = Core.Nothing
...
newGoogleCloudRecaptchaenterpriseV1IpOverrideData =
  GoogleCloudRecaptchaenterpriseV1IpOverrideData
    {ip = Core.Nothing, overrideType = Core.Nothing}
...
newGoogleCloudRecaptchaenterpriseV1ListFirewallPoliciesResponse =
  GoogleCloudRecaptchaenterpriseV1ListFirewallPoliciesResponse
    {firewallPolicies = Core.Nothing, nextPageToken = Core.Nothing}
...
newGoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse =
  GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse
    {ipOverrides = Core.Nothing, nextPageToken = Core.Nothing}
...
newGoogleCloudRecaptchaenterpriseV1PhoneFraudAssessment =
  GoogleCloudRecaptchaenterpriseV1PhoneFraudAssessment
    {smsTollFraudVerdict = Core.Nothing}
...
newGoogleCloudRecaptchaenterpriseV1PrivatePasswordLeakVerification =
  GoogleCloudRecaptchaenterpriseV1PrivatePasswordLeakVerification
    { encryptedLeakMatchPrefixes = Core.Nothing
    , encryptedUserCredentialsHash = Core.Nothing
    , lookupHashPrefix = Core.Nothing
    , reencryptedUserCredentialsHash = Core.Nothing
    }
              ...
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1PrivatePasswordLeakVerification
                   ...
                   (o Core..:? "encryptedLeakMatchPrefixes") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "reencryptedUserCredentialsHash"))
          ...
          = Core.object
              (Core.catMaybes
                 [("challenge" Core..=) Core.<$> challenge,
                  ("extendedVerdictReasons" Core..=) Core.<$>
...
newGoogleCloudRecaptchaenterpriseV1SmsTollFraudVerdict =
  GoogleCloudRecaptchaenterpriseV1SmsTollFraudVerdict
    {reasons = Core.Nothing, risk = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("avsResponseCode" Core..=) Core.<$>
                    avsResponseCode,
                  ("cvvResponseCode" Core..=) Core.<$> cvvResponseCode,
                  ("gatewayResponseCode" Core..=) Core.<$>
                    gatewayResponseCode,
                  ("name" Core..=) Core.<$> name])
...
newGoogleCloudRecaptchaenterpriseV1TransactionDataItem =
  GoogleCloudRecaptchaenterpriseV1TransactionDataItem
    { merchantAccountId = Core.Nothing
    , name = Core.Nothing
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("creationMs" Core..=) Core.. Core.AsText Core.<$>
                    creationMs,
...
newGoogleCloudRecaptchaenterpriseV1UserId =
  GoogleCloudRecaptchaenterpriseV1UserId
    {email = Core.Nothing, phoneNumber = Core.Nothing, username = Core.Nothing}
