...
type ReCaptchaEnterpriseProjectsKeysListIpOverridesResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "listIpOverrides" Core.Text
...
instance
  ...
  where
  type
    Rs ReCaptchaEnterpriseProjectsKeysListIpOverrides =
      GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse
  type
    Scopes ReCaptchaEnterpriseProjectsKeysListIpOverrides =
