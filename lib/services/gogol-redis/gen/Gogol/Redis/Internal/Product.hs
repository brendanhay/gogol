...
instance Core.FromJSON AOFConfig where
        parseJSON
          = Core.withObject "AOFConfig"
              (\ o ->
                 AOFConfig Core.<$> (o Core..:? "appendFsync"))

instance Core.ToJSON AOFConfig where
        toJSON AOFConfig{..}
          = Core.object
              (Core.catMaybes
                 [("appendFsync" Core..=) Core.<$> appendFsync])
...
instance Core.ToJSON AutomatedBackupConfig where
        toJSON AutomatedBackupConfig{..}
          = Core.object
              (Core.catMaybes
                 [("automatedBackupMode" Core..=) Core.<$>
                    automatedBackupMode,
                  ("fixedFrequencySchedule" Core..=) Core.<$>
                    fixedFrequencySchedule,
...
newAvailabilityConfiguration =
  AvailabilityConfiguration
    { automaticFailoverRoutingConfigured = Core.Nothing
...
instance Core.FromJSON AvailabilityConfiguration
         where
        parseJSON
          = Core.withObject "AvailabilityConfiguration"
              (\ o ->
                 AvailabilityConfiguration Core.<$>
                   (o Core..:? "automaticFailoverRoutingConfigured")
          ...
          = Core.object
              (Core.catMaybes
                 [("backupFiles" Core..=) Core.<$> backupFiles,
                  ...
                  ("totalSizeBytes" Core..=) Core.. Core.AsText
                    Core.<$> totalSizeBytes,
                  ("uid" Core..=) Core.<$> uid])
...
instance Core.FromJSON BackupRun where
        parseJSON
          = Core.withObject "BackupRun"
              (\ o ->
                 BackupRun Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "error")
...
instance Core.FromJSON CertChain where
        parseJSON
          = Core.withObject "CertChain"
              (\ o ->
                 CertChain Core.<$> (o Core..:? "certificates"))
...
newCertificateAuthority 
    ::  CertificateAuthority
newCertificateAuthority =
  CertificateAuthority {managedServerCa = Core.Nothing, name = Core.Nothing}
...
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster"
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "authorizationMode") Core.<*>
                     (o Core..:? "automatedBackupConfig")
...
instance Core.ToJSON Cluster where
        toJSON Cluster{..}
          = Core.object
              (Core.catMaybes
                 [("authorizationMode" Core..=) Core.<$>
                    authorizationMode,
                  ("automatedBackupConfig" Core..=) Core.<$>
                    automatedBackupConfig,
                  ("backupCollection" Core..=) Core.<$>
                    backupCollection,
                  ("clusterEndpoints" Core..=) Core.<$>
                    clusterEndpoints,
                  ("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("pscServiceAttachments" Core..=) Core.<$>
...
instance Core.FromJSON ClusterEndpoint where
        parseJSON
          = Core.withObject "ClusterEndpoint"
              (\ o ->
                 ClusterEndpoint Core.<$> (o Core..:? "connections"))
...
newClusterMaintenanceSchedule 
    ::  ClusterMaintenanceSchedule
newClusterMaintenanceSchedule =
  ClusterMaintenanceSchedule {endTime = Core.Nothing, startTime = Core.Nothing}

instance Core.FromJSON ClusterMaintenanceSchedule
         where
        parseJSON
...
newClusterPersistenceConfig =
  ClusterPersistenceConfig
    {aofConfig = Core.Nothing, mode = Core.Nothing, rdbConfig = Core.Nothing}
          ...
          = Core.withObject "ClusterPersistenceConfig"
              (\ o ->
                 ClusterPersistenceConfig Core.<$>
                   (o Core..:? "aofConfig") Core.<*> (o Core..:? "mode")
...
newClusterWeeklyMaintenanceWindow 
    ::  ClusterWeeklyMaintenanceWindow
newClusterWeeklyMaintenanceWindow =
  ClusterWeeklyMaintenanceWindow {day = Core.Nothing, startTime = Core.Nothing}

instance Core.FromJSON ClusterWeeklyMaintenanceWindow
         where
        parseJSON
...
instance Core.ToJSON ClusterWeeklyMaintenanceWindow
         where
...
newCompliance 
    ::  Compliance
newCompliance = Compliance {standard = Core.Nothing, version = Core.Nothing}
...
newConnectionDetail =
  ConnectionDetail
    {pscAutoConnection = Core.Nothing, pscConnection = Core.Nothing}
...
instance Core.ToJSON DatabaseResourceHealthSignalData
         where
        toJSON DatabaseResourceHealthSignalData{..}
          = Core.object
              (Core.catMaybes
                 [("additionalMetadata" Core..=) Core.<$>
                    additionalMetadata,
...
newDatabaseResourceHealthSignalData_AdditionalMetadata additional =
  DatabaseResourceHealthSignalData_AdditionalMetadata {additional = additional}
          ...
          = Core.withObject "DatabaseResourceId"
              (\ o ->
                 DatabaseResourceId Core.<$>
                   (o Core..:? "provider") Core.<*>
                     (o Core..:? "providerDescription")
...
newDatabaseResourceMetadata =
  DatabaseResourceMetadata
    { availabilityConfiguration = Core.Nothing
          ...
          = Core.object
              (Core.catMaybes
                 [("availabilityConfiguration" Core..=) Core.<$>
                  ...
                  ("machineConfiguration" Core..=) Core.<$>
                    machineConfiguration,
                  ("primaryResourceId" Core..=) Core.<$>
                    primaryResourceId,
...
newDatabaseResourceRecommendationSignalData_AdditionalMetadata 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'additional'.
    -> DatabaseResourceRecommendationSignalData_AdditionalMetadata
newDatabaseResourceRecommendationSignalData_AdditionalMetadata additional =
  DatabaseResourceRecommendationSignalData_AdditionalMetadata
...
newDiscoveryEndpoint =
  DiscoveryEndpoint
    {address = Core.Nothing, port = Core.Nothing, pscConfig = Core.Nothing}
          ...
          = Core.withObject "DiscoveryEndpoint"
              (\ o ->
                 DiscoveryEndpoint Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "port")
...
newEntitlement 
    ::  Entitlement
newEntitlement =
  Entitlement {entitlementState = Core.Nothing, type' = Core.Nothing}
...
newExportBackupRequest 
    ::  ExportBackupRequest
newExportBackupRequest = ExportBackupRequest {gcsBucket = Core.Nothing}

instance Core.FromJSON ExportBackupRequest where
        parseJSON
          = Core.withObject "ExportBackupRequest"
              (\ o ->
                 ExportBackupRequest Core.<$>
                   (o Core..:? "gcsBucket"))
...
newFixedFrequencySchedule 
    ::  FixedFrequencySchedule
newFixedFrequencySchedule = FixedFrequencySchedule {startTime = Core.Nothing}

instance Core.FromJSON FixedFrequencySchedule where
        parseJSON
          = Core.withObject "FixedFrequencySchedule"
              (\ o ->
                 FixedFrequencySchedule Core.<$>
                   (o Core..:? "startTime"))
...
instance Core.ToJSON GcsBackupSource where
        toJSON GcsBackupSource{..}
          = Core.object
              (Core.catMaybes [("uris" Core..=) Core.<$> uris])
...
instance Core.FromJSON ListBackupCollectionsResponse
         where
        parseJSON
...
instance Core.ToJSON ListBackupCollectionsResponse
         where
        toJSON ListBackupCollectionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("backupCollections" Core..=) Core.<$>
                    backupCollections,
          ...
          = Core.object
              (Core.catMaybes
                 [("cpuCount" Core..=) Core.<$> cpuCount,
                  ("memorySizeInBytes" Core..=) Core.. Core.AsText
...
instance Core.FromJSON ManagedBackupSource where
        parseJSON
          = Core.withObject "ManagedBackupSource"
              (\ o ->
                 ManagedBackupSource Core.<$> (o Core..:? "backup"))

instance Core.ToJSON ManagedBackupSource where
        toJSON ManagedBackupSource{..}
          = Core.object
              (Core.catMaybes [("backup" Core..=) Core.<$> backup])
...
instance Core.FromJSON ManagedCertificateAuthority
         where
        parseJSON
          = Core.withObject "ManagedCertificateAuthority"
              (\ o ->
                 ManagedCertificateAuthority Core.<$>
                   (o Core..:? "caCerts"))

instance Core.ToJSON ManagedCertificateAuthority
         where
...
newMembership 
    ::  Membership
newMembership =
  Membership {primaryCluster = Core.Nothing, secondaryClusters = Core.Nothing}
...
newOperationError =
  OperationError
    {code = Core.Nothing, errorType = Core.Nothing, message = Core.Nothing}
...
instance Core.FromJSON OperationError where
        parseJSON
          = Core.withObject "OperationError"
              (\ o ->
                 OperationError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "errorType")
                     Core.<*> (o Core..:? "message"))
...
newProduct 
    ::  Product
newProduct =
  Product {engine = Core.Nothing, type' = Core.Nothing, version = Core.Nothing}
...
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "engine") Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("pscConnectionStatus" Core..=) Core.<$>
                    pscConnectionStatus,
                  ("serviceAttachment" Core..=) Core.<$>
                    serviceAttachment])
...
newPscServiceAttachment =
  PscServiceAttachment
    {connectionType = Core.Nothing, serviceAttachment = Core.Nothing}
...
newRDBConfig =
  RDBConfig
    {rdbSnapshotPeriod = Core.Nothing, rdbSnapshotStartTime = Core.Nothing}
...
newRemoteCluster 
    ::  RemoteCluster
newRemoteCluster = RemoteCluster {cluster = Core.Nothing, uid = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("durationBasedRetention" Core..=) Core.<$>
                  ...
                  ("quantityBasedRetention" Core..=) Core.<$>
                    quantityBasedRetention,
                  ("retentionUnit" Core..=) Core.<$> retentionUnit,
                  ("timeBasedRetention" Core..=) Core.<$>
                    timeBasedRetention,
...
instance Core.FromJSON Tags where
        parseJSON
          = Core.withObject "Tags"
              (\ o -> Tags Core.<$> (o Core..:? "tags"))
...
instance Core.FromJSON UpdateInfo where
        parseJSON
          = Core.withObject "UpdateInfo"
              (\ o ->
                 UpdateInfo Core.<$>
                   (o Core..:? "targetReplicaCount") Core.<*>
                     (o Core..:? "targetShardCount"))

instance Core.ToJSON UpdateInfo where
        toJSON UpdateInfo{..}
          = Core.object
              (Core.catMaybes
                 [("targetReplicaCount" Core..=) Core.<$>
                    targetReplicaCount,
                  ("targetShardCount" Core..=) Core.<$>
                    targetShardCount])
...
newUserLabels_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> UserLabels_Labels
newUserLabels_Labels additional = UserLabels_Labels {additional = additional}

instance Core.FromJSON UserLabels_Labels where
        parseJSON
          = Core.withObject "UserLabels_Labels"
              (\ o ->
                 UserLabels_Labels Core.<$> (Core.parseJSONObject o))
