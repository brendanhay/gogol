...
newtype GoogleCloudRedisV1LocationMetadata_AvailableZones = GoogleCloudRedisV1LocationMetadata_AvailableZones
    {
      -- | 
      addtional :: (Core.HashMap Core.Text GoogleCloudRedisV1ZoneMetadata)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleCloudRedisV1LocationMetadata_AvailableZones 
    ::  Core.HashMap Core.Text GoogleCloudRedisV1ZoneMetadata
       -- ^  See 'addtional'.
    -> GoogleCloudRedisV1LocationMetadata_AvailableZones
newGoogleCloudRedisV1LocationMetadata_AvailableZones addtional =
  GoogleCloudRedisV1LocationMetadata_AvailableZones {addtional = addtional}
              ...
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "alternativeLocationId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "serverCaCerts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "state")
...
newInstance_RedisConfigs 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Instance_RedisConfigs
newInstance_RedisConfigs addtional =
  Instance_RedisConfigs {addtional = addtional}
              ...
              (\ o ->
                 MaintenancePolicy Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "weeklyMaintenanceWindow" Core..!=
                        Core.mempty))
