              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2ActionResult Core.<$>
                   (o Core..:? "executionMetadata") Core.<*>
                     (o Core..:? "exitCode")
                     Core.<*>
                     (o Core..:? "outputDirectories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "outputDirectorySymlinks" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "outputFileSymlinks" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "outputFiles" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "outputSymlinks" Core..!= Core.mempty)
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2CacheCapabilities Core.<$>
                   (o Core..:? "actionCacheUpdateCapabilities") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "digestFunction" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "maxBatchTotalSizeBytes")
                     Core.<*>
                     (o Core..:? "supportedCompressor" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2Command Core.<$>
                   (o Core..:? "arguments" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "environmentVariables" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "outputDirectories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "outputFiles" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "outputNodeProperties" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "outputPaths" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "platform")
          ...
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2Directory Core.<$>
                   (o Core..:? "directories" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "files" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nodeProperties")
                     Core.<*>
                     (o Core..:? "symlinks" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecutedActionMetadata
                   Core.<$>
                   (o Core..:? "auxiliaryMetadata" Core..!= Core.mempty)
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecutionCapabilities
                   ...
                   (o Core..:? "digestFunction") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "supportedNodeProperties" Core..!=
                        Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2FindMissingBlobsRequest
                   Core.<$>
                   (o Core..:? "blobDigests" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2FindMissingBlobsResponse
                   Core.<$>
                   (o Core..:? "missingBlobDigests" Core..!=
                      Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2PriorityCapabilities
                   Core.<$>
                   (o Core..:? "priorities" Core..!= Core.mempty))
          ...
          = Core.withObject "BuildBazelRemoteExecutionV2Tree"
              (\ o ->
                 BuildBazelRemoteExecutionV2Tree Core.<$>
                   (o Core..:? "children" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "root"))
              ...
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs
                   ...
                   (o Core..:? "arguments" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "files" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "inlineBlobs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "workingDirectory"))
