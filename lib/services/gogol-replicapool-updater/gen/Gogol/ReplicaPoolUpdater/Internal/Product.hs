    ...
    Core.withObject
      ...
      ( \o ->
          Operation
            ...
            Core.<*> (o Core..:? "kind" Core..!= "replicapoolupdater#operation")
            Core.<*> (o Core..:? "name")
    ...
    Core.withObject
      ...
      ( \o ->
          OperationList
            Core.<$> (o Core..:? "id")
            Core.<*> (o Core..:? "items")
            Core.<*> (o Core..:? "kind" Core..!= "replicapoolupdater#operationList")
            Core.<*> (o Core..:? "nextPageToken")
            Core.<*> (o Core..:? "selfLink")
      )
    ...
    Core.withObject
      ...
      ( \o ->
          RollingUpdate
            ...
            Core.<*> (o Core..:? "kind" Core..!= "replicapoolupdater#rollingUpdate")
...
instance Core.FromJSON RollingUpdate_Policy where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          RollingUpdate_Policy
            Core.<$> (o Core..:? "autoPauseAfterInstances")
            Core.<*> (o Core..:? "instanceStartupTimeoutSec")
...
instance Core.ToJSON RollingUpdate_Policy where
  toJSON RollingUpdate_Policy {..} =
    Core.object
      ( Core.catMaybes
          [ ("autoPauseAfterInstances" Core..=)
              Core.<$> autoPauseAfterInstances,
            ("instanceStartupTimeoutSec" Core..=)
              Core.<$> instanceStartupTimeoutSec,
            ("maxNumConcurrentInstances" Core..=)
              Core.<$> maxNumConcurrentInstances,
            ("maxNumFailedInstances" Core..=) Core.<$> maxNumFailedInstances,
            ("minInstanceUpdateTimeSec" Core..=)
              Core.<$> minInstanceUpdateTimeSec
          ]
      )
  ...
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          RollingUpdateList
            Core.<$> (o Core..:? "items")
            Core.<*> (o Core..:? "kind" Core..!= "replicapoolupdater#rollingUpdateList")
            Core.<*> (o Core..:? "nextPageToken")
            Core.<*> (o Core..:? "selfLink")
      )
