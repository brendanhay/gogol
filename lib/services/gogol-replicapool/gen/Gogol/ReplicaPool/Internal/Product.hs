              ...
              (\ o ->
                 Action Core.<$>
                   (o Core..:? "commands" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "envVariables" Core..!= Core.mempty)
...
instance Core.FromJSON EnvVariable where
        parseJSON
          = Core.withObject "EnvVariable"
              (\ o ->
                 EnvVariable Core.<$>
                   (o Core..:? "hidden") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "value"))
          ...
          = Core.withObject "NetworkInterface"
              (\ o ->
                 NetworkInterface Core.<$>
                   (o Core..:? "accessConfigs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "network")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRestart" Core..=) Core.<$> autoRestart,
                  ("baseInstanceName" Core..=) Core.<$>
                    baseInstanceName,
                  ("currentNumReplicas" Core..=) Core.<$>
                    currentNumReplicas,
                  ("description" Core..=) Core.<$> description,
                  ("healthChecks" Core..=) Core.<$> healthChecks,
                  ("initialNumReplicas" Core..=) Core.<$>
                    initialNumReplicas,
...
instance Core.FromJSON PoolsDeleteRequest where
        parseJSON
          = Core.withObject "PoolsDeleteRequest"
              (\ o ->
                 PoolsDeleteRequest Core.<$>
                   (o Core..:? "abandonInstances" Core..!= Core.mempty))

instance Core.ToJSON PoolsDeleteRequest where
        toJSON PoolsDeleteRequest{..}
          = Core.object
              (Core.catMaybes
                 [("abandonInstances" Core..=) Core.<$>
                    abandonInstances])
...
instance Core.FromJSON Replica where
        parseJSON
          = Core.withObject "Replica"
              (\ o ->
                 Replica Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "status"))
              ...
              (\ o ->
                 VmParams Core.<$>
                   (o Core..:? "baseInstanceName") Core.<*>
                     ...
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "disksToAttach" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "disksToCreate" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "machineType")
                     Core.<*> (o Core..:? "metadata")
                     Core.<*>
                     (o Core..:? "networkInterfaces" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "onHostMaintenance")
                     Core.<*>
                     (o Core..:? "serviceAccounts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "tags"))
