               ...
               Core.Capture "zone" Core.Text Core.:>
                 "pools" Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Pool Core.:>
...
newReplicaPoolPoolsInsert payload projectName zone =
  ReplicaPoolPoolsInsert
    {payload = payload, projectName = projectName, zone = zone}

instance Core.GoogleRequest ReplicaPoolPoolsInsert
         where
        ...
        requestClient ReplicaPoolPoolsInsert{..}
          = go projectName zone (Core.Just Core.AltJSON)
              payload
              replicaPoolService
          where go
                  = Core.buildClient
