          ...
          = Core.withObject "ListFoldersResponse"
              (\ o ->
                 ListFoldersResponse Core.<$>
                   (o Core..:? "folders" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListLiensResponse"
              (\ o ->
                 ListLiensResponse Core.<$>
                   (o Core..:? "liens" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListTagBindingsResponse"
              (\ o ->
                 ListTagBindingsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagBindings" Core..!= Core.mempty))
          ...
          = Core.withObject "ListTagKeysResponse"
              (\ o ->
                 ListTagKeysResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagKeys" Core..!= Core.mempty))
          ...
          = Core.withObject "ListTagValuesResponse"
              (\ o ->
                 ListTagValuesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tagValues" Core..!= Core.mempty))
...
newProject_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Project_Labels
newProject_Labels addtional = Project_Labels {addtional = addtional}
...
instance Core.ToJSON Project_Labels where
        toJSON Project_Labels{..} = Core.toJSON addtional
...
newTagBinding =
  TagBinding
    {name = Core.Nothing, parent = Core.Nothing, tagValue = Core.Nothing}
