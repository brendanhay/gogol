...
instance Core.FromJSON GoogleCloudRunV2BinaryAuthorization where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleCloudRunV2BinaryAuthorization
            Core.<$> (o Core..:? "breakglassJustification")
            Core.<*> (o Core..:? "policy")
...
instance Core.ToJSON GoogleCloudRunV2BinaryAuthorization where
  toJSON GoogleCloudRunV2BinaryAuthorization {..} =
    Core.object
      ( Core.catMaybes
          [ ("breakglassJustification" Core..=)
              Core.<$> breakglassJustification,
...
instance Core.ToJSON GoogleCloudRunV2ExecutionTemplate_Annotations where
...
instance Core.FromJSON GoogleCloudRunV2ExecutionTemplate_Labels where
  parseJSON =
    Core.withObject
      "GoogleCloudRunV2ExecutionTemplate_Labels"
      ( \o ->
...
instance Core.FromJSON GoogleCloudRunV2ExportStatusResponse where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleCloudRunV2ExportStatusResponse
            Core.<$> (o Core..:? "imageExportStatuses")
            Core.<*> (o Core..:? "operationId")
...
instance Core.FromJSON GoogleCloudRunV2ImageExportStatus where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleCloudRunV2ImageExportStatus
            Core.<$> (o Core..:? "exportJobState")
            Core.<*> (o Core..:? "exportedImageDigest")
            Core.<*> (o Core..:? "status")
            Core.<*> (o Core..:? "tag")
      )
...
instance Core.FromJSON GoogleCloudRunV2Overrides where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleCloudRunV2Overrides
            Core.<$> (o Core..:? "containerOverrides")
            Core.<*> (o Core..:? "taskCount")
            Core.<*> (o Core..:? "timeout")
      )
...
instance Core.FromJSON GoogleCloudRunV2ResourceRequirements_Limits where
  parseJSON =
    Core.withObject
      "GoogleCloudRunV2ResourceRequirements_Limits"
      ( \o ->
...
instance Core.ToJSON GoogleCloudRunV2ResourceRequirements_Limits where
...
instance Core.FromJSON GoogleCloudRunV2RevisionScalingStatus where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          GoogleCloudRunV2RevisionScalingStatus
            Core.<$> (o Core..:? "desiredMinInstanceCount")
      )
...
instance Core.ToJSON GoogleCloudRunV2RevisionScalingStatus where
  toJSON GoogleCloudRunV2RevisionScalingStatus {..} =
    Core.object
      ( Core.catMaybes
          [ ("desiredMinInstanceCount" Core..=)
              Core.<$> desiredMinInstanceCount
          ]
      )
...
instance Core.FromJSON GoogleCloudRunV2RevisionTemplate_Annotations where
  parseJSON =
    Core.withObject
      "GoogleCloudRunV2RevisionTemplate_Annotations"
      ( \o ->
...
instance Core.ToJSON GoogleCloudRunV2RevisionTemplate_Annotations where
...
instance Core.FromJSON GoogleCloudRunV2RevisionTemplate_Labels where
  parseJSON =
    Core.withObject
      "GoogleCloudRunV2RevisionTemplate_Labels"
      ( \o ->
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1ApprovalConfig where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1ApprovalConfig"
      ( \o ->
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1ApprovalResult where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1ApprovalResult"
      ( \o ->
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1ArtifactObjects where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1ArtifactObjects"
      ( \o ->
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1ArtifactObjects where
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1Build_Substitutions where
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1BuildApproval where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1BuildApproval"
      ( \o ->
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1ConnectedRepository where
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1HttpConfig where
  toJSON GoogleDevtoolsCloudbuildV1HttpConfig {..} =
    Core.object
      ( Core.catMaybes
          [ ("proxySecretVersionName" Core..=)
              Core.<$> proxySecretVersionName
          ]
      )
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1InlineSecret_EnvMap where
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1MavenArtifact where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1MavenArtifact"
      ( \o ->
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1PythonPackage where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1PythonPackage"
      ( \o ->
    ...
    Core.withObject
      ...
      ( \o ->
          GoogleDevtoolsCloudbuildV1Results
            ...
            Core.<*> (o Core..:? "mavenArtifacts")
            Core.<*> (o Core..:? "npmPackages")
            Core.<*> (o Core..:? "numArtifacts" Core.<&> Core.fmap Core.fromAsText)
            Core.<*> (o Core..:? "pythonPackages")
      )
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1Secret_SecretEnv where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1Secret_SecretEnv"
      ( \o ->
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1Secret_SecretEnv where
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1SecretManagerSecret where
    ...
    Core.withObject
      ...
      ( \o ->
          GoogleDevtoolsCloudbuildV1Source
            ...
            Core.<*> (o Core..:? "developerConnectConfig")
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1SourceProvenance where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1SourceProvenance"
      ( \o ->
          GoogleDevtoolsCloudbuildV1SourceProvenance
            ...
            Core.<*> (o Core..:? "resolvedConnectedRepository")
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1SourceProvenance where
  toJSON GoogleDevtoolsCloudbuildV1SourceProvenance {..} =
    Core.object
      ( Core.catMaybes
          [ ("fileHashes" Core..=) Core.<$> fileHashes,
            ("resolvedConnectedRepository" Core..=)
              Core.<$> resolvedConnectedRepository,
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1StorageSource where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1StorageSource"
      ( \o ->
...
instance Core.FromJSON GoogleDevtoolsCloudbuildV1UploadedNpmPackage where
  parseJSON =
    Core.withObject
      "GoogleDevtoolsCloudbuildV1UploadedNpmPackage"
      ( \o ->
...
instance Core.ToJSON GoogleDevtoolsCloudbuildV1UploadedNpmPackage where
