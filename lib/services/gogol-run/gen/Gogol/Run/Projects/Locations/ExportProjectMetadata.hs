...
type RunProjectsLocationsExportProjectMetadataResource =
  "v2"
    Core.:> Core.CaptureMode "name" "exportProjectMetadata" Core.Text
...
instance
  ...
  where
  type
    Rs RunProjectsLocationsExportProjectMetadata =
      GoogleCloudRunV2Metadata
  type
    Scopes RunProjectsLocationsExportProjectMetadata =
