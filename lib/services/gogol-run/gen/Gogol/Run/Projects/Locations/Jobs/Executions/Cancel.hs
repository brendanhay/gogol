...
type RunProjectsLocationsJobsExecutionsCancelResource =
  "v2"
    ...
    Core.:> Core.ReqBody '[Core.JSON] GoogleCloudRunV2CancelExecutionRequest
...
instance
  ...
  where
  type
    Rs RunProjectsLocationsJobsExecutionsCancel =
      GoogleLongrunningOperation
  type
    Scopes RunProjectsLocationsJobsExecutionsCancel =
