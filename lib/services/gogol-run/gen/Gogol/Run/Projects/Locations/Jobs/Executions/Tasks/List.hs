...
type RunProjectsLocationsJobsExecutionsTasksListResource =
  "v2"
    ...
    Core.:> Core.Get '[Core.JSON] GoogleCloudRunV2ListTasksResponse
...
instance
  ...
  where
  type
    Rs RunProjectsLocationsJobsExecutionsTasksList =
      GoogleCloudRunV2ListTasksResponse
  type
    Scopes RunProjectsLocationsJobsExecutionsTasksList =
