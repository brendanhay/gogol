...
instance Core.FromJSON Content where
        parseJSON
          = Core.withObject "Content"
              (\ o ->
                 Content Core.<$>
                   (o Core..:? "files" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "scriptId"))
              ...
              (\ o ->
                 Deployment Core.<$>
                   (o Core..:? "deploymentConfig") Core.<*>
                     (o Core..:? "deploymentId")
                     Core.<*>
                     (o Core..:? "entryPoints" Core..!= Core.mempty)
...
instance Core.FromJSON ExecuteStreamResponse where
        parseJSON
          = Core.withObject "ExecuteStreamResponse"
              (\ o ->
              ...
              (\ o ->
                 ExecutionError Core.<$>
                   (o Core..:? "errorMessage") Core.<*>
                     (o Core..:? "errorType")
                     Core.<*>
                     (o Core..:? "scriptStackTraceElements" Core..!=
                        Core.mempty))
...
instance Core.FromJSON GoogleAppsScriptTypeFunction
         where
        parseJSON
...
instance Core.ToJSON GoogleAppsScriptTypeFunction
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "GoogleAppsScriptTypeFunctionSet"
              (\ o ->
                 GoogleAppsScriptTypeFunctionSet Core.<$>
                   (o Core..:? "values" Core..!= Core.mempty))

instance Core.ToJSON GoogleAppsScriptTypeFunctionSet
         where
...
instance Core.FromJSON GoogleAppsScriptTypeProcess
         where
        parseJSON
...
instance Core.ToJSON GoogleAppsScriptTypeProcess
         where
          ...
          = Core.withObject "GoogleAppsScriptTypeUser"
              (\ o ->
                 GoogleAppsScriptTypeUser Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "name")
...
newGoogleAppsScriptTypeWebAppConfig =
  GoogleAppsScriptTypeWebAppConfig
    {access = Core.Nothing, executeAs = Core.Nothing}
...
instance Core.ToJSON GoogleAppsScriptTypeWebAppConfig
         where
...
newGoogleAppsScriptTypeWebAppEntryPoint =
  GoogleAppsScriptTypeWebAppEntryPoint
    {entryPointConfig = Core.Nothing, url = Core.Nothing}
          ...
          = Core.withObject "ListDeploymentsResponse"
              (\ o ->
                 ListDeploymentsResponse Core.<$>
                   (o Core..:? "deployments" Core..!= Core.mempty)
...
newListScriptProcessesResponse =
  ListScriptProcessesResponse
    {nextPageToken = Core.Nothing, processes = Core.Nothing}

instance Core.FromJSON ListScriptProcessesResponse
         where
        parseJSON
              ...
              (\ o ->
                 ListScriptProcessesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "processes" Core..!= Core.mempty))

instance Core.ToJSON ListScriptProcessesResponse
         where
...
instance Core.FromJSON ListUserProcessesResponse
         where
        parseJSON
...
instance Core.FromJSON Metrics where
        parseJSON
          = Core.withObject "Metrics"
              (\ o ->
                 Metrics Core.<$>
                   (o Core..:? "activeUsers" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "failedExecutions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "totalExecutions" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("activeUsers" Core..=) Core.<$> activeUsers,
                  ("failedExecutions" Core..=) Core.<$>
                    failedExecutions,
                  ("totalExecutions" Core..=) Core.<$>
                    totalExecutions])
...
newMetricsValue =
  MetricsValue
    {endTime = Core.Nothing, startTime = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON ScriptExecutionResult where
        parseJSON
          = Core.withObject "ScriptExecutionResult"
              (\ o ->
                 ScriptExecutionResult Core.<$>
                   (o Core..:? "returnValue"))
...
instance Core.FromJSON UpdateDeploymentRequest where
        parseJSON
          = Core.withObject "UpdateDeploymentRequest"
              (\ o ->
                 UpdateDeploymentRequest Core.<$>
                   (o Core..:? "deploymentConfig"))
          ...
          = Core.object
              (Core.catMaybes
                 [("boolValue" Core..=) Core.<$> boolValue,
                  ...
                  ("dateValue" Core..=) Core.. Core.AsText Core.<$>
                    dateValue,
...
instance Core.FromJSON Value_ProtoValue where
        parseJSON
          = Core.withObject "Value_ProtoValue"
              (\ o ->
