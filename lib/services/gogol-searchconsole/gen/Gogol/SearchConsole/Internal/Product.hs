              ...
              (\ o ->
                 IndexStatusInspectionResult Core.<$>
                   (o Core..:? "coverageState") Core.<*>
                     ...
                     Core.<*> (o Core..:? "pageFetchState")
                     Core.<*>
                     (o Core..:? "referringUrls" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "robotsTxtState")
          ...
          = Core.withObject "RichResultsInspectionResult"
              (\ o ->
                 RichResultsInspectionResult Core.<$>
                   (o Core..:? "detectedItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "verdict"))
              ...
              (\ o ->
                 RunMobileFriendlyTestResponse Core.<$>
                   (o Core..:? "mobileFriendliness") Core.<*>
                     (o Core..:? "mobileFriendlyIssues" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "resourceIssues" Core..!= Core.mempty)
              ...
              (\ o ->
                 SearchAnalyticsQueryRequest Core.<$>
                   (o Core..:? "aggregationType") Core.<*>
                     (o Core..:? "dataState")
                     Core.<*>
                     (o Core..:? "dimensionFilterGroups" Core..!=
                        Core.mempty)
                     Core.<*>
...
instance Core.FromJSON SitemapsListResponse where
        parseJSON
          = Core.withObject "SitemapsListResponse"
              (\ o ->
                 SitemapsListResponse Core.<$>
                   (o Core..:? "sitemap" Core..!= Core.mempty))
          ...
          = Core.withObject "SitesListResponse"
              (\ o ->
                 SitesListResponse Core.<$>
                   (o Core..:? "siteEntry" Core..!= Core.mempty))
...
instance Core.FromJSON WmxSitemap where
        parseJSON
          = Core.withObject "WmxSitemap"
              (\ o ->
                 WmxSitemap Core.<$>
                   (o Core..:? "contents" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "errors")
