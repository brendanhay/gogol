          ...
          = Core.withObject "AssetDiscoveryConfig"
              (\ o ->
                 AssetDiscoveryConfig Core.<$>
                   (o Core..:? "inclusionMode") Core.<*>
                     (o Core..:? "projectIds" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("finding" Core..=) Core.<$> finding,
                  ("notificationConfigName" Core..=) Core.<$>
        ...
        toJSON GoogleCloudSecuritycenterV1Resource{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ("parent" Core..=) Core.<$> parent,
                  ("parentDisplayName" Core..=) Core.<$>
                    parentDisplayName,
                  ("project" Core..=) Core.<$> project,
                  ("projectDisplayName" Core..=) Core.<$>
                    projectDisplayName])
...
newGoogleCloudSecuritycenterV1RunAssetDiscoveryResponse =
  GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse
    {duration = Core.Nothing, state = Core.Nothing}
              ...
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties
                   ...
                   (o Core..:? "resourceDisplayName") Core.<*>
                     (o Core..:? "resourceName")
                     Core.<*>
                     (o Core..:? "resourceOwners" Core..!= Core.mempty)
...
newGoogleCloudSecuritycenterV1p1beta1SecurityMarks =
  GoogleCloudSecuritycenterV1p1beta1SecurityMarks
    {marks = Core.Nothing, name = Core.Nothing}
...
newGoogleCloudSecuritycenterV1p1beta1TemporalAsset =
  GoogleCloudSecuritycenterV1p1beta1TemporalAsset
    {asset = Core.Nothing, changeType = Core.Nothing}
          ...
          = Core.withObject "GroupAssetsResponse"
              (\ o ->
                 GroupAssetsResponse Core.<$>
                   (o Core..:? "groupByResults" Core..!= Core.mempty)
          ...
          = Core.withObject "ListAssetsResponse"
              (\ o ->
                 ListAssetsResponse Core.<$>
                   (o Core..:? "listAssetsResults" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "totalSize"))
...
newListNotificationConfigsResponse =
  ListNotificationConfigsResponse
    {nextPageToken = Core.Nothing, notificationConfigs = Core.Nothing}
...
instance Core.ToJSON ListNotificationConfigsResponse
         where
...
instance Core.ToJSON OrganizationSettings where
        toJSON OrganizationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("assetDiscoveryConfig" Core..=) Core.<$>
                    assetDiscoveryConfig,
                  ("enableAssetDiscovery" Core..=) Core.<$>
