...
type SecurityCenterOrganizationsNotificationConfigsGetResource =
  "v1p1beta1"
    ...
    Core.:> Core.Get '[Core.JSON] NotificationConfig
...
instance
  ...
  where
  type
    Rs SecurityCenterOrganizationsNotificationConfigsGet =
      NotificationConfig
  type
    Scopes SecurityCenterOrganizationsNotificationConfigsGet =
