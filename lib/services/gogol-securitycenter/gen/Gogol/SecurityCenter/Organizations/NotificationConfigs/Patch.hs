...
type SecurityCenterOrganizationsNotificationConfigsPatchResource =
  "v1p1beta1"
    ...
    Core.:> Core.Patch '[Core.JSON] NotificationConfig
...
instance
  ...
  where
  type
    Rs SecurityCenterOrganizationsNotificationConfigsPatch =
      NotificationConfig
  type
    Scopes SecurityCenterOrganizationsNotificationConfigsPatch =
