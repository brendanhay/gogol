...
type SecurityCenterOrganizationsSourcesFindingsSetStateResource =
  "v1p1beta1"
    Core.:> Core.CaptureMode "name" "setState" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] SetFindingStateRequest
    Core.:> Core.Post '[Core.JSON] GoogleCloudSecuritycenterV1p1beta1Finding
...
instance
  ...
  where
  type
    Rs SecurityCenterOrganizationsSourcesFindingsSetState =
      GoogleCloudSecuritycenterV1p1beta1Finding
  type
    Scopes SecurityCenterOrganizationsSourcesFindingsSetState =
