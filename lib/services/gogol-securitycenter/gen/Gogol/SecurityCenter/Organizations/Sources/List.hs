...
type SecurityCenterOrganizationsSourcesListResource =
  "v1p1beta1"
    ...
    Core.:> Core.Get '[Core.JSON] ListSourcesResponse
...
instance Core.GoogleRequest SecurityCenterOrganizationsSourcesList where
  type
    Rs SecurityCenterOrganizationsSourcesList =
      ListSourcesResponse
  type
