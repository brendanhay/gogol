...
instance Core.GoogleRequest ServiceConsumerManagementOperationsList where
  type
    Rs ServiceConsumerManagementOperationsList =
      ListOperationsResponse
  type
    Scopes ServiceConsumerManagementOperationsList =
