...
type ServiceConsumerManagementServicesTenancyUnitsAddProjectResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "addProject" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] AddTenantProjectRequest
...
instance
  ...
  where
  type
    Rs ServiceConsumerManagementServicesTenancyUnitsAddProject =
      Operation
  type
    Scopes ServiceConsumerManagementServicesTenancyUnitsAddProject =
