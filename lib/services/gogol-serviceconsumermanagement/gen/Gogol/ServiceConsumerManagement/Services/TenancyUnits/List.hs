...
type ServiceConsumerManagementServicesTenancyUnitsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListTenancyUnitsResponse
...
instance
  ...
  where
  type
    Rs ServiceConsumerManagementServicesTenancyUnitsList =
      ListTenancyUnitsResponse
  type
    Scopes ServiceConsumerManagementServicesTenancyUnitsList =
