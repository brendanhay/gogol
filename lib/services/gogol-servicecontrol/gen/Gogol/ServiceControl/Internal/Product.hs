              ...
              (\ o ->
                 AuditLog Core.<$>
                   (o Core..:? "authenticationInfo") Core.<*>
                     (o Core..:? "authorizationInfo" Core..!= Core.mempty)
...
instance Core.FromJSON Auth where
        parseJSON
          = Core.withObject "Auth"
              (\ o ->
                 Auth Core.<$>
                   (o Core..:? "accessLevels" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "audiences" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "claims")
              ...
              (\ o ->
                 AuthenticationInfo Core.<$>
                   (o Core..:? "authoritySelector") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "serviceAccountDelegationInfo" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "ResourceLocation"
              (\ o ->
                 ResourceLocation Core.<$>
                   (o Core..:? "currentLocations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "originalLocations" Core..!=
                        Core.mempty))
