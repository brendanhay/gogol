...
type ServiceControlServicesCheckResource =
     "v2" Core.:>
       "services" Core.:>
         Core.CaptureMode "serviceName" "check" Core.Text
           Core.:>
