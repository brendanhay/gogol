...
instance Core.FromJSON ChangeReport where
        parseJSON
          = Core.withObject "ChangeReport"
              (\ o ->
                 ChangeReport Core.<$>
                   (o Core..:? "configChanges" Core..!= Core.mempty))
...
instance Core.FromJSON ConfigChange where
        parseJSON
          = Core.withObject "ConfigChange"
              (\ o ->
                 ConfigChange Core.<$>
                   (o Core..:? "advices" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "changeType")
                     Core.<*> (o Core..:? "element")
...
newGenerateConfigReportRequest_NewConfig 
    ...
    -> GenerateConfigReportRequest_NewConfig
newGenerateConfigReportRequest_NewConfig addtional =
  GenerateConfigReportRequest_NewConfig {addtional = addtional}
...
newGenerateConfigReportRequest_OldConfig 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'addtional'.
    -> GenerateConfigReportRequest_OldConfig
newGenerateConfigReportRequest_OldConfig addtional =
  GenerateConfigReportRequest_OldConfig {addtional = addtional}
          ...
          = Core.withObject "GenerateConfigReportResponse"
              (\ o ->
                 GenerateConfigReportResponse Core.<$>
                   (o Core..:? "changeReports" Core..!= Core.mempty)
                     Core.<*>
          ...
          = Core.withObject "ListServiceConfigsResponse"
              (\ o ->
                 ListServiceConfigsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "serviceConfigs" Core..!= Core.mempty))
          ...
          = Core.withObject "ListServiceRolloutsResponse"
              (\ o ->
                 ListServiceRolloutsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "rollouts" Core..!= Core.mempty))
...
newTrafficPercentStrategy_Percentages 
    ::  Core.HashMap Core.Text Core.Double
       -- ^  See 'addtional'.
    -> TrafficPercentStrategy_Percentages
newTrafficPercentStrategy_Percentages addtional =
  TrafficPercentStrategy_Percentages {addtional = addtional}
