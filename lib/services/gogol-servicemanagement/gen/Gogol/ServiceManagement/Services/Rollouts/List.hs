...
type ServiceManagementServicesRolloutsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListServiceRolloutsResponse
...
instance Core.GoogleRequest ServiceManagementServicesRolloutsList where
  type
    Rs ServiceManagementServicesRolloutsList =
      ListServiceRolloutsResponse
  type
    Scopes ServiceManagementServicesRolloutsList =
