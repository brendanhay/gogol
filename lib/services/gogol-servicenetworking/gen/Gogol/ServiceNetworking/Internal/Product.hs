    ...
    Core.object
      ( Core.catMaybes
          [ ("allowSubnetCidrRoutesOverlap" Core..=)
            ...
            ("skipRequestedAddressValidation" Core..=)
              Core.<$> skipRequestedAddressValidation,
    ...
    Core.withObject
      ...
      ( \o ->
          CloudSQLConfig
            ...
            Core.<*> (o Core..:? "umbrellaProject" Core.<&> Core.fmap Core.fromAsText)
      )
...
instance Core.FromJSON ConsumerProject where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          ConsumerProject
            Core.<$> (o Core..:? "projectNum" Core.<&> Core.fmap Core.fromAsText)
      )
...
instance Core.FromJSON GoogleCloudServicenetworkingV1betaConnection where
  parseJSON =
    Core.withObject
      "GoogleCloudServicenetworkingV1betaConnection"
      ( \o ->
...
instance Core.ToJSON GoogleCloudServicenetworkingV1betaConnection where
...
instance Core.FromJSON GoogleCloudServicenetworkingV1betaSubnetwork where
  parseJSON =
    Core.withObject
      "GoogleCloudServicenetworkingV1betaSubnetwork"
      ( \o ->
...
instance Core.ToJSON GoogleCloudServicenetworkingV1betaSubnetwork where
