              ...
              (\ o ->
                 AddSubnetworkRequest Core.<$>
                   (o Core..:? "allowSubnetCidrRoutesOverlap") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "skipRequestedAddressValidation")
...
instance Core.FromJSON ListDnsRecordSetsResponse
         where
        parseJSON
          = Core.withObject "ListDnsRecordSetsResponse"
              (\ o ->
                 ListDnsRecordSetsResponse Core.<$>
                   (o Core..:? "dnsRecordSets"))

instance Core.ToJSON ListDnsRecordSetsResponse where
        toJSON ListDnsRecordSetsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("dnsRecordSets" Core..=) Core.<$> dnsRecordSets])
...
newListDnsZonesResponse 
    ::  ListDnsZonesResponse
newListDnsZonesResponse = ListDnsZonesResponse {dnsZonePairs = Core.Nothing}

instance Core.FromJSON ListDnsZonesResponse where
        parseJSON
          = Core.withObject "ListDnsZonesResponse"
              (\ o ->
                 ListDnsZonesResponse Core.<$>
                   (o Core..:? "dnsZonePairs"))
...
instance Core.ToJSON ListDnsZonesResponse where
        toJSON ListDnsZonesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("dnsZonePairs" Core..=) Core.<$> dnsZonePairs])
...
instance Core.FromJSON VpcServiceControls where
        parseJSON
          = Core.withObject "VpcServiceControls"
              (\ o ->
                 VpcServiceControls Core.<$> (o Core..:? "enabled"))
