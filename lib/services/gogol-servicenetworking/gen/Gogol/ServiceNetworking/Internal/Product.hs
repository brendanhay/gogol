          ...
          = Core.withObject "AddRolesRequest"
              (\ o ->
                 AddRolesRequest Core.<$>
                   (o Core..:? "consumerNetwork") Core.<*>
                     (o Core..:? "policyBinding" Core..!= Core.mempty))
              ...
              (\ o ->
                 AddSubnetworkRequest Core.<$>
                   (o Core..:? "checkServiceNetworkingUsePermission")
                     ...
                     Core.<*>
                     (o Core..:? "requestedRanges" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "secondaryIpRangeSpecs" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "subnetwork")
                     Core.<*>
                     (o Core..:? "subnetworkUsers" Core..!= Core.mempty))
              ...
              (\ o ->
                 Connection Core.<$>
                   (o Core..:? "network") Core.<*>
                     (o Core..:? "peering")
                     Core.<*>
                     (o Core..:? "reservedPeeringRanges" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "service"))
...
instance Core.FromJSON ConsumerConfig where
        parseJSON
          = Core.withObject "ConsumerConfig"
              (\ o ->
                 ConsumerConfig Core.<$>
                   (o Core..:? "consumerExportCustomRoutes") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "reservedRanges" Core..!= Core.mempty)
                     Core.<*>
...
instance Core.FromJSON ConsumerProject where
        parseJSON
          = Core.withObject "ConsumerProject"
              (\ o ->
                 ConsumerProject Core.<$> (o Core..:? "projectNum"))
          ...
          = Core.withObject "ListPeeredDnsDomainsResponse"
              (\ o ->
                 ListPeeredDnsDomainsResponse Core.<$>
                   (o Core..:? "peeredDnsDomains" Core..!= Core.mempty))
              ...
              (\ o ->
                 RangeReservation Core.<$>
                   (o Core..:? "ipPrefixLength") Core.<*>
                     (o Core..:? "requestedRanges" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "secondaryRangeIpPrefixLengths" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "subnetworkCandidates" Core..!=
                        Core.mempty))
