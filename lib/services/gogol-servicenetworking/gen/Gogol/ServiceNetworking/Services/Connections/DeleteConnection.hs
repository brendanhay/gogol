...
type ServiceNetworkingServicesConnectionsDeleteConnectionResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] DeleteConnectionRequest
...
instance
  ...
  where
  type
    Rs ServiceNetworkingServicesConnectionsDeleteConnection =
      Operation
  type
    Scopes ServiceNetworkingServicesConnectionsDeleteConnection =
