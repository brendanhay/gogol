...
type ServiceNetworkingServicesEnableVpcServiceControlsResource =
  "v1"
    Core.:> Core.CaptureMode "parent" "enableVpcServiceControls" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] EnableVpcServiceControlsRequest
...
instance
  ...
  where
  type
    Rs ServiceNetworkingServicesEnableVpcServiceControls =
      Operation
  type
    Scopes ServiceNetworkingServicesEnableVpcServiceControls =
