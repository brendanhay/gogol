...
newAddEnableRulesResponse 
    ::  AddEnableRulesResponse
newAddEnableRulesResponse =
  AddEnableRulesResponse {addedValues = Core.Nothing, parent = Core.Nothing}
...
instance Core.FromJSON AnalyzeConsumerPolicyMetadata
         where
        parseJSON
          = Core.withObject "AnalyzeConsumerPolicyMetadata"
              (\ o -> Core.pure AnalyzeConsumerPolicyMetadata)

instance Core.ToJSON AnalyzeConsumerPolicyMetadata
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON AnalyzeConsumerPolicyResponse
         where
        parseJSON
          = Core.withObject "AnalyzeConsumerPolicyResponse"
              (\ o ->
                 AnalyzeConsumerPolicyResponse Core.<$>
                   (o Core..:? "analysis"))

instance Core.ToJSON AnalyzeConsumerPolicyResponse
         where
...
newControl 
    ::  Control
newControl = Control {environment = Core.Nothing, methodPolicies = Core.Nothing}
...
instance Core.FromJSON GoSettings_RenamedServices
         where
        parseJSON
          = Core.withObject "GoSettings_RenamedServices"
              (\ o ->
                 GoSettings_RenamedServices Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON GoSettings_RenamedServices where
        toJSON GoSettings_RenamedServices{..}
          = Core.toJSON additional
...
newGoogleApiServiceusageV2alphaConsumerPolicy_Annotations 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> GoogleApiServiceusageV2alphaConsumerPolicy_Annotations
newGoogleApiServiceusageV2alphaConsumerPolicy_Annotations additional =
  GoogleApiServiceusageV2alphaConsumerPolicy_Annotations
...
newGoogleApiServiceusageV2betaAnalysisResult =
  GoogleApiServiceusageV2betaAnalysisResult
    {blockers = Core.Nothing, warnings = Core.Nothing}
...
newGoogleApiServiceusageV2betaImpact =
  GoogleApiServiceusageV2betaImpact
    {detail = Core.Nothing, impactType = Core.Nothing}
...
newImpact 
    ::  Impact
newImpact = Impact {detail = Core.Nothing, impactType = Core.Nothing}
...
newMethodPolicy 
    ::  MethodPolicy
newMethodPolicy =
  MethodPolicy {requestPolicies = Core.Nothing, selector = Core.Nothing}
...
instance Core.FromJSON MethodSettings where
        parseJSON
          = Core.withObject "MethodSettings"
              (\ o ->
                 MethodSettings Core.<$>
                   (o Core..:? "autoPopulatedFields") Core.<*>
                     (o Core..:? "longRunning")
                     Core.<*> (o Core..:? "selector"))
              ...
              (\ o ->
                 MetricDescriptorMetadata Core.<$>
                   (o Core..:? "ingestDelay") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "timeSeriesResourceHierarchyLevel"))
              ...
              (\ o ->
                 Publishing Core.<$>
                   (o Core..:? "apiShortName") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "restReferenceDocumentationUri"))
...
newPythonSettings 
    ::  PythonSettings
newPythonSettings =
  PythonSettings {common = Core.Nothing, experimentalFeatures = Core.Nothing}
...
instance Core.ToJSON PythonSettings where
        toJSON PythonSettings{..}
          = Core.object
              (Core.catMaybes
                 [("common" Core..=) Core.<$> common,
                  ("experimentalFeatures" Core..=) Core.<$>
                    experimentalFeatures])
...
newRemoveEnableRulesResponse =
  RemoveEnableRulesResponse
    {parent = Core.Nothing, removedValues = Core.Nothing}
...
newSelectiveGapicGeneration 
    ::  SelectiveGapicGeneration
newSelectiveGapicGeneration = SelectiveGapicGeneration {methods = Core.Nothing}
...
instance Core.FromJSON UpdateConsumerPolicyMetadata
         where
        parseJSON
          = Core.withObject "UpdateConsumerPolicyMetadata"
              (\ o -> Core.pure UpdateConsumerPolicyMetadata)

instance Core.ToJSON UpdateConsumerPolicyMetadata
         where
        toJSON = Core.const Core.emptyObject
