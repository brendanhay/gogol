...
instance Core.FromJSON CancelDataSourceRefreshRequest
         where
        parseJSON
...
instance Core.ToJSON CancelDataSourceRefreshRequest
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "CancelDataSourceRefreshResponse"
              (\ o ->
                 CancelDataSourceRefreshResponse Core.<$>
                   (o Core..:? "statuses"))

instance Core.ToJSON CancelDataSourceRefreshResponse
         where
...
newCancelDataSourceRefreshStatus =
  CancelDataSourceRefreshStatus
    {reference = Core.Nothing, refreshCancellationStatus = Core.Nothing}

instance Core.FromJSON CancelDataSourceRefreshStatus
         where
        parseJSON
...
instance Core.ToJSON CancelDataSourceRefreshStatus
         where
...
newDataSourceSpec =
  DataSourceSpec
    {bigQuery = Core.Nothing, looker = Core.Nothing, parameters = Core.Nothing}
...
newLookerDataSourceSpec =
  LookerDataSourceSpec
    {explore = Core.Nothing, instanceUri = Core.Nothing, model = Core.Nothing}
...
newRefreshCancellationStatus 
    ::  RefreshCancellationStatus
newRefreshCancellationStatus =
  RefreshCancellationStatus {errorCode = Core.Nothing, state = Core.Nothing}

instance Core.FromJSON RefreshCancellationStatus
         where
        parseJSON
          ...
          = Core.withObject "SetDataValidationRequest"
              (\ o ->
                 SetDataValidationRequest Core.<$>
                   (o Core..:? "filteredRowsIncluded") Core.<*>
                     (o Core..:? "range")
                     Core.<*> (o Core..:? "rule"))
...
instance Core.ToJSON SetDataValidationRequest where
        toJSON SetDataValidationRequest{..}
          = Core.object
              (Core.catMaybes
                 [("filteredRowsIncluded" Core..=) Core.<$>
