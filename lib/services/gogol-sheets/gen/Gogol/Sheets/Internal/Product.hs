          ...
          = Core.withObject "AddDimensionGroupResponse"
              (\ o ->
                 AddDimensionGroupResponse Core.<$>
                   (o Core..:? "dimensionGroups" Core..!= Core.mempty))
              ...
              (\ o ->
                 BasicChartSeries Core.<$>
                   (o Core..:? "color") Core.<*>
                     ...
                     Core.<*> (o Core..:? "series")
                     Core.<*>
                     (o Core..:? "styleOverrides" Core..!= Core.mempty)
...
instance Core.FromJSON BasicChartSpec where
        parseJSON
          = Core.withObject "BasicChartSpec"
              (\ o ->
                 BasicChartSpec Core.<$>
                   (o Core..:? "axis" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "chartType")
              ...
              (\ o ->
                 BasicFilter Core.<$>
                   (o Core..:? "criteria") Core.<*>
                     (o Core..:? "filterSpecs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "range")
                     Core.<*>
                     (o Core..:? "sortSpecs" Core..!= Core.mempty))
...
newtype BasicFilter_Criteria = BasicFilter_Criteria
    {
      -- | 
      addtional :: (Core.HashMap Core.Text FilterCriteria)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newBasicFilter_Criteria 
    ::  Core.HashMap Core.Text FilterCriteria
       -- ^  See 'addtional'.
    -> BasicFilter_Criteria
newBasicFilter_Criteria addtional = BasicFilter_Criteria {addtional = addtional}
          ...
          = Core.withObject
              ...
              (\ o ->
                 BatchClearValuesByDataFilterRequest Core.<$>
                   (o Core..:? "dataFilters" Core..!= Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 BatchClearValuesByDataFilterResponse Core.<$>
                   (o Core..:? "clearedRanges" Core..!= Core.mempty)
          ...
          = Core.withObject "BatchClearValuesRequest"
              (\ o ->
                 BatchClearValuesRequest Core.<$>
                   (o Core..:? "ranges" Core..!= Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 BatchGetValuesByDataFilterResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*>
                     (o Core..:? "valueRanges" Core..!= Core.mempty))
              ...
              (\ o ->
                 BatchUpdateSpreadsheetRequest Core.<$>
                   (o Core..:? "includeSpreadsheetInResponse") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "responseRanges" Core..!= Core.mempty))
          ...
          = Core.withObject "BatchUpdateSpreadsheetResponse"
              (\ o ->
                 BatchUpdateSpreadsheetResponse Core.<$>
                   (o Core..:? "replies" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject
              ...
              (\ o ->
                 BatchUpdateValuesByDataFilterRequest Core.<$>
                   (o Core..:? "data" Core..!= Core.mempty) Core.<*>
              ...
              (\ o ->
                 CellData Core.<$>
                   (o Core..:? "dataSourceFormula") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "textFormatRuns" Core..!= Core.mempty)
...
instance Core.FromJSON DataSource where
        parseJSON
          = Core.withObject "DataSource"
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "calculatedColumns" Core..!= Core.mempty)
          ...
          = Core.withObject "DataSourceObjectReferences"
              (\ o ->
                 DataSourceObjectReferences Core.<$>
                   (o Core..:? "references" Core..!= Core.mempty))
          ...
          = Core.withObject "DataSourceRefreshMonthlySchedule"
              (\ o ->
                 DataSourceRefreshMonthlySchedule Core.<$>
                   (o Core..:? "daysOfMonth" Core..!= Core.mempty)
          ...
          = Core.withObject "DataSourceSheetDimensionRange"
              (\ o ->
                 DataSourceSheetDimensionRange Core.<$>
                   (o Core..:? "columnReferences" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "sheetId"))
          ...
          = Core.withObject "DeleteDeveloperMetadataResponse"
              (\ o ->
                 DeleteDeveloperMetadataResponse Core.<$>
                   (o Core..:? "deletedDeveloperMetadata" Core..!=
                      Core.mempty))
          ...
          = Core.withObject "DeleteDuplicatesRequest"
              (\ o ->
                 DeleteDuplicatesRequest Core.<$>
                   (o Core..:? "comparisonColumns" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "range"))
              ...
              (\ o ->
                 DimensionProperties Core.<$>
                   (o Core..:? "dataSourceColumnReference") Core.<*>
                     (o Core..:? "developerMetadata" Core..!= Core.mempty)
              ...
              (\ o ->
                 Editors Core.<$>
                   (o Core..:? "domainUsersCanEdit") Core.<*>
                     (o Core..:? "groups" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject "FilterCriteria"
              (\ o ->
                 FilterCriteria Core.<$>
                   (o Core..:? "condition") Core.<*>
                     (o Core..:? "hiddenValues" Core..!= Core.mempty)
...
newFilterView_Criteria 
    ::  Core.HashMap Core.Text FilterCriteria
       -- ^  See 'addtional'.
    -> FilterView_Criteria
newFilterView_Criteria addtional = FilterView_Criteria {addtional = addtional}
...
instance Core.FromJSON GridData where
        parseJSON
          = Core.withObject "GridData"
              (\ o ->
                 GridData Core.<$>
                   (o Core..:? "columnMetadata" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "rowData" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "rowMetadata" Core..!= Core.mempty)
              ...
              (\ o ->
                 PivotFilterCriteria Core.<$>
                   (o Core..:? "condition") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "visibleValues" Core..!= Core.mempty))
              ...
              (\ o ->
                 PivotGroup Core.<$>
                   (o Core..:? "dataSourceColumnReference") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "valueMetadata" Core..!= Core.mempty))
...
newtype PivotTable_Criteria = PivotTable_Criteria
    {
      -- | 
      addtional :: (Core.HashMap Core.Text PivotFilterCriteria)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPivotTable_Criteria 
    ::  Core.HashMap Core.Text PivotFilterCriteria
       -- ^  See 'addtional'.
    -> PivotTable_Criteria
newPivotTable_Criteria addtional = PivotTable_Criteria {addtional = addtional}
              ...
              (\ o ->
                 ProtectedRange Core.<$>
                   (o Core..:? "description") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "unprotectedRanges" Core..!= Core.mempty)
          ...
          = Core.withObject "RefreshDataSourceResponse"
              (\ o ->
                 RefreshDataSourceResponse Core.<$>
                   (o Core..:? "statuses" Core..!= Core.mempty))
          ...
          = Core.withObject "SearchDeveloperMetadataResponse"
              (\ o ->
                 SearchDeveloperMetadataResponse Core.<$>
                   (o Core..:? "matchedDeveloperMetadata" Core..!=
                      Core.mempty))
...
instance Core.FromJSON Sheet where
        parseJSON
          = Core.withObject "Sheet"
              (\ o ->
                 Sheet Core.<$>
                   (o Core..:? "bandedRanges" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "basicFilter")
                     Core.<*> (o Core..:? "charts" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "columnGroups" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "conditionalFormats" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "data" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "developerMetadata" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "filterViews" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "merges" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "properties")
                     Core.<*>
                     (o Core..:? "protectedRanges" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "rowGroups" Core..!= Core.mempty)
              ...
              (\ o ->
                 Spreadsheet Core.<$>
                   (o Core..:? "dataSourceSchedules" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "dataSources" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "developerMetadata" Core..!= Core.mempty)
                     Core.<*>
              ...
              (\ o ->
                 SpreadsheetTheme Core.<$>
                   (o Core..:? "primaryFontFamily") Core.<*>
                     (o Core..:? "themeColors" Core..!= Core.mempty))
          ...
          = Core.withObject "WaterfallChartSeries"
              (\ o ->
                 WaterfallChartSeries Core.<$>
                   (o Core..:? "customSubtotals" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "data")
                     Core.<*> (o Core..:? "dataLabel")
