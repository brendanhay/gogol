     ...
     "content" Core.:>
       "v2.1" Core.:>
         Core.Capture "merchantId" Core.Int64 Core.:>
           "buyongoogleprograms" Core.:>
             Core.Capture "regionCode" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BuyOnGoogleProgramStatus
                               Core.:>
                               Core.Patch '[Core.JSON] BuyOnGoogleProgramStatus
...
instance Core.GoogleRequest
           ContentBuyongoogleprogramsPatch
         where
        type Rs ContentBuyongoogleprogramsPatch =
             BuyOnGoogleProgramStatus
        type Scopes ContentBuyongoogleprogramsPatch =
             '["https://www.googleapis.com/auth/content"]
        requestClient ContentBuyongoogleprogramsPatch{..}
          = go merchantId regionCode xgafv accessToken callback
              updateMask
              uploadType
              uploadProtocol
