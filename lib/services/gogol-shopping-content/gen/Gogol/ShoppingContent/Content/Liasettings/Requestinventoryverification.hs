...
type ContentLiasettingsRequestinventoryverificationResource =
  "content"
    ...
    Core.:> "requestinventoryverification"
    Core.:> Core.Capture "country" Core.Text
...
instance
  ...
  where
  type
    Rs ContentLiasettingsRequestinventoryverification =
      LiasettingsRequestInventoryVerificationResponse
  type
    Scopes ContentLiasettingsRequestinventoryverification =
      '[Content'FullControl]
