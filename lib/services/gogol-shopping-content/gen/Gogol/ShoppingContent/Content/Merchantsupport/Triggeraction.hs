...
type ContentMerchantsupportTriggeractionResource =
  "content"
    ...
    Core.:> Core.ReqBody '[Core.JSON] TriggerActionPayload
    Core.:> Core.Post '[Core.JSON] TriggerActionResponse
...
instance Core.GoogleRequest ContentMerchantsupportTriggeraction where
  type Rs ContentMerchantsupportTriggeraction = TriggerActionResponse
  type
    Scopes ContentMerchantsupportTriggeraction =
      '[Content'FullControl]
