...
-- |
-- Module      : Gogol.ShoppingContent.Content.Orderinvoices.Createchargeinvoice
...
instance Core.GoogleRequest
           ContentOrderinvoicesCreatechargeinvoice
         where
        type Rs ContentOrderinvoicesCreatechargeinvoice =
             OrderinvoicesCreateChargeInvoiceResponse
        type Scopes ContentOrderinvoicesCreatechargeinvoice =
             '[Content'FullControl]
        requestClient
          ContentOrderinvoicesCreatechargeinvoice{..}
