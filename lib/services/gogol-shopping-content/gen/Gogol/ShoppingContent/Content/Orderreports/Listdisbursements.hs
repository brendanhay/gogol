...
-- |
-- Module      : Gogol.ShoppingContent.Content.Orderreports.Listdisbursements
               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "disbursementEndDate" Core.Text
                       Core.:>
                       Core.QueryParam "disbursementStartDate" Core.Text
                         Core.:>
...
instance Core.GoogleRequest
           ContentOrderreportsListdisbursements
         where
        type Rs ContentOrderreportsListdisbursements =
             OrderreportsListDisbursementsResponse
        type Scopes ContentOrderreportsListdisbursements =
