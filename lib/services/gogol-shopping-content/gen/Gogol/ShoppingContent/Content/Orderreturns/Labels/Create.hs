     ...
     "content" Core.:>
       "v2.1" Core.:>
         Core.Capture "merchantId" Core.Int64 Core.:>
           "orderreturns" Core.:>
             Core.Capture "returnId" Core.Text Core.:>
               "labels" Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ReturnShippingLabel
                               Core.:>
                               Core.Post '[Core.JSON] ReturnShippingLabel
...
instance Core.GoogleRequest
           ContentOrderreturnsLabelsCreate
         where
        type Rs ContentOrderreturnsLabelsCreate =
             ReturnShippingLabel
        type Scopes ContentOrderreturnsLabelsCreate =
             '[Content'FullControl]
        requestClient ContentOrderreturnsLabelsCreate{..}
          = go merchantId returnId xgafv accessToken callback
              uploadType
              uploadProtocol
