           ...
           "orderreturns" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "acknowledged" Core.Bool Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "createdEndDate" Core.Text Core.:>
                       Core.QueryParam "createdStartDate" Core.Text Core.:>
                         Core.QueryParams "googleOrderIds" Core.Text Core.:>
                           Core.QueryParam "maxResults" Core.Word32 Core.:>
                             Core.QueryParam "orderBy" OrderreturnsListOrderBy
                               Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParams "shipmentStates"
                                   OrderreturnsListShipmentStates
                                   Core.:>
                                   Core.QueryParams "shipmentStatus"
                                     OrderreturnsListShipmentStatus
                                     Core.:>
                                     Core.QueryParams "shipmentTrackingNumbers"
                                       Core.Text
                                       Core.:>
                                       Core.QueryParams "shipmentTypes"
...
instance Core.GoogleRequest ContentOrderreturnsList
         where
        type Rs ContentOrderreturnsList =
             OrderreturnsListResponse
        type Scopes ContentOrderreturnsList =
             '[Content'FullControl]
        requestClient ContentOrderreturnsList{..}
          = go merchantId xgafv accessToken acknowledged
              callback
              createdEndDate
              createdStartDate
