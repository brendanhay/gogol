...
-- |
-- Module      : Gogol.ShoppingContent.Content.Orders.Acknowledge
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] OrdersAcknowledgeRequest
                               Core.:>
                               Core.Post '[Core.JSON] OrdersAcknowledgeResponse
...
instance Core.GoogleRequest ContentOrdersAcknowledge
         where
        type Rs ContentOrdersAcknowledge =
             OrdersAcknowledgeResponse
        type Scopes ContentOrdersAcknowledge =
