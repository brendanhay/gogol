                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] CaptureOrderRequest
                               Core.:>
                               Core.Post '[Core.JSON] CaptureOrderResponse
...
instance Core.GoogleRequest ContentOrdersCaptureOrder
         where
        type Rs ContentOrdersCaptureOrder =
             CaptureOrderResponse
        type Scopes ContentOrdersCaptureOrder =
