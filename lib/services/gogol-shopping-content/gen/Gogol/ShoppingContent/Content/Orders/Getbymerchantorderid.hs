     ...
     "content" Core.:>
       "v2.1" Core.:>
         Core.Capture "merchantId" Core.Word64 Core.:>
           "ordersbymerchantid" Core.:>
             Core.Capture "merchantOrderId" Core.Text Core.:>
...
instance Core.GoogleRequest
           ContentOrdersGetbymerchantorderid
         where
        type Rs ContentOrdersGetbymerchantorderid =
             OrdersGetByMerchantOrderIdResponse
        type Scopes ContentOrdersGetbymerchantorderid =
             '[Content'FullControl]
        requestClient ContentOrdersGetbymerchantorderid{..}
          = go merchantId merchantOrderId xgafv accessToken
              callback
              uploadType
              uploadProtocol
