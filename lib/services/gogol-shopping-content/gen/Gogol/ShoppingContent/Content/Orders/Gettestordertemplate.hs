...
-- |
-- Module      : Gogol.ShoppingContent.Content.Orders.Gettestordertemplate
     ...
     "content" Core.:>
       "v2.1" Core.:>
         Core.Capture "merchantId" Core.Word64 Core.:>
           "testordertemplates" Core.:>
             Core.Capture "templateName"
...
instance Core.GoogleRequest
           ContentOrdersGettestordertemplate
         where
        type Rs ContentOrdersGettestordertemplate =
             OrdersGetTestOrderTemplateResponse
        type Scopes ContentOrdersGettestordertemplate =
             '[Content'FullControl]
        requestClient ContentOrdersGettestordertemplate{..}
          = go merchantId templateName xgafv accessToken
              callback
              country
              uploadType
              uploadProtocol
