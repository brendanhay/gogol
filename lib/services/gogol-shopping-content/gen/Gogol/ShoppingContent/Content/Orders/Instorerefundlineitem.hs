...
-- |
-- Module      : Gogol.ShoppingContent.Content.Orders.Instorerefundlineitem
...
instance Core.GoogleRequest
           ContentOrdersInstorerefundlineitem
         where
        type Rs ContentOrdersInstorerefundlineitem =
             OrdersInStoreRefundLineItemResponse
        type Scopes ContentOrdersInstorerefundlineitem =
