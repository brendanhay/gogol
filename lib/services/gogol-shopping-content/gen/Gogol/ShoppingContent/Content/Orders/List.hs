                     ...
                     Core.QueryParam "maxResults" Core.Word32 Core.:>
                       Core.QueryParam "orderBy" Core.Text Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "placedDateEnd" Core.Text Core.:>
                             Core.QueryParam "placedDateStart" Core.Text Core.:>
                               Core.QueryParams "statuses" OrdersListStatuses
                                 Core.:>
