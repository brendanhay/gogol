                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] OrdersRefundOrderRequest
                               Core.:>
                               Core.Post '[Core.JSON] OrdersRefundOrderResponse
...
instance Core.GoogleRequest ContentOrdersRefundorder
         where
        type Rs ContentOrdersRefundorder =
             OrdersRefundOrderResponse
        type Scopes ContentOrdersRefundorder =
             '[Content'FullControl]
