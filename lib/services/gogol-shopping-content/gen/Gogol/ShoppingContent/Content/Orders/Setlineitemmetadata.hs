...
-- |
-- Module      : Gogol.ShoppingContent.Content.Orders.Setlineitemmetadata
...
instance Core.GoogleRequest
           ContentOrdersSetlineitemmetadata
         where
        type Rs ContentOrdersSetlineitemmetadata =
             OrdersSetLineItemMetadataResponse
        type Scopes ContentOrdersSetlineitemmetadata =
             '[Content'FullControl]
