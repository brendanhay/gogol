             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "ruleId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] RepricingRule Core.:>
                             Core.Post '[Core.JSON] RepricingRule
...
instance Core.GoogleRequest
        ...
        type Scopes ContentRepricingrulesCreate =
             '[Content'FullControl]
        requestClient ContentRepricingrulesCreate{..}
          = go merchantId xgafv accessToken callback ruleId
              uploadType
              uploadProtocol
