...
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "accountManagement") Core.<*>
                     (o Core..:? "adsLinks" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "adultContent")
                     Core.<*> (o Core..:? "automaticImprovements")
                     Core.<*>
                     (o Core..:? "automaticLabelIds" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "youtubeChannelLinks" Core..!=
                        Core.mempty))
...
instance Core.ToJSON Account where
        toJSON Account{..}
          = Core.object
              (Core.catMaybes
                 [("accountManagement" Core..=) Core.<$>
                    accountManagement,
                  ("adsLinks" Core..=) Core.<$> adsLinks,
                  ("adultContent" Core..=) Core.<$> adultContent,
                  ("automaticImprovements" Core..=) Core.<$>
                    automaticImprovements,
                  ("automaticLabelIds" Core..=) Core.<$>
                    automaticLabelIds,
                  ("businessInformation" Core..=) Core.<$>
                    businessInformation,
                  ("cssId" Core..=) Core.. Core.AsText Core.<$> cssId,
                  ("googleMyBusinessLink" Core..=) Core.<$>
...
instance Core.FromJSON AccountAdsLink where
        parseJSON
          = Core.withObject "AccountAdsLink"
              (\ o ->
                 AccountAdsLink Core.<$>
                   (o Core..:? "adsId") Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON AccountAutomaticImprovements
         where
        parseJSON
...
instance Core.ToJSON AccountAutomaticImprovements
         where
        toJSON AccountAutomaticImprovements{..}
          = Core.object
              (Core.catMaybes
                 [("imageImprovements" Core..=) Core.<$>
                    imageImprovements,
                  ("itemUpdates" Core..=) Core.<$> itemUpdates,
                  ("shippingImprovements" Core..=) Core.<$>
...
instance Core.FromJSON AccountBusinessInformation
         where
        parseJSON
          = Core.withObject "AccountBusinessInformation"
              (\ o ->
                 AccountBusinessInformation Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "customerService")
                     Core.<*>
                     (o Core..:? "koreanBusinessRegistrationNumber")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessToken" Core..=) Core.<$> accessToken,
                  ("expiresIn" Core..=) Core.. Core.AsText Core.<$>
                    expiresIn,
...
newAccountCustomerService =
  AccountCustomerService
    {email = Core.Nothing, phoneNumber = Core.Nothing, url = Core.Nothing}
...
instance Core.FromJSON AccountGoogleMyBusinessLink
         where
        parseJSON
          = Core.withObject "AccountGoogleMyBusinessLink"
              (\ o ->
                 AccountGoogleMyBusinessLink Core.<$>
                   (o Core..:? "gmbAccountId") Core.<*>
                     (o Core..:? "gmbEmail")
                     Core.<*> (o Core..:? "status"))

instance Core.ToJSON AccountGoogleMyBusinessLink
         where
...
instance Core.ToJSON AccountIdentifier where
        toJSON AccountIdentifier{..}
          = Core.object
              (Core.catMaybes
                 [("aggregatorId" Core..=) Core.. Core.AsText Core.<$>
                    aggregatorId,
          ...
          = Core.withObject "AccountImageImprovements"
              (\ o ->
                 AccountImageImprovements Core.<$>
                   (o Core..:? "accountImageImprovementsSettings")
                     Core.<*>
                     (o Core..:?
...
instance Core.ToJSON AccountImageImprovementsSettings
         where
              ...
              (\ o ->
                 AccountItemUpdates Core.<$>
                   (o Core..:? "accountItemUpdatesSettings") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "effectiveAllowConditionUpdates")
...
instance Core.FromJSON AccountItemUpdatesSettings
         where
        parseJSON
              ...
              (\ o ->
                 AccountItemUpdatesSettings Core.<$>
                   (o Core..:? "allowAvailabilityUpdates") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "allowStrictAvailabilityUpdates"))
          ...
          = Core.object
              (Core.catMaybes
                 [("allowAvailabilityUpdates" Core..=) Core.<$>
                  ...
                  ("allowConditionUpdates" Core..=) Core.<$>
                    allowConditionUpdates,
                  ("allowPriceUpdates" Core..=) Core.<$>
                    allowPriceUpdates,
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("labelId" Core..=) Core.. Core.AsText Core.<$>
                    labelId,
          ...
          = Core.withObject "AccountReturnCarrier"
              (\ o ->
                 AccountReturnCarrier Core.<$>
                   (o Core..:? "carrierAccountId") Core.<*>
                     (o Core..:? "carrierAccountName")
          ...
          = Core.object
              (Core.catMaybes
                 [("carrierAccountId" Core..=) Core.. Core.AsText
                  ...
                  ("carrierAccountName" Core..=) Core.<$>
                    carrierAccountName,
                  ("carrierAccountNumber" Core..=) Core.<$>
...
instance Core.FromJSON AccountShippingImprovements
         where
        parseJSON
...
instance Core.ToJSON AccountShippingImprovements
         where
        ...
        parseJSON
          = Core.withObject "AccountStatus"
              (\ o ->
                 AccountStatus Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "accountLevelIssues" Core..!=
                        Core.mempty)
...
instance Core.FromJSON AccountStatusAccountLevelIssue
         where
        parseJSON
...
instance Core.ToJSON AccountStatusAccountLevelIssue
         where
...
instance Core.FromJSON AccountStatusItemLevelIssue
         where
        parseJSON
...
instance Core.ToJSON AccountStatusItemLevelIssue
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("attributeName" Core..=) Core.<$> attributeName,
                  ...
                  ("detail" Core..=) Core.<$> detail,
                  ("documentation" Core..=) Core.<$> documentation,
                  ("numItems" Core..=) Core.. Core.AsText Core.<$>
                    numItems,
              ...
              (\ o ->
                 AccountStatusProducts Core.<$>
                   (o Core..:? "channel") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "itemLevelIssues" Core..!= Core.mempty)
...
instance Core.ToJSON AccountStatusStatistics where
        toJSON AccountStatusStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("active" Core..=) Core.. Core.AsText Core.<$>
                    active,
                  ("disapproved" Core..=) Core.. Core.AsText Core.<$>
                    disapproved,
                  ("expiring" Core..=) Core.. Core.AsText Core.<$>
                    expiring,
...
newAccountTax =
  AccountTax
    {accountId = Core.Nothing, kind = Core.Nothing, rules = Core.Nothing}
...
instance Core.FromJSON AccountTax where
        parseJSON
          = Core.withObject "AccountTax"
              (\ o ->
                 AccountTax Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON AccountTaxTaxRule where
        toJSON AccountTaxTaxRule{..}
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ("locationId" Core..=) Core.. Core.AsText Core.<$>
                    locationId,
...
instance Core.FromJSON AccountYouTubeChannelLink
         where
        parseJSON
...
newAccountsAuthInfoResponse =
  AccountsAuthInfoResponse
    {accountIdentifiers = Core.Nothing, kind = Core.Nothing}
          ...
          = Core.withObject "AccountsAuthInfoResponse"
              (\ o ->
                 AccountsAuthInfoResponse Core.<$>
                   (o Core..:? "accountIdentifiers" Core..!=
                      Core.mempty)
                     Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON AccountsClaimWebsiteResponse
         where
        parseJSON
          = Core.withObject "AccountsClaimWebsiteResponse"
              (\ o ->
                 AccountsClaimWebsiteResponse Core.<$>
                   (o Core..:? "kind"))

instance Core.ToJSON AccountsClaimWebsiteResponse
         where
...
instance Core.FromJSON AccountsCustomBatchRequest
         where
        parseJSON
          = Core.withObject "AccountsCustomBatchRequest"
              (\ o ->
                 AccountsCustomBatchRequest Core.<$>
...
instance Core.ToJSON AccountsCustomBatchRequestEntry
         where
...
instance Core.FromJSON AccountsCustomBatchResponse
         where
        parseJSON
          = Core.withObject "AccountsCustomBatchResponse"
              (\ o ->
                 AccountsCustomBatchResponse Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind"))

instance Core.ToJSON AccountsCustomBatchResponse
         where
...
instance Core.ToJSON AccountsCustomBatchResponseEntry
         where
              ...
              (\ o ->
                 AccountsLinkRequest Core.<$>
                   (o Core..:? "action") Core.<*>
                     ...
                     Core.<*> (o Core..:? "linkedAccountId")
                     Core.<*>
                     (o Core..:? "paymentServiceProviderLinkInfo")
                     Core.<*>
                     (o Core..:? "services" Core..!= Core.mempty))
...
newAccountsListLinksResponse =
  AccountsListLinksResponse
    {kind = Core.Nothing, links = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON AccountsListLinksResponse
         where
        parseJSON
...
instance Core.FromJSON AccountsUpdateLabelsRequest
         where
        parseJSON
          = Core.withObject "AccountsUpdateLabelsRequest"
              (\ o ->
                 AccountsUpdateLabelsRequest Core.<$>
                   (o Core..:? "labelIds" Core..!= Core.mempty))

instance Core.ToJSON AccountsUpdateLabelsRequest
         where
...
instance Core.FromJSON AccountsUpdateLabelsResponse
         where
        parseJSON
          = Core.withObject "AccountsUpdateLabelsResponse"
              (\ o ->
                 AccountsUpdateLabelsResponse Core.<$>
                   (o Core..:? "kind"))

instance Core.ToJSON AccountsUpdateLabelsResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "AccountstatusesCustomBatchRequest"
              (\ o ->
                 AccountstatusesCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))
              ...
              (\ o ->
                 AccountstatusesCustomBatchRequestEntry Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "batchId")
                     Core.<*>
                     (o Core..:? "destinations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "merchantId")
                     Core.<*> (o Core..:? "method"))
...
newAccountstatusesCustomBatchResponse =
  AccountstatusesCustomBatchResponse
    {entries = Core.Nothing, kind = Core.Nothing}
...
instance Core.FromJSON AccountstatusesListResponse
         where
        parseJSON
...
instance Core.ToJSON AccountstatusesListResponse
         where
...
instance Core.FromJSON AccounttaxCustomBatchRequest
         where
        parseJSON
          = Core.withObject "AccounttaxCustomBatchRequest"
              (\ o ->
                 AccounttaxCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))

instance Core.ToJSON AccounttaxCustomBatchRequest
         where
...
instance Core.FromJSON AccounttaxCustomBatchResponse
         where
        parseJSON
...
instance Core.ToJSON AccounttaxCustomBatchResponse
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ActivateBuyOnGoogleProgramRequest"
...
instance Core.FromJSON Amount where
        parseJSON
          = Core.withObject "Amount"
              (\ o ->
                 Amount Core.<$>
                   (o Core..:? "priceAmount") Core.<*>
                     (o Core..:? "taxAmount"))
          ...
          = Core.withObject "BusinessDayConfig"
              (\ o ->
                 BusinessDayConfig Core.<$>
                   (o Core..:? "businessDays" Core..!= Core.mempty))
...
instance Core.FromJSON BuyOnGoogleProgramStatus where
        parseJSON
          = Core.withObject "BuyOnGoogleProgramStatus"
              (\ o ->
                 BuyOnGoogleProgramStatus Core.<$>
                   (o Core..:? "businessModel" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "customerServicePendingEmail")
                     Core.<*>
                     (o Core..:? "customerServicePendingPhoneNumber")
                     Core.<*>
                     (o Core..:? "customerServicePendingPhoneRegionCode")
                     Core.<*> (o Core..:? "customerServiceVerifiedEmail")
                     Core.<*>
                     (o Core..:? "customerServiceVerifiedPhoneNumber")
                     Core.<*>
                     (o Core..:? "customerServiceVerifiedPhoneRegionCode")
          ...
          = Core.object
              (Core.catMaybes
                 [("businessModel" Core..=) Core.<$> businessModel,
                  ("customerServicePendingEmail" Core..=) Core.<$>
                  ...
                  ("customerServiceVerifiedEmail" Core..=) Core.<$>
                  ...
                  ("onlineSalesChannel" Core..=) Core.<$>
                    onlineSalesChannel,
                  ("participationStage" Core..=) Core.<$>
                    participationStage])
...
instance Core.FromJSON CaptureOrderRequest where
        parseJSON
          = Core.withObject "CaptureOrderRequest"
...
instance Core.FromJSON CaptureOrderResponse where
        parseJSON
          = Core.withObject "CaptureOrderResponse"
              (\ o ->
                 CaptureOrderResponse Core.<$>
                   (o Core..:? "executionStatus"))

instance Core.ToJSON CaptureOrderResponse where
        toJSON CaptureOrderResponse{..}
          = Core.object
              (Core.catMaybes
                 [("executionStatus" Core..=) Core.<$>
                    executionStatus])
          ...
          = Core.object
              (Core.catMaybes
                 [("carrierName" Core..=) Core.<$> carrierName,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("originPostalCode" Core..=) Core.<$>
                    originPostalCode,
                  ("percentageAdjustment" Core..=) Core.<$>
          ...
          = Core.withObject "CarriersCarrier"
              (\ o ->
                 CarriersCarrier Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "eddServices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "services" Core..!= Core.mempty))
...
newCollectionFeaturedProduct =
  CollectionFeaturedProduct
    {offerId = Core.Nothing, x = Core.Nothing, y = Core.Nothing}

instance Core.FromJSON CollectionFeaturedProduct
         where
        parseJSON
          = Core.withObject "CollectionFeaturedProduct"
              (\ o ->
                 CollectionFeaturedProduct Core.<$>
                   (o Core..:? "offerId") Core.<*> (o Core..:? "x")
                     Core.<*> (o Core..:? "y"))
              ...
              (\ o ->
                 CollectionStatus Core.<$>
                   (o Core..:? "collectionLevelIssuses" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "destinationStatuses" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "id")
...
newCollectionStatusDestinationStatus =
  CollectionStatusDestinationStatus
    {destination = Core.Nothing, status = Core.Nothing}
...
instance Core.FromJSON CollectionStatusItemLevelIssue
         where
        parseJSON
...
instance Core.ToJSON CollectionStatusItemLevelIssue
         where
...
instance Core.ToJSON Css where
        toJSON Css{..}
          = Core.object
              (Core.catMaybes
                 [("cssDomainId" Core..=) Core.. Core.AsText Core.<$>
                    cssDomainId,
                  ("cssGroupId" Core..=) Core.. Core.AsText Core.<$>
                    cssGroupId,
...
newCustomAttribute =
  CustomAttribute
    {groupValues = Core.Nothing, name = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject "CustomAttribute"
              (\ o ->
                 CustomAttribute Core.<$>
                   (o Core..:? "groupValues" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON CustomerReturnReason where
        parseJSON
          = Core.withObject "CustomerReturnReason"
              (\ o ->
...
newCutoffTime =
  CutoffTime
    {hour = Core.Nothing, minute = Core.Nothing, timezone = Core.Nothing}
              ...
              (\ o ->
                 DatafeedStatus Core.<$>
                   (o Core..:? "country") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "warnings" Core..!= Core.mempty))
...
instance Core.ToJSON DatafeedStatus where
        toJSON DatafeedStatus{..}
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ("datafeedId" Core..=) Core.. Core.AsText Core.<$>
                    datafeedId,
                  ("errors" Core..=) Core.<$> errors,
                  ("itemsTotal" Core..=) Core.. Core.AsText Core.<$>
                    itemsTotal,
                  ("itemsValid" Core..=) Core.. Core.AsText Core.<$>
                    itemsValid,
                  ("kind" Core..=) Core.<$> kind,
                  ("language" Core..=) Core.<$> language,
...
newDatafeedStatusExample =
  DatafeedStatusExample
    {itemId = Core.Nothing, lineNumber = Core.Nothing, value = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "DatafeedTarget"
              (\ o ->
                 DatafeedTarget Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "excludedDestinations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "includedDestinations" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "language"))
...
instance Core.ToJSON DatafeedTarget where
        toJSON DatafeedTarget{..}
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ("excludedDestinations" Core..=) Core.<$>
                    excludedDestinations,
                  ("includedDestinations" Core..=) Core.<$>
...
instance Core.FromJSON DatafeedsCustomBatchRequest
         where
        parseJSON
          = Core.withObject "DatafeedsCustomBatchRequest"
              (\ o ->
                 DatafeedsCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))

instance Core.ToJSON DatafeedsCustomBatchRequest
         where
...
instance Core.ToJSON DatafeedsCustomBatchRequestEntry
         where
...
instance Core.FromJSON DatafeedsCustomBatchResponse
         where
        parseJSON
...
instance Core.ToJSON DatafeedsCustomBatchResponse
         where
...
newDatafeedsCustomBatchResponseEntry =
  DatafeedsCustomBatchResponseEntry
    {batchId = Core.Nothing, datafeed = Core.Nothing, errors = Core.Nothing}
...
instance Core.FromJSON DatafeedsFetchNowResponse
         where
        parseJSON
          = Core.withObject "DatafeedsFetchNowResponse"
              (\ o ->
                 DatafeedsFetchNowResponse Core.<$>
                   (o Core..:? "kind"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "DatafeedstatusesCustomBatchRequest"
              (\ o ->
                 DatafeedstatusesCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))
...
instance Core.FromJSON DatafeedstatusesListResponse
         where
        parseJSON
...
instance Core.ToJSON DatafeedstatusesListResponse
         where
              ...
              (\ o ->
                 DeliveryTime Core.<$>
                   (o Core..:? "cutoffTime") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "holidayCutoffs" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "warehouseBasedDeliveryTimes" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("cutoffTime" Core..=) Core.<$> cutoffTime,
                  ...
                  ("maxHandlingTimeInDays" Core..=) Core.<$>
                    maxHandlingTimeInDays,
                  ("maxTransitTimeInDays" Core..=) Core.<$>
                    maxTransitTimeInDays,
                  ("minHandlingTimeInDays" Core..=) Core.<$>
                    minHandlingTimeInDays,
                  ("minTransitTimeInDays" Core..=) Core.<$>
                    minTransitTimeInDays,
                  ("transitBusinessDayConfig" Core..=) Core.<$>
                    transitBusinessDayConfig,
                  ("transitTimeTable" Core..=) Core.<$>
                    transitTimeTable,
...
instance Core.FromJSON ECommercePlatformLinkInfo
         where
        parseJSON
...
instance Core.FromJSON Error' where
        parseJSON
          = Core.withObject "Error'"
              (\ o ->
                 Error' Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "reason"))
        ...
        parseJSON
          = Core.withObject "Errors"
              (\ o ->
                 Errors Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "errors" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "message"))
...
newFreeListingsProgramStatus =
  FreeListingsProgramStatus
    {globalState = Core.Nothing, regionStatuses = Core.Nothing}

instance Core.FromJSON FreeListingsProgramStatus
         where
        parseJSON
          = Core.withObject "FreeListingsProgramStatus"
              (\ o ->
                 FreeListingsProgramStatus Core.<$>
                   (o Core..:? "globalState") Core.<*>
                     (o Core..:? "regionStatuses" Core..!= Core.mempty))
              ...
              (\ o ->
                 FreeListingsProgramStatusRegionStatus Core.<$>
                   (o Core..:? "disapprovalDate") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "onboardingIssues" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "regionCodes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "reviewEligibilityStatus")
                     Core.<*> (o Core..:? "reviewIneligibilityReason")
                     Core.<*>
                     (o Core..:? "reviewIneligibilityReasonDescription")
                     Core.<*>
                     (o Core..:? "reviewIneligibilityReasonDetails")
                     Core.<*>
                     (o Core..:? "reviewIssues" Core..!= Core.mempty))
...
instance Core.ToJSON
        ...
        toJSON FreeListingsProgramStatusRegionStatus{..}
          = Core.object
              (Core.catMaybes
                 [("disapprovalDate" Core..=) Core.<$>
                    disapprovalDate,
                  ("eligibilityStatus" Core..=) Core.<$>
                    eligibilityStatus,
                  ("onboardingIssues" Core..=) Core.<$>
                    onboardingIssues,
        ...
        parseJSON
          = Core.withObject "GmbAccounts"
              (\ o ->
                 GmbAccounts Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "gmbAccounts" Core..!= Core.mempty))
...
instance Core.ToJSON GmbAccountsGmbAccount where
        toJSON GmbAccountsGmbAccount{..}
          = Core.object
              (Core.catMaybes
                 [("email" Core..=) Core.<$> email,
                  ("listingCount" Core..=) Core.. Core.AsText Core.<$>
                    listingCount,
                  ("name" Core..=) Core.<$> name,
                  ("type" Core..=) Core.<$> type'])
              ...
              (\ o ->
                 Headers Core.<$>
                   (o Core..:? "locations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "numberOfItems" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "postalCodeGroupNames" Core..!=
                        Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("locations" Core..=) Core.<$> locations,
                  ...
                  ("postalCodeGroupNames" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("deadlineDate" Core..=) Core.<$> deadlineDate,
                  ...
                  ("deadlineTimezone" Core..=) Core.<$>
                    deadlineTimezone,
                  ("holidayId" Core..=) Core.<$> holidayId,
                  ("visibleFromDate" Core..=) Core.<$>
                    visibleFromDate])
          ...
          = Core.object
              (Core.catMaybes
                 [("countryCode" Core..=) Core.<$> countryCode,
                  ("date" Core..=) Core.<$> date,
                  ("deliveryGuaranteeDate" Core..=) Core.<$>
...
newInapplicabilityDetails =
  InapplicabilityDetails
    {inapplicableCount = Core.Nothing, inapplicableReason = Core.Nothing}

instance Core.FromJSON InapplicabilityDetails where
        parseJSON
          = Core.withObject "InapplicabilityDetails"
              (\ o ->
                 InapplicabilityDetails Core.<$>
                   (o Core..:? "inapplicableCount") Core.<*>
                     (o Core..:? "inapplicableReason"))
...
instance Core.FromJSON Installment where
        parseJSON
          = Core.withObject "Installment"
              (\ o ->
                 Installment Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "months"))
          ...
          = Core.object
              (Core.catMaybes
                 [("amount" Core..=) Core.<$> amount,
                  ("months" Core..=) Core.. Core.AsText Core.<$>
                    months])
...
newInvoiceSummary =
  InvoiceSummary
    {additionalChargeSummaries = Core.Nothing, productTotal = Core.Nothing}

instance Core.FromJSON InvoiceSummary where
        parseJSON
          = Core.withObject "InvoiceSummary"
              (\ o ->
                 InvoiceSummary Core.<$>
                   (o Core..:? "additionalChargeSummaries" Core..!=
                      Core.mempty)
...
instance Core.ToJSON InvoiceSummary where
        toJSON InvoiceSummary{..}
          = Core.object
              (Core.catMaybes
                 [("additionalChargeSummaries" Core..=) Core.<$>
...
newInvoiceSummaryAdditionalChargeSummary =
  InvoiceSummaryAdditionalChargeSummary
    {totalAmount = Core.Nothing, type' = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "InvoiceSummaryAdditionalChargeSummary"
              (\ o ->
                 InvoiceSummaryAdditionalChargeSummary Core.<$>
                   (o Core..:? "totalAmount") Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.withObject "LiaCountrySettings"
              (\ o ->
                 LiaCountrySettings Core.<$>
                   (o Core..:? "about") Core.<*> (o Core..:? "country")
          ...
          = Core.object
              (Core.catMaybes
                 [("about" Core..=) Core.<$> about,
                  ...
                  ("onDisplayToOrder" Core..=) Core.<$>
                    onDisplayToOrder,
                  ("posDataProvider" Core..=) Core.<$> posDataProvider,
                  ("storePickupActive" Core..=) Core.<$>
                    storePickupActive])
          ...
          = Core.withObject "LiaInventorySettings"
              (\ o ->
                 LiaInventorySettings Core.<$>
                   (o Core..:? "inventoryVerificationContactEmail")
                     Core.<*>
                     (o Core..:? "inventoryVerificationContactName")
                     Core.<*>
                     (o Core..:? "inventoryVerificationContactStatus")
                     Core.<*> (o Core..:? "status"))
...
newLiaOnDisplayToOrderSettings =
  LiaOnDisplayToOrderSettings
    {shippingCostPolicyUrl = Core.Nothing, status = Core.Nothing}

instance Core.FromJSON LiaOnDisplayToOrderSettings
         where
        parseJSON
...
instance Core.ToJSON LiaOnDisplayToOrderSettings
         where
        toJSON LiaOnDisplayToOrderSettings{..}
          = Core.object
              (Core.catMaybes
                 [("shippingCostPolicyUrl" Core..=) Core.<$>
...
newLiaPosDataProvider =
  LiaPosDataProvider
    {posDataProviderId = Core.Nothing, posExternalAccountId = Core.Nothing}
          ...
          = Core.withObject "LiaPosDataProvider"
              (\ o ->
                 LiaPosDataProvider Core.<$>
                   (o Core..:? "posDataProviderId") Core.<*>
                     (o Core..:? "posExternalAccountId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("posDataProviderId" Core..=) Core.. Core.AsText
                  ...
                  ("posExternalAccountId" Core..=) Core.<$>
        ...
        parseJSON
          = Core.withObject "LiaSettings"
              (\ o ->
                 LiaSettings Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "countrySettings" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON LiasettingsCustomBatchRequest
         where
        parseJSON
          = Core.withObject "LiasettingsCustomBatchRequest"
              (\ o ->
                 LiasettingsCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))

instance Core.ToJSON LiasettingsCustomBatchRequest
         where
...
instance Core.FromJSON LiasettingsCustomBatchResponse
         where
        parseJSON
...
instance Core.ToJSON LiasettingsCustomBatchResponse
         where
          ...
          = Core.withObject
              ...
              (\ o ->
                 LiasettingsCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "gmbAccounts")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "liaSettings")
                     Core.<*>
                     (o Core..:? "posDataProviders" Core..!= Core.mempty))
...
newLiasettingsGetAccessibleGmbAccountsResponse =
  LiasettingsGetAccessibleGmbAccountsResponse
    {accountId = Core.Nothing, gmbAccounts = Core.Nothing, kind = Core.Nothing}
...
newLiasettingsListPosDataProvidersResponse =
  LiasettingsListPosDataProvidersResponse
    {kind = Core.Nothing, posDataProviders = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "LiasettingsRequestGmbAccessResponse"
              (\ o ->
                 LiasettingsRequestGmbAccessResponse Core.<$>
                   (o Core..:? "kind"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "LiasettingsSetPosDataProviderResponse"
              (\ o ->
                 LiasettingsSetPosDataProviderResponse Core.<$>
                   (o Core..:? "kind"))
...
newListAccountLabelsResponse =
  ListAccountLabelsResponse
    {accountLabels = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListAccountLabelsResponse
         where
        parseJSON
          = Core.withObject "ListAccountLabelsResponse"
              (\ o ->
                 ListAccountLabelsResponse Core.<$>
                   (o Core..:? "accountLabels" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListAccountReturnCarrierResponse"
              (\ o ->
                 ListAccountReturnCarrierResponse Core.<$>
                   (o Core..:? "accountReturnCarriers" Core..!=
                      Core.mempty))

instance Core.ToJSON ListAccountReturnCarrierResponse
         where
        toJSON ListAccountReturnCarrierResponse{..}
          = Core.object
              (Core.catMaybes
                 [("accountReturnCarriers" Core..=) Core.<$>
...
instance Core.FromJSON ListCollectionStatusesResponse
         where
        parseJSON
...
instance Core.ToJSON ListCollectionStatusesResponse
         where
          ...
          = Core.withObject "ListCssesResponse"
              (\ o ->
                 ListCssesResponse Core.<$>
                   (o Core..:? "csses" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListRegionsResponse"
              (\ o ->
                 ListRegionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "regions" Core..!= Core.mempty))
...
newListRepricingProductReportsResponse =
  ListRepricingProductReportsResponse
    {nextPageToken = Core.Nothing, repricingProductReports = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ListRepricingProductReportsResponse"
              (\ o ->
                 ListRepricingProductReportsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "repricingProductReports" Core..!=
                        Core.mempty))
...
instance Core.ToJSON
        ...
        toJSON ListRepricingProductReportsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("repricingProductReports" Core..=) Core.<$>
...
newListRepricingRuleReportsResponse =
  ListRepricingRuleReportsResponse
    {nextPageToken = Core.Nothing, repricingRuleReports = Core.Nothing}

instance Core.FromJSON
           ListRepricingRuleReportsResponse
         where
        parseJSON
          = Core.withObject "ListRepricingRuleReportsResponse"
              (\ o ->
                 ListRepricingRuleReportsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "repricingRuleReports" Core..!=
                        Core.mempty))

instance Core.ToJSON ListRepricingRuleReportsResponse
         where
        toJSON ListRepricingRuleReportsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("repricingRuleReports" Core..=) Core.<$>
...
newListRepricingRulesResponse =
  ListRepricingRulesResponse
    {nextPageToken = Core.Nothing, repricingRules = Core.Nothing}

instance Core.FromJSON ListRepricingRulesResponse
         where
        parseJSON
          = Core.withObject "ListRepricingRulesResponse"
              (\ o ->
                 ListRepricingRulesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "repricingRules" Core..!= Core.mempty))
...
instance Core.FromJSON ListReturnPolicyOnlineResponse
         where
        parseJSON
          = Core.withObject "ListReturnPolicyOnlineResponse"
              (\ o ->
                 ListReturnPolicyOnlineResponse Core.<$>
                   (o Core..:? "returnPolicies" Core..!= Core.mempty))

instance Core.ToJSON ListReturnPolicyOnlineResponse
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("availability" Core..=) Core.<$> availability,
                  ("instoreProductLocation" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "LocalinventoryCustomBatchRequest"
              (\ o ->
                 LocalinventoryCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))

instance Core.ToJSON LocalinventoryCustomBatchRequest
         where
...
newLocalinventoryCustomBatchResponseEntry =
  LocalinventoryCustomBatchResponseEntry
    {batchId = Core.Nothing, errors = Core.Nothing, kind = Core.Nothing}
...
instance Core.FromJSON LocationIdSet where
        parseJSON
          = Core.withObject "LocationIdSet"
              (\ o ->
                 LocationIdSet Core.<$>
                   (o Core..:? "locationIds" Core..!= Core.mempty))
...
newLoyaltyPoints =
  LoyaltyPoints
    {name = Core.Nothing, pointsValue = Core.Nothing, ratio = Core.Nothing}

instance Core.FromJSON LoyaltyPoints where
        parseJSON
          = Core.withObject "LoyaltyPoints"
              (\ o ->
                 LoyaltyPoints Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "pointsValue")
...
instance Core.ToJSON LoyaltyPoints where
        toJSON LoyaltyPoints{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ("pointsValue" Core..=) Core.. Core.AsText Core.<$>
                    pointsValue,
...
instance Core.FromJSON MerchantOrderReturn where
        parseJSON
          = Core.withObject "MerchantOrderReturn"
              (\ o ->
                 MerchantOrderReturn Core.<$>
                   (o Core..:? "creationDate") Core.<*>
                     (o Core..:? "merchantOrderId")
                     Core.<*> (o Core..:? "orderId")
                     Core.<*> (o Core..:? "orderReturnId")
                     Core.<*>
                     (o Core..:? "returnItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "returnPricingInfo")
                     Core.<*>
                     (o Core..:? "returnShipments" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("creationDate" Core..=) Core.<$> creationDate,
                  ...
                  ("returnPricingInfo" Core..=) Core.<$>
                    returnPricingInfo,
                  ("returnShipments" Core..=) Core.<$>
                    returnShipments])
...
instance Core.FromJSON MerchantOrderReturnItem where
        parseJSON
          = Core.withObject "MerchantOrderReturnItem"
              (\ o ->
                 MerchantOrderReturnItem Core.<$>
                   (o Core..:? "customerReturnReason") Core.<*>
                     (o Core..:? "itemId")
                     ...
                     Core.<*>
                     (o Core..:? "returnShipmentIds" Core..!= Core.mempty)
...
instance Core.ToJSON MerchantOrderReturnItem where
        toJSON MerchantOrderReturnItem{..}
          = Core.object
              (Core.catMaybes
                 [("customerReturnReason" Core..=) Core.<$>
                    customerReturnReason,
                  ("itemId" Core..=) Core.<$> itemId,
                  ("merchantRejectionReason" Core..=) Core.<$>
                    merchantRejectionReason,
                  ("merchantReturnReason" Core..=) Core.<$>
                    merchantReturnReason,
                  ("product" Core..=) Core.<$> product,
                  ("refundableAmount" Core..=) Core.<$>
                    refundableAmount,
                  ("returnItemId" Core..=) Core.<$> returnItemId,
                  ("returnShipmentIds" Core..=) Core.<$>
                    returnShipmentIds,
...
newMerchantRejectionReason =
  MerchantRejectionReason
    {description = Core.Nothing, reasonCode = Core.Nothing}

instance Core.FromJSON MerchantRejectionReason where
        parseJSON
          = Core.withObject "MerchantRejectionReason"
              (\ o ->
...
instance Core.FromJSON Metrics where
        parseJSON
          = Core.withObject "Metrics"
              (\ o ->
                 Metrics Core.<$>
                   (o Core..:? "aos") Core.<*> (o Core..:? "aovMicros")
                     Core.<*> (o Core..:? "clicks")
                     Core.<*> (o Core..:? "ctr")
          ...
          = Core.object
              (Core.catMaybes
                 [("aos" Core..=) Core.<$> aos,
                  ...
                  ("clicks" Core..=) Core.. Core.AsText Core.<$>
                    clicks,
                  ("ctr" Core..=) Core.<$> ctr,
                  ...
                  ("orderedItems" Core..=) Core.. Core.AsText Core.<$>
                    orderedItems,
                  ("orders" Core..=) Core.. Core.AsText Core.<$>
                    orders,
          ...
          = Core.withObject "MinimumOrderValueTable"
              (\ o ->
                 MinimumOrderValueTable Core.<$>
                   (o Core..:? "storeCodeSetWithMovs" Core..!=
                      Core.mempty))
...
instance Core.ToJSON MinimumOrderValueTable where
        toJSON MinimumOrderValueTable{..}
          = Core.object
              (Core.catMaybes
                 [("storeCodeSetWithMovs" Core..=) Core.<$>
...
newMinimumOrderValueTableStoreCodeSetWithMov =
  MinimumOrderValueTableStoreCodeSetWithMov
    {storeCodes = Core.Nothing, value = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 MinimumOrderValueTableStoreCodeSetWithMov Core.<$>
                   (o Core..:? "storeCodes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON MonetaryAmount where
        parseJSON
          = Core.withObject "MonetaryAmount"
              (\ o ->
                 MonetaryAmount Core.<$>
                   (o Core..:? "priceAmount") Core.<*>
                     (o Core..:? "taxAmount"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OnboardBuyOnGoogleProgramRequest"
              (\ o ->
                 OnboardBuyOnGoogleProgramRequest Core.<$>
                   (o Core..:? "customerServiceEmail"))

instance Core.ToJSON OnboardBuyOnGoogleProgramRequest
         where
        toJSON OnboardBuyOnGoogleProgramRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customerServiceEmail" Core..=) Core.<$>
              ...
              (\ o ->
                 Order Core.<$>
                   (o Core..:? "acknowledged") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "lineItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "merchantId")
                     ...
                     Core.<*>
                     (o Core..:? "promotions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "refunds" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "shipments" Core..!= Core.mempty)
...
instance Core.FromJSON OrderAddress where
        parseJSON
          = Core.withObject "OrderAddress"
              (\ o ->
                 OrderAddress Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "fullAddress" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "region")
                     Core.<*>
                     (o Core..:? "streetAddress" Core..!= Core.mempty))
...
instance Core.FromJSON OrderCancellation where
        parseJSON
          = Core.withObject "OrderCancellation"
              (\ o ->
                 OrderCancellation Core.<$>
                   (o Core..:? "actor") Core.<*>
                     (o Core..:? "creationDate")
                     Core.<*> (o Core..:? "quantity")
                     Core.<*> (o Core..:? "reason")
...
instance Core.FromJSON OrderCustomer where
        parseJSON
          = Core.withObject "OrderCustomer"
              (\ o ->
                 OrderCustomer Core.<$>
                   (o Core..:? "fullName") Core.<*>
                     (o Core..:? "invoiceReceivingEmail")
...
instance Core.ToJSON OrderCustomer where
        toJSON OrderCustomer{..}
          = Core.object
              (Core.catMaybes
                 [("fullName" Core..=) Core.<$> fullName,
                  ("invoiceReceivingEmail" Core..=) Core.<$>
                    invoiceReceivingEmail,
                  ("loyaltyInfo" Core..=) Core.<$> loyaltyInfo,
                  ("marketingRightsInfo" Core..=) Core.<$>
                    marketingRightsInfo])
...
instance Core.FromJSON OrderCustomerLoyaltyInfo where
        parseJSON
          = Core.withObject "OrderCustomerLoyaltyInfo"
              (\ o ->
                 OrderCustomerLoyaltyInfo Core.<$>
                   (o Core..:? "loyaltyNumber") Core.<*>
                     (o Core..:? "name"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrderCustomerMarketingRightsInfo"
              (\ o ->
                 OrderCustomerMarketingRightsInfo Core.<$>
                   (o Core..:? "explicitMarketingPreference") Core.<*>
                     (o Core..:? "lastUpdatedTimestamp")
                     Core.<*> (o Core..:? "marketingEmailAddress"))

instance Core.ToJSON OrderCustomerMarketingRightsInfo
         where
        toJSON OrderCustomerMarketingRightsInfo{..}
          = Core.object
              (Core.catMaybes
                 [("explicitMarketingPreference" Core..=) Core.<$>
                    explicitMarketingPreference,
                  ("lastUpdatedTimestamp" Core..=) Core.<$>
                    lastUpdatedTimestamp,
                  ("marketingEmailAddress" Core..=) Core.<$>
...
instance Core.FromJSON OrderDeliveryDetails where
        parseJSON
          = Core.withObject "OrderDeliveryDetails"
              (\ o ->
                 OrderDeliveryDetails Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "phoneNumber"))
...
instance Core.FromJSON OrderLineItem where
        parseJSON
          = Core.withObject "OrderLineItem"
              (\ o ->
                 OrderLineItem Core.<$>
                   (o Core..:? "adjustments" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "annotations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "cancellations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "price")
                     Core.<*> (o Core..:? "product")
...
instance Core.FromJSON OrderLineItemAdjustment where
        parseJSON
          = Core.withObject "OrderLineItemAdjustment"
              (\ o ->
                 OrderLineItemAdjustment Core.<$>
                   (o Core..:? "priceAdjustment") Core.<*>
                     (o Core..:? "taxAdjustment")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON OrderLineItemProduct where
        parseJSON
          = Core.withObject "OrderLineItemProduct"
              (\ o ->
                 OrderLineItemProduct Core.<$>
                   (o Core..:? "brand") Core.<*>
                     (o Core..:? "condition")
...
instance Core.FromJSON OrderLineItemProductFee where
        parseJSON
          = Core.withObject "OrderLineItemProductFee"
              (\ o ->
                 OrderLineItemProductFee Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "name"))
...
newOrderLineItemProductVariantAttribute =
  OrderLineItemProductVariantAttribute
    {dimension = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderLineItemProductVariantAttribute"
              (\ o ->
                 OrderLineItemProductVariantAttribute Core.<$>
...
instance Core.FromJSON OrderLineItemReturnInfo where
        parseJSON
          = Core.withObject "OrderLineItemReturnInfo"
              (\ o ->
                 OrderLineItemReturnInfo Core.<$>
                   (o Core..:? "daysToReturn") Core.<*>
                     (o Core..:? "isReturnable")
...
instance Core.FromJSON OrderLineItemShippingDetails
         where
        parseJSON
          = Core.withObject "OrderLineItemShippingDetails"
              (\ o ->
                 OrderLineItemShippingDetails Core.<$>
                   (o Core..:? "deliverByDate") Core.<*>
                     (o Core..:? "method")
                     Core.<*> (o Core..:? "pickupPromiseInMinutes")
                     Core.<*> (o Core..:? "shipByDate")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON OrderLineItemShippingDetails
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("deliverByDate" Core..=) Core.<$> deliverByDate,
                  ("method" Core..=) Core.<$> method,
                  ("pickupPromiseInMinutes" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderLineItemShippingDetailsMethod"
              (\ o ->
                 OrderLineItemShippingDetailsMethod Core.<$>
                   (o Core..:? "carrier") Core.<*>
                     (o Core..:? "maxDaysInTransit")
          ...
          = Core.object
              (Core.catMaybes
                 [("carrier" Core..=) Core.<$> carrier,
                  ("maxDaysInTransit" Core..=) Core.<$>
                    maxDaysInTransit,
                  ("methodName" Core..=) Core.<$> methodName,
                  ("minDaysInTransit" Core..=) Core.<$>
                    minDaysInTransit])
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrderMerchantProvidedAnnotation"
              (\ o ->
                 OrderMerchantProvidedAnnotation Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))

instance Core.ToJSON OrderMerchantProvidedAnnotation
         where
...
instance Core.FromJSON OrderOrderAnnotation where
        parseJSON
          = Core.withObject "OrderOrderAnnotation"
              (\ o ->
                 OrderOrderAnnotation Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON OrderPickupDetails where
        parseJSON
          = Core.withObject "OrderPickupDetails"
              (\ o ->
                 OrderPickupDetails Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "collectors" Core..!= Core.mempty)
...
instance Core.FromJSON OrderPickupDetailsCollector
         where
        parseJSON
          = Core.withObject "OrderPickupDetailsCollector"
              (\ o ->
                 OrderPickupDetailsCollector Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "phoneNumber"))

instance Core.ToJSON OrderPickupDetailsCollector
         where
...
instance Core.FromJSON OrderPromotion where
        parseJSON
          = Core.withObject "OrderPromotion"
              (\ o ->
                 OrderPromotion Core.<$>
                   (o Core..:? "applicableItems" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "appliedItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "funder")
...
instance Core.FromJSON OrderPromotionItem where
        parseJSON
          = Core.withObject "OrderPromotionItem"
              (\ o ->
                 OrderPromotionItem Core.<$>
...
instance Core.FromJSON OrderRefund where
        parseJSON
          = Core.withObject "OrderRefund"
              (\ o ->
                 OrderRefund Core.<$>
                   (o Core..:? "actor") Core.<*> (o Core..:? "amount")
                     Core.<*> (o Core..:? "creationDate")
                     Core.<*> (o Core..:? "reason")
                     Core.<*> (o Core..:? "reasonText"))
...
instance Core.FromJSON OrderReportDisbursement where
        parseJSON
          = Core.withObject "OrderReportDisbursement"
              (\ o ->
                 OrderReportDisbursement Core.<$>
                   (o Core..:? "disbursementAmount") Core.<*>
                     (o Core..:? "disbursementCreationDate")
...
instance Core.ToJSON OrderReportDisbursement where
        toJSON OrderReportDisbursement{..}
          = Core.object
              (Core.catMaybes
                 [("disbursementAmount" Core..=) Core.<$>
                    disbursementAmount,
                  ("disbursementCreationDate" Core..=) Core.<$>
                    disbursementCreationDate,
                  ("disbursementDate" Core..=) Core.<$>
                    disbursementDate,
...
instance Core.FromJSON OrderReportTransaction where
        parseJSON
          = Core.withObject "OrderReportTransaction"
              (\ o ->
                 OrderReportTransaction Core.<$>
                   (o Core..:? "disbursementAmount") Core.<*>
                     (o Core..:? "disbursementCreationDate")
                     Core.<*> (o Core..:? "disbursementDate")
                     Core.<*> (o Core..:? "disbursementId")
          ...
          = Core.object
              (Core.catMaybes
                 [("carrier" Core..=) Core.<$> carrier,
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("lineItems" Core..=) Core.<$> lineItems,
                  ("scheduledDeliveryDetails" Core..=) Core.<$>
...
instance Core.FromJSON OrderShipmentLineItemShipment
         where
        parseJSON
          = Core.withObject "OrderShipmentLineItemShipment"
              (\ o ->
                 OrderShipmentLineItemShipment Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "productId")
                     Core.<*> (o Core..:? "quantity"))

instance Core.ToJSON OrderShipmentLineItemShipment
         where
...
newOrderShipmentScheduledDeliveryDetails =
  OrderShipmentScheduledDeliveryDetails
    {carrierPhoneNumber = Core.Nothing, scheduledDate = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderShipmentScheduledDeliveryDetails"
              (\ o ->
                 OrderShipmentScheduledDeliveryDetails Core.<$>
                   (o Core..:? "carrierPhoneNumber") Core.<*>
                     (o Core..:? "scheduledDate"))
              ...
              (\ o ->
                 OrderTrackingSignal Core.<$>
                   (o Core..:? "customerShippingFee") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "shipmentLineItemMapping" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "shippingInfo" Core..!= Core.mempty))

instance Core.ToJSON OrderTrackingSignal where
        toJSON OrderTrackingSignal{..}
          = Core.object
              (Core.catMaybes
                 [("customerShippingFee" Core..=) Core.<$>
                    customerShippingFee,
                  ("deliveryPostalCode" Core..=) Core.<$>
                    deliveryPostalCode,
                  ("deliveryRegionCode" Core..=) Core.<$>
                    deliveryRegionCode,
                  ("lineItems" Core..=) Core.<$> lineItems,
                  ("merchantId" Core..=) Core.. Core.AsText Core.<$>
                    merchantId,
                  ("orderCreatedTime" Core..=) Core.<$>
                    orderCreatedTime,
                  ("orderId" Core..=) Core.<$> orderId,
...
instance Core.ToJSON OrderTrackingSignalShippingInfo
         where
        toJSON OrderTrackingSignalShippingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("actualDeliveryTime" Core..=) Core.<$>
                    actualDeliveryTime,
                  ("carrierName" Core..=) Core.<$> carrierName,
                  ("carrierServiceName" Core..=) Core.<$>
                    carrierServiceName,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderinvoicesCreateChargeInvoiceRequest"
              (\ o ->
                 OrderinvoicesCreateChargeInvoiceRequest Core.<$>
                   (o Core..:? "invoiceId") Core.<*>
                     (o Core..:? "invoiceSummary")
                     Core.<*>
                     (o Core..:? "lineItemInvoices" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("invoiceId" Core..=) Core.<$> invoiceId,
                  ...
                  ("lineItemInvoices" Core..=) Core.<$>
                    lineItemInvoices,
                  ("operationId" Core..=) Core.<$> operationId,
                  ("shipmentGroupId" Core..=) Core.<$>
                    shipmentGroupId])
...
newOrderinvoicesCreateChargeInvoiceResponse =
  OrderinvoicesCreateChargeInvoiceResponse
    {executionStatus = Core.Nothing, kind = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderinvoicesCreateChargeInvoiceResponse"
              (\ o ->
                 OrderinvoicesCreateChargeInvoiceResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderinvoicesCreateRefundInvoiceRequest"
              (\ o ->
                 OrderinvoicesCreateRefundInvoiceRequest Core.<$>
                   (o Core..:? "invoiceId") Core.<*>
                     (o Core..:? "operationId")
                     Core.<*> (o Core..:? "refundOnlyOption")
                     Core.<*> (o Core..:? "returnOption")
                     Core.<*>
                     (o Core..:? "shipmentInvoices" Core..!= Core.mempty))
        ...
        toJSON OrderinvoicesCreateRefundInvoiceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("invoiceId" Core..=) Core.<$> invoiceId,
                  ("operationId" Core..=) Core.<$> operationId,
                  ("refundOnlyOption" Core..=) Core.<$>
                    refundOnlyOption,
                  ("returnOption" Core..=) Core.<$> returnOption,
                  ("shipmentInvoices" Core..=) Core.<$>
                    shipmentInvoices])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderinvoicesCreateRefundInvoiceResponse"
              (\ o ->
                 OrderinvoicesCreateRefundInvoiceResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
newOrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceRefundOption =
  OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceRefundOption
    {description = Core.Nothing, reason = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderreportsListDisbursementsResponse"
              (\ o ->
                 OrderreportsListDisbursementsResponse Core.<$>
                   (o Core..:? "disbursements" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderreportsListTransactionsResponse"
              (\ o ->
                 OrderreportsListTransactionsResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "transactions" Core..!= Core.mempty))
...
instance Core.FromJSON OrderreturnsAcknowledgeRequest
         where
        parseJSON
          = Core.withObject "OrderreturnsAcknowledgeRequest"
              (\ o ->
                 OrderreturnsAcknowledgeRequest Core.<$>
                   (o Core..:? "operationId"))

instance Core.ToJSON OrderreturnsAcknowledgeRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrderreturnsAcknowledgeResponse"
              (\ o ->
                 OrderreturnsAcknowledgeResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))

instance Core.ToJSON OrderreturnsAcknowledgeResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderreturnsCreateOrderReturnRequest"
              (\ o ->
                 OrderreturnsCreateOrderReturnRequest Core.<$>
                   (o Core..:? "lineItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "operationId")
                     Core.<*> (o Core..:? "orderId")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrderreturnsCreateOrderReturnResponse"
              (\ o ->
                 OrderreturnsCreateOrderReturnResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind")
...
instance Core.FromJSON OrderreturnsLineItem where
        parseJSON
          = Core.withObject "OrderreturnsLineItem"
              (\ o ->
                 OrderreturnsLineItem Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "productId")
                     Core.<*> (o Core..:? "quantity"))
...
instance Core.FromJSON OrderreturnsListResponse where
        parseJSON
          = Core.withObject "OrderreturnsListResponse"
              (\ o ->
                 OrderreturnsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "resources" Core..!= Core.mempty))
...
newOrderreturnsPartialRefund =
  OrderreturnsPartialRefund
    {priceAmount = Core.Nothing, taxAmount = Core.Nothing}

instance Core.FromJSON OrderreturnsPartialRefund
         where
        parseJSON
          = Core.withObject "OrderreturnsPartialRefund"
              (\ o ->
                 OrderreturnsPartialRefund Core.<$>
                   (o Core..:? "priceAmount") Core.<*>
                     (o Core..:? "taxAmount"))
...
instance Core.FromJSON OrderreturnsProcessRequest
         where
        parseJSON
          = Core.withObject "OrderreturnsProcessRequest"
              (\ o ->
                 OrderreturnsProcessRequest Core.<$>
                   (o Core..:? "fullChargeReturnShippingCost") Core.<*>
                     (o Core..:? "operationId")
...
instance Core.ToJSON OrderreturnsProcessRequest where
        toJSON OrderreturnsProcessRequest{..}
          = Core.object
              (Core.catMaybes
                 [("fullChargeReturnShippingCost" Core..=) Core.<$>
                    fullChargeReturnShippingCost,
                  ("operationId" Core..=) Core.<$> operationId,
                  ("refundShippingFee" Core..=) Core.<$>
                    refundShippingFee,
                  ("returnItems" Core..=) Core.<$> returnItems])
...
instance Core.FromJSON OrderreturnsProcessResponse
         where
        parseJSON
          = Core.withObject "OrderreturnsProcessResponse"
              (\ o ->
                 OrderreturnsProcessResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))

instance Core.ToJSON OrderreturnsProcessResponse
         where
...
instance Core.FromJSON OrderreturnsRefundOperation
         where
        parseJSON
          = Core.withObject "OrderreturnsRefundOperation"
              (\ o ->
                 OrderreturnsRefundOperation Core.<$>
...
instance Core.ToJSON OrderreturnsRefundOperation
         where
...
instance Core.FromJSON OrderreturnsRejectOperation
         where
        parseJSON
          = Core.withObject "OrderreturnsRejectOperation"
              (\ o ->
                 OrderreturnsRejectOperation Core.<$>
                   (o Core..:? "reason") Core.<*>
                     (o Core..:? "reasonText"))

instance Core.ToJSON OrderreturnsRejectOperation
         where
...
newOrderreturnsReturnItem =
  OrderreturnsReturnItem
    {refund = Core.Nothing, reject = Core.Nothing, returnItemId = Core.Nothing}

instance Core.FromJSON OrderreturnsReturnItem where
        parseJSON
          = Core.withObject "OrderreturnsReturnItem"
              (\ o ->
                 OrderreturnsReturnItem Core.<$>
                   (o Core..:? "refund") Core.<*> (o Core..:? "reject")
                     Core.<*> (o Core..:? "returnItemId"))
...
instance Core.FromJSON OrdersAcknowledgeRequest where
        parseJSON
          = Core.withObject "OrdersAcknowledgeRequest"
              (\ o ->
                 OrdersAcknowledgeRequest Core.<$>
                   (o Core..:? "operationId"))
...
instance Core.FromJSON OrdersAcknowledgeResponse
         where
        parseJSON
          = Core.withObject "OrdersAcknowledgeResponse"
              (\ o ->
                 OrdersAcknowledgeResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON OrdersAdvanceTestOrderResponse
         where
        parseJSON
          = Core.withObject "OrdersAdvanceTestOrderResponse"
              (\ o ->
                 OrdersAdvanceTestOrderResponse Core.<$>
                   (o Core..:? "kind"))

instance Core.ToJSON OrdersAdvanceTestOrderResponse
         where
...
instance Core.FromJSON OrdersCancelLineItemRequest
         where
        parseJSON
          = Core.withObject "OrdersCancelLineItemRequest"
              (\ o ->
                 OrdersCancelLineItemRequest Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "operationId")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "quantity")
...
instance Core.ToJSON OrdersCancelLineItemRequest
         where
...
instance Core.FromJSON OrdersCancelLineItemResponse
         where
        parseJSON
          = Core.withObject "OrdersCancelLineItemResponse"
              (\ o ->
                 OrdersCancelLineItemResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))

instance Core.ToJSON OrdersCancelLineItemResponse
         where
...
instance Core.FromJSON OrdersCancelRequest where
        parseJSON
          = Core.withObject "OrdersCancelRequest"
              (\ o ->
                 OrdersCancelRequest Core.<$>
...
instance Core.FromJSON OrdersCancelResponse where
        parseJSON
          = Core.withObject "OrdersCancelResponse"
              (\ o ->
                 OrdersCancelResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersCancelTestOrderByCustomerRequest"
              (\ o ->
                 OrdersCancelTestOrderByCustomerRequest Core.<$>
                   (o Core..:? "reason"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersCancelTestOrderByCustomerResponse"
              (\ o ->
                 OrdersCancelTestOrderByCustomerResponse Core.<$>
                   (o Core..:? "kind"))
...
instance Core.FromJSON OrdersCreateTestOrderRequest
         where
        parseJSON
          = Core.withObject "OrdersCreateTestOrderRequest"
              (\ o ->
                 OrdersCreateTestOrderRequest Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "templateName")
                     Core.<*> (o Core..:? "testOrder"))

instance Core.ToJSON OrdersCreateTestOrderRequest
         where
...
instance Core.FromJSON OrdersCreateTestOrderResponse
         where
        parseJSON
          = Core.withObject "OrdersCreateTestOrderResponse"
              (\ o ->
                 OrdersCreateTestOrderResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "orderId"))

instance Core.ToJSON OrdersCreateTestOrderResponse
         where
...
instance Core.FromJSON OrdersCreateTestReturnRequest
         where
        parseJSON
          = Core.withObject "OrdersCreateTestReturnRequest"
              (\ o ->
                 OrdersCreateTestReturnRequest Core.<$>
                   (o Core..:? "items" Core..!= Core.mempty))

instance Core.ToJSON OrdersCreateTestReturnRequest
         where
...
instance Core.FromJSON OrdersCreateTestReturnResponse
         where
        parseJSON
          = Core.withObject "OrdersCreateTestReturnResponse"
              (\ o ->
                 OrdersCreateTestReturnResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "returnId"))

instance Core.ToJSON OrdersCreateTestReturnResponse
         where
...
newOrdersCustomBatchRequestEntryCreateTestReturnReturnItem =
  OrdersCustomBatchRequestEntryCreateTestReturnReturnItem
    {lineItemId = Core.Nothing, quantity = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersCustomBatchRequestEntryRefundItemItem"
              (\ o ->
                 OrdersCustomBatchRequestEntryRefundItemItem Core.<$>
                   (o Core..:? "amount") Core.<*>
                     (o Core..:? "fullRefund")
                     Core.<*> (o Core..:? "lineItemId")
                     Core.<*> (o Core..:? "productId")
...
newOrdersCustomBatchRequestEntryRefundItemShipping =
  OrdersCustomBatchRequestEntryRefundItemShipping
    {amount = Core.Nothing, fullRefund = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersGetByMerchantOrderIdResponse"
              (\ o ->
                 OrdersGetByMerchantOrderIdResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "order"))
...
newOrdersGetTestOrderTemplateResponse =
  OrdersGetTestOrderTemplateResponse
    {kind = Core.Nothing, template = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersGetTestOrderTemplateResponse"
              (\ o ->
                 OrdersGetTestOrderTemplateResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "template"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersInStoreRefundLineItemRequest"
              (\ o ->
                 OrdersInStoreRefundLineItemRequest Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "operationId")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersInStoreRefundLineItemResponse"
              (\ o ->
                 OrdersInStoreRefundLineItemResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON OrdersRefundItemRequest where
        parseJSON
          = Core.withObject "OrdersRefundItemRequest"
              (\ o ->
                 OrdersRefundItemRequest Core.<$>
...
instance Core.FromJSON OrdersRefundItemResponse where
        parseJSON
          = Core.withObject "OrdersRefundItemResponse"
              (\ o ->
                 OrdersRefundItemResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON OrdersRefundOrderRequest where
        parseJSON
          = Core.withObject "OrdersRefundOrderRequest"
              (\ o ->
                 OrdersRefundOrderRequest Core.<$>
                   (o Core..:? "amount") Core.<*>
                     (o Core..:? "fullRefund")
                     Core.<*> (o Core..:? "operationId")
                     Core.<*> (o Core..:? "reason")
...
instance Core.FromJSON OrdersRefundOrderResponse
         where
        parseJSON
          = Core.withObject "OrdersRefundOrderResponse"
              (\ o ->
                 OrdersRefundOrderResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrdersRejectReturnLineItemRequest"
              (\ o ->
                 OrdersRejectReturnLineItemRequest Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "operationId")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "quantity")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersRejectReturnLineItemResponse"
              (\ o ->
                 OrdersRejectReturnLineItemResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrdersReturnRefundLineItemRequest"
              (\ o ->
                 OrdersReturnRefundLineItemRequest Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "operationId")
                     Core.<*> (o Core..:? "priceAmount")
                     Core.<*> (o Core..:? "productId")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersReturnRefundLineItemResponse"
              (\ o ->
                 OrdersReturnRefundLineItemResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrdersSetLineItemMetadataRequest"
              (\ o ->
                 OrdersSetLineItemMetadataRequest Core.<$>
                   (o Core..:? "annotations" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "lineItemId")
                     Core.<*> (o Core..:? "operationId")
                     Core.<*> (o Core..:? "productId"))

instance Core.ToJSON OrdersSetLineItemMetadataRequest
         where
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "OrdersSetLineItemMetadataResponse"
              (\ o ->
                 OrdersSetLineItemMetadataResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.FromJSON OrdersShipLineItemsRequest
         where
        parseJSON
          = Core.withObject "OrdersShipLineItemsRequest"
              (\ o ->
                 OrdersShipLineItemsRequest Core.<$>
                   (o Core..:? "lineItems" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "operationId")
                     Core.<*> (o Core..:? "shipmentGroupId")
                     Core.<*>
                     (o Core..:? "shipmentInfos" Core..!= Core.mempty))
...
instance Core.FromJSON OrdersShipLineItemsResponse
         where
        parseJSON
          = Core.withObject "OrdersShipLineItemsResponse"
              (\ o ->
                 OrdersShipLineItemsResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))

instance Core.ToJSON OrdersShipLineItemsResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersUpdateLineItemShippingDetailsRequest"
              (\ o ->
                 OrdersUpdateLineItemShippingDetailsRequest Core.<$>
                   (o Core..:? "deliverByDate") Core.<*>
                     (o Core..:? "lineItemId")
                     Core.<*> (o Core..:? "operationId")
                     Core.<*> (o Core..:? "productId")
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersUpdateLineItemShippingDetailsResponse"
              (\ o ->
                 OrdersUpdateLineItemShippingDetailsResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
newOrdersUpdateMerchantOrderIdRequest =
  OrdersUpdateMerchantOrderIdRequest
    {merchantOrderId = Core.Nothing, operationId = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersUpdateMerchantOrderIdRequest"
              (\ o ->
                 OrdersUpdateMerchantOrderIdRequest Core.<$>
                   (o Core..:? "merchantOrderId") Core.<*>
                     (o Core..:? "operationId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OrdersUpdateMerchantOrderIdResponse"
              (\ o ->
                 OrdersUpdateMerchantOrderIdResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))
...
data OrdersUpdateShipmentRequest = OrdersUpdateShipmentRequest
    ...
    , readyPickupDate :: (Core.Maybe Core.Text)
      -- | Delivery details of the shipment if scheduling is needed.
    , scheduledDeliveryDetails :: (Core.Maybe
   OrdersCustomBatchRequestEntryUpdateShipmentScheduledDeliveryDetails)
      -- | The ID of the shipment.
    , shipmentId :: (Core.Maybe Core.Text)
...
instance Core.FromJSON OrdersUpdateShipmentRequest
         where
        parseJSON
          = Core.withObject "OrdersUpdateShipmentRequest"
              (\ o ->
                 OrdersUpdateShipmentRequest Core.<$>
                   (o Core..:? "carrier") Core.<*>
                     (o Core..:? "deliveryDate")
...
instance Core.ToJSON OrdersUpdateShipmentRequest
         where
...
instance Core.FromJSON OrdersUpdateShipmentResponse
         where
        parseJSON
          = Core.withObject "OrdersUpdateShipmentResponse"
              (\ o ->
                 OrdersUpdateShipmentResponse Core.<$>
                   (o Core..:? "executionStatus") Core.<*>
                     (o Core..:? "kind"))

instance Core.ToJSON OrdersUpdateShipmentResponse
         where
...
instance Core.FromJSON PauseBuyOnGoogleProgramRequest
         where
        parseJSON
          = Core.withObject "PauseBuyOnGoogleProgramRequest"
              (\ o -> Core.pure PauseBuyOnGoogleProgramRequest)

instance Core.ToJSON PauseBuyOnGoogleProgramRequest
         where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON PaymentServiceProviderLinkInfo
         where
        parseJSON
          = Core.withObject "PaymentServiceProviderLinkInfo"
              (\ o ->
                 PaymentServiceProviderLinkInfo Core.<$>
                   (o Core..:? "externalAccountBusinessCountry")
                     Core.<*> (o Core..:? "externalAccountId"))

instance Core.ToJSON PaymentServiceProviderLinkInfo
         where
...
instance Core.FromJSON PickupServicesPickupService
         where
        parseJSON
...
instance Core.ToJSON PickupServicesPickupService
         where
...
instance Core.FromJSON PosCustomBatchRequestEntry
         where
        parseJSON
...
instance Core.FromJSON PosCustomBatchResponseEntry
         where
        parseJSON
...
instance Core.ToJSON PosCustomBatchResponseEntry
         where
...
instance Core.ToJSON PosDataProvidersPosDataProvider
         where
        toJSON PosDataProvidersPosDataProvider{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("fullName" Core..=) Core.<$> fullName,
                  ("providerId" Core..=) Core.. Core.AsText Core.<$>
                    providerId])
...
instance Core.FromJSON PosStore where
        parseJSON
          = Core.withObject "PosStore"
              (\ o ->
                 PosStore Core.<$>
                   (o Core..:? "gcidCategory" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "phoneNumber")
                     Core.<*> (o Core..:? "placeId")
          ...
          = Core.withObject "PostalCodeGroup"
              (\ o ->
                 PostalCodeGroup Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "postalCodeRanges" Core..!= Core.mempty))
...
newPostalCodeRange =
  PostalCodeRange
    {postalCodeRangeBegin = Core.Nothing, postalCodeRangeEnd = Core.Nothing}
...
instance Core.ToJSON PostalCodeRange where
        toJSON PostalCodeRange{..}
          = Core.object
              (Core.catMaybes
                 [("postalCodeRangeBegin" Core..=) Core.<$>
                    postalCodeRangeBegin,
                  ("postalCodeRangeEnd" Core..=) Core.<$>
                    postalCodeRangeEnd])
              ...
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "additionalImageLinks" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "adsLabels" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "customAttributes" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "displayAdsSimilarIds" Core..!=
                        Core.mempty)
                     ...
                     Core.<*> (o Core..:? "price")
                     Core.<*>
                     (o Core..:? "productDetails" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "productHeight")
                     Core.<*>
                     (o Core..:? "productHighlights" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "productLength")
                     Core.<*>
                     (o Core..:? "productTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "productWeight")
                     Core.<*> (o Core..:? "productWidth")
                     Core.<*>
                     (o Core..:? "promotionIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "salePrice")
                     Core.<*> (o Core..:? "salePriceEffectiveDate")
                     ...
                     Core.<*>
                     (o Core..:? "shoppingAdsExcludedCountries" Core..!=
                        Core.mempty)
...
instance Core.ToJSON Product where
        toJSON Product{..}
          = Core.object
              (Core.catMaybes
                 [("additionalImageLinks" Core..=) Core.<$>
                    additionalImageLinks,
                  ("additionalSizeType" Core..=) Core.<$>
                    additionalSizeType,
                  ...
                  ("mobileLink" Core..=) Core.<$> mobileLink,
                  ("mobileLinkTemplate" Core..=) Core.<$>
                    mobileLinkTemplate,
                  ("mpn" Core..=) Core.<$> mpn,
                  ("multipack" Core..=) Core.. Core.AsText Core.<$>
                    multipack,
                  ("offerId" Core..=) Core.<$> offerId,
                  ...
                  ("subscriptionCost" Core..=) Core.<$>
                    subscriptionCost,
                  ("targetCountry" Core..=) Core.<$> targetCountry,
                  ("taxCategory" Core..=) Core.<$> taxCategory,
                  ("taxes" Core..=) Core.<$> taxes,
                  ("title" Core..=) Core.<$> title,
                  ("transitTimeLabel" Core..=) Core.<$>
                    transitTimeLabel,
                  ("unitPricingBaseMeasure" Core..=) Core.<$>
                    unitPricingBaseMeasure,
                  ("unitPricingMeasure" Core..=) Core.<$>
                    unitPricingMeasure])
...
instance Core.FromJSON ProductAmount where
        parseJSON
          = Core.withObject "ProductAmount"
              (\ o ->
                 ProductAmount Core.<$>
                   (o Core..:? "priceAmount") Core.<*>
                     (o Core..:? "remittedTaxAmount")
                     Core.<*> (o Core..:? "taxAmount"))
          ...
          = Core.object
              (Core.catMaybes
                 [("creationDate" Core..=) Core.<$> creationDate,
                  ("destinationStatuses" Core..=) Core.<$>
                    destinationStatuses,
                  ("googleExpirationDate" Core..=) Core.<$>
...
instance Core.FromJSON ProductStatusDestinationStatus
         where
        parseJSON
          = Core.withObject "ProductStatusDestinationStatus"
              (\ o ->
                 ProductStatusDestinationStatus Core.<$>
                   (o Core..:? "approvedCountries" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "destination")
                     Core.<*>
                     (o Core..:? "disapprovedCountries" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "pendingCountries" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "status"))

instance Core.ToJSON ProductStatusDestinationStatus
         where
        toJSON ProductStatusDestinationStatus{..}
          = Core.object
              (Core.catMaybes
                 [("approvedCountries" Core..=) Core.<$>
                    approvedCountries,
                  ("destination" Core..=) Core.<$> destination,
                  ("disapprovedCountries" Core..=) Core.<$>
                    disapprovedCountries,
                  ("pendingCountries" Core..=) Core.<$>
                    pendingCountries,
                  ("status" Core..=) Core.<$> status])
...
instance Core.FromJSON ProductStatusItemLevelIssue
         where
        parseJSON
...
instance Core.ToJSON ProductStatusItemLevelIssue
         where
        toJSON ProductStatusItemLevelIssue{..}
          = Core.object
              (Core.catMaybes
                 [("applicableCountries" Core..=) Core.<$>
                    applicableCountries,
                  ("attributeName" Core..=) Core.<$> attributeName,
                  ("code" Core..=) Core.<$> code,
                  ("description" Core..=) Core.<$> description,
...
newProductSubscriptionCost =
  ProductSubscriptionCost
    {amount = Core.Nothing, period = Core.Nothing, periodLength = Core.Nothing}
          ...
          = Core.withObject "ProductSubscriptionCost"
              (\ o ->
                 ProductSubscriptionCost Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "period")
          ...
          = Core.object
              (Core.catMaybes
                 [("amount" Core..=) Core.<$> amount,
                  ...
                  ("periodLength" Core..=) Core.. Core.AsText Core.<$>
                    periodLength])
...
instance Core.FromJSON ProductUnitPricingBaseMeasure
         where
        parseJSON
...
instance Core.ToJSON ProductUnitPricingBaseMeasure
         where
...
instance Core.FromJSON ProductUnitPricingMeasure
         where
        parseJSON
...
instance Core.FromJSON ProductsCustomBatchRequest
         where
        parseJSON
          = Core.withObject "ProductsCustomBatchRequest"
              (\ o ->
                 ProductsCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))
          ...
          = Core.withObject "ProductsCustomBatchRequestEntry"
              (\ o ->
                 ProductsCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "feedId")
                     Core.<*> (o Core..:? "merchantId")
                     Core.<*> (o Core..:? "method")
                     Core.<*> (o Core..:? "product")
                     Core.<*> (o Core..:? "productId")
...
instance Core.ToJSON ProductsCustomBatchRequestEntry
         where
        toJSON ProductsCustomBatchRequestEntry{..}
          = Core.object
              (Core.catMaybes
                 [("batchId" Core..=) Core.<$> batchId,
                  ("feedId" Core..=) Core.. Core.AsText Core.<$>
                    feedId,
                  ("merchantId" Core..=) Core.. Core.AsText Core.<$>
                    merchantId,
                  ("method" Core..=) Core.<$> method,
...
instance Core.FromJSON ProductsCustomBatchResponse
         where
        parseJSON
...
instance Core.ToJSON ProductsCustomBatchResponse
         where
...
instance Core.ToJSON ProductsCustomBatchResponseEntry
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "ProductstatusesCustomBatchRequest"
              (\ o ->
                 ProductstatusesCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))
...
instance Core.FromJSON ProductstatusesListResponse
         where
        parseJSON
...
instance Core.ToJSON ProductstatusesListResponse
         where
...
instance Core.FromJSON Promotion where
        parseJSON
          = Core.withObject "Promotion"
              (\ o ->
                 Promotion Core.<$>
                   (o Core..:? "brand" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "brandExclusion" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "contentLanguage")
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "itemGroupId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "itemGroupIdExclusion" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "itemId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "itemIdExclusion" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "productType" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "productTypeExclusion" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "promotionDestinationIds" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "redemptionChannel" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "shippingServiceNames" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "targetCountry"))
          ...
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ...
                  ("minimumPurchaseAmount" Core..=) Core.<$>
                  ...
                  ("redemptionChannel" Core..=) Core.<$>
                    redemptionChannel,
                  ("shippingServiceNames" Core..=) Core.<$>
...
instance Core.FromJSON PubsubNotificationSettings
         where
        parseJSON
          = Core.withObject "PubsubNotificationSettings"
              (\ o ->
                 PubsubNotificationSettings Core.<$>
                   (o Core..:? "cloudTopicName") Core.<*>
                     (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "registeredEvents" Core..!= Core.mempty))
              ...
              (\ o ->
                 RateGroup Core.<$>
                   (o Core..:? "applicableShippingLabels" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "carrierRates" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "mainTable")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "singleValue")
                     Core.<*>
                     (o Core..:? "subtables" Core..!= Core.mempty))
...
instance Core.ToJSON RegionGeoTargetArea where
        toJSON RegionGeoTargetArea{..}
          = Core.object
              (Core.catMaybes
                 [("geotargetCriteriaIds" Core..=) Core.<$>
          ...
          = Core.withObject "RegionPostalCodeArea"
              (\ o ->
                 RegionPostalCodeArea Core.<$>
                   (o Core..:? "postalCodes" Core..!= Core.mempty)
...
instance Core.FromJSON RepricingProductReport where
        parseJSON
          = Core.withObject "RepricingProductReport"
              (\ o ->
                 RepricingProductReport Core.<$>
                   (o Core..:? "applicationCount") Core.<*>
                     (o Core..:? "buyboxWinningProductStats")
                     Core.<*> (o Core..:? "date")
                     Core.<*> (o Core..:? "highWatermark")
                     Core.<*>
                     (o Core..:? "inapplicabilityDetails" Core..!=
                        Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("applicationCount" Core..=) Core.. Core.AsText
                  ...
                  ("buyboxWinningProductStats" Core..=) Core.<$>
                    buyboxWinningProductStats,
                  ("date" Core..=) Core.<$> date,
                  ("highWatermark" Core..=) Core.<$> highWatermark,
                  ("inapplicabilityDetails" Core..=) Core.<$>
                    inapplicabilityDetails,
...
instance Core.FromJSON RepricingRule where
        parseJSON
          = Core.withObject "RepricingRule"
              (\ o ->
                 RepricingRule Core.<$>
                   (o Core..:? "cogsBasedRule") Core.<*>
                     (o Core..:? "countryCode")
          ...
          = Core.object
              (Core.catMaybes
                 [("cogsBasedRule" Core..=) Core.<$> cogsBasedRule,
                  ("countryCode" Core..=) Core.<$> countryCode,
                  ("effectiveTimePeriod" Core..=) Core.<$>
                    effectiveTimePeriod,
                  ("eligibleOfferMatcher" Core..=) Core.<$>
...
newRepricingRuleCostOfGoodsSaleRule =
  RepricingRuleCostOfGoodsSaleRule
    {percentageDelta = Core.Nothing, priceDelta = Core.Nothing}

instance Core.FromJSON
           RepricingRuleCostOfGoodsSaleRule
         where
        parseJSON
          = Core.withObject "RepricingRuleCostOfGoodsSaleRule"
              (\ o ->
                 RepricingRuleCostOfGoodsSaleRule Core.<$>
                   (o Core..:? "percentageDelta") Core.<*>
                     (o Core..:? "priceDelta"))

instance Core.ToJSON RepricingRuleCostOfGoodsSaleRule
         where
        toJSON RepricingRuleCostOfGoodsSaleRule{..}
          = Core.object
              (Core.catMaybes
                 [("percentageDelta" Core..=) Core.<$>
                    percentageDelta,
...
instance Core.FromJSON RepricingRuleEffectiveTime
         where
        parseJSON
          = Core.withObject "RepricingRuleEffectiveTime"
              (\ o ->
                 RepricingRuleEffectiveTime Core.<$>
                   (o Core..:? "fixedTimePeriods" Core..!= Core.mempty))

instance Core.ToJSON RepricingRuleEffectiveTime where
        toJSON RepricingRuleEffectiveTime{..}
          = Core.object
              (Core.catMaybes
                 [("fixedTimePeriods" Core..=) Core.<$>
                    fixedTimePeriods])
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RepricingRuleEffectiveTimeFixedTimePeriod"
              (\ o ->
                 RepricingRuleEffectiveTimeFixedTimePeriod Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     (o Core..:? "startTime"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "RepricingRuleEligibleOfferMatcher"
              (\ o ->
                 RepricingRuleEligibleOfferMatcher Core.<$>
                   (o Core..:? "brandMatcher") Core.<*>
                     (o Core..:? "itemGroupIdMatcher")
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 RepricingRuleEligibleOfferMatcherStringMatcher
                   Core.<$>
                   (o Core..:? "strAttributes" Core..!= Core.mempty))
...
instance Core.FromJSON RepricingRuleReport where
        parseJSON
          = Core.withObject "RepricingRuleReport"
              (\ o ->
                 RepricingRuleReport Core.<$>
                   (o Core..:? "buyboxWinningRuleStats") Core.<*>
                     (o Core..:? "date")
                     Core.<*>
                     (o Core..:? "impactedProducts" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "inapplicabilityDetails" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "inapplicableProducts" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "orderItemCount")
                     Core.<*> (o Core..:? "ruleId")
                     Core.<*> (o Core..:? "totalGmv")
...
instance Core.ToJSON RepricingRuleReport where
        toJSON RepricingRuleReport{..}
          = Core.object
              (Core.catMaybes
                 [("buyboxWinningRuleStats" Core..=) Core.<$>
                    buyboxWinningRuleStats,
                  ("date" Core..=) Core.<$> date,
                  ("impactedProducts" Core..=) Core.<$>
                    impactedProducts,
                  ("inapplicabilityDetails" Core..=) Core.<$>
                    inapplicabilityDetails,
                  ("inapplicableProducts" Core..=) Core.<$>
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RepricingRuleReportBuyboxWinningRuleStats"
              (\ o ->
                 RepricingRuleReportBuyboxWinningRuleStats Core.<$>
                   (o Core..:? "buyboxWonProductCount"))
...
instance Core.ToJSON
        ...
        toJSON RepricingRuleReportBuyboxWinningRuleStats{..}
          = Core.object
              (Core.catMaybes
                 [("buyboxWonProductCount" Core..=) Core.<$>
...
newRepricingRuleRestriction =
  RepricingRuleRestriction
    {floor = Core.Nothing, useAutoPricingMinPrice = Core.Nothing}

instance Core.FromJSON RepricingRuleRestriction where
        parseJSON
          = Core.withObject "RepricingRuleRestriction"
              (\ o ->
                 RepricingRuleRestriction Core.<$>
                   (o Core..:? "floor") Core.<*>
                     (o Core..:? "useAutoPricingMinPrice"))
          ...
          = Core.object
              (Core.catMaybes
                 [("floor" Core..=) Core.<$> floor,
                  ("useAutoPricingMinPrice" Core..=) Core.<$>
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "RepricingRuleRestrictionBoundary"
              (\ o ->
                 RepricingRuleRestrictionBoundary Core.<$>
                   (o Core..:? "percentageDelta") Core.<*>
                     (o Core..:? "priceDelta"))

instance Core.ToJSON RepricingRuleRestrictionBoundary
         where
...
instance Core.FromJSON RepricingRuleStatsBasedRule
         where
        parseJSON
          = Core.withObject "RepricingRuleStatsBasedRule"
              (\ o ->
                 RepricingRuleStatsBasedRule Core.<$>
                   (o Core..:? "percentageDelta") Core.<*>
                     (o Core..:? "priceDelta"))

instance Core.ToJSON RepricingRuleStatsBasedRule
         where
...
instance Core.ToJSON RequestPhoneVerificationRequest
         where
...
instance Core.ToJSON RequestPhoneVerificationResponse
         where
...
instance Core.ToJSON RequestReviewFreeListingsRequest
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "RequestReviewShoppingAdsRequest"
              (\ o ->
                 RequestReviewShoppingAdsRequest Core.<$>
                   (o Core..:? "regionCode"))

instance Core.ToJSON RequestReviewShoppingAdsRequest
         where
...
instance Core.FromJSON ReturnPolicy where
        parseJSON
          = Core.withObject "ReturnPolicy"
              (\ o ->
                 ReturnPolicy Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "nonFreeReturnReasons" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "policy")
                     Core.<*> (o Core..:? "returnPolicyId")
                     Core.<*> (o Core..:? "returnShippingFee")
                     Core.<*>
                     (o Core..:? "seasonalOverrides" Core..!=
                        Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("label" Core..=) Core.<$> label,
                  ("name" Core..=) Core.<$> name,
                  ("nonFreeReturnReasons" Core..=) Core.<$>
                    nonFreeReturnReasons,
                  ("policy" Core..=) Core.<$> policy,
                  ("returnPolicyId" Core..=) Core.<$> returnPolicyId,
                  ("returnShippingFee" Core..=) Core.<$>
                    returnShippingFee,
                  ("seasonalOverrides" Core..=) Core.<$>
                    seasonalOverrides])
              ...
              (\ o ->
                 ReturnPolicyOnline Core.<$>
                   (o Core..:? "countries" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "itemConditions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "policy")
                     Core.<*> (o Core..:? "restockingFee")
                     Core.<*>
                     (o Core..:? "returnMethods" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "returnPolicyId")
                     Core.<*> (o Core..:? "returnPolicyUri")
                     Core.<*>
                     (o Core..:? "returnReasonCategoryInfo" Core..!=
                        Core.mempty))
...
newReturnPolicyOnlineRestockingFee =
  ReturnPolicyOnlineRestockingFee
    {fixedFee = Core.Nothing, microPercent = Core.Nothing}
          ...
          = Core.withObject "ReturnPolicyOnlineRestockingFee"
              (\ o ->
                 ReturnPolicyOnlineRestockingFee Core.<$>
                   (o Core..:? "fixedFee") Core.<*>
                     (o Core..:? "microPercent"))

instance Core.ToJSON ReturnPolicyOnlineRestockingFee
         where
...
instance Core.ToJSON
        ...
        toJSON ReturnPolicyOnlineReturnReasonCategoryInfo{..}
          = Core.object
              (Core.catMaybes
                 [("returnLabelSource" Core..=) Core.<$>
                    returnLabelSource,
                  ("returnReasonCategory" Core..=) Core.<$>
...
newReturnPolicyOnlineReturnShippingFee =
  ReturnPolicyOnlineReturnShippingFee
    {fixedFee = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("lastReturnDate" Core..=) Core.<$> lastReturnDate,
                  ("numberOfDays" Core..=) Core.. Core.AsText Core.<$>
                    numberOfDays,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON ReturnPolicySeasonalOverride
         where
        parseJSON
...
instance Core.ToJSON ReturnPolicySeasonalOverride
         where
...
instance Core.FromJSON ReturnPricingInfo where
        parseJSON
          = Core.withObject "ReturnPricingInfo"
              (\ o ->
                 ReturnPricingInfo Core.<$>
                   (o Core..:? "chargeReturnShippingFee") Core.<*>
                     (o Core..:? "maxReturnShippingFee")
...
instance Core.ToJSON ReturnPricingInfo where
        toJSON ReturnPricingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("chargeReturnShippingFee" Core..=) Core.<$>
                    chargeReturnShippingFee,
                  ("maxReturnShippingFee" Core..=) Core.<$>
                    maxReturnShippingFee,
                  ("refundableItemsTotalAmount" Core..=) Core.<$>
                    refundableItemsTotalAmount,
                  ("refundableShippingAmount" Core..=) Core.<$>
                    refundableShippingAmount,
                  ("totalRefundedAmount" Core..=) Core.<$>
                    totalRefundedAmount])
...
instance Core.FromJSON ReturnShipment where
        parseJSON
          = Core.withObject "ReturnShipment"
              (\ o ->
                 ReturnShipment Core.<$>
                   (o Core..:? "creationDate") Core.<*>
                     (o Core..:? "deliveryDate")
                     ...
                     Core.<*> (o Core..:? "shipmentId")
                     Core.<*>
                     (o Core..:? "shipmentTrackingInfos" Core..!=
                        Core.mempty)
              ...
              (Core.catMaybes
                 [("creationDate" Core..=) Core.<$> creationDate,
                  ...
                  ("returnMethodType" Core..=) Core.<$>
                    returnMethodType,
                  ("shipmentId" Core..=) Core.<$> shipmentId,
                  ("shipmentTrackingInfos" Core..=) Core.<$>
...
newReturnShippingLabel =
  ReturnShippingLabel
    {carrier = Core.Nothing, labelUri = Core.Nothing, trackingId = Core.Nothing}

instance Core.FromJSON ReturnShippingLabel where
        parseJSON
          = Core.withObject "ReturnShippingLabel"
              (\ o ->
                 ReturnShippingLabel Core.<$>
                   (o Core..:? "carrier") Core.<*>
                     (o Core..:? "labelUri")
                     Core.<*> (o Core..:? "trackingId"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject "ReturnaddressCustomBatchRequest"
              (\ o ->
                 ReturnaddressCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))

instance Core.ToJSON ReturnaddressCustomBatchRequest
         where
...
instance Core.ToJSON ReturnaddressCustomBatchResponse
         where
...
instance Core.FromJSON ReturnaddressListResponse
         where
        parseJSON
...
instance Core.FromJSON ReturnpolicyCustomBatchRequest
         where
        parseJSON
          = Core.withObject "ReturnpolicyCustomBatchRequest"
              (\ o ->
                 ReturnpolicyCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))

instance Core.ToJSON ReturnpolicyCustomBatchRequest
         where
...
instance Core.ToJSON ReturnpolicyCustomBatchResponse
         where
              ...
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "active") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "rateGroups" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("active" Core..=) Core.<$> active,
                  ...
                  ("minimumOrderValue" Core..=) Core.<$>
                    minimumOrderValue,
                  ("minimumOrderValueTable" Core..=) Core.<$>
                    minimumOrderValueTable,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON SettlementReport where
        parseJSON
          = Core.withObject "SettlementReport"
              (\ o ->
                 SettlementReport Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "kind")
                     ...
                     Core.<*>
                     (o Core..:? "transferIds" Core..!= Core.mempty))
...
instance Core.FromJSON SettlementTransaction where
        parseJSON
          = Core.withObject "SettlementTransaction"
              (\ o ->
                 SettlementTransaction Core.<$>
                   (o Core..:? "amount") Core.<*>
                     (o Core..:? "identifiers")
                     Core.<*> (o Core..:? "kind")
...
instance Core.FromJSON SettlementTransactionAmount
         where
        parseJSON
          = Core.withObject "SettlementTransactionAmount"
              (\ o ->
                 SettlementTransactionAmount Core.<$>
                   (o Core..:? "commission") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "transactionAmount")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON SettlementTransactionAmount
         where
...
newSettlementTransactionAmountCommission =
  SettlementTransactionAmountCommission
    {category = Core.Nothing, rate = Core.Nothing}
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SettlementTransactionAmountCommission"
              (\ o ->
                 SettlementTransactionAmountCommission Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "rate"))
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SettlementTransactionIdentifiers"
              (\ o ->
                 SettlementTransactionIdentifiers Core.<$>
                   (o Core..:? "adjustmentId") Core.<*>
                     (o Core..:? "merchantOrderId")
                     Core.<*> (o Core..:? "orderItemId")
                     Core.<*> (o Core..:? "settlementEntryId")
                     Core.<*>
                     (o Core..:? "shipmentIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "transactionId"))

instance Core.ToJSON SettlementTransactionIdentifiers
         where
...
newSettlementTransactionTransaction =
  SettlementTransactionTransaction
    {postDate = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON
           SettlementTransactionTransaction
         where
        parseJSON
          = Core.withObject "SettlementTransactionTransaction"
              (\ o ->
                 SettlementTransactionTransaction Core.<$>
                   (o Core..:? "postDate") Core.<*> (o Core..:? "type"))

instance Core.ToJSON SettlementTransactionTransaction
         where
...
instance Core.FromJSON SettlementreportsListResponse
         where
        parseJSON
          = Core.withObject "SettlementreportsListResponse"
              (\ o ->
                 SettlementreportsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "resources" Core..!= Core.mempty))

instance Core.ToJSON SettlementreportsListResponse
         where
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "SettlementtransactionsListResponse"
              (\ o ->
                 SettlementtransactionsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "resources" Core..!= Core.mempty))
...
instance Core.FromJSON ShipmentInvoice where
        parseJSON
          = Core.withObject "ShipmentInvoice"
              (\ o ->
                 ShipmentInvoice Core.<$>
                   (o Core..:? "invoiceSummary") Core.<*>
                     (o Core..:? "lineItemInvoices" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "shipmentGroupId"))
...
instance Core.FromJSON ShipmentInvoiceLineItemInvoice
         where
        parseJSON
          = Core.withObject "ShipmentInvoiceLineItemInvoice"
              (\ o ->
                 ShipmentInvoiceLineItemInvoice Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "productId")
                     Core.<*>
                     (o Core..:? "shipmentUnitIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "unitInvoice"))

instance Core.ToJSON ShipmentInvoiceLineItemInvoice
         where
...
instance Core.FromJSON ShipmentTrackingInfo where
        parseJSON
          = Core.withObject "ShipmentTrackingInfo"
              (\ o ->
                 ShipmentTrackingInfo Core.<$>
                   (o Core..:? "carrier") Core.<*>
                     (o Core..:? "trackingNumber"))
          ...
          = Core.withObject "ShippingSettings"
              (\ o ->
                 ShippingSettings Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "postalCodeGroups" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "services" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "warehouses" Core..!= Core.mempty))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ShippingsettingsCustomBatchRequest"
              (\ o ->
                 ShippingsettingsCustomBatchRequest Core.<$>
                   (o Core..:? "entries" Core..!= Core.mempty))
...
newShippingsettingsGetSupportedCarriersResponse =
  ShippingsettingsGetSupportedCarriersResponse
    {carriers = Core.Nothing, kind = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 ShippingsettingsGetSupportedCarriersResponse Core.<$>
                   (o Core..:? "carriers" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind"))
...
newShippingsettingsGetSupportedHolidaysResponse =
  ShippingsettingsGetSupportedHolidaysResponse
    {holidays = Core.Nothing, kind = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 ShippingsettingsGetSupportedHolidaysResponse Core.<$>
                   (o Core..:? "holidays" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "kind"))
...
newShippingsettingsGetSupportedPickupServicesResponse =
  ShippingsettingsGetSupportedPickupServicesResponse
    {kind = Core.Nothing, pickupServices = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 ShippingsettingsGetSupportedPickupServicesResponse
                   Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "pickupServices" Core..!= Core.mempty))
...
instance Core.FromJSON ShippingsettingsListResponse
         where
        parseJSON
...
instance Core.ToJSON ShippingsettingsListResponse
         where
...
instance Core.FromJSON TestOrder where
        parseJSON
          = Core.withObject "TestOrder"
              (\ o ->
                 TestOrder Core.<$>
                   (o Core..:? "deliveryDetails") Core.<*>
                     (o Core..:? "enableOrderinvoices")
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "lineItems" Core..!= Core.mempty)
...
instance Core.ToJSON TestOrder where
        toJSON TestOrder{..}
          = Core.object
              (Core.catMaybes
                 [("deliveryDetails" Core..=) Core.<$>
                    deliveryDetails,
                  ("enableOrderinvoices" Core..=) Core.<$>
                    enableOrderinvoices,
                  ("kind" Core..=) Core.<$> kind,
                  ("lineItems" Core..=) Core.<$> lineItems,
                  ("notificationMode" Core..=) Core.<$>
                    notificationMode,
                  ("pickupDetails" Core..=) Core.<$> pickupDetails,
                  ("predefinedBillingAddress" Core..=) Core.<$>
                    predefinedBillingAddress,
                  ("predefinedDeliveryAddress" Core..=) Core.<$>
                    predefinedDeliveryAddress,
                  ("predefinedEmail" Core..=) Core.<$> predefinedEmail,
                  ("predefinedPickupDetails" Core..=) Core.<$>
...
instance Core.FromJSON TestOrderAddress where
        parseJSON
          = Core.withObject "TestOrderAddress"
              (\ o ->
                 TestOrderAddress Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "fullAddress" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "isPostOfficeBox")
                     Core.<*> (o Core..:? "locality")
...
instance Core.FromJSON TestOrderDeliveryDetails where
        parseJSON
          = Core.withObject "TestOrderDeliveryDetails"
              (\ o ->
                 TestOrderDeliveryDetails Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "isScheduledDelivery")
                     Core.<*> (o Core..:? "phoneNumber"))
...
instance Core.FromJSON TestOrderLineItem where
        parseJSON
          = Core.withObject "TestOrderLineItem"
              (\ o ->
                 TestOrderLineItem Core.<$>
                   (o Core..:? "product") Core.<*>
                     (o Core..:? "quantityOrdered")
                     Core.<*> (o Core..:? "returnInfo")
                     Core.<*> (o Core..:? "shippingDetails"))
...
instance Core.FromJSON TestOrderLineItemProduct where
        parseJSON
          = Core.withObject "TestOrderLineItemProduct"
              (\ o ->
                 TestOrderLineItemProduct Core.<$>
                   (o Core..:? "brand") Core.<*>
                     (o Core..:? "condition")
                     Core.<*> (o Core..:? "contentLanguage")
                     Core.<*> (o Core..:? "fees" Core..!= Core.mempty)
...
instance Core.FromJSON TestOrderPickupDetails where
        parseJSON
          = Core.withObject "TestOrderPickupDetails"
              (\ o ->
                 TestOrderPickupDetails Core.<$>
                   (o Core..:? "locationCode") Core.<*>
                     (o Core..:? "pickupLocationAddress")
                     Core.<*> (o Core..:? "pickupLocationType")
                     Core.<*>
                     (o Core..:? "pickupPersons" Core..!= Core.mempty))
          ...
          = Core.object
              (Core.catMaybes
                 [("locationCode" Core..=) Core.<$> locationCode,
                  ("pickupLocationAddress" Core..=) Core.<$>
                    pickupLocationAddress,
                  ("pickupLocationType" Core..=) Core.<$>
                    pickupLocationType,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "TestOrderPickupDetailsPickupPerson"
              (\ o ->
                 TestOrderPickupDetailsPickupPerson Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "phoneNumber"))
...
instance Core.FromJSON TransitTableTransitTimeRow
         where
        parseJSON
          = Core.withObject "TransitTableTransitTimeRow"
              (\ o ->
                 TransitTableTransitTimeRow Core.<$>
...
newTransitTableTransitTimeRowTransitTimeValue =
  TransitTableTransitTimeRowTransitTimeValue
    {maxTransitTimeInDays = Core.Nothing, minTransitTimeInDays = Core.Nothing}
...
instance Core.FromJSON UnitInvoice where
        parseJSON
          = Core.withObject "UnitInvoice"
              (\ o ->
                 UnitInvoice Core.<$>
                   (o Core..:? "additionalCharges" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "unitPrice")
                     Core.<*>
                     (o Core..:? "unitPriceTaxes" Core..!= Core.mempty))

instance Core.ToJSON UnitInvoice where
        toJSON UnitInvoice{..}
          = Core.object
              (Core.catMaybes
                 [("additionalCharges" Core..=) Core.<$>
                    additionalCharges,
...
newUnitInvoiceAdditionalCharge =
  UnitInvoiceAdditionalCharge
    {additionalChargeAmount = Core.Nothing, type' = Core.Nothing}

instance Core.FromJSON UnitInvoiceAdditionalCharge
         where
        parseJSON
          = Core.withObject "UnitInvoiceAdditionalCharge"
              (\ o ->
                 UnitInvoiceAdditionalCharge Core.<$>
                   (o Core..:? "additionalChargeAmount") Core.<*>
                     (o Core..:? "type"))

instance Core.ToJSON UnitInvoiceAdditionalCharge
         where
        toJSON UnitInvoiceAdditionalCharge{..}
          = Core.object
              (Core.catMaybes
                 [("additionalChargeAmount" Core..=) Core.<$>
...
newUnitInvoiceTaxLine =
  UnitInvoiceTaxLine
    {taxAmount = Core.Nothing, taxName = Core.Nothing, taxType = Core.Nothing}

instance Core.FromJSON UnitInvoiceTaxLine where
        parseJSON
          = Core.withObject "UnitInvoiceTaxLine"
              (\ o ->
                 UnitInvoiceTaxLine Core.<$>
                   (o Core..:? "taxAmount") Core.<*>
                     (o Core..:? "taxName")
                     Core.<*> (o Core..:? "taxType"))
...
instance Core.FromJSON VerifyPhoneNumberResponse
         where
        parseJSON
...
instance Core.ToJSON Warehouse where
        toJSON Warehouse{..}
          = Core.object
              (Core.catMaybes
                 [("businessDayConfig" Core..=) Core.<$>
                    businessDayConfig,
                  ("cutoffTime" Core..=) Core.<$> cutoffTime,
                  ("handlingDays" Core..=) Core.. Core.AsText Core.<$>
                    handlingDays,
                  ("name" Core..=) Core.<$> name,
                  ("shippingAddress" Core..=) Core.<$>
                    shippingAddress])
...
instance Core.FromJSON WarehouseBasedDeliveryTime
         where
        parseJSON
