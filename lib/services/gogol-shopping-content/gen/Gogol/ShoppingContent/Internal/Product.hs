          ...
          = Core.object
              (Core.catMaybes
                 [("accountManagement" Core..=) Core.<$>
                  ...
                  ("businessIdentity" Core..=) Core.<$>
                    businessIdentity,
                  ("businessInformation" Core..=) Core.<$>
                    businessInformation,
                  ("conversionSettings" Core..=) Core.<$>
                    conversionSettings,
          ...
          = Core.object
              (Core.catMaybes
                 [("blackOwned" Core..=) Core.<$> blackOwned,
                  ("includeForPromotions" Core..=) Core.<$>
...
instance Core.FromJSON AccountConversionSettings
         where
        parseJSON
...
newAccountIdentityType 
    ::  AccountIdentityType
newAccountIdentityType = AccountIdentityType {selfIdentified = Core.Nothing}

instance Core.FromJSON AccountIdentityType where
        parseJSON
          = Core.withObject "AccountIdentityType"
              (\ o ->
                 AccountIdentityType Core.<$>
                   (o Core..:? "selfIdentified"))
...
instance Core.FromJSON AccountIssue where
        parseJSON
          = Core.withObject "AccountIssue"
              (\ o ->
                 AccountIssue Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "impact")
...
newAccountIssueImpact =
  AccountIssueImpact
    {breakdowns = Core.Nothing, message = Core.Nothing, severity = Core.Nothing}
              ...
              (\ o ->
                 AccountStatusStatistics Core.<$>
                   (o Core..:? "active" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "disapproved" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "expiring" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "pending" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON Action where
        toJSON Action{..}
          = Core.object
              (Core.catMaybes
                 [("builtinSimpleAction" Core..=) Core.<$>
                    builtinSimpleAction,
                  ("builtinUserInputAction" Core..=) Core.<$>
                    builtinUserInputAction,
...
newActionInput 
    ::  ActionInput
newActionInput =
  ActionInput {actionFlowId = Core.Nothing, inputValues = Core.Nothing}
...
newActionReason =
  ActionReason
    {action = Core.Nothing, detail = Core.Nothing, message = Core.Nothing}
...
instance Core.FromJSON ActionReason where
        parseJSON
          = Core.withObject "ActionReason"
              (\ o ->
                 ActionReason Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "detail")
                     Core.<*> (o Core..:? "message"))
...
newAlternateDisputeResolution 
    ::  AlternateDisputeResolution
newAlternateDisputeResolution =
  AlternateDisputeResolution {label = Core.Nothing, uri = Core.Nothing}

instance Core.FromJSON AlternateDisputeResolution
         where
        parseJSON
          ...
          = Core.withObject "AttributionSettings"
              (\ o ->
                 AttributionSettings Core.<$>
                   (o Core..:? "attributionLookbackWindowInDays")
...
newAttributionSettingsConversionType =
  AttributionSettingsConversionType
    {includeInReporting = Core.Nothing, name = Core.Nothing}
          ...
          = Core.withObject "AttributionSettingsConversionType"
              (\ o ->
                 AttributionSettingsConversionType Core.<$>
                   (o Core..:? "includeInReporting") Core.<*>
                     (o Core..:? "name"))
...
instance Core.ToJSON BestSellers where
        toJSON BestSellers{..}
          = Core.object
              (Core.catMaybes
                 [("categoryId" Core..=) Core.. Core.AsText Core.<$>
                    categoryId,
                  ("countryCode" Core..=) Core.<$> countryCode,
                  ("previousRank" Core..=) Core.. Core.AsText Core.<$>
                    previousRank,
                  ("previousRelativeDemand" Core..=) Core.<$>
                    previousRelativeDemand,
                  ("rank" Core..=) Core.. Core.AsText Core.<$> rank,
                  ("relativeDemand" Core..=) Core.<$> relativeDemand,
                  ("relativeDemandChange" Core..=) Core.<$>
                    relativeDemandChange,
                  ("reportDate" Core..=) Core.<$> reportDate,
                  ("reportGranularity" Core..=) Core.<$>
                    reportGranularity])
...
newBreakdown 
    ::  Breakdown
newBreakdown = Breakdown {details = Core.Nothing, regions = Core.Nothing}
...
newBreakdownRegion 
    ::  BreakdownRegion
newBreakdownRegion = BreakdownRegion {code = Core.Nothing, name = Core.Nothing}
...
newBuiltInSimpleActionAdditionalContent =
  BuiltInSimpleActionAdditionalContent
    {paragraphs = Core.Nothing, title = Core.Nothing}
...
newBuiltInUserInputAction 
    ::  BuiltInUserInputAction
newBuiltInUserInputAction =
  BuiltInUserInputAction {actionContext = Core.Nothing, flows = Core.Nothing}
...
newCallout 
    ::  Callout
newCallout = Callout {fullMessage = Core.Nothing, styleHint = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("effectiveEnrollmentState" Core..=) Core.<$>
                  ...
                  ("effectiveReviewState" Core..=) Core.<$>
                    effectiveReviewState,
                  ("effectiveUriSettings" Core..=) Core.<$>
...
instance Core.ToJSON CloudExportAdditionalProperties
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("boolValue" Core..=) Core.<$> boolValue,
                  ...
                  ("intValue" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> intValue,
...
instance Core.ToJSON ConversionSource where
        toJSON ConversionSource{..}
          = Core.object
              (Core.catMaybes
                 [("conversionSourceId" Core..=) Core.<$>
                    conversionSourceId,
                  ("expireTime" Core..=) Core.<$> expireTime,
                  ("googleAnalyticsLink" Core..=) Core.<$>
                    googleAnalyticsLink,
        ...
        parseJSON
          = Core.withObject "DatafeedStatus"
              (\ o ->
                 DatafeedStatus Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "datafeedId" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "feedLabel")
                     Core.<*>
                     (o Core..:? "itemsTotal" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "itemsValid" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "language")
...
newDeliveryAreaPostalCodeRange =
  DeliveryAreaPostalCodeRange
    {firstPostalCode = Core.Nothing, lastPostalCode = Core.Nothing}

instance Core.FromJSON DeliveryAreaPostalCodeRange
         where
        parseJSON
...
instance Core.ToJSON DeliveryAreaPostalCodeRange
         where
        toJSON DeliveryAreaPostalCodeRange{..}
          = Core.object
              (Core.catMaybes
                 [("firstPostalCode" Core..=) Core.<$>
                    firstPostalCode,
...
instance Core.FromJSON Errors where
        parseJSON
          = Core.withObject "Errors"
              (\ o ->
                 Errors Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "message"))
...
newExternalAction 
    ::  ExternalAction
newExternalAction = ExternalAction {type' = Core.Nothing, uri = Core.Nothing}
...
newFreeShippingThreshold 
    ::  FreeShippingThreshold
newFreeShippingThreshold =
  FreeShippingThreshold {country = Core.Nothing, priceThreshold = Core.Nothing}
...
newGenerateRecommendationsResponse =
  GenerateRecommendationsResponse
    {recommendations = Core.Nothing, responseToken = Core.Nothing}
...
instance Core.ToJSON GenerateRecommendationsResponse
         where
        toJSON GenerateRecommendationsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("recommendations" Core..=) Core.<$>
                    recommendations,
...
instance Core.ToJSON GoogleAnalyticsLink where
        toJSON GoogleAnalyticsLink{..}
          = Core.object
              (Core.catMaybes
                 [("attributionSettings" Core..=) Core.<$>
                    attributionSettings,
                  ("propertyId" Core..=) Core.. Core.AsText Core.<$>
                    propertyId,
                  ("propertyName" Core..=) Core.<$> propertyName])
...
newInputFieldChoiceInput 
    ::  InputFieldChoiceInput
newInputFieldChoiceInput = InputFieldChoiceInput {options = Core.Nothing}

instance Core.FromJSON InputFieldChoiceInput where
        parseJSON
          = Core.withObject "InputFieldChoiceInput"
              (\ o ->
                 InputFieldChoiceInput Core.<$>
                   (o Core..:? "options"))
...
newInputFieldChoiceInputChoiceInputOption =
  InputFieldChoiceInputChoiceInputOption
    {additionalInput = Core.Nothing, id = Core.Nothing, label = Core.Nothing}
...
instance Core.ToJSON InputValue where
        toJSON InputValue{..}
          = Core.object
              (Core.catMaybes
                 [("checkboxInputValue" Core..=) Core.<$>
                    checkboxInputValue,
                  ("choiceInputValue" Core..=) Core.<$>
                    choiceInputValue,
...
instance Core.FromJSON InputValueCheckboxInputValue
         where
        parseJSON
          = Core.withObject "InputValueCheckboxInputValue"
              (\ o ->
                 InputValueCheckboxInputValue Core.<$>
                   (o Core..:? "value"))

instance Core.ToJSON InputValueCheckboxInputValue
         where
...
instance Core.FromJSON InputValueChoiceInputValue
         where
        parseJSON
...
newInputValueTextInputValue 
    ::  InputValueTextInputValue
newInputValueTextInputValue = InputValueTextInputValue {value = Core.Nothing}

instance Core.FromJSON InputValueTextInputValue where
        parseJSON
          = Core.withObject "InputValueTextInputValue"
              (\ o ->
                 InputValueTextInputValue Core.<$>
                   (o Core..:? "value"))
...
instance Core.FromJSON InsertCheckoutSettingsRequest
         where
        parseJSON
          = Core.withObject "InsertCheckoutSettingsRequest"
              (\ o ->
                 InsertCheckoutSettingsRequest Core.<$>
                   (o Core..:? "uriSettings"))

instance Core.ToJSON InsertCheckoutSettingsRequest
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("about" Core..=) Core.<$> about,
                  ...
                  ("omnichannelExperience" Core..=) Core.<$>
...
newLiaOmnichannelExperience =
  LiaOmnichannelExperience
    {country = Core.Nothing, lsfType = Core.Nothing, pickupTypes = Core.Nothing}
...
newListConversionSourcesResponse =
  ListConversionSourcesResponse
    {conversionSources = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListConversionSourcesResponse
         where
        parseJSON
...
instance Core.ToJSON ListConversionSourcesResponse
         where
        toJSON ListConversionSourcesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("conversionSources" Core..=) Core.<$>
                    conversionSources,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListMethodQuotasResponse =
  ListMethodQuotasResponse
    {methodQuotas = Core.Nothing, nextPageToken = Core.Nothing}
...
newListPromotionResponse =
  ListPromotionResponse
    {nextPageToken = Core.Nothing, promotions = Core.Nothing}
...
instance Core.ToJSON LoyaltyProgram where
        toJSON LoyaltyProgram{..}
          = Core.object
              (Core.catMaybes
                 [("cashbackForFutureUse" Core..=) Core.<$>
...
instance Core.FromJSON MerchantCenterDestination
         where
        parseJSON
        ...
        parseJSON
          = Core.withObject "MethodQuota"
              (\ o ->
                 MethodQuota Core.<$>
                   (o Core..:? "method") Core.<*>
                     (o Core..:? "quotaLimit" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "quotaMinuteLimit" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "quotaUsage" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON MethodQuota where
        toJSON MethodQuota{..}
          = Core.object
              (Core.catMaybes
                 [("method" Core..=) Core.<$> method,
                  ("quotaLimit" Core..=) Core.. Core.AsText Core.<$>
                    quotaLimit,
                  ("quotaMinuteLimit" Core..=) Core.. Core.AsText
                    Core.<$> quotaMinuteLimit,
                  ("quotaUsage" Core..=) Core.. Core.AsText Core.<$>
                    quotaUsage])
                 ...
                 Metrics Core.<$>
                   (o Core..:? "aos") Core.<*> (o Core..:? "aovMicros")
                     ...
                     (o Core..:? "orderedItemSalesMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "orderedItems" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "orders" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "rejectedItems" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "returnRate")
                     Core.<*>
                     (o Core..:? "returnedItems" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "returnsMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shippedItemSalesMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shippedItems" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shippedOrders" Core.<&>
                        Core.fmap Core.fromAsText)
              ...
              (\ o ->
                 PriceInsights Core.<$>
                   (o Core..:? "effectiveness") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "predictedConversionsChangeFraction")
                     Core.<*>
                     (o Core..:? "predictedGrossProfitChangeFraction")
                     Core.<*>
                     (o Core..:? "predictedImpressionsChangeFraction")
                     Core.<*>
                     (o Core..:?
                        "predictedMonthlyGrossProfitChangeCurrencyCode")
                     Core.<*>
                     (o Core..:? "predictedMonthlyGrossProfitChangeMicros"
              ...
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "additionalImageLinks") Core.<*>
                     ...
                     Core.<*> (o Core..:? "channel")
                     Core.<*>
                     (o Core..:? "cloudExportAdditionalProperties")
                     Core.<*> (o Core..:? "color")
                     ...
                     Core.<*>
                     (o Core..:? "maxHandlingTime" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "minEnergyEfficiencyClass")
                     Core.<*>
                     (o Core..:? "minHandlingTime" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "mobileLink")
                     Core.<*> (o Core..:? "mobileLinkTemplate")
                     Core.<*> (o Core..:? "mpn")
                     Core.<*>
                     (o Core..:? "multipack" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "pattern")
                     Core.<*> (o Core..:? "pause")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalImageLinks" Core..=) Core.<$>
                  ...
                  ("externalSellerId" Core..=) Core.<$>
                    externalSellerId,
                  ("feedLabel" Core..=) Core.<$> feedLabel,
                  ("freeShippingThreshold" Core..=) Core.<$>
                    freeShippingThreshold,
                  ...
                  ("structuredDescription" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("certificationAuthority" Core..=) Core.<$>
                  ...
                  ("certificationCode" Core..=) Core.<$>
                    certificationCode,
                  ("certificationName" Core..=) Core.<$>
                    certificationName,
                  ("certificationValue" Core..=) Core.<$>
                    certificationValue])
...
instance Core.ToJSON ProductCluster where
        toJSON ProductCluster{..}
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ("brandInventoryStatus" Core..=) Core.<$>
...
newProductDeliveryTime =
  ProductDeliveryTime
    {areaDeliveryTimes = Core.Nothing, productId = Core.Nothing}
...
newProductDeliveryTimeAreaDeliveryTime =
  ProductDeliveryTimeAreaDeliveryTime
    {deliveryArea = Core.Nothing, deliveryTime = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("maxHandlingTimeDays" Core..=) Core.<$>
                    maxHandlingTimeDays,
                  ("maxTransitTimeDays" Core..=) Core.<$>
                    maxTransitTimeDays,
                  ("minHandlingTimeDays" Core..=) Core.<$>
                    minHandlingTimeDays,
                  ("minTransitTimeDays" Core..=) Core.<$>
                    minTransitTimeDays])
                 ...
                 ProductShipping Core.<$>
                   (o Core..:? "country") Core.<*>
                     ...
                     (o Core..:? "maxHandlingTime" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxTransitTime" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minHandlingTime" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minTransitTime" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "postalCode")
                     Core.<*> (o Core..:? "price")
                     Core.<*> (o Core..:? "region")
...
newProductStructuredDescription =
  ProductStructuredDescription
    {content = Core.Nothing, digitalSourceType = Core.Nothing}

instance Core.FromJSON ProductStructuredDescription
         where
        parseJSON
          = Core.withObject "ProductStructuredDescription"
              (\ o ->
                 ProductStructuredDescription Core.<$>
                   (o Core..:? "content") Core.<*>
                     (o Core..:? "digitalSourceType"))

instance Core.ToJSON ProductStructuredDescription
         where
        toJSON ProductStructuredDescription{..}
          = Core.object
              (Core.catMaybes
                 [("content" Core..=) Core.<$> content,
                  ("digitalSourceType" Core..=) Core.<$>
                    digitalSourceType])
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregatedDestinationStatus" Core..=) Core.<$>
                  ...
                  ("clickPotentialRank" Core..=) Core.. Core.AsText
                  ...
                  ("offerId" Core..=) Core.<$> offerId,
                  ("priceMicros" Core..=) Core.. Core.AsText Core.<$>
                    priceMicros,
...
newProductViewItemIssueItemIssueSeverity =
  ProductViewItemIssueItemIssueSeverity
    {aggregatedSeverity = Core.Nothing, severityPerDestination = Core.Nothing}
...
newProductViewItemIssueItemIssueType =
  ProductViewItemIssueItemIssueType
    {canonicalAttribute = Core.Nothing, code = Core.Nothing}
          ...
          = Core.withObject "ProductViewItemIssueItemIssueType"
              (\ o ->
                 ProductViewItemIssueItemIssueType Core.<$>
                   (o Core..:? "canonicalAttribute") Core.<*>
                     (o Core..:? "code"))
          ...
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ...
                  ("storeApplicability" Core..=) Core.<$>
                    storeApplicability,
                  ("storeCode" Core..=) Core.<$> storeCode,
                  ("storeCodeExclusion" Core..=) Core.<$>
                    storeCodeExclusion,
                  ("targetCountry" Core..=) Core.<$> targetCountry])
...
newPromotionPromotionStatusPromotionIssue =
  PromotionPromotionStatusPromotionIssue
    {code = Core.Nothing, detail = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalCallToAction" Core..=) Core.<$>
                  ...
                  ("additionalDescriptions" Core..=) Core.<$>
                    additionalDescriptions,
                  ("creative" Core..=) Core.<$> creative,
                  ("defaultCallToAction" Core..=) Core.<$>
                    defaultCallToAction,
                  ("defaultDescription" Core..=) Core.<$>
                    defaultDescription,
                  ("numericalImpact" Core..=) Core.<$> numericalImpact,
                  ("paid" Core..=) Core.<$> paid,
                  ("recommendationName" Core..=) Core.<$>
                    recommendationName,
...
newRecommendationCallToAction =
  RecommendationCallToAction
    {intent = Core.Nothing, localizedText = Core.Nothing, uri = Core.Nothing}

instance Core.FromJSON RecommendationCallToAction
         where
        parseJSON
...
instance Core.FromJSON RecommendationDescription
         where
        parseJSON
...
newRenderAccountIssuesRequestPayload =
  RenderAccountIssuesRequestPayload
    {contentOption = Core.Nothing, userInputActionOption = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("contentOption" Core..=) Core.<$> contentOption,
                  ("userInputActionOption" Core..=) Core.<$>
...
newRenderAccountIssuesResponse =
  RenderAccountIssuesResponse
    {alternateDisputeResolution = Core.Nothing, issues = Core.Nothing}

instance Core.FromJSON RenderAccountIssuesResponse
         where
        parseJSON
...
instance Core.ToJSON RenderAccountIssuesResponse
         where
...
instance Core.FromJSON RenderProductIssuesResponse
         where
        parseJSON
...
instance Core.ToJSON RenderProductIssuesResponse
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("bestSellers" Core..=) Core.<$> bestSellers,
                  ("brand" Core..=) Core.<$> brand,
                  ("competitiveVisibility" Core..=) Core.<$>
                    competitiveVisibility,
                  ("metrics" Core..=) Core.<$> metrics,
                  ("priceCompetitiveness" Core..=) Core.<$>
                    priceCompetitiveness,
          ...
          = Core.withObject "ServiceStoreConfig"
              (\ o ->
                 ServiceStoreConfig Core.<$>
                   (o Core..:? "cutoffConfig") Core.<*>
                     (o Core..:? "serviceRadius")
...
instance Core.FromJSON ServiceStoreConfigCutoffConfig
         where
        parseJSON
...
instance Core.ToJSON ServiceStoreConfigCutoffConfig
         where
        toJSON ServiceStoreConfigCutoffConfig{..}
          = Core.object
              (Core.catMaybes
                 [("localCutoffTime" Core..=) Core.<$>
                    localCutoffTime,
                  ("noDeliveryPostCutoff" Core..=) Core.<$>
                    noDeliveryPostCutoff,
                  ("storeCloseOffsetHours" Core..=) Core.. Core.AsText
...
newServiceStoreConfigCutoffConfigLocalCutoffTime =
  ServiceStoreConfigCutoffConfigLocalCutoffTime
    {hour = Core.Nothing, minute = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("hour" Core..=) Core.. Core.AsText Core.<$> hour,
                  ("minute" Core..=) Core.. Core.AsText Core.<$>
                    minute])
...
instance Core.ToJSON TextWithTooltip where
        toJSON TextWithTooltip{..}
          = Core.object
              (Core.catMaybes
                 [("simpleTooltipValue" Core..=) Core.<$>
                    simpleTooltipValue,
                  ("simpleValue" Core..=) Core.<$> simpleValue,
                  ("tooltipIconStyle" Core..=) Core.<$>
                    tooltipIconStyle])
...
instance Core.FromJSON TopicTrends where
        parseJSON
          = Core.withObject "TopicTrends"
              (\ o ->
                 TopicTrends Core.<$>
                   (o Core..:? "customerCountryCode") Core.<*>
                     (o Core..:? "date")
...
newTriggerActionPayload =
  TriggerActionPayload
    {actionContext = Core.Nothing, actionInput = Core.Nothing}
...
newTriggerActionResponse 
    ::  TriggerActionResponse
newTriggerActionResponse = TriggerActionResponse {message = Core.Nothing}

instance Core.FromJSON TriggerActionResponse where
        parseJSON
          = Core.withObject "TriggerActionResponse"
              (\ o ->
                 TriggerActionResponse Core.<$>
                   (o Core..:? "message"))
...
instance Core.ToJSON UndeleteConversionSourceRequest
         where
        toJSON = Core.const Core.emptyObject
...
newUrlSettings =
  UrlSettings
    {cartUriTemplate = Core.Nothing, checkoutUriTemplate = Core.Nothing}
...
instance Core.ToJSON UrlSettings where
        toJSON UrlSettings{..}
          = Core.object
              (Core.catMaybes
                 [("cartUriTemplate" Core..=) Core.<$>
                    cartUriTemplate,
                  ("checkoutUriTemplate" Core..=) Core.<$>
                    checkoutUriTemplate])
