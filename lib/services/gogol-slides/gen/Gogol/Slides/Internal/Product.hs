...
instance Core.FromJSON ColorScheme where
        parseJSON
          = Core.withObject "ColorScheme"
              (\ o ->
                 ColorScheme Core.<$>
                   (o Core..:? "colors" Core..!= Core.mempty))
              ...
              (\ o ->
                 CreateSlideRequest Core.<$>
                   (o Core..:? "insertionIndex") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*>
                     (o Core..:? "placeholderIdMappings" Core..!=
                        Core.mempty)
...
newDuplicateObjectRequest_ObjectIds 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> DuplicateObjectRequest_ObjectIds
newDuplicateObjectRequest_ObjectIds addtional =
  DuplicateObjectRequest_ObjectIds {addtional = addtional}
...
instance Core.FromJSON Group where
        parseJSON
          = Core.withObject "Group"
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "children" Core..!= Core.mempty))
          ...
          = Core.withObject "GroupObjectsRequest"
              (\ o ->
                 GroupObjectsRequest Core.<$>
                   (o Core..:? "childrenObjectIds" Core..!= Core.mempty)
...
newtype List_NestingLevel = List_NestingLevel
    {
      -- | 
      addtional :: (Core.HashMap Core.Text NestingLevel)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newList_NestingLevel 
    ::  Core.HashMap Core.Text NestingLevel
       -- ^  See 'addtional'.
    -> List_NestingLevel
newList_NestingLevel addtional = List_NestingLevel {addtional = addtional}
...
instance Core.ToJSON List_NestingLevel where
        toJSON List_NestingLevel{..} = Core.toJSON addtional
              ...
              (\ o ->
                 Page Core.<$>
                   (o Core..:? "layoutProperties") Core.<*>
                     ...
                     Core.<*> (o Core..:? "objectId")
                     Core.<*>
                     (o Core..:? "pageElements" Core..!= Core.mempty)
...
instance Core.FromJSON Presentation where
        parseJSON
          = Core.withObject "Presentation"
              (\ o ->
                 Presentation Core.<$>
                   (o Core..:? "layouts" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "locale")
        ...
        parseJSON
          = Core.withObject "Recolor"
              (\ o ->
                 Recolor Core.<$>
                   (o Core..:? "name") Core.<*>
                     (o Core..:? "recolorStops" Core..!= Core.mempty))
              ...
              (\ o ->
                 ReplaceAllShapesWithImageRequest Core.<$>
                   (o Core..:? "containsText") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "pageObjectIds" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "columns") Core.<*>
                     (o Core..:? "horizontalBorderRows" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "rows")
                     Core.<*>
                     (o Core..:? "tableColumns" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "tableRows" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "verticalBorderRows" Core..!=
                        Core.mempty))
...
instance Core.FromJSON TableBorderRow where
        parseJSON
          = Core.withObject "TableBorderRow"
              (\ o ->
                 TableBorderRow Core.<$>
                   (o Core..:? "tableBorderCells" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject "TextContent"
              (\ o ->
                 TextContent Core.<$>
                   (o Core..:? "lists") Core.<*>
                     (o Core..:? "textElements" Core..!= Core.mempty))
...
newTextContent_Lists 
    ::  Core.HashMap Core.Text List
       -- ^  See 'addtional'.
    -> TextContent_Lists
newTextContent_Lists addtional = TextContent_Lists {addtional = addtional}
...
instance Core.ToJSON TextContent_Lists where
        toJSON TextContent_Lists{..} = Core.toJSON addtional
              ...
              (\ o ->
                 UpdatePageElementsZOrderRequest Core.<$>
                   (o Core..:? "operation") Core.<*>
                     (o Core..:? "pageElementObjectIds" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "UpdateSlidesPositionRequest"
              (\ o ->
                 UpdateSlidesPositionRequest Core.<$>
                   (o Core..:? "insertionIndex") Core.<*>
                     (o Core..:? "slideObjectIds" Core..!= Core.mempty))
