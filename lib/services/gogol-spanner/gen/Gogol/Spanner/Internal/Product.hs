              ...
              (\ o ->
                 Backup Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "referencingDatabases" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "BatchCreateSessionsResponse"
              (\ o ->
                 BatchCreateSessionsResponse Core.<$>
                   (o Core..:? "session" Core..!= Core.mempty))
              ...
              (\ o ->
                 CreateDatabaseRequest Core.<$>
                   (o Core..:? "createStatement") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "extraStatements" Core..!= Core.mempty))
              ...
              (\ o ->
                 Database Core.<$>
                   (o Core..:? "createTime") Core.<*>
                     ...
                     Core.<*> (o Core..:? "encryptionConfig")
                     Core.<*>
                     (o Core..:? "encryptionInfo" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
          ...
          = Core.withObject "ExecuteBatchDmlResponse"
              (\ o ->
                 ExecuteBatchDmlResponse Core.<$>
                   (o Core..:? "resultSets" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "status"))
              ...
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "config") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*>
                     (o Core..:? "endpointUris" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
              ...
              (\ o ->
                 InstanceConfig Core.<$>
                   (o Core..:? "displayName") Core.<*>
                     (o Core..:? "leaderOptions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "replicas" Core..!= Core.mempty))
...
instance Core.FromJSON KeyRange where
        parseJSON
          = Core.withObject "KeyRange"
              (\ o ->
                 KeyRange Core.<$>
                   (o Core..:? "endClosed" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "endOpen" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "startClosed" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "startOpen" Core..!= Core.mempty))
...
instance Core.FromJSON KeyRangeInfo where
        parseJSON
          = Core.withObject "KeyRangeInfo"
              (\ o ->
                 KeyRangeInfo Core.<$>
                   (o Core..:? "contextValues" Core..!= Core.mempty)
...
instance Core.FromJSON KeyRangeInfos where
        parseJSON
          = Core.withObject "KeyRangeInfos"
              (\ o ->
                 KeyRangeInfos Core.<$>
                   (o Core..:? "infos" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "totalSize"))
          ...
          = Core.withObject "ListInstanceConfigsResponse"
              (\ o ->
                 ListInstanceConfigsResponse Core.<$>
                   (o Core..:? "instanceConfigs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListSessionsResponse"
              (\ o ->
                 ListSessionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "sessions" Core..!= Core.mempty))
...
instance Core.FromJSON MetricMatrixRow where
        parseJSON
          = Core.withObject "MetricMatrixRow"
              (\ o ->
                 MetricMatrixRow Core.<$>
                   (o Core..:? "cols" Core..!= Core.mempty))
...
instance Core.FromJSON PlanNode where
        parseJSON
          = Core.withObject "PlanNode"
              (\ o ->
                 PlanNode Core.<$>
                   (o Core..:? "childLinks" Core..!= Core.mempty)
...
instance Core.FromJSON QueryPlan where
        parseJSON
          = Core.withObject "QueryPlan"
              (\ o ->
                 QueryPlan Core.<$>
                   (o Core..:? "planNodes" Core..!= Core.mempty))
          ...
          = Core.withObject "UpdateDatabaseDdlMetadata"
              (\ o ->
                 UpdateDatabaseDdlMetadata Core.<$>
                   (o Core..:? "commitTimestamps" Core..!= Core.mempty)
...
newUpdateDatabaseDdlRequest =
  UpdateDatabaseDdlRequest
    {operationId = Core.Nothing, statements = Core.Nothing}
              ...
              (\ o ->
                 VisualizationData Core.<$>
                   (o Core..:? "dataSourceEndToken") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "diagnosticMessages" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "endKeyStrings" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "hasPii")
                     Core.<*>
                     (o Core..:? "indexedKeys" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "keySeparator")
                     Core.<*> (o Core..:? "keyUnit")
                     Core.<*> (o Core..:? "metrics" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "prefixNodes" Core..!= Core.mempty))
