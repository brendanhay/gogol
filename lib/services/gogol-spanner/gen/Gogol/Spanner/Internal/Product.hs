...
newAsymmetricAutoscalingOption =
  AsymmetricAutoscalingOption
    {overrides = Core.Nothing, replicaSelection = Core.Nothing}

instance Core.FromJSON AsymmetricAutoscalingOption
         where
        parseJSON
              ...
              (\ o ->
                 AsymmetricAutoscalingOption Core.<$>
                   (o Core..:? "overrides") Core.<*>
                     (o Core..:? "replicaSelection"))

instance Core.ToJSON AsymmetricAutoscalingOption
         where
        toJSON AsymmetricAutoscalingOption{..}
          = Core.object
              (Core.catMaybes
                 [("overrides" Core..=) Core.<$> overrides,
                  ("replicaSelection" Core..=) Core.<$>
                    replicaSelection])
...
instance Core.FromJSON AutoscalingConfigOverrides
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("maxNodes" Core..=) Core.<$> maxNodes,
                  ("maxProcessingUnits" Core..=) Core.<$>
                    maxProcessingUnits,
                  ("minNodes" Core..=) Core.<$> minNodes,
                  ("minProcessingUnits" Core..=) Core.<$>
                    minProcessingUnits])
...
newAutoscalingTargets =
  AutoscalingTargets
    { highPriorityCpuUtilizationPercent = Core.Nothing
          ...
          = Core.withObject "AutoscalingTargets"
              (\ o ->
                 AutoscalingTargets Core.<$>
                   (o Core..:? "highPriorityCpuUtilizationPercent")
          ...
          = Core.object
              (Core.catMaybes
                 [("encryptionConfig" Core..=) Core.<$>
                  ...
                  ("incrementalBackupSpec" Core..=) Core.<$>
                    incrementalBackupSpec,
                  ("name" Core..=) Core.<$> name,
                  ("retentionDuration" Core..=) Core.<$>
                    retentionDuration,
                  ("spec" Core..=) Core.<$> spec,
...
newChangeQuorumMetadata =
  ChangeQuorumMetadata
    {endTime = Core.Nothing, request' = Core.Nothing, startTime = Core.Nothing}
...
newChangeQuorumRequest =
  ChangeQuorumRequest
    {etag = Core.Nothing, name = Core.Nothing, quorumType = Core.Nothing}
...
instance Core.FromJSON CreateBackupEncryptionConfig
         where
        parseJSON
...
instance Core.ToJSON CreateBackupEncryptionConfig
         where
...
instance Core.ToJSON CreateInstancePartitionMetadata
         where
...
newCreateInstancePartitionRequest =
  CreateInstancePartitionRequest
    {instancePartition = Core.Nothing, instancePartitionId = Core.Nothing}

instance Core.FromJSON CreateInstancePartitionRequest
         where
        parseJSON
...
instance Core.ToJSON CreateInstancePartitionRequest
         where
...
newDirectedReadOptions =
  DirectedReadOptions
    {excludeReplicas = Core.Nothing, includeReplicas = Core.Nothing}
...
instance Core.ToJSON DirectedReadOptions where
        toJSON DirectedReadOptions{..}
          = Core.object
              (Core.catMaybes
                 [("excludeReplicas" Core..=) Core.<$>
                    excludeReplicas,
                  ("includeReplicas" Core..=) Core.<$>
                    includeReplicas])
...
newEncryptionConfig 
    ::  EncryptionConfig
newEncryptionConfig =
  EncryptionConfig {kmsKeyName = Core.Nothing, kmsKeyNames = Core.Nothing}
...
newExcludeReplicas 
    ::  ExcludeReplicas
newExcludeReplicas = ExcludeReplicas {replicaSelections = Core.Nothing}

instance Core.FromJSON ExcludeReplicas where
        parseJSON
          = Core.withObject "ExcludeReplicas"
              (\ o ->
                 ExcludeReplicas Core.<$>
...
newIncludeReplicas =
  IncludeReplicas
    {autoFailoverDisabled = Core.Nothing, replicaSelections = Core.Nothing}
...
instance Core.ToJSON IncludeReplicas where
        toJSON IncludeReplicas{..}
          = Core.object
              (Core.catMaybes
                 [("autoFailoverDisabled" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("autoscalingConfig" Core..=) Core.<$>
                  ...
                  ("replicaComputeCapacity" Core..=) Core.<$>
                    replicaComputeCapacity,
                  ("state" Core..=) Core.<$> state,
                  ("updateTime" Core..=) Core.<$> updateTime])
          ...
          = Core.object
              (Core.catMaybes
                 [("baseConfig" Core..=) Core.<$> baseConfig,
                  ...
                  ("state" Core..=) Core.<$> state,
                  ("storageLimitPerProcessingUnit" Core..=) Core..
                    Core.AsText
...
newInstanceReplicaSelection 
    ::  InstanceReplicaSelection
newInstanceReplicaSelection = InstanceReplicaSelection {location = Core.Nothing}

instance Core.FromJSON InstanceReplicaSelection where
        parseJSON
          = Core.withObject "InstanceReplicaSelection"
              (\ o ->
                 InstanceReplicaSelection Core.<$>
                   (o Core..:? "location"))
...
newListBackupSchedulesResponse =
  ListBackupSchedulesResponse
    {backupSchedules = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListBackupSchedulesResponse
         where
        parseJSON
...
instance Core.ToJSON ListBackupSchedulesResponse
         where
              ...
              (\ o ->
                 ListInstancePartitionOperationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "operations")
                     Core.<*>
                     (o Core..:? "unreachableInstancePartitions"))
...
instance Core.FromJSON ListInstancePartitionsResponse
         where
        parseJSON
...
instance Core.ToJSON ListInstancePartitionsResponse
         where
        toJSON ListInstancePartitionsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("instancePartitions" Core..=) Core.<$>
                    instancePartitions,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
...
newMoveInstanceRequest 
    ::  MoveInstanceRequest
newMoveInstanceRequest = MoveInstanceRequest {targetConfig = Core.Nothing}
...
newMultiplexedSessionPrecommitToken =
  MultiplexedSessionPrecommitToken
    {precommitToken = Core.Nothing, seqNum = Core.Nothing}
...
instance Core.ToJSON MultiplexedSessionPrecommitToken
         where
...
instance Core.FromJSON MutationGroup where
        parseJSON
          = Core.withObject "MutationGroup"
              (\ o ->
                 MutationGroup Core.<$> (o Core..:? "mutations"))
...
newQueryAdvisorResult 
    ::  QueryAdvisorResult
newQueryAdvisorResult = QueryAdvisorResult {indexAdvice = Core.Nothing}

instance Core.FromJSON QueryAdvisorResult where
        parseJSON
          = Core.withObject "QueryAdvisorResult"
              (\ o ->
                 QueryAdvisorResult Core.<$>
                   (o Core..:? "indexAdvice"))
...
instance Core.ToJSON QueryAdvisorResult where
        toJSON QueryAdvisorResult{..}
          = Core.object
              (Core.catMaybes
                 [("indexAdvice" Core..=) Core.<$> indexAdvice])
...
newQueryPlan 
    ::  QueryPlan
newQueryPlan = QueryPlan {planNodes = Core.Nothing, queryAdvice = Core.Nothing}
...
instance Core.FromJSON QuorumInfo where
        parseJSON
          = Core.withObject "QuorumInfo"
              (\ o ->
                 QuorumInfo Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "initiator")
                     Core.<*> (o Core..:? "quorumType")
                     Core.<*> (o Core..:? "startTime"))
...
newQuorumType 
    ::  QuorumType
newQuorumType =
  QuorumType {dualRegion = Core.Nothing, singleRegion = Core.Nothing}
...
instance Core.ToJSON UpdateInstancePartitionMetadata
         where
...
newUpdateInstancePartitionRequest =
  UpdateInstancePartitionRequest
    {fieldMask = Core.Nothing, instancePartition = Core.Nothing}

instance Core.FromJSON UpdateInstancePartitionRequest
         where
        parseJSON
...
instance Core.ToJSON UpdateInstancePartitionRequest
         where
