...
type SpannerProjectsInstancesDatabasesBackupSchedulesListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListBackupSchedulesResponse
...
instance
  ...
  where
  type
    Rs SpannerProjectsInstancesDatabasesBackupSchedulesList =
      ListBackupSchedulesResponse
  type
    Scopes SpannerProjectsInstancesDatabasesBackupSchedulesList =
