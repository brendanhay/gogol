...
type SpannerProjectsInstancesDatabasesSessionsPartitionReadResource =
  "v1"
    Core.:> Core.CaptureMode "session" "partitionRead" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] PartitionReadRequest
...
instance
  ...
  where
  type
    Rs SpannerProjectsInstancesDatabasesSessionsPartitionRead =
      PartitionResponse
  type
    Scopes SpannerProjectsInstancesDatabasesSessionsPartitionRead =
