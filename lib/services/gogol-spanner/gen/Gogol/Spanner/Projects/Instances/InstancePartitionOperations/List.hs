...
type SpannerProjectsInstancesInstancePartitionOperationsListResource =
  "v1"
    ...
    Core.:> "instancePartitionOperations"
    Core.:> Core.QueryParam "$.xgafv" Xgafv
    Core.:> Core.QueryParam "access_token" Core.Text
    Core.:> Core.QueryParam "callback" Core.Text
    Core.:> Core.QueryParam "filter" Core.Text
    Core.:> Core.QueryParam "instancePartitionDeadline" Core.DateTime
    Core.:> Core.QueryParam "pageSize" Core.Int32
    Core.:> Core.QueryParam "pageToken" Core.Text
    Core.:> Core.QueryParam "uploadType" Core.Text
    Core.:> Core.QueryParam "upload_protocol" Core.Text
    Core.:> Core.QueryParam "alt" Core.AltJSON
    Core.:> Core.Get '[Core.JSON] ListInstancePartitionOperationsResponse
...
instance
  ...
  where
  type
    Rs SpannerProjectsInstancesInstancePartitionOperationsList =
      ListInstancePartitionOperationsResponse
  type
    Scopes SpannerProjectsInstancesInstancePartitionOperationsList =
