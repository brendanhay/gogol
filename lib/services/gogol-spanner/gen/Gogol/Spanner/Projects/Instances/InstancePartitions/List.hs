...
type SpannerProjectsInstancesInstancePartitionsListResource =
  "v1"
    ...
    Core.:> Core.Get '[Core.JSON] ListInstancePartitionsResponse
...
instance
  ...
  where
  type
    Rs SpannerProjectsInstancesInstancePartitionsList =
      ListInstancePartitionsResponse
  type
    Scopes SpannerProjectsInstancesInstancePartitionsList =
