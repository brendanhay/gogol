...
instance Core.FromJSON LongRunningRecognizeMetadata
         where
        parseJSON
...
instance Core.ToJSON LongRunningRecognizeMetadata
         where
...
instance Core.FromJSON LongRunningRecognizeResponse
         where
        parseJSON
          = Core.withObject "LongRunningRecognizeResponse"
              (\ o ->
                 LongRunningRecognizeResponse Core.<$>
                   (o Core..:? "results" Core..!= Core.mempty))

instance Core.ToJSON LongRunningRecognizeResponse
         where
...
instance Core.FromJSON SpeechRecognitionAlternative
         where
        parseJSON
...
instance Core.ToJSON SpeechRecognitionAlternative
         where
