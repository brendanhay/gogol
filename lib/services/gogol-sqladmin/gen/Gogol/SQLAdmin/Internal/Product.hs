...
newBackupReencryptionConfig =
  BackupReencryptionConfig
    {backupLimit = Core.Nothing, backupType = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("backupKind" Core..=) Core.<$> backupKind,
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("location" Core..=) Core.<$> location,
                  ("maxChargeableBytes" Core..=) Core.. Core.AsText
          ...
          = Core.object
              (Core.catMaybes
                 [("allocatedIpRange" Core..=) Core.<$>
                  ...
                  ("preferredSecondaryZone" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("availableMaintenanceVersions" Core..=) Core.<$>
                  ...
                  ("sqlNetworkArchitecture" Core..=) Core.<$>
...
newDemoteContext =
  DemoteContext
    {kind = Core.Nothing, sourceRepresentativeInstanceName = Core.Nothing}
              ...
              (Core.catMaybes
                 [("bakType" Core..=) Core.<$> bakType,
                  ...
                  ("differentialBase" Core..=) Core.<$>
                    differentialBase,
                  ("exportLogEndTime" Core..=) Core.<$>
                    exportLogEndTime,
                  ("exportLogStartTime" Core..=) Core.<$>
                    exportLogStartTime,
          ...
          = Core.object
              (Core.catMaybes
                 [("mysqlExportOptions" Core..=) Core.<$>
                  ...
                  ("postgresExportOptions" Core..=) Core.<$>
...
newExportContext_SqlExportOptions_PostgresExportOptions =
  ExportContext_SqlExportOptions_PostgresExportOptions
    {clean = Core.Nothing, ifExists = Core.Nothing}
...
instance Core.FromJSON ExternalSyncSelectedObject
         where
        parseJSON
          = Core.withObject "ExternalSyncSelectedObject"
              (\ o ->
                 ExternalSyncSelectedObject Core.<$>
                   (o Core..:? "database"))
          ...
          = Core.withObject "GeminiInstanceConfig"
              (\ o ->
                 GeminiInstanceConfig Core.<$>
                   (o Core..:? "activeQueryEnabled") Core.<*>
                     (o Core..:? "entitled")
...
instance Core.FromJSON ImportContext_SqlImportOptions
         where
        parseJSON
...
instance Core.ToJSON ImportContext_SqlImportOptions
         where
        toJSON ImportContext_SqlImportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("parallel" Core..=) Core.<$> parallel,
                  ("postgresImportOptions" Core..=) Core.<$>
...
newInstancesAcquireSsrsLeaseRequest 
    ::  InstancesAcquireSsrsLeaseRequest
newInstancesAcquireSsrsLeaseRequest =
  InstancesAcquireSsrsLeaseRequest {acquireSsrsLeaseContext = Core.Nothing}
...
instance Core.ToJSON InstancesAcquireSsrsLeaseRequest
         where
...
instance Core.FromJSON InstancesDemoteRequest where
        parseJSON
          = Core.withObject "InstancesDemoteRequest"
              (\ o ->
                 InstancesDemoteRequest Core.<$>
                   (o Core..:? "demoteContext"))

instance Core.ToJSON InstancesDemoteRequest where
        toJSON InstancesDemoteRequest{..}
          = Core.object
              (Core.catMaybes
                 [("demoteContext" Core..=) Core.<$> demoteContext])
...
newInstancesReencryptRequest 
    ::  InstancesReencryptRequest
newInstancesReencryptRequest =
  InstancesReencryptRequest {backupReencryptionConfig = Core.Nothing}

instance Core.FromJSON InstancesReencryptRequest
         where
        parseJSON
...
newInstancesRotateServerCertificateRequest =
  InstancesRotateServerCertificateRequest
    {rotateServerCertificateContext = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("consumerNetwork" Core..=) Core.<$>
                    consumerNetwork,
                  ("consumerNetworkStatus" Core..=) Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("drReplica" Core..=) Core.<$> drReplica,
                  ("failoverDrReplicaName" Core..=) Core.<$>
                    failoverDrReplicaName,
                  ("psaWriteEndpoint" Core..=) Core.<$>
                    psaWriteEndpoint])
...
newRotateServerCertificateContext =
  RotateServerCertificateContext
    {kind = Core.Nothing, nextVersion = Core.Nothing}

instance Core.FromJSON RotateServerCertificateContext
         where
        parseJSON
...
instance Core.ToJSON RotateServerCertificateContext
         where
...
instance Core.FromJSON SelectedObjects where
        parseJSON
          = Core.withObject "SelectedObjects"
              (\ o ->
                 SelectedObjects Core.<$> (o Core..:? "database"))
...
newSqlInstancesGetLatestRecoveryTimeResponse =
  SqlInstancesGetLatestRecoveryTimeResponse
    {kind = Core.Nothing, latestRecoveryTime = Core.Nothing}
