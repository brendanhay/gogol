...
instance Core.FromJSON BackupContext where
        parseJSON
          = Core.withObject "BackupContext"
              (\ o ->
                 BackupContext Core.<$>
                   (o Core..:? "backupId") Core.<*> (o Core..:? "kind"))
              ...
              (\ o ->
                 DatabaseInstance Core.<$>
                   (o Core..:? "availableMaintenanceVersions" Core..!=
                     ...
                     Core.<*>
                     (o Core..:? "replicaNames" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "suspensionReason" Core..!= Core.mempty))
...
instance Core.FromJSON Flag where
        parseJSON
          = Core.withObject "Flag"
              (\ o ->
                 Flag Core.<$>
                   (o Core..:? "allowedIntValues" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "allowedStringValues" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "appliesTo" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "inBeta")
                     Core.<*> (o Core..:? "kind")
          ...
          = Core.withObject "IpConfiguration"
              (\ o ->
                 IpConfiguration Core.<$>
                   (o Core..:? "allocatedIpRange") Core.<*>
                     (o Core..:? "authorizedNetworks" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "MySqlSyncConfig"
              (\ o ->
                 MySqlSyncConfig Core.<$>
                   (o Core..:? "initialSyncFlags" Core..!= Core.mempty))
              ...
              (\ o ->
                 Settings Core.<$>
                   (o Core..:? "activationPolicy") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "authorizedGaeApplications" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "databaseFlags" Core..!= Core.mempty)
...
newSettings_UserLabels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Settings_UserLabels
newSettings_UserLabels addtional = Settings_UserLabels {addtional = addtional}
              ...
              (\ o ->
                 SqlServerUserDetails Core.<$>
                   (o Core..:? "disabled") Core.<*>
                     (o Core..:? "serverRoles" Core..!= Core.mempty))
...
instance Core.FromJSON Tier where
        parseJSON
          = Core.withObject "Tier"
              (\ o ->
                 Tier Core.<$>
                   (o Core..:? "DiskQuota") Core.<*> (o Core..:? "RAM")
                     Core.<*> (o Core..:? "kind")
