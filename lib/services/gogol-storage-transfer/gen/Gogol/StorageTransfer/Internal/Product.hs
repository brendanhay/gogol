...
instance Core.FromJSON ErrorLogEntry where
        parseJSON
          = Core.withObject "ErrorLogEntry"
              (\ o ->
                 ErrorLogEntry Core.<$>
                   (o Core..:? "errorDetails" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "url"))
              ...
              (\ o ->
                 ErrorSummary Core.<$>
                   (o Core..:? "errorCode") Core.<*>
                     (o Core..:? "errorCount")
                     Core.<*>
                     (o Core..:? "errorLogEntries" Core..!= Core.mempty))
          ...
          = Core.withObject "ListAgentPoolsResponse"
              (\ o ->
                 ListAgentPoolsResponse Core.<$>
                   (o Core..:? "agentPools" Core..!= Core.mempty)
          ...
          = Core.withObject "ListTransferJobsResponse"
              (\ o ->
                 ListTransferJobsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "transferJobs" Core..!= Core.mempty))
              ...
              (\ o ->
                 LoggingConfig Core.<$>
                   (o Core..:? "enableOnpremGcsTransferLogs") Core.<*>
                     (o Core..:? "logActionStates" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "logActions" Core..!= Core.mempty))
          ...
          = Core.withObject "NotificationConfig"
              (\ o ->
                 NotificationConfig Core.<$>
                   (o Core..:? "eventTypes" Core..!= Core.mempty)
          ...
          = Core.withObject "ObjectConditions"
              (\ o ->
                 ObjectConditions Core.<$>
                   (o Core..:? "excludePrefixes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "includePrefixes" Core..!= Core.mempty)
              ...
              (\ o ->
                 TransferCounters Core.<$>
                   (o Core..:? "bytesCopiedToSink") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "objectsFromSourceSkippedBySync"))
              ...
              (\ o ->
                 TransferOperation Core.<$>
                   (o Core..:? "counters") Core.<*>
                     (o Core..:? "endTime")
                     Core.<*>
                     (o Core..:? "errorBreakdowns" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "notificationConfig")
                     Core.<*> (o Core..:? "projectId")
...
instance Core.FromJSON TransferSpec where
        parseJSON
          = Core.withObject "TransferSpec"
              (\ o ->
                 TransferSpec Core.<$>
                   (o Core..:? "awsS3DataSource") Core.<*>
                     (o Core..:? "azureBlobStorageDataSource")
