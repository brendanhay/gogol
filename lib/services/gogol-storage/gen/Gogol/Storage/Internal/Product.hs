              ...
              (\ o ->
                 AnywhereCache Core.<$>
                   (o Core..:? "admissionPolicy") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#anywhereCache")
          ...
          = Core.object
              (Core.catMaybes
                 [("acl" Core..=) Core.<$> acl,
                  ...
                  ("hierarchicalNamespace" Core..=) Core.<$>
          ...
          = Core.withObject "Bucket_Autoclass"
              (\ o ->
                 Bucket_Autoclass Core.<$>
                   (o Core..:? "enabled") Core.<*>
                     (o Core..:? "terminalStorageClass")
                     Core.<*>
                     (o Core..:? "terminalStorageClassUpdateTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("terminalStorageClass" Core..=) Core.<$>
...
instance Core.FromJSON Bucket_HierarchicalNamespace
         where
        parseJSON
          = Core.withObject "Bucket_HierarchicalNamespace"
              (\ o ->
                 Bucket_HierarchicalNamespace Core.<$>
                   (o Core..:? "enabled"))

instance Core.ToJSON Bucket_HierarchicalNamespace
         where
...
instance Core.ToJSON Bucket_IpFilter where
        toJSON Bucket_IpFilter{..}
          = Core.object
              (Core.catMaybes
                 [("mode" Core..=) Core.<$> mode,
                  ("publicNetworkSource" Core..=) Core.<$>
                    publicNetworkSource,
                  ("vpcNetworkSources" Core..=) Core.<$>
                    vpcNetworkSources])
...
newBucket_IpFilter_PublicNetworkSource 
    ::  Bucket_IpFilter_PublicNetworkSource
newBucket_IpFilter_PublicNetworkSource =
  Bucket_IpFilter_PublicNetworkSource {allowedIpCidrRanges = Core.Nothing}
...
newBucket_IpFilter_VpcNetworkSourcesItem =
  Bucket_IpFilter_VpcNetworkSourcesItem
    {allowedIpCidrRanges = Core.Nothing, network = Core.Nothing}
          ...
          = Core.withObject
              ...
              (\ o ->
                 Bucket_IpFilter_VpcNetworkSourcesItem Core.<$>
                   (o Core..:? "allowedIpCidrRanges") Core.<*>
                     (o Core..:? "network"))
...
newBucket_ObjectRetention 
    ::  Bucket_ObjectRetention
newBucket_ObjectRetention = Bucket_ObjectRetention {mode = Core.Nothing}

instance Core.FromJSON Bucket_ObjectRetention where
        parseJSON
          = Core.withObject "Bucket_ObjectRetention"
              (\ o ->
                 Bucket_ObjectRetention Core.<$> (o Core..:? "mode"))
...
newBucket_SoftDeletePolicy =
  Bucket_SoftDeletePolicy
    {effectiveTime = Core.Nothing, retentionDurationSeconds = Core.Nothing}
...
instance Core.ToJSON Bucket_SoftDeletePolicy where
        toJSON Bucket_SoftDeletePolicy{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveTime" Core..=) Core.<$> effectiveTime,
                  ("retentionDurationSeconds" Core..=) Core..
                    Core.AsText
          ...
          = Core.withObject "BucketStorageLayout"
              (\ o ->
                 BucketStorageLayout Core.<$>
                   (o Core..:? "bucket") Core.<*>
                     (o Core..:? "customPlacementConfig")
                     Core.<*> (o Core..:? "hierarchicalNamespace")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#storageLayout")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "locationType"))
...
newBucketStorageLayout_CustomPlacementConfig 
    ::  BucketStorageLayout_CustomPlacementConfig
newBucketStorageLayout_CustomPlacementConfig =
  BucketStorageLayout_CustomPlacementConfig {dataLocations = Core.Nothing}
...
instance Core.FromJSON BulkRestoreObjectsRequest
         where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("allowOverwrite" Core..=) Core.<$> allowOverwrite,
                  ...
                  ("softDeletedAfterTime" Core..=) Core.<$>
                    softDeletedAfterTime,
                  ("softDeletedBeforeTime" Core..=) Core.<$>
              ...
              (\ o ->
                 Folder Core.<$>
                   (o Core..:? "bucket") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#folder")
                     Core.<*>
                     (o Core..:? "metageneration" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleLongrunningListOperationsResponse Core.<$>
                   (o Core..:? "kind" Core..!= "storage#operations")
                     Core.<*> (o Core..:? "nextPageToken")
              ...
              (\ o ->
                 ManagedFolder Core.<$>
                   (o Core..:? "bucket") Core.<*>
                     ...
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "storage#managedFolder")
                     Core.<*>
                     (o Core..:? "metageneration" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
...
newObject_Retention 
    ::  Object_Retention
newObject_Retention =
  Object_Retention {mode = Core.Nothing, retainUntilTime = Core.Nothing}
...
newRelocateBucketRequest =
  RelocateBucketRequest
    { destinationCustomPlacementConfig = Core.Nothing
          ...
          = Core.withObject "RelocateBucketRequest"
              (\ o ->
                 RelocateBucketRequest Core.<$>
                   (o Core..:? "destinationCustomPlacementConfig")
