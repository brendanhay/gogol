...
instance Core.FromJSON Bucket where
        parseJSON
          = Core.withObject "Bucket"
              (\ o ->
                 Bucket Core.<$>
                   (o Core..:? "acl" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "autoclass")
                     Core.<*> (o Core..:? "billing")
                     ...
                     Core.<*>
                     (o Core..:? "defaultObjectAcl" Core..!= Core.mempty)
              ...
              (\ o ->
                 Bucket_CorsItem Core.<$>
                   (o Core..:? "maxAgeSeconds") Core.<*>
                     (o Core..:? "method" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "origin" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "responseHeader" Core..!= Core.mempty))
          ...
          = Core.withObject "Bucket_CustomPlacementConfig"
              (\ o ->
                 Bucket_CustomPlacementConfig Core.<$>
                   (o Core..:? "dataLocations" Core..!= Core.mempty))
...
newBucket_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  An individual label entry. See 'addtional'.
    -> Bucket_Labels
newBucket_Labels addtional = Bucket_Labels {addtional = addtional}
...
instance Core.ToJSON Bucket_Labels where
        toJSON Bucket_Labels{..} = Core.toJSON addtional
...
instance Core.FromJSON Bucket_Lifecycle where
        parseJSON
          = Core.withObject "Bucket_Lifecycle"
              (\ o ->
                 Bucket_Lifecycle Core.<$>
                   (o Core..:? "rule" Core..!= Core.mempty))
              ...
              (\ o ->
                 Bucket_Lifecycle_RuleItem_Condition Core.<$>
                   (o Core..:? "age") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "matchesStorageClass" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 ComposeRequest Core.<$>
                   (o Core..:? "destination") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "sourceObjects" Core..!= Core.mempty))
              ...
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "custom_attributes") Core.<*>
                     (o Core..:? "etag")
                     Core.<*>
                     (o Core..:? "event_types" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "id")
                     Core.<*>
...
newNotification_Custom_attributes 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Notification_Custom_attributes
newNotification_Custom_attributes addtional =
  Notification_Custom_attributes {addtional = addtional}
...
newObject_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  An individual metadata entry. See 'addtional'.
    -> Object_Metadata
newObject_Metadata addtional = Object_Metadata {addtional = addtional}
...
instance Core.ToJSON Object_Metadata where
        toJSON Object_Metadata{..} = Core.toJSON addtional
              ...
              (\ o ->
                 Objects Core.<$>
                   (o Core..:? "items" Core..!= Core.mempty) Core.<*>
                     ...
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*>
                     (o Core..:? "prefixes" Core..!= Core.mempty))
