...
type StorageObjectsRestoreResource =
  "storage"
    ...
    Core.:> Core.QueryParam "copySourceAcl" Core.Bool
    ...
    Core.:> Core.QueryParam "projection" ObjectsRestoreProjection
    Core.:> Core.QueryParam "restoreToken" Core.Text
