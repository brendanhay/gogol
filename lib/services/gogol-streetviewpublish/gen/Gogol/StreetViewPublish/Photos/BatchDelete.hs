...
type StreetViewPublishPhotosBatchDeleteResource =
  "v1"
    ...
    Core.:> Core.ReqBody '[Core.JSON] BatchDeletePhotosRequest
    Core.:> Core.Post '[Core.JSON] BatchDeletePhotosResponse
...
instance Core.GoogleRequest StreetViewPublishPhotosBatchDelete where
  type
    Rs StreetViewPublishPhotosBatchDelete =
      BatchDeletePhotosResponse
  type
    Scopes StreetViewPublishPhotosBatchDelete =
