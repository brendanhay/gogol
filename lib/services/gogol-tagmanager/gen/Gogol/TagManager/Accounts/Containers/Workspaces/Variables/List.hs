...
type TagManagerAccountsContainersWorkspacesVariablesListResource =
  "tagmanager"
    ...
    Core.:> Core.Get '[Core.JSON] ListVariablesResponse
...
instance
  ...
  where
  type
    Rs TagManagerAccountsContainersWorkspacesVariablesList =
      ListVariablesResponse
  type
    Scopes TagManagerAccountsContainersWorkspacesVariablesList =
