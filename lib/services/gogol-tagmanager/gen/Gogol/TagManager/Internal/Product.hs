              ...
              (\ o ->
                 Client Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "notes")
                     Core.<*>
                     (o Core..:? "parameter" Core..!= Core.mempty)
              ...
              (\ o ->
                 Container Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "containerId")
                     Core.<*>
                     (o Core..:? "domainName" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fingerprint")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "notes")
                     Core.<*> (o Core..:? "path")
                     ...
                     Core.<*> (o Core..:? "tagManagerUrl")
                     Core.<*>
                     (o Core..:? "usageContext" Core..!= Core.mempty))
              ...
              (\ o ->
                 FolderEntities Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "tag" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "trigger" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "variable" Core..!= Core.mempty))
          ...
          = Core.withObject "GetWorkspaceStatusResponse"
              (\ o ->
                 GetWorkspaceStatusResponse Core.<$>
                   (o Core..:? "mergeConflict" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "workspaceChange" Core..!= Core.mempty))
          ...
          = Core.withObject "ListAccountsResponse"
              (\ o ->
                 ListAccountsResponse Core.<$>
                   (o Core..:? "account" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListClientsResponse"
              (\ o ->
                 ListClientsResponse Core.<$>
                   (o Core..:? "client" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListContainersResponse"
              (\ o ->
                 ListContainersResponse Core.<$>
                   (o Core..:? "container" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListFoldersResponse"
              (\ o ->
                 ListFoldersResponse Core.<$>
                   (o Core..:? "folder" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListTemplatesResponse"
              (\ o ->
                 ListTemplatesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "template" Core..!= Core.mempty))
          ...
          = Core.withObject "ListTriggersResponse"
              (\ o ->
                 ListTriggersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "trigger" Core..!= Core.mempty))
          ...
          = Core.withObject "ListUserPermissionsResponse"
              (\ o ->
                 ListUserPermissionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "userPermission" Core..!= Core.mempty))
          ...
          = Core.withObject "ListWorkspacesResponse"
              (\ o ->
                 ListWorkspacesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "workspace" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject "Tag"
              (\ o ->
                 Tag Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "blockingRuleId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "blockingTriggerId" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "consentSettings")
                     Core.<*> (o Core..:? "containerId")
                     Core.<*> (o Core..:? "fingerprint")
                     Core.<*>
                     (o Core..:? "firingRuleId" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "firingTriggerId" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "tagManagerUrl")
                     Core.<*>
                     (o Core..:? "teardownTag" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "workspaceId"))
        ...
        parseJSON
          = Core.withObject "Trigger"
              (\ o ->
                 Trigger Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "autoEventFilter" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "checkValidation")
                     Core.<*> (o Core..:? "containerId")
                     Core.<*> (o Core..:? "continuousTimeMinMilliseconds")
                     Core.<*>
                     (o Core..:? "customEventFilter" Core..!= Core.mempty)
              ...
              (\ o ->
                 UserPermission Core.<$>
                   (o Core..:? "accountAccess") Core.<*>
                     (o Core..:? "accountId")
                     Core.<*>
                     (o Core..:? "containerAccess" Core..!= Core.mempty)
              ...
              (\ o ->
                 Variable Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "containerId")
                     Core.<*>
                     (o Core..:? "disablingTriggerId" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "enablingTriggerId" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "fingerprint")
              ...
              (\ o ->
                 Zone Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "boundary")
                     Core.<*>
                     (o Core..:? "childContainer" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "containerId")
                     Core.<*> (o Core..:? "fingerprint")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "notes")
...
instance Core.FromJSON ZoneBoundary where
        parseJSON
          = Core.withObject "ZoneBoundary"
              (\ o ->
                 ZoneBoundary Core.<$>
                   (o Core..:? "condition" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "customEvaluationTriggerId" Core..!=
                        Core.mempty))
