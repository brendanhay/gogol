...
instance Core.FromJSON CancelDeviceSessionRequest
         where
        parseJSON
...
instance Core.ToJSON DirectAccessVersionInfo where
        toJSON DirectAccessVersionInfo{..}
          = Core.object
              (Core.catMaybes
                 [("directAccessSupported" Core..=) Core.<$>
...
newListDeviceSessionsResponse =
  ListDeviceSessionsResponse
    {deviceSessions = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListDeviceSessionsResponse
         where
        parseJSON
              ...
              (\ o ->
                 PerAndroidVersionInfo Core.<$>
                   (o Core..:? "deviceCapacity") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "interactiveDeviceAvailabilityEstimate")
...
newUsesPermissionTag 
    ::  UsesPermissionTag
newUsesPermissionTag =
  UsesPermissionTag {maxSdkVersion = Core.Nothing, name = Core.Nothing}
