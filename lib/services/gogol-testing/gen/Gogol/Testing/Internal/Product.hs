          ...
          = Core.withObject "AndroidDeviceList"
              (\ o ->
                 AndroidDeviceList Core.<$>
                   (o Core..:? "androidDevices" Core..!= Core.mempty))
              ...
              (\ o ->
                 AndroidInstrumentationTest Core.<$>
                   (o Core..:? "appApk") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "testTargets" Core..!= Core.mempty))
...
instance Core.FromJSON AndroidMatrix where
        parseJSON
          = Core.withObject "AndroidMatrix"
              (\ o ->
                 AndroidMatrix Core.<$>
                   (o Core..:? "androidModelIds" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "androidVersionIds" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "locales" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "orientations" Core..!= Core.mempty))
              ...
              (\ o ->
                 AndroidModel Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "codename")
                     ...
                     Core.<*> (o Core..:? "screenY")
                     Core.<*>
                     (o Core..:? "supportedAbis" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "supportedVersionIds" Core..!=
                        Core.mempty)
              ...
              (\ o ->
                 AndroidRoboTest Core.<$>
                   (o Core..:? "appApk") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "roboDirectives" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "roboMode")
                     Core.<*> (o Core..:? "roboScript")
                     Core.<*>
                     (o Core..:? "startingIntents" Core..!= Core.mempty))
          ...
          = Core.withObject "AndroidRuntimeConfiguration"
              (\ o ->
                 AndroidRuntimeConfiguration Core.<$>
                   (o Core..:? "locales" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "orientations" Core..!= Core.mempty))
              ...
              (\ o ->
                 AndroidTestLoop Core.<$>
                   (o Core..:? "appApk") Core.<*>
                     ...
                     Core.<*> (o Core..:? "appPackageId")
                     Core.<*>
                     (o Core..:? "scenarioLabels" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "scenarios" Core..!= Core.mempty))
...
instance Core.FromJSON ClientInfo where
        parseJSON
          = Core.withObject "ClientInfo"
              (\ o ->
                 ClientInfo Core.<$>
                   (o Core..:? "clientInfoDetails" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name"))
          ...
          = Core.withObject "DeviceIpBlockCatalog"
              (\ o ->
                 DeviceIpBlockCatalog Core.<$>
                   (o Core..:? "ipBlocks" Core..!= Core.mempty))
              ...
              (\ o ->
                 IntentFilter Core.<$>
                   (o Core..:? "actionNames" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "categoryNames" Core..!= Core.mempty)
              ...
              (\ o ->
                 IosDeviceCatalog Core.<$>
                   (o Core..:? "models" Core..!= Core.mempty) Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "xcodeVersions" Core..!= Core.mempty))
...
instance Core.FromJSON IosDeviceList where
        parseJSON
          = Core.withObject "IosDeviceList"
              (\ o ->
                 IosDeviceList Core.<$>
                   (o Core..:? "iosDevices" Core..!= Core.mempty))
...
instance Core.FromJSON IosTestSetup where
        parseJSON
          = Core.withObject "IosTestSetup"
              (\ o ->
                 IosTestSetup Core.<$>
                   (o Core..:? "additionalIpas" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "networkProfile")
                     Core.<*>
                     (o Core..:? "pullDirectories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "pushFiles" Core..!= Core.mempty))
              ...
              (\ o ->
                 IosVersion Core.<$>
                   (o Core..:? "id") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "supportedXcodeVersionIds" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "tags" Core..!= Core.mempty))
...
instance Core.FromJSON ManualSharding where
        parseJSON
          = Core.withObject "ManualSharding"
              (\ o ->
                 ManualSharding Core.<$>
                   (o Core..:? "testTargetsForShard" Core..!=
                      Core.mempty))
          ...
          = Core.withObject "NetworkConfigurationCatalog"
              (\ o ->
                 NetworkConfigurationCatalog Core.<$>
                   (o Core..:? "configurations" Core..!= Core.mempty))
              ...
              (\ o ->
                 TestDetails Core.<$>
                   (o Core..:? "errorMessage") Core.<*>
                     (o Core..:? "progressMessages" Core..!= Core.mempty))
              ...
              (\ o ->
                 TestMatrix Core.<$>
                   (o Core..:? "clientInfo") Core.<*>
                     ...
                     Core.<*> (o Core..:? "state")
                     Core.<*>
                     (o Core..:? "testExecutions" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject "TestSetup"
              (\ o ->
                 TestSetup Core.<$>
                   (o Core..:? "account") Core.<*>
                     (o Core..:? "additionalApks" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "directoriesToPull" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "dontAutograntPermissions")
                     Core.<*>
                     (o Core..:? "environmentVariables" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "filesToPush" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "networkProfile")
...
instance Core.FromJSON XcodeVersion where
        parseJSON
          = Core.withObject "XcodeVersion"
              (\ o ->
                 XcodeVersion Core.<$>
                   (o Core..:? "tags" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "version"))
