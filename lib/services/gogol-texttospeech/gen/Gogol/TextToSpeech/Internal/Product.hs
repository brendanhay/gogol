...
instance Core.FromJSON AdvancedVoiceOptions where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          AdvancedVoiceOptions
            Core.<$> (o Core..:? "lowLatencyJourneySynthesis")
      )
...
instance Core.ToJSON AdvancedVoiceOptions where
  toJSON AdvancedVoiceOptions {..} =
    Core.object
      ( Core.catMaybes
          [ ("lowLatencyJourneySynthesis" Core..=)
              Core.<$> lowLatencyJourneySynthesis
          ]
      )
...
instance Core.FromJSON SynthesisInput where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          SynthesisInput
            Core.<$> (o Core..:? "customPronunciations")
...
instance Core.FromJSON SynthesizeSpeechRequest where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          SynthesizeSpeechRequest
            Core.<$> (o Core..:? "advancedVoiceOptions")
            Core.<*> (o Core..:? "audioConfig")
            Core.<*> (o Core..:? "input")
            Core.<*> (o Core..:? "voice")
      )
