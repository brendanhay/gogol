...
instance Core.ToJSON CrashDialogError where
        toJSON CrashDialogError{..}
          = Core.object
              (Core.catMaybes
                 [("crashPackage" Core..=) Core.<$> crashPackage])
...
newEncounteredLoginScreen =
  EncounteredLoginScreen
    {distinctScreens = Core.Nothing, screenIds = Core.Nothing}
          ...
          = Core.withObject "EncounteredLoginScreen"
              (\ o ->
                 EncounteredLoginScreen Core.<$>
                   (o Core..:? "distinctScreens") Core.<*>
                     (o Core..:? "screenIds" Core..!= Core.mempty))

instance Core.ToJSON EncounteredLoginScreen where
        toJSON EncounteredLoginScreen{..}
          = Core.object
              (Core.catMaybes
                 [("distinctScreens" Core..=) Core.<$>
                    distinctScreens,
...
instance Core.FromJSON FatalException where
        parseJSON
          = Core.withObject "FatalException"
              (\ o ->
                 FatalException Core.<$> (o Core..:? "stackTrace"))
...
instance Core.FromJSON IosAppCrashed where
        parseJSON
          = Core.withObject "IosAppCrashed"
              (\ o ->
                 IosAppCrashed Core.<$> (o Core..:? "stackTrace"))
...
instance Core.FromJSON NativeCrash where
        parseJSON
          = Core.withObject "NativeCrash"
              (\ o ->
                 NativeCrash Core.<$> (o Core..:? "stackTrace"))
              ...
              (\ o ->
                 NonSdkApi Core.<$>
                   (o Core..:? "apiSignature") Core.<*>
                     (o Core..:? "exampleStackTraces" Core..!=
                        Core.mempty)
...
instance Core.ToJSON NonSdkApiInsight where
        toJSON NonSdkApiInsight{..}
          = Core.object
              (Core.catMaybes
                 [("exampleTraceMessages" Core..=) Core.<$>
...
newNonSdkApiUsageViolation =
  NonSdkApiUsageViolation
    {apiSignatures = Core.Nothing, uniqueApis = Core.Nothing}
          ...
          = Core.withObject "NonSdkApiUsageViolation"
              (\ o ->
                 NonSdkApiUsageViolation Core.<$>
                   (o Core..:? "apiSignatures" Core..!= Core.mempty)
...
instance Core.FromJSON NonSdkApiUsageViolationReport
         where
        parseJSON
          = Core.withObject "NonSdkApiUsageViolationReport"
              (\ o ->
                 NonSdkApiUsageViolationReport Core.<$>
                   (o Core..:? "exampleApis" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "minSdkVersion")
                     Core.<*> (o Core..:? "targetSdkVersion")
                     Core.<*> (o Core..:? "uniqueApis"))

instance Core.ToJSON NonSdkApiUsageViolationReport
         where
...
newOverlappingUIElements 
    ::  OverlappingUIElements
newOverlappingUIElements =
  OverlappingUIElements {resourceName = Core.Nothing, screenId = Core.Nothing}
          ...
          = Core.withObject "OverlappingUIElements"
              (\ o ->
                 OverlappingUIElements Core.<$>
                   (o Core..:? "resourceName" Core..!= Core.mempty)
...
instance Core.FromJSON PendingGoogleUpdateInsight
         where
        parseJSON
...
newPerformedMonkeyActions 
    ::  PerformedMonkeyActions
newPerformedMonkeyActions = PerformedMonkeyActions {totalActions = Core.Nothing}

instance Core.FromJSON PerformedMonkeyActions where
        parseJSON
          = Core.withObject "PerformedMonkeyActions"
              (\ o ->
                 PerformedMonkeyActions Core.<$>
                   (o Core..:? "totalActions"))
...
newRoboScriptExecution =
  RoboScriptExecution
    {successfulActions = Core.Nothing, totalActions = Core.Nothing}
          ...
          = Core.withObject "UIElementTooDeep"
              (\ o ->
                 UIElementTooDeep Core.<$>
                   (o Core..:? "depth") Core.<*> (o Core..:? "screenId")
...
newUnusedRoboDirective 
    ::  UnusedRoboDirective
newUnusedRoboDirective = UnusedRoboDirective {resourceName = Core.Nothing}

instance Core.FromJSON UnusedRoboDirective where
        parseJSON
          = Core.withObject "UnusedRoboDirective"
              (\ o ->
                 UnusedRoboDirective Core.<$>
                   (o Core..:? "resourceName"))
...
newUpgradeInsight 
    ::  UpgradeInsight
newUpgradeInsight =
  UpgradeInsight {packageName = Core.Nothing, upgradeToVersion = Core.Nothing}
...
newUsedRoboDirective 
    ::  UsedRoboDirective
newUsedRoboDirective = UsedRoboDirective {resourceName = Core.Nothing}

instance Core.FromJSON UsedRoboDirective where
        parseJSON
          = Core.withObject "UsedRoboDirective"
              (\ o ->
                 UsedRoboDirective Core.<$>
                   (o Core..:? "resourceName"))
