              ...
              (\ o ->
                 GetGuestAttributesRequest Core.<$>
                   (o Core..:? "queryPath") Core.<*>
                     (o Core..:? "workerIds" Core..!= Core.mempty))
          ...
          = Core.withObject "GetGuestAttributesResponse"
              (\ o ->
                 GetGuestAttributesResponse Core.<$>
                   (o Core..:? "guestAttributes" Core..!= Core.mempty))
          ...
          = Core.withObject "ListAcceleratorTypesResponse"
              (\ o ->
                 ListAcceleratorTypesResponse Core.<$>
                   (o Core..:? "acceleratorTypes" Core..!= Core.mempty)
          ...
          = Core.withObject "ListRuntimeVersionsResponse"
              (\ o ->
                 ListRuntimeVersionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "runtimeVersions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "unreachable" Core..!= Core.mempty))
              ...
              (\ o ->
                 Node Core.<$>
                   (o Core..:? "acceleratorType") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "networkEndpoints" Core..!= Core.mempty)
...
newNode_Labels 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Node_Labels
newNode_Labels addtional = Node_Labels {addtional = addtional}
...
instance Core.ToJSON Node_Labels where
        toJSON Node_Labels{..} = Core.toJSON addtional
...
newNode_Metadata 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'addtional'.
    -> Node_Metadata
newNode_Metadata addtional = Node_Metadata {addtional = addtional}
...
instance Core.ToJSON Node_Metadata where
        toJSON Node_Metadata{..} = Core.toJSON addtional
