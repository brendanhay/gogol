...
instance Core.FromJSON QueuedResourceState where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          QueuedResourceState
            Core.<$> (o Core..:? "acceptedData")
            Core.<*> (o Core..:? "activeData")
...
instance Core.FromJSON QueueingPolicy where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          QueueingPolicy
            Core.<$> (o Core..:? "validAfterDuration")
