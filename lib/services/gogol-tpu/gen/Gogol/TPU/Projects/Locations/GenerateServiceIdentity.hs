...
type TPUProjectsLocationsGenerateServiceIdentityResource =
  "v2"
    Core.:> Core.CaptureMode "parent" "generateServiceIdentity" Core.Text
    ...
    Core.:> Core.ReqBody '[Core.JSON] GenerateServiceIdentityRequest
    Core.:> Core.Post '[Core.JSON] GenerateServiceIdentityResponse
...
instance
  ...
  type
    Scopes TPUProjectsLocationsGenerateServiceIdentity =
