...
instance Core.GoogleRequest TPUProjectsLocationsList
         where
        type Rs TPUProjectsLocationsList =
             ListLocationsResponse
        type Scopes TPUProjectsLocationsList =
        ...
        requestClient TPUProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsListResource)
                      Core.mempty
