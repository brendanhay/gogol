...
type TPUProjectsLocationsQueuedResourcesListResource =
  "v2"
    ...
    Core.:> Core.Get '[Core.JSON] ListQueuedResourcesResponse
...
instance Core.GoogleRequest TPUProjectsLocationsQueuedResourcesList where
  type
    Rs TPUProjectsLocationsQueuedResourcesList =
      ListQueuedResourcesResponse
  type
    Scopes TPUProjectsLocationsQueuedResourcesList =
