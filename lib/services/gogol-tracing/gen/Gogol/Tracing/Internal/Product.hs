...
newtype Attributes_AttributeMap = Attributes_AttributeMap
  { -- |
    addtional :: (Core.HashMap Core.Text AttributeValue)
  }
  deriving (Core.Eq, Core.Show, Core.Generic)
...
newAttributes_AttributeMap ::
  ...
  Attributes_AttributeMap
newAttributes_AttributeMap addtional =
  Attributes_AttributeMap {addtional = addtional}
...
instance Core.ToJSON NetworkEvent where
  toJSON NetworkEvent {..} =
    Core.object
      ( Core.catMaybes
          [ ("messageId" Core..=) Core.. Core.AsText
              Core.<$> messageId,
            ("messageSize" Core..=) Core.. Core.AsText
              Core.<$> messageSize,
            ("time" Core..=) Core.<$> time,
            ("type" Core..=) Core.<$> type'
          ]
