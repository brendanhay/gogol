...
instance Core.FromJSON NetworkEvent where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          NetworkEvent
            Core.<$> (o Core..:? "messageId" Core.<&> Core.fmap Core.fromAsText)
            Core.<*> (o Core..:? "messageSize" Core.<&> Core.fmap Core.fromAsText)
            Core.<*> (o Core..:? "time")
            Core.<*> (o Core..:? "type")
      )
...
instance Core.FromJSON StackFrame where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          StackFrame
            Core.<$> (o Core..:? "columnNumber" Core.<&> Core.fmap Core.fromAsText)
...
newStackFrames =
  StackFrames
    { droppedFramesCount = Core.Nothing,
      frame = Core.Nothing
    }
    ...
    Core.withObject
      ...
      ( \o ->
          StackTrace
            ...
            Core.<*> (o Core..:? "stackTraceHashId" Core.<&> Core.fmap Core.fromAsText)
      )
    ...
    Core.object
      ( Core.catMaybes
          [ ("droppedAnnotationsCount" Core..=)
            ...
            ("droppedNetworkEventsCount" Core..=)
              Core.<$> droppedNetworkEventsCount,
...
newTruncatableString =
  TruncatableString
    { truncatedCharacterCount = Core.Nothing,
      value = Core.Nothing
    }
...
instance Core.FromJSON TruncatableString where
  parseJSON =
    Core.withObject
      ...
      ( \o ->
          TruncatableString
            Core.<$> (o Core..:? "truncatedCharacterCount")
            Core.<*> (o Core..:? "value")
      )
...
instance Core.ToJSON TruncatableString where
  toJSON TruncatableString {..} =
    Core.object
      ( Core.catMaybes
          [ ("truncatedCharacterCount" Core..=)
              Core.<$> truncatedCharacterCount,
