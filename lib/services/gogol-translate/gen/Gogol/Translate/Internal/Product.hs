...
instance Core.FromJSON AdaptiveMtTranslateRequest
         where
        parseJSON
...
instance Core.FromJSON AdaptiveMtTranslateResponse
         where
        parseJSON
...
instance Core.ToJSON AdaptiveMtTranslateResponse
         where
...
newAdaptiveMtTranslation 
    ::  AdaptiveMtTranslation
newAdaptiveMtTranslation = AdaptiveMtTranslation {translatedText = Core.Nothing}

instance Core.FromJSON AdaptiveMtTranslation where
        parseJSON
          = Core.withObject "AdaptiveMtTranslation"
              (\ o ->
                 AdaptiveMtTranslation Core.<$>
                   (o Core..:? "translatedText"))
...
newGlossaryConfig 
    ::  GlossaryConfig
newGlossaryConfig =
  GlossaryConfig {glossary = Core.Nothing, ignoreCase = Core.Nothing}
...
newImportAdaptiveMtFileRequest =
  ImportAdaptiveMtFileRequest
    {fileInputSource = Core.Nothing, gcsInputSource = Core.Nothing}

instance Core.FromJSON ImportAdaptiveMtFileRequest
         where
        parseJSON
...
instance Core.ToJSON ImportAdaptiveMtFileRequest
         where
        toJSON ImportAdaptiveMtFileRequest{..}
          = Core.object
              (Core.catMaybes
                 [("fileInputSource" Core..=) Core.<$>
                    fileInputSource,
...
instance Core.FromJSON ImportAdaptiveMtFileResponse
         where
        parseJSON
...
instance Core.ToJSON ImportAdaptiveMtFileResponse
         where
...
newListAdaptiveMtDatasetsResponse =
  ListAdaptiveMtDatasetsResponse
    {adaptiveMtDatasets = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListAdaptiveMtDatasetsResponse
         where
        parseJSON
...
instance Core.ToJSON ListAdaptiveMtDatasetsResponse
         where
        toJSON ListAdaptiveMtDatasetsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("adaptiveMtDatasets" Core..=) Core.<$>
                    adaptiveMtDatasets,
...
newListAdaptiveMtFilesResponse =
  ListAdaptiveMtFilesResponse
    {adaptiveMtFiles = Core.Nothing, nextPageToken = Core.Nothing}

instance Core.FromJSON ListAdaptiveMtFilesResponse
         where
        parseJSON
...
instance Core.ToJSON ListAdaptiveMtFilesResponse
         where
        toJSON ListAdaptiveMtFilesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("adaptiveMtFiles" Core..=) Core.<$>
                    adaptiveMtFiles,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newListAdaptiveMtSentencesResponse =
  ListAdaptiveMtSentencesResponse
    {adaptiveMtSentences = Core.Nothing, nextPageToken = Core.Nothing}
...
instance Core.ToJSON ListAdaptiveMtSentencesResponse
         where
        toJSON ListAdaptiveMtSentencesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("adaptiveMtSentences" Core..=) Core.<$>
                    adaptiveMtSentences,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken])
...
newReferenceSentenceConfig =
  ReferenceSentenceConfig
    { referenceSentencePairLists = Core.Nothing
    , sourceLanguageCode = Core.Nothing
    , targetLanguageCode = Core.Nothing
    }
...
newReferenceSentencePair =
  ReferenceSentencePair
    {sourceSentence = Core.Nothing, targetSentence = Core.Nothing}
...
instance Core.FromJSON ReferenceSentencePairList
         where
        parseJSON
...
newRomanization =
  Romanization
    {detectedLanguageCode = Core.Nothing, romanizedText = Core.Nothing}
...
newRomanizeTextRequest =
  RomanizeTextRequest
    {contents = Core.Nothing, sourceLanguageCode = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("contents" Core..=) Core.<$> contents,
                  ...
                  ("targetLanguageCode" Core..=) Core.<$>
                    targetLanguageCode,
                  ("transliterationConfig" Core..=) Core.<$>
                    transliterationConfig])
...
instance Core.ToJSON TransliterationConfig where
        toJSON TransliterationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enableTransliteration" Core..=) Core.<$>
