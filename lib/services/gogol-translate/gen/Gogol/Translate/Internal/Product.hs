          ...
          = Core.withObject "BatchTranslateDocumentRequest"
              (\ o ->
                 BatchTranslateDocumentRequest Core.<$>
                   (o Core..:? "formatConversions") Core.<*>
                     (o Core..:? "glossaries")
                     Core.<*>
                     (o Core..:? "inputConfigs" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "models")
                     Core.<*> (o Core..:? "outputConfig")
                     Core.<*> (o Core..:? "sourceLanguageCode")
                     Core.<*>
                     (o Core..:? "targetLanguageCodes" Core..!=
                        Core.mempty))
          ...
          = Core.withObject "DocumentTranslation"
              (\ o ->
                 DocumentTranslation Core.<$>
                   (o Core..:? "byteStreamOutputs" Core..!= Core.mempty)
          ...
          = Core.withObject "ListGlossariesResponse"
              (\ o ->
                 ListGlossariesResponse Core.<$>
                   (o Core..:? "glossaries" Core..!= Core.mempty)
          ...
          = Core.withObject "TranslateDocumentRequest"
              (\ o ->
                 TranslateDocumentRequest Core.<$>
                   (o Core..:? "documentInputConfig") Core.<*>
                     (o Core..:? "documentOutputConfig")
