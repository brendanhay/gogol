...
type TranslateProjectsLocationsAdaptiveMtDatasetsCreateResource =
  "v3"
    ...
    Core.:> Core.ReqBody '[Core.JSON] AdaptiveMtDataset
    Core.:> Core.Post '[Core.JSON] AdaptiveMtDataset
...
instance
  ...
  where
  type
    Rs TranslateProjectsLocationsAdaptiveMtDatasetsCreate =
      AdaptiveMtDataset
  type
    Scopes TranslateProjectsLocationsAdaptiveMtDatasetsCreate =
