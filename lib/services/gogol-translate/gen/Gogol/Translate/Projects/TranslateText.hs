...
type TranslateProjectsTranslateTextResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "translateText" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] TranslateTextRequest
...
instance Core.GoogleRequest
           TranslateProjectsTranslateText
         where
        type Rs TranslateProjectsTranslateText =
        ...
        requestClient TranslateProjectsTranslateText{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsTranslateTextResource)
                      Core.mempty
