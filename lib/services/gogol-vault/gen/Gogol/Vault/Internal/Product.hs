...
instance Core.FromJSON AccountCount where
        parseJSON
          = Core.withObject "AccountCount"
              (\ o ->
                 AccountCount Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "count"))
...
instance Core.FromJSON AccountInfo where
        parseJSON
          = Core.withObject "AccountInfo"
              (\ o ->
                 AccountInfo Core.<$>
                   (o Core..:? "emails" Core..!= Core.mempty))
          ...
          = Core.withObject "AddHeldAccountsRequest"
              (\ o ->
                 AddHeldAccountsRequest Core.<$>
                   (o Core..:? "accountIds" Core..!= Core.mempty)
...
instance Core.FromJSON CloudStorageSink where
        parseJSON
          = Core.withObject "CloudStorageSink"
              (\ o ->
                 CloudStorageSink Core.<$>
                   (o Core..:? "files" Core..!= Core.mempty))
...
instance Core.FromJSON DriveOptions where
        parseJSON
          = Core.withObject "DriveOptions"
              (\ o ->
                 DriveOptions Core.<$>
                   (o Core..:? "includeSharedDrives") Core.<*>
                     (o Core..:? "includeTeamDrives")
              ...
              (\ o ->
                 GroupsCountResult Core.<$>
                   (o Core..:? "accountCountErrors" Core..!=
                      Core.mempty)
                     Core.<*>
                     (o Core..:? "accountCounts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "matchingAccountsCount")
                     Core.<*>
                     (o Core..:? "nonQueryableAccounts" Core..!=
                        Core.mempty)
...
instance Core.FromJSON HangoutsChatInfo where
        parseJSON
          = Core.withObject "HangoutsChatInfo"
              (\ o ->
                 HangoutsChatInfo Core.<$>
                   (o Core..:? "roomId" Core..!= Core.mempty))
...
instance Core.FromJSON HeldVoiceQuery where
        parseJSON
          = Core.withObject "HeldVoiceQuery"
              (\ o ->
                 HeldVoiceQuery Core.<$>
                   (o Core..:? "coveredData" Core..!= Core.mempty))
          ...
          = Core.withObject "ListExportsResponse"
              (\ o ->
                 ListExportsResponse Core.<$>
                   (o Core..:? "exports" Core..!= Core.mempty) Core.<*>
          ...
          = Core.withObject "ListHeldAccountsResponse"
              (\ o ->
                 ListHeldAccountsResponse Core.<$>
                   (o Core..:? "accounts" Core..!= Core.mempty))
          ...
          = Core.withObject "ListHoldsResponse"
              (\ o ->
                 ListHoldsResponse Core.<$>
                   (o Core..:? "holds" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListMattersResponse"
              (\ o ->
                 ListMattersResponse Core.<$>
                   (o Core..:? "matters" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "nextPageToken"))
          ...
          = Core.withObject "ListSavedQueriesResponse"
              (\ o ->
                 ListSavedQueriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "savedQueries" Core..!= Core.mempty))
...
newMailOptions 
    ::  MailOptions
newMailOptions = MailOptions {excludeDrafts = Core.Nothing}

instance Core.FromJSON MailOptions where
        parseJSON
          = Core.withObject "MailOptions"
              (\ o ->
                 MailOptions Core.<$> (o Core..:? "excludeDrafts"))
              ...
              (\ o ->
                 Matter Core.<$>
                   (o Core..:? "description") Core.<*>
                     (o Core..:? "matterId")
                     Core.<*>
                     (o Core..:? "matterPermissions" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "state"))
          ...
          = Core.withObject "SharedDriveInfo"
              (\ o ->
                 SharedDriveInfo Core.<$>
                   (o Core..:? "sharedDriveIds" Core..!= Core.mempty))
...
instance Core.FromJSON TeamDriveInfo where
        parseJSON
          = Core.withObject "TeamDriveInfo"
              (\ o ->
                 TeamDriveInfo Core.<$>
                   (o Core..:? "teamDriveIds" Core..!= Core.mempty))
