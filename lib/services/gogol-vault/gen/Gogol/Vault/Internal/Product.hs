...
newCalendarExportOptions 
    ::  CalendarExportOptions
newCalendarExportOptions = CalendarExportOptions {exportFormat = Core.Nothing}

instance Core.FromJSON CalendarExportOptions where
        parseJSON
          = Core.withObject "CalendarExportOptions"
              (\ o ->
                 CalendarExportOptions Core.<$>
                   (o Core..:? "exportFormat"))
...
instance Core.ToJSON MailExportOptions where
        toJSON MailExportOptions{..}
          = Core.object
              (Core.catMaybes
                 [("exportFormat" Core..=) Core.<$> exportFormat,
                  ("exportLinkedDriveFiles" Core..=) Core.<$>
