     ...
     "v1" Core.:>
       "matters" Core.:>
         Core.Capture "matterId" Core.Text Core.:>
           "holds" Core.:>
             Core.CaptureMode "holdId" "addHeldAccounts" Core.Text
               Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AddHeldAccountsRequest
                             Core.:>
...
instance Core.GoogleRequest
           VaultMattersHoldsAddHeldAccounts
         where
        type Rs VaultMattersHoldsAddHeldAccounts =
        ...
        requestClient VaultMattersHoldsAddHeldAccounts{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy VaultMattersHoldsAddHeldAccountsResource)
                      Core.mempty
