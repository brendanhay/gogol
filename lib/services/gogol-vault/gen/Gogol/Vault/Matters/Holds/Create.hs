                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Hold Core.:>
                           Core.Post '[Core.JSON] Hold
...
instance Core.GoogleRequest VaultMattersHoldsCreate
         where
        type Rs VaultMattersHoldsCreate = Hold
        type Scopes VaultMattersHoldsCreate =
        ...
        requestClient VaultMattersHoldsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy VaultMattersHoldsCreateResource)
                      Core.mempty
