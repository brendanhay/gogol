        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_AnnotateVideoProgress
                   Core.<$>
                   (o Core..:? "annotationProgress" Core..!=
                      Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_ExplicitContentAnnotation
                   Core.<$>
                   (o Core..:? "frames" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "version"))
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_FaceDetectionAnnotation
                   ...
                   (o Core..:? "thumbnail") Core.<*>
                     (o Core..:? "tracks" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "version"))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_LabelAnnotation
                   Core.<$>
                   (o Core..:? "categoryEntities" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "entity")
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_NormalizedBoundingPoly
                   Core.<$>
                   (o Core..:? "vertices" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_PersonDetectionAnnotation
                   Core.<$>
                   (o Core..:? "tracks" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "version"))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_SpeechTranscription
                   Core.<$>
                   (o Core..:? "alternatives" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "languageCode"))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_TextAnnotation
                   Core.<$>
                   (o Core..:? "segments" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "text")
                     Core.<*> (o Core..:? "version"))
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_TextSegment Core.<$>
                   (o Core..:? "confidence") Core.<*>
                     (o Core..:? "frames" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "segment"))
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_TimestampedObject
                   ...
                   (o Core..:? "attributes" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "landmarks" Core..!= Core.mempty)
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_Track Core.<$>
                   (o Core..:? "attributes" Core..!= Core.mempty)
                     ...
                     Core.<*> (o Core..:? "segment")
                     Core.<*>
                     (o Core..:? "timestampedObjects" Core..!=
                        Core.mempty))
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1_VideoAnnotationResults
                   ...
                   (o Core..:? "error") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "faceAnnotations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "faceDetectionAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "frameLabelAnnotations" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "inputUri")
                     Core.<*>
                     (o Core..:? "logoRecognitionAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "objectAnnotations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "personDetectionAnnotations" Core..!=
                        Core.mempty)
                     Core.<*> (o Core..:? "segment")
                     Core.<*>
                     (o Core..:? "segmentLabelAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "segmentPresenceLabelAnnotations"
                        Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "shotAnnotations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "shotLabelAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "shotPresenceLabelAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "speechTranscriptions" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "textAnnotations" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest
                   Core.<$>
                   (o Core..:? "features" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "inputContent")
                     Core.<*> (o Core..:? "inputUri")
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_CelebrityRecognitionAnnotation
                   Core.<$>
                   (o Core..:? "celebrityTracks" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "version"))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_CelebrityTrack
                   Core.<$>
                   (o Core..:? "celebrities" Core..!= Core.mempty)
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_SpeechTranscriptionConfig
                   Core.<$>
                   (o Core..:? "audioTracks" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "speechContexts" Core..!= Core.mempty))
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_StreamingVideoAnnotationResults
                   ...
                   (o Core..:? "explicitAnnotation") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "labelAnnotations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "objectAnnotations" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "shotAnnotations" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVideointelligenceV1p3beta1_TextDetectionConfig
                   Core.<$>
                   (o Core..:? "languageHints" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "model"))
...
newGoogleLongrunning_Operation_Metadata 
    ...
    -> GoogleLongrunning_Operation_Metadata
newGoogleLongrunning_Operation_Metadata addtional =
  GoogleLongrunning_Operation_Metadata {addtional = addtional}
...
newGoogleLongrunning_Operation_Response 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'addtional'.
    -> GoogleLongrunning_Operation_Response
newGoogleLongrunning_Operation_Response addtional =
  GoogleLongrunning_Operation_Response {addtional = addtional}
...
newGoogleRpc_Status_DetailsItem 
    ::  Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. Contains field \@type with type URL. See 'addtional'.
    -> GoogleRpc_Status_DetailsItem
newGoogleRpc_Status_DetailsItem addtional =
  GoogleRpc_Status_DetailsItem {addtional = addtional}
