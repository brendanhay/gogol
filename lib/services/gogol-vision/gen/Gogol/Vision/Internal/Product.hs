              ...
              (\ o ->
                 AnnotateImageResponse Core.<$>
                   (o Core..:? "context") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "landmarkAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "localizedObjectAnnotations" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "logoAnnotations" Core..!= Core.mempty)
              ...
              (\ o ->
                 Block Core.<$>
                   (o Core..:? "blockType") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "paragraphs" Core..!= Core.mempty)
          ...
          = Core.withObject "CropHintsAnnotation"
              (\ o ->
                 CropHintsAnnotation Core.<$>
                   (o Core..:? "cropHints" Core..!= Core.mempty))
          ...
          = Core.withObject "GoogleCloudVisionV1p1beta1Page"
              (\ o ->
                 GoogleCloudVisionV1p1beta1Page Core.<$>
                   (o Core..:? "blocks" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "confidence")
                     Core.<*> (o Core..:? "height")
                     Core.<*> (o Core..:? "property")
                     Core.<*> (o Core..:? "width"))
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1Product Core.<$>
                   (o Core..:? "description") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "productLabels" Core..!= Core.mempty))
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1ProductSearchResults
                   ...
                   (o Core..:? "indexTime") Core.<*>
                     (o Core..:? "productGroupedResults" Core..!=
                        Core.mempty)
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1TextAnnotation Core.<$>
                   (o Core..:? "pages" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "text"))
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p1beta1WebDetection Core.<$>
                   (o Core..:? "bestGuessLabels" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "fullMatchingImages" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "pagesWithMatchingImages" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "partialMatchingImages" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "visuallySimilarImages" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "webEntities" Core..!= Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p2beta1CropHintsParams Core.<$>
                   (o Core..:? "aspectRatios" Core..!= Core.mempty))
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p3beta1ImportProductSetsResponse
                   Core.<$>
                   (o Core..:? "referenceImages" Core..!= Core.mempty)
                     Core.<*>
          ...
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudVisionV1p3beta1ReferenceImage Core.<$>
                   (o Core..:? "boundingPolys" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "uri"))
              ...
              (\ o ->
                 GoogleCloudVisionV1p4beta1FaceAnnotation Core.<$>
                   (o Core..:? "angerLikelihood") Core.<*>
                     ...
                     Core.<*> (o Core..:? "panAngle")
                     Core.<*>
                     (o Core..:? "recognitionResult" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "rollAngle")
                     Core.<*> (o Core..:? "sorrowLikelihood")
                     Core.<*> (o Core..:? "surpriseLikelihood")
                     Core.<*> (o Core..:? "tiltAngle")
