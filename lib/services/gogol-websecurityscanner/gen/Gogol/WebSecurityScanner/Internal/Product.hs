...
instance Core.FromJSON Authentication where
        parseJSON
          = Core.withObject "Authentication"
              (\ o ->
                 Authentication Core.<$>
                   (o Core..:? "customAccount") Core.<*>
                     (o Core..:? "googleAccount")
...
newCrawledUrl =
  CrawledUrl
    {body = Core.Nothing, httpMethod = Core.Nothing, url = Core.Nothing}
...
newCustomAccount =
  CustomAccount
    {loginUrl = Core.Nothing, password = Core.Nothing, username = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("body" Core..=) Core.<$> body,
                  ...
                  ("violatingResource" Core..=) Core.<$>
                    violatingResource,
                  ("vulnerableHeaders" Core..=) Core.<$>
                    vulnerableHeaders,
                  ("vulnerableParameters" Core..=) Core.<$>
                    vulnerableParameters,
                  ("xss" Core..=) Core.<$> xss,
                  ("xxe" Core..=) Core.<$> xxe])
...
instance Core.FromJSON IapCredential where
        parseJSON
          = Core.withObject "IapCredential"
              (\ o ->
                 IapCredential Core.<$>
                   (o Core..:? "iapTestServiceAccountInfo"))
...
instance Core.FromJSON IapTestServiceAccountInfo
         where
        parseJSON
...
newListCrawledUrlsResponse =
  ListCrawledUrlsResponse
    {crawledUrls = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListCrawledUrlsResponse"
              (\ o ->
                 ListCrawledUrlsResponse Core.<$>
                   (o Core..:? "crawledUrls" Core..!= Core.mempty)
...
instance Core.FromJSON ListFindingTypeStatsResponse
         where
        parseJSON
          = Core.withObject "ListFindingTypeStatsResponse"
              (\ o ->
                 ListFindingTypeStatsResponse Core.<$>
                   (o Core..:? "findingTypeStats" Core..!= Core.mempty))

instance Core.ToJSON ListFindingTypeStatsResponse
         where
        toJSON ListFindingTypeStatsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("findingTypeStats" Core..=) Core.<$>
                    findingTypeStats])
...
newListScanConfigsResponse =
  ListScanConfigsResponse
    {nextPageToken = Core.Nothing, scanConfigs = Core.Nothing}
              ...
              (\ o ->
                 ListScanConfigsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "scanConfigs" Core..!= Core.mempty))
          ...
          = Core.withObject "ListScanRunsResponse"
              (\ o ->
                 ListScanRunsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "scanRuns" Core..!= Core.mempty))
          ...
          = Core.withObject "OutdatedLibrary"
              (\ o ->
                 OutdatedLibrary Core.<$>
                   (o Core..:? "learnMoreUrls" Core..!= Core.mempty)
              ...
              (\ o ->
                 ScanConfig Core.<$>
                   (o Core..:? "authentication") Core.<*>
                     (o Core..:? "blacklistPatterns" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "startingUrls" Core..!= Core.mempty)
          ...
          = Core.object
              (Core.catMaybes
                 [("authentication" Core..=) Core.<$> authentication,
                  ("blacklistPatterns" Core..=) Core.<$>
                    blacklistPatterns,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("exportToSecurityCommandCenter" Core..=) Core.<$>
                    exportToSecurityCommandCenter,
                  ("ignoreHttpStatusErrors" Core..=) Core.<$>
              ...
              (\ o ->
                 ScanRun Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "warningTraces" Core..!= Core.mempty))
          ...
          = Core.withObject "ScanRunErrorTrace"
              (\ o ->
                 ScanRunErrorTrace Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "mostCommonHttpErrorCode")
...
instance Core.ToJSON Schedule where
        toJSON Schedule{..}
          = Core.object
              (Core.catMaybes
                 [("intervalDurationDays" Core..=) Core.<$>
              ...
              (\ o ->
                 VulnerableHeaders Core.<$>
                   (o Core..:? "headers" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "missingHeaders" Core..!= Core.mempty))
          ...
          = Core.withObject "VulnerableParameters"
              (\ o ->
                 VulnerableParameters Core.<$>
                   (o Core..:? "parameterNames" Core..!= Core.mempty))
...
instance Core.FromJSON Xss where
        parseJSON
          = Core.withObject "Xss"
              (\ o ->
                 Xss Core.<$>
                   (o Core..:? "attackVector") Core.<*>
                     (o Core..:? "errorMessage")
                     Core.<*>
                     (o Core..:? "stackTraces" Core..!= Core.mempty)
