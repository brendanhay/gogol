                     ...
                     Core.QueryParam "onBehalfOfContentOwner" Core.Text
                       ...
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "startTimeAtOrAfter" Core.DateTime
                             Core.:>
                             Core.QueryParam "startTimeBefore" Core.DateTime
                               Core.:>
...
instance Core.GoogleRequest
           YouTubeReportingJobsReportsList
         where
        type Rs YouTubeReportingJobsReportsList =
             ListReportsResponse
        ...
        requestClient YouTubeReportingJobsReportsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy YouTubeReportingJobsReportsListResource)
                      Core.mempty
