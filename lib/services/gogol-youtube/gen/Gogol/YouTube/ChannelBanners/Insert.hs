                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] ChannelBannerResource
                                 Core.:>
...
instance Core.GoogleRequest
           YouTubeChannelBannersInsert
         where
        type Rs YouTubeChannelBannersInsert =
             ChannelBannerResource
        ...
        requestClient YouTubeChannelBannersInsert{..}
          = go xgafv accessToken callback channelId
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy YouTubeChannelBannersInsertResource)
                      Core.mempty
