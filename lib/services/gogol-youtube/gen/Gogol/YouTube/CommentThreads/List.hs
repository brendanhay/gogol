           ...
           Core.QueryParams "part" Core.Text Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "allThreadsRelatedToChannelId"
                   Core.Text
                   Core.:>
                       ...
                       Core.QueryParams "id" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "moderationStatus"
                             ...
                             Core.:>
                             Core.QueryParam "order" CommentThreadsListOrder
                               Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "searchTerms" Core.Text Core.:>
                                   Core.QueryParam "textFormat"
                                     ...
                                     Core.QueryParam "uploadType" Core.Text
                                       ...
                                       Core.QueryParam "upload_protocol"
                                         Core.Text
                                         Core.:>
                                         Core.QueryParam "videoId" Core.Text
                                           Core.:>
...
instance Core.GoogleRequest YouTubeCommentThreadsList
         where
        type Rs YouTubeCommentThreadsList =
             CommentThreadListResponse
        type Scopes YouTubeCommentThreadsList =
             '[Youtube'ForceSsl]
        requestClient YouTubeCommentThreadsList{..}
          = go part xgafv accessToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy YouTubeCommentThreadsListResource)
                      Core.mempty
