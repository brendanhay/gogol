...
instance Core.FromJSON AbuseReport where
        parseJSON
          = Core.withObject "AbuseReport"
              (\ o ->
                 AbuseReport Core.<$>
                   (o Core..:? "abuseTypes" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "relatedEntities" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "subject"))
        ...
        parseJSON
          = Core.withObject "AccessPolicy"
              (\ o ->
                 AccessPolicy Core.<$>
                   (o Core..:? "allowed") Core.<*>
                     (o Core..:? "exception" Core..!= Core.mempty))
              ...
              (\ o ->
                 ActivityContentDetailsPromotedItem Core.<$>
                   (o Core..:? "adTag") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "forecastingUrl" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "impressionUrl" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "videoId"))
...
instance Core.FromJSON ChannelConversionPings where
        parseJSON
          = Core.withObject "ChannelConversionPings"
              (\ o ->
                 ChannelConversionPings Core.<$>
                   (o Core..:? "pings" Core..!= Core.mempty))
              ...
              (\ o ->
                 ChannelSectionContentDetails Core.<$>
                   (o Core..:? "channels" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "playlists" Core..!= Core.mempty))
              ...
              (\ o ->
                 ChannelSettings Core.<$>
                   (o Core..:? "country") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "featuredChannelsUrls" Core..!=
                        Core.mempty)
          ...
          = Core.withObject "ChannelTopicDetails"
              (\ o ->
                 ChannelTopicDetails Core.<$>
                   (o Core..:? "topicCategories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "topicIds" Core..!= Core.mempty))
          ...
          = Core.withObject "CommentThreadReplies"
              (\ o ->
                 CommentThreadReplies Core.<$>
                   (o Core..:? "comments" Core..!= Core.mempty))
              ...
              (\ o ->
                 ContentRating Core.<$>
                   (o Core..:? "acbRating") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "djctqRatingReasons" Core..!=
                        Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "fpbRatingReasons" Core..!= Core.mempty)
              ...
              (\ o ->
                 LocalizedProperty Core.<$>
                   (o Core..:? "default") Core.<*>
                     (o Core..:? "defaultLanguage")
                     Core.<*>
                     (o Core..:? "localized" Core..!= Core.mempty))
          ...
          = Core.withObject "VideoAbuseReportReasonSnippet"
              (\ o ->
                 VideoAbuseReportReasonSnippet Core.<$>
                   (o Core..:? "label") Core.<*>
                     (o Core..:? "secondaryReasons" Core..!= Core.mempty))
          ...
          = Core.withObject
              ...
              (\ o ->
                 VideoContentDetailsRegionRestriction Core.<$>
                   (o Core..:? "allowed" Core..!= Core.mempty) Core.<*>
                     (o Core..:? "blocked" Core..!= Core.mempty))
          ...
          = Core.withObject "VideoFileDetails"
              (\ o ->
                 VideoFileDetails Core.<$>
                   (o Core..:? "audioStreams" Core..!= Core.mempty)
                     ...
                     Core.<*>
                     (o Core..:? "videoStreams" Core..!= Core.mempty))
          ...
          = Core.withObject "VideoSuggestions"
              (\ o ->
                 VideoSuggestions Core.<$>
                   (o Core..:? "editorSuggestions" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "processingErrors" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "processingHints" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "processingWarnings" Core..!=
                        Core.mempty)
                     Core.<*>
                     (o Core..:? "tagSuggestions" Core..!= Core.mempty))
          ...
          = Core.withObject "VideoSuggestionsTagSuggestion"
              (\ o ->
                 VideoSuggestionsTagSuggestion Core.<$>
                   (o Core..:? "categoryRestricts" Core..!= Core.mempty)
                     Core.<*> (o Core..:? "tag"))
          ...
          = Core.withObject "VideoTopicDetails"
              (\ o ->
                 VideoTopicDetails Core.<$>
                   (o Core..:? "relevantTopicIds" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "topicCategories" Core..!= Core.mempty)
                     Core.<*>
                     (o Core..:? "topicIds" Core..!= Core.mempty))
