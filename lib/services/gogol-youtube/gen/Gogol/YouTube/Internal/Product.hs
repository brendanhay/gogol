...
newChannelToStoreLinkDetailsBillingDetails 
    ::  ChannelToStoreLinkDetailsBillingDetails
newChannelToStoreLinkDetailsBillingDetails =
  ChannelToStoreLinkDetailsBillingDetails {billingStatus = Core.Nothing}
...
instance Core.ToJSON
        ...
        toJSON ChannelToStoreLinkDetailsBillingDetails{..}
          = Core.object
              (Core.catMaybes
                 [("billingStatus" Core..=) Core.<$> billingStatus])
          ...
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ...
                  ("repeatIntervalSecs" Core..=) Core.<$>
                    repeatIntervalSecs,
                  ("scheduleStrategy" Core..=) Core.<$>
                    scheduleStrategy])
...
instance Core.ToJSON LiveBroadcastMonetizationDetails
         where
        toJSON LiveBroadcastMonetizationDetails{..}
          = Core.object
              (Core.catMaybes
                 [("cuepointSchedule" Core..=) Core.<$>
                    cuepointSchedule])
...
newLiveChatPollDetails 
    ::  LiveChatPollDetails
newLiveChatPollDetails =
  LiveChatPollDetails {metadata = Core.Nothing, status = Core.Nothing}
...
newLiveChatPollDetailsPollMetadata =
  LiveChatPollDetailsPollMetadata
    {options = Core.Nothing, questionText = Core.Nothing}
...
instance Core.ToJSON LiveChatPollDetailsPollMetadata
         where
...
newLiveChatPollDetailsPollMetadataPollOption =
  LiveChatPollDetailsPollMetadataPollOption
    {optionText = Core.Nothing, tally = Core.Nothing}
...
newPlaylistImage =
  PlaylistImage
    {id = Core.Nothing, kind = "youtube#playlistImage", snippet = Core.Nothing}
...
instance Core.FromJSON PlaylistImageListResponse
         where
        parseJSON
...
newPlaylistStatus 
    ::  PlaylistStatus
newPlaylistStatus =
  PlaylistStatus {podcastStatus = Core.Nothing, privacyStatus = Core.Nothing}
...
newVideoPaidProductPlacementDetails 
    ::  VideoPaidProductPlacementDetails
newVideoPaidProductPlacementDetails =
  VideoPaidProductPlacementDetails {hasPaidProductPlacement = Core.Nothing}
...
instance Core.ToJSON VideoPaidProductPlacementDetails
         where
