...
instance Core.GoogleRequest YouTubeLiveBroadcastsList
         where
        type Rs YouTubeLiveBroadcastsList =
             LiveBroadcastListResponse
        ...
        requestClient YouTubeLiveBroadcastsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy YouTubeLiveBroadcastsListResource)
                      Core.mempty
