...
type YouTubeSearchListResource =
  "youtube"
    ...
    Core.:> Core.QueryParam "channelType" SearchListChannelType
    Core.:> Core.QueryParam "eventType" SearchListEventType
    Core.:> Core.QueryParam "forContentOwner" Core.Bool
    Core.:> Core.QueryParam "forDeveloper" Core.Bool
    Core.:> Core.QueryParam "forMine" Core.Bool
    Core.:> Core.QueryParam "location" Core.Text
    Core.:> Core.QueryParam "locationRadius" Core.Text
    Core.:> Core.QueryParam "maxResults" Core.Word32
    Core.:> Core.QueryParam "onBehalfOfContentOwner" Core.Text
    Core.:> Core.QueryParam "order" SearchListOrder
    ...
    Core.:> Core.QueryParam "relevanceLanguage" Core.Text
    Core.:> Core.QueryParam
              "safeSearch"
              SearchListSafeSearch
    Core.:> Core.QueryParam "topicId" Core.Text
    Core.:> Core.QueryParams "type" Core.Text
